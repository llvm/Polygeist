/* Fixed-shape ATen adaptive_max_pool3d_backward. */
#ifndef B
#define B 1
#endif
#ifndef C
...
#define O2 3
#endif
void aten_adaptive_max_pool3d_backward_cpu(float grad_output[B*C*O0*O1*O2], int indices[B*C*O0*O1*O2], float grad_input[B*C*I0*I1*I2]){
