...
- Legally comparable raised/native ratios: 215/292
- Median raised/native ratio (eligible rows only): 2.615x

## Raised status

- LEGACY_RESIDENT: 1
- NO_COMPLETE_CURRENT_LIBRARY_REWRITE: 76
- VERIFIED_RESIDENT: 215

## Non-verified breakdown

- LEGACY_RESIDENT: aten_upsample_bilinear2d
