        ...
        affine.for %arg4 = 0 to 3 {
          ...
          affine.for %arg5 = 0 to 3 {
            ...
            affine.for %arg6 = #map(%arg3) to #map1(%arg3) {
              %37 = affine.load %alloca[%arg5] : memref<?xi32>
              %38 = affine.load %alloca_0[%arg5] : memref<?xf32>
              %39 = arith.muli %arg6, %c56 : index
              %40:2 = scf.for %arg7 = %7 to %8 step %c1 iter_args(%arg8 = %37, %arg9 = %38) -> (i32, f32) {
                %41 = arith.index_cast %arg8 : i32 to index
                %42 = arith.addi %41, %18 : index
                %43 = arith.index_cast %42 : index to i32
                %44 = arith.muli %arg7, %c8 : index
                %45 = scf.for %arg10 = %25 to %32 step %c1 iter_args(%arg11 = %arg9) -> (f32) {
                  %46 = arith.addi %arg10, %44 : index
                  %47 = arith.addi %46, %0 : index
                  %48 = arith.addi %47, %39 : index
                  %49 = memref.load %arg0[%48] : memref<?xf32>
                  %50 = arith.addf %arg11, %49 : f32
                  scf.yield %50 : f32
                }
                scf.yield %43, %45 : i32, f32
              }
              affine.store %40#0, %alloca[%arg5] : memref<?xi32>
              affine.store %40#1, %alloca_0[%arg5] : memref<?xf32>
            }
            %33 = affine.load %alloca[%arg5] : memref<?xi32>
            %34 = affine.load %alloca_0[%arg5] : memref<?xf32>
            %35 = arith.sitofp %33 : i32 to f32
            %36 = arith.divf %34, %35 : f32
            affine.store %36, %arg1[%arg2 * 27 + %arg5 + %arg3 * 9 + %arg4 * 3] : memref<?xf32>
          }
        }
      }
    }
