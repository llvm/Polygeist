          ...
          affine.for %arg6 = 0 to 5 {
            ...
            %37:2 = scf.for %arg7 = %10 to %17 step %c1 iter_args(%arg8 = %36, %arg9 = %34) -> (f32, i32) {
              ...
              %40:2 = scf.for %arg10 = %29 to %30 step %c1 iter_args(%arg11 = %arg8, %arg12 = %arg9) -> (f32, i32) {
                ...
                affine.store %arg11, %alloca[] : memref<f32>
                %alloca_0 = memref.alloca() : memref<i32>
                affine.store %arg12, %alloca_0[] : memref<i32>
                affine.for %arg13 = #map(%arg6) to #map1(%arg6) {
                  %46 = affine.load %alloca[] : memref<f32>
                  %47 = affine.load %alloca_0[] : memref<i32>
                  %48 = arith.index_cast %arg13 : index to i32
                  %49 = memref.load %arg0[%arg3, %arg7, %arg10, %arg13] : memref<?x8x9x10xf32>
                  %50 = arith.cmpf ogt, %49, %46 : f32
                  %51 = arith.select %50, %49, %46 : f32
                  %52 = arith.addi %43, %48 : i32
                  %53 = arith.select %50, %52, %47 : i32
                  affine.store %51, %alloca[] : memref<f32>
                  affine.store %53, %alloca_0[] : memref<i32>
                }
                %44 = affine.load %alloca[] : memref<f32>
                %45 = affine.load %alloca_0[] : memref<i32>
                scf.yield %44, %45 : f32, i32
              }
