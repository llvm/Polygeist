        ...
        affine.for %arg4 = 0 to 3 {
          affine.for %arg5 = #map(%arg3) to #map1(%arg3) {
            affine.for %arg6 = #map(%arg4) to #map1(%arg4) {
              %0 = affine.load %arg0[%arg4 + %arg2 * 9 + %arg3 * 3] : memref<?xf32>
              %1 = arith.divf %0, %cst : f32
              %2 = affine.load %arg1[%arg6 + %arg5 * 7 + %arg2 * 42] : memref<?xf32>
              %3 = arith.addf %2, %1 : f32
              affine.store %3, %arg1[%arg6 + %arg5 * 7 + %arg2 * 42] : memref<?xf32>
            }
          }
        }
      }
