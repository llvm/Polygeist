      ...
      affine.for %arg7 = 0 to 16 {
        affine.for %arg8 = 0 to 16 {
          affine.for %arg9 = 0 to 16 {
            %0 = affine.load %arg0[%arg6, %arg7, %arg8, %arg9] : memref<?x16x16x16xf32>
            %1 = affine.load %arg1[%arg7] : memref<?xf32>
            %2 = arith.subf %0, %1 : f32
            %3 = affine.load %arg2[%arg7] : memref<?xf32>
            %4 = arith.mulf %2, %3 : f32
            %5 = affine.load %arg3[%arg7] : memref<?xf32>
            %6 = arith.mulf %4, %5 : f32
            %7 = affine.load %arg4[%arg7] : memref<?xf32>
            %8 = arith.addf %6, %7 : f32
            affine.store %8, %arg5[%arg6, %arg7, %arg8, %arg9] : memref<?x16x16x16xf32>
          }
        }
      }
    }
