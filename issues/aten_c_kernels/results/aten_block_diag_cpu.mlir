  ...
  func.func @aten_block_diag_cpu(%arg0: memref<?x16x16xf32>, %arg1: memref<?x64xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg2 = 0 to 64 {
      affine.for %arg3 = 0 to 64 {
        affine.store %cst, %arg1[%arg2, %arg3] : memref<?x64xf32>
      }
    }
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 16 {
        affine.for %arg4 = 0 to 16 {
          %0 = affine.load %arg0[%arg2, %arg3, %arg4] : memref<?x16x16xf32>
          affine.store %0, %arg1[%arg3 + %arg2 * 16, %arg4 + %arg2 * 16] : memref<?x64xf32>
        }
      }
    }
    return
