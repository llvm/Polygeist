    ...
    affine.for %arg3 = 0 to 4 {
      affine.for %arg4 = 0 to 8 {
        affine.for %arg5 = 0 to 12 {
          affine.store %cst, %arg2[%arg3, %arg4, %arg5] : memref<?x8x12xf32>
        }
      }
    }
    affine.for %arg3 = 0 to 4 {
      affine.for %arg4 = 0 to 8 {
        affine.for %arg5 = 0 to 12 {
          affine.for %arg6 = 0 to 16 {
            %0 = affine.load %arg0[%arg3, %arg4, %arg6] : memref<?x8x16xf32>
            %1 = affine.load %arg1[%arg3, %arg6, %arg5] : memref<?x16x12xf32>
            %2 = arith.mulf %0, %1 : f32
            %3 = affine.load %arg2[%arg3, %arg4, %arg5] : memref<?x8x12xf32>
            %4 = arith.addf %3, %2 : f32
            affine.store %4, %arg2[%arg3, %arg4, %arg5] : memref<?x8x12xf32>
          }
        }
      }
    }
