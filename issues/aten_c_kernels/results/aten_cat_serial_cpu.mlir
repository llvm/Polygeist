  ...
  func.func @aten_cat_serial_cpu(%arg0: memref<?x64xf32>, %arg1: memref<?x64xf32>, %arg2: memref<?x64xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    affine.for %arg3 = 0 to 16 {
      affine.for %arg4 = 0 to 64 {
        %0 = affine.load %arg0[%arg3, %arg4] : memref<?x64xf32>
        affine.store %0, %arg2[%arg3, %arg4] : memref<?x64xf32>
      }
    }
    affine.for %arg3 = 0 to 12 {
      affine.for %arg4 = 0 to 64 {
        %0 = affine.load %arg1[%arg3, %arg4] : memref<?x64xf32>
        affine.store %0, %arg2[%arg3 + 16, %arg4] : memref<?x64xf32>
      }
    }
    return
  }
