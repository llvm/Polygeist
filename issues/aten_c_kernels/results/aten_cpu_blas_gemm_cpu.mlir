  ...
  func.func @aten_cpu_blas_gemm_cpu(%arg0: memref<?x40xf32>, %arg1: memref<?x32xf32>, %arg2: memref<?x32xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 24 {
      affine.for %arg4 = 0 to 32 {
        %0 = affine.for %arg5 = 0 to 40 iter_args(%arg6 = %cst) -> (f32) {
          %1 = affine.load %arg0[%arg3, %arg5] : memref<?x40xf32>
          %2 = affine.load %arg1[%arg5, %arg4] : memref<?x32xf32>
          %3 = arith.mulf %1, %2 : f32
          %4 = arith.addf %arg6, %3 : f32
          affine.yield %4 : f32
        }
        affine.store %0, %arg2[%arg3, %arg4] : memref<?x32xf32>
      }
    }
    return
  }
