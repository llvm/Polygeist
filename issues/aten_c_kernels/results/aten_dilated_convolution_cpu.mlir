    ...
    affine.for %arg3 = 0 to 3 {
      affine.for %arg4 = 0 to 12 {
        affine.for %arg5 = 0 to 12 {
          %0 = affine.for %arg6 = 0 to 2 iter_args(%arg7 = %cst) -> (f32) {
            %1 = affine.for %arg8 = 0 to 3 iter_args(%arg9 = %arg7) -> (f32) {
              %2 = affine.for %arg10 = 0 to 3 iter_args(%arg11 = %arg9) -> (f32) {
                %3 = affine.load %arg0[%arg6, %arg4 + %arg8 * 2, %arg5 + %arg10 * 2] : memref<?x16x16xf32>
                %4 = affine.load %arg1[%arg3, %arg6, %arg8, %arg10] : memref<?x2x3x3xf32>
                %5 = arith.mulf %3, %4 : f32
                %6 = arith.addf %arg11, %5 : f32
                affine.yield %6 : f32
              }
              affine.yield %2 : f32
            }
          ...
          affine.store %0, %arg2[%arg3, %arg4, %arg5] : memref<?x12x12xf32>
        }
      }
    }
    return
