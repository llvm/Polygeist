  ...
  func.func @aten_eig_complex_vectors_cpu(%arg0: memref<?x64xf32>, %arg1: memref<?xf32>, %arg2: memref<?x64xf32>, %arg3: memref<?x64xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg4 = 0 to 64 {
      affine.for %arg5 = 0 to 64 {
        %0 = affine.load %arg0[%arg4, %arg5] : memref<?x64xf32>
        affine.store %0, %arg2[%arg4, %arg5] : memref<?x64xf32>
        %1 = affine.load %arg1[%arg5] : memref<?xf32>
        %2 = arith.cmpf oeq, %1, %cst : f32
        %3 = scf.if %2 -> (f32) {
          scf.yield %cst : f32
        } else {
          %4 = affine.if #set(%arg5) -> f32 {
            %5 = affine.load %arg0[%arg4, %arg5 + 1] : memref<?x64xf32>
            affine.yield %5 : f32
          } else {
        ...
        affine.store %3, %arg3[%arg4, %arg5] : memref<?x64xf32>
      }
    }
    return
  }
