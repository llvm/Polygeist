  ...
  func.func @aten_embedding_bag_max_cpu(%arg0: memref<?x64xf32>, %arg1: memref<?x16xi32>, %arg2: memref<?x64xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    affine.for %arg3 = 0 to 32 {
      affine.for %arg4 = 0 to 64 {
        ...
        affine.store %2, %arg2[%arg3, %arg4] : memref<?x64xf32>
      }
    }
    affine.for %arg3 = 0 to 32 {
      affine.for %arg4 = 0 to 64 {
        affine.for %arg5 = 1 to 16 {
          %0 = affine.load %arg2[%arg3, %arg4] : memref<?x64xf32>
          %1 = affine.load %arg1[%arg3, %arg5] : memref<?x16xi32>
          %2 = arith.index_cast %1 : i32 to index
          %3 = memref.load %arg0[%2, %arg4] : memref<?x64xf32>
          %4 = arith.cmpf ogt, %3, %0 : f32
          %5 = memref.load %arg0[%2, %arg4] : memref<?x64xf32>
          %6 = arith.select %4, %5, %0 : f32
          affine.store %6, %arg2[%arg3, %arg4] : memref<?x64xf32>
        }
      }
    }
    return
