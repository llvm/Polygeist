    ...
    affine.for %arg3 = 0 to 16 {
      affine.for %arg4 = 0 to 32 {
        affine.for %arg5 = 0 to 48 {
          %0 = affine.for %arg6 = 0 to 64 iter_args(%arg7 = %cst) -> (f32) {
            %1 = affine.load %arg0[%arg3, %arg4, %arg6] : memref<?x32x64xf32>
            %2 = affine.load %arg1[%arg6, %arg5] : memref<?x48xf32>
            %3 = arith.mulf %1, %2 : f32
            %4 = arith.addf %arg7, %3 : f32
            affine.yield %4 : f32
          }
          affine.store %0, %arg2[%arg3, %arg4, %arg5] : memref<?x32x48xf32>
        }
      }
    }
    return
