  ...
  func.func @aten_int8pack_mm_cpu(%arg0: memref<?x64xf32>, %arg1: memref<?x64xi8>, %arg2: memref<?xf32>, %arg3: memref<?x48xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg4 = 0 to 32 {
      affine.for %arg5 = 0 to 48 {
        affine.store %cst, %arg3[%arg4, %arg5] : memref<?x48xf32>
        affine.for %arg6 = 0 to 64 {
          %0 = affine.load %arg0[%arg4, %arg6] : memref<?x64xf32>
          %1 = affine.load %arg1[%arg5, %arg6] : memref<?x64xi8>
          %2 = arith.sitofp %1 : i8 to f32
          %3 = arith.mulf %0, %2 : f32
          %4 = affine.load %arg2[%arg5] : memref<?xf32>
          %5 = arith.mulf %3, %4 : f32
          %6 = affine.load %arg3[%arg4, %arg5] : memref<?x48xf32>
          %7 = arith.addf %6, %5 : f32
          affine.store %7, %arg3[%arg4, %arg5] : memref<?x48xf32>
        }
      }
    }
    return
