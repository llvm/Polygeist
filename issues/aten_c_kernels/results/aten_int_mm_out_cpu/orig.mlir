  ...
  func.func @aten_int_mm_out_cpu(%arg0: memref<?x64xi8>, %arg1: memref<?x48xi8>, %arg2: memref<?x48xi32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 32 {
      affine.for %arg4 = 0 to 48 {
        %0 = affine.for %arg5 = 0 to 64 iter_args(%arg6 = %c0_i32) -> (i32) {
          %1 = affine.load %arg0[%arg3, %arg5] : memref<?x64xi8>
          %2 = arith.extsi %1 : i8 to i32
          %3 = affine.load %arg1[%arg5, %arg4] : memref<?x48xi8>
          %4 = arith.extsi %3 : i8 to i32
          %5 = arith.muli %2, %4 : i32
          %6 = arith.addi %arg6, %5 : i32
          affine.yield %6 : i32
        }
        affine.store %0, %arg2[%arg3, %arg4] : memref<?x48xi32>
      }
    }
    return
  }
