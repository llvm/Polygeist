...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @aten_layer_norm_cpu_backend(%arg0: memref<?x64xf32>, %arg1: memref<?xf32>, %arg2: memref<?xf32>, %arg3: f32, %arg4: memref<?x64xf32>, %arg5: memref<?xf32>, %arg6: memref<?xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg7 = 0 to 16 {
      ...
      %subview = memref.subview %arg0[%arg7, 0] [1, %c64] [1, 1] : memref<?x64xf32> to memref<?xf32, strided<[1], offset: ?>>
      ...
      affine.store %1, %arg5[%arg7] : memref<?xf32>
      %alloca_2 = memref.alloca() : memref<f32>
      affine.store %cst_1, %alloca_2[] : memref<f32>
      %subview_3 = memref.subview %arg0[%arg7, 0] [1, %c64] [1, 1] : memref<?x64xf32> to memref<?xf32, strided<[1], offset: ?>>
      linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["reduction"]} ins(%subview_3 : memref<?xf32, strided<[1], offset: ?>>) outs(%alloca_2 : memref<f32>) {
      ^bb0(%in: f32, %out: f32):
      ...
      affine.store %6, %arg6[%arg7] : memref<?xf32>
      %subview_4 = memref.subview %arg0[%arg7, 0] [1, %c64] [1, 1] : memref<?x64xf32> to memref<?xf32, strided<[1], offset: ?>>
      %subview_5 = memref.subview %arg5[%arg7] [1] [1] : memref<?xf32> to memref<f32, strided<[], offset: ?>>
      %subview_6 = memref.subview %arg6[%arg7] [1] [1] : memref<?xf32> to memref<f32, strided<[], offset: ?>>
      %subview_7 = memref.subview %arg1[0] [%c64] [1] : memref<?xf32> to memref<?xf32, strided<[1]>>
      %subview_8 = memref.subview %arg2[0] [%c64] [1] : memref<?xf32> to memref<?xf32, strided<[1]>>
      %subview_9 = memref.subview %arg4[%arg7, 0] [1, %c64] [1, 1] : memref<?x64xf32> to memref<?xf32, strided<[1], offset: ?>>
      linalg.generic {indexing_maps = [#map, #map1, #map1, #map, #map, #map], iterator_types = ["parallel"]} ins(%subview_4, %subview_5, %subview_6, %subview_7, %subview_8 : memref<?xf32, strided<[1], offset: ?>>, memref<f32, strided<[], offset: ?>>, memref<f32, strided<[], offset: ?>>, memref<?xf32, strided<[1]>>, memref<?xf32, strided<[1]>>) outs(%subview_9 : memref<?xf32, strided<[1], offset: ?>>) {
