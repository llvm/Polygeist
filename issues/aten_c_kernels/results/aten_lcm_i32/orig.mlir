  ...
  func.func @aten_lcm_i32(%arg0: memref<?xi32>, %arg1: memref<?xi32>, %arg2: memref<?xi32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 4096 {
      ...
      %6:2 = scf.while (%arg4 = %5, %arg5 = %2) : (i32, i32) -> (i32, i32) {
        %9 = arith.cmpi ne, %arg4, %c0_i32 : i32
        scf.condition(%9) %arg5, %arg4 : i32, i32
      } do {
      ^bb0(%arg4: i32, %arg5: i32):
        %9 = arith.remsi %arg4, %arg5 : i32
        scf.yield %9, %arg5 : i32, i32
      }
      %7 = arith.cmpi eq, %6#0, %c0_i32 : i32
      %8 = scf.if %7 -> (i32) {
        scf.yield %c0_i32 : i32
      } else {
        %9 = arith.divsi %2, %6#0 : i32
        %10 = arith.muli %9, %5 : i32
        scf.yield %10 : i32
      }
      affine.store %8, %arg2[%arg3] : memref<?xi32>
    }
    return
  }
}
