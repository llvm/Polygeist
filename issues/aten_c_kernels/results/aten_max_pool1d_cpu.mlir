  ...
  func.func @aten_max_pool1d_cpu(%arg0: memref<?xf32>, %arg1: memref<?xf32>, %arg2: memref<?xi32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 2 {
      affine.for %arg4 = 0 to 3 {
        %0:2 = affine.for %arg5 = #map(%arg4) to #map1(%arg4) iter_args(%arg6 = %c0_i32, %arg7 = %cst) -> (i32, f32) {
          %1 = arith.index_cast %arg5 : index to i32
          %2 = affine.load %arg0[%arg5 + %arg3 * 6] : memref<?xf32>
          %3 = arith.cmpf ogt, %2, %arg7 : f32
          %4 = arith.select %3, %1, %arg6 : i32
          %5 = arith.select %3, %2, %arg7 : f32
          affine.yield %4, %5 : i32, f32
        }
        affine.store %0#1, %arg1[%arg4 + %arg3 * 3] : memref<?xf32>
        affine.store %0#0, %arg2[%arg4 + %arg3 * 3] : memref<?xi32>
      }
    }
    return
  }
