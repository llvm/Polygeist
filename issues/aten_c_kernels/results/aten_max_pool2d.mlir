      ...
      affine.for %arg3 = 0 to 8 {
        affine.for %arg4 = 0 to 8 {
          affine.for %arg5 = 0 to 8 {
            affine.store %cst, %arg1[%arg2, %arg3, %arg4, %arg5] : memref<?x8x8x8xf32>
          }
        }
      }
    }
          ...
          affine.for %arg5 = 0 to 8 {
            affine.for %arg6 = 0 to 2 {
              affine.for %arg7 = 0 to 2 {
                %0 = affine.load %arg0[%arg2, %arg3, %arg6 + %arg4 * 2, %arg7 + %arg5 * 2] : memref<?x8x16x16xf32>
                %1 = affine.load %arg1[%arg2, %arg3, %arg4, %arg5] : memref<?x8x8x8xf32>
                %2 = arith.cmpf ogt, %0, %1 : f32
                %3 = arith.select %2, %0, %1 : f32
                affine.store %3, %arg1[%arg2, %arg3, %arg4, %arg5] : memref<?x8x8x8xf32>
              }
            }
          }
        }
