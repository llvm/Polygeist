  ...
  func.func @aten_mm(%arg0: memref<?x16xf64>, %arg1: memref<?x16xf64>, %arg2: memref<?x16xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 16 {
      affine.for %arg4 = 0 to 16 {
        affine.store %cst, %arg2[%arg3, %arg4] : memref<?x16xf64>
      }
    }
    affine.for %arg3 = 0 to 16 {
      affine.for %arg4 = 0 to 16 {
        affine.for %arg5 = 0 to 16 {
          %0 = affine.load %arg0[%arg3, %arg5] : memref<?x16xf64>
          %1 = affine.load %arg1[%arg5, %arg4] : memref<?x16xf64>
          %2 = arith.mulf %0, %1 : f64
          %3 = affine.load %arg2[%arg3, %arg4] : memref<?x16xf64>
          %4 = arith.addf %3, %2 : f64
          affine.store %4, %arg2[%arg3, %arg4] : memref<?x16xf64>
        }
      }
    }
    return
