  ...
  func.func @aten_outer(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?x24xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 32 {
      affine.for %arg4 = 0 to 24 {
        affine.store %cst, %arg2[%arg3, %arg4] : memref<?x24xf64>
      }
    }
    affine.for %arg3 = 0 to 32 {
      affine.for %arg4 = 0 to 24 {
        %0 = affine.load %arg0[%arg3] : memref<?xf64>
        %1 = affine.load %arg1[%arg4] : memref<?xf64>
        %2 = arith.mulf %0, %1 : f64
        %3 = affine.load %arg2[%arg3, %arg4] : memref<?x24xf64>
        %4 = arith.addf %3, %2 : f64
        affine.store %4, %arg2[%arg3, %arg4] : memref<?x24xf64>
      }
    }
    return
  }
