    ...
    %3 = affine.for %arg2 = 0 to 2 iter_args(%arg3 = %2) -> (tensor<?xf32>) {
      ...
      %7 = affine.for %arg4 = 0 to 8 iter_args(%arg5 = %arg3) -> (tensor<?xf32>) {
        ...
        %19 = affine.for %arg6 = 0 to 9 iter_args(%arg7 = %arg5) -> (tensor<?xf32>) {
          ...
          %22 = affine.apply #map1(%arg6)
          %23 = arith.cmpi sge, %22, %c0 : index
          %24 = arith.subi %c2_i32, %20 : i32
          %25 = arith.select %23, %24, %21 : i32
          %26 = arith.cmpi sge, %25, %c5_i32 : i32
          %27 = arith.subi %c8_i32, %25 : i32
          ...
          %31 = affine.for %arg8 = 0 to 10 iter_args(%arg9 = %arg7) -> (tensor<?xf32>) {
            ...
            %36 = arith.subi %c2_i32, %32 : i32
            %37 = arith.select %35, %36, %33 : i32
            %38 = arith.cmpi sge, %37, %c6_i32 : i32
            %39 = arith.subi %c10_i32, %37 : i32
