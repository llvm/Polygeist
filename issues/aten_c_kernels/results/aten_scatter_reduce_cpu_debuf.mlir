  ...
  func.func @aten_scatter_reduce_cpu(%arg0: memref<?x128xf32>, %arg1: memref<?x64xi32>, %arg2: memref<?x64xf32>, %arg3: i32) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg4 = 0 to 32 {
      affine.for %arg5 = 0 to 64 {
        %extracted = tensor.extract %1[%arg4, %arg5] : tensor<?x64xi32>
        %extracted_0 = tensor.extract %0[%arg4, %arg5] : tensor<?x64xf32>
        affine.if #set()[%2] {
          %3 = arith.index_cast %extracted : i32 to index
          %4 = memref.load %arg0[%arg4, %3] : memref<?x128xf32>
          %5 = arith.addf %4, %extracted_0 : f32
          memref.store %5, %arg0[%arg4, %3] : memref<?x128xf32>
        } else {
          affine.if #set1()[%2] {
            %3 = arith.index_cast %extracted : i32 to index
            %4 = memref.load %arg0[%arg4, %3] : memref<?x128xf32>
            %5 = arith.mulf %4, %extracted_0 : f32
            memref.store %5, %arg0[%arg4, %3] : memref<?x128xf32>
          } else {
            affine.if #set2()[%2] {
              %3 = arith.index_cast %extracted : i32 to index
              %4 = memref.load %arg0[%arg4, %3] : memref<?x128xf32>
              %5 = arith.cmpf ogt, %4, %extracted_0 : f32
              %6 = memref.load %arg0[%arg4, %3] : memref<?x128xf32>
              %7 = arith.select %5, %6, %extracted_0 : f32
              memref.store %7, %arg0[%arg4, %3] : memref<?x128xf32>
            } else {
              %3 = arith.index_cast %extracted : i32 to index
              %4 = memref.load %arg0[%arg4, %3] : memref<?x128xf32>
              %5 = arith.cmpf olt, %4, %extracted_0 : f32
              %6 = memref.load %arg0[%arg4, %3] : memref<?x128xf32>
              %7 = arith.select %5, %6, %extracted_0 : f32
              memref.store %7, %arg0[%arg4, %3] : memref<?x128xf32>
            }
