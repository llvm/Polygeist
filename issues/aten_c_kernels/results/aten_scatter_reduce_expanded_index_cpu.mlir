  ...
  func.func @aten_scatter_reduce_expanded_index_cpu(%arg0: memref<?x128xf32>, %arg1: memref<?x64xi32>, %arg2: memref<?x64xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    affine.for %arg3 = 0 to 32 {
      affine.for %arg4 = 0 to 64 {
        ...
        %2 = memref.load %arg0[%arg3, %1] : memref<?x128xf32>
        %3 = affine.load %arg2[%arg3, %arg4] : memref<?x64xf32>
        %4 = arith.cmpf ogt, %2, %3 : f32
        %5 = scf.if %4 -> (f32) {
          %6 = memref.load %arg0[%arg3, %1] : memref<?x128xf32>
          scf.yield %6 : f32
        } else {
          scf.yield %3 : f32
        }
        memref.store %5, %arg0[%arg3, %1] : memref<?x128xf32>
      }
    }
    return
  }
