      ...
      affine.for %arg7 = 0 to 16 {
        affine.for %arg8 = 0 to 4 {
          affine.for %arg9 = 0 to 8 {
            %0 = affine.load %arg0[%arg6, %arg7, 0, %arg8, %arg9] : memref<?x16x3x4x8xf32>
            %1 = affine.load %arg1[0, %arg8, %arg9] : memref<?x4x8xf32>
            %2 = arith.addf %0, %1 : f32
            %3 = arith.mulf %2, %arg2 : f32
            affine.store %3, %arg3[%arg6, %arg8, %arg7, %arg9] : memref<?x4x16x8xf32>
            %4 = affine.load %arg0[%arg6, %arg7, 1, %arg8, %arg9] : memref<?x16x3x4x8xf32>
            %5 = affine.load %arg1[1, %arg8, %arg9] : memref<?x4x8xf32>
            %6 = arith.addf %4, %5 : f32
            affine.store %6, %arg4[%arg6, %arg8, %arg7, %arg9] : memref<?x4x16x8xf32>
            %7 = affine.load %arg0[%arg6, %arg7, 2, %arg8, %arg9] : memref<?x16x3x4x8xf32>
            %8 = affine.load %arg1[2, %arg8, %arg9] : memref<?x4x8xf32>
            %9 = arith.addf %7, %8 : f32
            affine.store %9, %arg5[%arg6, %arg8, %arg7, %arg9] : memref<?x4x16x8xf32>
          }
        }
      }
    }
