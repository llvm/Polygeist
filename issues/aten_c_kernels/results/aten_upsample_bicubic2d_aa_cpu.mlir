    ...
    affine.for %arg2 = 0 to 2 {
      affine.for %arg3 = 0 to 7 {
        ...
        affine.for %arg4 = 0 to 8 {
          ...
          %10 = affine.for %arg5 = 0 to 4 iter_args(%arg6 = %cst_5) -> (f32) {
            %13 = arith.index_cast %arg5 : index to i32
            %14 = arith.sitofp %13 : i32 to f32
            %15 = arith.subf %4, %14 : f32
            %16 = arith.cmpf olt, %15, %cst_5 : f32
            %17 = scf.if %16 -> (f32) {
              %22 = arith.negf %15 : f32
              scf.yield %22 : f32
            } else {
              scf.yield %15 : f32
            }
            %18 = arith.cmpf olt, %17, %cst_4 : f32
            %19 = arith.cmpf olt, %17, %cst_7 : f32
            %20 = scf.if %18 -> (f32) {
              %22 = scf.if %19 -> (f32) {
                %23 = arith.mulf %17, %cst_3 : f32
                ...
                %23 = arith.mulf %17, %cst_1 : f32
                %24 = arith.addf %23, %cst_2 : f32
                %25 = arith.mulf %24, %17 : f32
                %26 = arith.subf %25, %cst_8 : f32
                %27 = arith.mulf %26, %17 : f32
                %28 = arith.addf %27, %cst_4 : f32
                scf.yield %28 : f32
              }
              scf.yield %22 : f32
            } else {
            ...
            %21 = affine.for %arg7 = 0 to 5 iter_args(%arg8 = %arg6) -> (f32) {
              %22 = arith.index_cast %arg7 : index to i32
              %23 = arith.sitofp %22 : i32 to f32
              %24 = arith.subf %9, %23 : f32
              %25 = arith.cmpf olt, %24, %cst_5 : f32
              %26 = scf.if %25 -> (f32) {
                %32 = arith.negf %24 : f32
                scf.yield %32 : f32
              } else {
                scf.yield %24 : f32
              }
              %27 = arith.cmpf olt, %26, %cst_4 : f32
              %28 = arith.cmpf olt, %26, %cst_7 : f32
              %29 = scf.if %27 -> (f32) {
                %32 = scf.if %28 -> (f32) {
                  %33 = arith.mulf %26, %cst_3 : f32
                  %34 = arith.subf %33, %cst_2 : f32
                  %35 = arith.mulf %34, %26 : f32
                  %36 = arith.mulf %35, %26 : f32
                  %37 = arith.addf %36, %cst_7 : f32
                  scf.yield %37 : f32
                } else {
                  %33 = arith.mulf %26, %cst_1 : f32
                  %34 = arith.addf %33, %cst_2 : f32
                  %35 = arith.mulf %34, %26 : f32
                  %36 = arith.subf %35, %cst_8 : f32
                  %37 = arith.mulf %36, %26 : f32
                  %38 = arith.addf %37, %cst_4 : f32
                  scf.yield %38 : f32
                }
                scf.yield %32 : f32
              } else {
          ...
          %11 = affine.for %arg5 = 0 to 4 iter_args(%arg6 = %cst_5) -> (f32) {
            %13 = arith.index_cast %arg5 : index to i32
            %14 = arith.sitofp %13 : i32 to f32
            %15 = arith.subf %4, %14 : f32
            %16 = arith.cmpf olt, %15, %cst_5 : f32
            ...
            %21 = affine.for %arg7 = 0 to 5 iter_args(%arg8 = %arg6) -> (f32) {
              ...
              %29 = scf.if %27 -> (f32) {
                %34 = scf.if %28 -> (f32) {
                  %35 = arith.mulf %26, %cst_3 : f32
                  %36 = arith.subf %35, %cst_2 : f32
                  %37 = arith.mulf %36, %26 : f32
                  %38 = arith.mulf %37, %26 : f32
                  %39 = arith.addf %38, %cst_7 : f32
                  scf.yield %39 : f32
                } else {
                  %35 = arith.mulf %26, %cst_1 : f32
                  %36 = arith.addf %35, %cst_2 : f32
                  %37 = arith.mulf %36, %26 : f32
                  %38 = arith.subf %37, %cst_8 : f32
                  %39 = arith.mulf %38, %26 : f32
                  %40 = arith.addf %39, %cst_4 : f32
                  scf.yield %40 : f32
                }
                scf.yield %34 : f32
              } else {
              ...
              %30 = affine.load %arg0[%arg7 + %arg2 * 20 + %arg5 * 5] : memref<?xf32>
              %31 = arith.mulf %30, %20 : f32
