    ...
    affine.for %arg2 = 0 to 2 {
      affine.for %arg3 = 0 to 7 {
        ...
        affine.for %arg4 = 0 to 8 {
          ...
          %10 = affine.for %arg5 = 0 to 4 iter_args(%arg6 = %cst_1) -> (f32) {
            %13 = arith.index_cast %arg5 : index to i32
            %14 = arith.sitofp %13 : i32 to f32
            %15 = arith.subf %4, %14 : f32
            %16 = arith.cmpf olt, %15, %cst_1 : f32
            %17 = scf.if %16 -> (f32) {
              %21 = arith.negf %15 : f32
              scf.yield %21 : f32
            } else {
              scf.yield %15 : f32
            }
            ...
            %19 = scf.if %18 -> (f32) {
              %21 = arith.subf %cst_3, %17 : f32
              scf.yield %21 : f32
            } else {
              scf.yield %cst_1 : f32
            }
            %20 = affine.for %arg7 = 0 to 5 iter_args(%arg8 = %arg6) -> (f32) {
              %21 = arith.index_cast %arg7 : index to i32
              %22 = arith.sitofp %21 : i32 to f32
              %23 = arith.subf %9, %22 : f32
              %24 = arith.cmpf olt, %23, %cst_1 : f32
              %25 = scf.if %24 -> (f32) {
                %30 = arith.negf %23 : f32
                scf.yield %30 : f32
              } else {
                scf.yield %23 : f32
              }
              %26 = arith.cmpf olt, %25, %cst_3 : f32
              %27 = scf.if %26 -> (f32) {
                %30 = arith.subf %cst_3, %25 : f32
                scf.yield %30 : f32
              } else {
                scf.yield %cst_1 : f32
              }
              %28 = arith.mulf %19, %27 : f32
              %29 = arith.addf %arg8, %28 : f32
              affine.yield %29 : f32
            }
            affine.yield %20 : f32
          }
          %11 = affine.for %arg5 = 0 to 4 iter_args(%arg6 = %cst_1) -> (f32) {
            %13 = arith.index_cast %arg5 : index to i32
            %14 = arith.sitofp %13 : i32 to f32
            %15 = arith.subf %4, %14 : f32
            %16 = arith.cmpf olt, %15, %cst_1 : f32
            ...
            %20 = affine.for %arg7 = 0 to 5 iter_args(%arg8 = %arg6) -> (f32) {
              ...
              %26 = arith.cmpf olt, %25, %cst_3 : f32
              %27 = scf.if %26 -> (f32) {
                %32 = arith.subf %cst_3, %25 : f32
                scf.yield %32 : f32
              } else {
                scf.yield %cst_1 : f32
              }
              %28 = affine.load %arg0[%arg7 + %arg2 * 20 + %arg5 * 5] : memref<?xf32>
              %29 = arith.mulf %28, %19 : f32
              %30 = arith.mulf %29, %27 : f32
