module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @aten_upsample_lanczos2d_aa_backward_cpu(%arg0: memref<?xf32>, %arg1: memref<?xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg2 = 0 to 40 {
      affine.store %cst_6, %arg1[%arg2] : memref<?xf32>
    }
    affine.for %arg2 = 0 to 2 {
      affine.for %arg3 = 0 to 7 {
        ...
        affine.for %arg4 = 0 to 8 {
          ...
          %10 = affine.for %arg5 = 0 to 4 iter_args(%arg6 = %cst_6) -> (f32) {
            %11 = arith.index_cast %arg5 : index to i32
            %12 = arith.sitofp %11 : i32 to f32
            %13 = arith.subf %4, %12 : f32
            %14 = arith.cmpf olt, %13, %cst_6 : f32
            %15 = scf.if %14 -> (f32) {
              %23 = arith.negf %13 : f32
              scf.yield %23 : f32
            } else {
              scf.yield %13 : f32
            }
            %16 = arith.cmpf olt, %15, %cst_3 : f32
            %17 = arith.cmpf oeq, %15, %cst_6 : f32
            %18 = arith.mulf %15, %cst_2 : f32
            %19 = arith.divf %18, %cst_3 : f32
            %20 = arith.mulf %15, %cst_1 : f32
            %21 = arith.mulf %20, %15 : f32
            %22 = affine.for %arg7 = 0 to 5 iter_args(%arg8 = %arg6) -> (f32) {
              %23 = arith.index_cast %arg7 : index to i32
              %24 = arith.sitofp %23 : i32 to f32
              %25 = arith.subf %9, %24 : f32
              %26 = arith.cmpf olt, %25, %cst_6 : f32
              %27 = scf.if %26 -> (f32) {
                %34 = arith.negf %25 : f32
                scf.yield %34 : f32
              } else {
                scf.yield %25 : f32
              }
              %28 = scf.if %16 -> (f32) {
                %34 = scf.if %17 -> (f32) {
                  ...
                  %35 = func.call @sinf(%18) : (f32) -> f32
                  %36 = func.call @sinf(%19) : (f32) -> f32
                  %37 = arith.mulf %35, %36 : f32
                  %38 = arith.divf %37, %21 : f32
                  scf.yield %38 : f32
                }
                scf.yield %34 : f32
              } else {
              ...
              %29 = arith.cmpf olt, %27, %cst_3 : f32
              %30 = arith.cmpf oeq, %27, %cst_6 : f32
              %31 = scf.if %29 -> (f32) {
                %34 = scf.if %30 -> (f32) {
                  scf.yield %cst_5 : f32
                } else {
                  %35 = arith.mulf %27, %cst_2 : f32
                  %36 = func.call @sinf(%35) : (f32) -> f32
                  %37 = arith.divf %35, %cst_3 : f32
                  %38 = func.call @sinf(%37) : (f32) -> f32
                  %39 = arith.mulf %36, %38 : f32
                  %40 = arith.mulf %27, %cst_1 : f32
                  %41 = arith.mulf %40, %27 : f32
          ...
          affine.for %arg5 = 0 to 4 {
            ...
            affine.for %arg6 = 0 to 5 {
              ...
              %24 = arith.subf %9, %23 : f32
              %25 = arith.cmpf olt, %24, %cst_6 : f32
              %26 = scf.if %25 -> (f32) {
                %37 = arith.negf %24 : f32
                scf.yield %37 : f32
              } else {
                scf.yield %24 : f32
              }
              %27 = scf.if %16 -> (f32) {
                %37 = scf.if %17 -> (f32) {
                  ...
                  %38 = func.call @sinf(%18) : (f32) -> f32
                  %39 = func.call @sinf(%19) : (f32) -> f32
                  %40 = arith.mulf %38, %39 : f32
                  %41 = arith.divf %40, %21 : f32
                  scf.yield %41 : f32
                }
                scf.yield %37 : f32
              } else {
              ...
              %28 = arith.cmpf olt, %26, %cst_3 : f32
              %29 = arith.cmpf oeq, %26, %cst_6 : f32
              %30 = scf.if %28 -> (f32) {
                %37 = scf.if %29 -> (f32) {
                  scf.yield %cst_5 : f32
                } else {
                  %38 = arith.mulf %26, %cst_2 : f32
                  %39 = func.call @sinf(%38) : (f32) -> f32
                  %40 = arith.divf %38, %cst_3 : f32
                  %41 = func.call @sinf(%40) : (f32) -> f32
                  %42 = arith.mulf %39, %41 : f32
                  %43 = arith.mulf %26, %cst_1 : f32
                  %44 = arith.mulf %43, %26 : f32
                  %45 = arith.divf %42, %44 : f32
                  scf.yield %45 : f32
                }
                scf.yield %37 : f32
              } else {
              ...
              %31 = affine.load %arg0[%arg4 + %arg2 * 56 + %arg3 * 8] : memref<?xf32>
              %32 = arith.mulf %31, %27 : f32
              %33 = arith.mulf %32, %30 : f32
              %34 = arith.divf %33, %10 : f32
              %35 = affine.load %arg1[%arg6 + %arg2 * 20 + %arg5 * 5] : memref<?xf32>
              %36 = arith.addf %35, %34 : f32
              affine.store %36, %arg1[%arg6 + %arg2 * 20 + %arg5 * 5] : memref<?xf32>
            }
          }
        }
      }
