    ...
    %3 = affine.for %arg2 = 0 to 2 iter_args(%arg3 = %2) -> (tensor<?xf32>) {
      ...
      %7 = affine.for %arg4 = 0 to 7 iter_args(%arg5 = %arg3) -> (tensor<?xf32>) {
        ...
        %15 = affine.for %arg6 = 0 to 8 iter_args(%arg7 = %arg5) -> (tensor<?xf32>) {
          ...
          %23 = affine.apply #map1(%arg6, %arg2, %arg4)
          %extracted = tensor.extract %1[%23] : tensor<?xf32>
          %extracted_0 = tensor.extract %arg7[%22] : tensor<?xf32>
          %24 = arith.addf %extracted_0, %extracted : f32
          %inserted = tensor.insert %24 into %arg7[%22] : tensor<?xf32>
