  ...
  func.func @aten_upsample_nearest_exact1d_backward_cpu(%arg0: memref<?xf32>, %arg1: memref<?xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %3 = affine.for %arg2 = 0 to 2 iter_args(%arg3 = %2) -> (tensor<?xf32>) {
      ...
      %7 = affine.for %arg4 = 0 to 7 iter_args(%arg5 = %arg3) -> (tensor<?xf32>) {
        ...
        %17 = affine.apply #map1(%arg4, %arg2)
        %extracted = tensor.extract %1[%17] : tensor<?xf32>
        %extracted_0 = tensor.extract %arg5[%16] : tensor<?xf32>
        %18 = arith.addf %extracted_0, %extracted : f32
        %inserted = tensor.insert %18 into %arg5[%16] : tensor<?xf32>
