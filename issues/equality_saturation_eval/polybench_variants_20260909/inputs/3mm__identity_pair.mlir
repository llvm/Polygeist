...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<?x?xf64>, %arg6: memref<?x?xf64>, %arg7: memref<?x?xf64>, %arg8: memref<?x?xf64>, %arg9: memref<?x?xf64>, %arg10: memref<?x?xf64>, %arg11: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %eqsat_variant_zero_19 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_19 = arith.constant 1.000000e+00 : f64
    %12 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel"], library_call = ""} outs(%0 : tensor<?x?xf64>) {
    ^bb0(%out: f64):
      %eqsat_variant_v0 = arith.addf %cst, %eqsat_variant_zero_19 : f64
      %eqsat_variant_v1 = arith.mulf %eqsat_variant_one_19, %eqsat_variant_v0 : f64
    ...
    %eqsat_variant_zero_26 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_26 = arith.constant 1.000000e+00 : f64
    %13 = linalg.generic {doc = "", indexing_maps = [#map1, #map2, #map3], iterator_types = ["parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice, %extracted_slice_0 : tensor<?x?xf64>, tensor<?x?xf64>) outs(%extracted_slice_1 : tensor<?x?xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %21 = arith.mulf %in, %in_8 : f64
      %22 = arith.addf %out, %21 : f64
      %eqsat_variant_v2 = arith.addf %22, %eqsat_variant_zero_26 : f64
      %eqsat_variant_v3 = arith.mulf %eqsat_variant_one_26, %eqsat_variant_v2 : f64
    ...
    %eqsat_variant_zero_35 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_35 = arith.constant 1.000000e+00 : f64
    %15 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel"], library_call = ""} outs(%3 : tensor<?x?xf64>) {
    ^bb0(%out: f64):
      %eqsat_variant_v4 = arith.addf %cst, %eqsat_variant_zero_35 : f64
      %eqsat_variant_v5 = arith.mulf %eqsat_variant_one_35, %eqsat_variant_v4 : f64
    ...
    %eqsat_variant_zero_42 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_42 = arith.constant 1.000000e+00 : f64
    %16 = linalg.generic {doc = "", indexing_maps = [#map1, #map2, #map3], iterator_types = ["parallel", "parallel", "reduction"], library_call = ""} ins(%extracted_slice_2, %extracted_slice_3 : tensor<?x?xf64>, tensor<?x?xf64>) outs(%extracted_slice_4 : tensor<?x?xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %21 = arith.mulf %in, %in_8 : f64
      %22 = arith.addf %out, %21 : f64
      %eqsat_variant_v6 = arith.addf %22, %eqsat_variant_zero_42 : f64
      %eqsat_variant_v7 = arith.mulf %eqsat_variant_one_42, %eqsat_variant_v6 : f64
    ...
    %eqsat_variant_zero_51 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_51 = arith.constant 1.000000e+00 : f64
    %18 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel", "parallel"], library_call = ""} outs(%6 : tensor<?x?xf64>) {
    ^bb0(%out: f64):
      %eqsat_variant_v8 = arith.addf %cst, %eqsat_variant_zero_51 : f64
      %eqsat_variant_v9 = arith.mulf %eqsat_variant_one_51, %eqsat_variant_v8 : f64
      linalg.yield %eqsat_variant_v9 : f64
    } -> tensor<?x?xf64>
    %extracted_slice_6 = tensor.extract_slice %18[0, 0] [%11, %10] [1, 1] : tensor<?x?xf64> to tensor<?x?xf64>
    %eqsat_variant_zero_56 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_56 = arith.constant 1.000000e+00 : f64
    %19 = linalg.generic {doc = "", indexing_maps = [#map1, #map2, #map3], iterator_types = ["parallel", "parallel", "reduction"], library_call = ""} ins(%13, %16 : tensor<?x?xf64>, tensor<?x?xf64>) outs(%extracted_slice_6 : tensor<?x?xf64>) {
    ^bb0(%in: f64, %in_8: f64, %out: f64):
      %21 = arith.mulf %in, %in_8 : f64
      %22 = arith.addf %out, %21 : f64
      %eqsat_variant_v10 = arith.addf %22, %eqsat_variant_zero_56 : f64
      %eqsat_variant_v11 = arith.mulf %eqsat_variant_one_56, %eqsat_variant_v10 : f64
