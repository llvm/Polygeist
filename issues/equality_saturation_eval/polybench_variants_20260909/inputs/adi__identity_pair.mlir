...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<?x?xf64>, %arg3: memref<?x?xf64>, %arg4: memref<?x?xf64>, %arg5: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %36:4 = affine.for %arg6 = 1 to #map1()[%19] iter_args(%arg7 = %1, %arg8 = %2, %arg9 = %3, %arg10 = %0) -> (tensor<?x?xf64>, tensor<?x?xf64>, tensor<?x?xf64>, tensor<?x?xf64>) {
      ...
      %eqsat_variant_zero_55 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_55 = arith.constant 1.000000e+00 : f64
      %41 = linalg.generic {doc = "", indexing_maps = [#map2], iterator_types = ["parallel"], library_call = ""} outs(%extracted_slice : tensor<?xf64>) {
      ^bb0(%out: f64):
        %eqsat_variant_v0 = arith.addf %cst_1, %eqsat_variant_zero_55 : f64
        %eqsat_variant_v1 = arith.mulf %eqsat_variant_one_55, %eqsat_variant_v0 : f64
      ...
      %eqsat_variant_zero_61 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_61 = arith.constant 1.000000e+00 : f64
      %42 = linalg.generic {doc = "", indexing_maps = [#map2], iterator_types = ["parallel"], library_call = ""} outs(%extracted_slice_2 : tensor<?xf64>) {
      ^bb0(%out: f64):
        %eqsat_variant_v2 = arith.addf %cst, %eqsat_variant_zero_61 : f64
        %eqsat_variant_v3 = arith.mulf %eqsat_variant_one_61, %eqsat_variant_v2 : f64
      ...
      %eqsat_variant_zero_69 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_69 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%in: f64, %out: f64):
        %eqsat_variant_v4 = arith.addf %in, %eqsat_variant_zero_69 : f64
        %eqsat_variant_v5 = arith.mulf %eqsat_variant_one_69, %eqsat_variant_v4 : f64
      ...
      %eqsat_variant_zero_83 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_83 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%out: f64):
        %eqsat_variant_v6 = arith.addf %cst_1, %eqsat_variant_zero_83 : f64
        %eqsat_variant_v7 = arith.mulf %eqsat_variant_one_83, %eqsat_variant_v6 : f64
      ...
      %eqsat_variant_zero_114 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_114 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%in: f64, %in_32: f64, %in_33: f64, %out: f64):
        ...
        %eqsat_variant_v8 = arith.addf %90, %eqsat_variant_zero_114 : f64
        %eqsat_variant_v9 = arith.mulf %eqsat_variant_one_114, %eqsat_variant_v8 : f64
      ...
      %eqsat_variant_zero_127 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_127 = arith.constant 1.000000e+00 : f64
      %66 = linalg.generic {doc = "", indexing_maps = [#map2], iterator_types = ["parallel"], library_call = ""} outs(%extracted_slice_16 : tensor<?xf64>) {
      ^bb0(%out: f64):
        %eqsat_variant_v10 = arith.addf %cst_1, %eqsat_variant_zero_127 : f64
        %eqsat_variant_v11 = arith.mulf %eqsat_variant_one_127, %eqsat_variant_v10 : f64
      ...
      %eqsat_variant_zero_135 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_135 = arith.constant 1.000000e+00 : f64
      %69 = linalg.generic {doc = "", indexing_maps = [#map2], iterator_types = ["parallel"], library_call = ""} outs(%extracted_slice_18 : tensor<?xf64>) {
      ^bb0(%out: f64):
        %eqsat_variant_v12 = arith.addf %cst, %eqsat_variant_zero_135 : f64
        %eqsat_variant_v13 = arith.mulf %eqsat_variant_one_135, %eqsat_variant_v12 : f64
      ...
      %eqsat_variant_zero_144 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_144 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%in: f64, %out: f64):
        %eqsat_variant_v14 = arith.addf %in, %eqsat_variant_zero_144 : f64
        %eqsat_variant_v15 = arith.mulf %eqsat_variant_one_144, %eqsat_variant_v14 : f64
      ...
      %eqsat_variant_zero_158 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_158 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%out: f64):
        %eqsat_variant_v16 = arith.addf %cst_1, %eqsat_variant_zero_158 : f64
        %eqsat_variant_v17 = arith.mulf %eqsat_variant_one_158, %eqsat_variant_v16 : f64
      ...
      %eqsat_variant_zero_189 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_189 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%in: f64, %in_32: f64, %in_33: f64, %out: f64):
        %89 = arith.mulf %in, %in_32 : f64
        %90 = arith.addf %89, %in_33 : f64
        %eqsat_variant_v18 = arith.addf %90, %eqsat_variant_zero_189 : f64
        %eqsat_variant_v19 = arith.mulf %eqsat_variant_one_189, %eqsat_variant_v18 : f64
