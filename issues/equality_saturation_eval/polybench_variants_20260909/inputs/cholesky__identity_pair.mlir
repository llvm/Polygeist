  ...
  func.func @kernel_cholesky(%arg0: i32, %arg1: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %3 = affine.for %arg2 = 0 to %1 iter_args(%arg3 = %0) -> (tensor<?x?xf64>) {
      ...
      %6 = affine.for %arg4 = 0 to #map(%arg2) iter_args(%arg5 = %arg3) -> (tensor<?x?xf64>) {
        ...
        %eqsat_variant_zero_14 = arith.constant 0.000000e+00 : f64
        %eqsat_variant_one_14 = arith.constant 1.000000e+00 : f64
        ...
        ^bb0(%in: f64, %in_8: f64, %out: f64):
          ...
          %eqsat_variant_v0 = arith.addf %15, %eqsat_variant_zero_14 : f64
          %eqsat_variant_v1 = arith.mulf %eqsat_variant_one_14, %eqsat_variant_v0 : f64
      ...
      %eqsat_variant_zero_32 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_32 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%in: f64, %out: f64):
        ...
        %eqsat_variant_v2 = arith.addf %13, %eqsat_variant_zero_32 : f64
        %eqsat_variant_v3 = arith.mulf %eqsat_variant_one_32, %eqsat_variant_v2 : f64
