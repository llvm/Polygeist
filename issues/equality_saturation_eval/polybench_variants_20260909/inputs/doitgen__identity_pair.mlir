  ...
  func.func @kernel_doitgen(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x?x?xf64>, %arg4: memref<?x?xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %6:2 = affine.for %arg6 = 0 to %5 iter_args(%arg7 = %2, %arg8 = %0) -> (tensor<?xf64>, tensor<?x?x?xf64>) {
      %9:2 = affine.for %arg9 = 0 to %3 iter_args(%arg10 = %arg7, %arg11 = %arg8) -> (tensor<?xf64>, tensor<?x?x?xf64>) {
        ...
        %10 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel"], library_call = ""} outs(%arg10 : tensor<?xf64>) {
        ^bb0(%out: f64):
          %eqsat_variant_v0 = arith.addf %cst, %eqsat_variant_zero_15 : f64
        ...
        %eqsat_variant_zero_22 = arith.constant 0.000000e+00 : f64
        %eqsat_variant_one_22 = arith.constant 1.000000e+00 : f64
        %11 = linalg.generic {doc = "", indexing_maps = [#map1, #map2, #map3], iterator_types = ["parallel", "reduction"], library_call = ""} ins(%extracted_slice, %extracted_slice_0 : tensor<?xf64>, tensor<?x?xf64>) outs(%extracted_slice_1 : tensor<?xf64>) {
        ^bb0(%in: f64, %in_4: f64, %out: f64):
          %13 = arith.mulf %in, %in_4 : f64
          %14 = arith.addf %out, %13 : f64
          %eqsat_variant_v2 = arith.addf %14, %eqsat_variant_zero_22 : f64
          %eqsat_variant_v3 = arith.mulf %eqsat_variant_one_22, %eqsat_variant_v2 : f64
        ...
        ^bb0(%in: f64, %out: f64):
          %eqsat_variant_v4 = arith.addf %in, %eqsat_variant_zero_30 : f64
