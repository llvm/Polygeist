...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_gesummv(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<?x?xf64>, %arg4: memref<?x?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %eqsat_variant_zero_17 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_17 = arith.constant 1.000000e+00 : f64
    %7 = linalg.generic {doc = "", indexing_maps = [#map], iterator_types = ["parallel"], library_call = ""} outs(%4 : tensor<?xf64>) {
    ^bb0(%out: f64):
      %eqsat_variant_v2 = arith.addf %cst, %eqsat_variant_zero_17 : f64
      %eqsat_variant_v3 = arith.mulf %eqsat_variant_one_17, %eqsat_variant_v2 : f64
    ...
    %eqsat_variant_zero_24 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_24 = arith.constant 1.000000e+00 : f64
    ...
    ^bb0(%in: f64, %in_6: f64, %out: f64):
      ...
      %eqsat_variant_v4 = arith.addf %14, %eqsat_variant_zero_24 : f64
      %eqsat_variant_v5 = arith.mulf %eqsat_variant_one_24, %eqsat_variant_v4 : f64
    ...
    %eqsat_variant_zero_36 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_36 = arith.constant 1.000000e+00 : f64
    %10 = linalg.generic {doc = "", indexing_maps = [#map1, #map2, #map3], iterator_types = ["parallel", "reduction"], library_call = ""} ins(%extracted_slice_2, %extracted_slice_3 : tensor<?x?xf64>, tensor<?xf64>) outs(%extracted_slice_4 : tensor<?xf64>) {
    ^bb0(%in: f64, %in_6: f64, %out: f64):
      %13 = arith.mulf %in, %in_6 : f64
      %14 = arith.addf %13, %out : f64
      %eqsat_variant_v6 = arith.addf %14, %eqsat_variant_zero_36 : f64
      %eqsat_variant_v7 = arith.mulf %eqsat_variant_one_36, %eqsat_variant_v6 : f64
      linalg.yield %eqsat_variant_v7 : f64
    } -> tensor<?xf64>
    %inserted_slice_5 = tensor.insert_slice %10 into %7[0] [%5] [1] : tensor<?xf64> into tensor<?xf64>
    %eqsat_variant_zero_43 = arith.constant 0.000000e+00 : f64
    %eqsat_variant_one_43 = arith.constant 1.000000e+00 : f64
    %11 = linalg.generic {doc = "", indexing_maps = [#map, #map], iterator_types = ["parallel"], library_call = ""} ins(%inserted_slice : tensor<?xf64>) outs(%inserted_slice_5 : tensor<?xf64>) {
    ^bb0(%in: f64, %out: f64):
      %13 = arith.mulf %arg1, %in : f64
      %14 = arith.mulf %arg2, %out : f64
      %15 = arith.addf %13, %14 : f64
      %eqsat_variant_v8 = arith.addf %15, %eqsat_variant_zero_43 : f64
      %eqsat_variant_v9 = arith.mulf %eqsat_variant_one_43, %eqsat_variant_v8 : f64
