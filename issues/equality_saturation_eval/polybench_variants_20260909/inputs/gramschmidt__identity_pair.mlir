  ...
  func.func @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<?x?xf64>, %arg3: memref<?x?xf64>, %arg4: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %7:3 = affine.for %arg5 = 0 to %5 iter_args(%arg6 = %4, %arg7 = %3, %arg8 = %2) -> (tensor<?x?xf64>, tensor<?x?xf64>, tensor<?x?xf64>) {
      ...
      ^bb0(%in: f64, %out: f64):
        ...
        %eqsat_variant_v0 = arith.addf %19, %eqsat_variant_zero_21 : f64
      ...
      ^bb0(%in: f64, %in_9: f64, %out: f64):
        ...
        %eqsat_variant_v2 = arith.addf %18, %eqsat_variant_zero_33 : f64
        %eqsat_variant_v3 = arith.mulf %eqsat_variant_one_33, %eqsat_variant_v2 : f64
      ...
      %eqsat_variant_zero_40 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_40 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%out: f64):
        ...
        %eqsat_variant_v4 = arith.addf %21, %eqsat_variant_zero_40 : f64
        %eqsat_variant_v5 = arith.mulf %eqsat_variant_one_40, %eqsat_variant_v4 : f64
        linalg.yield %eqsat_variant_v5 : f64
      } -> tensor<?xf64>
      %extracted_slice_5 = tensor.extract_slice %1[0, 0] [%6, %5] [1, 1] : tensor<?x?xf64> to tensor<?x?xf64>
      %eqsat_variant_zero_49 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_49 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%in: f64, %in_9: f64, %out: f64):
        ...
        %19 = arith.addf %out, %18 : f64
        %eqsat_variant_v6 = arith.addf %19, %eqsat_variant_zero_49 : f64
        %eqsat_variant_v7 = arith.mulf %eqsat_variant_one_49, %eqsat_variant_v6 : f64
      ...
      %eqsat_variant_zero_57 = arith.constant 0.000000e+00 : f64
      %eqsat_variant_one_57 = arith.constant 1.000000e+00 : f64
      ...
      ^bb0(%in: f64, %in_9: f64, %out: f64):
        ...
        %eqsat_variant_v8 = arith.addf %19, %eqsat_variant_zero_57 : f64
        %eqsat_variant_v9 = arith.mulf %eqsat_variant_one_57, %eqsat_variant_v8 : f64
