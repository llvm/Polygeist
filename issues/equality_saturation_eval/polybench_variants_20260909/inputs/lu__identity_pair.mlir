    ...
    %3 = affine.for %arg2 = 0 to %1 iter_args(%arg3 = %0) -> (tensor<?x?xf64>) {
      ...
      %6 = affine.for %arg4 = 0 to #map(%arg2) iter_args(%arg5 = %arg3) -> (tensor<?x?xf64>) {
        ...
        ^bb0(%in: f64, %in_7: f64, %out: f64):
          ...
          %eqsat_variant_v0 = arith.addf %14, %eqsat_variant_zero_17 : f64
          %eqsat_variant_v1 = arith.mulf %eqsat_variant_one_17, %eqsat_variant_v0 : f64
      ...
      ^bb0(%in: f64, %in_2: f64, %out: f64):
        ...
        %eqsat_variant_v2 = arith.addf %12, %eqsat_variant_zero_36 : f64
        %eqsat_variant_v3 = arith.mulf %eqsat_variant_one_36, %eqsat_variant_v2 : f64
