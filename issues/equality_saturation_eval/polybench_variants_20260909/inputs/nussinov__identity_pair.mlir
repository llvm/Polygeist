  ...
  func.func @kernel_nussinov(%arg0: i32, %arg1: memref<?xi8>, %arg2: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = #map(%arg3)[%0] to %0 {
        ...
        %eqsat_variant_zero_62 = arith.constant 0.000000e+00 : f64
        %eqsat_variant_one_62 = arith.constant 1.000000e+00 : f64
        ...
        ^bb0(%in: f64, %in_0: f64, %out: f64):
          ...
          %eqsat_variant_v0 = arith.addf %13, %eqsat_variant_zero_62 : f64
          %eqsat_variant_v1 = arith.mulf %eqsat_variant_one_62, %eqsat_variant_v0 : f64
