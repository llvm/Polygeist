...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_app_ex35p_hcurl_3d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>, %arg8: memref<?xf64>, %arg9: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %1 = polygeist.submap(%arg8, %c2, %c4, %c4, %c5, %c3) {map = #map1} : (memref<?xf64>, index, index, index, index, index) -> memref<?x?x?x?x?xf64>
    ...
    %21 = polygeist.submap(%arg8, %c2, %c4, %c3, %c5, %c4) {map = #map9} : (memref<?xf64>, index, index, index, index, index) -> memref<?x?x?x?x?xf64>
    ...
    %25 = polygeist.submap(%arg8, %c2, %c4, %c3, %c5, %c4) {map = #map9} : (memref<?xf64>, index, index, index, index, index) -> memref<?x?x?x?x?xf64>
    ...
    %45 = polygeist.submap(%arg8, %c2, %c3, %c4, %c5, %c4) {map = #map12} : (memref<?xf64>, index, index, index, index, index) -> memref<?x?x?x?x?xf64>
    ...
    %49 = polygeist.submap(%arg8, %c2, %c3, %c4, %c5, %c4) {map = #map12} : (memref<?xf64>, index, index, index, index, index) -> memref<?x?x?x?x?xf64>
    ...
    ^bb0(%in: f64, %in_35: f64, %in_36: f64, %in_37: f64, %in_38: f64, %in_39: f64, %in_40: f64, %in_41: f64, %in_42: f64, %in_43: f64, %out: f64):
      %242 = arith.subf %in_35, %in_36 : f64
      %243 = arith.mulf %in, %242 : f64
      %244 = arith.subf %in_38, %in_39 : f64
      %245 = arith.mulf %in_37, %244 : f64
      %246 = arith.addf %243, %245 : f64
      %247 = arith.subf %in_41, %in_42 : f64
      %248 = arith.mulf %in_40, %247 : f64
      %249 = arith.addf %246, %248 : f64
      %250 = arith.mulf %249, %in_43 : f64
      %251 = arith.addf %out, %250 : f64
      linalg.yield %251 : f64
    }
    ...
    %190 = polygeist.submap(%arg9, %c2, %c4, %c4, %c3) {map = #map24} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %193 = polygeist.submap(%arg9, %c2, %c4, %c3, %c4) {map = #map25} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %196 = polygeist.submap(%arg9, %c2, %c3, %c4, %c4) {map = #map26} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %197 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5) {map = #map27} : (memref<2x3x5x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} outs(%197 : memref<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %198 = polygeist.submap(%arg1, %c2, %c5, %c5, %c5, %c4, %c4, %c3) {map = #map28} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %199 = polygeist.submap(%arg1, %c2, %c5, %c5, %c5, %c4, %c4, %c3) {map = #map29} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %200 = polygeist.submap(%arg8, %c2, %c5, %c5, %c5, %c4, %c4, %c3) {map = #map30} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %201 = polygeist.submap(%arg0, %c2, %c5, %c5, %c5, %c4, %c4, %c3) {map = #map31} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %202 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5, %c4, %c4, %c3) {map = #map32} : (memref<2x3x5x5x5xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map33, #map33, #map33, #map33, #map33], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%198, %199, %200, %201 : memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>) outs(%202 : memref<?x?x?x?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_35: f64, %in_36: f64, %in_37: f64, %out: f64):
      %242 = arith.mulf %in_36, %in_37 : f64
      %243 = arith.mulf %242, %in_35 : f64
      %244 = arith.mulf %243, %in : f64
      %245 = arith.addf %out, %244 : f64
      linalg.yield %245 : f64
    }
    %203 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5) {map = #map34} : (memref<2x3x5x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} outs(%203 : memref<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %204 = polygeist.submap(%arg1, %c2, %c5, %c5, %c5, %c4, %c3, %c4) {map = #map28} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %205 = polygeist.submap(%arg0, %c2, %c5, %c5, %c5, %c4, %c3, %c4) {map = #map35} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %206 = polygeist.submap(%arg8, %c2, %c5, %c5, %c5, %c4, %c3, %c4) {map = #map36} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %207 = polygeist.submap(%arg1, %c2, %c5, %c5, %c5, %c4, %c3, %c4) {map = #map37} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %208 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5, %c4, %c3, %c4) {map = #map38} : (memref<2x3x5x5x5xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map33, #map33, #map33, #map33, #map33], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%204, %205, %206, %207 : memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>) outs(%208 : memref<?x?x?x?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_35: f64, %in_36: f64, %in_37: f64, %out: f64):
      %242 = arith.mulf %in_36, %in_37 : f64
      %243 = arith.mulf %242, %in_35 : f64
      %244 = arith.mulf %243, %in : f64
    ...
    %209 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5) {map = #map39} : (memref<2x3x5x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} outs(%209 : memref<?x?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %210 = polygeist.submap(%arg0, %c2, %c5, %c5, %c5, %c3, %c4, %c4) {map = #map40} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %211 = polygeist.submap(%arg1, %c2, %c5, %c5, %c5, %c3, %c4, %c4) {map = #map29} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %212 = polygeist.submap(%arg8, %c2, %c5, %c5, %c5, %c3, %c4, %c4) {map = #map41} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %213 = polygeist.submap(%arg1, %c2, %c5, %c5, %c5, %c3, %c4, %c4) {map = #map37} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %214 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5, %c3, %c4, %c4) {map = #map42} : (memref<2x3x5x5x5xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map33, #map33, #map33, #map33, #map33], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%210, %211, %212, %213 : memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>) outs(%214 : memref<?x?x?x?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_35: f64, %in_36: f64, %in_37: f64, %out: f64):
      %242 = arith.mulf %in_36, %in_37 : f64
      %243 = arith.mulf %242, %in_35 : f64
      %244 = arith.mulf %243, %in : f64
    ...
    %215 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map43} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %216 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map44} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %217 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map45} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %218 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map44} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %219 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map46} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %220 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map47} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %221 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map45} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %222 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map47} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %223 = polygeist.submap(%arg7, %c2, %c5, %c5, %c5) {map = #map48} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %224 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5) {map = #map27} : (memref<2x3x5x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %225 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5) {map = #map34} : (memref<2x3x5x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %226 = polygeist.submap(%alloca_34, %c2, %c5, %c5, %c5) {map = #map39} : (memref<2x3x5x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map, #map, #map, #map, #map, #map, #map, #map, #map, #map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%215, %216, %217, %218, %219, %220, %221, %222, %223 : memref<?x?x?x?xf64>, memref<?x?x?x?xf64>, memref<?x?x?x?xf64>, memref<?x?x?x?xf64>, memref<?x?x?x?xf64>, memref<?x?x?x?xf64>, memref<?x?x?x?xf64>, memref<?x?x?x?xf64>, memref<?x?x?x?xf64>) outs(%224, %225, %226 : memref<?x?x?x?xf64>, memref<?x?x?x?xf64>, memref<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_35: f64, %in_36: f64, %in_37: f64, %in_38: f64, %in_39: f64, %in_40: f64, %in_41: f64, %in_42: f64, %out: f64, %out_43: f64, %out_44: f64):
      %242 = arith.mulf %in, %out : f64
      %243 = arith.mulf %in_35, %out_43 : f64
      %244 = arith.addf %242, %243 : f64
      %245 = arith.mulf %in_36, %out_44 : f64
      %246 = arith.addf %244, %245 : f64
      %247 = arith.mulf %in_37, %out : f64
      %248 = arith.mulf %in_38, %out_43 : f64
      %249 = arith.addf %247, %248 : f64
      %250 = arith.mulf %in_39, %out_44 : f64
      %251 = arith.addf %249, %250 : f64
      %252 = arith.mulf %in_40, %out : f64
      %253 = arith.mulf %in_41, %out_43 : f64
      %254 = arith.addf %252, %253 : f64
      %255 = arith.mulf %in_42, %out_44 : f64
      %256 = arith.addf %254, %255 : f64
      linalg.yield %246, %251, %256 : f64, f64, f64
    }
    %227 = polygeist.submap(%arg3, %c2, %c4, %c4, %c3, %c5, %c5, %c5) {map = #map49} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %228 = polygeist.submap(%arg3, %c2, %c4, %c4, %c3, %c5, %c5, %c5) {map = #map50} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %229 = polygeist.submap(%alloca_34, %c2, %c4, %c4, %c3, %c5, %c5, %c5) {map = #map51} : (memref<2x3x5x5x5xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %230 = polygeist.submap(%arg2, %c2, %c4, %c4, %c3, %c5, %c5, %c5) {map = #map52} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %231 = polygeist.submap(%arg9, %c2, %c4, %c4, %c3) {map = #map24} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map33, #map33, #map33, #map33, #map53], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%227, %228, %229, %230 : memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>) outs(%231 : memref<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_35: f64, %in_36: f64, %in_37: f64, %out: f64):
      %242 = arith.mulf %in_36, %in_37 : f64
      %243 = arith.mulf %242, %in_35 : f64
      %244 = arith.mulf %243, %in : f64
    ...
    %232 = polygeist.submap(%arg3, %c2, %c4, %c3, %c4, %c5, %c5, %c5) {map = #map49} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %233 = polygeist.submap(%arg2, %c2, %c4, %c3, %c4, %c5, %c5, %c5) {map = #map50} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %234 = polygeist.submap(%alloca_34, %c2, %c4, %c3, %c4, %c5, %c5, %c5) {map = #map54} : (memref<2x3x5x5x5xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %235 = polygeist.submap(%arg3, %c2, %c4, %c3, %c4, %c5, %c5, %c5) {map = #map52} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %236 = polygeist.submap(%arg9, %c2, %c4, %c3, %c4) {map = #map25} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map33, #map33, #map33, #map33, #map53], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%232, %233, %234, %235 : memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>) outs(%236 : memref<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_35: f64, %in_36: f64, %in_37: f64, %out: f64):
      %242 = arith.mulf %in_36, %in_37 : f64
      %243 = arith.mulf %242, %in_35 : f64
      %244 = arith.mulf %243, %in : f64
    ...
    %237 = polygeist.submap(%arg2, %c2, %c3, %c4, %c4, %c5, %c5, %c5) {map = #map49} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %238 = polygeist.submap(%arg3, %c2, %c3, %c4, %c4, %c5, %c5, %c5) {map = #map50} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %239 = polygeist.submap(%alloca_34, %c2, %c3, %c4, %c4, %c5, %c5, %c5) {map = #map55} : (memref<2x3x5x5x5xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %240 = polygeist.submap(%arg3, %c2, %c3, %c4, %c4, %c5, %c5, %c5) {map = #map52} : (memref<?xf64>, index, index, index, index, index, index, index) -> memref<?x?x?x?x?x?x?xf64>
    %241 = polygeist.submap(%arg9, %c2, %c3, %c4, %c4) {map = #map26} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    linalg.generic {indexing_maps = [#map33, #map33, #map33, #map33, #map53], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%237, %238, %239, %240 : memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>, memref<?x?x?x?x?x?x?xf64>) outs(%241 : memref<?x?x?x?xf64>) {
    ^bb0(%in: f64, %in_35: f64, %in_36: f64, %in_37: f64, %out: f64):
      %242 = arith.mulf %in_36, %in_37 : f64
      %243 = arith.mulf %242, %in_35 : f64
      %244 = arith.mulf %243, %in : f64
