module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_app_grad_div_3d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>, %arg8: memref<?xf64>, %arg9: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
        ...
        affine.for %arg12 = 0 to 3 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 4 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %arg8[%arg11 * 12 + %arg14 + %arg12 * 4 + %arg10 * 108] : memref<?xf64>
              %2 = affine.load %arg4[%arg14 + %arg13 * 4] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_13[%arg10, %arg11, %arg12, %arg13] : memref<2x3x3x5xf64>
          }
        }
      }
    }
        ...
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 3 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_13[%arg10, %arg11, %arg14, %arg13] : memref<2x3x3x5xf64>
              %2 = affine.load %arg0[%arg14 + %arg12 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_10[%arg10, %arg11, %arg12, %arg13] : memref<2x3x5x5xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 3 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_10[%arg10, %arg14, %arg12, %arg13] : memref<2x3x5x5xf64>
              %2 = affine.load %arg0[%arg14 + %arg11 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_7[%arg10, %arg11, %arg12, %arg13] : memref<2x5x5x5xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 3 {
        affine.for %arg12 = 0 to 4 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 3 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %arg8[%arg11 * 12 + %arg14 + %arg12 * 3 + %arg10 * 108 + 36] : memref<?xf64>
              %2 = affine.load %arg0[%arg14 + %arg13 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_12[%arg10, %arg11, %arg12, %arg13] : memref<2x3x4x5xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 3 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 4 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_12[%arg10, %arg11, %arg14, %arg13] : memref<2x3x4x5xf64>
              %2 = affine.load %arg4[%arg14 + %arg12 * 4] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_9[%arg10, %arg11, %arg12, %arg13] : memref<2x3x5x5xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 3 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_9[%arg10, %arg14, %arg12, %arg13] : memref<2x3x5x5xf64>
              %2 = affine.load %arg0[%arg14 + %arg11 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_6[%arg10, %arg11, %arg12, %arg13] : memref<2x5x5x5xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 4 {
        affine.for %arg12 = 0 to 3 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 3 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %arg8[%arg11 * 9 + %arg14 + %arg12 * 3 + %arg10 * 108 + 72] : memref<?xf64>
              %2 = affine.load %arg0[%arg14 + %arg13 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_11[%arg10, %arg11, %arg12, %arg13] : memref<2x4x3x5xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 4 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 3 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_11[%arg10, %arg11, %arg14, %arg13] : memref<2x4x3x5xf64>
              %2 = affine.load %arg0[%arg14 + %arg12 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_8[%arg10, %arg11, %arg12, %arg13] : memref<2x4x5x5xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 4 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_8[%arg10, %arg14, %arg12, %arg13] : memref<2x4x5x5xf64>
              %2 = affine.load %arg4[%arg14 + %arg11 * 4] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_5[%arg10, %arg11, %arg12, %arg13] : memref<2x5x5x5xf64>
          }
        }
      }
    }
        ...
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 4 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %arg6[%arg10 * 125 + %arg14 + %arg11 * 25 + %arg12 * 5] : memref<?xf64>
              %2 = affine.load %alloca_7[%arg10, %arg11, %arg12, %arg14] : memref<2x5x5x5xf64>
              %3 = affine.load %alloca_6[%arg10, %arg11, %arg12, %arg14] : memref<2x5x5x5xf64>
              %4 = arith.addf %2, %3 : f64
              %5 = affine.load %alloca_5[%arg10, %arg11, %arg12, %arg14] : memref<2x5x5x5xf64>
              %6 = arith.addf %4, %5 : f64
              %7 = arith.mulf %1, %6 : f64
              %8 = affine.load %arg5[%arg14 + %arg13 * 5] : memref<?xf64>
              %9 = arith.mulf %7, %8 : f64
              %10 = arith.addf %arg15, %9 : f64
              affine.yield %10 : f64
            }
            affine.store %0, %alloca_4[%arg10, %arg11, %arg12, %arg13] : memref<2x5x5x4xf64>
          }
        }
      }
    }
        ...
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 3 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              ...
              %6 = arith.addf %4, %5 : f64
              %7 = arith.mulf %1, %6 : f64
              %8 = affine.load %arg2[%arg14 + %arg13 * 5] : memref<?xf64>
              %9 = arith.mulf %7, %8 : f64
              %10 = arith.addf %arg15, %9 : f64
              affine.yield %10 : f64
            }
            affine.store %0, %alloca_3[%arg10, %arg11, %arg12, %arg13] : memref<2x5x5x3xf64>
          }
        }
      }
    }
      ...
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 3 {
            ...
            affine.store %0, %alloca_2[%arg10, %arg11, %arg12, %arg13] : memref<2x5x5x3xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 3 {
          affine.for %arg13 = 0 to 4 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_4[%arg10, %arg11, %arg14, %arg13] : memref<2x5x5x4xf64>
              %2 = affine.load %arg2[%arg14 + %arg12 * 5] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_1[%arg10, %arg11, %arg12, %arg13] : memref<2x5x3x4xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 4 {
          affine.for %arg13 = 0 to 3 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_3[%arg10, %arg11, %arg14, %arg13] : memref<2x5x5x3xf64>
              %2 = affine.load %arg5[%arg14 + %arg12 * 5] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_0[%arg10, %arg11, %arg12, %arg13] : memref<2x5x4x3xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 3 {
          affine.for %arg13 = 0 to 3 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              %1 = affine.load %alloca_2[%arg10, %arg11, %arg14, %arg13] : memref<2x5x5x3xf64>
              %2 = affine.load %arg2[%arg14 + %arg12 * 5] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg15, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca[%arg10, %arg11, %arg12, %arg13] : memref<2x5x3x3xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 3 {
        affine.for %arg12 = 0 to 3 {
          affine.for %arg13 = 0 to 4 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              %3 = affine.load %alloca_1[%arg10, %arg14, %arg12, %arg13] : memref<2x5x3x4xf64>
              %4 = affine.load %arg2[%arg14 + %arg11 * 5] : memref<?xf64>
              %5 = arith.mulf %3, %4 : f64
              %6 = arith.addf %arg15, %5 : f64
              affine.yield %6 : f64
            }
            %1 = affine.load %arg9[%arg11 * 12 + %arg13 + %arg12 * 4 + %arg10 * 108] : memref<?xf64>
            %2 = arith.addf %1, %0 : f64
            affine.store %2, %arg9[%arg11 * 12 + %arg13 + %arg12 * 4 + %arg10 * 108] : memref<?xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 3 {
        affine.for %arg12 = 0 to 4 {
          affine.for %arg13 = 0 to 3 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              %3 = affine.load %alloca_0[%arg10, %arg14, %arg12, %arg13] : memref<2x5x4x3xf64>
              %4 = affine.load %arg2[%arg14 + %arg11 * 5] : memref<?xf64>
              %5 = arith.mulf %3, %4 : f64
              %6 = arith.addf %arg15, %5 : f64
              affine.yield %6 : f64
            }
            %1 = affine.load %arg9[%arg11 * 12 + %arg13 + %arg12 * 3 + %arg10 * 108 + 36] : memref<?xf64>
            %2 = arith.addf %1, %0 : f64
            affine.store %2, %arg9[%arg11 * 12 + %arg13 + %arg12 * 3 + %arg10 * 108 + 36] : memref<?xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 4 {
        affine.for %arg12 = 0 to 3 {
          affine.for %arg13 = 0 to 3 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              %3 = affine.load %alloca[%arg10, %arg14, %arg12, %arg13] : memref<2x5x3x3xf64>
              %4 = affine.load %arg5[%arg14 + %arg11 * 5] : memref<?xf64>
              %5 = arith.mulf %3, %4 : f64
              %6 = arith.addf %arg15, %5 : f64
              affine.yield %6 : f64
            }
            %1 = affine.load %arg9[%arg11 * 9 + %arg13 + %arg12 * 3 + %arg10 * 108 + 72] : memref<?xf64>
            %2 = arith.addf %1, %0 : f64
            affine.store %2, %arg9[%arg11 * 9 + %arg13 + %arg12 * 3 + %arg10 * 108 + 72] : memref<?xf64>
          }
        }
      }
    }
      ...
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 3 iter_args(%arg15 = %cst) -> (f64) {
              ...
              %2 = affine.for %arg16 = 0 to 3 iter_args(%arg17 = %arg15) -> (f64) {
                ...
                %4 = affine.for %arg18 = 0 to 4 iter_args(%arg19 = %arg17) -> (f64) {
                  %5 = affine.load %arg8[%arg14 * 12 + %arg18 + %arg16 * 4 + %arg10 * 108] : memref<?xf64>
            ...
            affine.store %0, %alloca_14[%arg10, 0, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
          }
        }
      }
    }
      ...
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 3 iter_args(%arg15 = %cst) -> (f64) {
              ...
              %2 = affine.for %arg16 = 0 to 4 iter_args(%arg17 = %arg15) -> (f64) {
                ...
                %4 = affine.for %arg18 = 0 to 3 iter_args(%arg19 = %arg17) -> (f64) {
                  %5 = affine.load %arg8[%arg14 * 12 + %arg18 + %arg16 * 3 + %arg10 * 108 + 36] : memref<?xf64>
            ...
            affine.store %0, %alloca_14[%arg10, 1, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
          }
        }
      }
    }
          ...
          affine.for %arg13 = 0 to 5 {
            %0 = affine.for %arg14 = 0 to 4 iter_args(%arg15 = %cst) -> (f64) {
              ...
              %2 = affine.for %arg16 = 0 to 3 iter_args(%arg17 = %arg15) -> (f64) {
                %3 = affine.load %arg0[%arg16 + %arg12 * 3] : memref<?xf64>
                %4 = affine.for %arg18 = 0 to 3 iter_args(%arg19 = %arg17) -> (f64) {
                  %5 = affine.load %arg8[%arg14 * 9 + %arg18 + %arg16 * 3 + %arg10 * 108 + 72] : memref<?xf64>
                  %6 = affine.load %arg0[%arg18 + %arg13 * 3] : memref<?xf64>
                  %7 = arith.mulf %5, %6 : f64
                  %8 = arith.mulf %7, %3 : f64
                  %9 = arith.mulf %8, %1 : f64
            ...
            affine.store %0, %alloca_14[%arg10, 2, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
          }
        }
      }
    }
    affine.for %arg10 = 0 to 2 {
      affine.for %arg11 = 0 to 5 {
        affine.for %arg12 = 0 to 5 {
          affine.for %arg13 = 0 to 5 {
            %0 = affine.load %alloca_14[%arg10, 0, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
            %1 = affine.load %alloca_14[%arg10, 1, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
            %2 = affine.load %alloca_14[%arg10, 2, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
            ...
            affine.store %10, %alloca_14[%arg10, 0, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
            ...
            affine.store %18, %alloca_14[%arg10, 1, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
            ...
            affine.store %26, %alloca_14[%arg10, 2, %arg11, %arg12, %arg13] : memref<2x3x5x5x5xf64>
          }
        }
      }
    }
            ...
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              ...
              %4 = affine.for %arg16 = 0 to 5 iter_args(%arg17 = %arg15) -> (f64) {
                ...
                %6 = affine.for %arg18 = 0 to 5 iter_args(%arg19 = %arg17) -> (f64) {
                  %7 = affine.load %alloca_14[%arg10, 0, %arg14, %arg16, %arg18] : memref<2x3x5x5x5xf64>
          ...
          affine.for %arg13 = 0 to 3 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              ...
              %4 = affine.for %arg16 = 0 to 5 iter_args(%arg17 = %arg15) -> (f64) {
                ...
                %6 = affine.for %arg18 = 0 to 5 iter_args(%arg19 = %arg17) -> (f64) {
                  %7 = affine.load %alloca_14[%arg10, 1, %arg14, %arg16, %arg18] : memref<2x3x5x5x5xf64>
          ...
          affine.for %arg13 = 0 to 3 {
            %0 = affine.for %arg14 = 0 to 5 iter_args(%arg15 = %cst) -> (f64) {
              ...
              %4 = affine.for %arg16 = 0 to 5 iter_args(%arg17 = %arg15) -> (f64) {
                %5 = affine.load %arg2[%arg16 + %arg12 * 5] : memref<?xf64>
                %6 = affine.for %arg18 = 0 to 5 iter_args(%arg19 = %arg17) -> (f64) {
                  %7 = affine.load %alloca_14[%arg10, 2, %arg14, %arg16, %arg18] : memref<2x3x5x5x5xf64>
                  %8 = affine.load %arg2[%arg18 + %arg13 * 5] : memref<?xf64>
                  %9 = arith.mulf %7, %8 : f64
                  %10 = arith.mulf %9, %5 : f64
                  %11 = arith.mulf %10, %3 : f64
      ...
      affine.for %arg8 = 0 to 3 {
        affine.for %arg9 = 0 to 3 {
          affine.for %arg10 = 0 to 5 {
            ...
            affine.store %0, %alloca_13[%arg7, %arg8, %arg9, %arg10] : memref<2x3x3x5xf64>
          }
        }
      }
    }
        ...
        affine.for %arg9 = 0 to 5 {
          affine.for %arg10 = 0 to 5 {
            %0 = affine.for %arg11 = 0 to 3 iter_args(%arg12 = %cst) -> (f64) {
              %1 = affine.load %alloca_13[%arg7, %arg8, %arg11, %arg10] : memref<2x3x3x5xf64>
              %2 = affine.load %arg0[%arg11 + %arg9 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg12, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_10[%arg7, %arg8, %arg9, %arg10] : memref<2x3x5x5xf64>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 5 {
          affine.for %arg10 = 0 to 5 {
            %0 = affine.for %arg11 = 0 to 3 iter_args(%arg12 = %cst) -> (f64) {
              %1 = affine.load %alloca_10[%arg7, %arg11, %arg9, %arg10] : memref<2x3x5x5xf64>
      ...
      affine.for %arg8 = 0 to 3 {
        affine.for %arg9 = 0 to 4 {
          affine.for %arg10 = 0 to 5 {
            ...
            affine.store %0, %alloca_12[%arg7, %arg8, %arg9, %arg10] : memref<2x3x4x5xf64>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 3 {
        affine.for %arg9 = 0 to 5 {
          affine.for %arg10 = 0 to 5 {
            %0 = affine.for %arg11 = 0 to 4 iter_args(%arg12 = %cst) -> (f64) {
              %1 = affine.load %alloca_12[%arg7, %arg8, %arg11, %arg10] : memref<2x3x4x5xf64>
              %2 = affine.load %arg2[%arg11 + %arg9 * 4] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg12, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_9[%arg7, %arg8, %arg9, %arg10] : memref<2x3x5x5xf64>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 5 {
          affine.for %arg10 = 0 to 5 {
            %0 = affine.for %arg11 = 0 to 3 iter_args(%arg12 = %cst) -> (f64) {
              %1 = affine.load %alloca_9[%arg7, %arg11, %arg9, %arg10] : memref<2x3x5x5xf64>
              %2 = affine.load %arg0[%arg11 + %arg8 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg12, %3 : f64
              affine.yield %4 : f64
      ...
      affine.for %arg8 = 0 to 4 {
        affine.for %arg9 = 0 to 3 {
          affine.for %arg10 = 0 to 5 {
            ...
            affine.store %0, %alloca_11[%arg7, %arg8, %arg9, %arg10] : memref<2x4x3x5xf64>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 4 {
        affine.for %arg9 = 0 to 5 {
          affine.for %arg10 = 0 to 5 {
            %0 = affine.for %arg11 = 0 to 3 iter_args(%arg12 = %cst) -> (f64) {
              %1 = affine.load %alloca_11[%arg7, %arg8, %arg11, %arg10] : memref<2x4x3x5xf64>
              %2 = affine.load %arg0[%arg11 + %arg9 * 3] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg12, %3 : f64
              affine.yield %4 : f64
      ...
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 5 {
          affine.for %arg10 = 0 to 3 {
            ...
            affine.store %0, %alloca_3[%arg7, %arg8, %arg9, %arg10] : memref<2x5x5x3xf64>
          }
        }
      }
    }
      ...
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 5 {
          affine.for %arg10 = 0 to 3 {
            ...
            affine.store %0, %alloca_2[%arg7, %arg8, %arg9, %arg10] : memref<2x5x5x3xf64>
          }
        }
      }
    }
      ...
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 3 {
          affine.for %arg10 = 0 to 4 {
            ...
            affine.store %0, %alloca_1[%arg7, %arg8, %arg9, %arg10] : memref<2x5x3x4xf64>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 4 {
          affine.for %arg10 = 0 to 3 {
            %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
              %1 = affine.load %alloca_3[%arg7, %arg8, %arg11, %arg10] : memref<2x5x5x3xf64>
              %2 = affine.load %arg3[%arg11 + %arg9 * 5] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg12, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca_0[%arg7, %arg8, %arg9, %arg10] : memref<2x5x4x3xf64>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 3 {
          affine.for %arg10 = 0 to 3 {
            %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
              %1 = affine.load %alloca_2[%arg7, %arg8, %arg11, %arg10] : memref<2x5x5x3xf64>
              %2 = affine.load %arg1[%arg11 + %arg9 * 5] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg12, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca[%arg7, %arg8, %arg9, %arg10] : memref<2x5x3x3xf64>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 3 {
        affine.for %arg9 = 0 to 3 {
          affine.for %arg10 = 0 to 4 {
            %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
              %3 = affine.load %alloca_1[%arg7, %arg11, %arg9, %arg10] : memref<2x5x3x4xf64>
    ...
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 3 {
        affine.for %arg9 = 0 to 4 {
          affine.for %arg10 = 0 to 3 {
            %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
              %3 = affine.load %alloca_0[%arg7, %arg11, %arg9, %arg10] : memref<2x5x4x3xf64>
              %4 = affine.load %arg1[%arg11 + %arg8 * 5] : memref<?xf64>
              %5 = arith.mulf %3, %4 : f64
              %6 = arith.addf %arg12, %5 : f64
              affine.yield %6 : f64
    ...
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 4 {
        affine.for %arg9 = 0 to 3 {
          affine.for %arg10 = 0 to 3 {
            %0 = affine.for %arg11 = 0 to 5 iter_args(%arg12 = %cst) -> (f64) {
              %3 = affine.load %alloca[%arg7, %arg11, %arg9, %arg10] : memref<2x5x3x3xf64>
  ...
  func.func @mfem_pa_hdiv_mass_apply_3d_direct(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    %cst = arith.constant 0.000000e+00 : f64
            ...
            %0 = affine.for %arg11 = 0 to 3 iter_args(%arg12 = %cst) -> (f64) {
              ...
              %2 = affine.for %arg13 = 0 to 3 iter_args(%arg14 = %arg12) -> (f64) {
                ...
                %4 = affine.for %arg15 = 0 to 4 iter_args(%arg16 = %arg14) -> (f64) {
                  %5 = affine.load %arg5[%arg11 * 12 + %arg15 + %arg13 * 4 + %arg7 * 108] : memref<?xf64>
            ...
            %0 = affine.for %arg11 = 0 to 3 iter_args(%arg12 = %cst) -> (f64) {
              ...
              %2 = affine.for %arg13 = 0 to 4 iter_args(%arg14 = %arg12) -> (f64) {
                ...
                %4 = affine.for %arg15 = 0 to 3 iter_args(%arg16 = %arg14) -> (f64) {
                  %5 = affine.load %arg5[%arg11 * 12 + %arg15 + %arg13 * 3 + %arg7 * 108 + 36] : memref<?xf64>
          ...
          affine.for %arg10 = 0 to 5 {
            %0 = affine.for %arg11 = 0 to 4 iter_args(%arg12 = %cst) -> (f64) {
              ...
              %2 = affine.for %arg13 = 0 to 3 iter_args(%arg14 = %arg12) -> (f64) {
                %3 = affine.load %arg0[%arg13 + %arg9 * 3] : memref<?xf64>
                %4 = affine.for %arg15 = 0 to 3 iter_args(%arg16 = %arg14) -> (f64) {
                  %5 = affine.load %arg5[%arg11 * 9 + %arg15 + %arg13 * 3 + %arg7 * 108 + 72] : memref<?xf64>
                  %6 = affine.load %arg0[%arg15 + %arg10 * 3] : memref<?xf64>
                  %7 = arith.mulf %5, %6 : f64
                  %8 = arith.mulf %7, %3 : f64
                  %9 = arith.mulf %8, %1 : f64
