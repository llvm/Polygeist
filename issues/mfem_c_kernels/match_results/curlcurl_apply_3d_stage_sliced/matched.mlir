...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_pa_curlcurl_apply_3d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>, %arg8: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %v47_contract_50_tc0 = tensor.cast %47 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v48_contract_50_tc1 = tensor.cast %48 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v49_contract_50_tc2 = tensor.cast %49 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v50_tdyn = kernel.launch @cutensornetContraction2_f64(%v47_contract_50_tc0, %v48_contract_50_tc1, %v49_contract_50_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %50 = tensor.cast %v50_tdyn : tensor<*xf64> to tensor<?x?x?x?x?xf64>
    ...
    %v87_contract_90_tc0 = tensor.cast %87 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v88_contract_90_tc1 = tensor.cast %88 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v89_contract_90_tc2 = tensor.cast %89 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v90_tdyn = kernel.launch @cutensornetContraction2_f64(%v87_contract_90_tc0, %v88_contract_90_tc1, %v89_contract_90_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %90 = tensor.cast %v90_tdyn : tensor<*xf64> to tensor<?x?x?x?x?xf64>
    ...
    %v95_contract_98_tc0 = tensor.cast %95 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v96_contract_98_tc1 = tensor.cast %96 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v97_contract_98_tc2 = tensor.cast %97 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v98_tdyn = kernel.launch @cutensornetContraction2_f64(%v95_contract_98_tc0, %v96_contract_98_tc1, %v97_contract_98_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %98 = tensor.cast %v98_tdyn : tensor<*xf64> to tensor<?x?x?x?x?xf64>
    ...
    %v135_contract_138_tc0 = tensor.cast %135 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v136_contract_138_tc1 = tensor.cast %136 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v137_contract_138_tc2 = tensor.cast %137 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v138_tdyn = kernel.launch @cutensornetContraction2_f64(%v135_contract_138_tc0, %v136_contract_138_tc1, %v137_contract_138_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %138 = tensor.cast %v138_tdyn : tensor<*xf64> to tensor<?x?x?x?x?xf64>
    ...
    %v143_contract_146_tc0 = tensor.cast %143 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v144_contract_146_tc1 = tensor.cast %144 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v145_contract_146_tc2 = tensor.cast %145 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v146_tdyn = kernel.launch @cutensornetContraction2_f64(%v143_contract_146_tc0, %v144_contract_146_tc1, %v145_contract_146_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %146 = tensor.cast %v146_tdyn : tensor<*xf64> to tensor<?x?x?x?x?xf64>
