...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_integrate_grad_3d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %v16_contract_19_tc0 = tensor.cast %16 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v17_contract_19_tc1 = tensor.cast %17 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v18_contract_19_tc2 = tensor.cast %18 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v19_tdyn = kernel.launch @cutensornetContraction2_f64(%v16_contract_19_tc0, %v17_contract_19_tc1, %v18_contract_19_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %19 = tensor.cast %v19_tdyn : tensor<*xf64> to tensor<?x?x?x?x?xf64>
    ...
    %v24_contract_27_tc0 = tensor.cast %24 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v25_contract_27_tc1 = tensor.cast %25 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v26_contract_27_tc2 = tensor.cast %26 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v27_tdyn = kernel.launch @cutensornetContraction2_f64(%v24_contract_27_tc0, %v25_contract_27_tc1, %v26_contract_27_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %27 = tensor.cast %v27_tdyn : tensor<*xf64> to tensor<?x?x?x?x?xf64>
    ...
    %v32_contract_35_tc0 = tensor.cast %32 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v33_contract_35_tc1 = tensor.cast %33 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v34_contract_35_tc2 = tensor.cast %34 : tensor<?x?x?x?x?xf64> to tensor<*xf64>

    %v35_tdyn = kernel.launch @cutensornetContraction2_f64(%v32_contract_35_tc0, %v33_contract_35_tc1, %v34_contract_35_tc2) {contraction_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3, d4)>]} : (tensor<*xf64>, tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>

    %35 = tensor.cast %v35_tdyn : tensor<*xf64> to tensor<?x?x?x?x?xf64>
