...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_pa_curlcurl_apply_2d(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
      ...
      affine.for %arg8 = 0 to 2 {
        ...
        scf.for %arg9 = %c0 to %12 step %c1 {
          ...
          affine.for %arg10 = 0 to 5 {
            ...
            %25 = arith.negf %24 : f64
            %26 = arith.muli %19, %c3_i32 : i32
            %27 = arith.addi %26, %16 : i32
            %28 = arith.index_cast %27 : i32 to index
            %29 = memref.load %arg0[%28] : memref<?xf64>
            %30 = arith.select %20, %25, %29 : f64
            %31 = polygeist.submap(%alloca_0, %c5) {map = #map1} : (memref<5xf64>, index) -> memref<?xf64>
            %32 = polygeist.submap(%alloca_1, %arg10, %c5) {map = #map2} : (memref<5x5xf64>, index, index) -> memref<?xf64>
            linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel"]} ins(%31 : memref<?xf64>) outs(%32 : memref<?xf64>) {
            ^bb0(%in: f64, %out: f64):
              %33 = arith.mulf %in, %30 : f64
              %34 = arith.addf %out, %33 : f64
              linalg.yield %34 : f64
            }
          }
        }
        %14 = arith.muli %11, %9 : i32
      ...
      affine.for %arg8 = 0 to 5 {
        ...
        affine.for %arg9 = 0 to 2 {
          ...
          scf.for %arg10 = %c0 to %14 step %c1 {
            ...
            %24 = arith.muli %17, %c5_i32 : i32
            %25 = arith.addi %24, %6 : i32
            %26 = arith.index_cast %25 : i32 to index
            %27 = memref.load %arg1[%26] : memref<?xf64>
            %28 = arith.select %18, %23, %27 : f64
            %29 = arith.muli %17, %12 : i32
            scf.for %arg11 = %c0 to %13 step %c1 {
              %30 = arith.index_cast %arg11 : index to i32
              %31 = arith.addi %30, %29 : i32
              %32 = arith.addi %31, %7 : i32
              %33 = arith.addi %32, %2 : i32
              %34 = arith.index_cast %33 : i32 to index
              %35 = memref.load %alloca[%arg11] : memref<4xf64>
              %36 = arith.mulf %35, %28 : f64
              %37 = memref.load %arg6[%34] : memref<?xf64>
              %38 = arith.addf %37, %36 : f64
              memref.store %38, %arg6[%34] : memref<?xf64>
            }
          }
          %15 = arith.muli %12, %10 : i32
