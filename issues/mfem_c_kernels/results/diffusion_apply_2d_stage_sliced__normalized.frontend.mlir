  ...
  func.func @mfem_pa_diffusion_apply_2d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
      ...
      affine.for %arg8 = 0 to 4 {
        affine.for %arg9 = 0 to 5 {
          %0 = affine.for %arg10 = 0 to 4 iter_args(%arg11 = %cst) -> (f64) {
            %1 = affine.load %arg5[%arg10 + %arg7 * 16 + %arg8 * 4] : memref<?xf64>
      ...
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 4 {
          %0 = affine.for %arg10 = 0 to 5 iter_args(%arg11 = %cst) -> (f64) {
            %1 = affine.load %arg4[%arg10 + %arg8 * 5 + %arg7 * 75] : memref<?xf64>
            %2 = affine.load %alloca_4[%arg7, %arg8, %arg10] : memref<2x5x5xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = affine.load %arg4[%arg10 + %arg7 * 75 + %arg8 * 5 + 25] : memref<?xf64>
            %5 = affine.load %alloca_3[%arg7, %arg8, %arg10] : memref<2x5x5xf64>
            %6 = arith.mulf %4, %5 : f64
            %7 = arith.addf %3, %6 : f64
            %8 = affine.load %arg3[%arg10 + %arg9 * 5] : memref<?xf64>
            %9 = arith.mulf %7, %8 : f64
            %10 = arith.addf %arg11, %9 : f64
            affine.yield %10 : f64
          }
    ...
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 5 {
        affine.for %arg9 = 0 to 4 {
          %0 = affine.for %arg10 = 0 to 5 iter_args(%arg11 = %cst) -> (f64) {
            %1 = affine.load %arg4[%arg10 + %arg7 * 75 + %arg8 * 5 + 25] : memref<?xf64>
            %2 = affine.load %alloca_4[%arg7, %arg8, %arg10] : memref<2x5x5xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = affine.load %arg4[%arg10 + %arg7 * 75 + %arg8 * 5 + 50] : memref<?xf64>
            %5 = affine.load %alloca_3[%arg7, %arg8, %arg10] : memref<2x5x5xf64>
            %6 = arith.mulf %4, %5 : f64
            %7 = arith.addf %3, %6 : f64
            %8 = affine.load %arg2[%arg10 + %arg9 * 5] : memref<?xf64>
            %9 = arith.mulf %7, %8 : f64
            %10 = arith.addf %arg11, %9 : f64
            affine.yield %10 : f64
          }
    ...
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 4 {
        affine.for %arg9 = 0 to 4 {
          ...
          affine.store %0, %alloca_0[%arg7, %arg8, %arg9] : memref<2x4x4xf64>
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 4 {
        affine.for %arg9 = 0 to 4 {
          ...
          affine.store %0, %alloca[%arg7, %arg8, %arg9] : memref<2x4x4xf64>
        }
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 4 {
        affine.for %arg9 = 0 to 4 {
          %0 = affine.load %alloca_0[%arg7, %arg8, %arg9] : memref<2x4x4xf64>
          %1 = affine.load %alloca[%arg7, %arg8, %arg9] : memref<2x4x4xf64>
          %2 = arith.addf %0, %1 : f64
          %3 = affine.load %arg6[%arg9 + %arg7 * 16 + %arg8 * 4] : memref<?xf64>
          %4 = arith.addf %3, %2 : f64
          affine.store %4, %arg6[%arg9 + %arg7 * 16 + %arg8 * 4] : memref<?xf64>
        }
      }
    }
    return
