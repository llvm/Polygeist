...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @mfem_pa_divdiv_apply_2d_stage_sliced(%arg0: memref<?xf64>, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %0 = polygeist.submap(%alloca_6, %c2, %c3, %c5) {map = #map} : (memref<2x3x5xf64>, index, index, index) -> memref<?x?x?xf64>
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%0 : memref<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %1 = polygeist.submap(%arg5, %c2, %c3, %c5, %c4) {map = #map1} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %2 = polygeist.submap(%arg2, %c2, %c3, %c5, %c4) {map = #map2} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %3 = polygeist.submap(%alloca_6, %c2, %c3, %c5, %c4) {map = #map3} : (memref<2x3x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %5 = polygeist.submap(%alloca_6, %c2, %c5, %c5, %c3) {map = #map5} : (memref<2x3x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %6 = polygeist.submap(%arg0, %c2, %c5, %c5, %c3) {map = #map6} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %7 = polygeist.submap(%alloca_4, %c2, %c5, %c5, %c3) {map = #map3} : (memref<2x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %8 = polygeist.submap(%alloca_5, %c2, %c4, %c5) {map = #map} : (memref<2x4x5xf64>, index, index, index) -> memref<?x?x?xf64>
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%8 : memref<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %9 = polygeist.submap(%arg5, %c2, %c4, %c5, %c3) {map = #map7} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %10 = polygeist.submap(%arg0, %c2, %c4, %c5, %c3) {map = #map8} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %11 = polygeist.submap(%alloca_5, %c2, %c4, %c5, %c3) {map = #map3} : (memref<2x4x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %13 = polygeist.submap(%alloca_5, %c2, %c5, %c5, %c4) {map = #map5} : (memref<2x4x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %14 = polygeist.submap(%arg2, %c2, %c5, %c5, %c4) {map = #map9} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %17 = polygeist.submap(%arg4, %c2, %c5, %c4, %c5) {map = #map10} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %18 = polygeist.submap(%alloca_4, %c2, %c5, %c4, %c5) {map = #map11} : (memref<2x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %19 = polygeist.submap(%alloca_3, %c2, %c5, %c4, %c5) {map = #map11} : (memref<2x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %20 = polygeist.submap(%arg3, %c2, %c5, %c4, %c5) {map = #map12} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %21 = polygeist.submap(%alloca_2, %c2, %c5, %c4, %c5) {map = #map3} : (memref<2x5x4xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    ^bb0(%in: f64, %in_7: f64, %in_8: f64, %in_9: f64, %out: f64):
      %40 = arith.addf %in_7, %in_8 : f64
      %41 = arith.mulf %in, %40 : f64
      %42 = arith.mulf %41, %in_9 : f64
      %43 = arith.addf %out, %42 : f64
      linalg.yield %43 : f64
    }
    %22 = polygeist.submap(%alloca_0, %c2, %c3, %c4) {map = #map} : (memref<2x3x4xf64>, index, index, index) -> memref<?x?x?xf64>
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%22 : memref<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %23 = polygeist.submap(%alloca_2, %c2, %c3, %c4, %c5) {map = #map5} : (memref<2x5x4xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %24 = polygeist.submap(%arg1, %c2, %c3, %c4, %c5) {map = #map13} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %25 = polygeist.submap(%alloca_0, %c2, %c3, %c4, %c5) {map = #map3} : (memref<2x3x4xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %26 = polygeist.submap(%alloca_1, %c2, %c5, %c3) {map = #map} : (memref<2x5x3xf64>, index, index, index) -> memref<?x?x?xf64>
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%26 : memref<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %27 = polygeist.submap(%arg4, %c2, %c5, %c3, %c5) {map = #map10} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %28 = polygeist.submap(%alloca_4, %c2, %c5, %c3, %c5) {map = #map11} : (memref<2x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %29 = polygeist.submap(%alloca_3, %c2, %c5, %c3, %c5) {map = #map11} : (memref<2x5x5xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %30 = polygeist.submap(%arg1, %c2, %c5, %c3, %c5) {map = #map12} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %31 = polygeist.submap(%alloca_1, %c2, %c5, %c3, %c5) {map = #map3} : (memref<2x5x3xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %32 = polygeist.submap(%alloca, %c2, %c4, %c3) {map = #map} : (memref<2x4x3xf64>, index, index, index) -> memref<?x?x?xf64>
    linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel", "parallel"]} outs(%32 : memref<?x?x?xf64>) {
    ^bb0(%out: f64):
      linalg.yield %cst : f64
    }
    %33 = polygeist.submap(%alloca_1, %c2, %c4, %c3, %c5) {map = #map5} : (memref<2x5x3xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %34 = polygeist.submap(%arg3, %c2, %c4, %c3, %c5) {map = #map13} : (memref<?xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    %35 = polygeist.submap(%alloca, %c2, %c4, %c3, %c5) {map = #map3} : (memref<2x4x3xf64>, index, index, index, index) -> memref<?x?x?x?xf64>
    ...
    %36 = polygeist.submap(%alloca_0, %c2, %c3, %c4) {map = #map} : (memref<2x3x4xf64>, index, index, index) -> memref<?x?x?xf64>
    %37 = polygeist.submap(%arg6, %c2, %c3, %c4) {map = #map14} : (memref<?xf64>, index, index, index) -> memref<?x?x?xf64>
    ...
    %38 = polygeist.submap(%alloca, %c2, %c4, %c3) {map = #map} : (memref<2x4x3xf64>, index, index, index) -> memref<?x?x?xf64>
    %39 = polygeist.submap(%arg6, %c2, %c4, %c3) {map = #map15} : (memref<?xf64>, index, index, index) -> memref<?x?x?xf64>
