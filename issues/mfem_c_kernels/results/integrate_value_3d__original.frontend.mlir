    ...
    affine.for %arg3 = 0 to 2 {
      affine.for %arg4 = 0 to 5 {
        affine.for %arg5 = 0 to 4 {
          affine.for %arg6 = 0 to 5 {
            ...
            affine.store %0, %alloca_0[%arg6, %arg4, %arg5] : memref<5x5x4xf64>
          }
        }
      }
      affine.for %arg4 = 0 to 4 {
        affine.for %arg5 = 0 to 4 {
          affine.for %arg6 = 0 to 5 {
            %0 = affine.for %arg7 = 0 to 5 iter_args(%arg8 = %cst) -> (f64) {
              %1 = affine.load %alloca_0[%arg6, %arg7, %arg5] : memref<5x5x4xf64>
              %2 = affine.load %arg1[%arg4 + %arg7 * 4] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg8, %3 : f64
              affine.yield %4 : f64
            }
            affine.store %0, %alloca[%arg6, %arg4, %arg5] : memref<5x4x4xf64>
          }
        }
      }
      affine.for %arg4 = 0 to 4 {
        affine.for %arg5 = 0 to 4 {
          affine.for %arg6 = 0 to 4 {
            %0 = affine.for %arg7 = 0 to 5 iter_args(%arg8 = %cst) -> (f64) {
              %3 = affine.load %alloca[%arg7, %arg5, %arg6] : memref<5x4x4xf64>
