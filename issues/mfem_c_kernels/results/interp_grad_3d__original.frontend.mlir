    ...
    affine.for %arg4 = 0 to 2 {
      affine.for %arg5 = 0 to 4 {
        affine.for %arg6 = 0 to 4 {
          affine.for %arg7 = 0 to 5 {
            %0:2 = affine.for %arg8 = 0 to 4 iter_args(%arg9 = %cst, %arg10 = %cst) -> (f64, f64) {
              ...
              %5 = affine.load %arg2[%arg8 + %arg7 * 4] : memref<?xf64>
              %6 = arith.mulf %1, %5 : f64
              %7 = arith.addf %arg9, %6 : f64
              affine.yield %7, %4 : f64, f64
            }
            affine.store %0#1, %alloca_3[%arg5, %arg6, %arg7] : memref<4x4x5xf64>
            affine.store %0#0, %alloca_2[%arg5, %arg6, %arg7] : memref<4x4x5xf64>
          }
        }
      }
      affine.for %arg5 = 0 to 4 {
        affine.for %arg6 = 0 to 5 {
          affine.for %arg7 = 0 to 5 {
            %0:3 = affine.for %arg8 = 0 to 4 iter_args(%arg9 = %cst, %arg10 = %cst, %arg11 = %cst) -> (f64, f64, f64) {
              %1 = affine.load %alloca_2[%arg5, %arg8, %arg7] : memref<4x4x5xf64>
              %2 = affine.load %arg1[%arg8 + %arg6 * 4] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg11, %3 : f64
              %5 = affine.load %alloca_3[%arg5, %arg8, %arg7] : memref<4x4x5xf64>
              %6 = affine.load %arg2[%arg8 + %arg6 * 4] : memref<?xf64>
              %7 = arith.mulf %5, %6 : f64
              %8 = arith.addf %arg10, %7 : f64
              %9 = arith.mulf %5, %2 : f64
              %10 = arith.addf %arg9, %9 : f64
              affine.yield %10, %8, %4 : f64, f64, f64
            }
            affine.store %0#2, %alloca_1[%arg5, %arg6, %arg7] : memref<4x5x5xf64>
            affine.store %0#1, %alloca_0[%arg5, %arg6, %arg7] : memref<4x5x5xf64>
            affine.store %0#0, %alloca[%arg5, %arg6, %arg7] : memref<4x5x5xf64>
          }
        }
      }
      affine.for %arg5 = 0 to 5 {
        affine.for %arg6 = 0 to 5 {
          affine.for %arg7 = 0 to 5 {
            %0:3 = affine.for %arg8 = 0 to 4 iter_args(%arg9 = %cst, %arg10 = %cst, %arg11 = %cst) -> (f64, f64, f64) {
              %1 = affine.load %alloca_1[%arg8, %arg6, %arg7] : memref<4x5x5xf64>
              %2 = affine.load %arg1[%arg8 + %arg5 * 4] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.addf %arg11, %3 : f64
              %5 = affine.load %alloca_0[%arg8, %arg6, %arg7] : memref<4x5x5xf64>
              %6 = arith.mulf %5, %2 : f64
              %7 = arith.addf %arg10, %6 : f64
              %8 = affine.load %alloca[%arg8, %arg6, %arg7] : memref<4x5x5xf64>
              %9 = affine.load %arg2[%arg8 + %arg5 * 4] : memref<?xf64>
              %10 = arith.mulf %8, %9 : f64
              %11 = arith.addf %arg9, %10 : f64
              affine.yield %11, %7, %4 : f64, f64, f64
            }
            affine.store %0#2, %arg3[%arg4 * 375 + %arg5 + %arg7 * 25 + %arg6 * 5] : memref<?xf64>
            affine.store %0#1, %arg3[%arg4 * 375 + %arg5 + %arg7 * 25 + %arg6 * 5 + 125] : memref<?xf64>
            affine.store %0#0, %arg3[%arg4 * 375 + %arg5 + %arg7 * 25 + %arg6 * 5 + 250] : memref<?xf64>
          }
        }
      }
    }
