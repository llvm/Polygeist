...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  gpu.module @__polygeist_gpu_module {
    gpu.func @kernel_3mm_kernel94153746519456(%arg0: index, %arg1: index, %arg2: memref<?x?xf64, strided<[?, 1], offset: ?>>, %arg3: memref<?x?xf64, strided<[?, 1], offset: ?>>) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>} {
      %0 = gpu.block_id  x
      %1 = gpu.block_id  y
      %2 = gpu.block_id  z
      %3 = gpu.thread_id  x
    ...
    gpu.func @kernel_3mm_kernel94153746527280(%arg0: index, %arg1: index, %arg2: memref<?x?xf64, strided<[?, 1], offset: ?>>, %arg3: memref<?x?xf64, strided<[?, 1], offset: ?>>) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>} {
      %0 = gpu.block_id  x
      %1 = gpu.block_id  y
      %2 = gpu.block_id  z
      %3 = gpu.thread_id  x
    ...
    gpu.func @kernel_3mm_kernel94153746505088(%arg0: index, %arg1: index, %arg2: memref<?x?xf64, strided<[?, 1], offset: ?>>, %arg3: memref<?x?xf64, strided<[?, 1], offset: ?>>) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>} {
      %0 = gpu.block_id  x
      %1 = gpu.block_id  y
      %2 = gpu.block_id  z
      %3 = gpu.thread_id  x
  ...
  func.func @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<?x?xf64>, %arg6: memref<?x?xf64>, %arg7: memref<?x?xf64>, %arg8: memref<?x?xf64>, %arg9: memref<?x?xf64>, %arg10: memref<?x?xf64>, %arg11: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>, polygeist.gpu_data_residency, polygeist.gpu_residual_pipeline, polygeist.gpu_timing_instrumented, polygeist.gpu_timing_region_id = -1890640588580836432 : i64, polygeist.pipeline_scope_coalesced} {
    ...
    %dim_58 = memref.dim %memref, %c0_55 : memref<?x?xf64>
    %13 = arith.index_cast %dim_58 : index to i32
    %dim_59 = memref.dim %memref, %c1_56 : memref<?x?xf64>
    %14 = arith.index_cast %dim_59 : index to i32
    ...
    %subview_60 = memref.subview %memref_14[0, 0] [%9, %8] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_61 = memref.subview %memref[0, 0] [%12, %8] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %intptr_62 = memref.extract_aligned_pointer_as_index %subview : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %17 = arith.index_cast %intptr_62 : index to i64
    ...
    %intptr_63 = memref.extract_aligned_pointer_as_index %subview_60 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %22 = arith.index_cast %intptr_63 : index to i64
    %base_buffer_64, %offset_65, %sizes_66:2, %strides_67:2 = memref.extract_strided_metadata %subview_60 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %23 = arith.index_cast %offset_65 : index to i64
    %24 = arith.muli %23, %c8_i64 : i64
    %25 = arith.addi %22, %24 : i64
    %26 = llvm.inttoptr %25 : i64 to !llvm.ptr
    %intptr_68 = memref.extract_aligned_pointer_as_index %subview_61 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %27 = arith.index_cast %intptr_68 : index to i64
    %base_buffer_69, %offset_70, %sizes_71:2, %strides_72:2 = memref.extract_strided_metadata %subview_61 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %28 = arith.index_cast %offset_70 : index to i64
    %29 = arith.muli %28, %c8_i64 : i64
    %30 = arith.addi %27, %29 : i64
    %31 = llvm.inttoptr %30 : i64 to !llvm.ptr
    call @polygeist_cublas_dgemm(%arg0, %arg1, %arg2, %cst, %21, %arg2, %26, %arg1, %cst_57, %31, %arg1) : (i32, i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, i32, f64, !llvm.ptr, i32) -> ()
    %subview_73 = memref.subview %memref[0, 0] [%12, %8] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    ...
    scf.if %35 {
      gpu.launch_func  @__polygeist_gpu_module::@kernel_3mm_kernel94153746519456 blocks in (%32, %33, %c1_74) threads in (%c1_74, %c1_74, %c1_74)  args(%c1_56 : index, %c0_55 : index, %subview_61 : memref<?x?xf64, strided<[?, 1], offset: ?>>, %subview_73 : memref<?x?xf64, strided<[?, 1], offset: ?>>) {polygeist.cuda_graph_safe}
      func.call @polygeist_cuda_graph_end(%c0_i64) : (i64) -> ()
    } {polygeist.cuda_graph_scope}
    %dim_75 = memref.dim %memref_22, %c0_55 : memref<?x?xf64>
    %36 = arith.index_cast %dim_75 : index to i32
    %dim_76 = memref.dim %memref_22, %c1_56 : memref<?x?xf64>
    %37 = arith.index_cast %dim_76 : index to i32
    %intptr_77 = memref.extract_aligned_pointer_as_index %memref_22 : memref<?x?xf64> -> index
    %38 = arith.index_cast %intptr_77 : index to i64
    %39 = llvm.inttoptr %38 : i64 to !llvm.ptr
    call @polygeist_cublas_memset_zero_2d(%36, %37, %39, %37) : (i32, i32, !llvm.ptr, i32) -> ()
    %subview_78 = memref.subview %memref_30[0, 0] [%8, %10] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_79 = memref.subview %memref_38[0, 0] [%10, %11] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_80 = memref.subview %memref_22[0, 0] [%8, %11] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %intptr_81 = memref.extract_aligned_pointer_as_index %subview_78 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %40 = arith.index_cast %intptr_81 : index to i64
    %base_buffer_82, %offset_83, %sizes_84:2, %strides_85:2 = memref.extract_strided_metadata %subview_78 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %41 = arith.index_cast %offset_83 : index to i64
    %42 = arith.muli %41, %c8_i64 : i64
    %43 = arith.addi %40, %42 : i64
    %44 = llvm.inttoptr %43 : i64 to !llvm.ptr
    %intptr_86 = memref.extract_aligned_pointer_as_index %subview_79 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %45 = arith.index_cast %intptr_86 : index to i64
    %base_buffer_87, %offset_88, %sizes_89:2, %strides_90:2 = memref.extract_strided_metadata %subview_79 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    ...
    %intptr_91 = memref.extract_aligned_pointer_as_index %subview_80 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %50 = arith.index_cast %intptr_91 : index to i64
    %base_buffer_92, %offset_93, %sizes_94:2, %strides_95:2 = memref.extract_strided_metadata %subview_80 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %51 = arith.index_cast %offset_93 : index to i64
    %52 = arith.muli %51, %c8_i64 : i64
    %53 = arith.addi %50, %52 : i64
    %54 = llvm.inttoptr %53 : i64 to !llvm.ptr
    call @polygeist_cublas_dgemm(%arg1, %arg3, %arg4, %cst, %44, %arg4, %49, %arg3, %cst_57, %54, %arg3) : (i32, i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, i32, f64, !llvm.ptr, i32) -> ()
    %subview_96 = memref.subview %memref_22[0, 0] [%8, %11] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    ...
    %58 = arith.cmpi ne, %57, %c0_i32_98 : i32
    scf.if %58 {
      gpu.launch_func  @__polygeist_gpu_module::@kernel_3mm_kernel94153746527280 blocks in (%55, %56, %c1_97) threads in (%c1_97, %c1_97, %c1_97)  args(%c1_56 : index, %c0_55 : index, %subview_80 : memref<?x?xf64, strided<[?, 1], offset: ?>>, %subview_96 : memref<?x?xf64, strided<[?, 1], offset: ?>>) {polygeist.cuda_graph_safe}
      func.call @polygeist_cuda_graph_end(%c1_i64) : (i64) -> ()
    } {polygeist.cuda_graph_scope}
    %dim_99 = memref.dim %memref_46, %c0_55 : memref<?x?xf64>
    %59 = arith.index_cast %dim_99 : index to i32
    %dim_100 = memref.dim %memref_46, %c1_56 : memref<?x?xf64>
    %60 = arith.index_cast %dim_100 : index to i32
    %intptr_101 = memref.extract_aligned_pointer_as_index %memref_46 : memref<?x?xf64> -> index
    %61 = arith.index_cast %intptr_101 : index to i64
    %62 = llvm.inttoptr %61 : i64 to !llvm.ptr
    call @polygeist_cublas_memset_zero_2d(%59, %60, %62, %60) : (i32, i32, !llvm.ptr, i32) -> ()
    %subview_102 = memref.subview %memref_46[0, 0] [%12, %11] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %intptr_103 = memref.extract_aligned_pointer_as_index %subview_61 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %63 = arith.index_cast %intptr_103 : index to i64
    %base_buffer_104, %offset_105, %sizes_106:2, %strides_107:2 = memref.extract_strided_metadata %subview_61 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %64 = arith.index_cast %offset_105 : index to i64
    %65 = arith.muli %64, %c8_i64 : i64
    %66 = arith.addi %63, %65 : i64
    %67 = llvm.inttoptr %66 : i64 to !llvm.ptr
    %intptr_108 = memref.extract_aligned_pointer_as_index %subview_80 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %68 = arith.index_cast %intptr_108 : index to i64
    %base_buffer_109, %offset_110, %sizes_111:2, %strides_112:2 = memref.extract_strided_metadata %subview_80 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %69 = arith.index_cast %offset_110 : index to i64
    %70 = arith.muli %69, %c8_i64 : i64
    %71 = arith.addi %68, %70 : i64
    %72 = llvm.inttoptr %71 : i64 to !llvm.ptr
    %intptr_113 = memref.extract_aligned_pointer_as_index %subview_102 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %73 = arith.index_cast %intptr_113 : index to i64
    %base_buffer_114, %offset_115, %sizes_116:2, %strides_117:2 = memref.extract_strided_metadata %subview_102 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %74 = arith.index_cast %offset_115 : index to i64
    %75 = arith.muli %74, %c8_i64 : i64
    %76 = arith.addi %73, %75 : i64
    %77 = llvm.inttoptr %76 : i64 to !llvm.ptr
    call @polygeist_cublas_dgemm(%arg0, %arg3, %arg1, %cst, %67, %arg1, %72, %arg3, %cst_57, %77, %arg3) : (i32, i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, i32, f64, !llvm.ptr, i32) -> ()
    %subview_118 = memref.subview %memref_46[0, 0] [%12, %11] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    ...
    %81 = arith.cmpi ne, %80, %c0_i32_120 : i32
    scf.if %81 {
      gpu.launch_func  @__polygeist_gpu_module::@kernel_3mm_kernel94153746505088 blocks in (%78, %79, %c1_119) threads in (%c1_119, %c1_119, %c1_119)  args(%c1_56 : index, %c0_55 : index, %subview_102 : memref<?x?xf64, strided<[?, 1], offset: ?>>, %subview_118 : memref<?x?xf64, strided<[?, 1], offset: ?>>) {polygeist.cuda_graph_safe}
