  ...
  func.func @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<?x?xf64>, %arg3: memref<?x?xf64>, %arg4: memref<?x?xf64>, %arg5: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg6 = 1 to #map()[%15] {
      affine.for %arg7 = 1 to #map1()[%0] {
        ...
        %22 = affine.load %arg3[0, %arg7] : memref<?x?xf64>
        affine.store %22, %arg5[%arg7, 0] : memref<?x?xf64>
        affine.for %arg8 = 1 to #map1()[%0] {
          %23 = affine.load %arg4[%arg7, %arg8 - 1] : memref<?x?xf64>
          %24 = arith.mulf %10, %23 : f64
          %25 = arith.addf %24, %11 : f64
          %26 = arith.divf %16, %25 : f64
          affine.store %26, %arg4[%arg7, %arg8] : memref<?x?xf64>
          %27 = affine.load %arg2[%arg8, %arg7 - 1] : memref<?x?xf64>
          %28 = arith.mulf %17, %27 : f64
          %29 = affine.load %arg2[%arg8, %arg7] : memref<?x?xf64>
          %30 = arith.mulf %19, %29 : f64
          %31 = arith.addf %28, %30 : f64
          %32 = affine.load %arg2[%arg8, %arg7 + 1] : memref<?x?xf64>
          %33 = arith.mulf %13, %32 : f64
          %34 = arith.subf %31, %33 : f64
          %35 = affine.load %arg5[%arg7, %arg8 - 1] : memref<?x?xf64>
          %36 = arith.mulf %10, %35 : f64
          %37 = arith.subf %34, %36 : f64
          %38 = arith.divf %37, %25 : f64
          affine.store %38, %arg5[%arg7, %arg8] : memref<?x?xf64>
        }
        affine.store %cst, %arg3[symbol(%0) - 1, %arg7] : memref<?x?xf64>
        affine.for %arg8 = 1 to #map1()[%0] {
          %23 = affine.load %arg4[%arg7, -%arg8 + symbol(%0) - 1] : memref<?x?xf64>
          %24 = affine.load %arg3[-%arg8 + symbol(%0), %arg7] : memref<?x?xf64>
          %25 = arith.mulf %23, %24 : f64
          %26 = affine.load %arg5[%arg7, -%arg8 + symbol(%0) - 1] : memref<?x?xf64>
          %27 = arith.addf %25, %26 : f64
          affine.store %27, %arg3[-%arg8 + symbol(%0) - 1, %arg7] : memref<?x?xf64>
        }
      }
      affine.for %arg7 = 1 to #map1()[%0] {
        affine.store %cst, %arg2[%arg7, 0] : memref<?x?xf64>
        affine.store %cst_1, %arg4[%arg7, 0] : memref<?x?xf64>
        %22 = affine.load %arg2[%arg7, 0] : memref<?x?xf64>
        affine.store %22, %arg5[%arg7, 0] : memref<?x?xf64>
        affine.for %arg8 = 1 to #map1()[%0] {
          %23 = affine.load %arg4[%arg7, %arg8 - 1] : memref<?x?xf64>
          ...
          affine.store %26, %arg4[%arg7, %arg8] : memref<?x?xf64>
          %27 = affine.load %arg3[%arg7 - 1, %arg8] : memref<?x?xf64>
          %28 = arith.mulf %16, %27 : f64
          %29 = affine.load %arg3[%arg7, %arg8] : memref<?x?xf64>
          %30 = arith.mulf %21, %29 : f64
          %31 = arith.addf %28, %30 : f64
          %32 = affine.load %arg3[%arg7 + 1, %arg8] : memref<?x?xf64>
        ...
        affine.store %cst, %arg2[%arg7, symbol(%0) - 1] : memref<?x?xf64>
        affine.for %arg8 = 1 to #map1()[%0] {
          %23 = affine.load %arg4[%arg7, -%arg8 + symbol(%0) - 1] : memref<?x?xf64>
          %24 = affine.load %arg2[%arg7, -%arg8 + symbol(%0)] : memref<?x?xf64>
          %25 = arith.mulf %23, %24 : f64
          %26 = affine.load %arg5[%arg7, -%arg8 + symbol(%0) - 1] : memref<?x?xf64>
          %27 = arith.addf %25, %26 : f64
          affine.store %27, %arg2[%arg7, -%arg8 + symbol(%0) - 1] : memref<?x?xf64>
        }
      }
    }
    return
