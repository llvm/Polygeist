module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_bicg(%arg0: i32, %arg1: i32, %arg2: memref<?x?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>, polygeist.gpu_data_residency, polygeist.gpu_timing_instrumented, polygeist.gpu_timing_region_id = -2281302616747103834 : i64, polygeist.pipeline_scope_coalesced} {
    ...
    %dim_28 = memref.dim %memref_4, %c0_26 : memref<?xf64>
    %7 = arith.index_cast %dim_28 : index to i32
    ...
    %dim_29 = memref.dim %memref_10, %c0_26 : memref<?xf64>
    %11 = arith.index_cast %dim_29 : index to i32
    %intptr_30 = memref.extract_aligned_pointer_as_index %memref_10 : memref<?xf64> -> index
    %12 = arith.index_cast %intptr_30 : index to i64
    %13 = llvm.inttoptr %12 : i64 to !llvm.ptr
    call @polygeist_cublas_memset_zero_1d(%11, %13) : (i32, !llvm.ptr) -> ()
    %dim_31 = memref.dim %memref, %c1_25 : memref<?x?xf64>
    %14 = arith.index_cast %dim_31 : index to i32
    %intptr_32 = memref.extract_aligned_pointer_as_index %memref : memref<?x?xf64> -> index
    %15 = arith.index_cast %intptr_32 : index to i64
    %16 = llvm.inttoptr %15 : i64 to !llvm.ptr
    %intptr_33 = memref.extract_aligned_pointer_as_index %memref_22 : memref<?xf64> -> index
    %17 = arith.index_cast %intptr_33 : index to i64
    %18 = llvm.inttoptr %17 : i64 to !llvm.ptr
    %subview = memref.subview %memref_4[0] [%6] [1] : memref<?xf64> to memref<?xf64, strided<[1]>>
    %intptr_34 = memref.extract_aligned_pointer_as_index %subview : memref<?xf64, strided<[1]>> -> index
    %19 = arith.index_cast %intptr_34 : index to i64
    %20 = llvm.inttoptr %19 : i64 to !llvm.ptr
    call @polygeist_cublas_dgemv_T(%arg1, %arg0, %cst, %16, %14, %18, %cst_27, %20) : (i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, f64, !llvm.ptr) -> ()
    %dim_35 = memref.dim %memref, %c1_25 : memref<?x?xf64>
    %21 = arith.index_cast %dim_35 : index to i32
    %intptr_36 = memref.extract_aligned_pointer_as_index %memref : memref<?x?xf64> -> index
    %22 = arith.index_cast %intptr_36 : index to i64
    %23 = llvm.inttoptr %22 : i64 to !llvm.ptr
    %intptr_37 = memref.extract_aligned_pointer_as_index %memref_16 : memref<?xf64> -> index
    %24 = arith.index_cast %intptr_37 : index to i64
    %25 = llvm.inttoptr %24 : i64 to !llvm.ptr
    %subview_38 = memref.subview %memref_10[0] [%10] [1] : memref<?xf64> to memref<?xf64, strided<[1]>>
    %intptr_39 = memref.extract_aligned_pointer_as_index %subview_38 : memref<?xf64, strided<[1]>> -> index
    %26 = arith.index_cast %intptr_39 : index to i64
    %27 = llvm.inttoptr %26 : i64 to !llvm.ptr
    call @polygeist_cublas_dgemv(%arg1, %arg0, %cst, %23, %21, %25, %cst_27, %27) : (i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, f64, !llvm.ptr) -> ()
    ...
    call @polygeist_gpu_region_timing_enter(%c5_i32_42) : (i32) -> ()
    %33 = gpu.memcpy async [%32] %arg4, %memref_10 : memref<?xf64>, memref<?xf64>
    call @polygeist_gpu_region_timing_leave() : () -> ()
    %c3_i32_43 = arith.constant 3 : i32
    call @polygeist_gpu_region_timing_enter(%c3_i32_43) : (i32) -> ()
