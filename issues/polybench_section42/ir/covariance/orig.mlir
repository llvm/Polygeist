  ...
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x?xf64>, %arg4: memref<?x?xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg6 = 0 to %1 {
      ...
      affine.for %arg7 = 0 to %0 {
        %5 = affine.load %arg3[%arg7, %arg6] : memref<?x?xf64>
    ...
    affine.for %arg6 = 0 to %0 {
      affine.for %arg7 = 0 to %1 {
        ...
        %4 = affine.load %arg3[%arg6, %arg7] : memref<?x?xf64>
        %5 = arith.subf %4, %3 : f64
        affine.store %5, %arg3[%arg6, %arg7] : memref<?x?xf64>
      }
    }
    ...
    affine.for %arg6 = 0 to %1 {
      affine.for %arg7 = #map(%arg6) to %1 {
        ...
        affine.for %arg8 = 0 to %0 {
          %5 = affine.load %arg3[%arg8, %arg6] : memref<?x?xf64>
          %6 = affine.load %arg3[%arg8, %arg7] : memref<?x?xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = affine.load %arg4[%arg6, %arg7] : memref<?x?xf64>
          %9 = arith.addf %8, %7 : f64
          affine.store %9, %arg4[%arg6, %arg7] : memref<?x?xf64>
        }
        %3 = affine.load %arg4[%arg6, %arg7] : memref<?x?xf64>
        %4 = arith.divf %3, %2 : f64
        affine.store %4, %arg4[%arg6, %arg7] : memref<?x?xf64>
        affine.store %4, %arg4[%arg7, %arg6] : memref<?x?xf64>
      }
    }
    return
  }
