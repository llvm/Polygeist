module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_gesummv(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<?x?xf64>, %arg4: memref<?x?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>, polygeist.gpu_data_residency, polygeist.gpu_timing_instrumented, polygeist.gpu_timing_region_id = 486721723013172567 : i64, polygeist.pipeline_scope_coalesced} {
    ...
    %dim_30 = memref.dim %memref_12, %c0_28 : memref<?xf64>
    %7 = arith.index_cast %dim_30 : index to i32
    ...
    %dim_31 = memref.dim %memref_24, %c0_28 : memref<?xf64>
    %10 = arith.index_cast %dim_31 : index to i32
    %intptr_32 = memref.extract_aligned_pointer_as_index %memref_24 : memref<?xf64> -> index
    %11 = arith.index_cast %intptr_32 : index to i64
    %12 = llvm.inttoptr %11 : i64 to !llvm.ptr
    call @polygeist_cublas_memset_zero_1d(%10, %12) : (i32, !llvm.ptr) -> ()
    %dim_33 = memref.dim %memref, %c1_27 : memref<?x?xf64>
    %13 = arith.index_cast %dim_33 : index to i32
    %intptr_34 = memref.extract_aligned_pointer_as_index %memref : memref<?x?xf64> -> index
    %14 = arith.index_cast %intptr_34 : index to i64
    %15 = llvm.inttoptr %14 : i64 to !llvm.ptr
    %intptr_35 = memref.extract_aligned_pointer_as_index %memref_18 : memref<?xf64> -> index
    %16 = arith.index_cast %intptr_35 : index to i64
    %17 = llvm.inttoptr %16 : i64 to !llvm.ptr
    %subview = memref.subview %memref_12[0] [%6] [1] : memref<?xf64> to memref<?xf64, strided<[1]>>
    %intptr_36 = memref.extract_aligned_pointer_as_index %subview : memref<?xf64, strided<[1]>> -> index
    %18 = arith.index_cast %intptr_36 : index to i64
    %19 = llvm.inttoptr %18 : i64 to !llvm.ptr
    call @polygeist_cublas_dgemv(%arg0, %arg0, %cst, %15, %13, %17, %cst_29, %19) : (i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, f64, !llvm.ptr) -> ()
    %dim_37 = memref.dim %memref_6, %c1_27 : memref<?x?xf64>
    %20 = arith.index_cast %dim_37 : index to i32
    %intptr_38 = memref.extract_aligned_pointer_as_index %memref_6 : memref<?x?xf64> -> index
    %21 = arith.index_cast %intptr_38 : index to i64
    %22 = llvm.inttoptr %21 : i64 to !llvm.ptr
    %intptr_39 = memref.extract_aligned_pointer_as_index %memref_18 : memref<?xf64> -> index
    %23 = arith.index_cast %intptr_39 : index to i64
    %24 = llvm.inttoptr %23 : i64 to !llvm.ptr
    %subview_40 = memref.subview %memref_24[0] [%6] [1] : memref<?xf64> to memref<?xf64, strided<[1]>>
    %intptr_41 = memref.extract_aligned_pointer_as_index %subview_40 : memref<?xf64, strided<[1]>> -> index
    %25 = arith.index_cast %intptr_41 : index to i64
    %26 = llvm.inttoptr %25 : i64 to !llvm.ptr
    call @polygeist_cublas_dgemv(%arg0, %arg0, %cst, %22, %20, %24, %cst_29, %26) : (i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, f64, !llvm.ptr) -> ()
    %dim_42 = memref.dim %memref_24, %c0_28 : memref<?xf64>
    %27 = arith.index_cast %dim_42 : index to i32
    %intptr_43 = memref.extract_aligned_pointer_as_index %memref_12 : memref<?xf64> -> index
    %28 = arith.index_cast %intptr_43 : index to i64
    %29 = llvm.inttoptr %28 : i64 to !llvm.ptr
    %intptr_44 = memref.extract_aligned_pointer_as_index %memref_24 : memref<?xf64> -> index
    %30 = arith.index_cast %intptr_44 : index to i64
