module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<?x?xf64>, %arg7: memref<?x?xf64>, %arg8: memref<?x?xf64>, %arg9: memref<?x?xf64>, %arg10: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %subview_5 = memref.subview %arg8[0, 0] [%5, %7] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_6 = memref.subview %arg6[0, 0] [%8, %7] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %c0_7 = arith.constant 0 : index
    %dim_8 = memref.dim %subview, %c0_7 : memref<?x?xf64, strided<[?, 1], offset: ?>>
    %17 = arith.index_cast %dim_8 : index to i32
    %c1_9 = arith.constant 1 : index
    %dim_10 = memref.dim %subview, %c1_9 : memref<?x?xf64, strided<[?, 1], offset: ?>>
    %18 = arith.index_cast %dim_10 : index to i32
    %c1_11 = arith.constant 1 : index
    %dim_12 = memref.dim %subview_5, %c1_11 : memref<?x?xf64, strided<[?, 1], offset: ?>>
    %19 = arith.index_cast %dim_12 : index to i32
    ...
    %20 = arith.index_cast %intptr_13 : index to i64
    ...
    %21 = arith.index_cast %offset_15 : index to i64
    %c8_i64_18 = arith.constant 8 : i64
    %22 = arith.muli %21, %c8_i64_18 : i64
    ...
    %25 = arith.index_cast %intptr_19 : index to i64
    ...
    %26 = arith.index_cast %offset_21 : index to i64
    %c8_i64_24 = arith.constant 8 : i64
    %27 = arith.muli %26, %c8_i64_24 : i64
    ...
    %30 = arith.index_cast %intptr_25 : index to i64
    ...
    %31 = arith.index_cast %offset_27 : index to i64
    %c8_i64_30 = arith.constant 8 : i64
    %32 = arith.muli %31, %c8_i64_30 : i64
    %33 = arith.addi %30, %32 : i64
    %34 = llvm.inttoptr %33 : i64 to !llvm.ptr
    call @polygeist_cublas_pipeline_begin() : () -> ()
    call @polygeist_cublas_dgemm(%17, %19, %18, %arg4, %24, %18, %29, %19, %cst_4, %34, %19) : (i32, i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, i32, f64, !llvm.ptr, i32) -> ()
    %35 = bufferization.to_tensor %subview_6 restrict writable : memref<?x?xf64, strided<[?, 1], offset: ?>>
    call @polygeist_cublas_pipeline_end() : () -> ()
    ...
    %extracted_slice_31 = tensor.extract_slice %3[0, 0] [%7, %6] [1, 1] : tensor<?x?xf64> to tensor<?x?xf64>
    %extracted_slice_32 = tensor.extract_slice %4[0, 0] [%8, %6] [1, 1] : tensor<?x?xf64> to tensor<?x?xf64>
    %cst_33 = arith.constant 1.000000e+00 : f64
    %subview_34 = memref.subview %arg9[0, 0] [%7, %6] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_35 = memref.subview %arg10[0, 0] [%8, %6] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %c0_36 = arith.constant 0 : index
    %dim_37 = memref.dim %subview_6, %c0_36 : memref<?x?xf64, strided<[?, 1], offset: ?>>
    %37 = arith.index_cast %dim_37 : index to i32
    %c1_38 = arith.constant 1 : index
    %dim_39 = memref.dim %subview_6, %c1_38 : memref<?x?xf64, strided<[?, 1], offset: ?>>
    %38 = arith.index_cast %dim_39 : index to i32
    %c1_40 = arith.constant 1 : index
    %dim_41 = memref.dim %subview_34, %c1_40 : memref<?x?xf64, strided<[?, 1], offset: ?>>
    %39 = arith.index_cast %dim_41 : index to i32
    %intptr_42 = memref.extract_aligned_pointer_as_index %subview_6 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %40 = arith.index_cast %intptr_42 : index to i64
    %base_buffer_43, %offset_44, %sizes_45:2, %strides_46:2 = memref.extract_strided_metadata %subview_6 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %41 = arith.index_cast %offset_44 : index to i64
    %c8_i64_47 = arith.constant 8 : i64
    %42 = arith.muli %41, %c8_i64_47 : i64
    %43 = arith.addi %40, %42 : i64
    %44 = llvm.inttoptr %43 : i64 to !llvm.ptr
    %intptr_48 = memref.extract_aligned_pointer_as_index %subview_34 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %45 = arith.index_cast %intptr_48 : index to i64
    %base_buffer_49, %offset_50, %sizes_51:2, %strides_52:2 = memref.extract_strided_metadata %subview_34 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %46 = arith.index_cast %offset_50 : index to i64
    %c8_i64_53 = arith.constant 8 : i64
    %47 = arith.muli %46, %c8_i64_53 : i64
    %48 = arith.addi %45, %47 : i64
    %49 = llvm.inttoptr %48 : i64 to !llvm.ptr
    %intptr_54 = memref.extract_aligned_pointer_as_index %subview_35 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %50 = arith.index_cast %intptr_54 : index to i64
    %base_buffer_55, %offset_56, %sizes_57:2, %strides_58:2 = memref.extract_strided_metadata %subview_35 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %51 = arith.index_cast %offset_56 : index to i64
    %c8_i64_59 = arith.constant 8 : i64
    %52 = arith.muli %51, %c8_i64_59 : i64
    %53 = arith.addi %50, %52 : i64
    %54 = llvm.inttoptr %53 : i64 to !llvm.ptr
    call @polygeist_cublas_pipeline_begin() : () -> ()
    call @polygeist_cublas_dgemm(%37, %39, %38, %cst_33, %44, %38, %49, %39, %arg5, %54, %39) : (i32, i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, i32, f64, !llvm.ptr, i32) -> ()
    %55 = bufferization.to_tensor %subview_35 restrict writable : memref<?x?xf64, strided<[?, 1], offset: ?>>
