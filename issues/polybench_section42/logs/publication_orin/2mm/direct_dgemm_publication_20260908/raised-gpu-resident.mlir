module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<?x?xf64>, %arg7: memref<?x?xf64>, %arg8: memref<?x?xf64>, %arg9: memref<?x?xf64>, %arg10: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>, polygeist.gpu_data_residency} {
    ...
    %dim_28 = memref.dim %memref, %c0_26 : memref<?x?xf64>
    %10 = arith.index_cast %dim_28 : index to i32
    %dim_29 = memref.dim %memref, %c1_25 : memref<?x?xf64>
    %11 = arith.index_cast %dim_29 : index to i32
    ...
    %subview_30 = memref.subview %memref_11[0, 0] [%6, %8] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_31 = memref.subview %memref[0, 0] [%9, %8] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    call @polygeist_cublas_pipeline_end() : () -> ()
    %intptr_32 = memref.extract_aligned_pointer_as_index %subview : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %14 = arith.index_cast %intptr_32 : index to i64
    ...
    %intptr_33 = memref.extract_aligned_pointer_as_index %subview_30 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %19 = arith.index_cast %intptr_33 : index to i64
    %base_buffer_34, %offset_35, %sizes_36:2, %strides_37:2 = memref.extract_strided_metadata %subview_30 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %20 = arith.index_cast %offset_35 : index to i64
    %21 = arith.muli %20, %c8_i64 : i64
    %22 = arith.addi %19, %21 : i64
    %23 = llvm.inttoptr %22 : i64 to !llvm.ptr
    %intptr_38 = memref.extract_aligned_pointer_as_index %subview_31 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %24 = arith.index_cast %intptr_38 : index to i64
    %base_buffer_39, %offset_40, %sizes_41:2, %strides_42:2 = memref.extract_strided_metadata %subview_31 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %25 = arith.index_cast %offset_40 : index to i64
    %26 = arith.muli %25, %c8_i64 : i64
    %27 = arith.addi %24, %26 : i64
    %28 = llvm.inttoptr %27 : i64 to !llvm.ptr
    call @polygeist_cublas_pipeline_begin() : () -> ()
    call @polygeist_cublas_dgemm(%arg0, %arg1, %arg2, %arg4, %18, %arg2, %23, %arg1, %cst_27, %28, %arg1) : (i32, i32, i32, f64, !llvm.ptr, i32, !llvm.ptr, i32, f64, !llvm.ptr, i32) -> ()
    call @polygeist_cublas_pipeline_end() : () -> ()
    %subview_43 = memref.subview %memref_17[0, 0] [%8, %7] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_44 = memref.subview %memref_23[0, 0] [%9, %7] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %intptr_45 = memref.extract_aligned_pointer_as_index %subview_31 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %29 = arith.index_cast %intptr_45 : index to i64
    %base_buffer_46, %offset_47, %sizes_48:2, %strides_49:2 = memref.extract_strided_metadata %subview_31 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %30 = arith.index_cast %offset_47 : index to i64
    ...
    %34 = arith.index_cast %intptr_50 : index to i64
    ...
    %35 = arith.index_cast %offset_52 : index to i64
    %36 = arith.muli %35, %c8_i64 : i64
    %37 = arith.addi %34, %36 : i64
    %38 = llvm.inttoptr %37 : i64 to !llvm.ptr
    %intptr_55 = memref.extract_aligned_pointer_as_index %subview_44 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %39 = arith.index_cast %intptr_55 : index to i64
    %base_buffer_56, %offset_57, %sizes_58:2, %strides_59:2 = memref.extract_strided_metadata %subview_44 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %40 = arith.index_cast %offset_57 : index to i64
