module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<?x?xf64>, %arg6: memref<?x?xf64>, %arg7: memref<?x?xf64>, %arg8: memref<?x?xf64>, %arg9: memref<?x?xf64>, %arg10: memref<?x?xf64>, %arg11: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>, polygeist.gpu_data_residency, polygeist.gpu_timing_instrumented, polygeist.gpu_timing_region_id = -1890640588580836432 : i64, polygeist.pipeline_scope_coalesced} {
    ...
    %dim_51 = memref.dim %memref, %c0_50 : memref<?x?xf64>
    %13 = arith.index_cast %dim_51 : index to i32
    %dim_52 = memref.dim %memref, %c1_49 : memref<?x?xf64>
    %14 = arith.index_cast %dim_52 : index to i32
    ...
    %subview_53 = memref.subview %memref_14[0, 0] [%9, %8] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_54 = memref.subview %memref[0, 0] [%12, %8] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %intptr_55 = memref.extract_aligned_pointer_as_index %subview : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %17 = arith.index_cast %intptr_55 : index to i64
    ...
    %intptr_56 = memref.extract_aligned_pointer_as_index %subview_53 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %22 = arith.index_cast %intptr_56 : index to i64
    %base_buffer_57, %offset_58, %sizes_59:2, %strides_60:2 = memref.extract_strided_metadata %subview_53 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %23 = arith.index_cast %offset_58 : index to i64
    %24 = arith.muli %23, %c8_i64 : i64
    %25 = arith.addi %22, %24 : i64
    %26 = llvm.inttoptr %25 : i64 to !llvm.ptr
    %intptr_61 = memref.extract_aligned_pointer_as_index %subview_54 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %27 = arith.index_cast %intptr_61 : index to i64
    %base_buffer_62, %offset_63, %sizes_64:2, %strides_65:2 = memref.extract_strided_metadata %subview_54 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %28 = arith.index_cast %offset_63 : index to i64
    ...
    %dim_66 = memref.dim %memref_22, %c0_50 : memref<?x?xf64>
    %32 = arith.index_cast %dim_66 : index to i32
    %dim_67 = memref.dim %memref_22, %c1_49 : memref<?x?xf64>
    %33 = arith.index_cast %dim_67 : index to i32
    %intptr_68 = memref.extract_aligned_pointer_as_index %memref_22 : memref<?x?xf64> -> index
    %34 = arith.index_cast %intptr_68 : index to i64
    %35 = llvm.inttoptr %34 : i64 to !llvm.ptr
    call @polygeist_cublas_memset_zero_2d(%32, %33, %35, %33) : (i32, i32, !llvm.ptr, i32) -> ()
    %subview_69 = memref.subview %memref_30[0, 0] [%8, %10] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_70 = memref.subview %memref_38[0, 0] [%10, %11] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %subview_71 = memref.subview %memref_22[0, 0] [%8, %11] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %intptr_72 = memref.extract_aligned_pointer_as_index %subview_69 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %36 = arith.index_cast %intptr_72 : index to i64
    %base_buffer_73, %offset_74, %sizes_75:2, %strides_76:2 = memref.extract_strided_metadata %subview_69 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %37 = arith.index_cast %offset_74 : index to i64
    %38 = arith.muli %37, %c8_i64 : i64
    %39 = arith.addi %36, %38 : i64
    %40 = llvm.inttoptr %39 : i64 to !llvm.ptr
    %intptr_77 = memref.extract_aligned_pointer_as_index %subview_70 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %41 = arith.index_cast %intptr_77 : index to i64
    %base_buffer_78, %offset_79, %sizes_80:2, %strides_81:2 = memref.extract_strided_metadata %subview_70 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %42 = arith.index_cast %offset_79 : index to i64
    %43 = arith.muli %42, %c8_i64 : i64
    %44 = arith.addi %41, %43 : i64
    %45 = llvm.inttoptr %44 : i64 to !llvm.ptr
    %intptr_82 = memref.extract_aligned_pointer_as_index %subview_71 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %46 = arith.index_cast %intptr_82 : index to i64
    %base_buffer_83, %offset_84, %sizes_85:2, %strides_86:2 = memref.extract_strided_metadata %subview_71 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %47 = arith.index_cast %offset_84 : index to i64
    ...
    %dim_87 = memref.dim %memref_46, %c0_50 : memref<?x?xf64>
    %51 = arith.index_cast %dim_87 : index to i32
    %dim_88 = memref.dim %memref_46, %c1_49 : memref<?x?xf64>
    %52 = arith.index_cast %dim_88 : index to i32
    %intptr_89 = memref.extract_aligned_pointer_as_index %memref_46 : memref<?x?xf64> -> index
    %53 = arith.index_cast %intptr_89 : index to i64
    %54 = llvm.inttoptr %53 : i64 to !llvm.ptr
    call @polygeist_cublas_memset_zero_2d(%51, %52, %54, %52) : (i32, i32, !llvm.ptr, i32) -> ()
    %subview_90 = memref.subview %memref_46[0, 0] [%12, %11] [1, 1] : memref<?x?xf64> to memref<?x?xf64, strided<[?, 1], offset: ?>>
    %intptr_91 = memref.extract_aligned_pointer_as_index %subview_54 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %55 = arith.index_cast %intptr_91 : index to i64
    %base_buffer_92, %offset_93, %sizes_94:2, %strides_95:2 = memref.extract_strided_metadata %subview_54 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %56 = arith.index_cast %offset_93 : index to i64
    %57 = arith.muli %56, %c8_i64 : i64
    %58 = arith.addi %55, %57 : i64
    %59 = llvm.inttoptr %58 : i64 to !llvm.ptr
    %intptr_96 = memref.extract_aligned_pointer_as_index %subview_71 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %60 = arith.index_cast %intptr_96 : index to i64
    %base_buffer_97, %offset_98, %sizes_99:2, %strides_100:2 = memref.extract_strided_metadata %subview_71 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %61 = arith.index_cast %offset_98 : index to i64
    %62 = arith.muli %61, %c8_i64 : i64
    %63 = arith.addi %60, %62 : i64
    %64 = llvm.inttoptr %63 : i64 to !llvm.ptr
    %intptr_101 = memref.extract_aligned_pointer_as_index %subview_90 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> index
    %65 = arith.index_cast %intptr_101 : index to i64
    %base_buffer_102, %offset_103, %sizes_104:2, %strides_105:2 = memref.extract_strided_metadata %subview_90 : memref<?x?xf64, strided<[?, 1], offset: ?>> -> memref<f64>, index, index, index, index, index
    %66 = arith.index_cast %offset_103 : index to i64
