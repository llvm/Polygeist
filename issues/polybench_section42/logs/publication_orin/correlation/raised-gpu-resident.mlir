module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x?xf64>, %arg4: memref<?x?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>, polygeist.gpu_data_residency} {
    ...
    %5 = arith.index_cast %dim_17 : index to i32
    %dim_18 = memref.dim %memref, %c1_15 : memref<?x?xf64>
    %6 = arith.index_cast %dim_18 : index to i32
    ...
    %intptr_19 = memref.extract_aligned_pointer_as_index %memref_5 : memref<?x?xf64> -> index
    %10 = arith.index_cast %intptr_19 : index to i64
    %11 = llvm.inttoptr %10 : i64 to !llvm.ptr
    %base_buffer_20, %offset_21, %sizes_22:2, %strides_23:2 = memref.extract_strided_metadata %memref_5 : memref<?x?xf64> -> memref<f64>, index, index, index, index, index
    %12 = arith.index_cast %strides_23#0 : index to i32
    %intptr_24 = memref.extract_aligned_pointer_as_index %memref_9 : memref<?xf64> -> index
    %13 = arith.index_cast %intptr_24 : index to i64
    %14 = llvm.inttoptr %13 : i64 to !llvm.ptr
    %intptr_25 = memref.extract_aligned_pointer_as_index %memref_13 : memref<?xf64> -> index
    %15 = arith.index_cast %intptr_25 : index to i64
    ...
    %20 = gpu.memcpy async [%19] %arg4, %memref_5 : memref<?x?xf64>, memref<?x?xf64>
    %21 = gpu.dealloc async [%20] %memref_5 : memref<?x?xf64>
    %22 = gpu.memcpy async [%21] %arg5, %memref_9 : memref<?xf64>, memref<?xf64>
    %23 = gpu.dealloc async [%22] %memref_9 : memref<?xf64>
    %24 = gpu.memcpy async [%23] %arg6, %memref_13 : memref<?xf64>, memref<?xf64>
    %25 = gpu.dealloc async [%24] %memref_13 : memref<?xf64>
    gpu.wait [%25]
    return
  }
