...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  gpu.module @__polygeist_gpu_module [#nvvm.target<O = 3, chip = "sm_87">]  {
    llvm.func @kernel_gemver_kernel94051337448048(%arg0: i64, %arg1: i64, %arg2: !llvm.ptr, %arg3: !llvm.ptr, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: i64, %arg8: i64, %arg9: !llvm.ptr, %arg10: !llvm.ptr, %arg11: i64, %arg12: i64, %arg13: i64, %arg14: i64, %arg15: i64) attributes {gpu.kernel, gpu.known_block_size = array<i32: 1, 1, 1>, nvvm.kernel} {
      ...
      llvm.br ^bb1
    ^bb1:  // pred: ^bb0
      %4 = llvm.mul %1, %arg0  : i64
      %5 = llvm.add %4, %arg1  : i64
      %6 = llvm.mul %3, %arg0  : i64
      %7 = llvm.add %6, %arg1  : i64
      %8 = llvm.getelementptr %arg3[%arg4] : (!llvm.ptr, i64) -> !llvm.ptr, f64
      %9 = llvm.mul %5, %arg7  : i64
      %10 = llvm.add %9, %7  : i64
      %11 = llvm.getelementptr %8[%10] : (!llvm.ptr, i64) -> !llvm.ptr, f64
      %12 = llvm.load %11 : !llvm.ptr -> f64
      %13 = llvm.getelementptr %arg10[%arg11] : (!llvm.ptr, i64) -> !llvm.ptr, f64
      %14 = llvm.mul %5, %arg14  : i64
      %15 = llvm.add %14, %7  : i64
      %16 = llvm.getelementptr %13[%15] : (!llvm.ptr, i64) -> !llvm.ptr, f64
      llvm.store %12, %16 : f64, !llvm.ptr
      llvm.return
    }
    llvm.func @kernel_gemver_kernel94051337811360(%arg0: i64, %arg1: i64, %arg2: !llvm.ptr, %arg3: !llvm.ptr, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: !llvm.ptr, %arg8: !llvm.ptr, %arg9: i64, %arg10: i64, %arg11: i64) attributes {gpu.kernel, gpu.known_block_size = array<i32: 1, 1, 1>, nvvm.kernel} {
      %0 = nvvm.read.ptx.sreg.ctaid.x : i32
      %1 = llvm.sext %0 : i32 to i64
      llvm.br ^bb1
    ^bb1:  // pred: ^bb0
      ...
      %6 = llvm.getelementptr %arg8[%3] : (!llvm.ptr, i64) -> !llvm.ptr, f64
      llvm.store %5, %6 : f64, !llvm.ptr
      llvm.return
    }
    llvm.func @kernel_gemver_kernel94051337834192(%arg0: i64, %arg1: i64, %arg2: !llvm.ptr, %arg3: !llvm.ptr, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: !llvm.ptr, %arg8: !llvm.ptr, %arg9: i64, %arg10: i64, %arg11: i64) attributes {gpu.kernel, gpu.known_block_size = array<i32: 1, 1, 1>, nvvm.kernel} {
      %0 = nvvm.read.ptx.sreg.ctaid.x : i32
      %1 = llvm.sext %0 : i32 to i64
      llvm.br ^bb1
    ^bb1:  // pred: ^bb0
  ...
  func.func @kernel_gemver(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<?x?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>, %arg8: memref<?xf64>, %arg9: memref<?xf64>, %arg10: memref<?xf64>, %arg11: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>, polygeist.gpu_data_residency, polygeist.gpu_residual_pipeline, polygeist.gpu_timing_instrumented, polygeist.gpu_timing_region_id = 6281486461887221929 : i64, polygeist.pipeline_scope_coalesced} {
    ...
    %24 = affine.apply #map(%10)[%c0_57, %c1_58]
    %25 = affine.apply #map(%10)[%c0_57, %c1_58]
    ...
    %37 = affine.apply #map(%10)[%c0_57, %c1_58]
    ...
    %54 = affine.apply #map(%10)[%c0_57, %c1_58]
