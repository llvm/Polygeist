...
// CHECK-NEXT:     %1 = index_cast %arg4 : i32 to index
// CHECK-NEXT:     %2 = index_cast %arg2 : i32 to index
// CHECK-NEXT:     %3 = index_cast %arg5 : i32 to index
// CHECK-NEXT:     %4 = index_cast %arg3 : i32 to index
// CHECK-NEXT:     %5 = index_cast %arg6 : i32 to index
// CHECK-NEXT:     scf.parallel (%arg7, %arg8) = (%0, %1) to (%2, %3) step (%4, %5) {
// CHECK-NEXT:       %6 = index_cast %arg7 : index to i64
// CHECK-NEXT:       %7 = index_cast %arg8 : index to i64
// CHECK-NEXT:       %8 = memref.load %arg0[%arg7] : memref<?xmemref<?xf64>>
// CHECK-NEXT:       %9 = addi %6, %7 : i64
// CHECK-NEXT:       %10 = sitofp %9 : i64 to f64
