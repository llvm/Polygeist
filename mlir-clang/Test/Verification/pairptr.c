...
// CHECK-NEXT:     call @byval(%2, %c2_i32, %0) : (memref<?x2xi32>, i32, memref<1x2xi32>) -> ()
// CHECK-NEXT:     %3 = affine.load %0[0, 0] : memref<1x2xi32>
// CHECK-NEXT:     return %3 : i32
// CHECK-NEXT:   }
// CHECK:   builtin.func @byval(%arg0: memref<?x2xi32>, %arg1: i32, %arg2: memref<1x2xi32>) {
