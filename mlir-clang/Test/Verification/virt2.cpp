...
// CHECK-NEXT:     %cst = constant 3.140000e+00 : f64
...
// CHECK-NEXT:     %2 = llvm.getelementptr %1[%c0_i64, %c0_i64] : (!llvm.ptr<array<12 x i8>>, i64, i64) -> !llvm.ptr<i8>
...
// CHECK-NEXT:     %1 = llvm.getelementptr %0[%c0_i64, %c0_i64] : (!llvm.ptr<array<13 x i8>>, i64, i64) -> !llvm.ptr<i8>
...
// CHECK-NEXT:     %1 = llvm.getelementptr %0[%c0_i64, %c0_i64] : (!llvm.ptr<array<14 x i8>>, i64, i64) -> !llvm.ptr<i8>
// CHECK-NEXT:     call @_Z5printPc(%1) : (!llvm.ptr<i8>) -> ()
// CHECK-NEXT:     return
// CHECK-NEXT:   }
