...
static void kernel_syrk(int n, int m, DATA_TYPE alpha, DATA_TYPE beta,
                        DATA_TYPE POLYBENCH_2D(C, N, N, n, n),
                        DATA_TYPE POLYBENCH_2D(A, N, M, n, m)) {
  int i, j, k;
...
// CHECK:  func @kernel_syrk(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64,
// %arg4: memref<1200x1200xf64>, %arg5: memref<1200x1000xf64>) { CHECK-NEXT: %0
// = index_cast %arg0 : i32 to index CHECK-NEXT:    %1 = index_cast %arg1 : i32
// to index CHECK-NEXT:    affine.for %arg6 = 0 to %0 { CHECK-NEXT: affine.for
// %arg7 = 0 to #map(%arg6) { CHECK-NEXT:        %2 = affine.load %arg4[%arg6,
// %arg7] : memref<1200x1200xf64> CHECK-NEXT:        %3 = mulf %2, %arg3 : f64
// CHECK-NEXT:        affine.store %3, %arg4[%arg6, %arg7] :
// memref<1200x1200xf64> CHECK-NEXT:      } CHECK-NEXT:      affine.for %arg7 =
// 0 to %1 { CHECK-NEXT:        %2 = affine.load %arg5[%arg6, %arg7] :
// memref<1200x1000xf64> CHECK-NEXT:        %3 = mulf %arg2, %2 : f64
// CHECK-NEXT:        affine.for %arg8 = 0 to #map(%arg6) {
// CHECK-NEXT:          %4 = affine.load %arg5[%arg8, %arg7] :
// memref<1200x1000xf64> CHECK-NEXT:          %5 = mulf %3, %4 : f64 CHECK-NEXT:
// %6 = affine.load %arg4[%arg6, %arg8] : memref<1200x1200xf64> CHECK-NEXT: %7 =
// addf %6, %5 : f64 CHECK-NEXT:          affine.store %7, %arg4[%arg6, %arg8] :
