...
// CHECK:   func @kernel_trmm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3:
// memref<1000x1000xf64>, %arg4: memref<1000x1200xf64>) { CHECK-NEXT:     %0 =
// index_cast %arg0 : i32 to index CHECK-NEXT:     %1 = index_cast %arg1 : i32
// to index CHECK-NEXT:     affine.for %arg5 = 0 to %0 { CHECK-NEXT: affine.for
// %arg6 = 0 to %1 { CHECK-NEXT:         %2 = affine.load %arg4[%arg5, %arg6] :
// memref<1000x1200xf64> CHECK-NEXT:         affine.for %arg7 = #map(%arg5) to
// %0 { CHECK-NEXT:           %5 = affine.load %arg3[%arg7, %arg5] :
// memref<1000x1000xf64> CHECK-NEXT:           %6 = affine.load %arg4[%arg7,
// %arg6] : memref<1000x1200xf64> CHECK-NEXT:           %7 = mulf %5, %6 : f64
// CHECK-NEXT:           %8 = addf %2, %7 : f64
// CHECK-NEXT:           affine.store %8, %arg4[%arg5, %arg6] :
// memref<1000x1200xf64> CHECK-NEXT:         } CHECK-NEXT:         %3 =
// affine.load %arg4[%arg5, %arg6] : memref<1000x1200xf64> CHECK-NEXT: %4 = mulf
// %arg2, %3 : f64 CHECK-NEXT:         affine.store %4, %arg4[%arg5, %arg6] :
