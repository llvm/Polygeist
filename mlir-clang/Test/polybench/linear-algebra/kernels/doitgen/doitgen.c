...
// CHECK:   func @kernel_doitgen(%arg0: i32, %arg1: i32, %arg2: i32, %arg3:
// memref<150x140x160xf64>, %arg4: memref<160x160xf64>, %arg5: memref<160xf64>)
// { CHECK-NEXT:  %cst = constant 0.000000e+00 : f64 CHECK-NEXT:  %0 =
// index_cast %arg0 : i32 to index CHECK-NEXT:  %1 = index_cast %arg1 : i32 to
// index CHECK-NEXT:  %2 = index_cast %arg2 : i32 to index CHECK-NEXT:
// affine.for %arg6 = 0 to %0 { CHECK-NEXT:    affine.for %arg7 = 0 to %1 {
...
// CHECK-NEXT:          %4 = affine.load %arg3[%arg6, %arg7, %arg9] :
// memref<150x140x160xf64> CHECK-NEXT:          %5 = affine.load %arg4[%arg9,
// %arg8] : memref<160x160xf64> CHECK-NEXT:          %6 = mulf %4, %5 : f64
...
// CHECK-NEXT:      affine.for %arg8 = 0 to %2 {
// CHECK-NEXT:        %3 = affine.load %arg5[%arg8] : memref<160xf64>
// CHECK-NEXT:        affine.store %3, %arg3[%arg6, %arg7, %arg8] :
// memref<150x140x160xf64> CHECK-NEXT:      } CHECK-NEXT:    } CHECK-NEXT:  }
// CHECK-NEXT:  return
// CHECK-NEXT: }
