...
pair byval(pair *a, int x) { return *a; }
...
// CHECK-NEXT:     call @byval(%2, %c2_i32, %3) : (memref<?x2xi32>, i32,
// memref<?x2xi32>) -> () CHECK-NEXT:     %4 = affine.load %0[0, 0] :
// memref<1x2xi32> CHECK-NEXT:     return %4 : i32 CHECK-NEXT:   } CHECK:   func
// @byval(%arg0: memref<?x2xi32>, %arg1: i32, %arg2: memref<?x2xi32>) {
