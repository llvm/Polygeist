...
// CHECK: func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3:
// memref<1400x1200xf64>, %arg4: memref<1200x1200xf64>, %arg5: memref<1200xf64>)
// { CHECK-NEXT:  %cst = constant 0.000000e+00 : f64 CHECK-NEXT:  %cst_0 =
// constant 1.000000e+00 : f64 CHECK-NEXT:  %0 = index_cast %arg0 : i32 to index
...
// CHECK-NEXT:        %6 = affine.load %arg3[%arg7, %arg6] :
// memref<1400x1200xf64> CHECK-NEXT:        %7 = addf %3, %6 : f64 CHECK-NEXT:
// affine.store %7, %arg5[%arg6] : memref<1200xf64> CHECK-NEXT:      }
...
// CHECK-NEXT:      affine.store %cst, %arg4[%arg6, %arg7] :
// memref<1200x1200xf64> CHECK-NEXT:        %3 = affine.load %arg4[%arg6, %arg7]
// : memref<1200x1200xf64> CHECK-NEXT:        affine.for %arg8 = 0 to %1 {
// CHECK-NEXT:          %7 = affine.load %arg3[%arg8, %arg6] :
// memref<1400x1200xf64> CHECK-NEXT:          %8 = affine.load %arg3[%arg8,
// %arg7] : memref<1400x1200xf64> CHECK-NEXT:          %9 = mulf %7, %8 : f64
// CHECK-NEXT:          %10 = addf %3, %9 : f64
// CHECK-NEXT:          affine.store %10, %arg4[%arg6, %arg7] :
// memref<1200x1200xf64> CHECK-NEXT:        } CHECK-NEXT:        %4 =
// affine.load %arg4[%arg6, %arg7] : memref<1200x1200xf64> CHECK-NEXT:        %5
// = divf %4, %2 : f64 CHECK-NEXT:        affine.store %5, %arg4[%arg6, %arg7] :
// memref<1200x1200xf64> CHECK-NEXT:        %6 = affine.load %arg4[%arg6, %arg7]
// : memref<1200x1200xf64> CHECK-NEXT:        affine.store %6, %arg4[%arg7,
// %arg6] : memref<1200x1200xf64> CHECK-NEXT:      } CHECK-NEXT:  } CHECK-NEXT:
// return CHECK-NEXT:}
