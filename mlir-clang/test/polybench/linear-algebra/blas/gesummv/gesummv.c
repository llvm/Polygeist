...
// CHECK: func @kernel_gesummv(%arg0: i32, %arg1: f64, %arg2: f64, %arg3:
// memref<1300x1300xf64>, %arg4: memref<1300x1300xf64>, %arg5: memref<1300xf64>,
// %arg6: memref<1300xf64>, %arg7: memref<1300xf64>) { CHECK-NEXT:  %cst =
...
// CHECK-NEXT:      %12 = affine.load %arg4[%arg8, %arg9] :
// memref<1300x1300xf64> CHECK-NEXT:      %13 = affine.load %arg6[%arg9] :
// memref<1300xf64> CHECK-NEXT:      %14 = mulf %12, %13 : f64 CHECK-NEXT: %15 =
// addf %14, %2 : f64 CHECK-NEXT:      affine.store %15, %arg7[%arg8] :
// memref<1300xf64> CHECK-NEXT:    } CHECK-NEXT:    %3 = affine.load
// %arg5[%arg8] : memref<1300xf64> CHECK-NEXT:    %4 = mulf %arg1, %3 : f64
