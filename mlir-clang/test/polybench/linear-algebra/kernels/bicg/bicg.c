...
static void kernel_bicg(int m, int n, DATA_TYPE POLYBENCH_2D(A, N, M, n, m),
...
// CHECK:   func @kernel_bicg(%arg0: i32, %arg1: i32, %arg2:
// memref<2100x1900xf64>, %arg3: memref<1900xf64>, %arg4: memref<2100xf64>,
// %arg5: memref<1900xf64>, %arg6: memref<2100xf64>) { CHECK-NEXT:  %c0_i32 =
// constant 0 : i32 CHECK-NEXT:  %cst = constant 0.000000e+00 : f64 CHECK-NEXT:
// %0 = index_cast %arg0 : i32 to index CHECK-NEXT:  %1 = sitofp %c0_i32 : i32
// to f64 CHECK-NEXT:  affine.for %arg7 = 0 to %0 { CHECK-NEXT:    affine.store
// %1, %arg3[%arg7] : memref<1900xf64> CHECK-NEXT:  } CHECK-NEXT:  %2 =
// index_cast %arg1 : i32 to index CHECK-NEXT:  affine.for %arg7 = 0 to %2 {
