...
static void init_array(int n, DATA_TYPE POLYBENCH_1D(x1, N, n),
...
static void print_array(int n, DATA_TYPE POLYBENCH_1D(x1, N, n),
                        DATA_TYPE POLYBENCH_1D(x2, N, n))
...
static void kernel_mvt(int n, DATA_TYPE POLYBENCH_1D(x1, N, n),
                       DATA_TYPE POLYBENCH_1D(x2, N, n),
                       DATA_TYPE POLYBENCH_1D(y_1, N, n),
                       DATA_TYPE POLYBENCH_1D(y_2, N, n),
                       DATA_TYPE POLYBENCH_2D(A, N, N, n, n)) {
...
// CHECK:   func @kernel_mvt(%arg0: i32, %arg1: memref<2000xf64>, %arg2:
// memref<2000xf64>, %arg3: memref<2000xf64>, %arg4: memref<2000xf64>, %arg5:
// memref<2000x2000xf64>) { CHECK-NEXT:  %0 = index_cast %arg0 : i32 to index
