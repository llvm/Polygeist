...
// CHECK:  func @kernel_durbin(%arg0: i32, %arg1: memref<2000xf64>, %arg2:
// memref<2000xf64>) { CHECK-NEXT:      %c0 = constant 0 : index CHECK-NEXT:
// %cst = constant 1.000000e+00 : f64 CHECK-NEXT:      %c1_i32 = constant 1 :
// i32 CHECK-NEXT:      %cst_0 = constant 0.000000e+00 : f64 CHECK-NEXT:      %0
// = alloca() : memref<2000xf64> CHECK-NEXT:      %1 = alloca() : memref<1xf64>
...
// CHECK-NEXT:          %22 = affine.load %arg1[%arg3 - %arg4 - 1] :
// memref<2000xf64> CHECK-NEXT:          %23 = affine.load %arg2[%arg4] :
// memref<2000xf64> CHECK-NEXT:          %24 = mulf %22, %23 : f64 CHECK-NEXT:
// %25 = addf %16, %24 : f64 CHECK-NEXT:          affine.store %25, %3[0] :
// memref<1xf64> CHECK-NEXT:        } CHECK-NEXT:        %18 = affine.load
// %arg1[%arg3] : memref<2000xf64> CHECK-NEXT:        %19 = addf %18, %17 : f64
...
// CHECK-NEXT:          %23 = affine.load %arg2[%arg3 - %arg4 - 1] :
// memref<2000xf64> CHECK-NEXT:          %24 = mulf %21, %23 : f64 CHECK-NEXT:
// %25 = addf %22, %24 : f64 CHECK-NEXT:          affine.store %25, %0[%arg4] :
// memref<2000xf64> CHECK-NEXT:        } CHECK-NEXT:        affine.for %arg4 = 0
// to #map(%arg3) { CHECK-NEXT:          %22 = affine.load %0[%arg4] :
// memref<2000xf64> CHECK-NEXT:          affine.store %22, %arg2[%arg4] :
// memref<2000xf64> CHECK-NEXT:        } CHECK-NEXT:        affine.store %21,
// %arg2[%arg3] : memref<2000xf64> CHECK-NEXT:      } CHECK-NEXT:      return
// CHECK-NEXT:    }
