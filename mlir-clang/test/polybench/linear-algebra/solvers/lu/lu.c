...
// CHECK-NEXT:         %1 = affine.load %arg1[%arg2, %arg3] :
// memref<2000x2000xf64> CHECK-NEXT:         affine.for %arg4 = 0 to #map(%arg3)
// { CHECK-NEXT:           %5 = affine.load %arg1[%arg2, %arg4] :
// memref<2000x2000xf64> CHECK-NEXT:           %6 = affine.load %arg1[%arg4,
// %arg3] : memref<2000x2000xf64> CHECK-NEXT:           %7 = mulf %5, %6 : f64
// CHECK-NEXT:           %8 = subf %1, %7 : f64
// CHECK-NEXT:           affine.store %8, %arg1[%arg2, %arg3] :
// memref<2000x2000xf64> CHECK-NEXT:         } CHECK-NEXT:         %2 =
// affine.load %arg1[%arg3, %arg3] : memref<2000x2000xf64> CHECK-NEXT: %3 =
// affine.load %arg1[%arg2, %arg3] : memref<2000x2000xf64> CHECK-NEXT: %4 = divf
// %3, %2 : f64 CHECK-NEXT:         affine.store %4, %arg1[%arg2, %arg3] :
// memref<2000x2000xf64> CHECK-NEXT:       } CHECK-NEXT:       affine.for %arg3
// = #map(%arg2) to %0 { CHECK-NEXT:         %1 = affine.load %arg1[%arg2,
// %arg3] : memref<2000x2000xf64> CHECK-NEXT:         affine.for %arg4 = 0 to
// #map(%arg2) { CHECK-NEXT:           %2 = affine.load %arg1[%arg2, %arg4] :
// memref<2000x2000xf64> CHECK-NEXT:           %3 = affine.load %arg1[%arg4,
// %arg3] : memref<2000x2000xf64> CHECK-NEXT:           %4 = mulf %2, %3 : f64
// CHECK-NEXT:           %5 = subf %1, %4 : f64
// CHECK-NEXT:           affine.store %5, %arg1[%arg2, %arg3] :
// memref<2000x2000xf64> CHECK-NEXT:         } CHECK-NEXT:       } CHECK-NEXT: }
// CHECK-NEXT:     return
// CHECK-NEXT:   }
