...
static void init_array(int n, DATA_TYPE POLYBENCH_2D(L, N, N, n, n),
...
static void kernel_trisolv(int n, DATA_TYPE POLYBENCH_2D(L, N, N, n, n),
                           DATA_TYPE POLYBENCH_1D(x, N, n),
                           DATA_TYPE POLYBENCH_1D(b, N, n)) {
  int i, j;
...
// CHECK:   func @kernel_trisolv(%arg0: i32, %arg1: memref<2000x2000xf64>,
// %arg2: memref<2000xf64>, %arg3: memref<2000xf64>) { CHECK-NEXT:     %0 =
// index_cast %arg0 : i32 to index CHECK-NEXT:     affine.for %arg4 = 0 to %0 {
...
// CHECK-NEXT:         %6 = affine.load %arg1[%arg4, %arg5] :
// memref<2000x2000xf64> CHECK-NEXT:         %7 = affine.load %arg2[%arg5] :
// memref<2000xf64> CHECK-NEXT:         %8 = mulf %6, %7 : f64 CHECK-NEXT: %9 =
// subf %2, %8 : f64 CHECK-NEXT:         affine.store %9, %arg2[%arg4] :
// memref<2000xf64> CHECK-NEXT:       } CHECK-NEXT:       %3 = affine.load
// %arg2[%arg4] : memref<2000xf64> CHECK-NEXT:       %4 = affine.load
// %arg1[%arg4, %arg4] : memref<2000x2000xf64> CHECK-NEXT:       %5 = divf %3,
// %4 : f64 CHECK-NEXT:       affine.store %5, %arg2[%arg4] : memref<2000xf64>
// CHECK-NEXT:     }
// CHECK-NEXT:     return
// CHECK-NEXT:   }
