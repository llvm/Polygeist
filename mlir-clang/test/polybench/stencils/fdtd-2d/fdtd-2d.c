...
// CHECK:    func @kernel_fdtd_2d(%arg0: i32, %arg1: i32, %arg2: i32, %arg3:
// memref<1000x1200xf64>, %arg4: memref<1000x1200xf64>, %arg5:
// memref<1000x1200xf64>, %arg6: memref<500xf64>) { CHECK-NEXT:    %cst =
// constant 5.000000e-01 : f64 CHECK-NEXT:    %cst_0 = constant
// 0.69999999999999996 : f64 CHECK-NEXT:    %0 = index_cast %arg1 : i32 to index
...
// CHECK-NEXT:          %4 = affine.load %arg4[%arg8, %arg9] :
// memref<1000x1200xf64> CHECK-NEXT:          %5 = affine.load %arg5[%arg8,
// %arg9] : memref<1000x1200xf64> CHECK-NEXT:          %6 = affine.load
// %arg5[%arg8 - 1, %arg9] : memref<1000x1200xf64> CHECK-NEXT:          %7 =
// subf %5, %6 : f64 CHECK-NEXT:          %8 = mulf %cst, %7 : f64 CHECK-NEXT:
// %9 = subf %4, %8 : f64 CHECK-NEXT:          affine.store %9, %arg4[%arg8,
// %arg9] : memref<1000x1200xf64> CHECK-NEXT:        } CHECK-NEXT:      }
// CHECK-NEXT:      affine.for %arg8 = 0 to %0 {
// CHECK-NEXT:        affine.for %arg9 = 1 to %1 {
// CHECK-NEXT:          %4 = affine.load %arg3[%arg8, %arg9] :
// memref<1000x1200xf64> CHECK-NEXT:          %5 = affine.load %arg5[%arg8,
// %arg9] : memref<1000x1200xf64> CHECK-NEXT:          %6 = affine.load
// %arg5[%arg8, %arg9 - 1] : memref<1000x1200xf64> CHECK-NEXT:          %7 =
// subf %5, %6 : f64 CHECK-NEXT:          %8 = mulf %cst, %7 : f64 CHECK-NEXT:
// %9 = subf %4, %8 : f64 CHECK-NEXT:          affine.store %9, %arg3[%arg8,
// %arg9] : memref<1000x1200xf64> CHECK-NEXT:        } CHECK-NEXT:      }
// CHECK-NEXT:      affine.for %arg8 = 0 to #map()[%0] {
// CHECK-NEXT:        affine.for %arg9 = 0 to #map()[%1] {
// CHECK-NEXT:          %4 = affine.load %arg5[%arg8, %arg9] :
// memref<1000x1200xf64> CHECK-NEXT:          %5 = affine.load %arg3[%arg8,
// %arg9 + 1] : memref<1000x1200xf64> CHECK-NEXT:          %6 = affine.load
// %arg3[%arg8, %arg9] : memref<1000x1200xf64> CHECK-NEXT:          %7 = subf
// %5, %6 : f64 CHECK-NEXT:          %8 = affine.load %arg4[%arg8 + 1, %arg9] :
// memref<1000x1200xf64> CHECK-NEXT:          %9 = addf %7, %8 : f64 CHECK-NEXT:
// %10 = affine.load %arg4[%arg8, %arg9] : memref<1000x1200xf64> CHECK-NEXT: %11
// = subf %9, %10 : f64 CHECK-NEXT:          %12 = mulf %cst_0, %11 : f64
// CHECK-NEXT:          %13 = subf %4, %12 : f64
// CHECK-NEXT:          affine.store %13, %arg5[%arg8, %arg9] :
// memref<1000x1200xf64> CHECK-NEXT:        } CHECK-NEXT:      } CHECK-NEXT: }
// CHECK-NEXT:    return
// CHECK-NEXT:  }
