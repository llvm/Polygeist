...
void ForOp::getCanonicalizationPatterns(RewritePatternSet &results,
  ...
  results.insert<ForOpIterArgsFolder, SimplifyTrivialLoops, RemoveUnusedArgs,
                  ...
                  DropConstantReturn, DropYieldedInput>(
      context);
}
...
void WhileOp::getCanonicalizationPatterns(OwningRewritePatternList &results,
                                          MLIRContext *context) {
  results.insert<MoveWhileDown, RemoveUnusedCondVar,
                 MoveSideEffectFreeWhile, MoveWhileToFor>(context);
}

void IfOp::getCanonicalizationPatterns(RewritePatternSet &results,
                                       MLIRContext *context) {
  results.insert<CombineIfs, ConditionPropagation, RemoveUnusedResults, RemoveStaticCondition, RemoveBoolean, ConvertTrivialIfToSelect>(
      context);
}
