...
func private @kernel_gemm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: f64, %arg4: f64, %arg5: memref<1000x1100xf64>, %arg6: memref<1000x1200xf64>, %arg7: memref<1200x1100xf64>) {
    ...
    ^bb0(%arg8: i32):  // no predecessors
      ...
      ^bb0(%arg9: i32):  // no predecessors
        ...
        %6 = memref.load %arg5[%1, %5] : memref<1000x1100xf64>
        %7 = mulf %6, %arg4 : f64
        memref.store %7, %arg5[%1, %5] : memref<1000x1100xf64>
      ...
      ^bb0(%arg9: i32):  // no predecessors
        ...
        ^bb0(%arg10: i32):  // no predecessors
          ...
          %9 = memref.load %arg6[%1, %5] : memref<1000x1200xf64>
          %10 = mulf %arg3, %9 : f64
          %11 = memref.load %arg7[%5, %8] : memref<1200x1100xf64>
          %12 = mulf %10, %11 : f64
          %13 = memref.load %arg5[%1, %8] : memref<1000x1100xf64>
          %14 = addf %13, %12 : f64
          memref.store %14, %arg5[%1, %8] : memref<1000x1100xf64>
...
func private @kernel_gemver(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<2000x2000xf64>, %arg4: memref<2000xf64>, %arg5: memref<2000xf64>, %arg6: memref<2000xf64>, %arg7: memref<2000xf64>, %arg8: memref<2000xf64>, %arg9: memref<2000xf64>, %arg10: memref<2000xf64>, %arg11: memref<2000xf64>) {
    ...
    ^bb0(%arg12: i32, %arg13: i32):  // no predecessors
      ...
      ^bb0(%arg14: i32):  // no predecessors
        ...
        %8 = memref.load %arg3[%4, %7] : memref<2000x2000xf64>
        %9 = memref.load %arg4[%4] : memref<2000xf64>
        %10 = memref.load %arg5[%7] : memref<2000xf64>
        %11 = mulf %9, %10 : f64
        %12 = addf %8, %11 : f64
        %13 = memref.load %arg6[%4] : memref<2000xf64>
        %14 = memref.load %arg7[%7] : memref<2000xf64>
        %15 = mulf %13, %14 : f64
        %16 = addf %12, %15 : f64
        memref.store %16, %arg3[%4, %7] : memref<2000x2000xf64>
    ...
    ^bb0(%arg12: i32, %arg13: i32):  // no predecessors
      ...
      ^bb0(%arg14: i32):  // no predecessors
        %7 = index_cast %arg14 : i32 to index
        %8 = memref.load %arg9[%4] : memref<2000xf64>
        %9 = memref.load %arg3[%7, %4] : memref<2000x2000xf64>
        %10 = mulf %arg2, %9 : f64
        %11 = memref.load %arg10[%7] : memref<2000xf64>
        %12 = mulf %10, %11 : f64
        %13 = addf %8, %12 : f64
        memref.store %13, %arg9[%4] : memref<2000xf64>
    ...
    ^bb0(%arg12: i32, %arg13: i32):  // no predecessors
      %4 = index_cast %arg13 : i32 to index
      %5 = memref.load %arg9[%4] : memref<2000xf64>
      %6 = memref.load %arg11[%4] : memref<2000xf64>
      %7 = addf %5, %6 : f64
      memref.store %7, %arg9[%4] : memref<2000xf64>
    ...
    ^bb0(%arg12: i32):  // no predecessors
      ...
      ^bb0(%arg13: i32):  // no predecessors
        ...
        %8 = memref.load %arg8[%4] : memref<2000xf64>
        %9 = memref.load %arg3[%4, %7] : memref<2000x2000xf64>
        %10 = mulf %arg1, %9 : f64
        %11 = memref.load %arg9[%7] : memref<2000xf64>
        %12 = mulf %10, %11 : f64
        %13 = addf %8, %12 : f64
        memref.store %13, %arg8[%4] : memref<2000xf64>
    ...
    ^bb0(%arg7: i32):  // no predecessors
      ...
      ^bb0(%arg8: i32):  // no predecessors
        ...
        ^bb0(%arg9: f64, %arg10: i32):  // no predecessors
          ...
          %18 = memref.load %arg6[%1, %4] : memref<1000x1200xf64>
          %19 = mulf %arg2, %18 : f64
          %20 = memref.load %arg5[%1, %17] : memref<1000x1000xf64>
          %21 = mulf %19, %20 : f64
          %22 = memref.load %arg4[%17, %4] : memref<1000x1200xf64>
          %23 = addf %22, %21 : f64
          memref.store %23, %arg4[%17, %4] : memref<1000x1200xf64>
          %24 = memref.load %arg6[%17, %4] : memref<1000x1200xf64>
          %25 = memref.load %arg5[%1, %17] : memref<1000x1000xf64>
          %26 = mulf %24, %25 : f64
          %27 = addf %arg9, %26 : f64
          %28 = addi %arg10, %c1_i32 : i32
          scf.yield %28, %27 : i32, f64
        }
        %7 = memref.load %arg4[%1, %4] : memref<1000x1200xf64>
        %8 = mulf %arg3, %7 : f64
        %9 = memref.load %arg6[%1, %4] : memref<1000x1200xf64>
        %10 = mulf %arg2, %9 : f64
        %11 = memref.load %arg5[%1, %1] : memref<1000x1000xf64>
        %12 = mulf %10, %11 : f64
        %13 = addf %8, %12 : f64
        %14 = mulf %arg2, %6#0 : f64
        %15 = addf %13, %14 : f64
        memref.store %15, %arg4[%1, %4] : memref<1000x1200xf64>
