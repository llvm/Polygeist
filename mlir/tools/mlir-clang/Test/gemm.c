...
// CHECK-NEXT:      %13 = load %2[%arg0, %arg1] : memref<1024x1024xf32>
// CHECK-NEXT:      affine.for %arg2 = 0 to 1024 {
// CHECK-NEXT:        %14 = load %0[%arg0, %arg2] : memref<1024x1024xf32>
// CHECK-NEXT:        %15 = mulf %3, %14 : f32
// CHECK-NEXT:        %16 = load %1[%arg2, %arg1] : memref<1024x1024xf32>
// CHECK-NEXT:        %17 = mulf %15, %16 : f32
// CHECK-NEXT:        %18 = addf %13, %17 : f32
// CHECK-NEXT:        store %18, %2[%arg0, %arg1] : memref<1024x1024xf32>
// CHECK-NEXT:      }
// CHECK-NEXT:    }
// CHECK-NEXT:  }
