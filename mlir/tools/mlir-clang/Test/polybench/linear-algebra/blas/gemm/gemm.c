...
// CHECK-NEXT:     call @init_array(%c1000_i32, %c1100_i32, %c1200_i32, %5, %6, %2, %3, %4) : (i32, i32, i32, memref<?xf64>, memref<?xf64>, memref<1000x1100xf64>, memref<1000x1200xf64>, memref<1200x1100xf64>) -> ()
// CHECK-NEXT:     %7 = load %0[%c0] : memref<1xf64>
// CHECK-NEXT:     %8 = load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     call @kernel_gemm(%c1000_i32, %c1100_i32, %c1200_i32, %7, %8, %2, %3, %4) : (i32, i32, i32, f64, f64, memref<1000x1100xf64>, memref<1000x1200xf64>, memref<1200x1100xf64>) -> ()
...
// CHECK-NEXT:       call @print_array(%c1000_i32, %c1100_i32, %2) : (i32, i32, memref<1000x1100xf64>) -> ()
// CHECK-NEXT:     }
