...
// CHECK-NEXT:     %3 = alloc() : memref<1200x1000xf64>
// CHECK-NEXT:     %4 = alloc() : memref<1200x1000xf64>
// CHECK-NEXT:     %5 = memref_cast %0 : memref<1xf64> to memref<?xf64>
// CHECK-NEXT:     %6 = memref_cast %1 : memref<1xf64> to memref<?xf64>
// CHECK-NEXT:     %7 = memref_cast %2 : memref<1200x1200xf64> to memref<?x1200xf64>
// CHECK-NEXT:     %8 = memref_cast %7 : memref<?x1200xf64> to memref<1200x1200xf64>
// CHECK-NEXT:     %9 = memref_cast %3 : memref<1200x1000xf64> to memref<?x1000xf64>
// CHECK-NEXT:     %10 = memref_cast %9 : memref<?x1000xf64> to memref<1200x1000xf64>
// CHECK-NEXT:     %11 = memref_cast %4 : memref<1200x1000xf64> to memref<?x1000xf64>
// CHECK-NEXT:     %12 = memref_cast %11 : memref<?x1000xf64> to memref<1200x1000xf64>
// CHECK-NEXT:     call @init_array(%c1200_i32, %c1000_i32, %5, %6, %8, %10, %12) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<1200x1200xf64>, memref<1200x1000xf64>, memref<1200x1000xf64>) -> ()
// CHECK-NEXT:     %13 = load %0[%c0] : memref<1xf64>
// CHECK-NEXT:     %14 = load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     call @kernel_syr2k(%c1200_i32, %c1000_i32, %13, %14, %8, %10, %12) : (i32, i32, f64, f64, memref<1200x1200xf64>, memref<1200x1000xf64>, memref<1200x1000xf64>) -> ()
...
// CHECK-NEXT:       call @print_array(%c1200_i32, %8) : (i32, memref<1200x1200xf64>) -> ()
// CHECK-NEXT:     }
...
// CHECK-NEXT:     store %11, %arg5[%4, %5] : memref<1200x1000xf64>
// CHECK-NEXT:     %12 = addi %6, %c2_i32 : i32
// CHECK-NEXT:     %13 = remi_signed %12, %arg1 : i32
// CHECK-NEXT:     %14 = sitofp %13 : i32 to f64
// CHECK-NEXT:     %15 = sitofp %arg1 : i32 to f64
// CHECK-NEXT:     %16 = divf %14, %15 : f64
// CHECK-NEXT:     store %16, %arg6[%4, %5] : memref<1200x1000xf64>
// CHECK-NEXT:     %17 = addi %2, %c1_i32 : i32
// CHECK-NEXT:     br ^bb2(%17 : i32)
// CHECK-NEXT:   ^bb4:  // pred: ^bb2
// CHECK-NEXT:     %18 = addi %0, %c1_i32 : i32
// CHECK-NEXT:     br ^bb1(%18 : i32)
// CHECK-NEXT:   ^bb5(%19: i32):  // 2 preds: ^bb1, ^bb9
// CHECK-NEXT:     %20 = cmpi "slt", %19, %arg0 : i32
// CHECK-NEXT:     cond_br %20, ^bb7(%c0_i32 : i32), ^bb6
// CHECK-NEXT:   ^bb6:  // pred: ^bb5
// CHECK-NEXT:     return
// CHECK-NEXT:   ^bb7(%21: i32):  // 2 preds: ^bb5, ^bb8
// CHECK-NEXT:     %22 = cmpi "slt", %21, %arg0 : i32
// CHECK-NEXT:     cond_br %22, ^bb8, ^bb9
// CHECK-NEXT:   ^bb8:  // pred: ^bb7
// CHECK-NEXT:     %23 = index_cast %19 : i32 to index
// CHECK-NEXT:     %24 = index_cast %21 : i32 to index
// CHECK-NEXT:     %25 = muli %19, %21 : i32
// CHECK-NEXT:     %26 = addi %25, %c3_i32 : i32
// CHECK-NEXT:     %27 = remi_signed %26, %arg0 : i32
// CHECK-NEXT:     %28 = sitofp %27 : i32 to f64
// CHECK-NEXT:     %29 = sitofp %arg1 : i32 to f64
// CHECK-NEXT:     %30 = divf %28, %29 : f64
// CHECK-NEXT:     store %30, %arg4[%23, %24] : memref<1200x1200xf64>
// CHECK-NEXT:     %31 = addi %21, %c1_i32 : i32
// CHECK-NEXT:     br ^bb7(%31 : i32)
// CHECK-NEXT:   ^bb9:  // pred: ^bb7
// CHECK-NEXT:     %32 = addi %19, %c1_i32 : i32
// CHECK-NEXT:     br ^bb5(%32 : i32)
// CHECK-NEXT:   }
...
// CHECK-NEXT:     %4 = index_cast %0 : i32 to index
// CHECK-NEXT:     %5 = index_cast %2 : i32 to index
// CHECK-NEXT:     %6 = load %arg4[%4, %5] : memref<1200x1200xf64>
// CHECK-NEXT:     %7 = mulf %6, %arg3 : f64
// CHECK-NEXT:     store %7, %arg4[%4, %5] : memref<1200x1200xf64>
...
// CHECK-NEXT:     %13 = cmpi "sle", %12, %0 : i32
...
// CHECK-NEXT:     %17 = load %arg5[%15, %16] : memref<1200x1000xf64>
// CHECK-NEXT:     %18 = mulf %17, %arg2 : f64
// CHECK-NEXT:     %19 = load %arg6[%14, %16] : memref<1200x1000xf64>
// CHECK-NEXT:     %20 = mulf %18, %19 : f64
// CHECK-NEXT:     %21 = load %arg6[%15, %16] : memref<1200x1000xf64>
// CHECK-NEXT:     %22 = mulf %21, %arg2 : f64
// CHECK-NEXT:     %23 = load %arg5[%14, %16] : memref<1200x1000xf64>
// CHECK-NEXT:     %24 = mulf %22, %23 : f64
// CHECK-NEXT:     %25 = addf %20, %24 : f64
// CHECK-NEXT:     %26 = load %arg4[%14, %15] : memref<1200x1200xf64>
// CHECK-NEXT:     %27 = addf %26, %25 : f64
// CHECK-NEXT:     store %27, %arg4[%14, %15] : memref<1200x1200xf64>
// CHECK-NEXT:     %28 = addi %12, %c1_i32 : i32
// CHECK-NEXT:     br ^bb7(%28 : i32)
// CHECK-NEXT:   ^bb9:  // pred: ^bb7
// CHECK-NEXT:     %29 = addi %9, %c1_i32 : i32
