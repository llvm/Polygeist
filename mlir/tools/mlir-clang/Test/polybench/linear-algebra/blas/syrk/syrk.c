...
// CHECK-NEXT:     %5 = memref_cast %1 : memref<1xf64> to memref<?xf64>
// CHECK-NEXT:     %6 = memref_cast %2 : memref<1200x1200xf64> to memref<?x1200xf64>
// CHECK-NEXT:     %7 = memref_cast %6 : memref<?x1200xf64> to memref<1200x1200xf64>
// CHECK-NEXT:     %8 = memref_cast %3 : memref<1200x1000xf64> to memref<?x1000xf64>
// CHECK-NEXT:     %9 = memref_cast %8 : memref<?x1000xf64> to memref<1200x1000xf64>
// CHECK-NEXT:     call @init_array(%c1200_i32, %c1000_i32, %4, %5, %7, %9) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<1200x1200xf64>, memref<1200x1000xf64>) -> ()
// CHECK-NEXT:     %10 = load %0[%c0] : memref<1xf64>
// CHECK-NEXT:     %11 = load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     call @kernel_syrk(%c1200_i32, %c1000_i32, %10, %11, %7, %9) : (i32, i32, f64, f64, memref<1200x1200xf64>, memref<1200x1000xf64>) -> ()
...
// CHECK-NEXT:       call @print_array(%c1200_i32, %7) : (i32, memref<1200x1200xf64>) -> ()
// CHECK-NEXT:     }
...
// CHECK-NEXT:   ^bb5(%14: i32):  // 2 preds: ^bb1, ^bb9
// CHECK-NEXT:     %15 = cmpi "slt", %14, %arg0 : i32
// CHECK-NEXT:     cond_br %15, ^bb7(%c0_i32 : i32), ^bb6
// CHECK-NEXT:   ^bb6:  // pred: ^bb5
// CHECK-NEXT:     return
// CHECK-NEXT:   ^bb7(%16: i32):  // 2 preds: ^bb5, ^bb8
...
// CHECK-NEXT:     %20 = muli %14, %16 : i32
// CHECK-NEXT:     %21 = addi %20, %c2_i32 : i32
...
// CHECK-NEXT:     store %25, %arg4[%18, %19] : memref<1200x1200xf64>
// CHECK-NEXT:     %26 = addi %16, %c1_i32 : i32
// CHECK-NEXT:     br ^bb7(%26 : i32)
// CHECK-NEXT:   ^bb9:  // pred: ^bb7
// CHECK-NEXT:     %27 = addi %14, %c1_i32 : i32
// CHECK-NEXT:     br ^bb5(%27 : i32)
// CHECK-NEXT:   }
...
// CHECK-NEXT:     %17 = load %arg5[%14, %16] : memref<1200x1000xf64>
// CHECK-NEXT:     %18 = mulf %arg2, %17 : f64
// CHECK-NEXT:     %19 = load %arg5[%15, %16] : memref<1200x1000xf64>
// CHECK-NEXT:     %20 = mulf %18, %19 : f64
// CHECK-NEXT:     %21 = load %arg4[%14, %15] : memref<1200x1200xf64>
// CHECK-NEXT:     %22 = addf %21, %20 : f64
// CHECK-NEXT:     store %22, %arg4[%14, %15] : memref<1200x1200xf64>
