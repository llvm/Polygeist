...
// CHECK-NEXT:     call @init_array(%c800_i32, %c900_i32, %c1100_i32, %c1200_i32, %7, %8, %3, %4, %5, %6) : (i32, i32, i32, i32, memref<?xf64>, memref<?xf64>, memref<800x1100xf64>, memref<1100x900xf64>, memref<900x1200xf64>, memref<800x1200xf64>) -> ()
// CHECK-NEXT:     %9 = load %0[%c0] : memref<1xf64>
// CHECK-NEXT:     %10 = load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     call @kernel_2mm(%c800_i32, %c900_i32, %c1100_i32, %c1200_i32, %9, %10, %2, %3, %4, %5, %6) : (i32, i32, i32, i32, f64, f64, memref<800x900xf64>, memref<800x1100xf64>, memref<1100x900xf64>, memref<900x1200xf64>, memref<800x1200xf64>) -> ()
...
// CHECK-NEXT:       call @print_array(%c800_i32, %c1200_i32, %6) : (i32, i32, memref<800x1200xf64>) -> ()
// CHECK-NEXT:     }
