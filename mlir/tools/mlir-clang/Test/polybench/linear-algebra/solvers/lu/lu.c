...
// CHECK-NEXT:     call @kernel_lu(%c2000_i32, %2) : (i32, memref<2000x2000xf64>) -> ()
...
// CHECK-NEXT:     cond_br %3, ^bb4(%c0_i32 : i32), ^bb7(%0 : i32)
...
// CHECK-NEXT:     %10 = load %arg1[%8, %7] : memref<2000x2000xf64>
...
// CHECK-NEXT:   ^bb7(%21: i32):  // 2 preds: ^bb3, ^bb11
// CHECK-NEXT:     %22 = cmpi "slt", %21, %arg0 : i32
// CHECK-NEXT:     cond_br %22, ^bb9(%c0_i32 : i32), ^bb8
// CHECK-NEXT:   ^bb8:  // pred: ^bb7
// CHECK-NEXT:     %23 = addi %0, %c1_i32 : i32
// CHECK-NEXT:     br ^bb1(%23 : i32)
// CHECK-NEXT:   ^bb9(%24: i32):  // 2 preds: ^bb7, ^bb10
// CHECK-NEXT:     %25 = cmpi "slt", %24, %0 : i32
// CHECK-NEXT:     cond_br %25, ^bb10, ^bb11
// CHECK-NEXT:   ^bb10:  // pred: ^bb9
// CHECK-NEXT:     %26 = index_cast %0 : i32 to index
// CHECK-NEXT:     %27 = index_cast %21 : i32 to index
// CHECK-NEXT:     %28 = index_cast %24 : i32 to index
// CHECK-NEXT:     %29 = load %arg1[%26, %28] : memref<2000x2000xf64>
// CHECK-NEXT:     %30 = load %arg1[%28, %27] : memref<2000x2000xf64>
// CHECK-NEXT:     %31 = mulf %29, %30 : f64
// CHECK-NEXT:     %32 = load %arg1[%26, %27] : memref<2000x2000xf64>
// CHECK-NEXT:     %33 = subf %32, %31 : f64
// CHECK-NEXT:     store %33, %arg1[%26, %27] : memref<2000x2000xf64>
// CHECK-NEXT:     %34 = addi %24, %c1_i32 : i32
// CHECK-NEXT:     br ^bb9(%34 : i32)
// CHECK-NEXT:   ^bb11:  // pred: ^bb9
// CHECK-NEXT:     %35 = addi %21, %c1_i32 : i32
