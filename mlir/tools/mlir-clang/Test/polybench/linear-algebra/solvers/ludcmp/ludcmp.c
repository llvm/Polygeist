...
// CHECK-NEXT:     %3 = alloc() : memref<2000xf64>
// CHECK-NEXT:     %4 = memref_cast %0 : memref<2000x2000xf64> to memref<?x2000xf64>
// CHECK-NEXT:     %5 = memref_cast %4 : memref<?x2000xf64> to memref<2000x2000xf64>
// CHECK-NEXT:     %6 = memref_cast %1 : memref<2000xf64> to memref<?xf64>
// CHECK-NEXT:     %7 = memref_cast %6 : memref<?xf64> to memref<2000xf64>
// CHECK-NEXT:     %8 = memref_cast %2 : memref<2000xf64> to memref<?xf64>
// CHECK-NEXT:     %9 = memref_cast %8 : memref<?xf64> to memref<2000xf64>
// CHECK-NEXT:     %10 = memref_cast %3 : memref<2000xf64> to memref<?xf64>
// CHECK-NEXT:     %11 = memref_cast %10 : memref<?xf64> to memref<2000xf64>
// CHECK-NEXT:     call @init_array(%c2000_i32, %5, %7, %9, %11) : (i32, memref<2000x2000xf64>, memref<2000xf64>, memref<2000xf64>, memref<2000xf64>) -> ()
// CHECK-NEXT:     call @kernel_ludcmp(%c2000_i32, %5, %7, %9, %11) : (i32, memref<2000x2000xf64>, memref<2000xf64>, memref<2000xf64>, memref<2000xf64>) -> ()
...
// CHECK-NEXT:       call @print_array(%c2000_i32, %9) : (i32, memref<2000xf64>) -> ()
// CHECK-NEXT:     }
