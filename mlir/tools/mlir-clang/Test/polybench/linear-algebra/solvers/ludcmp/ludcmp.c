...
// CHECK-NEXT:     call @init_array(%c2000_i32, %0, %1, %2, %3) : (i32, memref<2000x2000xf64>, memref<2000xf64>, memref<2000xf64>, memref<2000xf64>) -> ()
// CHECK-NEXT:     call @kernel_ludcmp(%c2000_i32, %0, %1, %2, %3) : (i32, memref<2000x2000xf64>, memref<2000xf64>, memref<2000xf64>, memref<2000xf64>) -> ()
// CHECK-NEXT:     %[[cmp:.+]] = cmpi "sgt", %arg0, %c42_i32 : i32
// CHECK-NEXT:     %[[trunc:.+]] = trunci %c0_i32 : i32 to i1
// CHECK-NEXT:     %[[not:.+]] = xor %[[trunc]], %true : i1
// CHECK-NEXT:     %[[and:.+]] = and %[[cmp]], %[[not]] : i1
// CHECK-NEXT:     scf.if %[[and]] {
// CHECK-NEXT:       call @print_array(%c2000_i32, %2) : (i32, memref<2000xf64>) -> ()
// CHECK-NEXT:     }
