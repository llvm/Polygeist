...
// CHECK-NEXT:     %2 = affine.load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     %3 = affine.load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     %4 = affine.load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     %5 = affine.load %1[%c0] : memref<1xf64>
...
// CHECK-NEXT:         affine.store %13, %1[%c0] : memref<1xf64>
...
// CHECK-NEXT:           affine.store %19, %1[%c0] : memref<1xf64>
// CHECK-NEXT:         }
...
// CHECK-NEXT:       }
// CHECK-NEXT:       affine.for %arg6 = #map(%arg5) to %0 {
// CHECK-NEXT:         %13 = affine.load %arg1[%arg5, %arg6] : memref<2000x2000xf64>
// CHECK-NEXT:         affine.store %13, %1[%c0] : memref<1xf64>
...
// CHECK-NEXT:           affine.store %17, %1[%c0] : memref<1xf64>
// CHECK-NEXT:         }
// CHECK-NEXT:         affine.store %5, %arg1[%arg5, %arg6] : memref<2000x2000xf64>
// CHECK-NEXT:       }
// CHECK-NEXT:     }
// CHECK-NEXT:     %6 = affine.load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     %7 = affine.load %1[%c0] : memref<1xf64>
// CHECK-NEXT:     affine.for %arg5 = 0 to %0 {
...
// CHECK-NEXT:         affine.store %20, %1[%c0] : memref<1xf64>
// CHECK-NEXT:       }
