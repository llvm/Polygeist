...
// CHECK-NEXT:   llvm.mlir.global internal constant @str4("\0A")
// CHECK-NEXT:   llvm.mlir.global internal constant @str3("%0.2lf ")
...
// CHECK-NEXT:     %14 = llvm.mlir.addressof @str3 : !llvm.ptr<array<7 x i8>>
// CHECK-NEXT:     %15 = llvm.getelementptr %14[%2, %2] : (!llvm.ptr<array<7 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
// CHECK-NEXT:     %16 = index_cast %11 : i32 to index
// CHECK-NEXT:     %17 = addi %c0, %16 : index
// CHECK-NEXT:     %18 = load %arg1[%17] : memref<2000xf64>
// CHECK-NEXT:     %19 = llvm.mlir.cast %18 : f64 to !llvm.double
// CHECK-NEXT:     %20 = llvm.call @fprintf(%13, %15, %19) : (!llvm.ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>, !llvm.ptr<i8>, !llvm.double) -> !llvm.i32
// CHECK-NEXT:     %c20_i32 = constant 20 : i32
// CHECK-NEXT:     %21 = remi_signed %11, %c20_i32 : i32
// CHECK-NEXT:     %22 = cmpi "eq", %21, %c0_i32 : i32
...
// CHECK-NEXT:       %35 = llvm.mlir.addressof @str4 : !llvm.ptr<array<1 x i8>>
