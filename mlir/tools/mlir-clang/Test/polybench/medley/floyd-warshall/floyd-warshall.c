...
// CHECK-NEXT:     %1 = memref_cast %0 : memref<2800x2800xi32> to memref<?x2800xi32>
// CHECK-NEXT:     %2 = memref_cast %1 : memref<?x2800xi32> to memref<2800x2800xi32>
// CHECK-NEXT:     call @init_array(%c2800_i32, %2) : (i32, memref<2800x2800xi32>) -> ()
// CHECK-NEXT:     call @kernel_floyd_warshall(%c2800_i32, %2) : (i32, memref<2800x2800xi32>) -> ()
...
// CHECK-NEXT:     scf.if %6 {
// CHECK-NEXT:       call @print_array(%c2800_i32, %2) : (i32, memref<2800x2800xi32>) -> ()
// CHECK-NEXT:     }
