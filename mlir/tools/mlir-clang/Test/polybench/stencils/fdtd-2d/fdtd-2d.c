...
// CHECK-NEXT:     call @init_array(%c500_i32, %c1000_i32, %c1200_i32, %0, %1, %2, %3) : (i32, i32, i32, memref<1000x1200xf64>, memref<1000x1200xf64>, memref<1000x1200xf64>, memref<500xf64>) -> ()
// CHECK-NEXT:     call @kernel_fdtd_2d(%c500_i32, %c1000_i32, %c1200_i32, %0, %1, %2, %3) : (i32, i32, i32, memref<1000x1200xf64>, memref<1000x1200xf64>, memref<1000x1200xf64>, memref<500xf64>) -> ()
...
// CHECK-NEXT:     scf.if %7 {
// CHECK-NEXT:       call @print_array(%c1000_i32, %c1200_i32, %0, %1, %2) : (i32, i32, memref<1000x1200xf64>, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
// CHECK-NEXT:     }
