...
// CHECK-NEXT:     call @init_array(%c2000_i32, %0, %1) : (i32, memref<2000xf64>, memref<2000xf64>) -> ()
// CHECK-NEXT:     call @kernel_jacobi_1d(%c500_i32, %c2000_i32, %0, %1) : (i32, i32, memref<2000xf64>, memref<2000xf64>) -> ()
// CHECK-NEXT:     %2 = cmpi "sgt", %arg0, %c42_i32 : i32
// CHECK-NEXT:     %3 = trunci %c0_i32 : i32 to i1
// CHECK-NEXT:     %4 = xor %3, %true : i1
// CHECK-NEXT:     %5 = and %2, %4 : i1
// CHECK-NEXT:     scf.if %5 {
// CHECK-NEXT:       call @print_array(%c2000_i32, %0) : (i32, memref<2000xf64>) -> ()
// CHECK-NEXT:     }
