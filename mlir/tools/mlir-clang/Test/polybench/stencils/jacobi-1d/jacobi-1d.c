...
// CHECK-NEXT:  %[[csta1:.+]] = index_cast %arg1 : i32 to index 
// CHECK-NEXT:  %[[csta0:.+]] = index_cast %arg0 : i32 to index
// CHECK-NEXT:  affine.for %arg4 = 0 to %[[csta0]] {
// CHECK-NEXT:    affine.for %arg5 = 1 to #map0()[%[[csta1]]] {
