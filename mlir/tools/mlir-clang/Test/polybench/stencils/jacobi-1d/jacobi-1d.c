...
// CHECK-NEXT:     %0 = alloc() : memref<2000xf64>
// CHECK-NEXT:     %1 = alloc() : memref<2000xf64>
// CHECK-NEXT:     %2 = memref_cast %0 : memref<2000xf64> to memref<?xf64>
// CHECK-NEXT:     %3 = memref_cast %2 : memref<?xf64> to memref<2000xf64>
// CHECK-NEXT:     %4 = memref_cast %1 : memref<2000xf64> to memref<?xf64>
// CHECK-NEXT:     %5 = memref_cast %4 : memref<?xf64> to memref<2000xf64>
// CHECK-NEXT:     call @init_array(%c2000_i32, %3, %5) : (i32, memref<2000xf64>, memref<2000xf64>) -> ()
// CHECK-NEXT:     call @kernel_jacobi_1d(%c500_i32, %c2000_i32, %3, %5) : (i32, i32, memref<2000xf64>, memref<2000xf64>) -> ()
...
// CHECK-NEXT:     scf.if %9 {
// CHECK-NEXT:       call @print_array(%c2000_i32, %3) : (i32, memref<2000xf64>) -> ()
// CHECK-NEXT:     }
...
// CHECK-NEXT:     store %7, %arg1[%2] : memref<2000xf64>
// CHECK-NEXT:     %8 = sitofp %c3_i32 : i32 to f64
// CHECK-NEXT:     %9 = addf %3, %8 : f64
// CHECK-NEXT:     %10 = divf %9, %6 : f64
...
// CHECK-NEXT:     br ^bb1(%c0_i32 : i32)
// CHECK-NEXT:   ^bb1(%0: i32):  // 2 preds: ^bb0, ^bb7
// CHECK-NEXT:     %1 = cmpi "slt", %0, %arg0 : i32
...
// CHECK-NEXT:     cond_br %4, ^bb4, ^bb5(%c1_i32 : i32)
// CHECK-NEXT:   ^bb4:  // pred: ^bb3
// CHECK-NEXT:     %5 = index_cast %2 : i32 to index
// CHECK-NEXT:     %6 = subi %2, %c1_i32 : i32
// CHECK-NEXT:     %7 = index_cast %6 : i32 to index
// CHECK-NEXT:     %8 = load %arg2[%7] : memref<2000xf64>
// CHECK-NEXT:     %9 = load %arg2[%5] : memref<2000xf64>
// CHECK-NEXT:     %10 = addf %8, %9 : f64
// CHECK-NEXT:     %11 = addi %2, %c1_i32 : i32
// CHECK-NEXT:     %12 = index_cast %11 : i32 to index
// CHECK-NEXT:     %13 = load %arg2[%12] : memref<2000xf64>
// CHECK-NEXT:     %14 = addf %10, %13 : f64
// CHECK-NEXT:     %15 = mulf %cst, %14 : f64
// CHECK-NEXT:     store %15, %arg3[%5] : memref<2000xf64>
// CHECK-NEXT:     br ^bb3(%11 : i32)
// CHECK-NEXT:   ^bb5(%16: i32):  // 2 preds: ^bb3, ^bb6
// CHECK-NEXT:     %17 = cmpi "slt", %16, %3 : i32
// CHECK-NEXT:     cond_br %17, ^bb6, ^bb7
// CHECK-NEXT:   ^bb6:  // pred: ^bb5
// CHECK-NEXT:     %18 = index_cast %16 : i32 to index
// CHECK-NEXT:     %19 = subi %16, %c1_i32 : i32
// CHECK-NEXT:     %20 = index_cast %19 : i32 to index
// CHECK-NEXT:     %21 = load %arg3[%20] : memref<2000xf64>
// CHECK-NEXT:     %22 = load %arg3[%18] : memref<2000xf64>
// CHECK-NEXT:     %23 = addf %21, %22 : f64
// CHECK-NEXT:     %24 = addi %16, %c1_i32 : i32
// CHECK-NEXT:     %25 = index_cast %24 : i32 to index
// CHECK-NEXT:     %26 = load %arg3[%25] : memref<2000xf64>
// CHECK-NEXT:     %27 = addf %23, %26 : f64
// CHECK-NEXT:     %28 = mulf %cst, %27 : f64
// CHECK-NEXT:     store %28, %arg2[%18] : memref<2000xf64>
// CHECK-NEXT:     br ^bb5(%24 : i32)
// CHECK-NEXT:   ^bb7:  // pred: ^bb5
// CHECK-NEXT:     %29 = addi %0, %c1_i32 : i32
