// RUN: polygeist-opt --affine-cfg -allow-unregistered-dialect --split-input-file %s | FileCheck %s
...
//  d0 <= s0 - 1 
//  d0 < s0 
// CHECK: #set0 = affine_set<(d0)[s0] : (-d0 + s0 - 1 >= 0)>
...
// CHECK-NEXT:       affine.if #set0(%arg1)[%arg0] {
