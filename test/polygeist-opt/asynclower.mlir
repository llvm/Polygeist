// RUN: polygeist-opt --convert-polygeist-to-llvm %s --allow-unregistered-dialect | FileCheck %s
...
module {
  ...
  llvm.func @_Z3runP11CUstream_stPii(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i32) {
    ...
    %token = async.execute [%7] {
      omp.parallel   {
        omp.wsloop {
          omp.loop_nest  (%arg3, %arg4) : i64 = (%0, %0) to (%3, %2) step (%1, %1) {
...
// CHECK-DAG:           %[[VAL_1:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.mlir.zero : !llvm.ptr
// CHECK-DAG:           %[[VAL_2:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.mlir.addressof @kernelbody.{{[0-9\.]+}} : !llvm.ptr
// CHECK:           llvm.call @fake_cuda_dispatch(%[[VAL_1]], %[[VAL_2]], %[[VAL_0]]) : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> ()
// CHECK:           llvm.return
// CHECK:         }
...
// CHECK-DAG:           %[[VAL_3:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.mlir.constant(16 : i64) : i64
// CHECK-DAG:           %[[VAL_4:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.call @malloc(%[[VAL_3]]) : (i64) -> !llvm.ptr
// CHECK-DAG:           %[[VAL_5:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.getelementptr %[[VAL_4]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(ptr, i32)>
// CHECK-DAG:           llvm.store %[[VAL_1]], %[[VAL_5]] : !llvm.ptr, !llvm.ptr
// CHECK-DAG:           %[[VAL_6:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.getelementptr %[[VAL_4]][0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(ptr, i32)>
// CHECK-DAG:           llvm.store %[[VAL_2]], %[[VAL_6]] : i32, !llvm.ptr
// CHECK-DAG:           %[[VAL_7:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.mlir.addressof @kernelbody.{{[0-9\.]+}} : !llvm.ptr
// CHECK-DAG:           llvm.call @fake_cuda_dispatch(%[[VAL_4]], %[[VAL_7]], %[[VAL_0]]) : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> ()
// CHECK:           llvm.return
// CHECK:         }
...
// CHECK-DAG:           %[[VAL_2:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.mlir.constant(10 : index) : i64
// CHECK-DAG:           %[[VAL_3:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.mlir.constant(20 : index) : i64
// CHECK-DAG:           %[[VAL_4:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.mlir.constant(1 : index) : i64
// CHECK:           %[[VAL_5:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.getelementptr %[[VAL_0]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(ptr, i32)>
// CHECK:           %[[VAL_6:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.load %[[VAL_5]] : !llvm.ptr -> !llvm.ptr
// CHECK:           %[[VAL_7:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.getelementptr %[[VAL_0]][0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(ptr, i32)>
