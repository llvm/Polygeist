...
// CHECK-DAG:           %[[VAL_5:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.getelementptr %[[VAL_4]][0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.ptr
// CHECK-DAG:           llvm.store %[[VAL_1]], %[[VAL_5]] : !llvm.ptr, !llvm.ptr
// CHECK-DAG:           %[[VAL_6:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.getelementptr %[[VAL_4]][0, 1] : (!llvm.ptr) -> !llvm.ptr, i32
