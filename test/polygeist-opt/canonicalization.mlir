...
// CHECK-NEXT:     %[[V0:.+]] = "polygeist.pointer2memref"(%[[arg0]]) : (!llvm.ptr<struct<(i32, i32)>>) -> memref<?xi32>
...
// CHECK-NEXT:     %[[V0:.+]] = llvm.getelementptr %[[arg0]][0, 1] : (!llvm.ptr<struct<(i32, i32)>>) -> !llvm.ptr<i32>
// CHECK-NEXT:     %[[V1:.+]] = "polygeist.pointer2memref"(%[[V0]]) : (!llvm.ptr<i32>) -> memref<?xi32>
...
// CHECK-NEXT: %[[V0:.+]] = "polygeist.memref2pointer"(%[[arg0]]) : (memref<10xi32>) -> !llvm.ptr<i8>
