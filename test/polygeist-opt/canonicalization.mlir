...
// -----
  ...
  func @fold2ref(%arg0 : !llvm.ptr<struct<(i32, i32)>>) -> memref<?xi32> {
...
// CHECK:   func @fold2ref(%arg0: !llvm.ptr<struct<(i32, i32)>>) -> memref<?xi32> {
// CHECK-NEXT:     %0 = "polygeist.pointer2memref"(%arg0) : (!llvm.ptr<struct<(i32, i32)>>) -> memref<?xi32>
// CHECK-NEXT:     return %0 : memref<?xi32>
// CHECK-NEXT:   }

  func @nofold2ref(%arg0 : !llvm.ptr<struct<(i32, i32)>>) -> memref<?xi32> {
        %c0_i32 = arith.constant 0 : i32
...
func @memref2ptr(%arg0: memref<10xi32>) -> !llvm.ptr<i8> {
...
// CHECK: func @memref2ptr(%arg0: memref<10xi32>) -> !llvm.ptr<i8> {
