...
module  {
  func @runHisto(%arg0: i32, %arg1: i32) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
  ...
  func private @histo_kernel() attributes {llvm.linkage = #llvm.linkage<external>}
}
...
module {
  func @compute_tran_temp(%1: f32, %4: f32) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    %c1_i32 = arith.constant 1 : i32
    %c0_i32 = arith.constant 0 : i32
...
// CHECK:   func @compute_tran_temp(%arg0: f32, %arg1: f32) -> i32 
