...
// CHECK-DAG:           %[[VAL_0:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.call @func_declaration_multi_result() : () -> !llvm.struct<(ptr, ptr, ptr)>
// CHECK-DAG:           %[[VAL_1:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.extractvalue %[[VAL_0]][0] : !llvm.struct<(ptr, ptr, ptr)>
// CHECK-DAG:           %[[VAL_2:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.extractvalue %[[VAL_0]][1] : !llvm.struct<(ptr, ptr, ptr)>
// CHECK-DAG:           %[[VAL_3:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.extractvalue %[[VAL_0]][2] : !llvm.struct<(ptr, ptr, ptr)>
  %0:3 = func.call @func_declaration_multi_result() : () -> (memref<f32>, memref<?xf32>, memref<?x4x42xf32>)
// CHECK-DAG:           %[[VAL_4:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.mlir.undef : !llvm.struct<(ptr, ptr, ptr)>
// CHECK-DAG:           %[[VAL_5:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.insertvalue %[[VAL_1]], %[[VAL_4]][0] : !llvm.struct<(ptr, ptr, ptr)>
// CHECK-DAG:           %[[VAL_6:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.insertvalue %[[VAL_2]], %[[VAL_5]][1] : !llvm.struct<(ptr, ptr, ptr)>
// CHECK-DAG:           %[[VAL_7:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]] = llvm.insertvalue %[[VAL_3]], %[[VAL_6]][2] : !llvm.struct<(ptr, ptr, ptr)>
