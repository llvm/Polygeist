...
module {
  func @_Z14computeTempCPUPfS_iii(%arg0: memref<?xf32>, %arg1: memref<?xf32>, %arg2: i32, %arg3: i32, %arg4: i32) {
    %c1_i32 = arith.constant 1 : i32
    %c0_i32 = arith.constant 0 : i32
    br ^bb1(%c0_i32, %c0_i32 : i32, i32)
  ^bb1(%0: i32, %1: i32):  // 3 preds: ^bb0, ^bb4, ^bb5
    %2 = arith.cmpi ult, %0, %arg3 : i32
    cond_br %2, ^bb2(%c0_i32 : i32), ^bb5
  ...
  ^bb5:  // pred: ^bb1
    ...
    cond_br %11, ^bb1(%c0_i32, %10 : i32, i32), ^bb6
  ^bb6:  // pred: ^bb5
    return
  }
}

// CHECK:   func @_Z14computeTempCPUPfS_iii(%arg0: memref<?xf32>, %arg1: memref<?xf32>, %arg2: i32, %arg3: i32, %arg4: i32) {
...
// CHECK-NEXT:         cond_br %2, ^bb3(%c0_i32 : i32), ^bb1
// CHECK-NEXT:       ^bb1:  // pred: ^bb0
// CHECK-NEXT:         %3 = arith.addi %arg6, %c1_i32 : i32
// CHECK-NEXT:         %4 = arith.cmpi ult, %3, %arg4 : i32
// CHECK-NEXT:         %false = arith.constant false
// CHECK-NEXT:         %true = arith.constant true
// CHECK-NEXT:         cond_br %4, ^bb2(%true, %c0_i32, %3 : i1, i32, i32), ^bb2(%false, %arg5, %arg6 : i1, i32, i32)
...
// CHECK-NEXT:         br ^bb2(%true_0, %10, %arg6 : i1, i32, i32)
// CHECK-NEXT:       }
