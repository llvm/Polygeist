...
// ISL_OUT:       writes:
// ISL_OUT:         - "[P0, P1, P2] -> { A1[i0, i1, i2, i3, i4] : i2 = i0 and i3 = i1 }"
// ISL_OUT: { domain: "[P0, P1, P2] -> { S0[i0, i1] : 0 <= i0 < P2 and 0 <= i1 < P0; S1[i0, i1, i2] : 0 <= i0 < P2 and 0 <= i1 < P0 and 0 <= i2 < P1 }", child: { schedule: "[P0, P1, P2] -> L3[{ S0[i0, i1] -> [(i0)]; S1[i0, i1, i2] -> [(i0)] }]", child: { sequence: [ { filter: "[P0, P1, P2] -> { S0[i0, i1] }", child: { schedule: "[P0, P1, P2] -> L0[{ S0[i0, i1] -> [(i1)] }]" } }, { filter: "[P0, P1, P2] -> { S1[i0, i1, i2] }", child: { schedule: "[P0, P1, P2] -> L2[{ S1[i0, i1, i2] -> [(i1)] }]", permutable: 1, child: { schedule: "[P0, P1, P2] -> L1[{ S1[i0, i1, i2] -> [(i2)] }]" } } } ] } } }
