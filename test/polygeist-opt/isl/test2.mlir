// RUN: if [ %polymer_enabled == 1 ]; then polygeist-opt --affine-opt --use-polyhedral-optimizer=tadashi -debug-only=tadashi-opt,islscop %s; fi
  ...
  func.func @f(%arg0: i64, %arg1: memref<?x?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg2 = 1 to %0 {
      affine.for %arg3 = 0 to %0 {
        ...
        affine.store %3, %arg1[%arg2, %arg3 + %0 + 42] : memref<?x?xf64>
      }
    }
    return
  }
