...
// CHECK-NEXT:     %[[V1:.+]]:2 = scf.execute_region -> (i32, i32) {
// CHECK-NEXT:       cf.cond_br %[[arg0]], ^bb1, ^bb2
// CHECK-NEXT:     ^bb1:  // pred: ^bb0
// CHECK-NEXT:       scf.yield %[[c20_i32]], %[[V0]] : i32, i32
// CHECK-NEXT:     ^bb2:  // pred: ^bb0
// CHECK-NEXT:       scf.yield %[[c10_i32]], %c-1_i32 : i32, i32
// CHECK-NEXT:     }
// CHECK-NEXT:     %[[V2:.+]] = scf.if %[[arg0]] -> (i32) {
// CHECK-NEXT:       scf.yield %[[V1]]#0 : i32
// CHECK-NEXT:     } else {
// CHECK-NEXT:       scf.yield %[[V1]]#1 : i32
// CHECK-NEXT:     }
