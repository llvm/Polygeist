...
module {
  func.func @_Z8BFSGraphiPPc(%arg0: i32, %arg1: memref<?xmemref<?xi8>>, %arg2: index, %arg3: index) -> (i32, i32) {
...
// CHECK:   func.func @_Z8BFSGraphiPPc(%arg0: i32, %arg1: memref<?xmemref<?xi8>>, %arg2: index, %arg3: index) 
