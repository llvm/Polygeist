...
// CHECK-DAG:           %[[VAL_0:.*]] = llvm.mlir.constant(2 : i32) : i32
// CHECK-DAG:           %[[VAL_1:.*]] = llvm.mlir.constant(0 : i32) : i32
// CHECK-DAG:           %[[VAL_2:.*]] = llvm.mlir.constant(1 : i32) : i32
// CHECK-DAG:           %[[VAL_3:.*]] = llvm.mlir.addressof @kernelId.0 : !llvm.ptr
// CHECK-DAG:           %[[VAL_4:.*]] = llvm.getelementptr %[[VAL_3]][0, 0] : (!llvm.ptr) -> !llvm.ptr
