...
// CHECK-NEXT:       %[[V1:.+]] = "polygeist.subindex"(%[[V0]], %[[arg0]]) : (memref<25x!llvm.struct<(i32, f64)>>, index) -> memref<?x!llvm.struct<(i32, f64)>>
// CHECK-NEXT:       func.call @_ZN11AIntDividerC1Ev(%[[V1:.+]]) : (memref<?x!llvm.struct<(i32, f64)>>) -> ()
// CHECK-NEXT:     }
// CHECK-NEXT: return
// CHECK-NEXT:   }
...
// CHECK-NEXT:     %[[V0:.+]] = "polygeist.memref2pointer"(%[[arg0]]) : (memref<?x!llvm.struct<(i32, f64)>>) -> !llvm.ptr<struct<(i32, f64)>>
// CHECK-NEXT:     %[[V1:.+]] = llvm.getelementptr %[[V0]][0, 0] : (!llvm.ptr<struct<(i32, f64)>>) -> !llvm.ptr<i32>
