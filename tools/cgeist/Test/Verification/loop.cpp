...
// CHECK-NEXT:     %3 = "polygeist.memref2pointer"(%0) :
...
// CHECK-NEXT:       %6 = llvm.getelementptr %3[%5] : (!llvm.ptr<struct<(i32,
// f64)>>, i64) -> !llvm.ptr<struct<(i32, f64)>> CHECK-NEXT:       %7 =
// llvm.getelementptr %6[0, 0] : (!llvm.ptr<struct<(i32, f64)>>) ->
// !llvm.ptr<i32> CHECK-NEXT:       %8 = memref.load %arg0[%arg1] :
// memref<?xi32> CHECK-NEXT:       llvm.store %8, %7 : !llvm.ptr<i32>
// CHECK-NEXT:     }
// CHECK-NEXT:     return
// CHECK-NEXT:   }
