...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND ${CMAKE_COMMAND} -E env CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} ${CMAKE_CURRENT_SOURCE_DIR}/pluto/autogen.sh && ${CMAKE_COMMAND} -E env CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} ${CMAKE_CURRENT_SOURCE_DIR}/pluto/configure --prefix=${CMAKE_CURRENT_BINARY_DIR}/pluto ${CLANG_PREFIX_CONFIG}
  PREFIX ${CMAKE_CURRENT_BINARY_DIR}/pluto
