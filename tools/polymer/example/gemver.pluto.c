...
extern void _mlir_ciface_gemver(float alpha, float beta, struct TwoDMemrefF32 *,
                                struct OneDMemrefF32 *, struct OneDMemrefF32 *,
                                struct OneDMemrefF32 *, struct OneDMemrefF32 *,
                                struct OneDMemrefF32 *, struct OneDMemrefF32 *,
                                struct OneDMemrefF32 *, struct OneDMemrefF32 *);
extern void
_mlir_ciface_gemver_new(struct OneDMemrefF32 *, struct OneDMemrefF32 *,
                        struct TwoDMemrefF32 *, struct OneDMemrefF32 *,
                        struct OneDMemrefF32 *, struct OneDMemrefF32 *,
                        struct OneDMemrefF32 *, struct OneDMemrefF32 *,
                        struct OneDMemrefF32 *, float alpha, float beta);
...
int main(int argc, char *argv[]) {
  ...
  start = clock();
  _mlir_ciface_gemver(alpha, beta, &A1_mem, &u1_mem, &v1_mem, &u2_mem, &v2_mem,
                      &w1_mem, &x1_mem, &y_mem, &z_mem);
  end = clock();
  ...
  start = clock();
  _mlir_ciface_gemver_new(&z_mem, &w2_mem, &A2_mem, &u1_mem, &v1_mem, &u2_mem,
                          &v2_mem, &y_mem, &x2_mem, alpha, beta);
  end = clock();
