...
module {
  ...
  func @gemver_new(%arg0: memref<?xf32>, %arg1: memref<?xf32>, %arg2: memref<?x?xf32>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: memref<?xf32>, %arg6: memref<?xf32>, %arg7: memref<?xf32>, %arg8: memref<?xf32>, %arg9: f32, %arg10: f32) {
    %c0 = constant 0 : index
    %0 = dim %arg2, %c0 : memref<?x?xf32>
      ...
      affine.for %arg12 = 0 to #map6()[%0] {
        affine.for %arg13 = #map4(%arg11) to min #map5(%arg11)[%0] {
          affine.for %arg14 = #map4(%arg12) to min #map5(%arg12)[%0] {
            ...
            call @S1(%arg8, %arg13, %arg7, %arg14, %arg10, %arg2) : (memref<?xf32>, index, memref<?xf32>, index, f32, memref<?x?xf32>) -> ()
          }
        }
      }
    }
    affine.for %arg11 = 0 to #map6()[%0] {
      affine.for %arg12 = #map4(%arg11) to min #map5(%arg11)[%0] {
        call @S2(%arg8, %arg12, %arg0) : (memref<?xf32>, index, memref<?xf32>) -> ()
      }
    }
    affine.for %arg11 = 0 to #map6()[%0] {
      affine.for %arg12 = 0 to #map6()[%0] {
        affine.for %arg13 = #map4(%arg11) to min #map5(%arg11)[%0] {
          affine.for %arg14 = #map4(%arg12) to min #map5(%arg12)[%0] {
            call @S3(%arg1, %arg13, %arg8, %arg14, %arg9, %arg2) : (memref<?xf32>, index, memref<?xf32>, index, f32, memref<?x?xf32>) -> ()
          }
        }
      }
    }
...
// [Pluto] After tiling:
// T(S1): (0, i3/32, i2/32, i3, i2, 2)
// loop types (scalar, loop, loop, loop, loop, scalar)

// T(S2): (0, i4/32, i6/32, i4, i6, 3)
// loop types (scalar, loop, loop, loop, loop, scalar)

// T(S3): (1, i5/32, i5, 0, 1, 0)
// loop types (scalar, loop, loop, scalar, scalar, scalar)

// T(S4): (2, i0/32, i1/32, i0, i1, 0)
// loop types (scalar, loop, loop, loop, loop, scalar)

// for (t2=0;t2<=floord(P0-1,32);t2++) {
//   for (t3=0;t3<=floord(P0-1,32);t3++) {
//     for (t4=32*t2;t4<=min(P0-1,32*t2+31);t4++) {
//       for (t5=32*t3;t5<=min(P0-1,32*t3+31);t5++) {
//         S0()
//         S1()
//       }
//     }
...
// }
// for (t2=0;t2<=floord(P0-1,32);t2++) {
//   for (t3=32*t2;t3<=min(P0-1,32*t2+31);t3++) {
//     S2()
//   }
// }
// for (t2=0;t2<=floord(P0-1,32);t2++) {
