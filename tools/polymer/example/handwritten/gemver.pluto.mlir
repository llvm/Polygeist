...
module {
  ...
  func @gemver_new(%arg0: f32, %arg1: memref<?xf32>, %arg2: f32, %arg3: memref<?x?xf32>, %arg4: memref<?xf32>, %arg5: memref<?xf32>, %arg6: memref<?xf32>, %arg7: memref<?xf32>, %arg8: memref<?xf32>, %arg9: memref<?xf32>, %arg10: memref<?xf32>) {
    %c0 = constant 0 : index
    %0 = dim %arg3, %c0 : memref<?x?xf32>
      ...
      affine.for %arg12 = 0 to #map6()[%0] {
        affine.for %arg13 = #map4(%arg11) to min #map5(%arg11)[%0] {
          affine.for %arg14 = #map4(%arg12) to min #map5(%arg12)[%0] {
            ...
            %2 = affine.apply #map3(%arg13)
            call @S0(%arg3, %1, %2, %arg7, %arg6, %arg5, %arg4) : (memref<?x?xf32>, index, index, memref<?xf32>, memref<?xf32>, memref<?xf32>, memref<?xf32>) -> ()
            call @S1(%arg9, %2, %arg8, %1, %arg0, %arg3) : (memref<?xf32>, index, memref<?xf32>, index, f32, memref<?x?xf32>) -> ()
          }
        }
      }
    }
    affine.for %arg11 = 0 to #map6()[%0] {
      affine.for %arg12 = #map4(%arg11) to min #map5(%arg11)[%0] {
        %1 = affine.apply #map3(%arg12)
        call @S2(%arg9, %1, %arg10) : (memref<?xf32>, index, memref<?xf32>) -> ()
      }
    }
    affine.for %arg11 = 0 to #map6()[%0] {
      affine.for %arg12 = 0 to #map6()[%0] {
        affine.for %arg13 = #map4(%arg11) to min #map5(%arg11)[%0] {
          affine.for %arg14 = #map4(%arg12) to min #map5(%arg12)[%0] {
            %1 = affine.apply #map3(%arg13)
            %2 = affine.apply #map3(%arg14)
            call @S3(%arg1, %1, %arg9, %2, %arg2, %arg3) : (memref<?xf32>, index, memref<?xf32>, index, f32, memref<?x?xf32>) -> ()
          }
        }
      }
    }
