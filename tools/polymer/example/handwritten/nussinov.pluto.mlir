...
#map4 = affine_map<() -> (0)>
#map5 = affine_map<()[s0, s1, s2] -> (-s1 + s0 - 1, s2)>
#map6 = affine_map<()[s0, s1, s2] -> (-s1 + s0 - 1, s2 - 1)>
#map7 = affine_map<()[s0, s1, s2] -> (-s1 + s0, s2)>
#map8 = affine_map<()[s0, s1] -> (-s1 + s0 - 1)>
#map9 = affine_map<()[s0, s1, s2] -> (-s1 + s0, s2 - 1)>
#map10 = affine_map<()[s0, s1] -> (s0 + 1, s1)>
#map11 = affine_map<(d0)[s0] -> (d0 * -32 + s0 - 31)>
#map12 = affine_map<(d0) -> (d0 * 32 + 31)>
...
#map18 = affine_map<(d0, d1)[s0] -> (2, d0 * 32 - d1 * 32, d1 * -32 + s0 - 30)>
#map19 = affine_map<(d0, d1)[s0] -> (s0, d0 * 32 - d1 * 32 + 32)>
#map20 = affine_map<(d0)[s0] -> (0, (d0 * 32 - s0 + 1) ceildiv 32)>
#map21 = affine_map<(d0)[s0] -> ((s0 - 1) floordiv 32 + 1, d0 + 1)>
#map22 = affine_map<()[s0] -> (0, (s0 - 61) ceildiv 32)>
#map23 = affine_map<()[s0] -> ((s0 - 1) floordiv 16 + 1)>
    ...
    affine.if #set4()[%0] {
      affine.if #set3()[%0] {
        affine.for %arg2 = 0 to #map13()[%0] {
          %1 = affine.apply #map11(%arg2)[%0]
          %2 = affine.apply #map12(%arg2)
          call @S0(%arg1, %1, %2, %0) : (memref<?x?xi32>, index, index, index) -> ()
          %3 = affine.apply #map11(%arg2)[%0]
          %4 = affine.apply #map12(%arg2)
          call @S1(%arg1, %3, %4, %0) : (memref<?x?xi32>, index, index, index) -> ()
          %5 = affine.apply #map11(%arg2)[%0]
          %6 = affine.apply #map12(%arg2)
          call @S2(%arg1, %5, %6, %0, %arg0) : (memref<?x?xi32>, index, index, index, memref<?xi8>) -> ()
          %7 = affine.apply #map11(%arg2)[%0]
          %8 = affine.apply #map12(%arg2)
          call @S3(%arg1, %7, %8, %0) : (memref<?x?xi32>, index, index, index) -> ()
        }
      }
    }
    affine.for %arg2 = max #map22()[%0] to #map23()[%0] {
      affine.for %arg3 = max #map20(%arg2)[%0] to min #map21(%arg2)[%0] {
        affine.if #set5(%arg2, %arg3)[%0] {
          %1 = affine.apply #map11(%arg3)[%0]
          %2 = affine.apply #map12(%arg3)
          call @S0(%arg1, %1, %2, %0) : (memref<?x?xi32>, index, index, index) -> ()
          %3 = affine.apply #map11(%arg3)[%0]
          %4 = affine.apply #map12(%arg3)
          call @S1(%arg1, %3, %4, %0) : (memref<?x?xi32>, index, index, index) -> ()
          %5 = affine.apply #map11(%arg3)[%0]
          %6 = affine.apply #map12(%arg3)
          call @S2(%arg1, %5, %6, %0, %arg0) : (memref<?x?xi32>, index, index, index, memref<?xi8>) -> ()
          %7 = affine.apply #map11(%arg3)[%0]
          %8 = affine.apply #map12(%arg3)
          call @S3(%arg1, %7, %8, %0) : (memref<?x?xi32>, index, index, index) -> ()
        }
        ...
        affine.for %arg4 = max #map18(%arg2, %arg3)[%0] to min #map19(%arg2, %arg3)[%0] {
          ...
          affine.for %arg5 = max #map16(%arg3, %arg4)[%0] to min #map17(%arg3)[%0] {
            ...
            affine.for %arg6 = #map15(%arg4)[%0] to #map2(%arg5) {
