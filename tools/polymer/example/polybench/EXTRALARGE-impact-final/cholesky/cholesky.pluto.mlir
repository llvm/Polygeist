...
#map14 = affine_map<(d0) -> (d0 * 16 + 2)>
#map15 = affine_map<(d0)[s0] -> (s0, d0 * 16 + 32)>
#set0 = affine_set<()[s0] : (s0 - 1 >= 0)>
#set1 = affine_set<(d0, d1, d2) : (d0 - (d1 * 2 + 1) >= 0, d1 - d2 == 0)>
#set2 = affine_set<(d0, d1) : (d0 - (d1 + 1) >= 0)>
#set3 = affine_set<(d0, d1, d2) : (d0 - (d1 + d2) == 0, d0 - (d1 * 2 + 1) >= 0)>
#set4 = affine_set<(d0, d1, d2) : (d0 - d1 * 2 == 0, d0 - d2 * 2 == 0)>
#set5 = affine_set<(d0) : (d0 mod 2 == 0)>
#set6 = affine_set<(d0, d1, d2)[s0] : (d0 - d1 * 2 == 0, d0 - d2 * 2 == 0, -d0 + (s0 - 2) floordiv 16 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_cholesky_new(%arg0: i32, %arg1: memref<4000x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.if #set0()[%0] {
      affine.for %arg2 = -1 to #map1()[%0] {
        affine.for %arg3 = max #map2(%arg2)[%0] to #map3(%arg2) {
          affine.for %arg4 = 0 to #map4(%arg2, %arg3) {
            affine.if #set1(%arg2, %arg3, %arg4) {
              affine.for %arg5 = #map5(%arg2, %arg3) to min #map6(%arg2, %arg3)[%0] {
                %1 = affine.apply #map7(%arg3)
                call @S1(%arg1, %arg5, %1) : (memref<4000x4000xf64>, index, index) -> ()
                affine.for %arg6 = #map8(%arg3) to #map9(%arg3) {
                  affine.for %arg7 = #map7(%arg3) to #map0(%arg6) {
                    call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
                  }
                  call @S1(%arg1, %arg5, %arg6) : (memref<4000x4000xf64>, index, index) -> ()
                }
              }
            }
            affine.if #set2(%arg3, %arg4) {
              affine.for %arg5 = max #map10(%arg2, %arg3) to min #map6(%arg2, %arg3)[%0] {
                affine.for %arg6 = #map7(%arg3) to min #map11(%arg3, %arg5) {
                  affine.for %arg7 = #map7(%arg4) to #map9(%arg4) {
                    call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
                  }
                }
              }
            ...
            affine.if #set3(%arg2, %arg3, %arg4) {
              affine.for %arg5 = #map5(%arg2, %arg3) to min #map6(%arg2, %arg3)[%0] {
                affine.for %arg6 = #map7(%arg3) to #map9(%arg3) {
                  call @S2(%arg1, %arg5, %arg6) : (memref<4000x4000xf64>, index, index) -> ()
                }
              }
            }
            affine.if #set4(%arg2, %arg3, %arg4) {
              affine.if #set5(%arg2) {
                %1 = affine.apply #map12(%arg2)
                call @S3(%arg1, %1) : (memref<4000x4000xf64>, index) -> ()
              }
            }
            affine.if #set6(%arg2, %arg3, %arg4)[%0] {
              affine.if #set5(%arg2) {
                %1 = affine.apply #map13(%arg2)
                %2 = affine.apply #map12(%arg2)
                call @S1(%arg1, %1, %2) : (memref<4000x4000xf64>, index, index) -> ()
              }
              affine.if #set5(%arg2) {
                %1 = affine.apply #map13(%arg2)
                %2 = affine.apply #map12(%arg2)
                call @S2(%arg1, %1, %2) : (memref<4000x4000xf64>, index, index) -> ()
              }
              affine.if #set5(%arg2) {
                %1 = affine.apply #map13(%arg2)
                call @S3(%arg1, %1) : (memref<4000x4000xf64>, index) -> ()
            ...
            affine.if #set4(%arg2, %arg3, %arg4) {
              affine.for %arg5 = #map14(%arg2) to min #map15(%arg2)[%0] {
                affine.if #set5(%arg2) {
                  %1 = affine.apply #map12(%arg2)
                  call @S1(%arg1, %arg5, %1) : (memref<4000x4000xf64>, index, index) -> ()
                }
                affine.if #set5(%arg2) {
                  %1 = affine.apply #map12(%arg2)
                  call @S2(%arg1, %arg5, %1) : (memref<4000x4000xf64>, index, index) -> ()
                }
                affine.for %arg6 = #map13(%arg2) to #map0(%arg5) {
                  affine.for %arg7 = #map12(%arg2) to #map0(%arg6) {
                    affine.if #set5(%arg2) {
                      call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
                    }
                  }
                ...
                affine.if #set5(%arg2) {
                  call @S3(%arg1, %arg5) : (memref<4000x4000xf64>, index) -> ()
                }
              }
            }
          }
