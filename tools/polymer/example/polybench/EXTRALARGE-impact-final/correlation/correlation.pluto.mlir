        ...
        affine.for %arg8 = 0 to #map4()[%1] {
          affine.for %arg9 = #map5(%arg8) to min #map8(%arg8)[%1] {
            affine.for %arg10 = #map5(%arg7) to min #map8(%arg7)[%0] {
              call @S1(%arg5, %arg10, %arg3, %arg9) : (memref<2600xf64>, index, memref<3000x2600xf64>, index) -> ()
            }
          }
        }
      }
    ...
    affine.if #set1()[%1] {
      affine.for %arg7 = 0 to #map4()[%0] {
        affine.for %arg8 = 0 to #map4()[%1] {
          affine.for %arg9 = #map5(%arg8) to min #map8(%arg8)[%1] {
            affine.for %arg10 = #map5(%arg7) to min #map8(%arg7)[%0] {
              call @S4(%arg6, %arg10, %arg5, %arg3, %arg9) : (memref<2600xf64>, index, memref<2600xf64>, memref<3000x2600xf64>, index) -> ()
              call @S8(%arg3, %arg9, %arg10, %arg5) : (memref<3000x2600xf64>, index, index, memref<2600xf64>) -> ()
            }
          }
        }
      }
        ...
        affine.for %arg8 = 0 to #map4()[%0] {
          affine.for %arg9 = #map5(%arg7) to min #map8(%arg7)[%1] {
            affine.for %arg10 = #map5(%arg8) to min #map8(%arg8)[%0] {
              call @S9(%arg3, %arg9, %arg10, %arg6, %arg2) : (memref<3000x2600xf64>, index, index, memref<2600xf64>, f64) -> ()
            }
          }
        }
      }
            ...
            affine.for %arg10 = #map5(%arg7) to min #map6(%arg7, %arg8)[%0] {
              affine.for %arg11 = #map5(%arg9) to min #map8(%arg9)[%1] {
                affine.for %arg12 = max #map7(%arg8, %arg10) to min #map8(%arg8)[%0] {
                  call @S12(%arg4, %arg10, %arg12, %arg3, %arg11) : (memref<2600x2600xf64>, index, index, memref<3000x2600xf64>, index) -> ()
                }
              }
            }
          }
