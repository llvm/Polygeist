...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %0 = alloc() : memref<250x220x270xf64>
    %1 = alloc() : memref<270xf64>
    %2 = alloc() : memref<270x270xf64>
    call @init_array(%c250_i32, %c220_i32, %c270_i32, %0, %2) : (i32, i32, i32, memref<250x220x270xf64>, memref<270x270xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_doitgen_new(%c250_i32, %c220_i32, %c270_i32, %0, %2, %1) : (i32, i32, i32, memref<250x220x270xf64>, memref<270x270xf64>, memref<270xf64>) -> ()
    ...
    scf.if %4 {
      call @print_array(%c250_i32, %c220_i32, %c270_i32, %0) : (i32, i32, i32, memref<250x220x270xf64>) -> ()
    }
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<250x220x270xf64>, %arg4: memref<270x270xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb5:  // pred: ^bb4
    ...
    %15 = divf %13, %14 : f64
    store %15, %arg3[%2, %5, %9] : memref<250x220x270xf64>
  ...
  ^bb10:  // pred: ^bb9
    ...
    %28 = divf %26, %27 : f64
    store %28, %arg4[%20, %23] : memref<270x270xf64>
  ...
  func @kernel_doitgen(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<250x220x270xf64>, %arg4: memref<270x270xf64>, %arg5: memref<270xf64>) {
    ...
    affine.for %arg6 = 0 to %2 {
      affine.for %arg7 = 0 to %0 {
        affine.for %arg8 = 0 to %1 {
          call @S0(%arg5, %arg8) : (memref<270xf64>, index) -> ()
          affine.for %arg9 = 0 to %1 {
            call @S1(%arg5, %arg8, %arg4, %arg9, %arg3, %arg6, %arg7) : (memref<270xf64>, index, memref<270x270xf64>, index, memref<250x220x270xf64>, index, index) -> ()
          }
        }
        affine.for %arg8 = 0 to %1 {
          call @S2(%arg3, %arg6, %arg7, %arg8, %arg5) : (memref<250x220x270xf64>, index, index, index, memref<270xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @print_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<250x220x270xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb6:  // pred: ^bb5
    ...
    %46 = load %arg3[%15, %30, %34] : memref<250x220x270xf64>
  ...
  func private @S0(%arg0: memref<270xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1] : memref<270xf64>
    return
  }
  func private @S1(%arg0: memref<270xf64>, %arg1: index, %arg2: memref<270x270xf64>, %arg3: index, %arg4: memref<250x220x270xf64>, %arg5: index, %arg6: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<270xf64>
    %1 = affine.load %arg4[%arg5, %arg6, %arg3] : memref<250x220x270xf64>
    %2 = affine.load %arg2[%arg3, %arg1] : memref<270x270xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1] : memref<270xf64>
    return
  }
  func private @S2(%arg0: memref<250x220x270xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<270xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[%arg3] : memref<270xf64>
    affine.store %0, %arg0[%arg1, %arg2, %arg3] : memref<250x220x270xf64>
    return
  }
  func private @kernel_doitgen_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<250x220x270xf64>, %arg4: memref<270x270xf64>, %arg5: memref<270xf64>) {
        ...
        affine.for %arg7 = 0 to %1 {
          affine.for %arg8 = 0 to #map0()[%2] {
            affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%2] {
              call @S0(%arg5, %arg9) : (memref<270xf64>, index) -> ()
            }
          }
          affine.for %arg8 = 0 to #map0()[%2] {
            affine.for %arg9 = 0 to #map0()[%2] {
              affine.for %arg10 = #map1(%arg9) to min #map2(%arg9)[%2] {
                affine.for %arg11 = #map1(%arg8) to min #map2(%arg8)[%2] {
                  call @S1(%arg5, %arg11, %arg4, %arg10, %arg3, %arg6, %arg7) : (memref<270xf64>, index, memref<270x270xf64>, index, memref<250x220x270xf64>, index, index) -> ()
                }
              }
            }
          }
          affine.for %arg8 = 0 to #map0()[%2] {
            affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%2] {
              call @S2(%arg3, %arg6, %arg7, %arg9, %arg5) : (memref<250x220x270xf64>, index, index, index, memref<270xf64>) -> ()
            }
          }
        }
      }
