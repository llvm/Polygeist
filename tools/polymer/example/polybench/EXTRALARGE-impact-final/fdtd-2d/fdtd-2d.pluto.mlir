...
#map3 = affine_map<(d0)[s0, s1] -> ((s0 + s1 - 2) floordiv 32 + 1, (d0 * 16 + s1 + 14) floordiv 32 + 1)>
#map4 = affine_map<(d0) -> (0, (d0 - 1) ceildiv 2)>
#map5 = affine_map<(d0)[s0] -> ((d0 + 1) floordiv 2 + 1, (s0 - 1) floordiv 32 + 1)>
#map6 = affine_map<(d0, d1, d2)[s0] -> (d0 * 16, d1 * 32, d2 * 32 - s0 + 1)>
#map7 = affine_map<(d0, d1, d2)[s0, s1] -> (s0, d0 * 16 + 32, d1 * 32 + 32, d0 * 32 - d2 * 32 + s1 + 31)>
#map8 = affine_map<(d0, d1, d2) -> (d0 * 32, d1, d2 * -32 + d0 * 32 + d1 * 2 - 31)>
#map9 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * -32 + d0 * 32 + d2 * 2 + 1, d2 + s0)>
#map10 = affine_map<(d0, d1) -> (-d0 + d1)>
#map11 = affine_map<(d0, d1)[s0, s1, s2] -> ((s0 + s1 - 1) floordiv 32 + 1, (d0 * 16 + s1 + 30) floordiv 32 + 1, (d0 * 16 + s0 * 14 + s1 * 15 + 2) floordiv 480 + 1, (d0 * 464 - d1 * 448 + s2 * 14 + s1 * 15 + 436) floordiv 480 + 1)>
#map12 = affine_map<(d0) -> (d0 * 16)>
#map13 = affine_map<(d0) -> (d0 * 16 + 1)>
#map14 = affine_map<(d0)[s0] -> (d0 * 16 + 32, d0 * 16 + s0)>
#map15 = affine_map<(d0, d1) -> (d0 * -16 + d1)>
#map16 = affine_map<(d0, d1) -> (d0 * -16 + d1 - 1)>
#map17 = affine_map<(d0)[s0] -> (s0, d0 * 16 + 31)>
#map18 = affine_map<(d0) -> (d0 + 1)>
#map19 = affine_map<(d0, d1)[s0] -> (d0 * 16 + 32, d1 + s0)>
#map20 = affine_map<(d0)[s0] -> (s0, d0 * 16 + 32)>
#map21 = affine_map<(d0, d1)[s0] -> (d0 * 16, d1 * 32 - s0 + 1)>
#map22 = affine_map<(d0, d1)[s0] -> (s0, d0 * 16 + 32, d1 * 32)>
#map23 = affine_map<(d0) -> (d0 * 32)>
#map24 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 + s0)>
#map25 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 16 + s0)>
#map26 = affine_map<(d0, d1, d2)[s0] -> (d0 * 16, d1 * 32, d0 * 32 - d2 * 32 + 1, d2 * 32 - s0 + 1)>
#map27 = affine_map<(d0, d1, d2)[s0, s1] -> (s0, d0 * 16 + 32, d1 * 32 + 31, d2 * 32 + 32, d0 * 32 - d1 * 32 + s1 + 31)>
#map28 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 + 1, d2 * -32 + d0 * 32 + d1 * 2 - 31)>
#map29 = affine_map<(d0) -> (d0 * 16 + 31)>
#map30 = affine_map<(d0, d1, d2)[s0, s1] -> (0, d0 * 16, d0 * 32 - d1 * 32 + 1, d1 * 32 - s0 + 1, d2 * 32 - s1 + 1)>
#map31 = affine_map<(d0, d1, d2)[s0, s1] -> (s0, d0 * 16 + 31, d1 * 32, d0 * 32 - d2 * 32 + s1 + 30)>
#map32 = affine_map<(d0, d1, d2) -> (d0 * -32 + d1 * 32 + d2 - 31)>
#map33 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 + 1, d2 * -32 + d0 * 32 + d1 * 2 - 30)>
#map34 = affine_map<(d0, d1) -> (-d0 + d1 - 1)>
#map35 = affine_map<(d0, d1, d2) -> (d0 * -32 + d1 * 32 + d2)>
#map36 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 16 + s0 + 31)>
#map37 = affine_map<(d0, d1) -> (d0 * -16 + d1 - 31)>
#map38 = affine_map<(d0, d1) -> (d0 * -16 + d1 * 32)>
#map39 = affine_map<(d0, d1, d2)[s0, s1] -> (d0 * 32 + 32, d1 * 32 - d2 * 32 + s0 + s1 + 30)>
#map40 = affine_map<(d0, d1, d2)[s0] -> (d0 * -32 + d1 * 32 + d2 - s0 - 30)>
#map41 = affine_map<(d0, d1, d2)[s0, s1] -> (s0, d0 * 16 + 31, d1 * 32 + 31, d0 * 32 - d2 * 32 + s1 + 30)>
#map42 = affine_map<(d0, d1)[s0] -> (d0 * 32 - d1 * 32 + s0 + 30)>
#map43 = affine_map<(d0, d1)[s0] -> (d0 * 32 - d1 * 32 + s0 + 31)>
#map44 = affine_map<(d0) -> (d0 * 16 + 32)>
#map45 = affine_map<(d0)[s0] -> (d0 * 16 + 48, d0 * 16 + s0 + 31)>
#map46 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * -32 + d0 * 32 + d2 * 64 + 31)>
#map47 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * 32 + s0 + 31, d2 * -32 + d0 * 32 + d1 * 64 + 63)>
#map48 = affine_map<(d0, d1) -> (d0 * -32 + d1 - 31)>
#map49 = affine_map<(d0) -> (d0 * 32 + 31)>
#set0 = affine_set<()[s0, s1] : (s0 - 1 >= 0, s1 - 1 >= 0)>
#set1 = affine_set<()[s0] : (-s0 - 1 >= 0)>
#set2 = affine_set<()[s0] : (s0 >= 0)>
#set3 = affine_set<(d0, d1, d2)[s0, s1] : (s0 - 2 >= 0, s1 - 2 >= 0, d0 - d1 * 2 == 0, d0 - d2 * 2 == 0)>
#set4 = affine_set<(d0) : (d0 mod 2 == 0)>
#set5 = affine_set<(d0, d1, d2)[s0, s1] : (s0 - 1 == 0, s1 - 2 >= 0, d0 - d1 * 2 == 0, d0 - d2 * 2 == 0)>
#set6 = affine_set<(d0, d1, d2)[s0, s1] : (s0 - 1 == 0, -s1 + 1 >= 0, d0 - d1 * 2 == 0, d0 - d2 * 2 == 0)>
#set7 = affine_set<()[s0, s1] : (s0 - 2 >= 0, s1 == 0)>
#set8 = affine_set<(d0, d1, d2)[s0, s1] : (s0 - 2 >= 0, s1 - 1 == 0, d0 - d1 * 2 == 0, d0 - d2 * 2 == 0)>
#set9 = affine_set<(d0, d1)[s0] : (s0 - 1 == 0, d0 - d1 * 2 == 0)>
#set10 = affine_set<(d0, d1, d2)[s0, s1] : (s0 - 2 >= 0, d0 - d1 * 2 == 0, d0 - (d2 * 32 - s1 + 1) ceildiv 16 >= 0, d2 * 2 - d0 - 2 >= 0)>
#set11 = affine_set<()[s0, s1] : (s0 - 2 >= 0, s1 - 1 == 0)>
#set12 = affine_set<(d0, d1, d2) : (d0 - d1 * 2 == 0, d0 - d2 * 2 == 0)>
#set13 = affine_set<(d0, d1, d2)[s0, s1, s2] : (s0 - 2 >= 0, s1 - 1 == 0, d0 - d1 * 2 == 0, d0 - d2 * 2 == 0, -d0 + s2 floordiv 16 - 2 >= 0)>
#set14 = affine_set<()[s0] : (s0 - 2 >= 0)>
#set15 = affine_set<(d0, d1, d2) : (d1 floordiv 16 - d0 - 1 >= 0, d2 + d1 floordiv 32 - d0 - 1 >= 0)>
#set16 = affine_set<(d0, d1) : (d0 - d1 * 2 == 0)>
#set17 = affine_set<(d0, d1, d2)[s0] : (d0 - (d1 - 15) ceildiv 16 >= 0, d0 - (d2 * 32 + d1 - s0 + 2) ceildiv 32 >= 0)>
#set18 = affine_set<(d0, d1, d2)[s0, s1] : (-d0 + s0 floordiv 16 - 2 >= 0, d1 * 2 - d0 - 1 >= 0, d2 * 2 - d0 - 2 >= 0, d0 - (d1 * 32 - s1 + 1) ceildiv 16 >= 0)>
#set19 = affine_set<(d0, d1, d2)[s0, s1, s2] : (d1 * 2 + (-s0) floordiv 16 - d0 >= 0, (d1 * 32 + s1 - s0 - 31) floordiv 32 - d0 >= 0, (d1 * 32 + d2 * 32 - s0 - 31) floordiv 32 - d0 >= 0, d0 - (d1 * 32 + d2 * 32 - s0 - s2 - 29) ceildiv 32 >= 0)>
#set20 = affine_set<(d0, d1, d2)[s0, s1] : (s0 - 2 >= 0, d0 - d1 * 2 == 0, -d0 + s1 floordiv 16 - 2 >= 0, d2 * 2 - d0 - 2 >= 0)>
#set21 = affine_set<()[s0, s1] : (s0 - 2 >= 0, s1 - 2 >= 0)>
#set22 = affine_set<(d0, d1, d2)[s0, s1, s2] : (s0 - 2 >= 0, d1 * 2 + (-s1) floordiv 16 - d0 >= 0, d1 + d2 + (-s1) floordiv 32 - d0 >= 0, (d1 * 32 + s2 - s1 - 31) floordiv 32 - d0 >= 0, d0 - (d1 * 32 + d2 * 32 - s1 - 30) ceildiv 32 >= 0)>
#set23 = affine_set<(d0, d1, d2)[s0, s1, s2] : (s0 - 2 >= 0, d0 - (d1 * 2 - 1) == 0, -d0 + s1 floordiv 16 - 2 >= 0, d0 - (d2 * 32 - s2 + 1) ceildiv 16 >= 0)>
#set24 = affine_set<(d0) : ((d0 + 1) mod 2 == 0)>
#set25 = affine_set<(d0, d1, d2)[s0, s1, s2] : (s0 - 2 >= 0, d0 - (d1 * 32 + d2 * 32 - s1 + 1) ceildiv 32 >= 0, d0 - d2 * 2 >= 0, d1 - (d2 + 1) >= 0, -d2 + s2 floordiv 32 - 1 >= 0)>
#set26 = affine_set<(d0, d1, d2)[s0, s1] : (s0 - 2 >= 0, d0 - d1 * 2 == 0, d0 - d2 * 2 == 0, -d0 + s1 floordiv 16 - 2 >= 0)>
  ...
  func private @kernel_fdtd_2d_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<2000x2600xf64>, %arg4: memref<2000x2600xf64>, %arg5: memref<2000x2600xf64>, %arg6: memref<1000xf64>) {
    ...
    affine.if #set0()[%0, %2] {
      affine.for %arg7 = -1 to #map1()[%0] {
        affine.for %arg8 = #map2(%arg7) to min #map3(%arg7)[%0, %2] {
          affine.if #set1()[%1] {
            affine.for %arg9 = max #map4(%arg7) to min #map5(%arg7)[%0] {
              affine.for %arg10 = max #map6(%arg7, %arg9, %arg8)[%2] to min #map7(%arg7, %arg9, %arg8)[%0, %2] {
                affine.for %arg11 = max #map8(%arg8, %arg10, %arg7) to min #map9(%arg8, %arg7, %arg10)[%2] {
                  %3 = affine.apply #map10(%arg10, %arg11)
                  call @S0(%arg4, %3, %arg6, %arg10) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                }
              }
            }
          }
          affine.if #set2()[%1] {
            affine.for %arg9 = max #map4(%arg7) to min #map11(%arg7, %arg8)[%0, %1, %2] {
              affine.if #set3(%arg7, %arg8, %arg9)[%2, %1] {
                affine.if #set4(%arg7) {
                  %3 = affine.apply #map12(%arg7)
                  call @S0(%arg4, %c0, %arg6, %3) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                }
                affine.for %arg10 = #map13(%arg7) to min #map14(%arg7)[%1] {
                  affine.if #set4(%arg7) {
              ...
              affine.if #set5(%arg7, %arg8, %arg9)[%2, %1] {
                affine.for %arg10 = #map12(%arg7) to min #map17(%arg7)[%0] {
                  affine.if #set4(%arg7) {
                    call @S0(%arg4, %c0, %arg6, %arg10) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                  }
                  affine.for %arg11 = #map18(%arg10) to min #map19(%arg7, %arg10)[%1] {
                    affine.if #set4(%arg7) {
                      %3 = affine.apply #map10(%arg10, %arg11)
                      call @S1(%arg4, %3, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                    }
              ...
              affine.if #set6(%arg7, %arg8, %arg9)[%2, %1] {
                affine.for %arg10 = #map12(%arg7) to min #map20(%arg7)[%0] {
                  affine.if #set4(%arg7) {
                    call @S0(%arg4, %c0, %arg6, %arg10) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                  }
                }
              ...
              affine.if #set8(%arg7, %arg8, %arg9)[%2, %1] {
                affine.if #set4(%arg7) {
                  %3 = affine.apply #map12(%arg7)
                  call @S0(%arg4, %c0, %arg6, %3) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                }
              }
              affine.if #set9(%arg7, %arg8)[%2] {
                affine.for %arg10 = max #map21(%arg7, %arg9)[%1] to min #map22(%arg7, %arg9)[%0] {
                  affine.for %arg11 = #map23(%arg9) to min #map24(%arg9, %arg10)[%1] {
                    affine.if #set4(%arg7) {
                      %3 = affine.apply #map10(%arg10, %arg11)
                      call @S1(%arg4, %3, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                    }
              ...
              affine.if #set10(%arg7, %arg8, %arg9)[%2, %1] {
                affine.for %arg10 = #map23(%arg9) to min #map25(%arg9, %arg7)[%1] {
                  affine.if #set4(%arg7) {
                    %3 = affine.apply #map15(%arg7, %arg10)
                    call @S1(%arg4, %3, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                  }
              ...
              affine.if #set11()[%2, %1] {
                affine.for %arg10 = max #map26(%arg7, %arg9, %arg8)[%2] to min #map27(%arg7, %arg8, %arg9)[%0, %2] {
                  affine.if #set12(%arg7, %arg8, %arg9) {
                    affine.if #set4(%arg7) {
                      call @S0(%arg4, %c0, %arg6, %arg10) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                    }
                  }
                  affine.for %arg11 = max #map28(%arg8, %arg10, %arg7) to min #map9(%arg8, %arg7, %arg10)[%2] {
                    %3 = affine.apply #map10(%arg10, %arg11)
                    call @S0(%arg4, %3, %arg6, %arg10) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                    %4 = affine.apply #map10(%arg10, %arg11)
                    call @S2(%arg3, %c0, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                  }
                }
              }
              affine.if #set13(%arg7, %arg8, %arg9)[%2, %1, %0] {
                affine.if #set4(%arg7) {
                  %3 = affine.apply #map29(%arg7)
                  call @S0(%arg4, %c0, %arg6, %3) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                }
              }
              affine.if #set14()[%2] {
                affine.for %arg10 = max #map30(%arg7, %arg8, %arg9)[%2, %1] to min #map31(%arg7, %arg9, %arg8)[%0, %2] {
                  affine.for %arg11 = #map23(%arg9) to min #map24(%arg9, %arg10)[%1] {
                    affine.if #set15(%arg7, %arg10, %arg8) {
                      %3 = affine.apply #map10(%arg10, %arg11)
                      %4 = affine.apply #map32(%arg7, %arg8, %arg10)
                      call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                      %5 = affine.apply #map10(%arg10, %arg11)
                      %6 = affine.apply #map32(%arg7, %arg8, %arg10)
                      call @S2(%arg3, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                    }
                    affine.if #set16(%arg7, %arg8) {
                      affine.if #set4(%arg7) {
                        %3 = affine.apply #map10(%arg10, %arg11)
                        call @S1(%arg4, %3, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                      }
                    }
                    affine.for %arg12 = max #map33(%arg8, %arg10, %arg7) to min #map9(%arg8, %arg7, %arg10)[%2] {
                      %3 = affine.apply #map10(%arg10, %arg11)
                      %4 = affine.apply #map10(%arg10, %arg12)
                      call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                      %5 = affine.apply #map10(%arg10, %arg11)
                      %6 = affine.apply #map10(%arg10, %arg12)
                      call @S2(%arg3, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                      %7 = affine.apply #map34(%arg10, %arg11)
                      %8 = affine.apply #map34(%arg10, %arg12)
                      call @S3(%arg5, %7, %8, %arg4, %arg3) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>, memref<2000x2600xf64>) -> ()
                    }
                    affine.if #set17(%arg7, %arg10, %arg8)[%2] {
                      %3 = affine.apply #map34(%arg10, %arg11)
                      %4 = affine.apply #map35(%arg7, %arg8, %arg10)
                      call @S3(%arg5, %3, %4, %arg4, %arg3) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>, memref<2000x2600xf64>) -> ()
                    }
                  }
                }
              }
              affine.if #set18(%arg7, %arg8, %arg9)[%0, %2] {
                affine.for %arg10 = #map23(%arg9) to min #map36(%arg9, %arg7)[%1] {
                  %3 = affine.apply #map37(%arg7, %arg10)
                  %4 = affine.apply #map38(%arg7, %arg8)
                  call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                  %5 = affine.apply #map37(%arg7, %arg10)
                  %6 = affine.apply #map38(%arg7, %arg8)
                  call @S2(%arg3, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                }
              }
              affine.if #set19(%arg7, %arg8, %arg9)[%2, %0, %1] {
                affine.for %arg10 = #map23(%arg9) to min #map39(%arg9, %arg7, %arg8)[%2, %1] {
                  %3 = affine.apply #map40(%arg7, %arg8, %arg10)[%2]
                  %4 = affine.apply #map0()[%2]
                  call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                  %5 = affine.apply #map40(%arg7, %arg8, %arg10)[%2]
                  %6 = affine.apply #map0()[%2]
                  call @S2(%arg3, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                }
              }
              affine.if #set20(%arg7, %arg8, %arg9)[%2, %0] {
                affine.for %arg10 = #map23(%arg9) to min #map36(%arg9, %arg7)[%1] {
                  affine.if #set4(%arg7) {
                    %3 = affine.apply #map37(%arg7, %arg10)
                    call @S1(%arg4, %3, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
              ...
              affine.if #set21()[%2, %1] {
                affine.for %arg10 = max #map26(%arg7, %arg9, %arg8)[%2] to min #map41(%arg7, %arg9, %arg8)[%0, %2] {
                  affine.if #set12(%arg7, %arg8, %arg9) {
                    affine.if #set4(%arg7) {
                      call @S0(%arg4, %c0, %arg6, %arg10) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                    }
                  ...
                  affine.for %arg11 = #map18(%arg10) to min #map24(%arg9, %arg10)[%1] {
                    affine.if #set15(%arg7, %arg10, %arg8) {
                      %3 = affine.apply #map10(%arg10, %arg11)
                      %4 = affine.apply #map32(%arg7, %arg8, %arg10)
                      call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
              ...
              affine.if #set25(%arg7, %arg8, %arg9)[%1, %2, %0] {
                affine.for %arg10 = max #map46(%arg8, %arg7, %arg9) to min #map47(%arg8, %arg9, %arg7)[%2] {
                  %3 = affine.apply #map48(%arg9, %arg10)
                  %4 = affine.apply #map49(%arg9)
                  call @S0(%arg4, %3, %arg6, %4) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                  %5 = affine.apply #map48(%arg9, %arg10)
                  call @S2(%arg3, %c0, %5, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                }
              }
              affine.if #set26(%arg7, %arg8, %arg9)[%1, %0] {
                affine.if #set4(%arg7) {
                  %3 = affine.apply #map29(%arg7)
                  call @S0(%arg4, %c0, %arg6, %3) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
                }
