...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %3 = alloc() : memref<2600x2000xf64>
    %4 = alloc() : memref<2600x2000xf64>
    %5 = memref_cast %0 : memref<1xf64> to memref<?xf64>
    %6 = memref_cast %1 : memref<1xf64> to memref<?xf64>
    call @init_array(%c2600_i32, %c2000_i32, %5, %6, %2, %3, %4) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<2600x2600xf64>, memref<2600x2000xf64>, memref<2600x2000xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %7 = load %0[%c0] : memref<1xf64>
    %8 = load %1[%c0] : memref<1xf64>
    call @kernel_syr2k_new(%c2600_i32, %c2000_i32, %7, %8, %2, %3, %4) : (i32, i32, f64, f64, memref<2600x2600xf64>, memref<2600x2000xf64>, memref<2600x2000xf64>) -> ()
  ...
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600x2000xf64>, %arg6: memref<2600x2000xf64>) {
    %c0 = constant 0 : index
  ...
  ^bb8:  // pred: ^bb7
    ...
    %30 = divf %28, %29 : f64
    store %30, %arg4[%21, %24] : memref<2600x2600xf64>
  ...
  func private @kernel_syr2k(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<2600x2600xf64>, %arg5: memref<2600x2000xf64>, %arg6: memref<2600x2000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to #map0(%arg7) {
        call @S0(%arg4, %arg7, %arg8, %arg3) : (memref<2600x2600xf64>, index, index, f64) -> ()
      }
      affine.for %arg8 = 0 to %1 {
        affine.for %arg9 = 0 to #map0(%arg7) {
          call @S1(%arg4, %arg7, %arg9, %arg5, %arg8, %arg2, %arg6) : (memref<2600x2600xf64>, index, index, memref<2600x2000xf64>, index, f64, memref<2600x2000xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @S0(%arg0: memref<2600x2600xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    %1 = mulf %0, %arg3 : f64
    affine.store %1, %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    return
  }
  func private @S1(%arg0: memref<2600x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<2600x2000xf64>, %arg4: index, %arg5: f64, %arg6: memref<2600x2000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    %1 = affine.load %arg3[%arg2, %arg4] : memref<2600x2000xf64>
    %2 = mulf %1, %arg5 : f64
    %3 = affine.load %arg6[%arg1, %arg4] : memref<2600x2000xf64>
    %4 = mulf %2, %3 : f64
    %5 = affine.load %arg6[%arg2, %arg4] : memref<2600x2000xf64>
    %6 = mulf %5, %arg5 : f64
    %7 = affine.load %arg3[%arg1, %arg4] : memref<2600x2000xf64>
    %8 = mulf %6, %7 : f64
    %9 = addf %4, %8 : f64
    %10 = addf %0, %9 : f64
    affine.store %10, %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    return
  }
  func private @kernel_syr2k_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<2600x2600xf64>, %arg5: memref<2600x2000xf64>, %arg6: memref<2600x2000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.if #set()[%0] {
      affine.for %arg7 = 0 to #map1()[%0] {
        affine.for %arg8 = 0 to #map0(%arg7) {
          affine.for %arg9 = #map2(%arg7) to min #map3(%arg7)[%0] {
            affine.for %arg10 = #map2(%arg8) to min #map4(%arg9, %arg8) {
              call @S0(%arg4, %arg9, %arg10, %arg3) : (memref<2600x2600xf64>, index, index, f64) -> ()
            }
          }
        }
      }
          ...
          affine.for %arg8 = 0 to #map0(%arg7) {
            affine.for %arg9 = 0 to #map1()[%1] {
              affine.for %arg10 = #map2(%arg7) to min #map3(%arg7)[%0] {
                affine.for %arg11 = #map2(%arg8) to min #map4(%arg10, %arg8) {
                  affine.for %arg12 = #map2(%arg9) to min #map3(%arg9)[%1] {
                    call @S1(%arg4, %arg10, %arg11, %arg5, %arg12, %arg2, %arg6) : (memref<2600x2600xf64>, index, index, memref<2600x2000xf64>, index, f64, memref<2600x2000xf64>) -> ()
                  }
                }
              }
            }
