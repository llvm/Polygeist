  ...
  func private @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<7680x4320xf32>, %arg4: memref<7680x4320xf32>, %arg5: memref<7680x4320xf32>, %arg6: memref<7680x4320xf32>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        %38 = affine.load %arg3[%arg7, %arg8] : memref<7680x4320xf32>
        %39 = mulf %21, %38 : f32
        ...
        %47 = mulf %36, %46 : f32
        %48 = addf %45, %47 : f32
        affine.store %48, %arg5[%arg7, %arg8] : memref<7680x4320xf32>
        affine.store %38, %2[0] : memref<1xf32>
        affine.store %43, %5[0] : memref<1xf32>
        affine.store %48, %4[0] : memref<1xf32>
      }
    }
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        ...
        %47 = mulf %36, %46 : f32
        %48 = addf %45, %47 : f32
        affine.store %48, %arg6[%arg7, -%arg8 + symbol(%0) - 1] : memref<7680x4320xf32>
        affine.store %38, %7[0] : memref<1xf32>
        %49 = affine.load %arg3[%arg7, -%arg8 + symbol(%0) - 1] : memref<7680x4320xf32>
        affine.store %49, %6[0] : memref<1xf32>
        affine.store %43, %11[0] : memref<1xf32>
        affine.store %48, %10[0] : memref<1xf32>
      }
    }
    affine.for %arg7 = 0 to %1 {
      affine.for %arg8 = 0 to %0 {
        %38 = affine.load %arg5[%arg7, %arg8] : memref<7680x4320xf32>
        %39 = affine.load %arg6[%arg7, %arg8] : memref<7680x4320xf32>
        %40 = addf %38, %39 : f32
        %41 = mulf %37, %40 : f32
        affine.store %41, %arg4[%arg7, %arg8] : memref<7680x4320xf32>
      }
    }
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        %38 = affine.load %arg4[%arg8, %arg7] : memref<7680x4320xf32>
        %39 = mulf %21, %38 : f32
        ...
        %47 = mulf %36, %46 : f32
        %48 = addf %45, %47 : f32
        affine.store %48, %arg5[%arg8, %arg7] : memref<7680x4320xf32>
        affine.store %38, %3[0] : memref<1xf32>
        affine.store %43, %5[0] : memref<1xf32>
        %49 = affine.load %arg5[%arg8, %arg7] : memref<7680x4320xf32>
        affine.store %49, %4[0] : memref<1xf32>
      }
    }
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        ...
        %47 = mulf %36, %46 : f32
        %48 = addf %45, %47 : f32
        affine.store %48, %arg6[-%arg8 + symbol(%1) - 1, %arg7] : memref<7680x4320xf32>
        affine.store %38, %9[0] : memref<1xf32>
        %49 = affine.load %arg4[-%arg8 + symbol(%1) - 1, %arg7] : memref<7680x4320xf32>
        affine.store %49, %8[0] : memref<1xf32>
        affine.store %43, %11[0] : memref<1xf32>
        %50 = affine.load %arg6[-%arg8 + symbol(%1) - 1, %arg7] : memref<7680x4320xf32>
        affine.store %50, %10[0] : memref<1xf32>
      }
    }
    affine.for %arg7 = 0 to %1 {
      affine.for %arg8 = 0 to %0 {
