module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_floyd_warshall(%c5600_i32, %0) : (i32, memref<5600x5600xi32>) -> ()
    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to %0 {
        affine.for %arg4 = 0 to %0 {
          %1 = affine.load %arg1[%arg3, %arg4] : memref<5600x5600xi32>
          %2 = affine.load %arg1[%arg3, %arg2] : memref<5600x5600xi32>
          %3 = affine.load %arg1[%arg2, %arg4] : memref<5600x5600xi32>
          %4 = addi %2, %3 : i32
          %5 = cmpi "slt", %1, %4 : i32
          %6 = select %5, %1, %4 : i32
          affine.store %6, %arg1[%arg3, %arg4] : memref<5600x5600xi32>
        }
      }
    }
    return
