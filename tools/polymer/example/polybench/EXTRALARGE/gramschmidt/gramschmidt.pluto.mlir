...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<2000x2600xf64>, %arg3: memref<2600x2600xf64>, %arg4: memref<2000x2600xf64>) {
    ...
    affine.for %arg5 = 0 to %3 {
      ...
      affine.for %arg6 = 0 to %1 {
        call @S4(%arg4, %arg6, %arg5, %0, %arg2) : (memref<2000x2600xf64>, index, index, memref<1xf64>, memref<2000x2600xf64>) -> ()
      }
    ...
    affine.if #set0()[%3] {
      ...
      affine.for %arg5 = 0 to %3 {
        ...
        affine.for %arg6 = 0 to %2 {
          call @S1(%1, %arg2, %arg6, %arg5) : (memref<1xf64>, memref<2000x2600xf64>, index, index) -> ()
        }
            ...
            affine.for %arg7 = 0 to #map3()[%2] {
              affine.for %arg8 = #map4(%arg7) to min #map7(%arg7)[%2] {
                affine.for %arg9 = max #map6(%arg6, %arg5) to min #map7(%arg6)[%3] {
                  call @S6(%arg3, %arg5, %arg9, %arg2, %arg8, %arg4) : (memref<2600x2600xf64>, index, index, memref<2000x2600xf64>, index, memref<2000x2600xf64>) -> ()
                }
              }
            }
            affine.for %arg7 = 0 to #map3()[%2] {
              affine.for %arg8 = #map4(%arg7) to min #map7(%arg7)[%2] {
                affine.for %arg9 = max #map6(%arg6, %arg5) to min #map7(%arg6)[%3] {
                  call @S7(%arg2, %arg8, %arg9, %arg3, %arg5, %arg4) : (memref<2000x2600xf64>, index, index, memref<2600x2600xf64>, index, memref<2000x2600xf64>) -> ()
                }
              }
            }
          }
