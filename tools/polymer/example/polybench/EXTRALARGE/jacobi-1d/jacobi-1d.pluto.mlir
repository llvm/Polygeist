...
#map5 = affine_map<(d0, d1)[s0] -> (0, (d0 * 32 - s0 + 2) ceildiv 2, d1 * 8, d1 * 16 - d0 * 16 + 1)>
#map6 = affine_map<(d0, d1)[s0, s1] -> (d0 * 16 - d1 * 16 + s0 floordiv 2 + 15, s1, d0 * 8 + 16, d1 * 16 + 15)>
#map7 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 2 + 2, d2 * -32 + d0 * 32 + d1 * 4 - 31)>
#map8 = affine_map<(d0, d1, d2) -> (d0 * -32 + d1 * 32 + d2 * 4 - 29)>
#map9 = affine_map<(d0, d1) -> (d0 * -2 + d1)>
#map10 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 2 + 2, d2 * -32 + d0 * 32 + d1 * 4 - 29)>
#map11 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * -32 + d0 * 32 + d2 * 4 + 1, d2 * 2 + s0 - 1)>
#map12 = affine_map<(d0, d1) -> (d0 * -2 + d1 - 1)>
#map13 = affine_map<(d0, d1, d2) -> (d0 * -32 + d1 * 32 + d2 * 4 + 1)>
#map14 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * 2 + s0, d2 * -32 + d0 * 32 + d1 * 4 + 3)>
...
#set3 = affine_set<(d0, d1) : (d0 - d1 * 2 == 0)>
#set4 = affine_set<(d0) : (d0 mod 2 == 0)>
#set5 = affine_set<(d0, d1, d2) : (d0 - (d1 * 16 + d2 - 16) ceildiv 16 >= 0, d2 floordiv 16 - d1 >= 0)>
#set6 = affine_set<(d0, d1, d2)[s0] : ((d1 * 32 + d2 * 2 - s0 + 1) floordiv 32 - d0 >= 0, d1 - (d2 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set7 = affine_set<(d0, d1)[s0, s1] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d1 * 32 + s1 * 2 - s0 - 31) floordiv 32 - d0 >= 0)>
#set8 = affine_set<(d0, d1)[s0] : (d0 - d1 * 2 == 0, -d0 + s0 floordiv 8 - 2 >= 0)>
      ...
      affine.for %arg4 = -1 to #map1()[%0] {
        affine.for %arg5 = #map2(%arg4) to min #map3(%arg4)[%0, %1] {
          ...
          affine.if #set3(%arg4, %arg5) {
            affine.if #set4(%arg4) {
              call @S1(%arg2, %c1, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
            }
          }
          affine.for %arg6 = max #map5(%arg5, %arg4)[%1] to min #map6(%arg4, %arg5)[%1, %0] {
            affine.if #set5(%arg4, %arg5, %arg6) {
              call @S0(%arg3, %c1, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
            }
            affine.for %arg7 = max #map7(%arg5, %arg6, %arg4) to #map8(%arg4, %arg5, %arg6) {
              %2 = affine.apply #map9(%arg6, %arg7)
              call @S0(%arg3, %2, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
            }
            affine.for %arg7 = max #map10(%arg5, %arg6, %arg4) to min #map11(%arg5, %arg4, %arg6)[%1] {
              %2 = affine.apply #map9(%arg6, %arg7)
              call @S0(%arg3, %2, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
              %3 = affine.apply #map12(%arg6, %arg7)
              call @S1(%arg2, %3, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
            }
            affine.for %arg7 = #map13(%arg4, %arg5, %arg6) to min #map14(%arg5, %arg6, %arg4)[%1] {
              %2 = affine.apply #map12(%arg6, %arg7)
              call @S1(%arg2, %2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
            }
