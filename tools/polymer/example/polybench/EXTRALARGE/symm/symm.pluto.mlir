...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_symm_new(%c2000_i32, %c2600_i32, %7, %8, %2, %3, %4) : (i32, i32, f64, f64, memref<2000x2600xf64>, memref<2000x2000xf64>, memref<2000x2600xf64>) -> ()
  ...
  func private @kernel_symm_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<2000x2600xf64>, %arg5: memref<2000x2000xf64>, %arg6: memref<2000x2600xf64>) {
    %c0 = constant 0 : index
    %0 = alloca() : memref<1xf64>
    %1 = alloca() : memref<1xf64>
    ...
    affine.if #set()[%2, %3] {
      affine.for %arg7 = 0 to %3 {
        ...
        call @S3(%arg4, %c0, %arg7, %arg2, %1, %arg5, %arg6, %arg3) : (memref<2000x2600xf64>, index, index, f64, memref<1xf64>, memref<2000x2000xf64>, memref<2000x2600xf64>, f64) -> ()
      }
      affine.for %arg7 = 1 to %2 {
        affine.for %arg8 = 0 to %3 {
          call @S1(%arg4, %c0, %arg8, %arg5, %arg7, %arg2, %arg6, %0) : (memref<2000x2600xf64>, index, index, memref<2000x2000xf64>, index, f64, memref<2000x2600xf64>, memref<1xf64>) -> ()
          call @S0(%1) : (memref<1xf64>) -> ()
          call @S2(%1, %0, %arg6, %c0, %arg8) : (memref<1xf64>, memref<1xf64>, memref<2000x2600xf64>, index, index) -> ()
          affine.for %arg9 = 1 to #map(%arg7) {
            call @S1(%arg4, %arg9, %arg8, %arg5, %arg7, %arg2, %arg6, %0) : (memref<2000x2600xf64>, index, index, memref<2000x2000xf64>, index, f64, memref<2000x2600xf64>, memref<1xf64>) -> ()
            call @S2(%1, %0, %arg6, %arg9, %arg8) : (memref<1xf64>, memref<1xf64>, memref<2000x2600xf64>, index, index) -> ()
          }
          call @S3(%arg4, %arg7, %arg8, %arg2, %1, %arg5, %arg6, %arg3) : (memref<2000x2600xf64>, index, index, f64, memref<1xf64>, memref<2000x2000xf64>, memref<2000x2600xf64>, f64) -> ()
        }
      }
    }
    return
