  ...
  func private @kernel_syr2k(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<2600x2600xf64>, %arg5: memref<2600x2000xf64>, %arg6: memref<2600x2000xf64>) {
    ...
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to #map(%arg7) {
        %2 = affine.load %arg4[%arg7, %arg8] : memref<2600x2600xf64>
        %3 = mulf %2, %arg3 : f64
        affine.store %3, %arg4[%arg7, %arg8] : memref<2600x2600xf64>
      }
      affine.for %arg8 = 0 to %1 {
        affine.for %arg9 = 0 to #map(%arg7) {
          %2 = affine.load %arg5[%arg9, %arg8] : memref<2600x2000xf64>
          %3 = mulf %2, %arg2 : f64
          %4 = affine.load %arg6[%arg7, %arg8] : memref<2600x2000xf64>
          %5 = mulf %3, %4 : f64
          %6 = affine.load %arg6[%arg9, %arg8] : memref<2600x2000xf64>
          %7 = mulf %6, %arg2 : f64
          %8 = affine.load %arg5[%arg7, %arg8] : memref<2600x2000xf64>
          %9 = mulf %7, %8 : f64
          %10 = addf %5, %9 : f64
          %11 = affine.load %arg4[%arg7, %arg9] : memref<2600x2600xf64>
          %12 = addf %11, %10 : f64
          affine.store %12, %arg4[%arg7, %arg9] : memref<2600x2600xf64>
        }
      }
    }
    return
