...
#map1 = affine_map<()[s0] -> ((-s0 - 30) ceildiv 32)>
#map2 = affine_map<()[s0] -> ((s0 - 1) floordiv 32 + 1)>
#map3 = affine_map<(d0) -> (d0, -d0 - 1)>
#map4 = affine_map<(d0)[s0, s1] -> ((d0 * -16 + s0 - 1) floordiv 16 + 1, (d0 * 16 + s1 + 14) floordiv 16 + 1, (s0 + s1 - 2) floordiv 32 + 1)>
#map5 = affine_map<(d0, d1) -> (0, (d0 + d1 - 1) ceildiv 2)>
#map6 = affine_map<(d0, d1)[s0, s1, s2] -> ((s0 + s1 - 2) floordiv 32 + 1, (d0 * 16 + d1 * 16 + s1 + 30) floordiv 32 + 1, (d0 * 32 + s2 + s1 + 29) floordiv 32 + 1)>
#map7 = affine_map<(d0) -> (d0 * 32)>
#map8 = affine_map<(d0) -> (d0 * 32 + 1)>
#map9 = affine_map<(d0)[s0] -> (d0 * 32 + 32, d0 * 32 + s0)>
#map10 = affine_map<(d0, d1) -> (d0 * -32 + d1)>
#map11 = affine_map<(d0, d1) -> (d0 * -32 + d1 - 1)>
#map12 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 32 + s0)>
#map13 = affine_map<(d0, d1, d2)[s0, s1] -> (0, d0 * 16 + d1 * 16, d0 * 32 + 1, d1 * 32 - s0 + 1, d2 * 32 - s1 + 1)>
#map14 = affine_map<(d0, d1, d2)[s0, s1] -> (s0, d0 * 32, d1 * 16 + d2 * 16 + 31, d1 * 32 + s1 + 30)>
#map15 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 + s0)>
#map16 = affine_map<(d0, d1) -> (-d0 + d1)>
#map17 = affine_map<(d0, d1) -> (d0 * -32 + d1 - 31)>
#map18 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 + 1, d2 * -32 + d1 * 2 - 30)>
#map19 = affine_map<(d0, d1, d2)[s0] -> (d0 * -32 + d1 * 2 + 1, d2 * 32 + 32, d1 + s0)>
#map20 = affine_map<(d0, d1) -> (-d0 + d1 - 1)>
#map21 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * 16 + d2 * 16 + s0 + 31)>
#map22 = affine_map<(d0, d1, d2) -> (d0 * -16 - d1 * 16 + d2 - 31)>
#map23 = affine_map<(d0, d1) -> (d0 * -16 + d1 * 16)>
#map24 = affine_map<(d0, d1)[s0, s1] -> (d0 * 32 + 32, d1 * 32 + s0 + s1 + 30)>
#map25 = affine_map<(d0, d1)[s0] -> (d0 * -32 + d1 - s0 - 30)>
#map26 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 32 + s0 + 31)>
#map27 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32, d1 * 16 + d2 * 16, d1 * 32 + 1, d2 * 32 - s0 + 1)>
#map28 = affine_map<(d0, d1, d2)[s0, s1] -> (s0, d0 * 32 + 31, d1 * 16 + d2 * 16 + 31, d1 * 32 + s1 + 30)>
#map29 = affine_map<(d0) -> (d0 + 1)>
#map30 = affine_map<(d0)[s0] -> (d0 * 32 + s0 + 30)>
#map31 = affine_map<(d0)[s0] -> (d0 * 32 + s0 + 31)>
#map32 = affine_map<(d0, d1) -> (d0 * 16 + d1 * 16 + 31)>
#map33 = affine_map<(d0, d1) -> (d0 * 16 + d1 * 16 + 32)>
#map34 = affine_map<(d0, d1)[s0] -> (d0 * 16 + d1 * 16 + 48, d0 * 16 + d1 * 16 + s0 + 31)>
#map35 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * -32 + d2 * 64 + 31)>
#map36 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * -32 + d2 * 64 + 63, d2 * 32 + s0 + 31)>
#map37 = affine_map<(d0) -> (d0 * 32 + 31)>
#set0 = affine_set<(d0, d1, d2) : (d0 - d1 == 0, d0 - d2 == 0)>
#set1 = affine_set<(d0, d1, d2)[s0] : (d0 - d1 == 0, d0 - (d2 * 32 - s0 + 1) ceildiv 32 >= 0, d2 - d0 - 1 >= 0)>
#set2 = affine_set<(d0, d1, d2) : (-d1 + d2 floordiv 16 - d0 - 1 >= 0, d2 floordiv 32 - d0 - 1 >= 0)>
#set3 = affine_set<(d0, d1) : (d0 - d1 == 0)>
#set4 = affine_set<(d0, d1, d2)[s0] : (d0 - (d1 * -16 + d2 - 15) ceildiv 16 >= 0, d0 - (d2 - s0 + 2) ceildiv 32 >= 0)>
#set5 = affine_set<(d0, d1, d2)[s0, s1] : (-d1 + s0 floordiv 16 - d0 - 2 >= 0, d1 - d0 - 1 >= 0, -d1 + d2 * 2 - d0 - 2 >= 0, d0 - (d1 * 16 - s1 + 1) ceildiv 16 >= 0)>
#set6 = affine_set<(d0, d1, d2)[s0, s1] : (d1 + (-s0) floordiv 16 - d0 >= 0, -d0 + (s1 - s0 - 31) floordiv 32 >= 0, (d2 * 32 - s0 - 31) floordiv 32 - d0 >= 0)>
#set7 = affine_set<(d0, d1, d2)[s0] : (d0 - d1 == 0, -d0 + s0 floordiv 32 - 1 >= 0, d2 - d0 - 1 >= 0)>
#set8 = affine_set<(d0, d1, d2)[s0, s1] : (d1 + (-s0) floordiv 16 - d0 >= 0, d2 + (-s0) floordiv 32 - d0 >= 0, -d0 + (s1 - s0 - 31) floordiv 32 >= 0, d0 - (d2 * 32 - s0 - 30) ceildiv 32 >= 0)>
#set9 = affine_set<(d0, d1, d2)[s0, s1] : (d0 - (-d1 + d2 * 2 - 1) == 0, -d1 + s0 floordiv 16 - d0 - 2 >= 0, d0 - (d1 * 16 - s1 + 1) ceildiv 16 >= 0)>
#set10 = affine_set<(d0, d1) : ((d0 + d1 + 1) mod 2 == 0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_fdtd_2d_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<2000x2600xf64>, %arg4: memref<2000x2600xf64>, %arg5: memref<2000x2600xf64>, %arg6: memref<1000xf64>) {
    ...
    affine.for %arg7 = #map1()[%2] to #map2()[%0] {
      affine.for %arg8 = max #map3(%arg7) to min #map4(%arg7)[%0, %2] {
        affine.for %arg9 = max #map5(%arg7, %arg8) to min #map6(%arg7, %arg8)[%0, %1, %2] {
          affine.if #set0(%arg7, %arg8, %arg9) {
            %3 = affine.apply #map7(%arg7)
            call @S0(%arg4, %c0, %arg6, %3) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
            affine.for %arg10 = #map8(%arg7) to min #map9(%arg7)[%1] {
              %4 = affine.apply #map10(%arg7, %arg10)
              call @S1(%arg4, %4, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
            }
            affine.for %arg10 = #map8(%arg7) to min #map9(%arg7)[%1] {
              %4 = affine.apply #map11(%arg7, %arg10)
              call @S3(%arg5, %4, %c0, %arg4, %arg3) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>, memref<2000x2600xf64>) -> ()
            }
          }
          affine.if #set1(%arg7, %arg8, %arg9)[%1] {
            affine.for %arg10 = #map7(%arg9) to min #map12(%arg9, %arg7)[%1] {
              %3 = affine.apply #map10(%arg7, %arg10)
              call @S1(%arg4, %3, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
            }
            affine.for %arg10 = #map7(%arg9) to min #map12(%arg9, %arg7)[%1] {
              %3 = affine.apply #map11(%arg7, %arg10)
              call @S3(%arg5, %3, %c0, %arg4, %arg3) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>, memref<2000x2600xf64>) -> ()
            }
          }
          affine.for %arg10 = max #map13(%arg7, %arg8, %arg9)[%2, %1] to min #map14(%arg9, %arg7, %arg8)[%0, %2] {
            affine.if #set2(%arg7, %arg8, %arg10) {
              affine.for %arg11 = #map7(%arg9) to min #map15(%arg9, %arg10)[%1] {
                %3 = affine.apply #map16(%arg10, %arg11)
                %4 = affine.apply #map17(%arg7, %arg10)
                call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                %5 = affine.apply #map16(%arg10, %arg11)
                %6 = affine.apply #map17(%arg7, %arg10)
            ...
            affine.for %arg11 = max #map18(%arg8, %arg10, %arg7) to min #map19(%arg7, %arg10, %arg8)[%2] {
              affine.for %arg12 = #map7(%arg9) to min #map15(%arg9, %arg10)[%1] {
                %3 = affine.apply #map16(%arg10, %arg12)
                %4 = affine.apply #map16(%arg10, %arg11)
                call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                %5 = affine.apply #map16(%arg10, %arg12)
                %6 = affine.apply #map16(%arg10, %arg11)
                call @S2(%arg3, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                %7 = affine.apply #map20(%arg10, %arg12)
                %8 = affine.apply #map20(%arg10, %arg11)
                call @S3(%arg5, %7, %8, %arg4, %arg3) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>, memref<2000x2600xf64>) -> ()
              }
            }
            affine.if #set4(%arg7, %arg8, %arg10)[%2] {
              affine.for %arg11 = #map7(%arg9) to min #map15(%arg9, %arg10)[%1] {
          ...
          affine.if #set5(%arg7, %arg8, %arg9)[%0, %2] {
            affine.for %arg10 = #map7(%arg9) to min #map21(%arg9, %arg7, %arg8)[%1] {
              %3 = affine.apply #map22(%arg7, %arg8, %arg10)
              %4 = affine.apply #map23(%arg7, %arg8)
              call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
              %5 = affine.apply #map22(%arg7, %arg8, %arg10)
              %6 = affine.apply #map23(%arg7, %arg8)
              call @S2(%arg3, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
            }
          }
          affine.if #set6(%arg7, %arg8, %arg9)[%2, %0] {
            affine.for %arg10 = #map7(%arg9) to min #map24(%arg9, %arg7)[%2, %1] {
              %3 = affine.apply #map25(%arg7, %arg10)[%2]
              %4 = affine.apply #map0()[%2]
              call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
              %5 = affine.apply #map25(%arg7, %arg10)[%2]
              %6 = affine.apply #map0()[%2]
              call @S2(%arg3, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
            }
          }
          affine.if #set7(%arg7, %arg8, %arg9)[%0] {
            affine.for %arg10 = #map7(%arg9) to min #map26(%arg9, %arg7)[%1] {
              %3 = affine.apply #map17(%arg7, %arg10)
              call @S1(%arg4, %3, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
            }
          }
          affine.for %arg10 = max #map27(%arg9, %arg7, %arg8)[%2] to min #map28(%arg9, %arg7, %arg8)[%0, %2] {
            affine.if #set2(%arg7, %arg8, %arg10) {
              %3 = affine.apply #map17(%arg7, %arg10)
              ...
              affine.for %arg11 = #map29(%arg10) to min #map15(%arg9, %arg10)[%1] {
                %5 = affine.apply #map16(%arg10, %arg11)
                %6 = affine.apply #map17(%arg7, %arg10)
                call @S1(%arg4, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                %7 = affine.apply #map16(%arg10, %arg11)
                %8 = affine.apply #map17(%arg7, %arg10)
            ...
            affine.if #set0(%arg7, %arg8, %arg9) {
              ...
              affine.for %arg11 = #map29(%arg10) to min #map15(%arg7, %arg10)[%1] {
                %3 = affine.apply #map16(%arg10, %arg11)
                call @S1(%arg4, %3, %c0, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
              }
            }
            affine.for %arg11 = max #map18(%arg8, %arg10, %arg7) to min #map19(%arg7, %arg10, %arg8)[%2] {
              ...
              %4 = affine.apply #map16(%arg10, %arg11)
              call @S0(%arg4, %4, %arg6, %arg10) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
              affine.for %arg12 = #map29(%arg10) to min #map15(%arg9, %arg10)[%1] {
                %5 = affine.apply #map16(%arg10, %arg12)
                %6 = affine.apply #map16(%arg10, %arg11)
                call @S1(%arg4, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                %7 = affine.apply #map16(%arg10, %arg12)
                %8 = affine.apply #map16(%arg10, %arg11)
                call @S2(%arg3, %7, %8, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                %9 = affine.apply #map20(%arg10, %arg12)
                %10 = affine.apply #map20(%arg10, %arg11)
                call @S3(%arg5, %9, %10, %arg4, %arg3) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>, memref<2000x2600xf64>) -> ()
              }
            }
            affine.if #set4(%arg7, %arg8, %arg10)[%2] {
              affine.for %arg11 = #map29(%arg10) to min #map15(%arg9, %arg10)[%1] {
          ...
          affine.if #set11(%arg7, %arg9, %arg8)[%2, %0] {
            affine.for %arg10 = max #map35(%arg8, %arg7, %arg9) to min #map36(%arg8, %arg7, %arg9)[%2] {
              %3 = affine.apply #map17(%arg9, %arg10)
              call @S2(%arg3, %c0, %3, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
              %4 = affine.apply #map17(%arg9, %arg10)
              %5 = affine.apply #map37(%arg9)
              call @S0(%arg4, %4, %arg6, %5) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
            }
          }
          affine.if #set12(%arg7, %arg8, %arg9)[%0] {
            %3 = affine.apply #map37(%arg7)
            call @S0(%arg4, %c0, %arg6, %3) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
          }
        }
      }
