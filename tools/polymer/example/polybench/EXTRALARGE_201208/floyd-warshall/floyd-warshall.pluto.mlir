...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    %c5600_i32 = constant 5600 : i32
    %c42_i32 = constant 42 : i32
    %true = constant true
    %false = constant false
    %c0_i32 = constant 0 : i32
    %0 = alloc() : memref<5600x5600xi32>
    call @init_array(%c5600_i32, %0) : (i32, memref<5600x5600xi32>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_floyd_warshall_new(%c5600_i32, %0) : (i32, memref<5600x5600xi32>) -> ()
    ...
    scf.if %2 {
      call @print_array(%c5600_i32, %0) : (i32, memref<5600x5600xi32>) -> ()
    }
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: memref<5600x5600xi32>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    %8 = addi %7, %c1_i32 : i32
    store %8, %arg1[%2, %5] : memref<5600x5600xi32>
    %9 = addi %0, %3 : i32
    ...
    scf.if %13 {
      store %c999_i32, %arg1[%2, %5] : memref<5600x5600xi32>
    }
  ...
  func private @kernel_floyd_warshall(%arg0: i32, %arg1: memref<5600x5600xi32>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to %0 {
        affine.for %arg4 = 0 to %0 {
          call @S0(%arg1, %arg3, %arg4, %arg2) : (memref<5600x5600xi32>, index, index, index) -> ()
        }
      }
    }
    return
  ...
  func private @print_array(%arg0: i32, %arg1: memref<5600x5600xi32>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    %39 = load %arg1[%15, %30] : memref<5600x5600xi32>
  ...
  func private @S0(%arg0: memref<5600x5600xi32>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<5600x5600xi32>
    %1 = affine.load %arg0[%arg1, %arg3] : memref<5600x5600xi32>
    %2 = affine.load %arg0[%arg3, %arg2] : memref<5600x5600xi32>
    %3 = addi %1, %2 : i32
    %4 = cmpi "slt", %0, %3 : i32
    %5 = select %4, %0, %3 : i32
    affine.store %5, %arg0[%arg1, %arg2] : memref<5600x5600xi32>
    return
  }
  func private @kernel_floyd_warshall_new(%arg0: i32, %arg1: memref<5600x5600xi32>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg2 = 0 to %0 {
