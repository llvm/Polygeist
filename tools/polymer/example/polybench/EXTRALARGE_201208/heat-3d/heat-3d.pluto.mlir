...
#map3 = affine_map<(d0)[s0] -> ((d0 * 16 + s0 + 13) floordiv 16 + 1, (s0 + 1999) floordiv 32 + 1, -d0 + 126)>
#map4 = affine_map<(d0, d1)[s0] -> (0, (d0 + d1 - 1) ceildiv 2, (d1 * 32 - s0 - 28) ceildiv 32)>
#map5 = affine_map<(d0, d1)[s0] -> ((s0 + 1999) floordiv 32 + 1, (d0 * 8 + d1 * 24 + s0 + 28) floordiv 32 + 1, (d0 * 16 + d1 * 16 + s0 + 29) floordiv 32 + 1)>
#map6 = affine_map<(d0, d1, d2)[s0] -> (0, (d0 + d1 - 1) ceildiv 2, (d1 * 32 - s0 - 28) ceildiv 32, (d2 * 32 - s0 - 28) ceildiv 32)>
#map7 = affine_map<(d0, d1, d2)[s0] -> ((s0 + 1999) floordiv 32 + 1, (d0 * 32 + s0 + 28) floordiv 32 + 1, (d1 * 8 + d2 * 24 + s0 + 28) floordiv 32 + 1, (d1 * 16 + d2 * 16 + s0 + 29) floordiv 32 + 1)>
...
#map15 = affine_map<(d0, d1) -> (d0 * 32, d1 * 32 + 2)>
#map16 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 32 + s0)>
#map17 = affine_map<(d0, d1) -> (d0 * -32 + d1 - 1)>
#map18 = affine_map<(d0, d1, d2, d3)[s0] -> (1, (d0 * 32 - s0 + 2) ceildiv 2, (d1 * 32 - s0 + 2) ceildiv 2, (d2 * 32 - s0 + 2) ceildiv 2, d3 * 8 + d0 * 8, d3 * 16 + 1)>
#map19 = affine_map<(d0, d1, d2, d3)[s0] -> (1001, d0 * 16 + s0 floordiv 2 + 15, d1 * 16 + 15, d2 * 16 + 15, d3 * 16 + 15, d0 * 8 + d1 * 8 + 16)>
...
#map35 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 32 + 31, d2 * -32 + d1 * 64 + 29)>
#map36 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * -32 + d2 * 64 + 61, d2 * 32 + s0 + 29)>
#map37 = affine_map<(d0) -> (d0 * 32)>
#map38 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 32 + s0 + 29)>
#map39 = affine_map<(d0, d1) -> (d0 * -32 + d1 - 30)>
#map40 = affine_map<(d0, d1) -> (d0 * 32, d1 * 32 + 31)>
...
#set4 = affine_set<(d0, d1, d2, d3)[s0] : (d0 - d1 == 0, d0 - 1 >= 0, d0 - (d2 * 32 - s0 + 1) ceildiv 32 >= 0, d0 - (d3 * 32 - s0 + 1) ceildiv 32 >= 0)>
...
#set9 = affine_set<(d0, d1, d2, d3)[s0] : ((d1 * 16 - s0 + 1) floordiv 16 - d0 >= 0, -d0 + (-s0 + 1971) floordiv 32 >= 0, (d2 * 32 - s0 - 1) floordiv 32 - d0 >= 0, (d3 * 32 - s0 - 1) floordiv 32 - d0 >= 0)>
#set10 = affine_set<(d0, d1, d2, d3)[s0] : (d0 - (d1 * 32 - s0 + 1) ceildiv 32 >= 0, d0 - (-d2 + d1 * 2) >= 0, -d1 + 61 >= 0, d3 - d1 - 1 >= 0)>
#set11 = affine_set<(d0, d1, d2)[s0] : (d0 - (d1 * 32 - s0 + 1) ceildiv 32 >= 0, d0 - (-d2 + d1 * 2) >= 0, -d1 + 61 >= 0)>
#set12 = affine_set<(d0, d1, d2, d3) : (d0 - d1 == 0, -d0 + 61 >= 0, d2 - d0 - 1 >= 0, d3 - d0 - 1 >= 0)>
        ...
        affine.for %arg6 = max #map4(%arg4, %arg5)[%0] to min #map5(%arg4, %arg5)[%0] {
          affine.for %arg7 = max #map6(%arg4, %arg5, %arg6)[%0] to min #map7(%arg6, %arg4, %arg5)[%0] {
            ...
            affine.if #set4(%arg4, %arg5, %arg6, %arg7)[%0] {
              affine.for %arg8 = max #map15(%arg6, %arg4) to min #map16(%arg6, %arg4)[%0] {
                affine.for %arg9 = max #map15(%arg7, %arg4) to min #map16(%arg7, %arg4)[%0] {
                  %1 = affine.apply #map17(%arg4, %arg8)
                  %2 = affine.apply #map17(%arg4, %arg9)
            ...
            affine.if #set10(%arg4, %arg6, %arg5, %arg7)[%0] {
              affine.for %arg8 = max #map35(%arg5, %arg6, %arg4) to min #map36(%arg5, %arg4, %arg6)[%0] {
                affine.for %arg9 = #map37(%arg7) to min #map38(%arg7, %arg6)[%0] {
                  %1 = affine.apply #map39(%arg6, %arg8)
                  %2 = affine.apply #map39(%arg6, %arg9)
                  call @S0(%arg3, %1, %c1, %2, %arg2) : (memref<200x200x200xf64>, index, index, index, memref<200x200x200xf64>) -> ()
                }
              }
            }
            affine.if #set11(%arg4, %arg7, %arg5)[%0] {
              affine.for %arg8 = max #map35(%arg5, %arg7, %arg4) to min #map36(%arg5, %arg4, %arg7)[%0] {
                affine.for %arg9 = max #map40(%arg6, %arg7) to min #map38(%arg6, %arg7)[%0] {
                  %1 = affine.apply #map39(%arg7, %arg8)
                  %2 = affine.apply #map39(%arg7, %arg9)
                  call @S0(%arg3, %1, %2, %c1, %arg2) : (memref<200x200x200xf64>, index, index, index, memref<200x200x200xf64>) -> ()
                }
              }
            }
            affine.if #set12(%arg4, %arg5, %arg6, %arg7) {
              affine.for %arg8 = #map37(%arg6) to min #map38(%arg6, %arg4)[%0] {
                affine.for %arg9 = #map37(%arg7) to min #map38(%arg7, %arg4)[%0] {
                  %1 = affine.apply #map39(%arg4, %arg8)
                  %2 = affine.apply #map39(%arg4, %arg9)
                  call @S0(%arg3, %c1, %1, %2, %arg2) : (memref<200x200x200xf64>, index, index, index, memref<200x200x200xf64>) -> ()
                }
              }
            }
