...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<3000x2600xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600xf64>, %arg6: memref<2600xf64>) {
    ...
    affine.for %arg7 = 0 to %1 {
      affine.store %cst_0, %arg5[%arg7] : memref<2600xf64>
      affine.for %arg8 = 0 to %0 {
        %5 = affine.load %arg3[%arg8, %arg7] : memref<3000x2600xf64>
        %6 = affine.load %arg5[%arg7] : memref<2600xf64>
        %7 = addf %6, %5 : f64
        affine.store %7, %arg5[%arg7] : memref<2600xf64>
      }
      %3 = affine.load %arg5[%arg7] : memref<2600xf64>
      %4 = divf %3, %arg2 : f64
      affine.store %4, %arg5[%arg7] : memref<2600xf64>
    }
    affine.for %arg7 = 0 to %1 {
      affine.store %cst_0, %arg6[%arg7] : memref<2600xf64>
      affine.for %arg8 = 0 to %0 {
        %8 = affine.load %arg3[%arg8, %arg7] : memref<3000x2600xf64>
        %9 = affine.load %arg5[%arg7] : memref<2600xf64>
        %10 = subf %8, %9 : f64
        %11 = mulf %10, %10 : f64
        %12 = affine.load %arg6[%arg7] : memref<2600xf64>
        %13 = addf %12, %11 : f64
        affine.store %13, %arg6[%arg7] : memref<2600xf64>
      }
      %3 = affine.load %arg6[%arg7] : memref<2600xf64>
      %4 = divf %3, %arg2 : f64
      affine.store %4, %arg6[%arg7] : memref<2600xf64>
      %5 = sqrt %4 : f64
      affine.store %5, %arg6[%arg7] : memref<2600xf64>
      %6 = cmpf "ule", %5, %cst : f64
      %7 = scf.if %6 -> (f64) {
        scf.yield %cst_1 : f64
      } else {
        %8 = affine.load %arg6[%arg7] : memref<2600xf64>
        scf.yield %8 : f64
      }
      affine.store %7, %arg6[%arg7] : memref<2600xf64>
    }
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to %1 {
        %3 = affine.load %arg5[%arg8] : memref<2600xf64>
        %4 = affine.load %arg3[%arg7, %arg8] : memref<3000x2600xf64>
        %5 = subf %4, %3 : f64
        affine.store %5, %arg3[%arg7, %arg8] : memref<3000x2600xf64>
        %6 = sqrt %arg2 : f64
        %7 = affine.load %arg6[%arg8] : memref<2600xf64>
        %8 = mulf %6, %7 : f64
        %9 = divf %5, %8 : f64
        affine.store %9, %arg3[%arg7, %arg8] : memref<3000x2600xf64>
      }
    }
    %2 = subi %1, %c1 : index
    affine.for %arg7 = 0 to #map0()[%1] {
      affine.store %cst_1, %arg4[%arg7, %arg7] : memref<2600x2600xf64>
      affine.for %arg8 = #map1(%arg7) to %1 {
        affine.store %cst_0, %arg4[%arg7, %arg8] : memref<2600x2600xf64>
        affine.for %arg9 = 0 to %0 {
          %4 = affine.load %arg3[%arg9, %arg7] : memref<3000x2600xf64>
          %5 = affine.load %arg3[%arg9, %arg8] : memref<3000x2600xf64>
          %6 = mulf %4, %5 : f64
          %7 = affine.load %arg4[%arg7, %arg8] : memref<2600x2600xf64>
          %8 = addf %7, %6 : f64
          affine.store %8, %arg4[%arg7, %arg8] : memref<2600x2600xf64>
        }
        %3 = affine.load %arg4[%arg7, %arg8] : memref<2600x2600xf64>
        affine.store %3, %arg4[%arg8, %arg7] : memref<2600x2600xf64>
      }
    }
    store %cst_1, %arg4[%2, %2] : memref<2600x2600xf64>
    return
  }
