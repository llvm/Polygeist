...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<3000x2600xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600xf64>) {
    ...
    affine.for %arg6 = 0 to %1 {
      affine.store %cst, %arg5[%arg6] : memref<2600xf64>
      affine.for %arg7 = 0 to %0 {
        %4 = affine.load %arg3[%arg7, %arg6] : memref<3000x2600xf64>
        %5 = affine.load %arg5[%arg6] : memref<2600xf64>
        %6 = addf %5, %4 : f64
        affine.store %6, %arg5[%arg6] : memref<2600xf64>
      }
      %2 = affine.load %arg5[%arg6] : memref<2600xf64>
      %3 = divf %2, %arg2 : f64
      affine.store %3, %arg5[%arg6] : memref<2600xf64>
    }
    affine.for %arg6 = 0 to %0 {
      affine.for %arg7 = 0 to %1 {
        %2 = affine.load %arg5[%arg7] : memref<2600xf64>
        %3 = affine.load %arg3[%arg6, %arg7] : memref<3000x2600xf64>
        %4 = subf %3, %2 : f64
        affine.store %4, %arg3[%arg6, %arg7] : memref<3000x2600xf64>
      }
    }
    affine.for %arg6 = 0 to %1 {
      affine.for %arg7 = #map(%arg6) to %1 {
        affine.store %cst, %arg4[%arg6, %arg7] : memref<2600x2600xf64>
        affine.for %arg8 = 0 to %0 {
          %5 = affine.load %arg3[%arg8, %arg6] : memref<3000x2600xf64>
          %6 = affine.load %arg3[%arg8, %arg7] : memref<3000x2600xf64>
          %7 = mulf %5, %6 : f64
          %8 = affine.load %arg4[%arg6, %arg7] : memref<2600x2600xf64>
          %9 = addf %8, %7 : f64
          affine.store %9, %arg4[%arg6, %arg7] : memref<2600x2600xf64>
        }
        %2 = subf %arg2, %cst_0 : f64
        %3 = affine.load %arg4[%arg6, %arg7] : memref<2600x2600xf64>
        %4 = divf %3, %2 : f64
        affine.store %4, %arg4[%arg6, %arg7] : memref<2600x2600xf64>
        affine.store %4, %arg4[%arg7, %arg6] : memref<2600x2600xf64>
      }
    }
    return
  }
