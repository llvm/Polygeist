  ...
  func @kernel_jacobi_1d(%arg0: i32, %arg1: i32, %arg2: memref<2000xf64>, %arg3: memref<2000xf64>) {
    ...
    affine.for %arg4 = 0 to %1 {
      affine.for %arg5 = 1 to #map()[%0] {
        %2 = affine.load %arg2[%arg5 - 1] : memref<2000xf64>
        %3 = affine.load %arg2[%arg5] : memref<2000xf64>
        %4 = addf %2, %3 : f64
        %5 = affine.load %arg2[%arg5 + 1] : memref<2000xf64>
        %6 = addf %4, %5 : f64
        %7 = mulf %cst, %6 : f64
        affine.store %7, %arg3[%arg5] : memref<2000xf64>
      }
      affine.for %arg5 = 1 to #map()[%0] {
        %2 = affine.load %arg3[%arg5 - 1] : memref<2000xf64>
        %3 = affine.load %arg3[%arg5] : memref<2000xf64>
        %4 = addf %2, %3 : f64
        %5 = affine.load %arg3[%arg5 + 1] : memref<2000xf64>
        %6 = addf %4, %5 : f64
        %7 = mulf %cst, %6 : f64
        affine.store %7, %arg2[%arg5] : memref<2000xf64>
      }
    }
    return
  }
