  ...
  func private @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<1600x1800xf64>, %arg6: memref<1600x2000xf64>, %arg7: memref<2000x1800xf64>, %arg8: memref<1800x2200xf64>, %arg9: memref<1800x2400xf64>, %arg10: memref<2400x2200xf64>, %arg11: memref<1600x2200xf64>) {
    ...
    affine.for %arg12 = 0 to %4 {
      affine.for %arg13 = 0 to %0 {
        affine.store %cst, %arg5[%arg12, %arg13] : memref<1600x1800xf64>
        affine.for %arg14 = 0 to %1 {
          %5 = affine.load %arg6[%arg12, %arg14] : memref<1600x2000xf64>
          %6 = affine.load %arg7[%arg14, %arg13] : memref<2000x1800xf64>
          %7 = mulf %5, %6 : f64
          %8 = affine.load %arg5[%arg12, %arg13] : memref<1600x1800xf64>
          %9 = addf %8, %7 : f64
          affine.store %9, %arg5[%arg12, %arg13] : memref<1600x1800xf64>
        }
      }
    }
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %2 {
        affine.store %cst, %arg8[%arg12, %arg13] : memref<1800x2200xf64>
        affine.for %arg14 = 0 to %3 {
          %5 = affine.load %arg9[%arg12, %arg14] : memref<1800x2400xf64>
          %6 = affine.load %arg10[%arg14, %arg13] : memref<2400x2200xf64>
          %7 = mulf %5, %6 : f64
          %8 = affine.load %arg8[%arg12, %arg13] : memref<1800x2200xf64>
          %9 = addf %8, %7 : f64
          affine.store %9, %arg8[%arg12, %arg13] : memref<1800x2200xf64>
        }
      }
    }
    affine.for %arg12 = 0 to %4 {
      affine.for %arg13 = 0 to %2 {
        affine.store %cst, %arg11[%arg12, %arg13] : memref<1600x2200xf64>
        affine.for %arg14 = 0 to %0 {
          %5 = affine.load %arg5[%arg12, %arg14] : memref<1600x1800xf64>
          %6 = affine.load %arg8[%arg14, %arg13] : memref<1800x2200xf64>
          %7 = mulf %5, %6 : f64
          %8 = affine.load %arg11[%arg12, %arg13] : memref<1600x2200xf64>
          %9 = addf %8, %7 : f64
          affine.store %9, %arg11[%arg12, %arg13] : memref<1600x2200xf64>
        }
      }
    }
    return
