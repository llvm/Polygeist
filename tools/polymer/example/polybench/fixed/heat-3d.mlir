...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_heat_3d(%c1000_i32, %c200_i32, %0, %1) : (i32, i32, memref<200x200x200xf64>, memref<200x200x200xf64>) -> ()
      ...
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          affine.for %arg7 = 1 to #map()[%0] {
            %1 = affine.load %arg2[%arg5 + 1, %arg6, %arg7] : memref<200x200x200xf64>
            %2 = affine.load %arg2[%arg5, %arg6, %arg7] : memref<200x200x200xf64>
            %3 = mulf %cst_0, %2 : f64
            %4 = subf %1, %3 : f64
            %5 = affine.load %arg2[%arg5 - 1, %arg6, %arg7] : memref<200x200x200xf64>
            %6 = addf %4, %5 : f64
            %7 = mulf %cst, %6 : f64
            %8 = affine.load %arg2[%arg5, %arg6 + 1, %arg7] : memref<200x200x200xf64>
            %9 = subf %8, %3 : f64
            %10 = affine.load %arg2[%arg5, %arg6 - 1, %arg7] : memref<200x200x200xf64>
            %11 = addf %9, %10 : f64
            %12 = mulf %cst, %11 : f64
            %13 = addf %7, %12 : f64
            %14 = affine.load %arg2[%arg5, %arg6, %arg7 + 1] : memref<200x200x200xf64>
            %15 = subf %14, %3 : f64
            %16 = affine.load %arg2[%arg5, %arg6, %arg7 - 1] : memref<200x200x200xf64>
            %17 = addf %15, %16 : f64
            %18 = mulf %cst, %17 : f64
            %19 = addf %13, %18 : f64
            %20 = addf %19, %2 : f64
            affine.store %20, %arg3[%arg5, %arg6, %arg7] : memref<200x200x200xf64>
          }
        }
      }
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          affine.for %arg7 = 1 to #map()[%0] {
            %1 = affine.load %arg3[%arg5 + 1, %arg6, %arg7] : memref<200x200x200xf64>
            %2 = affine.load %arg3[%arg5, %arg6, %arg7] : memref<200x200x200xf64>
            %3 = mulf %cst_0, %2 : f64
            %4 = subf %1, %3 : f64
            %5 = affine.load %arg3[%arg5 - 1, %arg6, %arg7] : memref<200x200x200xf64>
            %6 = addf %4, %5 : f64
            %7 = mulf %cst, %6 : f64
            %8 = affine.load %arg3[%arg5, %arg6 + 1, %arg7] : memref<200x200x200xf64>
            %9 = subf %8, %3 : f64
            %10 = affine.load %arg3[%arg5, %arg6 - 1, %arg7] : memref<200x200x200xf64>
            %11 = addf %9, %10 : f64
            %12 = mulf %cst, %11 : f64
            %13 = addf %7, %12 : f64
            %14 = affine.load %arg3[%arg5, %arg6, %arg7 + 1] : memref<200x200x200xf64>
            %15 = subf %14, %3 : f64
            %16 = affine.load %arg3[%arg5, %arg6, %arg7 - 1] : memref<200x200x200xf64>
            %17 = addf %15, %16 : f64
            %18 = mulf %cst, %17 : f64
            %19 = addf %13, %18 : f64
            %20 = addf %19, %2 : f64
            affine.store %20, %arg2[%arg5, %arg6, %arg7] : memref<200x200x200xf64>
          }
        }
      }
    }
