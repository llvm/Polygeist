  ...
  func private @kernel_nussinov(%arg0: i32, %arg1: memref<5500xi8>, %arg2: memref<5500x5500xi32>) {
    ...
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = #map0(%arg3)[%0] to %0 {
        affine.if #set0(%arg4) {
          %1 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<5500x5500xi32>
          %2 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4 - 1] : memref<5500x5500xi32>
          %3 = cmpi "sge", %1, %2 : i32
          %4 = select %3, %1, %2 : i32
          affine.store %4, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<5500x5500xi32>
        }
        affine.if #set1(%arg3)[%0] {
          %1 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<5500x5500xi32>
          %2 = affine.load %arg2[-%arg3 + symbol(%0), %arg4] : memref<5500x5500xi32>
          %3 = cmpi "sge", %1, %2 : i32
          %4 = select %3, %1, %2 : i32
          affine.store %4, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<5500x5500xi32>
        }
        affine.if #set2(%arg4, %arg3)[%0] {
          affine.if #set3(%arg3, %arg4)[%0] {
            %1 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<5500x5500xi32>
            %2 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<5500x5500xi32>
            %3 = affine.load %arg1[-%arg3 + symbol(%0) - 1] : memref<5500xi8>
            %4 = sexti %3 : i8 to i32
            %5 = affine.load %arg1[%arg4] : memref<5500xi8>
            %6 = sexti %5 : i8 to i32
            %7 = addi %4, %6 : i32
            ...
            affine.store %12, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<5500x5500xi32>
          } else {
            %1 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<5500x5500xi32>
            %2 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<5500x5500xi32>
            %3 = cmpi "sge", %1, %2 : i32
        ...
        affine.for %arg5 = #map0(%arg3)[%0] to #map1(%arg4) {
          %1 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<5500x5500xi32>
          %2 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg5] : memref<5500x5500xi32>
          %3 = affine.load %arg2[%arg5 + 1, %arg4] : memref<5500x5500xi32>
          %4 = addi %2, %3 : i32
          %5 = cmpi "sge", %1, %4 : i32
          %6 = select %5, %1, %4 : i32
