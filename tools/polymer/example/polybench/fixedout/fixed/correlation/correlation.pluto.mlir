...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_correlation_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<3000x2600xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600xf64>, %arg6: memref<2600xf64>) {
    ...
    call @S11(%arg4, %0) : (memref<2600x2600xf64>, index) -> ()
      ...
      affine.for %arg8 = #map3(%arg7) to #map4()[%0] {
        affine.for %arg9 = #map5(%arg7) to min #map6(%arg7, %arg8)[%0] {
          affine.for %arg10 = max #map7(%arg8, %arg9) to min #map8(%arg8)[%0] {
            call @S8(%arg4, %arg9, %arg10) : (memref<2600x2600xf64>, index, index) -> ()
          }
        }
      }
    }
    affine.for %arg7 = 0 to #map4()[%0] {
      affine.for %arg8 = #map5(%arg7) to min #map9(%arg7)[%0] {
        ...
        call @S7(%arg4, %arg8) : (memref<2600x2600xf64>, index) -> ()
      }
      affine.if #set(%arg7)[%0] {
        %2 = affine.apply #map0()[%0]
        call @S0(%arg5, %2) : (memref<2600xf64>, index) -> ()
        %3 = affine.apply #map0()[%0]
        call @S3(%arg6, %3) : (memref<2600xf64>, index) -> ()
      }
    }
    affine.for %arg7 = 0 to #map4()[%0] {
      ...
      affine.for %arg8 = 0 to #map4()[%0] {
        affine.for %arg9 = #map5(%arg8) to min #map8(%arg8)[%0] {
          affine.for %arg10 = #map5(%arg7) to min #map8(%arg7)[%1] {
            call @S6(%arg3, %arg10, %arg9, %arg6, %arg2, %arg5) : (memref<3000x2600xf64>, index, index, memref<2600xf64>, f64, memref<2600xf64>) -> ()
          }
        }
      }
    }
          ...
          affine.for %arg10 = #map5(%arg7) to min #map6(%arg7, %arg8)[%0] {
            affine.for %arg11 = max #map7(%arg8, %arg10) to min #map8(%arg8)[%0] {
              affine.for %arg12 = #map5(%arg9) to min #map8(%arg9)[%1] {
                call @S9(%arg4, %arg10, %arg11, %arg3, %arg12) : (memref<2600x2600xf64>, index, index, memref<3000x2600xf64>, index) -> ()
              }
            }
          }
        }
    ...
    affine.for %arg7 = 0 to #map2()[%0] {
      affine.for %arg8 = #map3(%arg7) to #map4()[%0] {
        affine.for %arg9 = #map5(%arg7) to min #map6(%arg7, %arg8)[%0] {
          affine.for %arg10 = max #map7(%arg8, %arg9) to min #map8(%arg8)[%0] {
            call @S10(%arg4, %arg10, %arg9) : (memref<2600x2600xf64>, index, index) -> ()
          }
        }
      }
    }
