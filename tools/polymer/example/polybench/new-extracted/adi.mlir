...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @init_array(%arg0: i32, %arg1: memref<1000x1000xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<1000x1000xf64>, %arg3: memref<1000x1000xf64>, %arg4: memref<1000x1000xf64>, %arg5: memref<1000x1000xf64>) {
    ...
    affine.for %arg6 = 1 to #map0()[%16] {
      affine.for %arg7 = 1 to #map1()[%0] {
        affine.store %cst, %arg3[0, %arg7] : memref<1000x1000xf64>
        affine.store %cst_1, %arg4[%arg7, 0] : memref<1000x1000xf64>
        %17 = affine.load %arg3[0, %arg7] : memref<1000x1000xf64>
        affine.store %17, %arg5[%arg7, 0] : memref<1000x1000xf64>
        affine.for %arg8 = 1 to #map1()[%0] {
          %18 = negf %11 : f64
          %19 = affine.load %arg4[%arg7, %arg8 - 1] : memref<1000x1000xf64>
          %20 = mulf %11, %19 : f64
          %21 = addf %20, %12 : f64
          %22 = divf %18, %21 : f64
          affine.store %22, %arg4[%arg7, %arg8] : memref<1000x1000xf64>
          %23 = negf %14 : f64
          %24 = affine.load %arg2[%arg8, %arg7 - 1] : memref<1000x1000xf64>
          %25 = mulf %23, %24 : f64
          %26 = mulf %cst_0, %14 : f64
          %27 = addf %cst, %26 : f64
          %28 = affine.load %arg2[%arg8, %arg7] : memref<1000x1000xf64>
          %29 = mulf %27, %28 : f64
          %30 = addf %25, %29 : f64
          %31 = affine.load %arg2[%arg8, %arg7 + 1] : memref<1000x1000xf64>
          %32 = mulf %14, %31 : f64
          %33 = subf %30, %32 : f64
          %34 = affine.load %arg5[%arg7, %arg8 - 1] : memref<1000x1000xf64>
          %35 = mulf %11, %34 : f64
          %36 = subf %33, %35 : f64
          %37 = affine.load %arg4[%arg7, %arg8 - 1] : memref<1000x1000xf64>
          %38 = mulf %11, %37 : f64
          %39 = addf %38, %12 : f64
          %40 = divf %36, %39 : f64
          affine.store %40, %arg5[%arg7, %arg8] : memref<1000x1000xf64>
        }
        affine.store %cst, %arg3[symbol(%0) - 1, %arg7] : memref<1000x1000xf64>
        affine.for %arg8 = 1 to #map1()[%0] {
          %18 = affine.load %arg4[%arg7, -%arg8 + symbol(%0) - 1] : memref<1000x1000xf64>
          %19 = affine.load %arg3[-%arg8 + symbol(%0), %arg7] : memref<1000x1000xf64>
          %20 = mulf %18, %19 : f64
          %21 = affine.load %arg5[%arg7, -%arg8 + symbol(%0) - 1] : memref<1000x1000xf64>
          %22 = addf %20, %21 : f64
          affine.store %22, %arg3[-%arg8 + symbol(%0) - 1, %arg7] : memref<1000x1000xf64>
        }
      }
      affine.for %arg7 = 1 to #map1()[%0] {
        affine.store %cst, %arg2[%arg7, 0] : memref<1000x1000xf64>
        affine.store %cst_1, %arg4[%arg7, 0] : memref<1000x1000xf64>
        %17 = affine.load %arg2[%arg7, 0] : memref<1000x1000xf64>
        affine.store %17, %arg5[%arg7, 0] : memref<1000x1000xf64>
        affine.for %arg8 = 1 to #map1()[%0] {
          %18 = negf %14 : f64
          %19 = affine.load %arg4[%arg7, %arg8 - 1] : memref<1000x1000xf64>
          ...
          affine.store %22, %arg4[%arg7, %arg8] : memref<1000x1000xf64>
          %23 = negf %11 : f64
          %24 = affine.load %arg3[%arg7 - 1, %arg8] : memref<1000x1000xf64>
          %25 = mulf %23, %24 : f64
          %26 = mulf %cst_0, %11 : f64
          %27 = addf %cst, %26 : f64
          %28 = affine.load %arg3[%arg7, %arg8] : memref<1000x1000xf64>
          %29 = mulf %27, %28 : f64
          %30 = addf %25, %29 : f64
          %31 = affine.load %arg3[%arg7 + 1, %arg8] : memref<1000x1000xf64>
          %32 = mulf %11, %31 : f64
          %33 = subf %30, %32 : f64
          %34 = affine.load %arg5[%arg7, %arg8 - 1] : memref<1000x1000xf64>
          %35 = mulf %14, %34 : f64
        ...
        affine.store %cst, %arg2[%arg7, symbol(%0) - 1] : memref<1000x1000xf64>
        affine.for %arg8 = 1 to #map1()[%0] {
          %18 = affine.load %arg4[%arg7, -%arg8 + symbol(%0) - 1] : memref<1000x1000xf64>
          %19 = affine.load %arg2[%arg7, -%arg8 + symbol(%0)] : memref<1000x1000xf64>
          %20 = mulf %18, %19 : f64
          %21 = affine.load %arg5[%arg7, -%arg8 + symbol(%0) - 1] : memref<1000x1000xf64>
          %22 = addf %20, %21 : f64
          affine.store %22, %arg2[%arg7, -%arg8 + symbol(%0) - 1] : memref<1000x1000xf64>
        }
      }
    }
    return
  }
  func private @print_array(%arg0: i32, %arg1: memref<1000x1000xf64>) {
    %c0_i32 = constant 0 : i32
