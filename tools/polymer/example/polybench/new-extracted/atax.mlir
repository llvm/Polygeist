module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c1900_i32, %c2100_i32, %0, %1) : (i32, i32, memref<1900x2100xf64>, memref<2100xf64>) -> ()
    call @kernel_atax(%c1900_i32, %c2100_i32, %0, %1, %2, %3) : (i32, i32, memref<1900x2100xf64>, memref<2100xf64>, memref<2100xf64>, memref<1900xf64>) -> ()
    call @print_array(%c2100_i32, %2) : (i32, memref<2100xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<1900x2100xf64>, %arg3: memref<2100xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @kernel_atax(%arg0: i32, %arg1: i32, %arg2: memref<1900x2100xf64>, %arg3: memref<2100xf64>, %arg4: memref<2100xf64>, %arg5: memref<1900xf64>) {
    %c0_i32 = constant 0 : i32
    %cst = constant 0.000000e+00 : f64
    %0 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to %0 {
      %2 = sitofp %c0_i32 : i32 to f64
      affine.store %2, %arg4[%arg6] : memref<2100xf64>
    }
    ...
    affine.for %arg6 = 0 to %1 {
      ...
      affine.for %arg7 = 0 to %0 {
        ...
        %3 = affine.load %arg2[%arg6, %arg7] : memref<1900x2100xf64>
        %4 = affine.load %arg3[%arg7] : memref<2100xf64>
        %5 = mulf %3, %4 : f64
        %6 = addf %2, %5 : f64
        affine.store %6, %arg5[%arg6] : memref<1900xf64>
      }
      affine.for %arg7 = 0 to %0 {
        %2 = affine.load %arg4[%arg7] : memref<2100xf64>
        %3 = affine.load %arg2[%arg6, %arg7] : memref<1900x2100xf64>
        %4 = affine.load %arg5[%arg6] : memref<1900xf64>
        %5 = mulf %3, %4 : f64
        %6 = addf %2, %5 : f64
        affine.store %6, %arg4[%arg7] : memref<2100xf64>
      }
    }
    return
  }
