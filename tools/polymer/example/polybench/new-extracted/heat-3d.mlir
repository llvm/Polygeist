...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @init_array(%arg0: i32, %arg1: memref<120x120x120xf64>, %arg2: memref<120x120x120xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @kernel_heat_3d(%arg0: i32, %arg1: i32, %arg2: memref<120x120x120xf64>, %arg3: memref<120x120x120xf64>) {
      ...
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          affine.for %arg7 = 1 to #map()[%0] {
            %1 = affine.load %arg2[%arg5 + 1, %arg6, %arg7] : memref<120x120x120xf64>
            %2 = affine.load %arg2[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
            %3 = mulf %cst_0, %2 : f64
            %4 = subf %1, %3 : f64
            %5 = affine.load %arg2[%arg5 - 1, %arg6, %arg7] : memref<120x120x120xf64>
            %6 = addf %4, %5 : f64
            %7 = mulf %cst, %6 : f64
            %8 = affine.load %arg2[%arg5, %arg6 + 1, %arg7] : memref<120x120x120xf64>
            %9 = affine.load %arg2[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
            %10 = mulf %cst_0, %9 : f64
            %11 = subf %8, %10 : f64
            ...
            %14 = mulf %cst, %13 : f64
            %15 = addf %7, %14 : f64
            %16 = affine.load %arg2[%arg5, %arg6, %arg7 + 1] : memref<120x120x120xf64>
            %17 = affine.load %arg2[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
            %18 = mulf %cst_0, %17 : f64
            %19 = subf %16, %18 : f64
            %20 = affine.load %arg2[%arg5, %arg6, %arg7 - 1] : memref<120x120x120xf64>
            %21 = addf %19, %20 : f64
            %22 = mulf %cst, %21 : f64
            %23 = addf %15, %22 : f64
            %24 = affine.load %arg2[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
            %25 = addf %23, %24 : f64
            affine.store %25, %arg3[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
          }
        }
      }
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          affine.for %arg7 = 1 to #map()[%0] {
            %1 = affine.load %arg3[%arg5 + 1, %arg6, %arg7] : memref<120x120x120xf64>
            %2 = affine.load %arg3[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
            %3 = mulf %cst_0, %2 : f64
            %4 = subf %1, %3 : f64
            %5 = affine.load %arg3[%arg5 - 1, %arg6, %arg7] : memref<120x120x120xf64>
            %6 = addf %4, %5 : f64
            %7 = mulf %cst, %6 : f64
            %8 = affine.load %arg3[%arg5, %arg6 + 1, %arg7] : memref<120x120x120xf64>
            %9 = affine.load %arg3[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
            %10 = mulf %cst_0, %9 : f64
            %11 = subf %8, %10 : f64
            ...
            %14 = mulf %cst, %13 : f64
            %15 = addf %7, %14 : f64
            %16 = affine.load %arg3[%arg5, %arg6, %arg7 + 1] : memref<120x120x120xf64>
            %17 = affine.load %arg3[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
            %18 = mulf %cst_0, %17 : f64
            %19 = subf %16, %18 : f64
            %20 = affine.load %arg3[%arg5, %arg6, %arg7 - 1] : memref<120x120x120xf64>
            %21 = addf %19, %20 : f64
            %22 = mulf %cst, %21 : f64
            %23 = addf %15, %22 : f64
            %24 = affine.load %arg3[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
            %25 = addf %23, %24 : f64
            affine.store %25, %arg2[%arg5, %arg6, %arg7] : memref<120x120x120xf64>
          }
        }
      }
    }
