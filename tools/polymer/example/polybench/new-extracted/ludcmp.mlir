  ...
  func private @kernel_ludcmp(%arg0: i32, %arg1: memref<2000x2000xf64>, %arg2: memref<2000xf64>, %arg3: memref<2000xf64>, %arg4: memref<2000xf64>) {
    ...
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to #map0(%arg5) {
        %2 = affine.load %arg1[%arg5, %arg6] : memref<2000x2000xf64>
        affine.store %2, %1[0] : memref<1xf64>
        affine.for %arg7 = 0 to #map0(%arg6) {
          %6 = affine.load %arg1[%arg5, %arg7] : memref<2000x2000xf64>
          %7 = affine.load %arg1[%arg7, %arg6] : memref<2000x2000xf64>
          %8 = mulf %6, %7 : f64
        ...
        %4 = affine.load %arg1[%arg6, %arg6] : memref<2000x2000xf64>
        %5 = divf %3, %4 : f64
      ...
      affine.for %arg6 = #map0(%arg5) to %0 {
        ...
        affine.for %arg7 = 0 to #map0(%arg5) {
          %4 = affine.load %arg1[%arg5, %arg7] : memref<2000x2000xf64>
          %5 = affine.load %arg1[%arg7, %arg6] : memref<2000x2000xf64>
          %6 = mulf %4, %5 : f64
        ...
        %3 = affine.load %1[0] : memref<1xf64>
        affine.store %3, %arg1[%arg5, %arg6] : memref<2000x2000xf64>
      }
    }
    affine.for %arg5 = 0 to %0 {
      %2 = affine.load %arg2[%arg5] : memref<2000xf64>
      affine.store %2, %1[0] : memref<1xf64>
      affine.for %arg6 = 0 to #map0(%arg5) {
        %4 = affine.load %arg1[%arg5, %arg6] : memref<2000x2000xf64>
        %5 = affine.load %arg4[%arg6] : memref<2000xf64>
        %6 = mulf %4, %5 : f64
        %7 = affine.load %1[0] : memref<1xf64>
        %8 = subf %7, %6 : f64
        affine.store %8, %1[0] : memref<1xf64>
      ...
      %3 = affine.load %1[0] : memref<1xf64>
      affine.store %3, %arg4[%arg5] : memref<2000xf64>
    }
    affine.for %arg5 = 0 to %0 {
      %2 = affine.load %arg4[-%arg5 + symbol(%0) - 1] : memref<2000xf64>
      affine.store %2, %1[0] : memref<1xf64>
      affine.for %arg6 = #map1(%arg5)[%0] to %0 {
        %6 = affine.load %arg1[-%arg5 + symbol(%0) - 1, %arg6] : memref<2000x2000xf64>
        %7 = affine.load %arg3[%arg6] : memref<2000xf64>
        %8 = mulf %6, %7 : f64
        %9 = affine.load %1[0] : memref<1xf64>
        %10 = subf %9, %8 : f64
        affine.store %10, %1[0] : memref<1xf64>
      ...
      %3 = affine.load %1[0] : memref<1xf64>
      %4 = affine.load %arg1[-%arg5 + symbol(%0) - 1, -%arg5 + symbol(%0) - 1] : memref<2000x2000xf64>
      %5 = divf %3, %4 : f64
      affine.store %5, %arg3[-%arg5 + symbol(%0) - 1] : memref<2000xf64>
    }
    return
  }
