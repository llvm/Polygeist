...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<64x64xf32>, %arg4: memref<64x64xf32>, %arg5: memref<64x64xf32>, %arg6: memref<64x64xf32>) {
    ...
    call @S0(%19, %arg2, %13, %10) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>) -> ()
    call @S1(%16, %arg2, %13, %19, %12, %11) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    call @S2(%17, %arg2, %12) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    call @S3(%15, %arg2, %11, %9) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>) -> ()
    call @S4(%20, %10) : (memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %22 {
      ...
      affine.for %arg8 = 0 to %21 {
        call @S10(%arg5, %arg7, %arg8, %26, %14, %25, %20, %23, %16, %arg3, %19, %8, %7, %6) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %22 {
      ...
      affine.for %arg8 = 0 to %21 {
        call @S18(%arg6, %arg7, %arg8, %21, %32, %14, %31, %20, %28, %15, %27, %17, %5, %4) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %21 {
      ...
      affine.for %arg8 = 0 to %22 {
        call @S27(%arg5, %arg8, %arg7, %26, %14, %25, %20, %24, %16, %arg4, %19, %3, %2) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %21 {
      ...
      affine.for %arg8 = 0 to %22 {
        call @S35(%arg6, %arg8, %arg7, %22, %32, %14, %31, %20, %30, %15, %29, %17, %1, %0) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
