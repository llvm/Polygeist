...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @S0(%arg0: memref<2000x2300xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<2000x2300xf64>
    %1 = mulf %0, %arg3 : f64
    affine.store %1, %arg0[%arg1, %arg2] : memref<2000x2300xf64>
    return
  }
  func private @S1(%arg0: memref<2000x2300xf64>, %arg1: index, %arg2: index, %arg3: memref<2600x2300xf64>, %arg4: index, %arg5: f64, %arg6: memref<2000x2600xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<2000x2300xf64>
    %1 = affine.load %arg6[%arg1, %arg4] : memref<2000x2600xf64>
    %2 = mulf %arg5, %1 : f64
    %3 = affine.load %arg3[%arg4, %arg2] : memref<2600x2300xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
    affine.store %5, %arg0[%arg1, %arg2] : memref<2000x2300xf64>
    return
  }
      ...
      affine.for %arg9 = 0 to #map0()[%1] {
        affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%0] {
          affine.for %arg11 = #map1(%arg9) to min #map2(%arg9)[%1] {
            ...
            // %3 = affine.load %arg5[%arg10, %arg11] : memref<2000x2300xf64>
            // %4 = mulf %3, %arg4 : f64
            // affine.store %4, %arg5[%arg10, %arg11] : memref<2000x2300xf64>
          }
        }
      }
    }
        ...
        affine.for %arg10 = 0 to #map0()[%2] {
          affine.for %arg11 = #map1(%arg8) to min #map2(%arg8)[%0] {
            ...
            affine.for %arg12 = #map1(%arg9) to min #map2(%arg9)[%1] {
                // %v0 = affine.load %arg5[%arg11, %arg12] : memref<2000x2300xf64>
                // %v1 = affine.load %arg6[%arg11, %arg13] : memref<2000x2600xf64>
                // %v2 = mulf %arg3, %v1 : f64
                // %v3 = affine.load %arg7[%arg13, %arg12] : memref<2600x2300xf64>
                // %v4 = mulf %v2, %v3 : f64
                // %v5 = addf %v0, %v4 : f64
                // affine.store %v5, %arg5[%arg11, %arg12] : memref<2000x2300xf64>
                call @S1(%arg5, %arg11, %arg12, %arg7, %arg13, %arg3, %arg6) : (memref<2000x2300xf64>, index, index, memref<2600x2300xf64>, index, f64, memref<2000x2600xf64>) -> ()
              }
            }
          }
        }
