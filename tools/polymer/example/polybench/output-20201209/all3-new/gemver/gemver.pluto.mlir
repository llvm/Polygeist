      ...
      affine.for %arg13 = 0 to #map0()[%0] {
        affine.for %arg14 = #map1(%arg12) to min #map2(%arg12)[%0] {
          affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%0] {
            call @S0(%arg3, %arg15, %arg14, %arg7, %arg6, %arg5, %arg4) : (memref<4000x4000xf64>, index, index, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>) -> ()
            call @S1(%arg9, %arg14, %arg10, %arg15, %arg2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>, index, f64, memref<4000x4000xf64>) -> ()
          }
        }
      }
    }
