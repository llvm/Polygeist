...
#map5 = affine_map<(d0)[s0] -> (s0 - 1, d0 * 32 + 3)>
#map6 = affine_map<(d0, d1) -> (d0 * 32, d1 * -32 + d0 * 32 - 29, d1 * 32 - d0 * 32 + 2)>
#map7 = affine_map<(d0, d1)[s0, s1] -> (d0 * 32 + 32, s0 * 2 + s1 - 3, d1 * -32 + d0 * 32 + s0 * 4 - 3, d1 * 32 - d0 * 32 + s1 * 2 + 28)>
#map8 = affine_map<(d0, d1, d2)[s0] -> (0, (d0 - s0 + 2) ceildiv 2, (d1 * 32 - d2 * 32 + d0 - 2) ceildiv 4)>
#map9 = affine_map<(d0, d1, d2) -> ((d0 * 32 - d1 * 32 + d2 - 1) floordiv 4 + 1)>
#map10 = affine_map<(d0, d1) -> (d0 - d1 * 2 - 1)>
#map11 = affine_map<()[s0] -> (s0 - 2)>
#map12 = affine_map<(d0, d1, d2)[s0] -> (0, (d0 - s0 + 2) ceildiv 2, (d1 * 32 - d2 * 32 + d0) ceildiv 4)>
#map13 = affine_map<(d0, d1, d2)[s0] -> (d0 floordiv 2, (d1 * 32 - d2 * 32 + d0 + 29) floordiv 4 + 1, s0)>
#map14 = affine_map<(d0, d1) -> (d0 - d1 * 2)>
#map15 = affine_map<(d0, d1, d2) -> ((d0 * 32 - d1 * 32 + d2 + 30) ceildiv 4)>
#map16 = affine_map<(d0, d1, d2)[s0] -> (d0 floordiv 2, (d1 * 32 - d2 * 32 + d0 + 31) floordiv 4 + 1, s0)>
#map17 = affine_map<(d0, d1)[s0] -> (s0 * 2, d0 * -32 + d1 * 32 + s0 * 4 - 3)>
#map18 = affine_map<(d0, d1)[s0, s1] -> (d0 * 32 + 32, s0 * 2 + s1 - 3, d1 * -32 + d0 * 32 + s0 * 4 - 1)>
#map19 = affine_map<(d0)[s0] -> (d0 - s0 * 2 + 1)>
#set0 = affine_set<(d0) : (d0 + 1 == 0)>
#set1 = affine_set<(d0, d1, d2)[s0] : ((d1 * 32 + d2 - s0 * 2 + 4) floordiv 32 - d0 >= 0, d2 - (s0 - 1) >= 0)>
#set2 = affine_set<(d0)[s0] : ((d0 + s0 + 1) mod 2 == 0)>
#set3 = affine_set<(d0, d1, d2)[s0] : (d0 - (d1 * 32 + d2 - 33) ceildiv 32 >= 0, -d2 + s0 * 2 - 1 >= 0)>
#set4 = affine_set<(d0) : ((d0 + 1) mod 2 == 0)>
#set5 = affine_set<(d0, d1)[s0, s1] : ((d1 * 32 + s0 * 2 - s1 + 1) floordiv 32 - d0 >= 0, d0 - (d1 * 32 + s0 * 2 - s1 - 30) ceildiv 32 >= 0, d1 - (s0 * 2 + s1 - 34) ceildiv 32 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_jacobi_1d_new(%c1000_i32, %c4000_i32, %0, %1) : (i32, i32, memref<4000xf64>, memref<4000xf64>) -> ()
  ...
  func private @kernel_jacobi_1d(%arg0: i32, %arg1: i32, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>) {
    ...
    affine.for %arg4 = 0 to %1 {
      affine.for %arg5 = 1 to #map0()[%0] {
        call @S0(%arg3, %arg5, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
      }
      affine.for %arg5 = 1 to #map0()[%0] {
        call @S1(%arg2, %arg5, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
      }
    }
    return
  }
  ...
  func private @S0(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<4000xf64>) attributes {scop.stmt} {
    %cst = constant 3.333300e-01 : f64
    %0 = affine.load %arg2[%arg1 - 1] : memref<4000xf64>
    %1 = affine.load %arg2[%arg1] : memref<4000xf64>
    %2 = addf %0, %1 : f64
    %3 = affine.load %arg2[%arg1 + 1] : memref<4000xf64>
    %4 = addf %2, %3 : f64
    %5 = mulf %cst, %4 : f64
    affine.store %5, %arg0[%arg1] : memref<4000xf64>
    return
  }
  func private @S1(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<4000xf64>) attributes {scop.stmt} {
    %cst = constant 3.333300e-01 : f64
    %0 = affine.load %arg2[%arg1 - 1] : memref<4000xf64>
    %1 = affine.load %arg2[%arg1] : memref<4000xf64>
    %2 = addf %0, %1 : f64
  ...
  func private @kernel_jacobi_1d_new(%arg0: i32, %arg1: i32, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>) {
    %c1 = constant 1 : index
    ...
    affine.for %arg4 = -1 to #map1()[%0] {
      affine.for %arg5 = #map2(%arg4) to min #map3(%arg4)[%0, %1] {
        affine.if #set0(%arg4) {
          affine.for %arg6 = #map4(%arg5) to min #map5(%arg5)[%1] {
            call @S0(%arg3, %arg6, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
          }
        }
        affine.for %arg6 = max #map6(%arg5, %arg4) to min #map7(%arg5, %arg4)[%0, %1] {
          affine.for %arg7 = max #map8(%arg6, %arg4, %arg5)[%1] to #map9(%arg4, %arg5, %arg6) {
            %2 = affine.apply #map10(%arg6, %arg7)
            call @S1(%arg2, %2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
          }
          affine.if #set1(%arg4, %arg5, %arg6)[%1] {
            affine.if #set2(%arg6)[%1] {
              %2 = affine.apply #map11()[%1]
              call @S1(%arg2, %2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
            }
          }
          affine.for %arg7 = max #map12(%arg6, %arg4, %arg5)[%1] to min #map13(%arg6, %arg4, %arg5)[%0] {
            %2 = affine.apply #map14(%arg6, %arg7)
            call @S0(%arg3, %2, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
            %3 = affine.apply #map10(%arg6, %arg7)
            call @S1(%arg2, %3, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
          }
          affine.for %arg7 = #map15(%arg4, %arg5, %arg6) to min #map16(%arg6, %arg4, %arg5)[%0] {
            %2 = affine.apply #map14(%arg6, %arg7)
            call @S0(%arg3, %2, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
          }
          affine.if #set3(%arg4, %arg5, %arg6)[%0] {
            affine.if #set4(%arg6) {
              call @S0(%arg3, %c1, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
            }
          }
        }
        affine.for %arg6 = max #map17(%arg4, %arg5)[%0] to min #map18(%arg5, %arg4)[%0, %1] {
          %2 = affine.apply #map19(%arg6)[%0]
          call @S1(%arg2, %2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
        }
