...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<3000x2600xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600xf64>, %arg6: memref<2600xf64>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      call @S6(%arg6, %arg7) : (memref<2600xf64>, index) -> ()
      call @S7(%arg6, %arg7) : (memref<2600xf64>, index) -> ()
    }
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to %1 {
        call @S8(%arg3, %arg7, %arg8, %arg5) : (memref<3000x2600xf64>, index, index, memref<2600xf64>) -> ()
        call @S9(%arg3, %arg7, %arg8, %arg6, %arg2) : (memref<3000x2600xf64>, index, index, memref<2600xf64>, f64) -> ()
      }
    }
    ...
    call @S14(%arg4, %1) : (memref<2600x2600xf64>, index) -> ()
    return
  }
  ...
  func private @S6(%arg0: memref<2600xf64>, %arg1: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<2600xf64>
    %1 = sqrt %0 : f64
    affine.store %1, %arg0[%arg1] : memref<2600xf64>
    return
  }
  func private @S7(%arg0: memref<2600xf64>, %arg1: index) attributes {scop.stmt} {
  ...
  func private @S8(%arg0: memref<3000x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<2600xf64>) attributes {scop.stmt} {
  ...
  func private @S9(%arg0: memref<3000x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<2600xf64>, %arg4: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<3000x2600xf64>
    %1 = sqrt %arg4 : f64
  ...
  func private @kernel_correlation_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<3000x2600xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600xf64>, %arg6: memref<2600xf64>) {
    ...
    call @S14(%arg4, %0) : (memref<2600x2600xf64>, index) -> ()
    ...
    affine.for %arg7 = 0 to #map4()[%0] {
      ...
      affine.if #set(%arg7)[%0] {
        ...
        call @S3(%arg6, %2) : (memref<2600xf64>, index) -> ()
        %3 = affine.apply #map0()[%0]
        call @S0(%arg5, %3) : (memref<2600xf64>, index) -> ()
      }
    }
    affine.for %arg7 = 0 to #map4()[%0] {
      affine.for %arg8 = 0 to #map4()[%1] {
        affine.for %arg9 = #map5(%arg7) to min #map8(%arg7)[%0] {
          affine.for %arg10 = #map5(%arg8) to min #map8(%arg8)[%1] {
      ...
      affine.for %arg8 = 0 to #map4()[%1] {
        affine.for %arg9 = #map5(%arg7) to min #map8(%arg7)[%0] {
          affine.for %arg10 = #map5(%arg8) to min #map8(%arg8)[%1] {
            ...
            call @S8(%arg3, %arg10, %arg9, %arg5) : (memref<3000x2600xf64>, index, index, memref<2600xf64>) -> ()
          }
        }
      }
    }
    affine.for %arg7 = 0 to #map4()[%0] {
      affine.for %arg8 = #map5(%arg7) to min #map8(%arg7)[%0] {
        call @S5(%arg6, %arg8, %arg2) : (memref<2600xf64>, index, f64) -> ()
        call @S6(%arg6, %arg8) : (memref<2600xf64>, index) -> ()
        call @S7(%arg6, %arg8) : (memref<2600xf64>, index) -> ()
      }
    }
    affine.for %arg7 = 0 to #map4()[%1] {
      affine.for %arg8 = 0 to #map4()[%0] {
        affine.for %arg9 = #map5(%arg8) to min #map8(%arg8)[%0] {
          affine.for %arg10 = #map5(%arg7) to min #map8(%arg7)[%1] {
            call @S9(%arg3, %arg10, %arg9, %arg6, %arg2) : (memref<3000x2600xf64>, index, index, memref<2600xf64>, f64) -> ()
          }
        }
      }
    }
      ...
      affine.for %arg8 = #map3(%arg7) to #map4()[%0] {
        affine.for %arg9 = 0 to #map4()[%1] {
          affine.for %arg10 = #map5(%arg7) to min #map6(%arg7, %arg8)[%0] {
            affine.for %arg11 = max #map7(%arg8, %arg10) to min #map8(%arg8)[%0] {
              affine.for %arg12 = #map5(%arg9) to min #map8(%arg9)[%1] {
