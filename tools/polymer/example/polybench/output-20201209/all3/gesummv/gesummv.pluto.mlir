...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %2 = alloc() : memref<2800x2800xf64>
    %3 = alloc() : memref<2800x2800xf64>
    %4 = alloc() : memref<2800xf64>
    %5 = alloc() : memref<2800xf64>
    %6 = alloc() : memref<2800xf64>
    %7 = memref_cast %0 : memref<1xf64> to memref<?xf64>
    %8 = memref_cast %1 : memref<1xf64> to memref<?xf64>
    call @init_array(%c2800_i32, %7, %8, %2, %3, %5) : (i32, memref<?xf64>, memref<?xf64>, memref<2800x2800xf64>, memref<2800x2800xf64>, memref<2800xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %9 = load %0[%c0] : memref<1xf64>
    %10 = load %1[%c0] : memref<1xf64>
    call @kernel_gesummv_new(%c2800_i32, %9, %10, %2, %3, %4, %5, %6) : (i32, f64, f64, memref<2800x2800xf64>, memref<2800x2800xf64>, memref<2800xf64>, memref<2800xf64>, memref<2800xf64>) -> ()
    ...
    scf.if %12 {
      call @print_array(%c2800_i32, %6) : (i32, memref<2800xf64>) -> ()
    }
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<2800x2800xf64>, %arg4: memref<2800x2800xf64>, %arg5: memref<2800xf64>) {
    %c0 = constant 0 : index
  ...
  ^bb2:  // pred: ^bb1
    ...
    %6 = divf %4, %5 : f64
    store %6, %arg5[%2] : memref<2800xf64>
    br ^bb4(%c0_i32 : i32)
  ^bb3:  // pred: ^bb1
    return
  ...
  ^bb5:  // pred: ^bb4
    ...
    %14 = divf %13, %5 : f64
    store %14, %arg3[%2, %9] : memref<2800x2800xf64>
    %15 = addi %10, %c2_i32 : i32
    %16 = remi_signed %15, %arg0 : i32
    %17 = sitofp %16 : i32 to f64
    %18 = divf %17, %5 : f64
    store %18, %arg4[%2, %9] : memref<2800x2800xf64>
  ...
  func private @kernel_gesummv(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<2800x2800xf64>, %arg4: memref<2800x2800xf64>, %arg5: memref<2800xf64>, %arg6: memref<2800xf64>, %arg7: memref<2800xf64>) {
    %0 = alloca() : memref<1xf64>
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg8 = 0 to %1 {
      call @S0(%arg5, %arg8) : (memref<2800xf64>, index) -> ()
      call @S1(%arg7, %arg8) : (memref<2800xf64>, index) -> ()
      affine.for %arg9 = 0 to %1 {
        call @S2(%arg5, %arg8, %arg6, %arg9, %arg3, %0) : (memref<2800xf64>, index, memref<2800xf64>, index, memref<2800x2800xf64>, memref<1xf64>) -> ()
        call @S3(%arg7, %arg8, %0, %arg4, %arg9) : (memref<2800xf64>, index, memref<1xf64>, memref<2800x2800xf64>, index) -> ()
      }
      call @S4(%arg7, %arg8, %arg2, %arg1, %arg5) : (memref<2800xf64>, index, f64, f64, memref<2800xf64>) -> ()
    }
    return
  }
  func private @polybench_timer_stop()
  func private @polybench_timer_print()
  func private @print_array(%arg0: i32, %arg1: memref<2800xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    %22 = load %arg1[%15] : memref<2800xf64>
  ...
  func private @S0(%arg0: memref<2800xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1] : memref<2800xf64>
    return
  }
  func private @S1(%arg0: memref<2800xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1] : memref<2800xf64>
    return
  }
  func private @S2(%arg0: memref<2800xf64>, %arg1: index, %arg2: memref<2800xf64>, %arg3: index, %arg4: memref<2800x2800xf64>, %arg5: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[%arg1, %arg3] : memref<2800x2800xf64>
    %1 = affine.load %arg2[%arg3] : memref<2800xf64>
    affine.store %1, %arg5[0] : memref<1xf64>
    %2 = mulf %0, %1 : f64
    %3 = affine.load %arg0[%arg1] : memref<2800xf64>
    %4 = addf %2, %3 : f64
    affine.store %4, %arg0[%arg1] : memref<2800xf64>
    return
  }
  func private @S3(%arg0: memref<2800xf64>, %arg1: index, %arg2: memref<1xf64>, %arg3: memref<2800x2800xf64>, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg3[%arg1, %arg4] : memref<2800x2800xf64>
  ...
  func private @S4(%arg0: memref<2800xf64>, %arg1: index, %arg2: f64, %arg3: f64, %arg4: memref<2800xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[%arg1] : memref<2800xf64>
    %1 = mulf %arg3, %0 : f64
    %2 = affine.load %arg0[%arg1] : memref<2800xf64>
    %3 = mulf %arg2, %2 : f64
    %4 = addf %1, %3 : f64
    affine.store %4, %arg0[%arg1] : memref<2800xf64>
    return
  }
  func private @kernel_gesummv_new(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<2800x2800xf64>, %arg4: memref<2800x2800xf64>, %arg5: memref<2800xf64>, %arg6: memref<2800xf64>, %arg7: memref<2800xf64>) {
    %0 = alloca() : memref<1xf64>
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg8 = 0 to #map0()[%1] {
      affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%1] {
        call @S1(%arg7, %arg9) : (memref<2800xf64>, index) -> ()
        call @S0(%arg5, %arg9) : (memref<2800xf64>, index) -> ()
      }
    }
    affine.for %arg8 = 0 to %1 {
      affine.for %arg9 = 0 to %1 {
    ...
    affine.for %arg8 = 0 to #map0()[%1] {
      affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%1] {
        call @S4(%arg7, %arg9, %arg2, %arg1, %arg5) : (memref<2800xf64>, index, f64, f64, memref<2800xf64>) -> ()
      }
    }
    return
  }
