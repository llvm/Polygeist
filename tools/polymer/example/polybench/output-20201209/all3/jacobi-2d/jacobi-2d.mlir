...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_jacobi_2d(%c1000_i32, %c2800_i32, %0, %1) : (i32, i32, memref<2800x2800xf64>, memref<2800x2800xf64>) -> ()
    ...
    affine.for %arg4 = 0 to %1 {
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          %2 = affine.load %arg2[%arg5, %arg6] : memref<2800x2800xf64>
          %3 = affine.load %arg2[%arg5, %arg6 - 1] : memref<2800x2800xf64>
          %4 = addf %2, %3 : f64
          %5 = affine.load %arg2[%arg5, %arg6 + 1] : memref<2800x2800xf64>
          %6 = addf %4, %5 : f64
          %7 = affine.load %arg2[%arg5 + 1, %arg6] : memref<2800x2800xf64>
          %8 = addf %6, %7 : f64
          %9 = affine.load %arg2[%arg5 - 1, %arg6] : memref<2800x2800xf64>
          %10 = addf %8, %9 : f64
          %11 = mulf %cst, %10 : f64
          affine.store %11, %arg3[%arg5, %arg6] : memref<2800x2800xf64>
        }
      }
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          %2 = affine.load %arg3[%arg5, %arg6] : memref<2800x2800xf64>
          %3 = affine.load %arg3[%arg5, %arg6 - 1] : memref<2800x2800xf64>
          %4 = addf %2, %3 : f64
          %5 = affine.load %arg3[%arg5, %arg6 + 1] : memref<2800x2800xf64>
          %6 = addf %4, %5 : f64
          %7 = affine.load %arg3[%arg5 + 1, %arg6] : memref<2800x2800xf64>
          %8 = addf %6, %7 : f64
          %9 = affine.load %arg3[%arg5 - 1, %arg6] : memref<2800x2800xf64>
          %10 = addf %8, %9 : f64
          %11 = mulf %cst, %10 : f64
          affine.store %11, %arg2[%arg5, %arg6] : memref<2800x2800xf64>
        }
      }
    }
    return
