...
#map10 = affine_map<(d0) -> (d0 * 16 + 1)>
#map11 = affine_map<(d0) -> (d0 * 16)>
#map12 = affine_map<(d0)[s0] -> (s0, d0 * 16 + 32)>
#map13 = affine_map<(d0, d1, d2) -> (d0 * 32 - d1 * 32, d2 * 32 + 1)>
#map14 = affine_map<(d0, d1) -> (d0 * 32 + 1, d1 * 32 - d0 * 32 + 32)>
#map15 = affine_map<(d0)[s0] -> (s0, d0 * 32 + 32)>
#map16 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1)>
#map17 = affine_map<(d0) -> (d0 * 16 + 2)>
        ...
        affine.for %arg4 = 0 to min #map4(%arg3, %arg2)[%0] {
          ...
          affine.if #set2(%arg2, %arg3, %arg4) {
            affine.if #set3(%arg2) {
              ...
              %2 = affine.apply #map11(%arg2)
              call @S1(%arg1, %1, %2) : (memref<4000x4000xf64>, index, index) -> ()
            }
            affine.for %arg5 = #map10(%arg2) to min #map12(%arg2)[%0] {
              affine.if #set3(%arg2) {
                %1 = affine.apply #map10(%arg2)
                %2 = affine.apply #map11(%arg2)
          ...
          affine.for %arg5 = max #map13(%arg2, %arg3, %arg4) to min #map14(%arg3, %arg2) {
            affine.for %arg6 = #map7(%arg3) to min #map15(%arg3)[%0] {
              affine.for %arg7 = #map7(%arg4) to min #map16(%arg4, %arg5) {
                call @S2(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
              }
            }
          }
          affine.if #set2(%arg2, %arg3, %arg4) {
            affine.for %arg5 = #map17(%arg2) to min #map12(%arg2)[%0] {
              affine.if #set3(%arg2) {
                %1 = affine.apply #map11(%arg2)
                call @S1(%arg1, %arg5, %1) : (memref<4000x4000xf64>, index, index) -> ()
              }
              affine.for %arg6 = #map10(%arg2) to #map0(%arg5) {
                affine.for %arg7 = #map11(%arg2) to #map0(%arg6) {
                  affine.if #set3(%arg2) {
                    call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
                  }
                }
              ...
              affine.for %arg6 = #map0(%arg5) to min #map12(%arg2)[%0] {
                affine.for %arg7 = #map11(%arg2) to #map0(%arg5) {
                  affine.if #set3(%arg2) {
                    call @S2(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
                  }
                }
          ...
          affine.if #set4(%arg2, %arg3, %arg4) {
            affine.for %arg5 = #map10(%arg2) to min #map12(%arg2)[%0] {
              affine.for %arg6 = #map11(%arg2) to #map0(%arg5) {
                affine.for %arg7 = #map7(%arg4) to #map9(%arg4) {
                  affine.if #set3(%arg2) {
                    call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
                  }
