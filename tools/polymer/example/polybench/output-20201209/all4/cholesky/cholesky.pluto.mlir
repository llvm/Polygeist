...
#map4 = affine_map<(d0)[s0] -> (0, (d0 * 32 - s0 + 2) ceildiv 16)>
...
#map9 = affine_map<(d0) -> (d0 * 32 + 1)>
#map10 = affine_map<(d0) -> (d0 * 32 + 32)>
#map11 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32, d1 * 32 + 1)>
...
#set5 = affine_set<(d0, d1, d2)[s0] : (d0 - d1 * 2 == 0, d0 - d2 * 2 == 0, -d0 + (s0 - 2) floordiv 16 >= 0)>
      ...
      affine.for %arg3 = max #map2(%arg2)[%0] to #map3(%arg2) {
        affine.for %arg4 = max #map4(%arg3)[%0] to #map5(%arg2, %arg3) {
          ...
          affine.if #set1(%arg3, %arg4) {
            affine.for %arg5 = max #map11(%arg2, %arg3) to min #map7(%arg2, %arg3)[%0] {
              affine.for %arg6 = #map8(%arg3) to min #map12(%arg3, %arg5) {
                affine.for %arg7 = #map8(%arg4) to #map10(%arg4) {
                  call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
                }
              }
            }
          ...
          affine.if #set2(%arg2, %arg3, %arg4) {
            affine.for %arg5 = #map6(%arg2, %arg3) to min #map7(%arg2, %arg3)[%0] {
              affine.for %arg6 = #map8(%arg3) to #map10(%arg3) {
          ...
          affine.if #set5(%arg2, %arg3, %arg4)[%0] {
            affine.if #set4(%arg2) {
              %1 = affine.apply #map14(%arg2)
          ...
          affine.if #set3(%arg2, %arg3, %arg4) {
            affine.for %arg5 = #map15(%arg2) to min #map16(%arg2)[%0] {
              affine.if #set4(%arg2) {
                %1 = affine.apply #map13(%arg2)
                call @S1(%arg1, %arg5, %1) : (memref<4000x4000xf64>, index, index) -> ()
              }
              ...
              affine.for %arg6 = #map14(%arg2) to #map0(%arg5) {
                affine.for %arg7 = #map13(%arg2) to #map0(%arg6) {
                  affine.if #set4(%arg2) {
                    call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
                  }
                }
