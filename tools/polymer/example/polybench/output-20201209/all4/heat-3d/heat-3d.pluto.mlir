...
#set0 = affine_set<(d0, d1)[s0] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, d1 - (s0 + 1) ceildiv 32 >= 0)>
#set1 = affine_set<()[s0] : ((s0 + 1) mod 2 == 0)>
#set2 = affine_set<(d0, d1, d2)[s0] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d2 * 32 + d1 * 32 - s0 - 1) floordiv 32 - d0 >= 0, d1 - d2 - 1 >= 0, d1 - (s0 + 1) ceildiv 32 >= 0)>
#set3 = affine_set<(d0, d1, d2, d3)[s0] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d2 * 32 + d1 * 32 - s0 - 1) floordiv 32 - d0 >= 0, d1 - d2 - 1 >= 0, d1 - d3 - 1 >= 0, d1 - (s0 + 1) ceildiv 32 >= 0)>
#set4 = affine_set<(d0, d1, d2, d3)[s0] : (d0 - d1 * 2 == 0, d0 - 2 >= 0, d0 - (d2 * 32 - s0 + 1) ceildiv 16 >= 0, d0 - (d3 * 32 - s0 + 1) ceildiv 16 >= 0)>
#set5 = affine_set<(d0) : (d0 mod 2 == 0)>
#set6 = affine_set<(d0, d1, d2) : (d0 - (d1 * 16 + d2 - 16) ceildiv 16 >= 0, d2 floordiv 16 - d1 >= 0)>
#set7 = affine_set<(d0, d1) : (d1 floordiv 16 - d0 >= 0)>
#set8 = affine_set<(d0, d1)[s0] : (d0 - (d1 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set9 = affine_set<(d0, d1, d2)[s0] : ((d1 * 32 + d2 * 2 - s0 + 1) floordiv 32 - d0 >= 0, d1 - (d2 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set10 = affine_set<(d0, d1, d2, d3)[s0] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d1 * 32 - s0 + 1971) floordiv 32 - d0 >= 0, (d1 * 32 + d2 * 32 - s0 - 1) floordiv 32 - d0 >= 0, (d1 * 32 + d3 * 32 - s0 - 1) floordiv 32 - d0 >= 0)>
#set11 = affine_set<(d0, d1, d2, d3)[s0] : (d0 - (d1 * 32 + d2 * 32 - s0 + 1) ceildiv 32 >= 0, d0 - d2 * 2 >= 0, -d2 + 61 >= 0, d3 - d2 - 1 >= 0)>
#set12 = affine_set<(d0, d1, d2)[s0] : (d0 - (d1 * 32 + d2 * 32 - s0 + 1) ceildiv 32 >= 0, d0 - d2 * 2 >= 0, -d2 + 61 >= 0)>
#set13 = affine_set<(d0, d1, d2, d3) : (d0 - d1 * 2 == 0, -d0 + 122 >= 0, d2 * 2 - d0 - 2 >= 0, d3 * 2 - d0 - 2 >= 0)>
      ...
      affine.for %arg5 = #map1(%arg4) to min #map2(%arg4)[%0] {
        affine.for %arg6 = max #map3(%arg4, %arg5)[%0] to min #map4(%arg4, %arg5)[%0] {
          affine.for %arg7 = max #map5(%arg4, %arg5, %arg6)[%0] to min #map6(%arg4, %arg6, %arg5)[%0] {
            ...
            affine.if #set2(%arg4, %arg6, %arg5)[%0] {
              affine.if #set1()[%0] {
            ...
            affine.if #set3(%arg4, %arg7, %arg5, %arg6)[%0] {
              affine.if #set1()[%0] {
            ...
            affine.for %arg8 = max #map17(%arg5, %arg6, %arg7, %arg4)[%0] to min #map18(%arg4, %arg5, %arg6, %arg7)[%0] {
              ...
              affine.if #set9(%arg4, %arg5, %arg8)[%0] {
            ...
            affine.if #set12(%arg4, %arg5, %arg7)[%0] {
            ...
            affine.if #set13(%arg4, %arg5, %arg6, %arg7) {
