...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c4000_i32, %0, %1, %2, %3) : (i32, memref<4000x4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_ludcmp_new(%c4000_i32, %0, %1, %2, %3) : (i32, memref<4000x4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>) -> ()
    ...
    scf.if %5 {
      call @print_array(%c4000_i32, %2) : (i32, memref<4000xf64>) -> ()
    }
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: memref<4000x4000xf64>, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>, %arg4: memref<4000xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    store %4, %arg3[%3] : memref<4000xf64>
    ...
    %10 = addf %8, %9 : f64
    store %10, %arg2[%3] : memref<4000xf64>
    br ^bb1(%5 : i32)
  ...
  ^bb6:  // pred: ^bb5
    ...
    %23 = addf %21, %22 : f64
    store %23, %arg1[%13, %17] : memref<4000x4000xf64>
  ...
  ^bb9:  // pred: ^bb8
    ...
    store %29, %arg1[%13, %28] : memref<4000x4000xf64>
    %30 = addi %26, %c1_i32 : i32
    br ^bb8(%30 : i32)
  ^bb10:  // pred: ^bb8
    %31 = sitofp %c1_i32 : i32 to f64
    store %31, %arg1[%13, %13] : memref<4000x4000xf64>
    br ^bb3(%25 : i32)
  ...
  ^bb13:  // pred: ^bb12
    ...
    store %38, %14[%34, %37] : memref<4000x4000xf64>
  ...
  ^bb19:  // pred: ^bb18
    %51 = load %arg1[%46, %43] : memref<4000x4000xf64>
    %52 = load %arg1[%50, %43] : memref<4000x4000xf64>
    %53 = mulf %51, %52 : f64
    %54 = load %14[%46, %50] : memref<4000x4000xf64>
    %55 = addf %54, %53 : f64
    store %55, %14[%46, %50] : memref<4000x4000xf64>
  ...
  ^bb24:  // pred: ^bb23
    %64 = load %14[%60, %63] : memref<4000x4000xf64>
    store %64, %arg1[%60, %63] : memref<4000x4000xf64>
  ...
  func private @kernel_ludcmp(%arg0: i32, %arg1: memref<4000x4000xf64>, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>, %arg4: memref<4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = alloca() : memref<1xf64>
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to #map0(%arg5) {
        call @S0(%1, %arg1, %arg5, %arg6) : (memref<1xf64>, memref<4000x4000xf64>, index, index) -> ()
        affine.for %arg7 = 0 to #map0(%arg6) {
          call @S1(%1, %arg1, %arg7, %arg6, %arg5) : (memref<1xf64>, memref<4000x4000xf64>, index, index, index) -> ()
        }
        call @S2(%arg1, %arg5, %arg6, %1) : (memref<4000x4000xf64>, index, index, memref<1xf64>) -> ()
      }
      affine.for %arg6 = #map0(%arg5) to %0 {
        call @S3(%1, %arg1, %arg5, %arg6) : (memref<1xf64>, memref<4000x4000xf64>, index, index) -> ()
        affine.for %arg7 = 0 to #map0(%arg5) {
          call @S4(%1, %arg1, %arg7, %arg6, %arg5) : (memref<1xf64>, memref<4000x4000xf64>, index, index, index) -> ()
        }
        call @S5(%arg1, %arg5, %arg6, %1) : (memref<4000x4000xf64>, index, index, memref<1xf64>) -> ()
      }
    }
    affine.for %arg5 = 0 to %0 {
      call @S6(%1, %arg2, %arg5) : (memref<1xf64>, memref<4000xf64>, index) -> ()
      affine.for %arg6 = 0 to #map0(%arg5) {
        call @S7(%1, %arg4, %arg6, %arg1, %arg5) : (memref<1xf64>, memref<4000xf64>, index, memref<4000x4000xf64>, index) -> ()
      }
      call @S8(%arg4, %arg5, %1) : (memref<4000xf64>, index, memref<1xf64>) -> ()
    }
    affine.for %arg5 = 0 to %0 {
      call @S9(%1, %arg4, %arg5, %0) : (memref<1xf64>, memref<4000xf64>, index, index) -> ()
      affine.for %arg6 = #map1(%arg5)[%0] to %0 {
        call @S10(%1, %arg3, %arg6, %arg1, %arg5, %0) : (memref<1xf64>, memref<4000xf64>, index, memref<4000x4000xf64>, index, index) -> ()
      }
      call @S11(%arg3, %arg5, %0, %arg1, %1) : (memref<4000xf64>, index, index, memref<4000x4000xf64>, memref<1xf64>) -> ()
    }
    return
  }
  ...
  func private @S0(%arg0: memref<1xf64>, %arg1: memref<4000x4000xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2, %arg3] : memref<4000x4000xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S1(%arg0: memref<1xf64>, %arg1: memref<4000x4000xf64>, %arg2: index, %arg3: index, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg1[%arg4, %arg2] : memref<4000x4000xf64>
    %2 = affine.load %arg1[%arg2, %arg3] : memref<4000x4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[0] : memref<1xf64>
    return
  }
  func private @S2(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg3[0] : memref<1xf64>
    %1 = affine.load %arg0[%arg2, %arg2] : memref<4000x4000xf64>
    %2 = divf %0, %1 : f64
    affine.store %2, %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    return
  }
  func private @S3(%arg0: memref<1xf64>, %arg1: memref<4000x4000xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2, %arg3] : memref<4000x4000xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S4(%arg0: memref<1xf64>, %arg1: memref<4000x4000xf64>, %arg2: index, %arg3: index, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg1[%arg4, %arg2] : memref<4000x4000xf64>
    %2 = affine.load %arg1[%arg2, %arg3] : memref<4000x4000xf64>
    %3 = mulf %1, %2 : f64
  ...
  func private @S5(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg3[0] : memref<1xf64>
    affine.store %0, %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    return
  }
  func private @S6(%arg0: memref<1xf64>, %arg1: memref<4000xf64>, %arg2: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2] : memref<4000xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S7(%arg0: memref<1xf64>, %arg1: memref<4000xf64>, %arg2: index, %arg3: memref<4000x4000xf64>, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg3[%arg4, %arg2] : memref<4000x4000xf64>
    %2 = affine.load %arg1[%arg2] : memref<4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[0] : memref<1xf64>
    return
  }
  func private @S8(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg2[0] : memref<1xf64>
    affine.store %0, %arg0[%arg1] : memref<4000xf64>
    return
  }
  func private @S9(%arg0: memref<1xf64>, %arg1: memref<4000xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[-%arg2 + symbol(%arg3) - 1] : memref<4000xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S10(%arg0: memref<1xf64>, %arg1: memref<4000xf64>, %arg2: index, %arg3: memref<4000x4000xf64>, %arg4: index, %arg5: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg3[-%arg4 + symbol(%arg5) - 1, %arg2] : memref<4000x4000xf64>
    %2 = affine.load %arg1[%arg2] : memref<4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[0] : memref<1xf64>
  ...
  func private @S11(%arg0: memref<4000xf64>, %arg1: index, %arg2: index, %arg3: memref<4000x4000xf64>, %arg4: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[0] : memref<1xf64>
    %1 = affine.load %arg3[-%arg1 + symbol(%arg2) - 1, -%arg1 + symbol(%arg2) - 1] : memref<4000x4000xf64>
    %2 = divf %0, %1 : f64
    affine.store %2, %arg0[-%arg1 + symbol(%arg2) - 1] : memref<4000xf64>
    return
  }
  func private @kernel_ludcmp_new(%arg0: i32, %arg1: memref<4000x4000xf64>, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>, %arg4: memref<4000xf64>) {
    %c1 = constant 1 : index
    %c0 = constant 0 : index
    %0 = alloca() : memref<1xf64>
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg5 = 0 to %1 {
      call @S3(%0, %arg1, %c0, %arg5) : (memref<1xf64>, memref<4000x4000xf64>, index, index) -> ()
      call @S5(%arg1, %c0, %arg5, %0) : (memref<4000x4000xf64>, index, index, memref<1xf64>) -> ()
    }
    call @S0(%0, %arg1, %c1, %c0) : (memref<1xf64>, memref<4000x4000xf64>, index, index) -> ()
    call @S2(%arg1, %c1, %c0, %0) : (memref<4000x4000xf64>, index, index, memref<1xf64>) -> ()
    affine.for %arg5 = 1 to %1 {
      call @S3(%0, %arg1, %c1, %arg5) : (memref<1xf64>, memref<4000x4000xf64>, index, index) -> ()
      call @S4(%0, %arg1, %c0, %arg5, %c1) : (memref<1xf64>, memref<4000x4000xf64>, index, index, index) -> ()
      call @S5(%arg1, %c1, %arg5, %0) : (memref<4000x4000xf64>, index, index, memref<1xf64>) -> ()
    }
    affine.for %arg5 = 2 to %1 {
      call @S0(%0, %arg1, %arg5, %c0) : (memref<1xf64>, memref<4000x4000xf64>, index, index) -> ()
      call @S2(%arg1, %arg5, %c0, %0) : (memref<4000x4000xf64>, index, index, memref<1xf64>) -> ()
      affine.for %arg6 = 1 to #map0(%arg5) {
        call @S0(%0, %arg1, %arg5, %arg6) : (memref<1xf64>, memref<4000x4000xf64>, index, index) -> ()
        affine.for %arg7 = 0 to #map0(%arg6) {
          call @S1(%0, %arg1, %arg7, %arg6, %arg5) : (memref<1xf64>, memref<4000x4000xf64>, index, index, index) -> ()
        }
        call @S2(%arg1, %arg5, %arg6, %0) : (memref<4000x4000xf64>, index, index, memref<1xf64>) -> ()
      }
      affine.for %arg6 = #map0(%arg5) to %1 {
        call @S3(%0, %arg1, %arg5, %arg6) : (memref<1xf64>, memref<4000x4000xf64>, index, index) -> ()
        affine.for %arg7 = 0 to #map0(%arg5) {
          call @S4(%0, %arg1, %arg7, %arg6, %arg5) : (memref<1xf64>, memref<4000x4000xf64>, index, index, index) -> ()
        }
        call @S5(%arg1, %arg5, %arg6, %0) : (memref<4000x4000xf64>, index, index, memref<1xf64>) -> ()
      }
    }
    call @S6(%0, %arg2, %c0) : (memref<1xf64>, memref<4000xf64>, index) -> ()
    call @S8(%arg4, %c0, %0) : (memref<4000xf64>, index, memref<1xf64>) -> ()
    affine.for %arg5 = 1 to %1 {
      call @S6(%0, %arg2, %arg5) : (memref<1xf64>, memref<4000xf64>, index) -> ()
      affine.for %arg6 = 0 to #map0(%arg5) {
        call @S7(%0, %arg4, %arg6, %arg1, %arg5) : (memref<1xf64>, memref<4000xf64>, index, memref<4000x4000xf64>, index) -> ()
      }
      call @S8(%arg4, %arg5, %0) : (memref<4000xf64>, index, memref<1xf64>) -> ()
    }
    call @S9(%0, %arg4, %c0, %1) : (memref<1xf64>, memref<4000xf64>, index, index) -> ()
    call @S11(%arg3, %c0, %1, %arg1, %0) : (memref<4000xf64>, index, index, memref<4000x4000xf64>, memref<1xf64>) -> ()
    affine.for %arg5 = 1 to %1 {
      call @S9(%0, %arg4, %arg5, %1) : (memref<1xf64>, memref<4000xf64>, index, index) -> ()
      affine.for %arg6 = #map1(%arg5)[%1] to %1 {
        call @S10(%0, %arg3, %arg6, %arg1, %arg5, %1) : (memref<1xf64>, memref<4000xf64>, index, memref<4000x4000xf64>, index, index) -> ()
      }
      call @S11(%arg3, %arg5, %1, %arg1, %0) : (memref<4000xf64>, index, index, memref<4000x4000xf64>, memref<1xf64>) -> ()
    }
    return
  }
}
