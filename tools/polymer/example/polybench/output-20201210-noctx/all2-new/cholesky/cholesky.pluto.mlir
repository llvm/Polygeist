...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_cholesky_new(%c40_i32, %0) : (i32, memref<40x40xf64>) -> ()
  ...
  func private @kernel_cholesky(%arg0: i32, %arg1: memref<40x40xf64>) {
  ...
  func private @S2(%arg0: memref<40x40xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    ...
    %2 = mulf %1, %1 : f64
    %3 = subf %0, %2 : f64
    affine.store %3, %arg0[%arg1, %arg1] : memref<40x40xf64>
    return
  }
          ...
          affine.for %arg4 = 0 to #map4(%arg2, %arg3) {
            affine.if #set1(%arg2, %arg3, %arg4) {
              affine.for %arg5 = #map5(%arg2, %arg3) to min #map6(%arg2, %arg3)[%0] {
                ...
                call @S1(%arg1, %arg5, %1) : (memref<40x40xf64>, index, index) -> ()
                affine.for %arg6 = #map8(%arg3) to #map9(%arg3) {
                  ...
                  call @S1(%arg1, %arg5, %arg6) : (memref<40x40xf64>, index, index) -> ()
                }
              }
            }
            ...
            affine.if #set3(%arg2, %arg3, %arg4) {
              affine.for %arg5 = #map5(%arg2, %arg3) to min #map6(%arg2, %arg3)[%0] {
                affine.for %arg6 = #map7(%arg3) to #map9(%arg3) {
                  call @S2(%arg1, %arg5, %arg6) : (memref<40x40xf64>, index, index) -> ()
                }
              }
            }
            ...
            affine.if #set6(%arg2, %arg3, %arg4)[%0] {
              ...
              affine.if #set5(%arg2) {
                %1 = affine.apply #map13(%arg2)
                %2 = affine.apply #map12(%arg2)
                call @S2(%arg1, %1, %2) : (memref<40x40xf64>, index, index) -> ()
              }
              affine.if #set5(%arg2) {
                %1 = affine.apply #map13(%arg2)
                call @S3(%arg1, %1) : (memref<40x40xf64>, index) -> ()
            ...
            affine.if #set4(%arg2, %arg3, %arg4) {
              affine.for %arg5 = #map14(%arg2) to min #map15(%arg2)[%0] {
                ...
                affine.if #set5(%arg2) {
                  %1 = affine.apply #map12(%arg2)
                  call @S2(%arg1, %arg5, %1) : (memref<40x40xf64>, index, index) -> ()
                }
                ...
                affine.if #set5(%arg2) {
                  call @S3(%arg1, %arg5) : (memref<40x40xf64>, index) -> ()
                }
              }
            }
          }
