...
#map1 = affine_map<()[s0, s1] -> ((s0 + s1 - 1) floordiv 32 + 1)>
#map2 = affine_map<(d0) -> (d0 * 32)>
#map3 = affine_map<(d0)[s0] -> (s0, d0 * 32 + 32)>
#map4 = affine_map<(d0)[s0, s1] -> (s0, s1, d0 * 32 + 32)>
#set0 = affine_set<()[s0] : (s0 - 1 >= 0)>
#set1 = affine_set<()[s0, s1] : (s0 >= 0, s1 >= 0)>
#set2 = affine_set<(d0)[s0, s1] : (-d0 + (s0 - 1) floordiv 32 >= 0, -d0 + (s1 - 1) floordiv 32 >= 0)>
#set3 = affine_set<(d0)[s0, s1] : (-d0 + (s0 - 1) floordiv 32 >= 0, d0 - s1 ceildiv 32 >= 0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_2mm_new(%c1600_i32, %c1800_i32, %c2200_i32, %c2400_i32, %9, %10, %2, %3, %4, %5, %6) : (i32, i32, i32, i32, f64, f64, memref<1600x1800xf64>, memref<1600x2200xf64>, memref<2200x1800xf64>, memref<1800x2400xf64>, memref<1600x2400xf64>) -> ()
  ...
  func private @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<1600x1800xf64>, %arg7: memref<1600x2200xf64>, %arg8: memref<2200x1800xf64>, %arg9: memref<1800x2400xf64>, %arg10: memref<1600x2400xf64>) {
    ...
    affine.for %arg11 = 0 to %3 {
      affine.for %arg12 = 0 to %0 {
        call @S0(%arg6, %arg11, %arg12) : (memref<1600x1800xf64>, index, index) -> ()
        affine.for %arg13 = 0 to %1 {
          call @S1(%arg6, %arg11, %arg12, %arg8, %arg13, %arg4, %arg7) : (memref<1600x1800xf64>, index, index, memref<2200x1800xf64>, index, f64, memref<1600x2200xf64>) -> ()
        }
      }
    }
    affine.for %arg11 = 0 to %3 {
      affine.for %arg12 = 0 to %2 {
        call @S2(%arg10, %arg11, %arg12, %arg5) : (memref<1600x2400xf64>, index, index, f64) -> ()
        affine.for %arg13 = 0 to %0 {
          call @S3(%arg10, %arg11, %arg12, %arg9, %arg13, %arg6) : (memref<1600x2400xf64>, index, index, memref<1800x2400xf64>, index, memref<1600x1800xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @S1(%arg0: memref<1600x1800xf64>, %arg1: index, %arg2: index, %arg3: memref<2200x1800xf64>, %arg4: index, %arg5: f64, %arg6: memref<1600x2200xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<1600x1800xf64>
    %1 = affine.load %arg6[%arg1, %arg4] : memref<1600x2200xf64>
    %2 = mulf %arg5, %1 : f64
    %3 = affine.load %arg3[%arg4, %arg2] : memref<2200x1800xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
    affine.store %5, %arg0[%arg1, %arg2] : memref<1600x1800xf64>
    return
  }
  func private @S2(%arg0: memref<1600x2400xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<1600x2400xf64>
    %1 = mulf %0, %arg3 : f64
    affine.store %1, %arg0[%arg1, %arg2] : memref<1600x2400xf64>
    return
  }
  func private @S3(%arg0: memref<1600x2400xf64>, %arg1: index, %arg2: index, %arg3: memref<1800x2400xf64>, %arg4: index, %arg5: memref<1600x1800xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<1600x2400xf64>
    %1 = affine.load %arg5[%arg1, %arg4] : memref<1600x1800xf64>
    %2 = affine.load %arg3[%arg4, %arg2] : memref<1800x2400xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1, %arg2] : memref<1600x2400xf64>
    return
  }
  func private @kernel_2mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<1600x1800xf64>, %arg7: memref<1600x2200xf64>, %arg8: memref<2200x1800xf64>, %arg9: memref<1800x2400xf64>, %arg10: memref<1600x2400xf64>) {
    ...
    affine.if #set0()[%0] {
      affine.for %arg11 = 0 to #map0()[%0] {
        affine.if #set1()[%1, %3] {
          affine.for %arg12 = 0 to #map1()[%1, %3] {
            affine.if #set2(%arg12)[%1, %3] {
              affine.for %arg13 = #map2(%arg11) to min #map3(%arg11)[%0] {
                affine.for %arg14 = #map2(%arg12) to min #map4(%arg12)[%1, %3] {
                  call @S2(%arg10, %arg13, %arg14, %arg5) : (memref<1600x2400xf64>, index, index, f64) -> ()
                  call @S0(%arg6, %arg13, %arg14) : (memref<1600x1800xf64>, index, index) -> ()
                }
                affine.for %arg14 = %3 to min #map3(%arg12)[%1] {
                  call @S0(%arg6, %arg13, %arg14) : (memref<1600x1800xf64>, index, index) -> ()
                }
                affine.for %arg14 = %1 to min #map3(%arg12)[%3] {
                  call @S2(%arg10, %arg13, %arg14, %arg5) : (memref<1600x2400xf64>, index, index, f64) -> ()
                }
              }
            }
            affine.if #set3(%arg12)[%1, %3] {
              affine.for %arg13 = #map2(%arg11) to min #map3(%arg11)[%0] {
                affine.for %arg14 = #map2(%arg12) to min #map3(%arg12)[%1] {
                  call @S0(%arg6, %arg13, %arg14) : (memref<1600x1800xf64>, index, index) -> ()
                }
              }
            }
            affine.if #set3(%arg12)[%3, %1] {
              affine.for %arg13 = #map2(%arg11) to min #map3(%arg11)[%0] {
                affine.for %arg14 = #map2(%arg12) to min #map3(%arg12)[%3] {
                  call @S2(%arg10, %arg13, %arg14, %arg5) : (memref<1600x2400xf64>, index, index, f64) -> ()
                }
              }
            }
          ...
          affine.for %arg12 = 0 to #map0()[%1] {
            affine.if #set0()[%2] {
              affine.for %arg13 = 0 to #map0()[%2] {
                affine.for %arg14 = #map2(%arg11) to min #map3(%arg11)[%0] {
                  affine.for %arg15 = #map2(%arg13) to min #map3(%arg13)[%2] {
                    affine.for %arg16 = #map2(%arg12) to min #map3(%arg12)[%1] {
                      call @S1(%arg6, %arg14, %arg16, %arg8, %arg15, %arg4, %arg7) : (memref<1600x1800xf64>, index, index, memref<2200x1800xf64>, index, f64, memref<1600x2200xf64>) -> ()
                    }
                  }
                }
              }
            ...
            affine.if #set0()[%3] {
              affine.for %arg13 = 0 to #map0()[%3] {
                affine.for %arg14 = #map2(%arg11) to min #map3(%arg11)[%0] {
                  affine.for %arg15 = #map2(%arg12) to min #map3(%arg12)[%1] {
                    affine.for %arg16 = #map2(%arg13) to min #map3(%arg13)[%3] {
                      call @S3(%arg10, %arg14, %arg16, %arg9, %arg15, %arg6) : (memref<1600x2400xf64>, index, index, memref<1800x2400xf64>, index, memref<1600x1800xf64>) -> ()
                    }
                  }
                }
              }
