...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
    ...
    affine.for %arg6 = 1 to #map0()[%13] {
      affine.for %arg7 = 1 to #map1()[%12] {
        ...
        affine.for %arg8 = 1 to #map1()[%12] {
          call @S7(%arg4, %arg7, %arg8, %10, %11, %3, %2) : (memref<20x20xf64>, index, index, memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
          call @S8(%arg5, %arg7, %arg8, %3, %arg4, %2, %arg2, %8) : (memref<20x20xf64>, index, index, memref<1xf64>, memref<20x20xf64>, memref<1xf64>, memref<20x20xf64>, memref<1xf64>) -> ()
        }
      ...
      affine.for %arg7 = 1 to #map1()[%12] {
        ...
        affine.for %arg8 = 1 to #map1()[%12] {
          call @S14(%arg4, %arg7, %arg8, %9, %8, %1, %0) : (memref<20x20xf64>, index, index, memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
          call @S15(%arg5, %arg7, %arg8, %1, %arg4, %0, %arg3, %11) : (memref<20x20xf64>, index, index, memref<1xf64>, memref<20x20xf64>, memref<1xf64>, memref<20x20xf64>, memref<1xf64>) -> ()
        }
  ...
  func private @S6(%arg0: memref<20x20xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, 0] : memref<20x20xf64>
    return
  }
  ...
  func private @S13(%arg0: memref<20x20xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, 0] : memref<20x20xf64>
    return
  }
    ...
    affine.for %arg6 = 1 to #map0()[%12] {
      affine.for %arg7 = 0 to #map2()[%13] {
        affine.for %arg8 = max #map3(%arg7) to min #map4(%arg7)[%13] {
          ...
          call @S6(%arg5, %arg8) : (memref<20x20xf64>, index) -> ()
      ...
      affine.for %arg7 = 0 to #map2()[%13] {
        affine.for %arg8 = max #map3(%arg7) to min #map4(%arg7)[%13] {
          ...
          call @S13(%arg5, %arg8) : (memref<20x20xf64>, index) -> ()
        ...
        affine.for %arg8 = 0 to #map2()[%13] {
          affine.for %arg9 = max #map3(%arg8) to min #map4(%arg8)[%13] {
            affine.for %arg10 = max #map3(%arg7) to min #map4(%arg7)[%13] {
              call @S10(%arg3, %arg9, %arg10, %13, %arg5, %arg4) : (memref<20x20xf64>, index, index, index, memref<20x20xf64>, memref<20x20xf64>) -> ()
            }
          }
        }
      }
      ...
      affine.for %arg7 = 1 to #map1()[%13] {
        ...
        affine.for %arg8 = 1 to #map1()[%13] {
          call @S17(%arg2, %arg7, %arg8, %13, %arg5, %arg4) : (memref<20x20xf64>, index, index, index, memref<20x20xf64>, memref<20x20xf64>) -> ()
        }
      }
    }
    return
