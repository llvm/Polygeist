...
#set4 = affine_set<(d0, d1, d2, d3)[s0] : (d0 - 2 == 0, d1 - 1 == 0, -d2 + (s0 + 31) floordiv 32 >= 0, -d3 + (s0 + 31) floordiv 32 >= 0)>
...
#set9 = affine_set<(d0, d1, d2, d3)[s0] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d1 * 32 - s0 + 11) floordiv 32 - d0 >= 0, (d1 * 32 + d2 * 32 - s0 - 1) floordiv 32 - d0 >= 0, (d1 * 32 + d3 * 32 - s0 - 1) floordiv 32 - d0 >= 0)>
#set10 = affine_set<(d0, d1, d2, d3)[s0] : (d0 >= 0, d0 - (d1 * 32 - s0 + 1) ceildiv 32 >= 0, d2 == 0, d3 - 1 >= 0)>
#set11 = affine_set<(d0, d1, d2)[s0] : (d0 >= 0, d0 - (d1 * 32 - s0 + 1) ceildiv 32 >= 0, d2 == 0)>
        ...
        affine.for %arg6 = max #map3(%arg4, %arg5)[%0] to min #map4(%arg4, %arg5)[%0] {
          affine.for %arg7 = max #map5(%arg4, %arg5, %arg6)[%0] to min #map6(%arg4, %arg6, %arg5)[%0] {
            ...
            affine.for %arg8 = max #map17(%arg5, %arg6, %arg7, %arg4)[%0] to min #map18(%arg4, %arg5, %arg6, %arg7)[%0] {
              ...
              affine.if #set8(%arg4, %arg5, %arg8)[%0] {
