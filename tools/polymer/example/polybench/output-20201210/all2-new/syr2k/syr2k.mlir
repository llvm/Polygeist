...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_syr2k(%c30_i32, %c20_i32, %7, %8, %2, %3, %4) : (i32, i32, f64, f64, memref<30x30xf64>, memref<30x20xf64>, memref<30x20xf64>) -> ()
  ...
  func private @kernel_syr2k(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<30x30xf64>, %arg5: memref<30x20xf64>, %arg6: memref<30x20xf64>) {
    ...
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to #map(%arg7) {
        %2 = affine.load %arg4[%arg7, %arg8] : memref<30x30xf64>
        %3 = mulf %2, %arg3 : f64
        affine.store %3, %arg4[%arg7, %arg8] : memref<30x30xf64>
      }
      affine.for %arg8 = 0 to %1 {
        affine.for %arg9 = 0 to #map(%arg7) {
          %2 = affine.load %arg5[%arg9, %arg8] : memref<30x20xf64>
          %3 = mulf %2, %arg2 : f64
          %4 = affine.load %arg6[%arg7, %arg8] : memref<30x20xf64>
          %5 = mulf %3, %4 : f64
          %6 = affine.load %arg6[%arg9, %arg8] : memref<30x20xf64>
          %7 = mulf %6, %arg2 : f64
          %8 = affine.load %arg5[%arg7, %arg8] : memref<30x20xf64>
          %9 = mulf %7, %8 : f64
          %10 = addf %5, %9 : f64
          %11 = affine.load %arg4[%arg7, %arg9] : memref<30x30xf64>
          %12 = addf %11, %10 : f64
          affine.store %12, %arg4[%arg7, %arg9] : memref<30x30xf64>
        }
      }
    }
    return
