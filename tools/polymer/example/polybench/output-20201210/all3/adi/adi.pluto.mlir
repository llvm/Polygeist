...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<2000x2000xf64>, %arg3: memref<2000x2000xf64>, %arg4: memref<2000x2000xf64>, %arg5: memref<2000x2000xf64>) {
    ...
    call @S2(%8, %6, %5, %4) : (memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
    ...
    affine.for %arg6 = 1 to #map0()[%13] {
      affine.for %arg7 = 1 to #map1()[%12] {
        ...
        affine.for %arg8 = 1 to #map1()[%12] {
          call @S7(%arg4, %arg7, %arg8, %11, %10, %3, %2) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
          call @S8(%arg5, %arg7, %arg8, %3, %arg4, %2, %arg2, %8) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>) -> ()
        }
      ...
      affine.for %arg7 = 1 to #map1()[%12] {
        ...
        affine.for %arg8 = 1 to #map1()[%12] {
          call @S14(%arg4, %arg7, %arg8, %9, %8, %1, %0) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
          call @S15(%arg5, %arg7, %arg8, %1, %arg4, %0, %arg3, %10) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>) -> ()
        }
    ...
    affine.for %arg6 = 1 to #map0()[%12] {
      ...
      affine.for %arg7 = 0 to #map2()[%13] {
        affine.for %arg8 = 0 to #map2()[%13] {
          affine.for %arg9 = max #map3(%arg8) to min #map4(%arg8)[%13] {
            affine.for %arg10 = max #map3(%arg7) to min #map4(%arg7)[%13] {
              call @S10(%arg3, %arg9, %arg10, %13, %arg5, %arg4) : (memref<2000x2000xf64>, index, index, index, memref<2000x2000xf64>, memref<2000x2000xf64>) -> ()
            }
          }
        }
      }
