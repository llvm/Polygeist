...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c2600_i32, %c3000_i32, %4, %1) : (i32, i32, memref<?xf64>, memref<3000x2600xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %5 = load %0[%c0] : memref<1xf64>
    call @kernel_covariance_new(%c2600_i32, %c3000_i32, %5, %1, %2, %3) : (i32, i32, f64, memref<3000x2600xf64>, memref<2600x2600xf64>, memref<2600xf64>) -> ()
    call @polybench_timer_stop() : () -> ()
    call @polybench_timer_print() : () -> ()
    %6 = cmpi "sgt", %arg0, %c42_i32 : i32
    %7 = scf.if %6 -> (i1) {
      %8 = llvm.load %arg1 : !llvm.ptr<ptr<i8>>
      %9 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %10 = llvm.mlir.constant(0 : index) : !llvm.i64
      %11 = llvm.getelementptr %9[%10, %10] : (!llvm.ptr<array<1 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %12 = llvm.call @strcmp(%8, %11) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
      %13 = llvm.mlir.cast %12 : !llvm.i32 to i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    %9 = mulf %7, %8 : f64
    %10 = sitofp %c2600_i32 : i32 to f64
    %11 = divf %9, %10 : f64
    store %11, %arg3[%3, %6] : memref<3000x2600xf64>
  ...
  func private @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<3000x2600xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600xf64>) {
    %0 = alloca() : memref<1xf64>
    %1 = index_cast %arg1 : i32 to index
    %2 = index_cast %arg0 : i32 to index
    affine.for %arg6 = 0 to %2 {
      call @S0(%arg5, %arg6) : (memref<2600xf64>, index) -> ()
      affine.for %arg7 = 0 to %1 {
        call @S1(%arg5, %arg6, %arg3, %arg7) : (memref<2600xf64>, index, memref<3000x2600xf64>, index) -> ()
      }
      call @S2(%arg5, %arg6, %arg2) : (memref<2600xf64>, index, f64) -> ()
    }
    affine.for %arg6 = 0 to %1 {
      affine.for %arg7 = 0 to %2 {
        call @S3(%arg3, %arg6, %arg7, %arg5) : (memref<3000x2600xf64>, index, index, memref<2600xf64>) -> ()
      }
    }
    affine.for %arg6 = 0 to %2 {
      affine.for %arg7 = #map0(%arg6) to %2 {
        call @S4(%arg4, %arg6, %arg7) : (memref<2600x2600xf64>, index, index) -> ()
        affine.for %arg8 = 0 to %1 {
          call @S5(%arg4, %arg6, %arg7, %arg3, %arg8) : (memref<2600x2600xf64>, index, index, memref<3000x2600xf64>, index) -> ()
        }
        call @S6(%arg4, %arg6, %arg7, %arg2, %0) : (memref<2600x2600xf64>, index, index, f64, memref<1xf64>) -> ()
        call @S7(%arg4, %arg7, %arg6, %0) : (memref<2600x2600xf64>, index, index, memref<1xf64>) -> ()
      }
    }
    return
  }
  ...
  func private @S3(%arg0: memref<3000x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<2600xf64>) attributes {scop.stmt} {
  ...
  func private @S4(%arg0: memref<2600x2600xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    return
  }
  func private @S5(%arg0: memref<2600x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<3000x2600xf64>, %arg4: index) attributes {scop.stmt} {
  ...
  func private @S6(%arg0: memref<2600x2600xf64>, %arg1: index, %arg2: index, %arg3: f64, %arg4: memref<1xf64>) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    %0 = affine.load %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    %1 = subf %arg3, %cst : f64
    %2 = divf %0, %1 : f64
    affine.store %2, %arg4[0] : memref<1xf64>
    affine.store %2, %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    return
  }
  func private @S7(%arg0: memref<2600x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg3[0] : memref<1xf64>
    affine.store %0, %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    return
  }
  func private @kernel_covariance_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<3000x2600xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600xf64>) {
    %0 = alloca() : memref<1xf64>
    %1 = index_cast %arg0 : i32 to index
    %2 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to #map1()[%1] {
      affine.for %arg7 = #map0(%arg6) to #map1()[%1] {
        affine.for %arg8 = #map2(%arg6) to min #map3(%arg6)[%1] {
          affine.for %arg9 = max #map4(%arg7, %arg8) to min #map3(%arg7)[%1] {
            call @S4(%arg4, %arg8, %arg9) : (memref<2600x2600xf64>, index, index) -> ()
          }
        }
      }
    }
    affine.for %arg6 = 0 to #map1()[%1] {
      affine.for %arg7 = #map2(%arg6) to min #map3(%arg6)[%1] {
        call @S0(%arg5, %arg7) : (memref<2600xf64>, index) -> ()
      }
    }
    affine.for %arg6 = 0 to #map1()[%1] {
      affine.for %arg7 = 0 to #map1()[%2] {
        affine.for %arg8 = #map2(%arg7) to min #map3(%arg7)[%2] {
          affine.for %arg9 = #map2(%arg6) to min #map3(%arg6)[%1] {
            call @S1(%arg5, %arg9, %arg3, %arg8) : (memref<2600xf64>, index, memref<3000x2600xf64>, index) -> ()
          }
        }
      }
    }
    ...
    affine.for %arg6 = 0 to #map1()[%1] {
      affine.for %arg7 = #map0(%arg6) to #map1()[%1] {
        affine.for %arg8 = 0 to #map1()[%2] {
          affine.for %arg9 = #map2(%arg6) to min #map3(%arg6)[%1] {
            affine.for %arg10 = #map2(%arg8) to min #map3(%arg8)[%2] {
              affine.for %arg11 = max #map4(%arg7, %arg9) to min #map3(%arg7)[%1] {
                call @S5(%arg4, %arg9, %arg11, %arg3, %arg10) : (memref<2600x2600xf64>, index, index, memref<3000x2600xf64>, index) -> ()
              }
            }
          }
        }
