...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_deriche_new(%c7680_i32, %c4320_i32, %6, %1, %2, %3, %4) : (i32, i32, f32, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<7680x4320xf32>) -> ()
  ...
  func private @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<7680x4320xf32>, %arg4: memref<7680x4320xf32>, %arg5: memref<7680x4320xf32>, %arg6: memref<7680x4320xf32>) {
    ...
    call @S1(%19, %arg2, %13, %15, %12, %11) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    call @S2(%14, %arg2, %12) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    call @S3(%17, %arg2, %11, %9) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>) -> ()
    call @S4(%20, %10) : (memref<1xf32>, memref<1xf32>) -> ()
    call @S5(%16, %9) : (memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %22 {
      ...
      affine.for %arg8 = 0 to %21 {
        call @S10(%arg5, %arg7, %arg8, %26, %16, %25, %20, %23, %19, %arg3, %15, %8, %7, %6) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %22 {
      ...
      affine.for %arg8 = 0 to %21 {
        call @S18(%arg6, %arg7, %arg8, %21, %32, %16, %31, %20, %28, %17, %27, %14, %5, %4) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %22 {
      affine.for %arg8 = 0 to %21 {
        call @S23(%arg4, %arg7, %arg8, %arg6, %arg5, %18) : (memref<7680x4320xf32>, index, index, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<1xf32>) -> ()
      }
    }
    affine.for %arg7 = 0 to %21 {
      ...
      affine.for %arg8 = 0 to %22 {
        call @S27(%arg5, %arg8, %arg7, %26, %16, %25, %20, %24, %19, %arg4, %15, %3, %2) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %21 {
      ...
      affine.for %arg8 = 0 to %22 {
        call @S35(%arg6, %arg8, %arg7, %22, %32, %16, %31, %20, %30, %17, %29, %14, %1, %0) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %22 {
      affine.for %arg8 = 0 to %21 {
        call @S40(%arg4, %arg7, %arg8, %arg6, %arg5, %18) : (memref<7680x4320xf32>, index, index, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<1xf32>) -> ()
      }
    }
    return
  }
  ...
  func private @kernel_deriche_new(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<7680x4320xf32>, %arg4: memref<7680x4320xf32>, %arg5: memref<7680x4320xf32>, %arg6: memref<7680x4320xf32>) {
    %0 = alloca() : memref<1xf32>
    %1 = alloca() : memref<1xf32>
    %2 = alloca() : memref<1xf32>
    %3 = alloca() : memref<1xf32>
    ...
    affine.for %arg7 = 0 to %31 {
      ...
      affine.for %arg8 = 0 to %32 {
        call @S10(%arg5, %arg7, %arg8, %26, %29, %27, %30, %25, %16, %arg3, %19, %24, %23, %22) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %31 {
      ...
      affine.for %arg8 = 0 to %32 {
        call @S18(%arg6, %arg7, %arg8, %32, %11, %29, %12, %30, %9, %13, %10, %15, %8, %7) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S22(%12, %arg6, %arg7, %arg8, %32) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
        call @S21(%11, %7) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S20(%10, %arg3, %arg7, %arg8, %32) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
      ...
      affine.for %arg8 = 0 to #map0()[%32] {
        affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%31] {
          affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%32] {
            call @S23(%arg4, %arg9, %arg10, %arg6, %arg5, %28) : (memref<7680x4320xf32>, index, index, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<1xf32>) -> ()
          }
        }
      }
    }
    affine.for %arg7 = 0 to %32 {
      ...
      affine.for %arg8 = 0 to %31 {
        call @S27(%arg5, %arg8, %arg7, %26, %29, %27, %30, %6, %16, %arg4, %19, %5, %4) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S30(%27, %arg5, %arg8, %arg7) : (memref<1xf32>, memref<7680x4320xf32>, index, index) -> ()
    ...
    affine.for %arg7 = 0 to %32 {
      ...
      affine.for %arg8 = 0 to %31 {
        call @S35(%arg6, %arg8, %arg7, %31, %11, %29, %12, %30, %2, %13, %3, %15, %1, %0) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S39(%12, %arg6, %arg8, %arg7, %31) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
        call @S38(%11, %0) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S37(%3, %arg4, %arg8, %arg7, %31) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
    ...
    affine.for %arg7 = 0 to #map0()[%31] {
      affine.for %arg8 = 0 to #map0()[%32] {
        affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%31] {
          affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%32] {
            call @S40(%arg4, %arg9, %arg10, %arg6, %arg5, %28) : (memref<7680x4320xf32>, index, index, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<1xf32>) -> ()
          }
        }
      }
    }
