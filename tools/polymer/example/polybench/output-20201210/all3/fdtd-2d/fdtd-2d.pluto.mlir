...
#map29 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 + 1, d2 * -32 + d0 * 32 + d1 * 2 - 31)>
#map30 = affine_map<(d0) -> (d0 + 1)>
        ...
        affine.for %arg9 = max #map4(%arg7) to min #map5(%arg7, %arg8)[%0, %1, %2] {
          ...
          affine.for %arg10 = max #map13(%arg7, %arg8, %arg9)[%2, %1] to min #map14(%arg7, %arg9, %arg8)[%0, %2] {
            affine.for %arg11 = #map11(%arg9) to min #map15(%arg9, %arg10)[%1] {
              ...
              affine.for %arg12 = max #map18(%arg8, %arg10, %arg7) to min #map19(%arg8, %arg7, %arg10)[%2] {
                %3 = affine.apply #map16(%arg10, %arg11)
                %4 = affine.apply #map16(%arg10, %arg12)
                call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                %5 = affine.apply #map16(%arg10, %arg11)
                %6 = affine.apply #map16(%arg10, %arg12)
                call @S2(%arg3, %5, %6, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
                %7 = affine.apply #map20(%arg10, %arg11)
                %8 = affine.apply #map20(%arg10, %arg12)
          ...
          affine.for %arg10 = max #map27(%arg7, %arg9, %arg8)[%2] to min #map28(%arg7, %arg9, %arg8)[%0, %2] {
            ...
            affine.for %arg11 = max #map29(%arg8, %arg10, %arg7) to min #map19(%arg8, %arg7, %arg10)[%2] {
              %3 = affine.apply #map16(%arg10, %arg11)
            ...
            affine.for %arg11 = #map30(%arg10) to min #map15(%arg9, %arg10)[%1] {
              affine.if #set3(%arg7, %arg10, %arg8) {
                %3 = affine.apply #map16(%arg10, %arg11)
                %4 = affine.apply #map17(%arg7, %arg8, %arg10)
                call @S1(%arg4, %3, %4, %arg5) : (memref<2000x2600xf64>, index, index, memref<2000x2600xf64>) -> ()
          ...
          affine.if #set12(%arg7, %arg8, %arg9)[%2, %0] {
            affine.for %arg10 = max #map36(%arg8, %arg7, %arg9) to min #map37(%arg8, %arg9, %arg7)[%2] {
              ...
              %4 = affine.apply #map39(%arg9)
              call @S0(%arg4, %3, %arg6, %4) : (memref<2000x2600xf64>, index, memref<1000xf64>, index) -> ()
              %5 = affine.apply #map38(%arg9, %arg10)
