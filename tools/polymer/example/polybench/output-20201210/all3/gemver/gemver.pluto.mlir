...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_gemver_new(%c4000_i32, %13, %14, %2, %3, %4, %5, %6, %7, %8, %9, %10) : (i32, f64, f64, memref<4000x4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>) -> ()
  ...
  func private @kernel_gemver(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<4000x4000xf64>, %arg4: memref<4000xf64>, %arg5: memref<4000xf64>, %arg6: memref<4000xf64>, %arg7: memref<4000xf64>, %arg8: memref<4000xf64>, %arg9: memref<4000xf64>, %arg10: memref<4000xf64>, %arg11: memref<4000xf64>) {
    ...
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %0 {
        call @S0(%arg3, %arg12, %arg13, %arg7, %arg6, %arg5, %arg4) : (memref<4000x4000xf64>, index, index, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>) -> ()
      }
    }
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %0 {
        call @S1(%arg9, %arg12, %arg10, %arg13, %arg2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>, index, f64, memref<4000x4000xf64>) -> ()
      }
    }
    affine.for %arg12 = 0 to %0 {
      call @S2(%arg9, %arg12, %arg11) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
    }
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %0 {
        call @S3(%arg8, %arg12, %arg9, %arg13, %arg1, %arg3) : (memref<4000xf64>, index, memref<4000xf64>, index, f64, memref<4000x4000xf64>) -> ()
      }
    }
    return
  }
  ...
  func private @S0(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index, %arg3: memref<4000xf64>, %arg4: memref<4000xf64>, %arg5: memref<4000xf64>, %arg6: memref<4000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    %1 = affine.load %arg6[%arg1] : memref<4000xf64>
    %2 = affine.load %arg5[%arg2] : memref<4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    %5 = affine.load %arg4[%arg1] : memref<4000xf64>
    %6 = affine.load %arg3[%arg2] : memref<4000xf64>
    %7 = mulf %5, %6 : f64
    %8 = addf %4, %7 : f64
    affine.store %8, %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    return
  }
  func private @S1(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<4000xf64>, %arg3: index, %arg4: f64, %arg5: memref<4000x4000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<4000xf64>
    %1 = affine.load %arg5[%arg3, %arg1] : memref<4000x4000xf64>
    %2 = mulf %arg4, %1 : f64
    %3 = affine.load %arg2[%arg3] : memref<4000xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
    affine.store %5, %arg0[%arg1] : memref<4000xf64>
    return
  }
  func private @S2(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<4000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<4000xf64>
    %1 = affine.load %arg2[%arg1] : memref<4000xf64>
    %2 = addf %0, %1 : f64
    affine.store %2, %arg0[%arg1] : memref<4000xf64>
    return
  }
  func private @S3(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<4000xf64>, %arg3: index, %arg4: f64, %arg5: memref<4000x4000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<4000xf64>
    %1 = affine.load %arg5[%arg1, %arg3] : memref<4000x4000xf64>
    %2 = mulf %arg4, %1 : f64
    %3 = affine.load %arg2[%arg3] : memref<4000xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
  ...
  func private @kernel_gemver_new(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<4000x4000xf64>, %arg4: memref<4000xf64>, %arg5: memref<4000xf64>, %arg6: memref<4000xf64>, %arg7: memref<4000xf64>, %arg8: memref<4000xf64>, %arg9: memref<4000xf64>, %arg10: memref<4000xf64>, %arg11: memref<4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
      ...
      affine.for %arg13 = 0 to #map0()[%0] {
        affine.for %arg14 = #map1(%arg13) to min #map2(%arg13)[%0] {
          affine.for %arg15 = #map1(%arg12) to min #map2(%arg12)[%0] {
            call @S0(%arg3, %arg14, %arg15, %arg7, %arg6, %arg5, %arg4) : (memref<4000x4000xf64>, index, index, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>, memref<4000xf64>) -> ()
            call @S1(%arg9, %arg15, %arg10, %arg14, %arg2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>, index, f64, memref<4000x4000xf64>) -> ()
          }
        }
      }
    }
    affine.for %arg12 = 0 to #map0()[%0] {
      affine.for %arg13 = #map1(%arg12) to min #map2(%arg12)[%0] {
        call @S2(%arg9, %arg13, %arg11) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
      }
    }
    affine.for %arg12 = 0 to #map0()[%0] {
      affine.for %arg13 = 0 to #map0()[%0] {
        affine.for %arg14 = #map1(%arg12) to min #map2(%arg12)[%0] {
          affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%0] {
            call @S3(%arg8, %arg14, %arg9, %arg15, %arg1, %arg3) : (memref<4000xf64>, index, memref<4000xf64>, index, f64, memref<4000x4000xf64>) -> ()
          }
        }
      }
    }
