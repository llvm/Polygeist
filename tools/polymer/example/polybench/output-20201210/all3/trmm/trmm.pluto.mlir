...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %3 = memref_cast %0 : memref<1xf64> to memref<?xf64>
    call @init_array(%c2000_i32, %c2600_i32, %3, %1, %2) : (i32, i32, memref<?xf64>, memref<2000x2000xf64>, memref<2000x2600xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %4 = load %0[%c0] : memref<1xf64>
    call @kernel_trmm_new(%c2000_i32, %c2600_i32, %4, %1, %2) : (i32, i32, f64, memref<2000x2000xf64>, memref<2000x2600xf64>) -> ()
  ...
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<2000x2000xf64>, %arg4: memref<2000x2600xf64>) {
    %c0 = constant 0 : index
  ...
  ^bb4:  // pred: ^bb3
    ...
    %10 = divf %8, %9 : f64
    store %10, %arg3[%2, %5] : memref<2000x2000xf64>
    %11 = addi %3, %c1_i32 : i32
    br ^bb3(%11 : i32)
  ^bb5:  // pred: ^bb3
    store %cst_0, %arg3[%2, %2] : memref<2000x2000xf64>
    br ^bb6(%c0_i32 : i32)
  ...
  ^bb7:  // pred: ^bb6
    ...
    %20 = divf %18, %19 : f64
    store %20, %arg4[%2, %14] : memref<2000x2600xf64>
  ...
  func private @kernel_trmm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<2000x2000xf64>, %arg4: memref<2000x2600xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to %1 {
        affine.for %arg7 = #map0(%arg5) to %0 {
          call @S0(%arg4, %arg5, %arg6, %arg7, %arg3) : (memref<2000x2600xf64>, index, index, index, memref<2000x2000xf64>) -> ()
        }
        call @S1(%arg4, %arg5, %arg6, %arg2) : (memref<2000x2600xf64>, index, index, f64) -> ()
      }
    }
    return
  }
  ...
  func private @S0(%arg0: memref<2000x2600xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<2000x2000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<2000x2600xf64>
    %1 = affine.load %arg4[%arg3, %arg1] : memref<2000x2000xf64>
    %2 = affine.load %arg0[%arg3, %arg2] : memref<2000x2600xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1, %arg2] : memref<2000x2600xf64>
    return
  }
  func private @S1(%arg0: memref<2000x2600xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<2000x2600xf64>
    %1 = mulf %arg3, %0 : f64
    affine.store %1, %arg0[%arg1, %arg2] : memref<2000x2600xf64>
    return
  }
  func private @kernel_trmm_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<2000x2000xf64>, %arg4: memref<2000x2600xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg5 = 0 to #map1()[%1] {
      affine.for %arg6 = 0 to #map2()[%0] {
        affine.for %arg7 = #map3(%arg6) to #map1()[%0] {
          affine.for %arg8 = #map4(%arg6) to min #map5(%arg6, %arg7)[%0] {
            affine.for %arg9 = max #map6(%arg7, %arg8) to min #map7(%arg7)[%0] {
              affine.for %arg10 = #map4(%arg5) to min #map7(%arg5)[%1] {
                call @S0(%arg4, %arg8, %arg10, %arg9, %arg3) : (memref<2000x2600xf64>, index, index, index, memref<2000x2000xf64>) -> ()
              }
            }
          }
        }
    ...
    affine.for %arg5 = 0 to #map1()[%0] {
      affine.for %arg6 = 0 to #map1()[%1] {
        affine.for %arg7 = #map4(%arg5) to min #map7(%arg5)[%0] {
          affine.for %arg8 = #map4(%arg6) to min #map7(%arg6)[%1] {
            call @S1(%arg4, %arg7, %arg8, %arg2) : (memref<2000x2600xf64>, index, index, f64) -> ()
          }
        }
      }
    }
