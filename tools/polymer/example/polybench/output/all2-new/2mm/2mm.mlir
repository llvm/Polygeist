module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_2mm(%c16_i32, %c18_i32, %c22_i32, %c24_i32, %9, %10, %2, %3, %4, %5, %6) : (i32, i32, i32, i32, f64, f64, memref<16x18xf64>, memref<16x22xf64>, memref<22x18xf64>, memref<18x24xf64>, memref<16x24xf64>) -> ()
  ...
  func private @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<16x18xf64>, %arg7: memref<16x22xf64>, %arg8: memref<22x18xf64>, %arg9: memref<18x24xf64>, %arg10: memref<16x24xf64>) {
    ...
    affine.for %arg11 = 0 to %3 {
      affine.for %arg12 = 0 to %0 {
        affine.store %cst, %arg6[%arg11, %arg12] : memref<16x18xf64>
        affine.for %arg13 = 0 to %1 {
          %4 = affine.load %arg7[%arg11, %arg13] : memref<16x22xf64>
          %5 = mulf %arg4, %4 : f64
          %6 = affine.load %arg8[%arg13, %arg12] : memref<22x18xf64>
          %7 = mulf %5, %6 : f64
          %8 = affine.load %arg6[%arg11, %arg12] : memref<16x18xf64>
          %9 = addf %8, %7 : f64
          affine.store %9, %arg6[%arg11, %arg12] : memref<16x18xf64>
        }
      }
    }
    affine.for %arg11 = 0 to %3 {
      affine.for %arg12 = 0 to %2 {
        %4 = affine.load %arg10[%arg11, %arg12] : memref<16x24xf64>
        %5 = mulf %4, %arg5 : f64
        affine.store %5, %arg10[%arg11, %arg12] : memref<16x24xf64>
        affine.for %arg13 = 0 to %0 {
          %6 = affine.load %arg6[%arg11, %arg13] : memref<16x18xf64>
          %7 = affine.load %arg9[%arg13, %arg12] : memref<18x24xf64>
          %8 = mulf %6, %7 : f64
          %9 = affine.load %arg10[%arg11, %arg12] : memref<16x24xf64>
          %10 = addf %9, %8 : f64
          affine.store %10, %arg10[%arg11, %arg12] : memref<16x24xf64>
        }
      }
    }
    return
