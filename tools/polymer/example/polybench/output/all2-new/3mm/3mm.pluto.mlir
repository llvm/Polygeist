...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_3mm_new(%c16_i32, %c18_i32, %c20_i32, %c22_i32, %c24_i32, %0, %1, %2, %3, %4, %5, %6) : (i32, i32, i32, i32, i32, memref<16x18xf64>, memref<16x20xf64>, memref<20x18xf64>, memref<18x22xf64>, memref<18x24xf64>, memref<24x22xf64>, memref<16x22xf64>) -> ()
    call @print_array(%c16_i32, %c22_i32, %6) : (i32, i32, memref<16x22xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<16x20xf64>, %arg6: memref<20x18xf64>, %arg7: memref<18x24xf64>, %arg8: memref<24x22xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<16x18xf64>, %arg6: memref<16x20xf64>, %arg7: memref<20x18xf64>, %arg8: memref<18x22xf64>, %arg9: memref<18x24xf64>, %arg10: memref<24x22xf64>, %arg11: memref<16x22xf64>) {
  ...
  func private @print_array(%arg0: i32, %arg1: i32, %arg2: memref<16x22xf64>) {
    %c0_i32 = constant 0 : i32
    %c20_i32 = constant 20 : i32
    %c1_i32 = constant 1 : i32
  ...
  func private @kernel_3mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<16x18xf64>, %arg6: memref<16x20xf64>, %arg7: memref<20x18xf64>, %arg8: memref<18x22xf64>, %arg9: memref<18x24xf64>, %arg10: memref<24x22xf64>, %arg11: memref<16x22xf64>) {
      ...
      affine.for %arg13 = 0 to #map0()[%1] {
        affine.for %arg14 = #map1(%arg12) to min #map2(%arg12)[%0] {
          affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%1] {
            ...
            affine.for %arg16 = 0 to min #map3()[%2] {
              call @S1(%arg5, %arg14, %arg15, %arg7, %arg16, %arg6) : (memref<16x18xf64>, index, index, memref<20x18xf64>, index, memref<16x20xf64>) -> ()
            }
          }
        }
        affine.for %arg14 = 1 to #map0()[%2] {
          affine.for %arg15 = #map1(%arg12) to min #map2(%arg12)[%0] {
            affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%1] {
              affine.for %arg17 = #map1(%arg14) to min #map2(%arg14)[%2] {
                call @S1(%arg5, %arg15, %arg16, %arg7, %arg17, %arg6) : (memref<16x18xf64>, index, index, memref<20x18xf64>, index, memref<16x20xf64>) -> ()
              }
            }
          }
        }
    ...
    affine.for %arg12 = 0 to #map0()[%1] {
      affine.for %arg13 = 0 to #map0()[%3] {
        affine.for %arg14 = #map1(%arg12) to min #map2(%arg12)[%1] {
          affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%3] {
            call @S2(%arg8, %arg14, %arg15) : (memref<18x22xf64>, index, index) -> ()
            affine.for %arg16 = 0 to min #map3()[%4] {
              call @S3(%arg8, %arg14, %arg15, %arg10, %arg16, %arg9) : (memref<18x22xf64>, index, index, memref<24x22xf64>, index, memref<18x24xf64>) -> ()
            }
          }
        }
        affine.for %arg14 = 1 to #map0()[%4] {
          affine.for %arg15 = #map1(%arg12) to min #map2(%arg12)[%1] {
            affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%3] {
              affine.for %arg17 = #map1(%arg14) to min #map2(%arg14)[%4] {
                call @S3(%arg8, %arg15, %arg16, %arg10, %arg17, %arg9) : (memref<18x22xf64>, index, index, memref<24x22xf64>, index, memref<18x24xf64>) -> ()
              }
            }
          }
        }
      ...
      affine.for %arg13 = 0 to #map0()[%3] {
        affine.for %arg14 = #map1(%arg12) to min #map2(%arg12)[%0] {
          affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%3] {
            ...
            affine.for %arg16 = 0 to min #map3()[%1] {
              call @S5(%arg11, %arg14, %arg15, %arg8, %arg16, %arg5) : (memref<16x22xf64>, index, index, memref<18x22xf64>, index, memref<16x18xf64>) -> ()
            }
          }
        }
        affine.for %arg14 = 1 to #map0()[%1] {
          affine.for %arg15 = #map1(%arg12) to min #map2(%arg12)[%0] {
            affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%3] {
              affine.for %arg17 = #map1(%arg14) to min #map2(%arg14)[%1] {
