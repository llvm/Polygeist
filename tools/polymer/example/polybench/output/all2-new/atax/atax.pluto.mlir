...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_atax_new(%c38_i32, %c42_i32, %0, %1, %2, %3) : (i32, i32, memref<38x42xf64>, memref<42xf64>, memref<42xf64>, memref<38xf64>) -> ()
  ...
  func private @kernel_atax_new(%arg0: i32, %arg1: i32, %arg2: memref<38x42xf64>, %arg3: memref<42xf64>, %arg4: memref<42xf64>, %arg5: memref<38xf64>) {
    ...
    affine.for %arg6 = 0 to #map0()[%0] {
      affine.for %arg7 = #map1(%arg6) to min #map2(%arg6)[%0] {
        ...
        affine.for %arg8 = 0 to min #map3()[%1] {
          call @S2(%arg5, %arg7, %arg3, %arg8, %arg2) : (memref<38xf64>, index, memref<42xf64>, index, memref<38x42xf64>) -> ()
        }
        affine.for %arg8 = 0 to min #map3()[%1] {
          call @S3(%arg4, %arg8, %arg5, %arg7, %arg2) : (memref<42xf64>, index, memref<38xf64>, index, memref<38x42xf64>) -> ()
        }
      }
      affine.for %arg7 = 1 to #map0()[%1] {
