...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_cholesky_new(%arg0: i32, %arg1: memref<40x40xf64>) {
    ...
    %c0 = constant 0 : index
    %0 = index_cast %arg0 : i32 to index
    call @S3(%arg1, %c0) : (memref<40x40xf64>, index) -> ()
    call @S1(%arg1, %c1, %c0) : (memref<40x40xf64>, index, index) -> ()
    call @S2(%arg1, %c1, %c0) : (memref<40x40xf64>, index, index) -> ()
    call @S3(%arg1, %c1) : (memref<40x40xf64>, index) -> ()
    affine.for %arg2 = 2 to %0 {
      call @S1(%arg1, %arg2, %c0) : (memref<40x40xf64>, index, index) -> ()
