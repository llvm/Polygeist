...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c10_i32, %c8_i32, %c12_i32, %0, %2) : (i32, i32, i32, memref<10x8x12xf64>, memref<12x12xf64>) -> ()
    call @kernel_doitgen_new(%c10_i32, %c8_i32, %c12_i32, %0, %2, %1) : (i32, i32, i32, memref<10x8x12xf64>, memref<12x12xf64>, memref<12xf64>) -> ()
    call @print_array(%c10_i32, %c8_i32, %c12_i32, %0) : (i32, i32, i32, memref<10x8x12xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<10x8x12xf64>, %arg4: memref<12x12xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @print_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<10x8x12xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @kernel_doitgen_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<10x8x12xf64>, %arg4: memref<12x12xf64>, %arg5: memref<12xf64>) {
    ...
    affine.for %arg6 = 0 to %0 {
      affine.for %arg7 = 0 to %1 {
        affine.for %arg8 = 0 to #map0()[%2] {
          affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%2] {
            call @S0(%arg5, %arg9) : (memref<12xf64>, index) -> ()
            affine.for %arg10 = 0 to min #map3()[%2] {
              call @S1(%arg5, %arg9, %arg4, %arg10, %arg3, %arg6, %arg7) : (memref<12xf64>, index, memref<12x12xf64>, index, memref<10x8x12xf64>, index, index) -> ()
            }
          }
          affine.for %arg9 = 1 to #map0()[%2] {
            affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%2] {
              affine.for %arg11 = #map1(%arg9) to min #map2(%arg9)[%2] {
                call @S1(%arg5, %arg10, %arg4, %arg11, %arg3, %arg6, %arg7) : (memref<12xf64>, index, memref<12x12xf64>, index, memref<10x8x12xf64>, index, index) -> ()
              }
            }
          }
        }
