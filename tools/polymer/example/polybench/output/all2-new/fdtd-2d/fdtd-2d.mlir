...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_fdtd_2d(%c20_i32, %c20_i32, %c30_i32, %0, %1, %2, %3) : (i32, i32, i32, memref<20x30xf64>, memref<20x30xf64>, memref<20x30xf64>, memref<20xf64>) -> ()
  ...
  func private @kernel_fdtd_2d(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<20x30xf64>, %arg4: memref<20x30xf64>, %arg5: memref<20x30xf64>, %arg6: memref<20xf64>) {
    ...
    affine.for %arg7 = 0 to %2 {
      affine.for %arg8 = 0 to %0 {
        %3 = affine.load %arg6[%arg7] : memref<20xf64>
        affine.store %3, %arg4[0, %arg8] : memref<20x30xf64>
      }
      affine.for %arg8 = 1 to %1 {
        affine.for %arg9 = 0 to %0 {
          %3 = affine.load %arg4[%arg8, %arg9] : memref<20x30xf64>
          %4 = affine.load %arg5[%arg8, %arg9] : memref<20x30xf64>
          %5 = affine.load %arg5[%arg8 - 1, %arg9] : memref<20x30xf64>
          %6 = subf %4, %5 : f64
          %7 = mulf %cst, %6 : f64
          %8 = subf %3, %7 : f64
          affine.store %8, %arg4[%arg8, %arg9] : memref<20x30xf64>
        }
      }
      affine.for %arg8 = 0 to %1 {
        affine.for %arg9 = 1 to %0 {
          %3 = affine.load %arg3[%arg8, %arg9] : memref<20x30xf64>
          %4 = affine.load %arg5[%arg8, %arg9] : memref<20x30xf64>
          %5 = affine.load %arg5[%arg8, %arg9 - 1] : memref<20x30xf64>
          %6 = subf %4, %5 : f64
          %7 = mulf %cst, %6 : f64
          %8 = subf %3, %7 : f64
          affine.store %8, %arg3[%arg8, %arg9] : memref<20x30xf64>
        }
      }
      affine.for %arg8 = 0 to #map()[%1] {
        affine.for %arg9 = 0 to #map()[%0] {
          %3 = affine.load %arg5[%arg8, %arg9] : memref<20x30xf64>
          %4 = affine.load %arg3[%arg8, %arg9 + 1] : memref<20x30xf64>
          %5 = affine.load %arg3[%arg8, %arg9] : memref<20x30xf64>
          %6 = subf %4, %5 : f64
          %7 = affine.load %arg4[%arg8 + 1, %arg9] : memref<20x30xf64>
          %8 = addf %6, %7 : f64
          %9 = affine.load %arg4[%arg8, %arg9] : memref<20x30xf64>
          %10 = subf %8, %9 : f64
          %11 = mulf %cst_0, %10 : f64
          %12 = subf %3, %11 : f64
          affine.store %12, %arg5[%arg8, %arg9] : memref<20x30xf64>
        }
      }
    }
    return
