  ...
  func private @kernel_fdtd_2d_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<20x30xf64>, %arg4: memref<20x30xf64>, %arg5: memref<20x30xf64>, %arg6: memref<20xf64>) {
    ...
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to #map1()[%2] {
        affine.for %arg9 = #map2(%arg8) to min #map3(%arg8)[%2] {
          call @S0(%arg4, %arg9, %arg6, %arg7) : (memref<20x30xf64>, index, memref<20xf64>, index) -> ()
        }
      }
      affine.for %arg8 = 0 to #map1()[%1] {
        affine.for %arg9 = 0 to #map1()[%2] {
          affine.for %arg10 = max #map4(%arg8) to min #map3(%arg8)[%1] {
            affine.for %arg11 = #map2(%arg9) to min #map3(%arg9)[%2] {
              call @S1(%arg4, %arg10, %arg11, %arg5) : (memref<20x30xf64>, index, index, memref<20x30xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg8 = 0 to #map1()[%1] {
        affine.for %arg9 = 0 to #map1()[%2] {
          affine.for %arg10 = #map2(%arg8) to min #map3(%arg8)[%1] {
            affine.for %arg11 = max #map4(%arg9) to min #map3(%arg9)[%2] {
              call @S2(%arg3, %arg10, %arg11, %arg5) : (memref<20x30xf64>, index, index, memref<20x30xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg8 = 0 to #map5()[%1] {
        affine.for %arg9 = 0 to #map5()[%2] {
          affine.for %arg10 = #map2(%arg8) to min #map6(%arg8)[%1] {
            affine.for %arg11 = #map2(%arg9) to min #map6(%arg9)[%2] {
              call @S3(%arg5, %arg10, %arg11, %arg4, %arg3) : (memref<20x30xf64>, index, index, memref<20x30xf64>, memref<20x30xf64>) -> ()
            }
          }
        }
      }
