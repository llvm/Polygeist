...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c20_i32, %c25_i32, %c30_i32, %5, %6, %2, %3, %4) : (i32, i32, i32, memref<?xf64>, memref<?xf64>, memref<20x25xf64>, memref<20x30xf64>, memref<30x25xf64>) -> ()
    %7 = load %0[%c0] : memref<1xf64>
    %8 = load %1[%c0] : memref<1xf64>
    call @kernel_gemm_new(%c20_i32, %c25_i32, %c30_i32, %7, %8, %2, %3, %4) : (i32, i32, i32, f64, f64, memref<20x25xf64>, memref<20x30xf64>, memref<30x25xf64>) -> ()
    call @print_array(%c20_i32, %c25_i32, %2) : (i32, i32, memref<20x25xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<20x25xf64>, %arg6: memref<20x30xf64>, %arg7: memref<30x25xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_gemm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: f64, %arg4: f64, %arg5: memref<20x25xf64>, %arg6: memref<20x30xf64>, %arg7: memref<30x25xf64>) {
  ...
  func private @print_array(%arg0: i32, %arg1: i32, %arg2: memref<20x25xf64>) {
    %c0_i32 = constant 0 : i32
    %c20_i32 = constant 20 : i32
    %c1_i32 = constant 1 : i32
  ...
  func private @kernel_gemm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: f64, %arg4: f64, %arg5: memref<20x25xf64>, %arg6: memref<20x30xf64>, %arg7: memref<30x25xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    %2 = index_cast %arg2 : i32 to index
    affine.for %arg8 = 0 to #map0()[%0] {
      affine.for %arg9 = 0 to min #map1()[%1, %2] {
        affine.for %arg10 = #map2(%arg8) to min #map3(%arg8)[%0] {
          affine.for %arg11 = #map2(%arg9) to min #map3(%arg9)[%1] {
            call @S0(%arg5, %arg10, %arg11, %arg4) : (memref<20x25xf64>, index, index, f64) -> ()
          }
          affine.for %arg11 = #map2(%arg9) to min #map3(%arg9)[%2] {
            affine.for %arg12 = 0 to min #map4()[%1] {
              call @S1(%arg5, %arg10, %arg12, %arg7, %arg11, %arg3, %arg6) : (memref<20x25xf64>, index, index, memref<30x25xf64>, index, f64, memref<20x30xf64>) -> ()
            }
          }
        }
        affine.for %arg10 = 1 to #map0()[%1] {
          affine.for %arg11 = #map2(%arg8) to min #map3(%arg8)[%0] {
            affine.for %arg12 = #map2(%arg9) to min #map3(%arg9)[%2] {
              affine.for %arg13 = #map2(%arg10) to min #map3(%arg10)[%1] {
                call @S1(%arg5, %arg11, %arg13, %arg7, %arg12, %arg3, %arg6) : (memref<20x25xf64>, index, index, memref<30x25xf64>, index, f64, memref<20x30xf64>) -> ()
              }
            }
          }
        }
      }
      affine.for %arg9 = #map5()[%2] to #map0()[%1] {
        affine.for %arg10 = #map2(%arg8) to min #map3(%arg8)[%0] {
          affine.for %arg11 = #map2(%arg9) to min #map3(%arg9)[%1] {
            call @S0(%arg5, %arg10, %arg11, %arg4) : (memref<20x25xf64>, index, index, f64) -> ()
          }
      ...
      affine.for %arg9 = #map5()[%1] to #map0()[%2] {
        affine.for %arg10 = 0 to #map0()[%1] {
          affine.for %arg11 = #map2(%arg8) to min #map3(%arg8)[%0] {
            affine.for %arg12 = #map2(%arg9) to min #map3(%arg9)[%2] {
              affine.for %arg13 = #map2(%arg10) to min #map3(%arg10)[%1] {
                call @S1(%arg5, %arg11, %arg13, %arg7, %arg12, %arg3, %arg6) : (memref<20x25xf64>, index, index, memref<30x25xf64>, index, f64, memref<20x30xf64>) -> ()
