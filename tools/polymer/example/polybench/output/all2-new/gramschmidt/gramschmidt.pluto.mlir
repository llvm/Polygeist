...
#map5 = affine_map<(d0) -> ((d0 - 30) ceildiv 32)>
#map6 = affine_map<(d0, d1) -> (d0 * 32, d1 + 1)>
#map7 = affine_map<()[s0] -> (32, s0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c20_i32, %c30_i32, %0, %1, %2) : (i32, i32, memref<20x30xf64>, memref<30x30xf64>, memref<20x30xf64>) -> ()
    call @kernel_gramschmidt_new(%c20_i32, %c30_i32, %0, %1, %2) : (i32, i32, memref<20x30xf64>, memref<30x30xf64>, memref<20x30xf64>) -> ()
    call @print_array(%c20_i32, %c30_i32, %0, %1, %2) : (i32, i32, memref<20x30xf64>, memref<30x30xf64>, memref<20x30xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) {
    ...
    affine.for %arg5 = 0 to %4 {
      ...
      affine.for %arg6 = 0 to %2 {
        call @S1(%3, %arg2, %arg6, %arg5) : (memref<1xf64>, memref<20x30xf64>, index, index) -> ()
      }
      call @S2(%1, %3, %0) : (memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
      call @S3(%arg3, %arg5, %0) : (memref<30x30xf64>, index, memref<1xf64>) -> ()
      affine.for %arg6 = 0 to %2 {
        call @S4(%arg4, %arg6, %arg5, %1, %arg2) : (memref<20x30xf64>, index, index, memref<1xf64>, memref<20x30xf64>) -> ()
      }
      affine.for %arg6 = #map0(%arg5) to %4 {
        call @S5(%arg3, %arg5, %arg6) : (memref<30x30xf64>, index, index) -> ()
        affine.for %arg7 = 0 to %2 {
          call @S6(%arg3, %arg5, %arg6, %arg2, %arg7, %arg4) : (memref<30x30xf64>, index, index, memref<20x30xf64>, index, memref<20x30xf64>) -> ()
        }
        affine.for %arg7 = 0 to %2 {
          call @S7(%arg2, %arg7, %arg6, %arg3, %arg5, %arg4) : (memref<20x30xf64>, index, index, memref<30x30xf64>, index, memref<20x30xf64>) -> ()
        }
      }
    }
    return
  }
  func private @print_array(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) {
    %c0_i32 = constant 0 : i32
    %c20_i32 = constant 20 : i32
    %c1_i32 = constant 1 : i32
  ...
  func private @S3(%arg0: memref<30x30xf64>, %arg1: index, %arg2: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg2[0] : memref<1xf64>
    affine.store %0, %arg0[%arg1, %arg1] : memref<30x30xf64>
    return
  }
  func private @S4(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>, %arg4: memref<20x30xf64>) attributes {scop.stmt} {
  ...
  func private @S5(%arg0: memref<30x30xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, %arg2] : memref<30x30xf64>
    return
  }
  func private @S6(%arg0: memref<30x30xf64>, %arg1: index, %arg2: index, %arg3: memref<20x30xf64>, %arg4: index, %arg5: memref<20x30xf64>) attributes {scop.stmt} {
  ...
  func private @S7(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: memref<30x30xf64>, %arg4: index, %arg5: memref<20x30xf64>) attributes {scop.stmt} {
  ...
  func private @kernel_gramschmidt_new(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) {
    %0 = alloca() : memref<1xf64>
    %1 = alloca() : memref<1xf64>
    ...
    affine.for %arg5 = 0 to #map1()[%4] {
      ...
      affine.for %arg6 = 0 to %3 {
        call @S1(%2, %arg2, %arg6, %arg5) : (memref<1xf64>, memref<20x30xf64>, index, index) -> ()
      }
      call @S2(%0, %2, %1) : (memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
      call @S3(%arg3, %arg5, %1) : (memref<30x30xf64>, index, memref<1xf64>) -> ()
      affine.for %arg6 = 0 to #map2()[%3] {
        affine.for %arg7 = #map3(%arg6) to min #map4(%arg6)[%3] {
          call @S4(%arg4, %arg7, %arg5, %0, %arg2) : (memref<20x30xf64>, index, index, memref<1xf64>, memref<20x30xf64>) -> ()
        }
      }
      affine.for %arg6 = #map5(%arg5) to #map2()[%4] {
        affine.for %arg7 = max #map6(%arg5, %arg6) to min #map4(%arg6)[%4] {
          call @S5(%arg3, %arg5, %arg7) : (memref<30x30xf64>, index, index) -> ()
          affine.for %arg8 = 0 to min #map7()[%3] {
            call @S6(%arg3, %arg5, %arg7, %arg2, %arg8, %arg4) : (memref<30x30xf64>, index, index, memref<20x30xf64>, index, memref<20x30xf64>) -> ()
          }
          affine.for %arg8 = 0 to min #map7()[%3] {
            call @S7(%arg2, %arg8, %arg7, %arg3, %arg5, %arg4) : (memref<20x30xf64>, index, index, memref<30x30xf64>, index, memref<20x30xf64>) -> ()
          }
        }
        affine.for %arg7 = 1 to #map2()[%3] {
          affine.for %arg8 = max #map6(%arg5, %arg6) to min #map4(%arg6)[%4] {
            affine.for %arg9 = #map3(%arg7) to min #map4(%arg7)[%3] {
              call @S6(%arg3, %arg5, %arg8, %arg2, %arg9, %arg4) : (memref<30x30xf64>, index, index, memref<20x30xf64>, index, memref<20x30xf64>) -> ()
            }
            affine.for %arg9 = #map3(%arg7) to min #map4(%arg7)[%3] {
              call @S7(%arg2, %arg9, %arg8, %arg3, %arg5, %arg4) : (memref<20x30xf64>, index, index, memref<30x30xf64>, index, memref<20x30xf64>) -> ()
            }
          }
        }
      }
    ...
    affine.for %arg5 = 0 to %3 {
      ...
      call @S1(%2, %arg2, %arg5, %6) : (memref<1xf64>, memref<20x30xf64>, index, index) -> ()
    }
    call @S2(%0, %2, %1) : (memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
    %5 = affine.apply #map1()[%4]
    call @S3(%arg3, %5, %1) : (memref<30x30xf64>, index, memref<1xf64>) -> ()
    affine.for %arg5 = 0 to #map2()[%3] {
      affine.for %arg6 = #map3(%arg5) to min #map4(%arg5)[%3] {
        %6 = affine.apply #map1()[%4]
        call @S4(%arg4, %arg6, %6, %0, %arg2) : (memref<20x30xf64>, index, index, memref<1xf64>, memref<20x30xf64>) -> ()
      }
    }
    return
  }
