...
#map8 = affine_map<(d0)[s0] -> ((d0 * 16 + s0 + 13) floordiv 16 + 1, (s0 + 38) floordiv 32 + 1, -d0 + 3)>
#map9 = affine_map<()[s0] -> ((s0 + 28) floordiv 32 + 1)>
#map10 = affine_map<(d0) -> (31, d0 * 32)>
#map11 = affine_map<(d0)[s0] -> (s0 + 29, d0 * 32 + 32)>
#map12 = affine_map<(d0) -> (d0 - 30)>
#map13 = affine_map<(d0, d1)[s0] -> (0, (d0 + d1 - 1) ceildiv 2, (d1 * 32 - s0 - 27) ceildiv 32)>
#map14 = affine_map<(d0, d1)[s0] -> ((s0 + 38) floordiv 32 + 1, (d0 * 32 + s0 + 27) floordiv 32 + 1, (d1 * 16 + d0 * 16 + s0 + 28) floordiv 32 + 1)>
#map15 = affine_map<(d0, d1) -> (d0 * 32, d1 * -32 + 29)>
#map16 = affine_map<(d0, d1) -> (d0 * -32 + 61, d1 * 32 + 32)>
#map17 = affine_map<(d0) -> (d0 * 32)>
#map18 = affine_map<(d0, d1, d2)[s0] -> (0, (d0 + d1 - 1) ceildiv 2, (d1 * 32 - s0 - 27) ceildiv 32, (d2 * 32 - s0 - 27) ceildiv 32)>
#map19 = affine_map<(d0, d1, d2)[s0] -> ((s0 + 38) floordiv 32 + 1, (d0 * 32 + s0 + 27) floordiv 32 + 1, (d1 * 32 + s0 + 27) floordiv 32 + 1, (d2 * 16 + d0 * 16 + s0 + 28) floordiv 32 + 1)>
#map20 = affine_map<(d0, d1)[s0] -> (d0 * 32, d1 * 32 - s0 + 3)>
#map21 = affine_map<(d0, d1) -> (d0 * 32 + 1, d1 * 32 + 32)>
#map22 = affine_map<(d0, d1)[s0] -> (d0 * -32 + d1 + s0 - 2)>
#map23 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32, d1 * 32 - s0 + 3, d2 * -32 + d1 * 64 - s0 * 2 - 27)>
#map24 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * -32 + d2 * 64 - s0 * 2 + 5)>
#map25 = affine_map<(d0) -> (d0 * 32 + 32)>
#map26 = affine_map<(d0) -> (34, d0 * 32)>
#map27 = affine_map<(d0)[s0] -> (s0 + 32, d0 * 32 + 32)>
#map28 = affine_map<(d0) -> (d0 - 33)>
#map29 = affine_map<(d0, d1, d2, d3)[s0] -> (1, (d0 * 32 - s0 + 2) ceildiv 2, (d1 * 32 - s0 + 2) ceildiv 2, (d2 * 32 - s0 + 2) ceildiv 2, d3 * 8 + d0 * 8, d3 * 16 + 1)>
#map30 = affine_map<(d0, d1, d2, d3)[s0] -> (21, d0 * 16 + s0 floordiv 2 + 15, d1 * 16 + 15, d2 * 16 + 15, d3 * 16 + 15, d0 * 8 + d1 * 8 + 16)>
...
#map46 = affine_map<(d0, d1) -> (31, d0 * 32, d1 * -32 + 29)>
#map47 = affine_map<(d0, d1)[s0] -> (s0 + 29, d0 * -32 + 61, d1 * 32 + 32)>
#map48 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 16 + d2 * 16 + 32)>
#map49 = affine_map<(d0, d1) -> (d0 * -16 + d1 * 16)>
#map50 = affine_map<(d0, d1, d2) -> (d0 * -16 - d1 * 16 + d2 - 31)>
#map51 = affine_map<(d0, d1) -> (42, d0 * 32, d1 * -32 + 51)>
#map52 = affine_map<(d0, d1) -> (d0 * -32 + 83, d1 * 32 + 32)>
#map53 = affine_map<(d0) -> (42, d0 * 32)>
#map54 = affine_map<(d0) -> (d0 - 41)>
#map55 = affine_map<(d0, d1) -> ((d0 + d1 + 1) ceildiv 2)>
#map56 = affine_map<(d0, d1)[s0] -> ((d0 * 16 + d1 * 16 + s0 + 29) floordiv 32 + 1)>
#map57 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * 16 + d2 * 16 + s0 + 30)>
#map58 = affine_map<()[s0] -> ((s0 + 39) floordiv 32 + 1)>
#map59 = affine_map<(d0)[s0] -> (s0 + 40, d0 * 32 + 32)>
#set0 = affine_set<()[s0] : ((s0 * 31 + 5) mod 32 == 0)>
#set1 = affine_set<(d0, d1)[s0] : (d0 * 32 - (-s0 + 4) == 0, d1 * 32 - (s0 + 28) == 0)>
#set2 = affine_set<()[s0] : ((s0 + 28) mod 32 == 0)>
#set3 = affine_set<(d0, d1, d2)[s0] : (-d1 - d0 + 1 >= 0, -d1 + (s0 - 4) floordiv 32 >= 0, d2 * 32 - (s0 + 28) == 0)>
#set4 = affine_set<(d0, d1)[s0] : ((d1 * 16 - s0 + 1) floordiv 16 - d0 >= 0, d1 - (s0 + 1) ceildiv 32 >= 0)>
#set5 = affine_set<()[s0] : ((s0 + 1) mod 2 == 0)>
#set6 = affine_set<(d0, d1, d2)[s0] : ((d1 * -16 + d2 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d2 * 32 - s0 - 1) floordiv 32 - d0 >= 0, d2 - d1 - 1 >= 0, d2 - (s0 + 1) ceildiv 32 >= 0)>
#set7 = affine_set<(d0, d1, d2, d3)[s0] : ((d1 * -16 + d2 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d2 * 32 - s0 - 1) floordiv 32 - d0 >= 0, d2 - d1 - 1 >= 0, d2 - d3 - 1 >= 0, d2 - (s0 + 1) ceildiv 32 >= 0)>
#set8 = affine_set<(d0, d1, d2, d3)[s0] : (d0 - 1 == 0, d1 - 1 == 0, -d2 + (s0 + 31) floordiv 32 >= 0, -d3 + (s0 + 31) floordiv 32 >= 0)>
#set9 = affine_set<(d0, d1, d2) : (d0 - (d1 - 16) ceildiv 16 >= 0, d1 floordiv 16 - d2 >= 0)>
#set10 = affine_set<(d0, d1) : (d1 floordiv 16 - d0 >= 0)>
#set11 = affine_set<(d0, d1)[s0] : (d0 - (d1 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set12 = affine_set<(d0, d1, d2)[s0] : ((d1 * 2 - s0 + 1) floordiv 32 - d0 >= 0, d2 - (d1 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set13 = affine_set<(d0, d1, d2, d3)[s0] : ((d1 * 16 - s0 + 1) floordiv 16 - d0 >= 0, -d0 + (-s0 + 11) floordiv 32 >= 0, (d2 * 32 - s0 - 1) floordiv 32 - d0 >= 0, (d3 * 32 - s0 - 1) floordiv 32 - d0 >= 0)>
#set14 = affine_set<(d0, d1, d2, d3)[s0] : (d0 - (-s0 + 1) ceildiv 32 >= 0, d0 + d1 >= 0, d2 == 0, d3 - 1 >= 0)>
#set15 = affine_set<(d0, d1, d2)[s0] : (d0 - (-s0 + 1) ceildiv 32 >= 0, d0 + d1 >= 0, d2 == 0)>
#set16 = affine_set<(d0, d1, d2, d3) : (d0 == 0, d1 == 0, d2 - 1 >= 0, d3 - 1 >= 0)>
#set17 = affine_set<(d0, d1, d2) : (d0 == 0, d1 == 0, d2 - 1 >= 0)>
#set18 = affine_set<(d0, d1, d2) : (d0 + d1 >= 0, d2 == 0)>
#set19 = affine_set<(d0, d1, d2) : (-d1 - d0 >= 0, d1 - d0 - 1 >= 0, -d1 + d2 * 2 - d0 - 1 >= 0)>
#set20 = affine_set<(d0, d1)[s0] : ((d0 * 16 + d1 * 16 + s0 + 29) mod 32 == 0)>
#set21 = affine_set<(d0, d1, d2) : (d0 - (-d1 + 1) >= 0, d2 - 1 >= 0)>
#set22 = affine_set<()[s0] : ((s0 + 7) mod 32 == 0)>
#set23 = affine_set<(d0, d1) : (d0 == 0, d1 == 0)>
#set24 = affine_set<(d0, d1) : (-d1 - d0 >= 0, d1 - d0 - 1 >= 0)>
#set25 = affine_set<(d0, d1) : (d0 - (-d1 + 1) >= 0)>
#set26 = affine_set<(d0)[s0] : (d0 * 32 - (-s0 + 25) == 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_heat_3d_new(%arg0: i32, %arg1: i32, %arg2: memref<10x10x10xf64>, %arg3: memref<10x10x10xf64>) {
    ...
    affine.for %arg4 = #map6()[%0] to 2 {
      affine.for %arg5 = max #map7(%arg4) to min #map8(%arg4)[%0] {
        affine.if #set1(%arg4, %arg5)[%0] {
          affine.for %arg6 = 0 to #map9()[%0] {
            affine.for %arg7 = max #map10(%arg6) to min #map11(%arg6)[%0] {
              affine.if #set2()[%0] {
                %1 = affine.apply #map4()[%0]
                %2 = affine.apply #map12(%arg7)
                call @S0(%arg3, %1, %c1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              }
            }
          }
        }
        affine.for %arg6 = max #map13(%arg4, %arg5)[%0] to min #map14(%arg5, %arg4)[%0] {
          affine.if #set3(%arg4, %arg5, %arg6)[%0] {
            affine.for %arg7 = max #map15(%arg5, %arg4) to min #map16(%arg4, %arg5) {
              affine.if #set2()[%0] {
          ...
          affine.if #set1(%arg4, %arg5)[%0] {
            affine.for %arg7 = #map17(%arg6) to min #map11(%arg6)[%0] {
              affine.if #set2()[%0] {
                %1 = affine.apply #map4()[%0]
                %2 = affine.apply #map12(%arg7)
                call @S0(%arg3, %1, %2, %c1, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
          ...
          affine.for %arg7 = max #map18(%arg4, %arg5, %arg6)[%0] to min #map19(%arg5, %arg6, %arg4)[%0] {
            affine.if #set4(%arg4, %arg5)[%0] {
              affine.if #set5()[%0] {
                affine.for %arg8 = max #map20(%arg6, %arg5)[%0] to min #map21(%arg5, %arg6) {
                  affine.for %arg9 = max #map20(%arg7, %arg5)[%0] to min #map21(%arg5, %arg7) {
                    %1 = affine.apply #map4()[%0]
                    %2 = affine.apply #map22(%arg5, %arg8)[%0]
                    %3 = affine.apply #map22(%arg5, %arg9)[%0]
                    call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                  }
                }
              }
            }
            affine.if #set6(%arg4, %arg5, %arg6)[%0] {
              affine.if #set5()[%0] {
                affine.for %arg8 = max #map23(%arg5, %arg6, %arg4)[%0] to min #map24(%arg5, %arg4, %arg6)[%0] {
                  affine.for %arg9 = max #map20(%arg7, %arg6)[%0] to min #map21(%arg6, %arg7) {
                    %1 = affine.apply #map22(%arg6, %arg8)[%0]
                    %2 = affine.apply #map4()[%0]
                    %3 = affine.apply #map22(%arg6, %arg9)[%0]
                    call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                  }
                }
              }
            }
            affine.if #set7(%arg4, %arg5, %arg7, %arg6)[%0] {
              affine.if #set5()[%0] {
                affine.for %arg8 = max #map23(%arg5, %arg7, %arg4)[%0] to min #map24(%arg5, %arg4, %arg7)[%0] {
                  affine.for %arg9 = max #map20(%arg6, %arg7)[%0] to #map25(%arg6) {
                    %1 = affine.apply #map22(%arg7, %arg8)[%0]
                    %2 = affine.apply #map22(%arg7, %arg9)[%0]
            ...
            affine.if #set8(%arg4, %arg5, %arg6, %arg7)[%0] {
              affine.for %arg8 = max #map26(%arg6) to min #map27(%arg6)[%0] {
                affine.for %arg9 = max #map26(%arg7) to min #map27(%arg7)[%0] {
                  %1 = affine.apply #map28(%arg8)
                  %2 = affine.apply #map28(%arg9)
            ...
            affine.for %arg8 = max #map29(%arg5, %arg6, %arg7, %arg4)[%0] to min #map30(%arg4, %arg5, %arg6, %arg7)[%0] {
              ...
              affine.for %arg9 = max #map36(%arg5, %arg8, %arg4) to min #map37(%arg4, %arg8, %arg5)[%0] {
                ...
                affine.for %arg10 = max #map38(%arg6, %arg8) to min #map32(%arg6, %arg8)[%0] {
                  ...
                  affine.for %arg11 = max #map38(%arg7, %arg8) to min #map32(%arg7, %arg8)[%0] {
                    ...
                    call @S0(%arg3, %4, %5, %6, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                  }
                  affine.if #set11(%arg7, %arg8)[%0] {
                    %1 = affine.apply #map39(%arg8, %arg9)
                    %2 = affine.apply #map39(%arg8, %arg10)
                    %3 = affine.apply #map4()[%0]
                    call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              ...
              affine.if #set12(%arg4, %arg8, %arg5)[%0] {
            ...
            affine.if #set14(%arg4, %arg5, %arg6, %arg7)[%0] {
              affine.for %arg8 = max #map46(%arg5, %arg4) to min #map47(%arg4, %arg5)[%0] {
                affine.for %arg9 = #map17(%arg7) to min #map11(%arg7)[%0] {
                  %1 = affine.apply #map12(%arg8)
                  %2 = affine.apply #map12(%arg9)
                  call @S0(%arg3, %1, %c1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
            }
            affine.if #set15(%arg4, %arg5, %arg7)[%0] {
              affine.for %arg8 = max #map46(%arg5, %arg4) to min #map47(%arg4, %arg5)[%0] {
            ...
            affine.if #set16(%arg4, %arg5, %arg6, %arg7) {
              affine.for %arg8 = #map17(%arg6) to min #map11(%arg6)[%0] {
                affine.for %arg9 = #map17(%arg7) to min #map11(%arg7)[%0] {
                  %1 = affine.apply #map12(%arg8)
                  %2 = affine.apply #map12(%arg9)
                  call @S0(%arg3, %c1, %1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
          ...
          affine.if #set17(%arg4, %arg5, %arg6) {
            affine.if #set2()[%0] {
              affine.for %arg7 = #map17(%arg6) to #map25(%arg6) {
                %1 = affine.apply #map12(%arg7)
                %2 = affine.apply #map4()[%0]
                call @S0(%arg3, %c1, %1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              }
          ...
          affine.if #set18(%arg4, %arg5, %arg6) {
            affine.if #set2()[%0] {
              affine.for %arg7 = max #map46(%arg5, %arg4) to min #map16(%arg4, %arg5) {
                %1 = affine.apply #map12(%arg7)
                %2 = affine.apply #map4()[%0]
                call @S0(%arg3, %1, %c1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              }
          ...
          affine.if #set19(%arg4, %arg5, %arg6) {
            affine.if #set20(%arg4, %arg5)[%0] {
              affine.for %arg7 = max #map48(%arg6, %arg4, %arg5) to #map25(%arg6) {
                %1 = affine.apply #map49(%arg4, %arg5)
                %2 = affine.apply #map50(%arg4, %arg5, %arg7)
                %3 = affine.apply #map4()[%0]
                call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              }
            }
          ...
          affine.if #set21(%arg4, %arg5, %arg6) {
            affine.if #set22()[%0] {
              affine.for %arg7 = max #map51(%arg5, %arg4) to min #map52(%arg4, %arg5) {
                affine.for %arg8 = max #map53(%arg6) to #map25(%arg6) {
                  %1 = affine.apply #map54(%arg7)
                  %2 = affine.apply #map54(%arg8)
                  %3 = affine.apply #map4()[%0]
                  call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
        ...
        affine.if #set24(%arg4, %arg5) {
          affine.if #set20(%arg4, %arg5)[%0] {
            affine.for %arg6 = #map55(%arg4, %arg5) to #map56(%arg4, %arg5)[%0] {
              affine.for %arg7 = max #map48(%arg6, %arg4, %arg5) to min #map57(%arg6, %arg4, %arg5)[%0] {
                %1 = affine.apply #map49(%arg4, %arg5)
                %2 = affine.apply #map4()[%0]
                %3 = affine.apply #map50(%arg4, %arg5, %arg7)
                call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              }
            }
          }
        ...
        affine.if #set25(%arg4, %arg5) {
          affine.if #set22()[%0] {
            affine.for %arg6 = 1 to #map58()[%0] {
              affine.for %arg7 = max #map51(%arg5, %arg4) to min #map52(%arg4, %arg5) {
                affine.for %arg8 = max #map53(%arg6) to min #map59(%arg6)[%0] {
                  %1 = affine.apply #map54(%arg7)
                  %2 = affine.apply #map4()[%0]
                  %3 = affine.apply #map54(%arg8)
                  call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
            }
      ...
      affine.if #set26(%arg4)[%0] {
        affine.if #set22()[%0] {
          affine.for %arg5 = 1 to #map58()[%0] {
            affine.for %arg6 = 1 to #map58()[%0] {
              affine.for %arg7 = max #map53(%arg5) to min #map59(%arg5)[%0] {
                affine.for %arg8 = max #map53(%arg6) to min #map59(%arg6)[%0] {
                  %1 = affine.apply #map4()[%0]
                  %2 = affine.apply #map54(%arg7)
                  %3 = affine.apply #map54(%arg8)
                  call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
