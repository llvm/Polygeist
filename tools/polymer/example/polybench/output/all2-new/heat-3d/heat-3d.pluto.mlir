      ...
      affine.for %arg5 = 0 to #map1()[%0] {
        affine.for %arg6 = 0 to #map1()[%0] {
          affine.for %arg7 = 0 to #map1()[%0] {
            affine.for %arg8 = max #map2(%arg5) to min #map3(%arg5)[%0] {
              affine.for %arg9 = max #map2(%arg6) to min #map3(%arg6)[%0] {
                affine.for %arg10 = max #map2(%arg7) to min #map3(%arg7)[%0] {
                  call @S0(%arg3, %arg8, %arg9, %arg10, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
            }
          }
        ...
        affine.for %arg6 = 0 to #map1()[%0] {
          affine.for %arg7 = 0 to #map1()[%0] {
            affine.for %arg8 = max #map2(%arg5) to min #map3(%arg5)[%0] {
              affine.for %arg9 = max #map2(%arg6) to min #map3(%arg6)[%0] {
                affine.for %arg10 = max #map2(%arg7) to min #map3(%arg7)[%0] {
                  call @S1(%arg2, %arg8, %arg9, %arg10, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
            }
          }
