...
#map4 = affine_map<(d0) -> ((d0 - 31) ceildiv 32)>
#map5 = affine_map<(d0) -> ((d0 - 1) floordiv 32 + 1)>
#map6 = affine_map<(d0, d1) -> (d0, d1 * 32)>
#map7 = affine_map<(d0) -> (d0 * 32)>
#map8 = affine_map<(d0, d1) -> (d0, d1 * 32 + 32)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_lu_new(%arg0: i32, %arg1: memref<40x40xf64>) {
    ...
    affine.for %arg2 = 0 to #map1()[%0] {
      affine.for %arg3 = max #map2(%arg2) to min #map3(%arg2)[%0] {
        call @S2(%arg1, %c1, %arg3, %c0) : (memref<40x40xf64>, index, index, index) -> ()
      }
    }
    affine.for %arg2 = 2 to %0 {
      ...
      affine.for %arg3 = #map4(%arg2) to #map1()[%0] {
        affine.for %arg4 = 0 to #map5(%arg2) {
          affine.for %arg5 = max #map6(%arg2, %arg3) to min #map3(%arg3)[%0] {
            affine.for %arg6 = #map7(%arg4) to min #map8(%arg2, %arg4) {
              call @S2(%arg1, %arg2, %arg5, %arg6) : (memref<40x40xf64>, index, index, index) -> ()
            }
          }
        }
      }
