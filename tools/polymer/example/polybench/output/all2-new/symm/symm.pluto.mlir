...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<20x30xf64>, %arg5: memref<20x20xf64>, %arg6: memref<20x30xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_symm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<20x30xf64>, %arg5: memref<20x20xf64>, %arg6: memref<20x30xf64>) {
    %0 = alloca() : memref<1xf64>
    ...
    affine.for %arg7 = 0 to %3 {
      affine.for %arg8 = 0 to %1 {
        ...
        affine.for %arg9 = 0 to #map(%arg7) {
          ...
          call @S2(%2, %0, %arg6, %arg9, %arg8) : (memref<1xf64>, memref<1xf64>, memref<20x30xf64>, index, index) -> ()
        }
        call @S3(%arg4, %arg7, %arg8, %arg2, %2, %arg5, %arg6, %arg3) : (memref<20x30xf64>, index, index, f64, memref<1xf64>, memref<20x20xf64>, memref<20x30xf64>, f64) -> ()
      }
    }
    return
  }
  func private @print_array(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>) {
    %c0_i32 = constant 0 : i32
    %c20_i32 = constant 20 : i32
    %c1_i32 = constant 1 : i32
  ...
  func private @S1(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: memref<20x20xf64>, %arg4: index, %arg5: f64, %arg6: memref<20x30xf64>, %arg7: memref<1xf64>) attributes {scop.stmt} {
  ...
  func private @S2(%arg0: memref<1xf64>, %arg1: memref<1xf64>, %arg2: memref<20x30xf64>, %arg3: index, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg2[%arg3, %arg4] : memref<20x30xf64>
  ...
  func private @kernel_symm_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<20x30xf64>, %arg5: memref<20x20xf64>, %arg6: memref<20x30xf64>) {
    ...
    affine.for %arg7 = 0 to %3 {
      ...
      call @S3(%arg4, %c0, %arg7, %arg2, %1, %arg5, %arg6, %arg3) : (memref<20x30xf64>, index, index, f64, memref<1xf64>, memref<20x20xf64>, memref<20x30xf64>, f64) -> ()
    }
