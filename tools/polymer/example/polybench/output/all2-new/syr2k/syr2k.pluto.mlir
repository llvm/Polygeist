...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c30_i32, %c20_i32, %5, %6, %2, %3, %4) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<30x30xf64>, memref<30x20xf64>, memref<30x20xf64>) -> ()
    %7 = load %0[%c0] : memref<1xf64>
    %8 = load %1[%c0] : memref<1xf64>
    call @kernel_syr2k_new(%c30_i32, %c20_i32, %7, %8, %2, %3, %4) : (i32, i32, f64, f64, memref<30x30xf64>, memref<30x20xf64>, memref<30x20xf64>) -> ()
    call @print_array(%c30_i32, %2) : (i32, memref<30x30xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<30x30xf64>, %arg5: memref<30x20xf64>, %arg6: memref<30x20xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_syr2k(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<30x30xf64>, %arg5: memref<30x20xf64>, %arg6: memref<30x20xf64>) {
  ...
  func private @kernel_syr2k_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<30x30xf64>, %arg5: memref<30x20xf64>, %arg6: memref<30x20xf64>) {
    ...
    affine.for %arg7 = 0 to #map1()[%0] {
      affine.for %arg8 = 0 to min #map2(%arg7)[%1] {
        affine.for %arg9 = #map3(%arg7) to min #map4(%arg7)[%0] {
          affine.for %arg10 = #map3(%arg8) to min #map5(%arg8, %arg9) {
            call @S0(%arg4, %arg9, %arg10, %arg3) : (memref<30x30xf64>, index, index, f64) -> ()
          }
          affine.for %arg10 = #map3(%arg8) to min #map4(%arg8)[%1] {
            affine.for %arg11 = 0 to min #map6(%arg9) {
              call @S1(%arg4, %arg9, %arg11, %arg5, %arg10, %arg2, %arg6) : (memref<30x30xf64>, index, index, memref<30x20xf64>, index, f64, memref<30x20xf64>) -> ()
            }
          }
        }
        affine.for %arg9 = 1 to #map0(%arg7) {
          affine.for %arg10 = #map3(%arg7) to min #map4(%arg7)[%0] {
            affine.for %arg11 = #map3(%arg8) to min #map4(%arg8)[%1] {
              affine.for %arg12 = #map3(%arg9) to min #map5(%arg9, %arg10) {
                call @S1(%arg4, %arg10, %arg12, %arg5, %arg11, %arg2, %arg6) : (memref<30x30xf64>, index, index, memref<30x20xf64>, index, f64, memref<30x20xf64>) -> ()
              }
            }
          }
        }
      }
      affine.for %arg8 = #map7()[%1] to #map0(%arg7) {
        affine.for %arg9 = #map3(%arg7) to min #map4(%arg7)[%0] {
          affine.for %arg10 = #map3(%arg8) to min #map5(%arg8, %arg9) {
            call @S0(%arg4, %arg9, %arg10, %arg3) : (memref<30x30xf64>, index, index, f64) -> ()
          }
      ...
      affine.for %arg8 = #map0(%arg7) to #map1()[%1] {
        affine.for %arg9 = 0 to #map0(%arg7) {
          affine.for %arg10 = #map3(%arg7) to min #map4(%arg7)[%0] {
            affine.for %arg11 = #map3(%arg8) to min #map4(%arg8)[%1] {
              affine.for %arg12 = #map3(%arg9) to min #map5(%arg9, %arg10) {
