...
#map5 = affine_map<(d0, d1) -> (d0 + 1, d1 * 32 + 32)>
#map6 = affine_map<(d0) -> (32, d0 + 1)>
#map7 = affine_map<()[s0] -> (s0 ceildiv 32)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_syrk_new(%c30_i32, %c20_i32, %6, %7, %2, %3) : (i32, i32, f64, f64, memref<30x30xf64>, memref<30x20xf64>) -> ()
    call @print_array(%c30_i32, %2) : (i32, memref<30x30xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<30x30xf64>, %arg5: memref<30x20xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_syrk(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<30x30xf64>, %arg5: memref<30x20xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to %0 {
      affine.for %arg7 = 0 to #map0(%arg6) {
        call @S0(%arg4, %arg6, %arg7, %arg3) : (memref<30x30xf64>, index, index, f64) -> ()
      }
      affine.for %arg7 = 0 to %1 {
        affine.for %arg8 = 0 to #map0(%arg6) {
          call @S1(%arg4, %arg6, %arg8, %arg5, %arg7, %arg2) : (memref<30x30xf64>, index, index, memref<30x20xf64>, index, f64) -> ()
        }
      }
    }
    return
  ...
  func private @S1(%arg0: memref<30x30xf64>, %arg1: index, %arg2: index, %arg3: memref<30x20xf64>, %arg4: index, %arg5: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<30x30xf64>
    %1 = affine.load %arg3[%arg1, %arg4] : memref<30x20xf64>
    %2 = mulf %arg5, %1 : f64
    %3 = affine.load %arg3[%arg2, %arg4] : memref<30x20xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
    affine.store %5, %arg0[%arg1, %arg2] : memref<30x30xf64>
    return
  }
  func private @kernel_syrk_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<30x30xf64>, %arg5: memref<30x20xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to #map1()[%0] {
      affine.for %arg7 = 0 to min #map2(%arg6)[%1] {
        affine.for %arg8 = #map3(%arg6) to min #map4(%arg6)[%0] {
          affine.for %arg9 = #map3(%arg7) to min #map5(%arg7, %arg8) {
            call @S0(%arg4, %arg8, %arg9, %arg3) : (memref<30x30xf64>, index, index, f64) -> ()
          }
          affine.for %arg9 = #map3(%arg7) to min #map4(%arg7)[%1] {
            affine.for %arg10 = 0 to min #map6(%arg8) {
              call @S1(%arg4, %arg8, %arg10, %arg5, %arg9, %arg2) : (memref<30x30xf64>, index, index, memref<30x20xf64>, index, f64) -> ()
            }
          }
        }
        affine.for %arg8 = 1 to #map0(%arg6) {
          affine.for %arg9 = #map3(%arg6) to min #map4(%arg6)[%0] {
            affine.for %arg10 = #map3(%arg7) to min #map4(%arg7)[%1] {
              affine.for %arg11 = #map3(%arg8) to min #map5(%arg8, %arg9) {
                call @S1(%arg4, %arg9, %arg11, %arg5, %arg10, %arg2) : (memref<30x30xf64>, index, index, memref<30x20xf64>, index, f64) -> ()
              }
            }
          }
        }
      }
      affine.for %arg7 = #map7()[%1] to #map0(%arg6) {
        affine.for %arg8 = #map3(%arg6) to min #map4(%arg6)[%0] {
          affine.for %arg9 = #map3(%arg7) to min #map5(%arg7, %arg8) {
            call @S0(%arg4, %arg8, %arg9, %arg3) : (memref<30x30xf64>, index, index, f64) -> ()
          }
