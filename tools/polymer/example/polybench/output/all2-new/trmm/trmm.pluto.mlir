...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c20_i32, %c30_i32, %3, %1, %2) : (i32, i32, memref<?xf64>, memref<20x20xf64>, memref<20x30xf64>) -> ()
    %4 = load %0[%c0] : memref<1xf64>
    call @kernel_trmm_new(%c20_i32, %c30_i32, %4, %1, %2) : (i32, i32, f64, memref<20x20xf64>, memref<20x30xf64>) -> ()
    call @print_array(%c20_i32, %c30_i32, %2) : (i32, i32, memref<20x30xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<20x20xf64>, %arg4: memref<20x30xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_trmm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<20x20xf64>, %arg4: memref<20x30xf64>) {
  ...
  func private @kernel_trmm_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<20x20xf64>, %arg4: memref<20x30xf64>) {
    ...
    affine.for %arg5 = 0 to #map1()[%0] {
      affine.for %arg6 = 0 to #map2()[%1] {
        affine.for %arg7 = #map3(%arg5) to min #map4(%arg5)[%0] {
          affine.for %arg8 = #map3(%arg6) to min #map5(%arg6)[%1] {
            affine.for %arg9 = #map0(%arg7) to %0 {
              call @S0(%arg4, %arg7, %arg8, %arg9, %arg3) : (memref<20x30xf64>, index, index, index, memref<20x20xf64>) -> ()
            }
            call @S1(%arg4, %arg7, %arg8, %arg2) : (memref<20x30xf64>, index, index, f64) -> ()
          }
        }
        affine.if #set0(%arg5)[%0] {
          affine.for %arg7 = #map3(%arg6) to min #map5(%arg6)[%1] {
            %2 = affine.apply #map6()[%0]
            call @S1(%arg4, %2, %arg7, %arg2) : (memref<20x30xf64>, index, index, f64) -> ()
          }
        }
      }
    }
    affine.if #set1()[%0] {
      affine.for %arg5 = 0 to #map2()[%1] {
        affine.for %arg6 = #map3(%arg5) to min #map5(%arg5)[%1] {
          %2 = affine.apply #map6()[%0]
          call @S1(%arg4, %2, %arg6, %arg2) : (memref<20x30xf64>, index, index, f64) -> ()
        }
      }
    }
    return
