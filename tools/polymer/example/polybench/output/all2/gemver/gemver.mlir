module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c40_i32, %11, %12, %2, %3, %4, %5, %6, %7, %8, %9, %10) : (i32, memref<?xf64>, memref<?xf64>, memref<40x40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>) -> ()
    %13 = load %0[%c0] : memref<1xf64>
    %14 = load %1[%c0] : memref<1xf64>
    call @kernel_gemver(%c40_i32, %13, %14, %2, %3, %4, %5, %6, %7, %8, %9, %10) : (i32, f64, f64, memref<40x40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>, memref<40xf64>) -> ()
    call @print_array(%c40_i32, %7) : (i32, memref<40xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<40x40xf64>, %arg4: memref<40xf64>, %arg5: memref<40xf64>, %arg6: memref<40xf64>, %arg7: memref<40xf64>, %arg8: memref<40xf64>, %arg9: memref<40xf64>, %arg10: memref<40xf64>, %arg11: memref<40xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_gemver(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<40x40xf64>, %arg4: memref<40xf64>, %arg5: memref<40xf64>, %arg6: memref<40xf64>, %arg7: memref<40xf64>, %arg8: memref<40xf64>, %arg9: memref<40xf64>, %arg10: memref<40xf64>, %arg11: memref<40xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %0 {
        %1 = affine.load %arg3[%arg12, %arg13] : memref<40x40xf64>
        %2 = affine.load %arg4[%arg12] : memref<40xf64>
        %3 = affine.load %arg5[%arg13] : memref<40xf64>
        %4 = mulf %2, %3 : f64
        %5 = addf %1, %4 : f64
        %6 = affine.load %arg6[%arg12] : memref<40xf64>
        %7 = affine.load %arg7[%arg13] : memref<40xf64>
        %8 = mulf %6, %7 : f64
        %9 = addf %5, %8 : f64
        affine.store %9, %arg3[%arg12, %arg13] : memref<40x40xf64>
      }
    }
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %0 {
        %1 = affine.load %arg9[%arg12] : memref<40xf64>
        %2 = affine.load %arg3[%arg13, %arg12] : memref<40x40xf64>
        %3 = mulf %arg2, %2 : f64
        %4 = affine.load %arg10[%arg13] : memref<40xf64>
        %5 = mulf %3, %4 : f64
        %6 = addf %1, %5 : f64
        affine.store %6, %arg9[%arg12] : memref<40xf64>
      }
    }
    affine.for %arg12 = 0 to %0 {
      %1 = affine.load %arg9[%arg12] : memref<40xf64>
      %2 = affine.load %arg11[%arg12] : memref<40xf64>
      %3 = addf %1, %2 : f64
      affine.store %3, %arg9[%arg12] : memref<40xf64>
    }
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %0 {
        %1 = affine.load %arg8[%arg12] : memref<40xf64>
        %2 = affine.load %arg3[%arg12, %arg13] : memref<40x40xf64>
        %3 = mulf %arg1, %2 : f64
        %4 = affine.load %arg9[%arg13] : memref<40xf64>
        %5 = mulf %3, %4 : f64
        %6 = addf %1, %5 : f64
        affine.store %6, %arg8[%arg12] : memref<40xf64>
      }
    }
    return
  }
