...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %1 = alloc() : memref<2000x2000xf64>
    %2 = alloc() : memref<2000x2000xf64>
    %3 = alloc() : memref<2000x2000xf64>
    call @init_array(%c2000_i32, %0) : (i32, memref<2000x2000xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_adi_new(%c1000_i32, %c2000_i32, %0, %1, %2, %3) : (i32, i32, memref<2000x2000xf64>, memref<2000x2000xf64>, memref<2000x2000xf64>, memref<2000x2000xf64>) -> ()
  ...
  func private @init_array(%arg0: i32, %arg1: memref<2000x2000xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    %10 = divf %8, %9 : f64
    store %10, %arg1[%2, %5] : memref<2000x2000xf64>
  ...
  func private @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<2000x2000xf64>, %arg3: memref<2000x2000xf64>, %arg4: memref<2000x2000xf64>, %arg5: memref<2000x2000xf64>) {
    ...
    call @S0(%11, %arg1, %arg0, %7, %6, %5) : (memref<1xf64>, i32, i32, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
    call @S1(%8, %7) : (memref<1xf64>, memref<1xf64>) -> ()
    call @S2(%10, %6, %5, %4) : (memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
    call @S3(%9, %4) : (memref<1xf64>, memref<1xf64>) -> ()
    %13 = index_cast %arg0 : i32 to index
    affine.for %arg6 = 1 to #map0()[%13] {
      affine.for %arg7 = 1 to #map1()[%12] {
        call @S4(%arg3, %arg7) : (memref<2000x2000xf64>, index) -> ()
        call @S5(%arg4, %arg7) : (memref<2000x2000xf64>, index) -> ()
        call @S6(%arg5, %arg7) : (memref<2000x2000xf64>, index) -> ()
        affine.for %arg8 = 1 to #map1()[%12] {
          call @S7(%arg4, %arg7, %arg8, %8, %11, %3, %2) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
          call @S8(%arg5, %arg7, %arg8, %3, %arg4, %2, %arg2, %10) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>) -> ()
        }
        call @S9(%arg3, %arg7, %12) : (memref<2000x2000xf64>, index, index) -> ()
        affine.for %arg8 = 1 to #map1()[%12] {
          call @S10(%arg3, %arg8, %arg7, %12, %arg5, %arg4) : (memref<2000x2000xf64>, index, index, index, memref<2000x2000xf64>, memref<2000x2000xf64>) -> ()
        }
      }
      affine.for %arg7 = 1 to #map1()[%12] {
        call @S11(%arg2, %arg7) : (memref<2000x2000xf64>, index) -> ()
        call @S12(%arg4, %arg7) : (memref<2000x2000xf64>, index) -> ()
        call @S13(%arg5, %arg7) : (memref<2000x2000xf64>, index) -> ()
        affine.for %arg8 = 1 to #map1()[%12] {
          call @S14(%arg4, %arg7, %arg8, %9, %10, %1, %0) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
          call @S15(%arg5, %arg7, %arg8, %1, %arg4, %0, %arg3, %11) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>) -> ()
        }
        call @S16(%arg2, %arg7, %12) : (memref<2000x2000xf64>, index, index) -> ()
        affine.for %arg8 = 1 to #map1()[%12] {
          call @S17(%arg2, %arg7, %arg8, %12, %arg5, %arg4) : (memref<2000x2000xf64>, index, index, index, memref<2000x2000xf64>, memref<2000x2000xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @S4(%arg0: memref<2000x2000xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    affine.store %cst, %arg0[0, %arg1] : memref<2000x2000xf64>
    return
  }
  func private @S5(%arg0: memref<2000x2000xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, 0] : memref<2000x2000xf64>
    return
  }
  func private @S6(%arg0: memref<2000x2000xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, 0] : memref<2000x2000xf64>
    return
  }
  func private @S7(%arg0: memref<2000x2000xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>, %arg4: memref<1xf64>, %arg5: memref<1xf64>, %arg6: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[0] : memref<1xf64>
    affine.store %0, %arg6[0] : memref<1xf64>
    %1 = negf %0 : f64
    %2 = affine.load %arg0[%arg1, %arg2 - 1] : memref<2000x2000xf64>
    %3 = mulf %0, %2 : f64
    %4 = affine.load %arg3[0] : memref<1xf64>
    affine.store %4, %arg5[0] : memref<1xf64>
    %5 = addf %3, %4 : f64
    %6 = divf %1, %5 : f64
    affine.store %6, %arg0[%arg1, %arg2] : memref<2000x2000xf64>
    return
  }
  func private @S8(%arg0: memref<2000x2000xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>, %arg4: memref<2000x2000xf64>, %arg5: memref<1xf64>, %arg6: memref<2000x2000xf64>, %arg7: memref<1xf64>) attributes {scop.stmt} {
    %cst = constant 2.000000e+00 : f64
    %cst_0 = constant 1.000000e+00 : f64
    %0 = affine.load %arg6[%arg2, %arg1 - 1] : memref<2000x2000xf64>
    %1 = affine.load %arg6[%arg2, %arg1] : memref<2000x2000xf64>
    ...
    %7 = mulf %6, %0 : f64
    %8 = addf %7, %5 : f64
    %9 = affine.load %arg6[%arg2, %arg1 + 1] : memref<2000x2000xf64>
    %10 = mulf %2, %9 : f64
    %11 = subf %8, %10 : f64
    %12 = affine.load %arg0[%arg1, %arg2 - 1] : memref<2000x2000xf64>
    %13 = affine.load %arg5[0] : memref<1xf64>
    %14 = mulf %13, %12 : f64
    %15 = subf %11, %14 : f64
    %16 = affine.load %arg4[%arg1, %arg2 - 1] : memref<2000x2000xf64>
    %17 = mulf %13, %16 : f64
    %18 = affine.load %arg3[0] : memref<1xf64>
    %19 = addf %17, %18 : f64
    %20 = divf %15, %19 : f64
    affine.store %20, %arg0[%arg1, %arg2] : memref<2000x2000xf64>
    return
  }
  func private @S9(%arg0: memref<2000x2000xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    affine.store %cst, %arg0[symbol(%arg2) - 1, %arg1] : memref<2000x2000xf64>
    return
  }
  func private @S10(%arg0: memref<2000x2000xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<2000x2000xf64>, %arg5: memref<2000x2000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg5[%arg2, -%arg1 + symbol(%arg3) - 1] : memref<2000x2000xf64>
    %1 = affine.load %arg0[-%arg1 + symbol(%arg3), %arg2] : memref<2000x2000xf64>
    %2 = mulf %0, %1 : f64
    %3 = affine.load %arg4[%arg2, -%arg1 + symbol(%arg3) - 1] : memref<2000x2000xf64>
    %4 = addf %2, %3 : f64
    affine.store %4, %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<2000x2000xf64>
    return
  }
  func private @S11(%arg0: memref<2000x2000xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, 0] : memref<2000x2000xf64>
    return
  }
  func private @S12(%arg0: memref<2000x2000xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, 0] : memref<2000x2000xf64>
    return
  }
  func private @S13(%arg0: memref<2000x2000xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, 0] : memref<2000x2000xf64>
    return
  }
  func private @S14(%arg0: memref<2000x2000xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>, %arg4: memref<1xf64>, %arg5: memref<1xf64>, %arg6: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[0] : memref<1xf64>
    affine.store %0, %arg6[0] : memref<1xf64>
    %1 = negf %0 : f64
    %2 = affine.load %arg0[%arg1, %arg2 - 1] : memref<2000x2000xf64>
  ...
  func private @S15(%arg0: memref<2000x2000xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>, %arg4: memref<2000x2000xf64>, %arg5: memref<1xf64>, %arg6: memref<2000x2000xf64>, %arg7: memref<1xf64>) attributes {scop.stmt} {
    %cst = constant 2.000000e+00 : f64
    %cst_0 = constant 1.000000e+00 : f64
    %0 = affine.load %arg6[%arg1 - 1, %arg2] : memref<2000x2000xf64>
    %1 = affine.load %arg6[%arg1, %arg2] : memref<2000x2000xf64>
    %2 = affine.load %arg7[0] : memref<1xf64>
    %3 = mulf %cst, %2 : f64
    %4 = addf %cst_0, %3 : f64
    %5 = mulf %4, %1 : f64
    ...
    %7 = mulf %6, %0 : f64
    %8 = addf %7, %5 : f64
    %9 = affine.load %arg6[%arg1 + 1, %arg2] : memref<2000x2000xf64>
    %10 = mulf %2, %9 : f64
    %11 = subf %8, %10 : f64
    %12 = affine.load %arg0[%arg1, %arg2 - 1] : memref<2000x2000xf64>
    %13 = affine.load %arg5[0] : memref<1xf64>
  ...
  func private @S16(%arg0: memref<2000x2000xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, symbol(%arg2) - 1] : memref<2000x2000xf64>
    return
  }
  func private @S17(%arg0: memref<2000x2000xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<2000x2000xf64>, %arg5: memref<2000x2000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg5[%arg1, -%arg2 + symbol(%arg3) - 1] : memref<2000x2000xf64>
    %1 = affine.load %arg0[%arg1, -%arg2 + symbol(%arg3)] : memref<2000x2000xf64>
    %2 = mulf %0, %1 : f64
    %3 = affine.load %arg4[%arg1, -%arg2 + symbol(%arg3) - 1] : memref<2000x2000xf64>
    %4 = addf %2, %3 : f64
    affine.store %4, %arg0[%arg1, -%arg2 + symbol(%arg3) - 1] : memref<2000x2000xf64>
    return
  }
  func private @kernel_adi_new(%arg0: i32, %arg1: i32, %arg2: memref<2000x2000xf64>, %arg3: memref<2000x2000xf64>, %arg4: memref<2000x2000xf64>, %arg5: memref<2000x2000xf64>) {
    %0 = alloca() : memref<1xf64>
    %1 = alloca() : memref<1xf64>
    %2 = alloca() : memref<1xf64>
    %3 = alloca() : memref<1xf64>
    ...
    affine.for %arg6 = 1 to #map0()[%12] {
      affine.for %arg7 = 0 to #map2()[%13] {
        affine.for %arg8 = max #map3(%arg7) to min #map4(%arg7)[%13] {
          call @S9(%arg3, %arg8, %13) : (memref<2000x2000xf64>, index, index) -> ()
          call @S6(%arg5, %arg8) : (memref<2000x2000xf64>, index) -> ()
          call @S5(%arg4, %arg8) : (memref<2000x2000xf64>, index) -> ()
        }
      }
      affine.for %arg7 = 1 to #map1()[%13] {
        affine.for %arg8 = 1 to #map1()[%13] {
          call @S7(%arg4, %arg7, %arg8, %3, %4, %10, %11) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
          call @S8(%arg5, %arg7, %arg8, %10, %arg4, %11, %arg2, %1) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>) -> ()
        }
      }
      affine.for %arg7 = 0 to #map2()[%13] {
        affine.for %arg8 = max #map3(%arg7) to min #map4(%arg7)[%13] {
          call @S16(%arg2, %arg8, %13) : (memref<2000x2000xf64>, index, index) -> ()
          call @S13(%arg5, %arg8) : (memref<2000x2000xf64>, index) -> ()
          call @S12(%arg4, %arg8) : (memref<2000x2000xf64>, index) -> ()
          call @S11(%arg2, %arg8) : (memref<2000x2000xf64>, index) -> ()
        }
      }
      affine.for %arg7 = 0 to #map2()[%13] {
        affine.for %arg8 = 0 to #map2()[%13] {
          affine.for %arg9 = max #map3(%arg7) to min #map4(%arg7)[%13] {
            affine.for %arg10 = max #map3(%arg8) to min #map4(%arg8)[%13] {
              call @S10(%arg3, %arg10, %arg9, %13, %arg5, %arg4) : (memref<2000x2000xf64>, index, index, index, memref<2000x2000xf64>, memref<2000x2000xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg7 = 0 to #map2()[%13] {
        affine.for %arg8 = max #map3(%arg7) to min #map4(%arg7)[%13] {
          call @S4(%arg3, %arg8) : (memref<2000x2000xf64>, index) -> ()
        }
      }
      affine.for %arg7 = 1 to #map1()[%13] {
        affine.for %arg8 = 1 to #map1()[%13] {
          call @S14(%arg4, %arg7, %arg8, %0, %1, %8, %9) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
          call @S15(%arg5, %arg7, %arg8, %8, %arg4, %9, %arg3, %4) : (memref<2000x2000xf64>, index, index, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>, memref<2000x2000xf64>, memref<1xf64>) -> ()
        }
        affine.for %arg8 = 1 to #map1()[%13] {
          call @S17(%arg2, %arg7, %arg8, %13, %arg5, %arg4) : (memref<2000x2000xf64>, index, index, index, memref<2000x2000xf64>, memref<2000x2000xf64>) -> ()
        }
      }
    }
    return
