...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %0 = alloc() : memref<1800x2200xf64>
    %1 = alloc() : memref<2200xf64>
    %2 = alloc() : memref<2200xf64>
    %3 = alloc() : memref<1800xf64>
    call @init_array(%c1800_i32, %c2200_i32, %0, %1) : (i32, i32, memref<1800x2200xf64>, memref<2200xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_atax_new(%c1800_i32, %c2200_i32, %0, %1, %2, %3) : (i32, i32, memref<1800x2200xf64>, memref<2200xf64>, memref<2200xf64>, memref<1800xf64>) -> ()
    ...
    scf.if %5 {
      call @print_array(%c2200_i32, %2) : (i32, memref<2200xf64>) -> ()
    }
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<1800x2200xf64>, %arg3: memref<2200xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    %6 = divf %5, %0 : f64
    %7 = addf %4, %6 : f64
    store %7, %arg3[%3] : memref<2200xf64>
    %8 = addi %1, %c1_i32 : i32
    br ^bb1(%8 : i32)
  ...
  ^bb6:  // pred: ^bb5
    ...
    %20 = divf %17, %19 : f64
    store %20, %arg2[%11, %14] : memref<1800x2200xf64>
  ...
  func private @kernel_atax(%arg0: i32, %arg1: i32, %arg2: memref<1800x2200xf64>, %arg3: memref<2200xf64>, %arg4: memref<2200xf64>, %arg5: memref<1800xf64>) {
    %0 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to %0 {
      call @S0(%arg4, %arg6) : (memref<2200xf64>, index) -> ()
    }
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg6 = 0 to %1 {
      call @S1(%arg5, %arg6) : (memref<1800xf64>, index) -> ()
      affine.for %arg7 = 0 to %0 {
        call @S2(%arg5, %arg6, %arg3, %arg7, %arg2) : (memref<1800xf64>, index, memref<2200xf64>, index, memref<1800x2200xf64>) -> ()
      }
      affine.for %arg7 = 0 to %0 {
        call @S3(%arg4, %arg7, %arg5, %arg6, %arg2) : (memref<2200xf64>, index, memref<1800xf64>, index, memref<1800x2200xf64>) -> ()
      }
    }
    return
  }
  ...
  func private @print_array(%arg0: i32, %arg1: memref<2200xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    %22 = load %arg1[%15] : memref<2200xf64>
  ...
  func private @S0(%arg0: memref<2200xf64>, %arg1: index) attributes {scop.stmt} {
    %c0_i32 = constant 0 : i32
    %0 = sitofp %c0_i32 : i32 to f64
    affine.store %0, %arg0[%arg1] : memref<2200xf64>
    return
  }
  func private @S1(%arg0: memref<1800xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1] : memref<1800xf64>
    return
  }
  func private @S2(%arg0: memref<1800xf64>, %arg1: index, %arg2: memref<2200xf64>, %arg3: index, %arg4: memref<1800x2200xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<1800xf64>
    %1 = affine.load %arg4[%arg1, %arg3] : memref<1800x2200xf64>
    %2 = affine.load %arg2[%arg3] : memref<2200xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1] : memref<1800xf64>
    return
  }
  func private @S3(%arg0: memref<2200xf64>, %arg1: index, %arg2: memref<1800xf64>, %arg3: index, %arg4: memref<1800x2200xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<2200xf64>
    %1 = affine.load %arg4[%arg3, %arg1] : memref<1800x2200xf64>
  ...
  func private @kernel_atax_new(%arg0: i32, %arg1: i32, %arg2: memref<1800x2200xf64>, %arg3: memref<2200xf64>, %arg4: memref<2200xf64>, %arg5: memref<1800xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to #map0()[%0] {
      affine.for %arg7 = #map1(%arg6) to min #map2(%arg6)[%0] {
        call @S1(%arg5, %arg7) : (memref<1800xf64>, index) -> ()
      }
    }
    affine.for %arg6 = 0 to #map0()[%0] {
      affine.for %arg7 = 0 to #map0()[%1] {
        affine.for %arg8 = #map1(%arg6) to min #map2(%arg6)[%0] {
          affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%1] {
            call @S2(%arg5, %arg8, %arg3, %arg9, %arg2) : (memref<1800xf64>, index, memref<2200xf64>, index, memref<1800x2200xf64>) -> ()
          }
        }
      }
    }
    affine.for %arg6 = 0 to #map0()[%1] {
      affine.for %arg7 = #map1(%arg6) to min #map2(%arg6)[%1] {
        call @S0(%arg4, %arg7) : (memref<2200xf64>, index) -> ()
      }
    }
    affine.for %arg6 = 0 to #map0()[%1] {
      affine.for %arg7 = 0 to #map0()[%0] {
        affine.for %arg8 = #map1(%arg6) to min #map2(%arg6)[%1] {
          affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%0] {
            call @S3(%arg4, %arg8, %arg5, %arg9, %arg2) : (memref<2200xf64>, index, memref<1800xf64>, index, memref<1800x2200xf64>) -> ()
          }
        }
      }
    }
