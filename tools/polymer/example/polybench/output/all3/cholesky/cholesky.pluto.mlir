      ...
      affine.if #set0(%arg2) {
        affine.for %arg3 = 0 to #map9(%arg2) {
          affine.for %arg4 = #map10(%arg2) to min #map11(%arg2)[%0] {
            affine.for %arg5 = #map12(%arg2) to #map0(%arg4) {
              affine.for %arg6 = #map6(%arg3) to #map7(%arg3) {
                call @S0(%arg1, %arg4, %arg5, %arg6) : (memref<4000x4000xf64>, index, index, index) -> ()
              }
            }
        ...
        affine.if #set1(%arg2)[%0] {
          affine.if #set2()[%0] {
            ...
            %4 = affine.apply #map14()[%0]
            %5 = affine.apply #map13()[%0]
            call @S2(%arg1, %4, %5) : (memref<4000x4000xf64>, index, index) -> ()
            %6 = affine.apply #map14()[%0]
