...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_cholesky_new(%c4000_i32, %0) : (i32, memref<4000x4000xf64>) -> ()
  ...
  func private @kernel_cholesky(%arg0: i32, %arg1: memref<4000x4000xf64>) {
    ...
    affine.for %arg2 = 0 to %0 {
      ...
      affine.for %arg3 = 0 to #map0(%arg2) {
        call @S2(%arg1, %arg2, %arg3) : (memref<4000x4000xf64>, index, index) -> ()
      }
      call @S3(%arg1, %arg2) : (memref<4000x4000xf64>, index) -> ()
    }
    return
  }
  ...
  func private @S0(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    ...
    %2 = affine.load %arg0[%arg2, %arg3] : memref<4000x4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
  ...
  func private @S2(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg1] : memref<4000x4000xf64>
    %1 = affine.load %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    %2 = mulf %1, %1 : f64
    %3 = subf %0, %2 : f64
    affine.store %3, %arg0[%arg1, %arg1] : memref<4000x4000xf64>
    return
  }
  func private @S3(%arg0: memref<4000x4000xf64>, %arg1: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg1] : memref<4000x4000xf64>
    %1 = sqrt %0 : f64
    affine.store %1, %arg0[%arg1, %arg1] : memref<4000x4000xf64>
    return
  }
  func private @kernel_cholesky_new(%arg0: i32, %arg1: memref<4000x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg2 = 0 to #map1()[%0] {
      affine.for %arg3 = 0 to #map0(%arg2) {
        ...
        affine.for %arg4 = #map2(%arg2) to min #map3(%arg2)[%0] {
          affine.for %arg5 = #map2(%arg3) to #map4(%arg3) {
            call @S2(%arg1, %arg4, %arg5) : (memref<4000x4000xf64>, index, index) -> ()
          }
        }
      }
      affine.if #set0(%arg2)[%0] {
        affine.if #set1()[%0] {
          ...
          call @S3(%arg1, %1) : (memref<4000x4000xf64>, index) -> ()
        }
      }
      affine.if #set2(%arg2)[%0] {
        ...
        affine.if #set3(%arg2)[%0] {
          affine.if #set4()[%0] {
            ...
            call @S1(%arg1, %2, %3) : (memref<4000x4000xf64>, index, index) -> ()
            %4 = affine.apply #map6()[%0]
            %5 = affine.apply #map7()[%0]
            call @S2(%arg1, %4, %5) : (memref<4000x4000xf64>, index, index) -> ()
            %6 = affine.apply #map6()[%0]
            call @S3(%arg1, %6) : (memref<4000x4000xf64>, index) -> ()
          }
        }
        affine.if #set5(%arg2)[%0] {
          ...
          call @S3(%arg1, %6) : (memref<4000x4000xf64>, index) -> ()
          affine.for %arg3 = #map8(%arg2) to min #map3(%arg2)[%0] {
            %7 = affine.apply #map2(%arg2)
            call @S1(%arg1, %arg3, %7) : (memref<4000x4000xf64>, index, index) -> ()
            %8 = affine.apply #map2(%arg2)
            call @S2(%arg1, %arg3, %8) : (memref<4000x4000xf64>, index, index) -> ()
            affine.for %arg4 = #map5(%arg2) to #map0(%arg3) {
              ...
              call @S2(%arg1, %arg3, %arg4) : (memref<4000x4000xf64>, index, index) -> ()
            }
            call @S3(%arg1, %arg3) : (memref<4000x4000xf64>, index) -> ()
          }
        }
      }
    }
