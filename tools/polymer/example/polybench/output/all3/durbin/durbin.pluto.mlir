...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c4000_i32, %0) : (i32, memref<4000xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_durbin_new(%c4000_i32, %0, %1) : (i32, memref<4000xf64>, memref<4000xf64>) -> ()
  ...
  func private @init_array(%arg0: i32, %arg1: memref<4000xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    store %5, %arg1[%2] : memref<4000xf64>
    %6 = addi %0, %c1_i32 : i32
    br ^bb1(%6 : i32)
  ^bb3:  // pred: ^bb1
    return
  ...
  func private @kernel_durbin(%arg0: i32, %arg1: memref<4000xf64>, %arg2: memref<4000xf64>) {
    %0 = alloca() : memref<1xf64>
    %1 = alloca() : memref<1xf64>
    %2 = alloca() : memref<1xf64>
    %3 = alloca() : memref<1xf64>
    %4 = alloca() : memref<4000xf64>
    %5 = alloca() : memref<1xf64>
    %6 = alloca() : memref<1xf64>
    %7 = alloca() : memref<1xf64>
    call @S0(%arg2, %arg1) : (memref<4000xf64>, memref<4000xf64>) -> ()
    call @S1(%6) : (memref<1xf64>) -> ()
    call @S2(%5, %arg1) : (memref<1xf64>, memref<4000xf64>) -> ()
    %8 = index_cast %arg0 : i32 to index
    affine.for %arg3 = 1 to %8 {
      call @S3(%6, %5, %2) : (memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
      call @S4(%7) : (memref<1xf64>) -> ()
      affine.for %arg4 = 0 to #map0(%arg3) {
        call @S5(%7, %arg2, %arg4, %arg1, %arg3) : (memref<1xf64>, memref<4000xf64>, index, memref<4000xf64>, index) -> ()
      }
      call @S6(%3, %2, %7, %arg1, %arg3, %1) : (memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<4000xf64>, index, memref<1xf64>) -> ()
      call @S7(%5, %1, %0) : (memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
      affine.for %arg4 = 0 to #map0(%arg3) {
        call @S8(%arg4, %4, %arg2, %arg3, %3) : (index, memref<4000xf64>, memref<4000xf64>, index, memref<1xf64>) -> ()
      }
      affine.for %arg4 = 0 to #map0(%arg3) {
        call @S9(%arg2, %arg4, %4) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
      }
      call @S10(%arg2, %arg3, %0) : (memref<4000xf64>, index, memref<1xf64>) -> ()
    }
    return
  }
  ...
  func private @S0(%arg0: memref<4000xf64>, %arg1: memref<4000xf64>) attributes {scop.stmt} {
    %c0 = constant 0 : index
    %0 = load %arg1[%c0] : memref<4000xf64>
    %1 = negf %0 : f64
    store %1, %arg0[%c0] : memref<4000xf64>
    return
  }
  func private @S1(%arg0: memref<1xf64>) attributes {scop.stmt} {
    %cst = constant 1.000000e+00 : f64
    %c0 = constant 0 : index
    store %cst, %arg0[%c0] : memref<1xf64>
    return
  }
  func private @S2(%arg0: memref<1xf64>, %arg1: memref<4000xf64>) attributes {scop.stmt} {
    %c0 = constant 0 : index
    %0 = load %arg1[%c0] : memref<4000xf64>
    %1 = negf %0 : f64
    store %1, %arg0[%c0] : memref<1xf64>
    return
  }
  func private @S3(%arg0: memref<1xf64>, %arg1: memref<1xf64>, %arg2: memref<1xf64>) attributes {scop.stmt} {
    %c1_i32 = constant 1 : i32
    ...
    %5 = mulf %3, %4 : f64
    affine.store %5, %arg2[0] : memref<1xf64>
  ...
  func private @S5(%arg0: memref<1xf64>, %arg1: memref<4000xf64>, %arg2: index, %arg3: memref<4000xf64>, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg3[%arg4 - %arg2 - 1] : memref<4000xf64>
  ...
  func private @S6(%arg0: memref<1xf64>, %arg1: memref<1xf64>, %arg2: memref<1xf64>, %arg3: memref<4000xf64>, %arg4: index, %arg5: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg3[%arg4] : memref<4000xf64>
  ...
  func private @S7(%arg0: memref<1xf64>, %arg1: memref<1xf64>, %arg2: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg1[0] : memref<1xf64>
    affine.store %0, %arg2[0] : memref<1xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S8(%arg0: index, %arg1: memref<4000xf64>, %arg2: memref<4000xf64>, %arg3: index, %arg4: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg2[%arg0] : memref<4000xf64>
    %1 = affine.load %arg4[0] : memref<1xf64>
    %2 = affine.load %arg2[%arg3 - %arg0 - 1] : memref<4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg1[%arg0] : memref<4000xf64>
    return
  }
  func private @S9(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<4000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg2[%arg1] : memref<4000xf64>
    affine.store %0, %arg0[%arg1] : memref<4000xf64>
    return
  }
  func private @S10(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg2[0] : memref<1xf64>
    affine.store %0, %arg0[%arg1] : memref<4000xf64>
    return
  }
  func private @kernel_durbin_new(%arg0: i32, %arg1: memref<4000xf64>, %arg2: memref<4000xf64>) {
    %c0 = constant 0 : index
    %0 = alloca() : memref<1xf64>
    %1 = alloca() : memref<1xf64>
    %2 = alloca() : memref<1xf64>
    ...
    %5 = alloca() : memref<1xf64>
    %6 = alloca() : memref<1xf64>
    %7 = alloca() : memref<4000xf64>
    %8 = index_cast %arg0 : i32 to index
    call @S2(%6, %arg1) : (memref<1xf64>, memref<4000xf64>) -> ()
    call @S1(%5) : (memref<1xf64>) -> ()
    call @S0(%arg2, %arg1) : (memref<4000xf64>, memref<4000xf64>) -> ()
    affine.for %arg3 = 1 to %8 {
      call @S4(%3) : (memref<1xf64>) -> ()
      call @S5(%3, %arg2, %c0, %arg1, %arg3) : (memref<1xf64>, memref<4000xf64>, index, memref<4000xf64>, index) -> ()
      call @S3(%5, %6, %4) : (memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
      affine.for %arg4 = 1 to #map0(%arg3) {
        call @S5(%3, %arg2, %arg4, %arg1, %arg3) : (memref<1xf64>, memref<4000xf64>, index, memref<4000xf64>, index) -> ()
      }
      call @S6(%0, %4, %3, %arg1, %arg3, %2) : (memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<4000xf64>, index, memref<1xf64>) -> ()
      call @S8(%c0, %7, %arg2, %arg3, %0) : (index, memref<4000xf64>, memref<4000xf64>, index, memref<1xf64>) -> ()
      call @S7(%6, %2, %1) : (memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
      call @S10(%arg2, %arg3, %1) : (memref<4000xf64>, index, memref<1xf64>) -> ()
      affine.for %arg4 = #map1(%arg3) to #map2(%arg3) {
        %9 = affine.apply #map3(%arg3, %arg4)
        call @S8(%9, %7, %arg2, %arg3, %0) : (index, memref<4000xf64>, memref<4000xf64>, index, memref<1xf64>) -> ()
      }
      affine.for %arg4 = #map2(%arg3) to #map4(%arg3) {
        %9 = affine.apply #map5(%arg3, %arg4)
        call @S9(%arg2, %9, %7) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
      }
    }
    return
  }
