...
#map8 = affine_map<(d0)[s0] -> (d0 * -32 + s0 * 4 - 3)>
#map9 = affine_map<(d0, d1)[s0, s1] -> (d0 * 32 + 32, s0 * 2 + s1 - 3, d1 * -32 + s0 * 4 - 1)>
#map10 = affine_map<(d0)[s0] -> (d0 - s0 * 2 + 1)>
#set0 = affine_set<()[s0] : ((s0 * 31 + 3) mod 32 == 0)>
#set1 = affine_set<(d0, d1) : (d0 - (-d1 - 1) == 0)>
#set2 = affine_set<(d0, d1)[s0, s1] : (-d0 + (s0 * 2 - s1 + 1) floordiv 32 >= 0, d0 - (s0 * 2 - s1 - 30) ceildiv 32 >= 0, d1 - (s0 * 2 + s1 - 34) ceildiv 32 >= 0)>
#set3 = affine_set<(d0)[s0, s1] : (-d0 + (s0 * 2 - s1 - 1) floordiv 32 >= 0, d0 - (s0 * 2 - s1 - 29) ceildiv 32 >= 0)>
#set4 = affine_set<()[s0, s1] : ((s0 * 2 + s1 + 29) mod 32 == 0)>
#set5 = affine_set<()[s0] : ((s0 + 15) mod 16 == 0)>
  ...
  func private @kernel_jacobi_1d_new(%arg0: i32, %arg1: i32, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>) {
    ...
    affine.for %arg4 = #map2()[%1] to #map3()[%0] {
      affine.for %arg5 = max #map4(%arg4) to min #map5(%arg4)[%0, %1] {
        ...
        affine.for %arg6 = #map8(%arg4)[%0] to min #map9(%arg5, %arg4)[%0, %1] {
          %2 = affine.apply #map10(%arg6)[%0]
          call @S1(%arg2, %2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
        }
        affine.if #set2(%arg4, %arg5)[%0, %1] {
          %2 = affine.apply #map1()[%1]
          call @S1(%arg2, %2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
        }
      }
      affine.if #set3(%arg4)[%0, %1] {
        affine.if #set4()[%0, %1] {
          %2 = affine.apply #map1()[%1]
          call @S1(%arg2, %2, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
        }
