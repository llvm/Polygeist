...
#map3 = affine_map<(d0)[s0] -> ((d0 * 2) ceildiv 3, (d0 * 32 - s0 + 1) ceildiv 32)>
#map4 = affine_map<(d0)[s0, s1] -> ((s0 * 2 + s1 - 4) floordiv 32 + 1, (d0 * 64 + s1 + 60) floordiv 96 + 1, d0 + 1)>
#map5 = affine_map<(d0, d1)[s0] -> ((d0 * 32 - s0 + 2) ceildiv 2, d1 * 32 - d0 * 32)>
#map6 = affine_map<(d0, d1)[s0] -> (s0, d0 * 16 + 15, d1 * 32 - d0 * 32 + 32)>
#map7 = affine_map<(d0, d1) -> (d0 * 32, d1 * 2 + 2)>
#map8 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 2 + s0 - 1)>
#map9 = affine_map<(d0, d1) -> (d0 * -2 + d1)>
#map10 = affine_map<(d0, d1) -> (d0 * -2 + d1 - 1)>
#set0 = affine_set<(d0)[s0, s1] : (d0 - (s0 * 3 + s1 - 35) ceildiv 32 >= 0)>
#set1 = affine_set<()[s0, s1] : ((s0 * 2 + s1 + 29) mod 32 == 0)>
#set2 = affine_set<(d0, d1)[s0] : ((d1 * 96 - s0 + 1) floordiv 64 - d0 >= 0)>
#set3 = affine_set<()[s0] : ((s0 + 1) mod 2 == 0)>
#set4 = affine_set<(d0, d1) : (d1 floordiv 16 - d0 >= 0)>
#set5 = affine_set<(d0, d1)[s0] : (d0 - (d1 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set6 = affine_set<(d0, d1)[s0] : (d0 - (d1 * 3 - 1) ceildiv 2 >= 0, -d1 + s0 floordiv 16 - 1 >= 0)>
#set7 = affine_set<(d0)[s0, s1] : (-d0 + (s0 * 3 + s1 - 38) floordiv 32 >= 0, d0 - (s1 + 61) ceildiv 32 >= 0)>
#set8 = affine_set<(d0)[s0] : ((d0 * 64 + s0 + 61) mod 96 == 0)>
#set9 = affine_set<()[s0, s1] : ((s0 * 3 + s1 + 28) mod 32 == 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_jacobi_1d_new(%arg0: i32, %arg1: i32, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>) {
    ...
    affine.for %arg4 = 0 to #map1()[%0, %1] {
      ...
      affine.for %arg5 = max #map3(%arg4)[%0] to min #map4(%arg4)[%0, %1] {
        ...
        affine.for %arg6 = max #map5(%arg4, %arg5)[%1] to min #map6(%arg4, %arg5)[%0] {
          affine.if #set4(%arg5, %arg6) {
            call @S0(%arg3, %c1, %arg2) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
          }
          affine.for %arg7 = max #map7(%arg5, %arg6) to min #map8(%arg5, %arg6)[%1] {
