...
#map6 = affine_map<()[s0] -> ((s0 - 33) floordiv 32 + 1)>
#map7 = affine_map<()[s0] -> (s0 - 1)>
#map8 = affine_map<()[s0] -> (s0 - 2)>
#map9 = affine_map<(d0) -> (d0 * 32 + 2)>
#map10 = affine_map<(d0) -> (d0 + 1)>
#map11 = affine_map<(d0, d1) -> (d0 * 32, d1 * 32 + 1)>
#map12 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1)>
#set0 = affine_set<(d0)[s0] : (d0 * 32 - (s0 - 1) == 0)>
#set1 = affine_set<()[s0] : ((s0 + 31) mod 32 == 0)>
#set2 = affine_set<(d0)[s0] : (-d0 + (s0 - 2) floordiv 32 >= 0)>
#set3 = affine_set<(d0)[s0] : (d0 * 32 - (s0 - 2) == 0)>
#set4 = affine_set<()[s0] : ((s0 + 30) mod 32 == 0)>
#set5 = affine_set<(d0)[s0] : (-d0 + (s0 - 3) floordiv 32 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_lu_new(%c4000_i32, %0) : (i32, memref<4000x4000xf64>) -> ()
  ...
  func private @kernel_lu(%arg0: i32, %arg1: memref<4000x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map0(%arg2) {
        affine.for %arg4 = 0 to #map0(%arg3) {
          call @S0(%arg1, %arg2, %arg3, %arg4) : (memref<4000x4000xf64>, index, index, index) -> ()
        }
        call @S1(%arg1, %arg2, %arg3) : (memref<4000x4000xf64>, index, index) -> ()
      }
      affine.for %arg3 = #map0(%arg2) to %0 {
        affine.for %arg4 = 0 to #map0(%arg2) {
          call @S2(%arg1, %arg2, %arg3, %arg4) : (memref<4000x4000xf64>, index, index, index) -> ()
        }
      }
    }
    return
  ...
  func private @S0(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    %1 = affine.load %arg0[%arg1, %arg3] : memref<4000x4000xf64>
    %2 = affine.load %arg0[%arg3, %arg2] : memref<4000x4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    return
  }
  func private @S1(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<4000x4000xf64>
  ...
  func private @S2(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    %1 = affine.load %arg0[%arg1, %arg3] : memref<4000x4000xf64>
    %2 = affine.load %arg0[%arg3, %arg2] : memref<4000x4000xf64>
    %3 = mulf %1, %2 : f64
  ...
  func private @kernel_lu_new(%arg0: i32, %arg1: memref<4000x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg2 = 0 to #map1()[%0] {
      affine.for %arg3 = 0 to #map0(%arg2) {
        affine.for %arg4 = 0 to #map0(%arg3) {
          affine.for %arg5 = #map2(%arg2) to min #map3(%arg2)[%0] {
            affine.for %arg6 = #map2(%arg3) to #map4(%arg3) {
              affine.for %arg7 = #map2(%arg4) to #map4(%arg4) {
                call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
              }
            }
          }
        }
        affine.for %arg4 = #map2(%arg2) to min #map3(%arg2)[%0] {
          %1 = affine.apply #map2(%arg3)
          call @S1(%arg1, %arg4, %1) : (memref<4000x4000xf64>, index, index) -> ()
          affine.for %arg5 = #map5(%arg3) to #map4(%arg3) {
            affine.for %arg6 = #map2(%arg3) to #map0(%arg5) {
              call @S0(%arg1, %arg4, %arg5, %arg6) : (memref<4000x4000xf64>, index, index, index) -> ()
            }
            call @S1(%arg1, %arg4, %arg5) : (memref<4000x4000xf64>, index, index) -> ()
          }
        }
      }
        ...
        affine.if #set1()[%0] {
          affine.for %arg3 = 0 to #map6()[%0] {
            affine.for %arg4 = #map2(%arg3) to #map4(%arg3) {
              ...
              call @S2(%arg1, %1, %2, %arg4) : (memref<4000x4000xf64>, index, index, index) -> ()
            }
          }
        }
      }
      affine.if #set2(%arg2)[%0] {
        affine.for %arg3 = 0 to #map0(%arg2) {
          affine.for %arg4 = #map2(%arg2) to min #map3(%arg2)[%0] {
            affine.for %arg5 = #map2(%arg3) to #map4(%arg3) {
              %1 = affine.apply #map2(%arg2)
              call @S2(%arg1, %1, %arg4, %arg5) : (memref<4000x4000xf64>, index, index, index) -> ()
            }
          }
          affine.for %arg4 = #map5(%arg2) to min #map3(%arg2)[%0] {
            affine.for %arg5 = #map2(%arg2) to #map0(%arg4) {
              affine.for %arg6 = #map2(%arg3) to #map4(%arg3) {
                call @S0(%arg1, %arg4, %arg5, %arg6) : (memref<4000x4000xf64>, index, index, index) -> ()
              }
            }
            affine.for %arg5 = #map0(%arg4) to min #map3(%arg2)[%0] {
              affine.for %arg6 = #map2(%arg3) to #map4(%arg3) {
                call @S2(%arg1, %arg4, %arg5, %arg6) : (memref<4000x4000xf64>, index, index, index) -> ()
              }
            }
          }
        }
        affine.if #set3(%arg2)[%0] {
          affine.if #set4()[%0] {
            ...
            call @S1(%arg1, %1, %2) : (memref<4000x4000xf64>, index, index) -> ()
            %3 = affine.apply #map7()[%0]
            %4 = affine.apply #map7()[%0]
            %5 = affine.apply #map8()[%0]
            call @S2(%arg1, %3, %4, %5) : (memref<4000x4000xf64>, index, index, index) -> ()
          }
        }
        affine.if #set5(%arg2)[%0] {
          ...
          call @S1(%arg1, %1, %2) : (memref<4000x4000xf64>, index, index) -> ()
          affine.for %arg3 = #map5(%arg2) to min #map3(%arg2)[%0] {
            %3 = affine.apply #map5(%arg2)
            %4 = affine.apply #map2(%arg2)
            call @S2(%arg1, %3, %arg3, %4) : (memref<4000x4000xf64>, index, index, index) -> ()
          }
          affine.for %arg3 = #map9(%arg2) to min #map3(%arg2)[%0] {
            %3 = affine.apply #map2(%arg2)
            call @S1(%arg1, %arg3, %3) : (memref<4000x4000xf64>, index, index) -> ()
            affine.for %arg4 = #map5(%arg2) to #map0(%arg3) {
              affine.for %arg5 = #map2(%arg2) to #map0(%arg4) {
                call @S0(%arg1, %arg3, %arg4, %arg5) : (memref<4000x4000xf64>, index, index, index) -> ()
              }
              call @S1(%arg1, %arg3, %arg4) : (memref<4000x4000xf64>, index, index) -> ()
            }
            affine.for %arg4 = #map0(%arg3) to min #map3(%arg2)[%0] {
              affine.for %arg5 = #map2(%arg2) to #map0(%arg3) {
                call @S2(%arg1, %arg3, %arg4, %arg5) : (memref<4000x4000xf64>, index, index, index) -> ()
              }
            }
          }
        }
      }
      affine.for %arg3 = #map10(%arg2) to #map1()[%0] {
        affine.for %arg4 = 0 to #map10(%arg2) {
          affine.for %arg5 = max #map11(%arg2, %arg4) to #map4(%arg2) {
            affine.for %arg6 = #map2(%arg3) to min #map3(%arg3)[%0] {
              affine.for %arg7 = #map2(%arg4) to min #map12(%arg4, %arg5) {
                call @S2(%arg1, %arg5, %arg6, %arg7) : (memref<4000x4000xf64>, index, index, index) -> ()
              }
            }
          }
        }
