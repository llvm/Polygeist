...
#map7 = affine_map<(d0)[s0] -> (0, (d0 * -32 + s0 - 61) ceildiv 32)>
#map8 = affine_map<()[s0] -> (s0 - 1)>
#map9 = affine_map<(d0, d1)[s0] -> (2, d0 * 32, d1 * -32 + s0 - 30)>
...
#set5 = affine_set<(d0)[s0] : (-d0 + (s0 - 62) floordiv 32 >= 0)>
#set6 = affine_set<()[s0] : ((s0 + 2) mod 32 == 0)>
#set7 = affine_set<(d0, d1)[s0] : ((d1 * -32 + s0 - 31) floordiv 32 - d0 >= 0, -d1 + s0 floordiv 32 - 1 >= 0)>
#set8 = affine_set<(d0, d1)[s0] : (d0 == 0, d1 - (s0 - 31) ceildiv 32 >= 0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_nussinov_new(%c5500_i32, %0, %1) : (i32, memref<5500xi8>, memref<5500x5500xi32>) -> ()
  ...
  func private @kernel_nussinov(%arg0: i32, %arg1: memref<5500xi8>, %arg2: memref<5500x5500xi32>) {
    ...
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = #map0(%arg3)[%0] to %0 {
        ...
        affine.if #set0(%1) {
          call @S0(%arg2, %arg3, %arg4, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
        }
        %2 = affine.apply #map0(%arg3)[%0]
        affine.if #set1(%2)[%0] {
          call @S1(%arg2, %arg3, %arg4, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
        }
        affine.if #set2(%1, %2)[%0] {
          %3 = affine.apply #map2(%arg3)[%0]
          affine.if #set3(%3, %1) {
            call @S2(%arg2, %arg3, %arg4, %0, %arg1) : (memref<5500x5500xi32>, index, index, index, memref<5500xi8>) -> ()
          }
          affine.if #set4(%3, %1) {
            call @S3(%arg2, %arg3, %arg4, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          }
        }
        affine.for %arg5 = #map0(%arg3)[%0] to #map3(%arg4) {
          call @S4(%arg2, %arg3, %arg4, %0, %arg5) : (memref<5500x5500xi32>, index, index, index, index) -> ()
        }
      }
    }
    return
  ...
  func private @S0(%arg0: memref<5500x5500xi32>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    %1 = affine.load %arg0[-%arg1 + symbol(%arg3) - 1, %arg2 - 1] : memref<5500x5500xi32>
    %2 = cmpi "sge", %0, %1 : i32
    %3 = select %2, %0, %1 : i32
    affine.store %3, %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    return
  }
  func private @S1(%arg0: memref<5500x5500xi32>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    %1 = affine.load %arg0[-%arg1 + symbol(%arg3), %arg2] : memref<5500x5500xi32>
    %2 = cmpi "sge", %0, %1 : i32
    %3 = select %2, %0, %1 : i32
    affine.store %3, %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    return
  }
  func private @S2(%arg0: memref<5500x5500xi32>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<5500xi8>) attributes {scop.stmt} {
    %c3_i32 = constant 3 : i32
    %c1_i32 = constant 1 : i32
    %c0_i32 = constant 0 : i32
    %0 = affine.load %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    %1 = affine.load %arg0[-%arg1 + symbol(%arg3), %arg2 - 1] : memref<5500x5500xi32>
    %2 = affine.load %arg4[-%arg1 + symbol(%arg3) - 1] : memref<5500xi8>
    %3 = sexti %2 : i8 to i32
    %4 = affine.load %arg4[%arg2] : memref<5500xi8>
    %5 = sexti %4 : i8 to i32
    %6 = addi %3, %5 : i32
    ...
    affine.store %11, %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    return
  }
  func private @S3(%arg0: memref<5500x5500xi32>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    %1 = affine.load %arg0[-%arg1 + symbol(%arg3), %arg2 - 1] : memref<5500x5500xi32>
    %2 = cmpi "sge", %0, %1 : i32
    %3 = select %2, %0, %1 : i32
  ...
  func private @S4(%arg0: memref<5500x5500xi32>, %arg1: index, %arg2: index, %arg3: index, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    %1 = affine.load %arg0[-%arg1 + symbol(%arg3) - 1, %arg4] : memref<5500x5500xi32>
    %2 = affine.load %arg0[%arg4 + 1, %arg2] : memref<5500x5500xi32>
    %3 = addi %1, %2 : i32
    %4 = cmpi "sge", %0, %3 : i32
    %5 = select %4, %0, %3 : i32
    affine.store %5, %arg0[-%arg1 + symbol(%arg3) - 1, %arg2] : memref<5500x5500xi32>
    return
  }
  func private @kernel_nussinov_new(%arg0: i32, %arg1: memref<5500xi8>, %arg2: memref<5500x5500xi32>) {
    %c1 = constant 1 : index
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg3 = 0 to #map4()[%0] {
      affine.if #set5(%arg3)[%0] {
        affine.if #set6()[%0] {
          %1 = affine.apply #map5(%arg3)
          %2 = affine.apply #map6(%arg3)[%0]
          call @S0(%arg2, %1, %2, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          %3 = affine.apply #map5(%arg3)
          %4 = affine.apply #map6(%arg3)[%0]
          call @S1(%arg2, %3, %4, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          %5 = affine.apply #map5(%arg3)
          %6 = affine.apply #map6(%arg3)[%0]
          call @S2(%arg2, %5, %6, %0, %arg1) : (memref<5500x5500xi32>, index, index, index, memref<5500xi8>) -> ()
        }
      }
      affine.for %arg4 = max #map7(%arg3)[%0] to #map4()[%0] {
        affine.if #set7(%arg3, %arg4)[%0] {
          %1 = affine.apply #map6(%arg4)[%0]
          %2 = affine.apply #map5(%arg4)
          call @S0(%arg2, %1, %2, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          %3 = affine.apply #map6(%arg4)[%0]
          %4 = affine.apply #map5(%arg4)
          call @S1(%arg2, %3, %4, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          %5 = affine.apply #map6(%arg4)[%0]
          %6 = affine.apply #map5(%arg4)
          call @S2(%arg2, %5, %6, %0, %arg1) : (memref<5500x5500xi32>, index, index, index, memref<5500xi8>) -> ()
        }
        affine.if #set8(%arg3, %arg4)[%0] {
          %1 = affine.apply #map8()[%0]
          call @S0(%arg2, %c1, %1, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          %2 = affine.apply #map8()[%0]
          call @S1(%arg2, %c1, %2, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          %3 = affine.apply #map8()[%0]
          call @S2(%arg2, %c1, %3, %0, %arg1) : (memref<5500x5500xi32>, index, index, index, memref<5500xi8>) -> ()
        }
        affine.for %arg5 = max #map9(%arg3, %arg4)[%0] to min #map10(%arg3)[%0] {
          affine.if #set9(%arg4, %arg5)[%0] {
            %1 = affine.apply #map0(%arg5)[%0]
            call @S0(%arg2, %arg5, %1, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
            %2 = affine.apply #map0(%arg5)[%0]
            call @S1(%arg2, %arg5, %2, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
            %3 = affine.apply #map0(%arg5)[%0]
            call @S2(%arg2, %arg5, %3, %0, %arg1) : (memref<5500x5500xi32>, index, index, index, memref<5500xi8>) -> ()
          }
          affine.for %arg6 = max #map11(%arg4, %arg5)[%0] to min #map10(%arg4)[%0] {
            call @S0(%arg2, %arg5, %arg6, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
            call @S1(%arg2, %arg5, %arg6, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
            call @S2(%arg2, %arg5, %arg6, %0, %arg1) : (memref<5500x5500xi32>, index, index, index, memref<5500xi8>) -> ()
            affine.for %arg7 = #map0(%arg5)[%0] to #map3(%arg6) {
              call @S4(%arg2, %arg5, %arg6, %0, %arg7) : (memref<5500x5500xi32>, index, index, index, index) -> ()
            }
          }
        }
      }
