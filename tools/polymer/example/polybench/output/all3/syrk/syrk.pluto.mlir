...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c2600_i32, %c2000_i32, %4, %5, %2, %3) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<2600x2600xf64>, memref<2600x2000xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %6 = load %0[%c0] : memref<1xf64>
    %7 = load %1[%c0] : memref<1xf64>
    call @kernel_syrk_new(%c2600_i32, %c2000_i32, %6, %7, %2, %3) : (i32, i32, f64, f64, memref<2600x2600xf64>, memref<2600x2000xf64>) -> ()
    call @polybench_timer_stop() : () -> ()
    call @polybench_timer_print() : () -> ()
    %8 = cmpi "sgt", %arg0, %c42_i32 : i32
    %9 = scf.if %8 -> (i1) {
      %10 = llvm.load %arg1 : !llvm.ptr<ptr<i8>>
      %11 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %12 = llvm.mlir.constant(0 : index) : !llvm.i64
      %13 = llvm.getelementptr %11[%12, %12] : (!llvm.ptr<array<1 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %14 = llvm.call @strcmp(%10, %13) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
      %15 = llvm.mlir.cast %14 : !llvm.i32 to i32
  ...
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<2600x2600xf64>, %arg5: memref<2600x2000xf64>) {
    %c0 = constant 0 : index
  ...
  ^bb8:  // pred: ^bb7
    ...
    %25 = divf %23, %24 : f64
    store %25, %arg4[%16, %19] : memref<2600x2600xf64>
  ...
  func private @kernel_syrk(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<2600x2600xf64>, %arg5: memref<2600x2000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to %0 {
      affine.for %arg7 = 0 to #map0(%arg6) {
        call @S0(%arg4, %arg6, %arg7, %arg3) : (memref<2600x2600xf64>, index, index, f64) -> ()
      }
      affine.for %arg7 = 0 to %1 {
        affine.for %arg8 = 0 to #map0(%arg6) {
          call @S1(%arg4, %arg6, %arg8, %arg5, %arg7, %arg2) : (memref<2600x2600xf64>, index, index, memref<2600x2000xf64>, index, f64) -> ()
        }
      }
    }
    return
  ...
  func private @S1(%arg0: memref<2600x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<2600x2000xf64>, %arg4: index, %arg5: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    %1 = affine.load %arg3[%arg1, %arg4] : memref<2600x2000xf64>
    %2 = mulf %arg5, %1 : f64
    %3 = affine.load %arg3[%arg2, %arg4] : memref<2600x2000xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
    affine.store %5, %arg0[%arg1, %arg2] : memref<2600x2600xf64>
    return
  }
  func private @kernel_syrk_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<2600x2600xf64>, %arg5: memref<2600x2000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
      ...
      affine.for %arg7 = 0 to #map0(%arg6) {
        affine.for %arg8 = #map2(%arg6) to min #map3(%arg6)[%0] {
          affine.for %arg9 = #map2(%arg7) to min #map4(%arg7, %arg8) {
            call @S0(%arg4, %arg8, %arg9, %arg3) : (memref<2600x2600xf64>, index, index, f64) -> ()
          }
        }
      }
    }
      ...
      affine.for %arg7 = 0 to #map0(%arg6) {
        affine.for %arg8 = 0 to #map1()[%1] {
          affine.for %arg9 = #map2(%arg6) to min #map3(%arg6)[%0] {
            affine.for %arg10 = #map2(%arg7) to min #map4(%arg7, %arg9) {
              affine.for %arg11 = #map2(%arg8) to min #map3(%arg8)[%1] {
                call @S1(%arg4, %arg9, %arg10, %arg5, %arg11, %arg2) : (memref<2600x2600xf64>, index, index, memref<2600x2000xf64>, index, f64) -> ()
              }
            }
          }
        }
