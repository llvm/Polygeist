...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_trisolv_new(%c4000_i32, %0, %1, %2) : (i32, memref<4000x4000xf64>, memref<4000xf64>, memref<4000xf64>) -> ()
  ...
  func private @kernel_trisolv(%arg0: i32, %arg1: memref<4000x4000xf64>, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>) {
    ...
    affine.for %arg4 = 0 to %0 {
      call @S0(%arg2, %arg4, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
      affine.for %arg5 = 0 to #map0(%arg4) {
        call @S1(%arg2, %arg4, %arg5, %arg1) : (memref<4000xf64>, index, index, memref<4000x4000xf64>) -> ()
      }
      call @S2(%arg2, %arg4, %arg1) : (memref<4000xf64>, index, memref<4000x4000xf64>) -> ()
    }
    return
  }
  ...
  func private @S1(%arg0: memref<4000xf64>, %arg1: index, %arg2: index, %arg3: memref<4000x4000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<4000xf64>
    %1 = affine.load %arg3[%arg1, %arg2] : memref<4000x4000xf64>
    %2 = affine.load %arg0[%arg2] : memref<4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[%arg1] : memref<4000xf64>
    return
  }
  func private @S2(%arg0: memref<4000xf64>, %arg1: index, %arg2: memref<4000x4000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<4000xf64>
    %1 = affine.load %arg2[%arg1, %arg1] : memref<4000x4000xf64>
    %2 = divf %0, %1 : f64
    affine.store %2, %arg0[%arg1] : memref<4000xf64>
    return
  }
  func private @kernel_trisolv_new(%arg0: i32, %arg1: memref<4000x4000xf64>, %arg2: memref<4000xf64>, %arg3: memref<4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg4 = 0 to #map1()[%0] {
      affine.for %arg5 = #map2(%arg4) to min #map3(%arg4)[%0] {
        call @S0(%arg2, %arg5, %arg3) : (memref<4000xf64>, index, memref<4000xf64>) -> ()
      }
    }
    affine.for %arg4 = 0 to #map1()[%0] {
      affine.for %arg5 = 0 to #map0(%arg4) {
        affine.for %arg6 = #map2(%arg4) to min #map3(%arg4)[%0] {
          affine.for %arg7 = #map2(%arg5) to #map4(%arg5) {
            call @S1(%arg2, %arg6, %arg7, %arg1) : (memref<4000xf64>, index, index, memref<4000x4000xf64>) -> ()
          }
        }
      }
      affine.if #set0(%arg4)[%0] {
        affine.if #set1()[%0] {
          ...
          call @S2(%arg2, %1, %arg1) : (memref<4000xf64>, index, memref<4000x4000xf64>) -> ()
        }
      }
      affine.if #set2(%arg4)[%0] {
        %1 = affine.apply #map2(%arg4)
        call @S2(%arg2, %1, %arg1) : (memref<4000xf64>, index, memref<4000x4000xf64>) -> ()
        affine.for %arg5 = #map6(%arg4) to min #map3(%arg4)[%0] {
          affine.for %arg6 = #map2(%arg4) to #map0(%arg5) {
            call @S1(%arg2, %arg5, %arg6, %arg1) : (memref<4000xf64>, index, index, memref<4000x4000xf64>) -> ()
          }
          call @S2(%arg2, %arg5, %arg1) : (memref<4000xf64>, index, memref<4000x4000xf64>) -> ()
        }
      }
    }
    return
