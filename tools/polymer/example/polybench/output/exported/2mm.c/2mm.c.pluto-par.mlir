#map0 = affine_map<()[s0, s1, s2] -> (s0 + s1 - 1, s0 + s2 - 1)>
#map1 = affine_map<(d0)[s0] -> (0, d0 - s0 + 1)>
#map2 = affine_map<(d0)[s0] -> (d0 - s0 + 1)>
#map3 = affine_map<(d0, d1) -> (d0 - d1)>
#map4 = affine_map<(d0)[s0, s1] -> (0, d0 - s0 + 1, d0 - s1 + 1)>
#map5 = affine_map<(d0)[s0] -> (d0 + 1, s0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_2mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<800x900xf64>, %arg7: memref<800x1100xf64>, %arg8: memref<1100x900xf64>, %arg9: memref<900x1200xf64>, %arg10: memref<800x1200xf64>) {
    ...
    affine.for %arg11 = 0 to min #map0()[%2, %1, %0] {
      affine.for %arg12 = max #map1(%arg11)[%1] to #map2(%arg11)[%0] {
        affine.for %arg13 = 0 to %0 {
          %3 = affine.apply #map3(%arg11, %arg12)
          call @S1(%arg6, %arg12, %3, %arg8, %arg13, %arg4, %arg7) : (memref<800x900xf64>, index, index, memref<1100x900xf64>, index, f64, memref<800x1100xf64>) -> ()
        }
      }
      affine.for %arg12 = max #map1(%arg11)[%0] to #map2(%arg11)[%1] {
        affine.for %arg13 = 0 to %1 {
          %3 = affine.apply #map3(%arg11, %arg12)
          call @S3(%arg10, %arg12, %arg13, %arg9, %3, %arg6) : (memref<800x1200xf64>, index, index, memref<900x1200xf64>, index, memref<800x900xf64>) -> ()
        }
      }
      affine.for %arg12 = max #map4(%arg11)[%1, %0] to min #map5(%arg11)[%2] {
        affine.for %arg13 = 0 to %0 {
          %3 = affine.apply #map3(%arg11, %arg12)
          call @S1(%arg6, %arg12, %3, %arg8, %arg13, %arg4, %arg7) : (memref<800x900xf64>, index, index, memref<1100x900xf64>, index, f64, memref<800x1100xf64>) -> ()
        }
    ...
    affine.for %arg11 = #map6()[%2, %0] to #map6()[%2, %1] {
      affine.for %arg12 = max #map1(%arg11)[%1] to %2 {
        affine.for %arg13 = 0 to %0 {
          %3 = affine.apply #map3(%arg11, %arg12)
          call @S1(%arg6, %arg12, %3, %arg8, %arg13, %arg4, %arg7) : (memref<800x900xf64>, index, index, memref<1100x900xf64>, index, f64, memref<800x1100xf64>) -> ()
        }
    ...
    affine.for %arg11 = #map6()[%2, %1] to #map6()[%2, %0] {
      affine.for %arg12 = max #map1(%arg11)[%0] to %2 {
        affine.for %arg13 = 0 to %1 {
          %3 = affine.apply #map3(%arg11, %arg12)
          call @S3(%arg10, %arg12, %arg13, %arg9, %3, %arg6) : (memref<800x1200xf64>, index, index, memref<900x1200xf64>, index, memref<800x900xf64>) -> ()
        }
