...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_2mm(%c800_i32, %c900_i32, %c1100_i32, %c1200_i32, %9, %10, %2, %3, %4, %5, %6) : (i32, i32, i32, i32, f64, f64, memref<800x900xf64>, memref<800x1100xf64>, memref<1100x900xf64>, memref<900x1200xf64>, memref<800x1200xf64>) -> ()
  ...
  func @S1(%arg0: memref<800x900xf64>, %arg1: index, %arg2: index, %arg3: memref<1100x900xf64>, %arg4: index, %arg5: f64, %arg6: memref<800x1100xf64>) attributes {scop.stmt} {
  ...
  func @S2(%arg0: memref<800x1200xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<800x1200xf64>
    %1 = mulf %0, %arg3 : f64
    affine.store %1, %arg0[%arg1, %arg2] : memref<800x1200xf64>
    return
  }
  func @S3(%arg0: memref<800x1200xf64>, %arg1: index, %arg2: index, %arg3: memref<900x1200xf64>, %arg4: index, %arg5: memref<800x900xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<800x1200xf64>
