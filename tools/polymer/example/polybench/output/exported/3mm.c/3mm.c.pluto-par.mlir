...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_3mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<800x900xf64>, %arg6: memref<800x1000xf64>, %arg7: memref<1000x900xf64>, %arg8: memref<900x1100xf64>, %arg9: memref<900x1200xf64>, %arg10: memref<1200x1100xf64>, %arg11: memref<800x1100xf64>) {
    ...
    affine.for %arg12 = 0 to %1 {
      affine.for %arg13 = 0 to %2 {
        affine.for %arg14 = 0 to %0 {
          call @S3(%arg8, %arg13, %arg12, %arg10, %arg14, %arg9) : (memref<900x1100xf64>, index, index, memref<1200x1100xf64>, index, memref<900x1200xf64>) -> ()
        }
      }
    }
    affine.for %arg12 = 0 to %2 {
    ...
    affine.for %arg12 = 0 to min #map0()[%1, %2, %0] {
      affine.for %arg13 = max #map1(%arg12)[%1] to #map2(%arg12)[%0] {
        affine.for %arg14 = 0 to %0 {
          %3 = affine.apply #map3(%arg12, %arg13)
          call @S1(%arg5, %arg13, %3, %arg7, %arg14, %arg6) : (memref<800x900xf64>, index, index, memref<1000x900xf64>, index, memref<800x1000xf64>) -> ()
        }
      }
      affine.for %arg13 = max #map1(%arg12)[%0] to #map2(%arg12)[%1] {
        affine.for %arg14 = 0 to %1 {
          %3 = affine.apply #map3(%arg12, %arg13)
          call @S5(%arg11, %arg13, %arg14, %arg8, %3, %arg5) : (memref<800x1100xf64>, index, index, memref<900x1100xf64>, index, memref<800x900xf64>) -> ()
        }
      }
      affine.for %arg13 = max #map4(%arg12)[%1, %0] to min #map5(%arg12)[%2] {
        affine.for %arg14 = 0 to %0 {
          %3 = affine.apply #map3(%arg12, %arg13)
          call @S1(%arg5, %arg13, %3, %arg7, %arg14, %arg6) : (memref<800x900xf64>, index, index, memref<1000x900xf64>, index, memref<800x1000xf64>) -> ()
        }
    ...
    affine.for %arg12 = #map6()[%2, %0] to #map6()[%1, %2] {
      affine.for %arg13 = max #map1(%arg12)[%1] to %2 {
        affine.for %arg14 = 0 to %0 {
          %3 = affine.apply #map3(%arg12, %arg13)
          call @S1(%arg5, %arg13, %3, %arg7, %arg14, %arg6) : (memref<800x900xf64>, index, index, memref<1000x900xf64>, index, memref<800x1000xf64>) -> ()
        }
    ...
    affine.for %arg12 = #map6()[%1, %2] to #map6()[%2, %0] {
      affine.for %arg13 = max #map1(%arg12)[%0] to %2 {
        affine.for %arg14 = 0 to %1 {
          %3 = affine.apply #map3(%arg12, %arg13)
          call @S5(%arg11, %arg13, %arg14, %arg8, %3, %arg5) : (memref<800x1100xf64>, index, index, memref<900x1100xf64>, index, memref<800x900xf64>) -> ()
        }
