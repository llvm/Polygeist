...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @S1(%arg0: memref<800x900xf64>, %arg1: index, %arg2: index, %arg3: memref<1000x900xf64>, %arg4: index, %arg5: memref<800x1000xf64>) attributes {scop.stmt} {
  ...
  func @S2(%arg0: memref<900x1100xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, %arg2] : memref<900x1100xf64>
    return
  }
  func @S3(%arg0: memref<900x1100xf64>, %arg1: index, %arg2: index, %arg3: memref<1200x1100xf64>, %arg4: index, %arg5: memref<900x1200xf64>) attributes {scop.stmt} {
  ...
  func @S4(%arg0: memref<800x1100xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, %arg2] : memref<800x1100xf64>
    return
  }
  func @S5(%arg0: memref<800x1100xf64>, %arg1: index, %arg2: index, %arg3: memref<900x1100xf64>, %arg4: index, %arg5: memref<800x900xf64>) attributes {scop.stmt} {
  ...
  func @kernel_3mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<800x900xf64>, %arg6: memref<800x1000xf64>, %arg7: memref<1000x900xf64>, %arg8: memref<900x1100xf64>, %arg9: memref<900x1200xf64>, %arg10: memref<1200x1100xf64>, %arg11: memref<800x1100xf64>) {
        ...
        affine.for %arg14 = 0 to #map0()[%0] {
          affine.for %arg15 = #map1(%arg12) to min #map2(%arg12)[%1] {
            affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%2] {
              affine.for %arg17 = #map1(%arg14) to min #map2(%arg14)[%0] {
    ...
    affine.for %arg12 = 0 to min #map3()[%1, %2, %0] {
      affine.for %arg13 = max #map4(%arg12)[%1] to #map5(%arg12)[%0] {
        affine.for %arg14 = 0 to #map0()[%0] {
          affine.for %arg15 = #map6(%arg12, %arg13) to min #map7(%arg12, %arg13)[%1] {
            affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%2] {
              affine.for %arg17 = #map1(%arg14) to min #map2(%arg14)[%0] {
      ...
      affine.for %arg13 = max #map4(%arg12)[%0] to #map5(%arg12)[%1] {
        affine.for %arg14 = 0 to #map0()[%1] {
          affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%2] {
            affine.for %arg16 = #map1(%arg14) to min #map2(%arg14)[%1] {
              affine.for %arg17 = #map6(%arg12, %arg13) to min #map7(%arg12, %arg13)[%0] {
      ...
      affine.for %arg13 = max #map8(%arg12)[%1, %0] to min #map9(%arg12)[%2] {
        affine.for %arg14 = 0 to #map0()[%0] {
          affine.for %arg15 = #map6(%arg12, %arg13) to min #map7(%arg12, %arg13)[%1] {
            affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%2] {
              affine.for %arg17 = #map1(%arg14) to min #map2(%arg14)[%0] {
    ...
    affine.for %arg12 = #map10()[%2, %0] to #map11()[%1, %2] {
      affine.for %arg13 = max #map4(%arg12)[%1] to #map0()[%2] {
        affine.for %arg14 = 0 to #map0()[%0] {
          affine.for %arg15 = #map6(%arg12, %arg13) to min #map7(%arg12, %arg13)[%1] {
            affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%2] {
              affine.for %arg17 = #map1(%arg14) to min #map2(%arg14)[%0] {
    ...
    affine.for %arg12 = #map10()[%1, %2] to #map11()[%2, %0] {
      affine.for %arg13 = max #map4(%arg12)[%0] to #map0()[%2] {
        affine.for %arg14 = 0 to #map0()[%1] {
          affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%2] {
            affine.for %arg16 = #map1(%arg14) to min #map2(%arg14)[%1] {
              affine.for %arg17 = #map6(%arg12, %arg13) to min #map7(%arg12, %arg13)[%0] {
