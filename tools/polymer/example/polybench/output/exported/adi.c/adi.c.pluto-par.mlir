...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_adi_new(%arg0: i32, %arg1: i32, %arg2: memref<1000x1000xf64>, %arg3: memref<1000x1000xf64>, %arg4: memref<1000x1000xf64>, %arg5: memref<1000x1000xf64>) {
    ...
    affine.for %arg6 = 1 to #map0()[%5] {
      ...
      affine.for %arg7 = 1 to #map1()[%4] {
        affine.for %arg8 = 1 to #map1()[%4] {
          call @S10(%arg3, %arg6, %arg7, %4, %arg5, %arg4) : (memref<1000x1000xf64>, index, index, index, memref<1000x1000xf64>, memref<1000x1000xf64>) -> ()
        }
      }
      affine.for %arg7 = 1 to #map1()[%4] {
      ...
      affine.for %arg7 = 1 to #map1()[%4] {
        affine.for %arg8 = 1 to #map1()[%4] {
          call @S7(%arg4, %arg6, %arg7, %1, %2) : (memref<1000x1000xf64>, index, index, memref<1xf64>, memref<1xf64>) -> ()
        }
        affine.for %arg8 = 1 to #map1()[%4] {
          call @S8(%arg5, %arg6, %arg7, %1, %arg4, %2, %arg2, %0) : (memref<1000x1000xf64>, index, index, memref<1xf64>, memref<1000x1000xf64>, memref<1xf64>, memref<1000x1000xf64>, memref<1xf64>) -> ()
        }
      }
      affine.for %arg7 = 1 to #map1()[%4] {
      ...
      affine.for %arg7 = 1 to #map1()[%4] {
        affine.for %arg8 = 1 to #map1()[%4] {
          call @S14(%arg4, %arg6, %arg7, %3, %0) : (memref<1000x1000xf64>, index, index, memref<1xf64>, memref<1xf64>) -> ()
        }
        affine.for %arg8 = 1 to #map1()[%4] {
          call @S15(%arg5, %arg6, %arg7, %3, %arg4, %0, %arg3, %2) : (memref<1000x1000xf64>, index, index, memref<1xf64>, memref<1000x1000xf64>, memref<1xf64>, memref<1000x1000xf64>, memref<1xf64>) -> ()
        }
        affine.for %arg8 = 1 to #map1()[%4] {
          call @S17(%arg2, %arg6, %arg7, %4, %arg5, %arg4) : (memref<1000x1000xf64>, index, index, index, memref<1000x1000xf64>, memref<1000x1000xf64>) -> ()
        }
      }
    }
