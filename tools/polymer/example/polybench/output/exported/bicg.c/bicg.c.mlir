module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_bicg(%arg0: i32, %arg1: i32, %arg2: memref<2100x1900xf64>, %arg3: memref<1900xf64>, %arg4: memref<2100xf64>, %arg5: memref<1900xf64>, %arg6: memref<2100xf64>) {
    ...
    affine.for %arg7 = 0 to %0 {
      ...
      affine.store %2, %arg3[%arg7] : memref<1900xf64>
    }
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg7 = 0 to %1 {
      affine.store %cst, %arg4[%arg7] : memref<2100xf64>
      affine.for %arg8 = 0 to %0 {
        %2 = affine.load %arg3[%arg8] : memref<1900xf64>
        %3 = affine.load %arg6[%arg7] : memref<2100xf64>
        %4 = affine.load %arg2[%arg7, %arg8] : memref<2100x1900xf64>
        %5 = mulf %3, %4 : f64
        %6 = addf %2, %5 : f64
        affine.store %6, %arg3[%arg8] : memref<1900xf64>
        %7 = affine.load %arg4[%arg7] : memref<2100xf64>
        %8 = affine.load %arg2[%arg7, %arg8] : memref<2100x1900xf64>
        %9 = affine.load %arg5[%arg8] : memref<1900xf64>
        %10 = mulf %8, %9 : f64
        %11 = addf %7, %10 : f64
        affine.store %11, %arg4[%arg7] : memref<2100xf64>
      }
    }
    return
  }
