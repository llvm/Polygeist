...
#map1 = affine_map<(d0) -> (2100, d0 * 32 + 32)>
#map2 = affine_map<(d0) -> (0, (d0 * 32 - 1899) ceildiv 32)>
#map3 = affine_map<(d0) -> (66, d0 + 1)>
#map4 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32)>
#map5 = affine_map<(d0, d1) -> (1900, d0 * 32 - d1 * 32 + 32)>
#map6 = affine_map<(d0) -> (1900, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  llvm.mlir.global internal constant @str10("%0.6f\0A\00")
  global_memref "private" @polybench_t_end : memref<1xf64>
  llvm.mlir.global internal constant @str9("Error return from gettimeofday: %d\00")
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %c0 = constant 0 : index
    %0 = alloc() : memref<2100x1900xf64>
    %1 = alloc() : memref<1900xf64>
    %2 = alloc() : memref<2100xf64>
    %3 = alloc() : memref<1900xf64>
    %4 = alloc() : memref<2100xf64>
    br ^bb1(%c0_i32 : i32)
  ^bb1(%5: i32):  // 2 preds: ^bb0, ^bb2
    %6 = cmpi "slt", %5, %c1900_i32 : i32
    %7 = index_cast %5 : i32 to index
    cond_br %6, ^bb2, ^bb3(%c0_i32 : i32)
  ^bb2:  // pred: ^bb1
    %8 = remi_signed %5, %c1900_i32 : i32
    %9 = sitofp %8 : i32 to f64
    %10 = sitofp %c1900_i32 : i32 to f64
    %11 = divf %9, %10 : f64
    store %11, %3[%7] : memref<1900xf64>
    %12 = addi %5, %c1_i32 : i32
    br ^bb1(%12 : i32)
  ^bb3(%13: i32):  // 2 preds: ^bb1, ^bb8
    %14 = cmpi "slt", %13, %c2100_i32 : i32
    %15 = index_cast %13 : i32 to index
    cond_br %14, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %16 = remi_signed %13, %c2100_i32 : i32
    %17 = sitofp %16 : i32 to f64
    %18 = sitofp %c2100_i32 : i32 to f64
    %19 = divf %17, %18 : f64
    store %19, %4[%15] : memref<2100xf64>
    br ^bb6(%c0_i32 : i32)
  ^bb5:  // pred: ^bb3
    %20 = get_global_memref @polybench_t_start : memref<1xf64>
    %21 = call @rtclock() : () -> f64
    store %21, %20[%c0] : memref<1xf64>
    affine.for %arg2 = 0 to 66 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S1(%2, %arg3) : (memref<2100xf64>, index) -> ()
      }
    }
      ...
      affine.for %arg3 = max #map2(%arg2) to min #map3(%arg2) {
        affine.for %arg4 = #map0(%arg3) to min #map1(%arg3) {
          affine.for %arg5 = #map4(%arg2, %arg3) to min #map5(%arg2, %arg3) {
            call @S3(%2, %arg4, %3, %arg5, %0) : (memref<2100xf64>, index, memref<1900xf64>, index, memref<2100x1900xf64>) -> ()
          }
        }
      }
    }
    affine.for %arg2 = 0 to 66 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S0(%1, %arg3) : (memref<1900xf64>, index) -> ()
      }
    }
      ...
      affine.for %arg3 = 0 to 66 {
        affine.for %arg4 = #map0(%arg2) to min #map6(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            call @S2(%1, %arg5, %0, %arg4, %4) : (memref<1900xf64>, index, memref<2100x1900xf64>, index, memref<2100xf64>) -> ()
          }
        }
      }
    }
    %22 = get_global_memref @polybench_t_end : memref<1xf64>
    %23 = call @rtclock() : () -> f64
    store %23, %22[%c0] : memref<1xf64>
    call @polybench_timer_print() : () -> ()
    %24 = cmpi "sgt", %arg0, %c42_i32 : i32
    %25 = scf.if %24 -> (i1) {
      %35 = llvm.load %arg1 : !llvm.ptr<ptr<i8>>
      %36 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %37 = llvm.mlir.constant(0 : index) : !llvm.i64
      %38 = llvm.getelementptr %36[%37, %37] : (!llvm.ptr<array<1 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %39 = llvm.call @strcmp(%35, %38) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
      %40 = llvm.mlir.cast %39 : !llvm.i32 to i32
      %41 = trunci %40 : i32 to i1
      %42 = xor %41, %true : i1
      scf.yield %42 : i1
    } else {
      scf.yield %false : i1
    ...
    scf.if %25 {
      call @print_array(%c1900_i32, %c2100_i32, %1, %2) : (i32, i32, memref<1900xf64>, memref<2100xf64>) -> ()
    }
    return %c0_i32 : i32
  ^bb6(%26: i32):  // 2 preds: ^bb4, ^bb7
    %27 = cmpi "slt", %26, %c1900_i32 : i32
    %28 = index_cast %26 : i32 to index
    cond_br %27, ^bb7, ^bb8
  ^bb7:  // pred: ^bb6
    %29 = addi %26, %c1_i32 : i32
    %30 = muli %13, %29 : i32
    %31 = remi_signed %30, %c2100_i32 : i32
    %32 = sitofp %31 : i32 to f64
    %33 = divf %32, %18 : f64
    store %33, %0[%15, %28] : memref<2100x1900xf64>
    br ^bb6(%29 : i32)
  ^bb8:  // pred: ^bb6
    %34 = addi %13, %c1_i32 : i32
    br ^bb3(%34 : i32)
  }
  func @init_array(%arg0: i32, %arg1: i32, %arg2: memref<2100x1900xf64>, %arg3: memref<2100xf64>, %arg4: memref<1900xf64>) {
    %c0_i32 = constant 0 : i32
    %c1_i32 = constant 1 : i32
    br ^bb1(%c0_i32 : i32)
  ...
  ^bb2:  // pred: ^bb1
    ...
    %6 = divf %4, %5 : f64
    store %6, %arg4[%2] : memref<1900xf64>
    %7 = addi %0, %c1_i32 : i32
    br ^bb1(%7 : i32)
  ^bb3(%8: i32):  // 2 preds: ^bb1, ^bb8
    %9 = cmpi "slt", %8, %arg1 : i32
    %10 = index_cast %8 : i32 to index
    cond_br %9, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %11 = remi_signed %8, %arg1 : i32
    %12 = sitofp %11 : i32 to f64
    %13 = sitofp %arg1 : i32 to f64
    %14 = divf %12, %13 : f64
    store %14, %arg3[%10] : memref<2100xf64>
    br ^bb6(%c0_i32 : i32)
  ^bb5:  // pred: ^bb3
    return
  ^bb6(%15: i32):  // 2 preds: ^bb4, ^bb7
    %16 = cmpi "slt", %15, %arg0 : i32
    %17 = index_cast %15 : i32 to index
    cond_br %16, ^bb7, ^bb8
  ^bb7:  // pred: ^bb6
    %18 = addi %15, %c1_i32 : i32
    %19 = muli %8, %18 : i32
    %20 = remi_signed %19, %arg1 : i32
    %21 = sitofp %20 : i32 to f64
    %22 = divf %21, %13 : f64
    store %22, %arg2[%10, %17] : memref<2100x1900xf64>
    br ^bb6(%18 : i32)
  ^bb8:  // pred: ^bb6
    %23 = addi %8, %c1_i32 : i32
    br ^bb3(%23 : i32)
  }
  ...
  func @kernel_bicg(%arg0: i32, %arg1: i32, %arg2: memref<2100x1900xf64>, %arg3: memref<1900xf64>, %arg4: memref<2100xf64>, %arg5: memref<1900xf64>, %arg6: memref<2100xf64>) {
    ...
    affine.for %arg7 = 0 to %0 {
      call @S0(%arg3, %arg7) : (memref<1900xf64>, index) -> ()
    }
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg7 = 0 to %1 {
      call @S1(%arg4, %arg7) : (memref<2100xf64>, index) -> ()
      affine.for %arg8 = 0 to %0 {
        call @S2(%arg3, %arg8, %arg2, %arg7, %arg6) : (memref<1900xf64>, index, memref<2100x1900xf64>, index, memref<2100xf64>) -> ()
        call @S3(%arg4, %arg7, %arg5, %arg8, %arg2) : (memref<2100xf64>, index, memref<1900xf64>, index, memref<2100x1900xf64>) -> ()
      }
    }
    return
  }
  ...
  func @polybench_timer_print() {
    %c0 = constant 0 : index
    %0 = llvm.mlir.addressof @str10 : !llvm.ptr<array<7 x i8>>
  ...
  func @print_array(%arg0: i32, %arg1: i32, %arg2: memref<1900xf64>, %arg3: memref<2100xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    scf.if %17 {
      %65 = llvm.mlir.addressof @stderr : !llvm.ptr<ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>>
      %66 = llvm.load %65 : !llvm.ptr<ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>>
      %67 = llvm.mlir.addressof @str4 : !llvm.ptr<array<2 x i8>>
      %68 = llvm.getelementptr %67[%3, %3] : (!llvm.ptr<array<2 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %69 = llvm.call @fprintf(%66, %68) : (!llvm.ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>, !llvm.ptr<i8>) -> !llvm.i32
    }
    ...
    %22 = load %arg2[%15] : memref<1900xf64>
  ...
  ^bb3:  // pred: ^bb1
    ...
    %35 = llvm.mlir.addressof @str2 : !llvm.ptr<array<15 x i8>>
    %36 = llvm.getelementptr %35[%3, %3] : (!llvm.ptr<array<15 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
    %37 = llvm.mlir.addressof @str7 : !llvm.ptr<array<2 x i8>>
    %38 = llvm.getelementptr %37[%3, %3] : (!llvm.ptr<array<2 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
    %39 = llvm.call @fprintf(%34, %36, %38) : (!llvm.ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>, !llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
    br ^bb4(%c0_i32 : i32)
  ^bb4(%40: i32):  // 2 preds: ^bb3, ^bb5
    %41 = cmpi "slt", %40, %arg1 : i32
    %42 = index_cast %40 : i32 to index
    cond_br %41, ^bb5, ^bb6
  ^bb5:  // pred: ^bb4
    %43 = remi_signed %40, %c20_i32 : i32
    %44 = cmpi "eq", %43, %c0_i32 : i32
    scf.if %44 {
      %65 = llvm.mlir.addressof @stderr : !llvm.ptr<ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>>
      %66 = llvm.load %65 : !llvm.ptr<ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>>
      %67 = llvm.mlir.addressof @str4 : !llvm.ptr<array<2 x i8>>
    ...
    %47 = llvm.mlir.addressof @str5 : !llvm.ptr<array<8 x i8>>
    %48 = llvm.getelementptr %47[%3, %3] : (!llvm.ptr<array<8 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
    %49 = load %arg3[%42] : memref<2100xf64>
    %50 = llvm.mlir.cast %49 : f64 to !llvm.double
    %51 = llvm.call @fprintf(%46, %48, %50) : (!llvm.ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>, !llvm.ptr<i8>, !llvm.double) -> !llvm.i32
    %52 = addi %40, %c1_i32 : i32
    br ^bb4(%52 : i32)
  ^bb6:  // pred: ^bb4
    %53 = llvm.mlir.addressof @stderr : !llvm.ptr<ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>>
    %54 = llvm.load %53 : !llvm.ptr<ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>>
    %55 = llvm.mlir.addressof @str6 : !llvm.ptr<array<17 x i8>>
    %56 = llvm.getelementptr %55[%3, %3] : (!llvm.ptr<array<17 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
    %57 = llvm.mlir.addressof @str7 : !llvm.ptr<array<2 x i8>>
    %58 = llvm.getelementptr %57[%3, %3] : (!llvm.ptr<array<2 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
    %59 = llvm.call @fprintf(%54, %56, %58) : (!llvm.ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>, !llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
    %60 = llvm.mlir.addressof @stderr : !llvm.ptr<ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>>
    %61 = llvm.load %60 : !llvm.ptr<ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>>
    %62 = llvm.mlir.addressof @str8 : !llvm.ptr<array<23 x i8>>
    %63 = llvm.getelementptr %62[%3, %3] : (!llvm.ptr<array<23 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
    %64 = llvm.call @fprintf(%61, %63) : (!llvm.ptr<struct<"struct._IO_FILE", (i32, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, ptr<struct<"struct._IO_marker", (ptr<struct<"struct._IO_marker">>, ptr<struct<"struct._IO_FILE">>, i32, array<4 x i8>)>>, ptr<struct<"struct._IO_FILE">>, i32, i32, i64, i16, i8, array<1 x i8>, ptr<i8>, i64, ptr<i8>, ptr<i8>, ptr<i8>, ptr<i8>, i64, i32, array<20 x i8>)>>, !llvm.ptr<i8>) -> !llvm.i32
    return
  }
  ...
  func @rtclock() -> f64 {
    ...
    scf.if %10 {
      %15 = llvm.mlir.addressof @str9 : !llvm.ptr<array<35 x i8>>
  ...
  func private @S0(%arg0: memref<1900xf64>, %arg1: index) attributes {scop.stmt} {
    %c0_i32 = constant 0 : i32
    %0 = sitofp %c0_i32 : i32 to f64
    affine.store %0, %arg0[%arg1] : memref<1900xf64>
    return
  }
  func private @S1(%arg0: memref<2100xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1] : memref<2100xf64>
    return
  }
  func private @S2(%arg0: memref<1900xf64>, %arg1: index, %arg2: memref<2100x1900xf64>, %arg3: index, %arg4: memref<2100xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<1900xf64>
    %1 = affine.load %arg4[%arg3] : memref<2100xf64>
  ...
  func private @S3(%arg0: memref<2100xf64>, %arg1: index, %arg2: memref<1900xf64>, %arg3: index, %arg4: memref<2100x1900xf64>) attributes {scop.stmt} {
  ...
  func @kernel_bicg_new(%arg0: i32, %arg1: i32, %arg2: memref<2100x1900xf64>, %arg3: memref<1900xf64>, %arg4: memref<2100xf64>, %arg5: memref<1900xf64>, %arg6: memref<2100xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg7 = 0 to #map7()[%1] {
      affine.for %arg8 = #map0(%arg7) to min #map8(%arg7)[%1] {
        call @S1(%arg4, %arg8) : (memref<2100xf64>, index) -> ()
      }
    }
    affine.for %arg7 = 0 to #map9()[%1, %0] {
      affine.for %arg8 = max #map10(%arg7)[%0] to min #map11(%arg7)[%1] {
        affine.for %arg9 = #map0(%arg8) to min #map8(%arg8)[%1] {
          affine.for %arg10 = #map4(%arg7, %arg8) to min #map12(%arg7, %arg8)[%0] {
            call @S3(%arg4, %arg9, %arg5, %arg10, %arg2) : (memref<2100xf64>, index, memref<1900xf64>, index, memref<2100x1900xf64>) -> ()
          }
        }
      }
    }
    affine.for %arg7 = 0 to #map7()[%1] {
      affine.for %arg8 = #map0(%arg7) to min #map8(%arg7)[%1] {
        call @S0(%arg3, %arg8) : (memref<1900xf64>, index) -> ()
      }
    }
    affine.for %arg7 = 0 to #map7()[%0] {
      affine.for %arg8 = 0 to #map7()[%1] {
        affine.for %arg9 = #map0(%arg7) to min #map8(%arg7)[%0] {
          affine.for %arg10 = #map0(%arg8) to min #map8(%arg8)[%1] {
            call @S2(%arg3, %arg10, %arg2, %arg9, %arg6) : (memref<1900xf64>, index, memref<2100x1900xf64>, index, memref<2100xf64>) -> ()
          }
        }
      }
    }
