...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb5:  // pred: ^bb3
    ...
    affine.for %arg2 = 0 to 1900 {
      call @S0(%1, %arg2) : (memref<1900xf64>, index) -> ()
    }
    affine.for %arg2 = 0 to 2100 {
      call @S1(%2, %arg2) : (memref<2100xf64>, index) -> ()
      affine.for %arg3 = 0 to 1900 {
        call @S2(%1, %arg3, %0, %arg2, %4) : (memref<1900xf64>, index, memref<2100x1900xf64>, index, memref<2100xf64>) -> ()
        call @S3(%2, %arg2, %3, %arg3, %0) : (memref<2100xf64>, index, memref<1900xf64>, index, memref<2100x1900xf64>) -> ()
      }
    }
  ...
  func @kernel_bicg_new(%arg0: i32, %arg1: i32, %arg2: memref<2100x1900xf64>, %arg3: memref<1900xf64>, %arg4: memref<2100xf64>, %arg5: memref<1900xf64>, %arg6: memref<2100xf64>) {
    ...
    affine.for %arg7 = 0 to #map3()[%1, %0] {
      affine.for %arg8 = max #map4(%arg7)[%0] to min #map5(%arg7)[%1] {
        affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%1] {
          affine.for %arg10 = #map6(%arg7, %arg8) to min #map7(%arg7, %arg8)[%0] {
    ...
    affine.for %arg7 = 0 to #map0()[%0] {
      affine.for %arg8 = 0 to #map0()[%1] {
        affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%0] {
          affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%1] {
