...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @S0(%arg0: memref<1900xf64>, %arg1: index) attributes {scop.stmt} {
    %c0_i32 = constant 0 : i32
    %0 = sitofp %c0_i32 : i32 to f64
    affine.store %0, %arg0[%arg1] : memref<1900xf64>
    return
  }
  func @S1(%arg0: memref<2100xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1] : memref<2100xf64>
    return
  }
  func @S2(%arg0: memref<1900xf64>, %arg1: index, %arg2: memref<2100x1900xf64>, %arg3: index, %arg4: memref<2100xf64>) attributes {scop.stmt} {
  ...
  func @S3(%arg0: memref<2100xf64>, %arg1: index, %arg2: memref<1900xf64>, %arg3: index, %arg4: memref<2100x1900xf64>) attributes {scop.stmt} {
