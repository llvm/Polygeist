...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c1900_i32, %c2100_i32, %0, %4, %3) : (i32, i32, memref<2100x1900xf64>, memref<2100xf64>, memref<1900xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_bicg_new(%c1900_i32, %c2100_i32, %0, %1, %2, %3, %4) : (i32, i32, memref<2100x1900xf64>, memref<1900xf64>, memref<2100xf64>, memref<1900xf64>, memref<2100xf64>) -> ()
    call @polybench_timer_stop() : () -> ()
    call @polybench_timer_print() : () -> ()
    %5 = cmpi "sgt", %arg0, %c42_i32 : i32
    %6 = scf.if %5 -> (i1) {
      %7 = llvm.load %arg1 : !llvm.ptr<ptr<i8>>
      %8 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %9 = llvm.mlir.constant(0 : index) : !llvm.i64
      %10 = llvm.getelementptr %8[%9, %9] : (!llvm.ptr<array<1 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %11 = llvm.call @strcmp(%7, %10) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
      %12 = llvm.mlir.cast %11 : !llvm.i32 to i32
