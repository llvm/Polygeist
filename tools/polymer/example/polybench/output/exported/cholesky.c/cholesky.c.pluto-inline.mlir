    ...
    affine.for %arg2 = 0 to 125 {
      ...
      affine.if #set0(%arg2) {
        ...
        affine.if #set3(%arg2) {
          ...
          call @S3(%0, %64) : (memref<2000x2000xf64>, index) -> ()
          %65 = affine.apply #map9(%arg2)
          %66 = affine.apply #map11(%arg2)
          call @S1(%0, %65, %66) : (memref<2000x2000xf64>, index, index) -> ()
          %67 = affine.apply #map9(%arg2)
          %68 = affine.apply #map11(%arg2)
          call @S2(%0, %67, %68) : (memref<2000x2000xf64>, index, index) -> ()
          %69 = affine.apply #map9(%arg2)
          call @S3(%0, %69) : (memref<2000x2000xf64>, index) -> ()
          affine.for %arg3 = #map12(%arg2) to min #map10(%arg2) {
            %70 = affine.apply #map11(%arg2)
            call @S1(%0, %arg3, %70) : (memref<2000x2000xf64>, index, index) -> ()
            %71 = affine.apply #map11(%arg2)
            call @S2(%0, %arg3, %71) : (memref<2000x2000xf64>, index, index) -> ()
