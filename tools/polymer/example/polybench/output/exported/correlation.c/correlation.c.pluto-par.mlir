...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_correlation_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<1400x1200xf64>, %arg4: memref<1200x1200xf64>, %arg5: memref<1200xf64>, %arg6: memref<1200xf64>) {
    ...
    affine.for %arg7 = 0 to #map0()[%1] {
      affine.for %arg8 = #map1(%arg7) to %1 {
        call @S13(%arg4, %arg7, %arg8) : (memref<1200x1200xf64>, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to #map0()[%1] {
      call @S10(%arg4, %arg7) : (memref<1200x1200xf64>, index) -> ()
    ...
    affine.for %arg7 = 0 to min #map2()[%0, %1] {
      affine.for %arg8 = 0 to min #map2()[%0, %1] {
        call @S4(%arg6, %arg7, %arg5, %arg3, %arg8) : (memref<1200xf64>, index, memref<1200xf64>, memref<1400x1200xf64>, index) -> ()
        call @S8(%arg3, %arg8, %arg7, %arg5) : (memref<1400x1200xf64>, index, index, memref<1200xf64>) -> ()
      }
    ...
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to %1 {
        call @S9(%arg3, %arg8, %arg7, %arg6, %arg2) : (memref<1400x1200xf64>, index, index, memref<1200xf64>, f64) -> ()
      }
    }
    return
  }
