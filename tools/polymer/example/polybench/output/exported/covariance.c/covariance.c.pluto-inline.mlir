...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb2:  // pred: ^bb1
    ...
    affine.for %arg2 = 0 to 1200 {
      ...
      call @S2(%3, %arg2, %10) : (memref<1200xf64>, index, f64) -> ()
    }
    affine.for %arg2 = 0 to 1400 {
      affine.for %arg3 = 0 to 1200 {
        call @S3(%1, %arg2, %arg3, %3) : (memref<1400x1200xf64>, index, index, memref<1200xf64>) -> ()
      }
    }
    affine.for %arg2 = 0 to 1200 {
      affine.for %arg3 = #map0(%arg2) to 1200 {
        call @S4(%2, %arg2, %arg3) : (memref<1200x1200xf64>, index, index) -> ()
        affine.for %arg4 = 0 to 1400 {
          call @S5(%2, %arg2, %arg3, %1, %arg4) : (memref<1200x1200xf64>, index, index, memref<1400x1200xf64>, index) -> ()
        }
        call @S6(%2, %arg2, %arg3, %10) : (memref<1200x1200xf64>, index, index, f64) -> ()
        call @S7(%2, %arg3, %arg2) : (memref<1200x1200xf64>, index, index) -> ()
      }
    }
