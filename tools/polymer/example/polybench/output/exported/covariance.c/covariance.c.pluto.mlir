...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c1200_i32, %c1400_i32, %4, %1) : (i32, i32, memref<?xf64>, memref<1400x1200xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %5 = load %0[%c0] : memref<1xf64>
    call @kernel_covariance(%c1200_i32, %c1400_i32, %5, %1, %2, %3) : (i32, i32, f64, memref<1400x1200xf64>, memref<1200x1200xf64>, memref<1200xf64>) -> ()
  ...
  func @S3(%arg0: memref<1400x1200xf64>, %arg1: index, %arg2: index, %arg3: memref<1200xf64>) attributes {scop.stmt} {
  ...
  func @S5(%arg0: memref<1200x1200xf64>, %arg1: index, %arg2: index, %arg3: memref<1400x1200xf64>, %arg4: index) attributes {scop.stmt} {
  ...
  func @S6(%arg0: memref<1200x1200xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
  ...
  func @S7(%arg0: memref<1200x1200xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    ...
    affine.for %arg6 = 0 to #map5()[%1, %0] {
      affine.for %arg7 = max #map6(%arg6)[%0] to min #map7(%arg6)[%1] {
        affine.for %arg8 = #map0(%arg7) to #map1()[%1] {
          affine.for %arg9 = #map2(%arg7) to min #map3(%arg7)[%1] {
            affine.for %arg10 = max #map4(%arg8, %arg9) to min #map3(%arg8)[%1] {
