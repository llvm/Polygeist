module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_deriche_new(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<4096x2160xf32>, %arg4: memref<4096x2160xf32>, %arg5: memref<4096x2160xf32>, %arg6: memref<4096x2160xf32>) {
    ...
    affine.for %arg7 = 0 to %18 {
      affine.for %arg8 = 0 to %17 {
        call @S23(%arg4, %arg7, %arg8, %arg6, %arg5, %13) : (memref<4096x2160xf32>, index, index, memref<4096x2160xf32>, memref<4096x2160xf32>, memref<1xf32>) -> ()
      }
    }
    affine.for %arg7 = 0 to %18 {
    ...
    affine.for %arg7 = 0 to %18 {
      affine.for %arg8 = 0 to %17 {
        call @S40(%arg4, %arg7, %arg8, %arg6, %arg5, %13) : (memref<4096x2160xf32>, index, index, memref<4096x2160xf32>, memref<4096x2160xf32>, memref<1xf32>) -> ()
      }
    }
