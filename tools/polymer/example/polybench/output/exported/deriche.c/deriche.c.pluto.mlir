  ...
  func @kernel_deriche_new(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<4096x2160xf32>, %arg4: memref<4096x2160xf32>, %arg5: memref<4096x2160xf32>, %arg6: memref<4096x2160xf32>) {
    ...
    affine.for %arg7 = 0 to %18 {
      ...
      affine.for %arg8 = 0 to %17 {
        call @S18(%arg6, %arg7, %arg8, %17, %10, %3, %16, %5, %15, %14, %9, %11) : (memref<4096x2160xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        ...
        call @S19(%15, %9) : (memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %18 {
      ...
      affine.for %arg8 = 0 to %17 {
        call @S35(%arg6, %arg7, %arg8, %18, %10, %3, %16, %5, %0, %14, %1, %11) : (memref<4096x2160xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
