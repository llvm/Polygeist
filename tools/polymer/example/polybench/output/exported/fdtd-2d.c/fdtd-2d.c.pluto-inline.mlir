...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb4:  // pred: ^bb3
    %12 = get_global_memref @polybench_t_start : memref<1xf64>
    %13 = call @rtclock() : () -> f64
    ...
    affine.for %arg2 = -1 to 32 {
        ...
        affine.if #set1() {
          ...
          affine.for %arg3 = 16 to 47 {
            affine.for %arg4 = max #map0(%arg3) to min #map1(%arg3) {
              %37 = affine.apply #map2(%arg4)[%c500]
              call @S1(%1, %c499, %37, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            }
            affine.for %arg4 = max #map0(%arg3) to min #map1(%arg3) {
              %37 = affine.apply #map3(%arg4)[%c500]
              call @S3(%2, %c499, %37, %1, %0) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg3 = max #map4(%arg2) to min #map5(%arg2) {
          ...
          affine.if #set3(%arg2) {
            affine.for %arg4 = max #map6(%arg2) to #map7(%arg2) {
              affine.for %arg5 = #map8(%arg2) to min #map9(%arg2, %arg4) {
                affine.if #set4(%arg2) {
                  %37 = affine.apply #map10(%arg4, %arg5)
                  call @S0(%1, %arg4, %3, %37) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
                }
              }
            }
            affine.if #set4(%arg2) {
              %37 = affine.apply #map7(%arg2)
              call @S2(%0, %37, %c0, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            }
            affine.for %arg4 = #map8(%arg2) to min #map11(%arg2) {
              affine.if #set4(%arg2) {
                %37 = affine.apply #map7(%arg2)
                %38 = affine.apply #map12(%arg2, %arg4)
                call @S0(%1, %37, %3, %38) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
              }
            }
          }
        }
        affine.for %arg4 = max #map13(%arg2, %arg3) to min #map14(%arg2) {
          affine.if #set5(%arg2, %arg3, %arg4) {
            affine.if #set6(%arg2) {
              %37 = affine.apply #map15(%arg2)
              call @S0(%1, %37, %3, %c0) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
            }
            affine.for %arg5 = #map16(%arg2) to min #map17(%arg2) {
              affine.if #set6(%arg2) {
                %37 = affine.apply #map15(%arg2)
                %38 = affine.apply #map18(%arg2, %arg5)
                call @S1(%1, %37, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              }
            }
            affine.for %arg5 = #map16(%arg2) to min #map17(%arg2) {
              affine.if #set6(%arg2) {
                %37 = affine.apply #map15(%arg2)
                %38 = affine.apply #map19(%arg2, %arg5)
                call @S3(%2, %37, %38, %1, %0) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
              }
            }
          }
          affine.for %arg5 = max #map20(%arg2, %arg3, %arg4) to #map21(%arg3) {
            affine.for %arg6 = #map22(%arg3) to min #map23(%arg2, %arg3, %arg5) {
              %37 = affine.apply #map10(%arg5, %arg6)
              call @S0(%1, %arg5, %3, %37) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
            }
          }
          affine.for %arg5 = max #map24(%arg2, %arg3, %arg4) to #map25(%arg3) {
            affine.for %arg6 = #map22(%arg3) to min #map26(%arg2, %arg3, %arg5) {
              ...
              affine.for %arg7 = #map27(%arg5) to min #map28(%arg4, %arg5) {
                %37 = affine.apply #map29(%arg5, %arg7)
                call @S3(%2, %arg5, %37, %1, %0) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
                %38 = affine.apply #map10(%arg5, %arg7)
                call @S1(%1, %arg5, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
                %39 = affine.apply #map10(%arg5, %arg7)
                call @S2(%0, %arg5, %39, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              }
            }
            affine.if #set7(%arg2, %arg3, %arg5) {
              affine.for %arg6 = #map27(%arg5) to min #map28(%arg4, %arg5) {
                %37 = affine.apply #map29(%arg5, %arg6)
                call @S3(%2, %arg5, %37, %1, %0) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
              }
            }
          }
            ...
            affine.for %arg5 = max #map30(%arg2, %arg3) to #map31(%arg2) {
              affine.for %arg6 = #map22(%arg3) to min #map26(%arg2, %arg3, %arg5) {
                affine.for %arg7 = #map31(%arg2) to min #map32(%arg2, %arg5) {
                  ...
                  affine.if #set3(%arg2) {
                    %37 = affine.apply #map10(%arg5, %arg7)
                    call @S1(%1, %arg5, %37, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
                  }
                  affine.if #set3(%arg2) {
                    %37 = affine.apply #map10(%arg5, %arg7)
                    call @S2(%0, %arg5, %37, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
                  }
                }
              }
              affine.if #set7(%arg2, %arg3, %arg5) {
          ...
          affine.for %arg5 = max #map33(%arg2, %arg3, %arg4) to min #map34(%arg2, %arg3, %arg4) {
            affine.if #set9(%arg2, %arg3, %arg5) {
              call @S2(%0, %arg5, %c0, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              %37 = affine.apply #map35(%arg2, %arg3, %arg5)
              call @S0(%1, %arg5, %3, %37) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
              affine.for %arg6 = #map27(%arg5) to min #map28(%arg4, %arg5) {
                %38 = affine.apply #map10(%arg5, %arg6)
                call @S1(%1, %arg5, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
                %39 = affine.apply #map10(%arg5, %arg6)
                call @S2(%0, %arg5, %39, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              }
            }
            affine.if #set5(%arg2, %arg3, %arg4) {
            ...
            affine.for %arg6 = max #map37(%arg2, %arg3, %arg5) to min #map38(%arg2, %arg3, %arg5) {
              ...
              call @S0(%1, %arg5, %3, %37) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
              affine.for %arg7 = #map27(%arg5) to min #map28(%arg4, %arg5) {
                %38 = affine.apply #map29(%arg5, %arg7)
                call @S3(%2, %arg5, %38, %1, %0) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
                %39 = affine.apply #map10(%arg5, %arg7)
                call @S1(%1, %arg5, %39, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
                %40 = affine.apply #map10(%arg5, %arg7)
                call @S2(%0, %arg5, %40, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              }
            }
          ...
          affine.if #set11(%arg2, %arg3, %arg4) {
            %37 = affine.apply #map43(%arg2, %arg3)[%c1200]
            call @S2(%0, %37, %c0, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            %38 = affine.apply #map43(%arg2, %arg3)[%c1200]
            call @S0(%1, %38, %3, %c1199) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
            affine.for %arg5 = #map44(%arg2, %arg3) to min #map45(%arg2, %arg3, %arg4) {
              %39 = affine.apply #map43(%arg2, %arg3)[%c1200]
              %40 = affine.apply #map46(%arg2, %arg3, %arg5)[%c1200]
              call @S1(%1, %39, %40, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              %41 = affine.apply #map43(%arg2, %arg3)[%c1200]
              %42 = affine.apply #map46(%arg2, %arg3, %arg5)[%c1200]
              call @S2(%0, %41, %42, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            }
            affine.for %arg5 = #map47(%arg2, %arg3) to min #map48(%arg2, %arg3) {
              %39 = affine.apply #map43(%arg2, %arg3)[%c1200]
              %40 = affine.apply #map46(%arg2, %arg3, %arg5)[%c1200]
              call @S0(%1, %39, %3, %40) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
            }
          }
          affine.if #set12(%arg2, %arg3, %arg4) {
            affine.if #set3(%arg2) {
              %37 = affine.apply #map49(%arg2)
              call @S2(%0, %37, %c0, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            }
            affine.if #set3(%arg2) {
              %37 = affine.apply #map49(%arg2)
              %38 = affine.apply #map50(%arg2, %arg3)
              call @S0(%1, %37, %3, %38) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
            }
            affine.for %arg5 = #map51(%arg2) to #map52(%arg2) {
              affine.if #set3(%arg2) {
                %37 = affine.apply #map49(%arg2)
                %38 = affine.apply #map53(%arg2, %arg5)
                call @S1(%1, %37, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              }
              affine.if #set3(%arg2) {
                %37 = affine.apply #map49(%arg2)
                %38 = affine.apply #map53(%arg2, %arg5)
                call @S2(%0, %37, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              }
            }
          }
          ...
          affine.if #set13(%arg2, %arg3, %arg4) {
            affine.for %arg5 = max #map56(%arg2, %arg3, %arg4) to min #map57(%arg2, %arg3, %arg4) {
              %37 = affine.apply #map58(%arg4)
              call @S2(%0, %37, %c0, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              %38 = affine.apply #map58(%arg4)
              %39 = affine.apply #map59(%arg4, %arg5)
              call @S0(%1, %38, %3, %39) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
            }
            affine.if #set14(%arg2, %arg4) {
              affine.for %arg5 = #map60(%arg2) to min #map61(%arg2, %arg3) {
                affine.if #set3(%arg2) {
                  %37 = affine.apply #map7(%arg2)
                  %38 = affine.apply #map12(%arg2, %arg5)
                  call @S0(%1, %37, %3, %38) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
                }
              }
            }
          ...
          affine.for %arg5 = #map64(%arg2, %arg3) to min #map65(%arg2, %arg3, %arg4) {
            ...
            affine.for %arg6 = #map27(%arg5) to min #map28(%arg4, %arg5) {
              ...
              call @S1(%1, %arg5, %37, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              %38 = affine.apply #map10(%arg5, %arg6)
              call @S2(%0, %arg5, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            }
          ...
          affine.if #set17(%arg2, %arg3, %arg4) {
            ...
            affine.for %arg5 = #map44(%arg2, %arg3) to min #map45(%arg2, %arg3, %arg4) {
              %38 = affine.apply #map43(%arg2, %arg3)[%c1200]
              %39 = affine.apply #map46(%arg2, %arg3, %arg5)[%c1200]
              call @S1(%1, %38, %39, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              %40 = affine.apply #map43(%arg2, %arg3)[%c1200]
              %41 = affine.apply #map46(%arg2, %arg3, %arg5)[%c1200]
              call @S2(%0, %40, %41, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            }
          }
            ...
            affine.for %arg4 = max #map69(%arg2, %arg3) to 500 {
              affine.for %arg5 = #map22(%arg3) to min #map26(%arg2, %arg3, %arg4) {
                affine.for %arg6 = #map31(%arg2) to min #map32(%arg2, %arg4) {
                  %37 = affine.apply #map29(%arg4, %arg6)
                  call @S3(%2, %arg4, %37, %1, %0) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
                  %38 = affine.apply #map10(%arg4, %arg6)
                  call @S1(%1, %arg4, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
                  %39 = affine.apply #map10(%arg4, %arg6)
                  call @S2(%0, %arg4, %39, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
                }
              }
              affine.if #set7(%arg2, %arg3, %arg4) {
                affine.for %arg5 = #map31(%arg2) to min #map32(%arg2, %arg4) {
                  %37 = affine.apply #map29(%arg4, %arg5)
                  call @S3(%2, %arg4, %37, %1, %0) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
                }
              }
            }
        ...
        affine.for %arg4 = #map70(%arg2) to min #map71(%arg2, %arg3) {
          ...
          affine.if #set23(%arg2, %arg3) {
            affine.for %arg5 = #map22(%arg4) to min #map75(%arg2, %arg4) {
              ...
              %38 = affine.apply #map53(%arg2, %arg5)
              call @S1(%1, %37, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              %39 = affine.apply #map49(%arg2)
              %40 = affine.apply #map53(%arg2, %arg5)
              call @S2(%0, %39, %40, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            }
          }
          affine.if #set24(%arg2, %arg3) {
            affine.for %arg5 = #map22(%arg4) to min #map45(%arg2, %arg3, %arg4) {
              %37 = affine.apply #map43(%arg2, %arg3)[%c1200]
              %38 = affine.apply #map46(%arg2, %arg3, %arg5)[%c1200]
              call @S1(%1, %37, %38, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
              %39 = affine.apply #map43(%arg2, %arg3)[%c1200]
              %40 = affine.apply #map46(%arg2, %arg3, %arg5)[%c1200]
              call @S2(%0, %39, %40, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
        ...
        affine.if #set23(%arg2, %arg3) {
          affine.if #set26(%arg2) {
            %37 = affine.apply #map49(%arg2)
            call @S1(%1, %37, %c999, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            %38 = affine.apply #map49(%arg2)
            call @S2(%0, %38, %c999, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
          }
        }
        affine.if #set24(%arg2, %arg3) {
          affine.if #set27() {
        ...
        affine.if #set29() {
          ...
          affine.for %arg3 = 1 to -199 {
            affine.for %arg4 = #map76(%arg3) to min #map77(%arg3) {
              %37 = affine.apply #map10(%arg3, %arg4)
              call @S0(%1, %arg3, %3, %37) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
            }
          }
          affine.for %arg3 = 1 to 32 {
      ...
      affine.if #set30(%arg2) {
        %37 = affine.apply #map79(%arg2)
        affine.if #set31(%37) {
          affine.for %arg3 = max #map80(%arg2) to 500 {
            affine.for %arg4 = 1728 to min #map81(%arg2, %arg3) {
              %38 = affine.apply #map10(%arg3, %arg4)
              call @S0(%1, %arg3, %3, %38) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
            }
          }
        }
      }
    ...
    %14 = get_global_memref @polybench_t_end : memref<1xf64>
    %15 = call @rtclock() : () -> f64
    ...
    return %c0_i32 : i32
  ^bb5(%18: i32):  // 2 preds: ^bb3, ^bb6
    %19 = cmpi "slt", %18, %c1200_i32 : i32
    %20 = index_cast %18 : i32 to index
    cond_br %19, ^bb6, ^bb7
  ^bb6:  // pred: ^bb5
    %21 = sitofp %9 : i32 to f64
    %22 = addi %18, %c1_i32 : i32
    %23 = sitofp %22 : i32 to f64
    %24 = mulf %21, %23 : f64
    %25 = sitofp %c1000_i32 : i32 to f64
    %26 = divf %24, %25 : f64
    store %26, %0[%11, %20] : memref<1000x1200xf64>
    %27 = addi %18, %c2_i32 : i32
    %28 = sitofp %27 : i32 to f64
    %29 = mulf %21, %28 : f64
    %30 = sitofp %c1200_i32 : i32 to f64
    %31 = divf %29, %30 : f64
    store %31, %1[%11, %20] : memref<1000x1200xf64>
    %32 = addi %18, %c3_i32 : i32
    %33 = sitofp %32 : i32 to f64
    %34 = mulf %21, %33 : f64
    %35 = divf %34, %25 : f64
    store %35, %2[%11, %20] : memref<1000x1200xf64>
    br ^bb5(%22 : i32)
  ^bb7:  // pred: ^bb5
    %36 = addi %9, %c1_i32 : i32
    br ^bb3(%36 : i32)
  }
