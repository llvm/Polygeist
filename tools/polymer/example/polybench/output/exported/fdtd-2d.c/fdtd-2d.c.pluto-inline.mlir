  ...
  ^bb4:  // pred: ^bb3
    ...
    affine.for %arg2 = 0 to 500 {
      affine.for %arg3 = 0 to 1200 {
        call @S0(%1, %arg3, %3, %arg2) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
      }
      affine.for %arg3 = 1 to 1000 {
        affine.for %arg4 = 0 to 1200 {
          call @S1(%1, %arg3, %arg4, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
        }
      }
      affine.for %arg3 = 0 to 1000 {
        affine.for %arg4 = 1 to 1200 {
          call @S2(%0, %arg3, %arg4, %2) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
        }
      }
      affine.for %arg3 = 0 to 999 {
        affine.for %arg4 = 0 to 1199 {
          call @S3(%2, %arg3, %arg4, %1, %0) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
        }
      }
    }
