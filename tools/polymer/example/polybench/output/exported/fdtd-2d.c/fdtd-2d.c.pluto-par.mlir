...
#map4 = affine_map<(d0)[s0] -> ((d0 + s0 * 2 - 3) floordiv 2 + 1)>
#map5 = affine_map<(d0) -> ((d0 - 1) ceildiv 2)>
#map6 = affine_map<(d0, d1) -> ((-d0 + d1 * 2 - 1) ceildiv 2)>
#map7 = affine_map<(d0) -> (d0 ceildiv 2)>
#map8 = affine_map<(d0) -> ((d0 + 2) ceildiv 2)>
#map9 = affine_map<(d0)[s0] -> (d0 floordiv 2 + s0)>
#map10 = affine_map<(d0, d1) -> ((-d0 + d1 * 2) ceildiv 2)>
#map11 = affine_map<(d0)[s0, s1] -> (d0 floordiv 2 + s0, d0 floordiv 2 + s1)>
#map12 = affine_map<(d0)[s0] -> ((d0 + s0 * 2 - 1) ceildiv 2)>
#map13 = affine_map<()[s0, s1] -> (s0 + s1 - 1)>
#map14 = affine_map<(d0)[s0] -> (d0 - s0)>
#set0 = affine_set<(d0) : ((d0 + 1) mod 2 == 0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_fdtd_2d_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<1000x1200xf64>, %arg4: memref<1000x1200xf64>, %arg5: memref<1000x1200xf64>, %arg6: memref<500xf64>) {
    ...
    %1 = index_cast %arg1 : i32 to index
    %2 = index_cast %arg0 : i32 to index
    call @S0(%arg4, %c0, %arg6, %c0) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
    affine.for %arg7 = 1 to %1 {
      call @S1(%arg4, %c0, %arg7, %arg5) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
    }
    affine.for %arg7 = 1 to min #map1()[%1, %0] {
      call @S2(%arg3, %c0, %c0, %arg5) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
      call @S0(%arg4, %c0, %arg6, %arg7) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
      affine.for %arg8 = 1 to %1 {
    ...
    affine.for %arg7 = 1 to #map2()[%2] {
      affine.for %arg8 = #map3(%arg7) to #map4(%arg7)[%0] {
        affine.for %arg9 = #map3(%arg7) to #map4(%arg7)[%1] {
          affine.if #set0(%arg7) {
            %3 = affine.apply #map5(%arg7)
            %4 = affine.apply #map6(%arg7, %arg9)
            call @S3(%arg5, %3, %4, %arg4, %arg3) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
          }
        }
      }
      affine.if #set1(%arg7) {
        %3 = affine.apply #map7(%arg7)
        call @S0(%arg4, %3, %arg6, %c0) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
        affine.for %arg8 = #map8(%arg7) to #map9(%arg7)[%1] {
          %4 = affine.apply #map7(%arg7)
          %5 = affine.apply #map10(%arg7, %arg8)
          call @S1(%arg4, %4, %5, %arg5) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
        }
      }
      affine.for %arg8 = #map8(%arg7) to min #map11(%arg7)[%1, %0] {
        affine.if #set1(%arg7) {
          %3 = affine.apply #map7(%arg7)
          call @S2(%arg3, %3, %c0, %arg5) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
          %4 = affine.apply #map7(%arg7)
          %5 = affine.apply #map10(%arg7, %arg8)
          call @S0(%arg4, %4, %arg6, %5) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
        }
        affine.for %arg9 = #map8(%arg7) to #map9(%arg7)[%1] {
          affine.if #set1(%arg7) {
            %3 = affine.apply #map7(%arg7)
            %4 = affine.apply #map10(%arg7, %arg9)
            call @S1(%arg4, %3, %4, %arg5) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
            %5 = affine.apply #map7(%arg7)
            %6 = affine.apply #map10(%arg7, %arg9)
            call @S2(%arg3, %5, %6, %arg5) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
          }
        }
      }
      affine.for %arg8 = #map12(%arg7)[%0] to #map9(%arg7)[%1] {
        affine.if #set1(%arg7) {
          %3 = affine.apply #map7(%arg7)
          %4 = affine.apply #map10(%arg7, %arg8)
          call @S0(%arg4, %3, %arg6, %4) : (memref<1000x1200xf64>, index, memref<500xf64>, index) -> ()
        }
      }
      affine.for %arg8 = #map12(%arg7)[%1] to #map9(%arg7)[%0] {
        affine.if #set1(%arg7) {
          %3 = affine.apply #map7(%arg7)
          call @S2(%arg3, %3, %c0, %arg5) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>) -> ()
        }
    ...
    affine.for %arg7 = %2 to #map13()[%2, %0] {
      affine.for %arg8 = %2 to #map13()[%2, %1] {
        %3 = affine.apply #map0()[%2]
        %4 = affine.apply #map14(%arg8)[%2]
        call @S3(%arg5, %3, %4, %arg4, %arg3) : (memref<1000x1200xf64>, index, index, memref<1000x1200xf64>, memref<1000x1200xf64>) -> ()
      }
    }
    return
