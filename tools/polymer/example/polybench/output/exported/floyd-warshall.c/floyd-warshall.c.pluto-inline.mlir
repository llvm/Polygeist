...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb3(%10: i32):  // 2 preds: ^bb1, ^bb4
    %11 = cmpi "slt", %10, %c2800_i32 : i32
    %12 = index_cast %10 : i32 to index
    cond_br %11, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %13 = muli %1, %10 : i32
    %14 = remi_signed %13, %c7_i32 : i32
    %15 = addi %14, %c1_i32 : i32
    store %15, %0[%3, %12] : memref<2800x2800xi32>
    %16 = addi %1, %10 : i32
    %17 = remi_signed %16, %c13_i32 : i32
    %18 = cmpi "eq", %17, %c0_i32 : i32
    %19 = scf.if %18 -> (i1) {
      scf.yield %true : i1
    } else {
      %23 = remi_signed %16, %c7_i32 : i32
    ...
    %20 = scf.if %19 -> (i1) {
      ...
      %23 = remi_signed %16, %c11_i32 : i32
      %24 = cmpi "eq", %23, %c0_i32 : i32
      scf.yield %24 : i1
    }
    scf.if %20 {
      store %c999_i32, %0[%3, %12] : memref<2800x2800xi32>
    }
