#map0 = affine_map<()[s0] -> (s0 * 2 - 1)>
#map1 = affine_map<(d0)[s0] -> (0, d0 - s0 + 1)>
#map2 = affine_map<(d0)[s0] -> (d0 + 1, s0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_floyd_warshall(%c2800_i32, %0) : (i32, memref<2800x2800xi32>) -> ()
    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map0()[%0] {
        affine.for %arg4 = max #map1(%arg3)[%0] to min #map2(%arg3)[%0] {
          %1 = affine.apply #map3(%arg3, %arg4)
          call @S0(%arg1, %arg2, %1, %arg4) : (memref<2800x2800xi32>, index, index, index) -> ()
        }
      }
    }
    return
