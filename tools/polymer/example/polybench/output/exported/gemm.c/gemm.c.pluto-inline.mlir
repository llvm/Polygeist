...
#map3 = affine_map<(d0) -> (1100, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %2 = alloc() : memref<1000x1100xf64>
    %3 = alloc() : memref<1000x1200xf64>
    %4 = alloc() : memref<1200x1100xf64>
  ...
  ^bb2(%8: i32):  // 2 preds: ^bb1, ^bb3
    %9 = cmpi "slt", %8, %c1100_i32 : i32
    %10 = index_cast %8 : i32 to index
    cond_br %9, ^bb3, ^bb4
  ^bb3:  // pred: ^bb2
    %11 = muli %5, %8 : i32
    %12 = addi %11, %c1_i32 : i32
    %13 = remi_signed %12, %c1000_i32 : i32
    %14 = sitofp %13 : i32 to f64
    %15 = sitofp %c1000_i32 : i32 to f64
    %16 = divf %14, %15 : f64
    store %16, %2[%7, %10] : memref<1000x1100xf64>
  ...
  ^bb7:  // pred: ^bb6
    ...
    %30 = divf %28, %29 : f64
    store %30, %3[%21, %24] : memref<1000x1200xf64>
    br ^bb6(%25 : i32)
  ^bb8:  // pred: ^bb6
  ...
  ^bb10:  // pred: ^bb9
    %35 = get_global_memref @polybench_t_start : memref<1xf64>
    %36 = call @rtclock() : () -> f64
    store %36, %35[%c0] : memref<1xf64>
    %37 = load %0[%c0] : memref<1xf64>
    %38 = load %1[%c0] : memref<1xf64>
    affine.for %arg2 = 0 to 32 {
      affine.for %arg3 = 0 to 38 {
        affine.for %arg4 = #map0(%arg2) to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map2(%arg3) {
            call @S0(%2, %arg4, %arg5, %38) : (memref<1000x1100xf64>, index, index, f64) -> ()
          }
        }
      }
    }
          ...
          affine.for %arg5 = #map0(%arg2) to min #map3(%arg2) {
            affine.for %arg6 = #map0(%arg4) to min #map1(%arg4) {
              affine.for %arg7 = #map0(%arg3) to min #map2(%arg3) {
                call @S1(%2, %arg6, %arg7, %4, %arg5, %37, %3) : (memref<1000x1100xf64>, index, index, memref<1200x1100xf64>, index, f64, memref<1000x1200xf64>) -> ()
              }
            }
          }
        }
    ...
    %39 = get_global_memref @polybench_t_end : memref<1xf64>
    %40 = call @rtclock() : () -> f64
    store %40, %39[%c0] : memref<1xf64>
    call @polybench_timer_print() : () -> ()
    %41 = cmpi "sgt", %arg0, %c42_i32 : i32
    %42 = scf.if %41 -> (i1) {
      %54 = llvm.load %arg1 : !llvm.ptr<ptr<i8>>
      %55 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %56 = llvm.mlir.constant(0 : index) : !llvm.i64
      %57 = llvm.getelementptr %55[%56, %56] : (!llvm.ptr<array<1 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %58 = llvm.call @strcmp(%54, %57) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
      %59 = llvm.mlir.cast %58 : !llvm.i32 to i32
      %60 = trunci %59 : i32 to i1
      %61 = xor %60, %true : i1
      scf.yield %61 : i1
    } else {
      scf.yield %false : i1
    ...
    scf.if %42 {
      call @print_array(%c1000_i32, %c1100_i32, %2) : (i32, i32, memref<1000x1100xf64>) -> ()
    }
    return %c0_i32 : i32
  ^bb11(%43: i32):  // 2 preds: ^bb9, ^bb12
    %44 = cmpi "slt", %43, %c1100_i32 : i32
    %45 = index_cast %43 : i32 to index
    cond_br %44, ^bb12, ^bb13
  ^bb12:  // pred: ^bb11
    %46 = addi %43, %c2_i32 : i32
    %47 = muli %32, %46 : i32
    %48 = remi_signed %47, %c1100_i32 : i32
    %49 = sitofp %48 : i32 to f64
    %50 = sitofp %c1100_i32 : i32 to f64
    %51 = divf %49, %50 : f64
    store %51, %4[%34, %45] : memref<1200x1100xf64>
    %52 = addi %43, %c1_i32 : i32
    br ^bb11(%52 : i32)
  ^bb13:  // pred: ^bb11
    %53 = addi %32, %c1_i32 : i32
    br ^bb9(%53 : i32)
  }
  func @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<1000x1100xf64>, %arg6: memref<1000x1200xf64>, %arg7: memref<1200x1100xf64>) {
    %c0 = constant 0 : index
    %cst = constant 1.500000e+00 : f64
    %cst_0 = constant 1.200000e+00 : f64
    %c0_i32 = constant 0 : i32
  ...
  ^bb3:  // pred: ^bb2
    ...
    %11 = divf %9, %10 : f64
    store %11, %arg5[%2, %5] : memref<1000x1100xf64>
  ...
  ^bb7:  // pred: ^bb6
    ...
    %25 = divf %23, %24 : f64
    store %25, %arg6[%16, %19] : memref<1000x1200xf64>
    br ^bb6(%20 : i32)
  ^bb8:  // pred: ^bb6
  ...
  ^bb12:  // pred: ^bb11
    ...
    %38 = divf %36, %37 : f64
    store %38, %arg7[%29, %32] : memref<1200x1100xf64>
    ...
    affine.for %arg8 = 0 to %0 {
      ...
      affine.for %arg9 = 0 to %2 {
        affine.for %arg10 = 0 to %1 {
          call @S1(%arg5, %arg8, %arg10, %arg7, %arg9, %arg3, %arg6) : (memref<1000x1100xf64>, index, index, memref<1200x1100xf64>, index, f64, memref<1000x1200xf64>) -> ()
        }
      }
    }
    return
  ...
  func @print_array(%arg0: i32, %arg1: i32, %arg2: memref<1000x1100xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    %39 = load %arg2[%15, %30] : memref<1000x1100xf64>
  ...
  func private @S0(%arg0: memref<1000x1100xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<1000x1100xf64>
    %1 = mulf %0, %arg3 : f64
    affine.store %1, %arg0[%arg1, %arg2] : memref<1000x1100xf64>
    return
  }
  func private @S1(%arg0: memref<1000x1100xf64>, %arg1: index, %arg2: index, %arg3: memref<1200x1100xf64>, %arg4: index, %arg5: f64, %arg6: memref<1000x1200xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<1000x1100xf64>
    %1 = affine.load %arg6[%arg1, %arg4] : memref<1000x1200xf64>
    %2 = mulf %arg5, %1 : f64
    %3 = affine.load %arg3[%arg4, %arg2] : memref<1200x1100xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
    affine.store %5, %arg0[%arg1, %arg2] : memref<1000x1100xf64>
    return
  }
          ...
          affine.for %arg11 = #map0(%arg8) to min #map5(%arg8)[%0] {
            affine.for %arg12 = #map0(%arg10) to min #map5(%arg10)[%2] {
              affine.for %arg13 = #map0(%arg9) to min #map5(%arg9)[%1] {
                call @S1(%arg5, %arg12, %arg13, %arg7, %arg11, %arg3, %arg6) : (memref<1000x1100xf64>, index, index, memref<1200x1100xf64>, index, f64, memref<1000x1200xf64>) -> ()
              }
            }
          }
        }
