...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb3:  // pred: ^bb1
    ...
    %16 = load %0[%c0] : memref<1xf64>
    %17 = load %1[%c0] : memref<1xf64>
    affine.for %arg2 = 0 to 1300 {
      call @S0(%4, %arg2) : (memref<1300xf64>, index) -> ()
      call @S1(%6, %arg2) : (memref<1300xf64>, index) -> ()
      affine.for %arg3 = 0 to 1300 {
        call @S2(%4, %arg2, %5, %arg3, %2) : (memref<1300xf64>, index, memref<1300xf64>, index, memref<1300x1300xf64>) -> ()
        call @S3(%6, %arg2, %5, %arg3, %3) : (memref<1300xf64>, index, memref<1300xf64>, index, memref<1300x1300xf64>) -> ()
      }
      call @S4(%6, %arg2, %17, %16, %4) : (memref<1300xf64>, index, f64, f64, memref<1300xf64>) -> ()
    }
    ...
    %21 = scf.if %20 -> (i1) {
      %36 = llvm.load %arg1 : !llvm.ptr<ptr<i8>>
      %37 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %38 = llvm.mlir.constant(0 : index) : !llvm.i64
      %39 = llvm.getelementptr %37[%38, %38] : (!llvm.ptr<array<1 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %40 = llvm.call @strcmp(%36, %39) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
      %41 = llvm.mlir.cast %40 : !llvm.i32 to i32
      %42 = trunci %41 : i32 to i1
      %43 = xor %42, %true : i1
      scf.yield %43 : i1
    } else {
      scf.yield %false : i1
  ...
  ^bb4(%22: i32):  // 2 preds: ^bb2, ^bb5
    %23 = cmpi "slt", %22, %c1300_i32 : i32
    %24 = index_cast %22 : i32 to index
    cond_br %23, ^bb5, ^bb6
  ^bb5:  // pred: ^bb4
    %25 = muli %7, %22 : i32
    %26 = addi %25, %c1_i32 : i32
    %27 = remi_signed %26, %c1300_i32 : i32
    %28 = sitofp %27 : i32 to f64
    %29 = divf %28, %12 : f64
    store %29, %2[%9, %24] : memref<1300x1300xf64>
    %30 = addi %25, %c2_i32 : i32
    %31 = remi_signed %30, %c1300_i32 : i32
    %32 = sitofp %31 : i32 to f64
    %33 = divf %32, %12 : f64
    store %33, %3[%9, %24] : memref<1300x1300xf64>
    %34 = addi %22, %c1_i32 : i32
    br ^bb4(%34 : i32)
  ^bb6:  // pred: ^bb4
    %35 = addi %7, %c1_i32 : i32
    br ^bb1(%35 : i32)
  }
