  ...
  ^bb2:  // pred: ^bb1
    ...
    affine.for %arg2 = 1 to 501 {
      affine.for %arg3 = 1 to 119 {
        affine.for %arg4 = 1 to 119 {
          affine.for %arg5 = 1 to 119 {
            call @S0(%1, %arg3, %arg4, %arg5, %0) : (memref<120x120x120xf64>, index, index, index, memref<120x120x120xf64>) -> ()
          }
        }
      }
      affine.for %arg3 = 1 to 119 {
        affine.for %arg4 = 1 to 119 {
          affine.for %arg5 = 1 to 119 {
            call @S1(%0, %arg3, %arg4, %arg5, %1) : (memref<120x120x120xf64>, index, index, index, memref<120x120x120xf64>) -> ()
          }
        }
      }
    }
