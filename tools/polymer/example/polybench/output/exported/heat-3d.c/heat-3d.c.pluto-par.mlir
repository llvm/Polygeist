...
#map3 = affine_map<(d0) -> ((d0 + 2) ceildiv 2)>
#map4 = affine_map<(d0)[s0] -> (d0 floordiv 2 + s0 - 1)>
#map5 = affine_map<(d0) -> ((d0 - 2) ceildiv 4)>
#map6 = affine_map<(d0, d1) -> ((-d0 + d1 * 2) ceildiv 2)>
#map7 = affine_map<(d0) -> (d0 ceildiv 4)>
#map8 = affine_map<()[s0] -> (s0 + 1000)>
#map9 = affine_map<(d0) -> (d0 - 1001)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_heat_3d_new(%arg0: i32, %arg1: i32, %arg2: memref<120x120x120xf64>, %arg3: memref<120x120x120xf64>) {
    ...
    %0 = index_cast %arg1 : i32 to index
    affine.for %arg4 = 3 to #map1()[%0] {
      affine.for %arg5 = 3 to #map1()[%0] {
        affine.for %arg6 = 3 to #map1()[%0] {
    ...
    affine.for %arg4 = 6 to 2001 {
      affine.for %arg5 = #map3(%arg4) to #map4(%arg4)[%0] {
        affine.for %arg6 = #map3(%arg4) to #map4(%arg4)[%0] {
          affine.for %arg7 = #map3(%arg4) to #map4(%arg4)[%0] {
            affine.if #set0(%arg4) {
              %1 = affine.apply #map5(%arg4)
              %2 = affine.apply #map6(%arg4, %arg5)
              %3 = affine.apply #map6(%arg4, %arg6)
    ...
    affine.for %arg4 = 1002 to #map8()[%0] {
      affine.for %arg5 = 1002 to #map8()[%0] {
        affine.for %arg6 = 1002 to #map8()[%0] {
          %1 = affine.apply #map9(%arg4)
          %2 = affine.apply #map9(%arg5)
