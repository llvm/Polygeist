...
#map2 = affine_map<()[s0] -> (s0 * 4 - 3)>
#map3 = affine_map<(d0)[s0] -> ((d0 - s0 * 2 + 4) ceildiv 2)>
#map4 = affine_map<(d0) -> (d0 floordiv 2)>
#map5 = affine_map<(d0) -> ((d0 - 2) ceildiv 4)>
#map6 = affine_map<(d0) -> (d0 ceildiv 4)>
#map7 = affine_map<()[s0, s1] -> (s0 * 2 - s1 + 1)>
#map8 = affine_map<()[s0] -> (s0 * 2 - 1)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_jacobi_1d_new(%arg0: i32, %arg1: i32, %arg2: memref<2000xf64>, %arg3: memref<2000xf64>) {
    ...
    %0 = index_cast %arg1 : i32 to index
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg4 = #map1()[%0] to 0 {
      call @S0(%arg3, %c0, %arg2) : (memref<2000xf64>, index, memref<2000xf64>) -> ()
    }
    affine.for %arg4 = 2 to #map2()[%1] {
      affine.for %arg5 = #map3(%arg4)[%0] to #map4(%arg4) {
        affine.if #set0(%arg4) {
        ...
        affine.if #set1(%arg4) {
          ...
          call @S0(%arg3, %2, %arg2) : (memref<2000xf64>, index, memref<2000xf64>) -> ()
        }
      }
    }
    affine.for %arg4 = #map7()[%1, %0] to #map8()[%1] {
