...
#map1 = affine_map<()[s0] -> (s0 * 4 - 3)>
#map2 = affine_map<(d0) -> ((d0 + 2) ceildiv 2)>
#map3 = affine_map<(d0)[s0] -> (d0 floordiv 2 + s0 - 1)>
#map4 = affine_map<(d0) -> ((d0 - 2) ceildiv 4)>
#map5 = affine_map<(d0, d1) -> ((-d0 + d1 * 2) ceildiv 2)>
#map6 = affine_map<(d0) -> (d0 ceildiv 4)>
#map7 = affine_map<()[s0] -> (s0 * 2)>
#map8 = affine_map<()[s0, s1] -> (s0 * 2 + s1 - 2)>
#map9 = affine_map<(d0)[s0] -> (d0 - s0 * 2 + 1)>
#set0 = affine_set<(d0) : ((d0 + 2) mod 4 == 0)>
#set1 = affine_set<(d0) : (d0 mod 4 == 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_jacobi_2d_new(%arg0: i32, %arg1: i32, %arg2: memref<1300x1300xf64>, %arg3: memref<1300x1300xf64>) {
    ...
    affine.for %arg4 = 1 to #map0()[%0] {
      affine.for %arg5 = 1 to #map0()[%0] {
        call @S0(%arg3, %c0, %arg4, %arg2) : (memref<1300x1300xf64>, index, index, memref<1300x1300xf64>) -> ()
      }
    }
    affine.for %arg4 = 2 to #map1()[%1] {
      affine.for %arg5 = #map2(%arg4) to #map3(%arg4)[%0] {
        affine.for %arg6 = #map2(%arg4) to #map3(%arg4)[%0] {
          affine.if #set0(%arg4) {
            %2 = affine.apply #map4(%arg4)
            %3 = affine.apply #map5(%arg4, %arg5)
    ...
    affine.for %arg4 = #map7()[%1] to #map8()[%1, %0] {
      affine.for %arg5 = #map7()[%1] to #map8()[%1, %0] {
        %2 = affine.apply #map0()[%1]
        %3 = affine.apply #map9(%arg4)[%1]
        call @S1(%arg2, %2, %3, %arg3) : (memref<1300x1300xf64>, index, index, memref<1300x1300xf64>) -> ()
      }
    }
    return
