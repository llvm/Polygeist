...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_lu_new(%arg0: i32, %arg1: memref<2000x2000xf64>) {
    ...
    %c0 = constant 0 : index
    %0 = index_cast %arg0 : i32 to index
    call @S1(%arg1, %c1, %c0) : (memref<2000x2000xf64>, index, index) -> ()
    call @S1(%arg1, %c2, %c0) : (memref<2000x2000xf64>, index, index) -> ()
    call @S2(%arg1, %c1, %c1, %c0) : (memref<2000x2000xf64>, index, index, index) -> ()
    affine.for %arg2 = 3 to #map1()[%0] {
      affine.if #set(%arg2)[%0] {
      ...
      affine.for %arg3 = max #map2(%arg2)[%0] to #map3(%arg2) {
        affine.for %arg4 = 0 to #map0(%arg3) {
          ...
          call @S0(%arg1, %2, %arg3, %arg4) : (memref<2000x2000xf64>, index, index, index) -> ()
        }
        %1 = affine.apply #map4(%arg2, %arg3)
        call @S1(%arg1, %1, %arg3) : (memref<2000x2000xf64>, index, index) -> ()
      }
      affine.for %arg3 = #map5(%arg2) to min #map6(%arg2)[%0] {
        affine.for %arg4 = 0 to #map4(%arg2, %arg3) {
          %1 = affine.apply #map4(%arg2, %arg3)
          call @S2(%arg1, %1, %arg3, %arg4) : (memref<2000x2000xf64>, index, index, index) -> ()
        }
      }
    }
    affine.for %arg2 = 0 to #map7()[%0] {
      %1 = affine.apply #map7()[%0]
      %2 = affine.apply #map7()[%0]
      call @S2(%arg1, %1, %2, %arg2) : (memref<2000x2000xf64>, index, index, index) -> ()
    }
    return
  }
}
