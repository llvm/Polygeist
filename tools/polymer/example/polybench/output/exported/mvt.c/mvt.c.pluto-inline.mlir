...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb1(%5: i32):  // 2 preds: ^bb0, ^bb4
    ...
    cond_br %6, ^bb2, ^bb3
  ^bb2:  // pred: ^bb1
    %8 = remi_signed %5, %c2000_i32 : i32
    %9 = sitofp %8 : i32 to f64
    %10 = sitofp %c2000_i32 : i32 to f64
    %11 = divf %9, %10 : f64
    store %11, %1[%7] : memref<2000xf64>
    %12 = addi %5, %c1_i32 : i32
    %13 = remi_signed %12, %c2000_i32 : i32
    %14 = sitofp %13 : i32 to f64
    %15 = divf %14, %10 : f64
    store %15, %2[%7] : memref<2000xf64>
    %16 = addi %5, %c3_i32 : i32
    %17 = remi_signed %16, %c2000_i32 : i32
    %18 = sitofp %17 : i32 to f64
    %19 = divf %18, %10 : f64
    store %19, %3[%7] : memref<2000xf64>
    %20 = addi %5, %c4_i32 : i32
    %21 = remi_signed %20, %c2000_i32 : i32
    %22 = sitofp %21 : i32 to f64
    %23 = divf %22, %10 : f64
    store %23, %4[%7] : memref<2000xf64>
    br ^bb4(%c0_i32 : i32)
  ^bb3:  // pred: ^bb1
      ...
      affine.for %arg3 = 0 to 63 {
        affine.for %arg4 = #map0(%arg2) to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            call @S0(%1, %arg4, %3, %arg5, %0) : (memref<2000xf64>, index, memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
            call @S1(%2, %arg4, %4, %arg5, %0) : (memref<2000xf64>, index, memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
          }
        }
      }
    }
    ...
    %29 = scf.if %28 -> (i1) {
      %38 = llvm.load %arg1 : !llvm.ptr<ptr<i8>>
      %39 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %40 = llvm.mlir.constant(0 : index) : !llvm.i64
      %41 = llvm.getelementptr %39[%40, %40] : (!llvm.ptr<array<1 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %42 = llvm.call @strcmp(%38, %41) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
      %43 = llvm.mlir.cast %42 : !llvm.i32 to i32
      %44 = trunci %43 : i32 to i1
      %45 = xor %44, %true : i1
      scf.yield %45 : i1
    } else {
      scf.yield %false : i1
    ...
    scf.if %29 {
      call @print_array(%c2000_i32, %1, %2) : (i32, memref<2000xf64>, memref<2000xf64>) -> ()
    }
    return %c0_i32 : i32
  ^bb4(%30: i32):  // 2 preds: ^bb2, ^bb5
    %31 = cmpi "slt", %30, %c2000_i32 : i32
    %32 = index_cast %30 : i32 to index
    cond_br %31, ^bb5, ^bb1(%12 : i32)
  ^bb5:  // pred: ^bb4
    %33 = muli %5, %30 : i32
    %34 = remi_signed %33, %c2000_i32 : i32
    %35 = sitofp %34 : i32 to f64
    %36 = divf %35, %10 : f64
    store %36, %0[%7, %32] : memref<2000x2000xf64>
    %37 = addi %30, %c1_i32 : i32
    br ^bb4(%37 : i32)
  }
  func @init_array(%arg0: i32, %arg1: memref<2000xf64>, %arg2: memref<2000xf64>, %arg3: memref<2000xf64>, %arg4: memref<2000xf64>, %arg5: memref<2000x2000xf64>) {
    %c0_i32 = constant 0 : i32
    %c1_i32 = constant 1 : i32
    %c3_i32 = constant 3 : i32
    %c4_i32 = constant 4 : i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    %6 = divf %4, %5 : f64
    store %6, %arg1[%2] : memref<2000xf64>
    %7 = addi %0, %c1_i32 : i32
    %8 = remi_signed %7, %arg0 : i32
    %9 = sitofp %8 : i32 to f64
    %10 = divf %9, %5 : f64
    store %10, %arg2[%2] : memref<2000xf64>
    %11 = addi %0, %c3_i32 : i32
    %12 = remi_signed %11, %arg0 : i32
    %13 = sitofp %12 : i32 to f64
    %14 = divf %13, %5 : f64
    store %14, %arg3[%2] : memref<2000xf64>
    %15 = addi %0, %c4_i32 : i32
    %16 = remi_signed %15, %arg0 : i32
    %17 = sitofp %16 : i32 to f64
    %18 = divf %17, %5 : f64
    store %18, %arg4[%2] : memref<2000xf64>
    br ^bb4(%c0_i32 : i32)
  ^bb3:  // pred: ^bb1
    return
  ^bb4(%19: i32):  // 2 preds: ^bb2, ^bb5
    %20 = cmpi "slt", %19, %arg0 : i32
    %21 = index_cast %19 : i32 to index
    cond_br %20, ^bb5, ^bb1(%7 : i32)
  ^bb5:  // pred: ^bb4
    %22 = muli %0, %19 : i32
    %23 = remi_signed %22, %arg0 : i32
    %24 = sitofp %23 : i32 to f64
    %25 = divf %24, %5 : f64
    store %25, %arg5[%2, %21] : memref<2000x2000xf64>
    %26 = addi %19, %c1_i32 : i32
    br ^bb4(%26 : i32)
  }
  ...
  func @kernel_mvt(%arg0: i32, %arg1: memref<2000xf64>, %arg2: memref<2000xf64>, %arg3: memref<2000xf64>, %arg4: memref<2000xf64>, %arg5: memref<2000x2000xf64>) {
    ...
    affine.for %arg6 = 0 to %0 {
      affine.for %arg7 = 0 to %0 {
        call @S0(%arg1, %arg6, %arg3, %arg7, %arg5) : (memref<2000xf64>, index, memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
      }
    }
    affine.for %arg6 = 0 to %0 {
      affine.for %arg7 = 0 to %0 {
        call @S1(%arg2, %arg6, %arg4, %arg7, %arg5) : (memref<2000xf64>, index, memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
      }
    }
    return
  }
  ...
  func @print_array(%arg0: i32, %arg1: memref<2000xf64>, %arg2: memref<2000xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb3:  // pred: ^bb1
    ...
    %30 = llvm.mlir.addressof @str3 : !llvm.ptr<array<3 x i8>>
    %31 = llvm.getelementptr %30[%3, %3] : (!llvm.ptr<array<3 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
    ...
    %37 = llvm.mlir.addressof @str7 : !llvm.ptr<array<3 x i8>>
    %38 = llvm.getelementptr %37[%3, %3] : (!llvm.ptr<array<3 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
  ...
  ^bb5:  // pred: ^bb4
    ...
    %49 = load %arg2[%42] : memref<2000xf64>
  ...
  ^bb6:  // pred: ^bb4
    ...
    %57 = llvm.mlir.addressof @str7 : !llvm.ptr<array<3 x i8>>
    %58 = llvm.getelementptr %57[%3, %3] : (!llvm.ptr<array<3 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
  ...
  func private @S0(%arg0: memref<2000xf64>, %arg1: index, %arg2: memref<2000xf64>, %arg3: index, %arg4: memref<2000x2000xf64>) attributes {scop.stmt} {
  ...
  func private @S1(%arg0: memref<2000xf64>, %arg1: index, %arg2: memref<2000xf64>, %arg3: index, %arg4: memref<2000x2000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<2000xf64>
  ...
  func @kernel_mvt_new(%arg0: i32, %arg1: memref<2000xf64>, %arg2: memref<2000xf64>, %arg3: memref<2000xf64>, %arg4: memref<2000xf64>, %arg5: memref<2000x2000xf64>) {
    ...
    affine.for %arg6 = 0 to #map2()[%0] {
      affine.for %arg7 = 0 to #map2()[%0] {
        affine.for %arg8 = #map0(%arg6) to min #map3(%arg6)[%0] {
          affine.for %arg9 = #map0(%arg7) to min #map3(%arg7)[%0] {
            call @S0(%arg1, %arg8, %arg3, %arg9, %arg5) : (memref<2000xf64>, index, memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
            call @S1(%arg2, %arg8, %arg4, %arg9, %arg5) : (memref<2000xf64>, index, memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
          }
        }
      }
    }
