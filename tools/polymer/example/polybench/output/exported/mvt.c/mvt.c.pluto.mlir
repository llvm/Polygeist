...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c2000_i32, %1, %2, %3, %4, %0) : (i32, memref<2000xf64>, memref<2000xf64>, memref<2000xf64>, memref<2000xf64>, memref<2000x2000xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_mvt_new(%c2000_i32, %1, %2, %3, %4, %0) : (i32, memref<2000xf64>, memref<2000xf64>, memref<2000xf64>, memref<2000xf64>, memref<2000x2000xf64>) -> ()
