...
#map5 = affine_map<()[s0] -> (s0 * 2 - 1)>
#map6 = affine_map<(d0)[s0] -> (d0 - s0 + 1)>
#map7 = affine_map<(d0, d1) -> (d0 - d1)>
#map8 = affine_map<(d0, d1)[s0] -> (-d0 + d1 + s0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_nussinov_new(%arg0: i32, %arg1: memref<2500xi8>, %arg2: memref<2500x2500xi32>) {
    ...
    affine.for %arg3 = 1 to %0 {
      ...
      call @S0(%arg2, %1, %arg3, %0) : (memref<2500x2500xi32>, index, index, index) -> ()
      %2 = affine.apply #map0(%arg3)[%0]
      call @S1(%arg2, %2, %arg3, %0) : (memref<2500x2500xi32>, index, index, index) -> ()
      %3 = affine.apply #map0(%arg3)[%0]
      call @S2(%arg2, %3, %arg3, %0, %arg1) : (memref<2500x2500xi32>, index, index, index, memref<2500xi8>) -> ()
      %4 = affine.apply #map0(%arg3)[%0]
      call @S3(%arg2, %4, %arg3, %0) : (memref<2500x2500xi32>, index, index, index) -> ()
    }
    affine.for %arg3 = #map4()[%0] to #map5()[%0] {
      affine.for %arg4 = #map6(%arg3)[%0] to %0 {
        %1 = affine.apply #map7(%arg3, %arg4)
        call @S0(%arg2, %1, %arg4, %0) : (memref<2500x2500xi32>, index, index, index) -> ()
        %2 = affine.apply #map7(%arg3, %arg4)
        call @S1(%arg2, %2, %arg4, %0) : (memref<2500x2500xi32>, index, index, index) -> ()
        %3 = affine.apply #map7(%arg3, %arg4)
        call @S2(%arg2, %3, %arg4, %0, %arg1) : (memref<2500x2500xi32>, index, index, index, memref<2500xi8>) -> ()
        %4 = affine.apply #map7(%arg3, %arg4)
        call @S3(%arg2, %4, %arg4, %0) : (memref<2500x2500xi32>, index, index, index) -> ()
        affine.for %arg5 = #map8(%arg3, %arg4)[%0] to #map3(%arg4) {
          %5 = affine.apply #map7(%arg3, %arg4)
          call @S4(%arg2, %5, %arg4, %0, %arg5) : (memref<2500x2500xi32>, index, index, index, index) -> ()
        }
      }
    }
    return
