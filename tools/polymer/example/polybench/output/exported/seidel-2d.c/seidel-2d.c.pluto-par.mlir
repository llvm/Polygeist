...
#map1 = affine_map<()[s0, s1] -> (s0 * 2 + s1 - 3)>
#map2 = affine_map<(d0)[s0] -> ((d0 + 1) ceildiv 2, d0 - s0 + 1)>
#map3 = affine_map<(d0)[s0] -> ((d0 + s0) floordiv 2, d0 + 1)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_seidel_2d(%c500_i32, %c2000_i32, %0) : (i32, i32, memref<2000x2000xf64>) -> ()
  ...
  func @kernel_seidel_2d_new(%arg0: i32, %arg1: i32, %arg2: memref<2000x2000xf64>) {
    ...
    affine.for %arg3 = 1 to #map1()[%1, %0] {
      affine.for %arg4 = max #map2(%arg3)[%1] to min #map3(%arg3)[%0] {
        affine.for %arg5 = #map4(%arg3) to #map5(%arg3)[%0] {
          %2 = affine.apply #map6(%arg3, %arg4)
          %3 = affine.apply #map7(%arg3, %arg4)
          call @S0(%arg2, %2, %3) : (memref<2000x2000xf64>, index, index) -> ()
        }
      }
    }
    return
