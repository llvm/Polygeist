...
#map1 = affine_map<()[s0, s1] -> (s0 + s1 - 1)>
#map2 = affine_map<(d0)[s0] -> (0, d0 - s0 + 1)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_syr2k_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<1200x1200xf64>, %arg5: memref<1200x1000xf64>, %arg6: memref<1200x1000xf64>) {
    ...
    affine.for %arg7 = 0 to #map1()[%1, %0] {
      affine.for %arg8 = max #map2(%arg7)[%0] to min #map3(%arg7)[%1] {
        affine.for %arg9 = 0 to #map0(%arg8) {
          %2 = affine.apply #map4(%arg7, %arg8)
          call @S1(%arg4, %arg8, %2, %arg5, %arg9, %arg2, %arg6) : (memref<1200x1200xf64>, index, index, memref<1200x1000xf64>, index, f64, memref<1200x1000xf64>) -> ()
        }
      }
    }
    return
