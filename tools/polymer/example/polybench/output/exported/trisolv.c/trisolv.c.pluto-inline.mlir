...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb3:  // pred: ^bb1
    ...
    affine.for %arg2 = 0 to 2000 {
      call @S0(%1, %arg2, %2) : (memref<2000xf64>, index, memref<2000xf64>) -> ()
      affine.for %arg3 = 0 to #map0(%arg2) {
        call @S1(%1, %arg2, %arg3, %0) : (memref<2000xf64>, index, index, memref<2000x2000xf64>) -> ()
      }
      call @S2(%1, %arg2, %0) : (memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
    }
    %10 = get_global_memref @polybench_t_end : memref<1xf64>
    %11 = call @rtclock() : () -> f64
    store %11, %10[%c0] : memref<1xf64>
    ...
    return %c0_i32 : i32
  ^bb4(%14: i32):  // 2 preds: ^bb2, ^bb5
    %15 = cmpi "sle", %14, %3 : i32
    %16 = index_cast %14 : i32 to index
    cond_br %15, ^bb5, ^bb6
  ^bb5:  // pred: ^bb4
    %17 = addi %3, %c2000_i32 : i32
    %18 = subi %17, %14 : i32
    %19 = addi %18, %c1_i32 : i32
    %20 = sitofp %19 : i32 to f64
    %21 = sitofp %c2_i32 : i32 to f64
    %22 = mulf %20, %21 : f64
    %23 = sitofp %c2000_i32 : i32 to f64
    %24 = divf %22, %23 : f64
    store %24, %0[%5, %16] : memref<2000x2000xf64>
    %25 = addi %14, %c1_i32 : i32
    br ^bb4(%25 : i32)
  ^bb6:  // pred: ^bb4
