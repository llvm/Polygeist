...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_trisolv_new(%arg0: i32, %arg1: memref<2000x2000xf64>, %arg2: memref<2000xf64>, %arg3: memref<2000xf64>) {
    ...
    call @S2(%arg2, %c0, %arg1) : (memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
    affine.for %arg4 = 1 to #map1()[%0] {
      affine.for %arg5 = max #map2(%arg4)[%0] to #map3(%arg4) {
        %2 = affine.apply #map4(%arg4, %arg5)
        call @S1(%arg2, %2, %arg5, %arg1) : (memref<2000xf64>, index, index, memref<2000x2000xf64>) -> ()
      }
      affine.if #set(%arg4) {
        %2 = affine.apply #map5(%arg4)
        call @S2(%arg2, %2, %arg1) : (memref<2000xf64>, index, memref<2000x2000xf64>) -> ()
      }
    }
