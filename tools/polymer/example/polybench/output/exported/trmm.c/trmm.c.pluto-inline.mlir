...
#map3 = affine_map<(d0, d1) -> (999, d0 * 32 + 32, d1 * 32 + 31)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb1(%3: i32):  // 2 preds: ^bb0, ^bb8
    ...
    cond_br %4, ^bb3(%c0_i32 : i32), ^bb2
  ^bb2:  // pred: ^bb1
    %6 = get_global_memref @polybench_t_start : memref<1xf64>
    %7 = call @rtclock() : () -> f64
    store %7, %6[%c0] : memref<1xf64>
    %8 = load %0[%c0] : memref<1xf64>
    affine.for %arg2 = 0 to 38 {
      affine.for %arg3 = 0 to 32 {
        affine.for %arg4 = #map0(%arg3) to 32 {
          affine.for %arg5 = #map1(%arg2) to min #map2(%arg2) {
            affine.for %arg6 = #map1(%arg3) to min #map3(%arg3, %arg4) {
              affine.for %arg7 = max #map4(%arg4, %arg6) to min #map5(%arg4) {
                call @S0(%2, %arg6, %arg5, %arg7, %1) : (memref<1000x1200xf64>, index, index, index, memref<1000x1000xf64>) -> ()
              }
            }
          }
        }
    ...
    affine.for %arg2 = 0 to 32 {
      affine.for %arg3 = 0 to 38 {
        affine.for %arg4 = #map1(%arg2) to min #map5(%arg2) {
          affine.for %arg5 = #map1(%arg3) to min #map2(%arg3) {
            call @S1(%2, %arg4, %arg5, %8) : (memref<1000x1200xf64>, index, index, f64) -> ()
          }
        }
      }
    }
    %9 = get_global_memref @polybench_t_end : memref<1xf64>
    %10 = call @rtclock() : () -> f64
    store %10, %9[%c0] : memref<1xf64>
    call @polybench_timer_print() : () -> ()
    %11 = cmpi "sgt", %arg0, %c42_i32 : i32
    %12 = scf.if %11 -> (i1) {
      %33 = llvm.load %arg1 : !llvm.ptr<ptr<i8>>
      %34 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %35 = llvm.mlir.constant(0 : index) : !llvm.i64
      %36 = llvm.getelementptr %34[%35, %35] : (!llvm.ptr<array<1 x i8>>, !llvm.i64, !llvm.i64) -> !llvm.ptr<i8>
      %37 = llvm.call @strcmp(%33, %36) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.i32
      %38 = llvm.mlir.cast %37 : !llvm.i32 to i32
      %39 = trunci %38 : i32 to i1
      %40 = xor %39, %true : i1
      scf.yield %40 : i1
    } else {
      scf.yield %false : i1
    ...
    return %c0_i32 : i32
  ^bb3(%13: i32):  // 2 preds: ^bb1, ^bb4
    %14 = cmpi "slt", %13, %3 : i32
    %15 = index_cast %13 : i32 to index
    cond_br %14, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %16 = addi %3, %13 : i32
    %17 = remi_signed %16, %c1000_i32 : i32
    %18 = sitofp %17 : i32 to f64
    %19 = sitofp %c1000_i32 : i32 to f64
    %20 = divf %18, %19 : f64
    store %20, %1[%5, %15] : memref<1000x1000xf64>
    %21 = addi %13, %c1_i32 : i32
    br ^bb3(%21 : i32)
  ^bb5:  // pred: ^bb3
    store %cst_0, %1[%5, %5] : memref<1000x1000xf64>
    br ^bb6(%c0_i32 : i32)
  ^bb6(%22: i32):  // 2 preds: ^bb5, ^bb7
    %23 = cmpi "slt", %22, %c1200_i32 : i32
    %24 = index_cast %22 : i32 to index
    cond_br %23, ^bb7, ^bb8
  ^bb7:  // pred: ^bb6
    %25 = subi %3, %22 : i32
    %26 = addi %25, %c1200_i32 : i32
    %27 = remi_signed %26, %c1200_i32 : i32
    %28 = sitofp %27 : i32 to f64
    %29 = sitofp %c1200_i32 : i32 to f64
    %30 = divf %28, %29 : f64
    store %30, %2[%5, %24] : memref<1000x1200xf64>
    %31 = addi %22, %c1_i32 : i32
    br ^bb6(%31 : i32)
  ^bb8:  // pred: ^bb6
    %32 = addi %3, %c1_i32 : i32
    br ^bb1(%32 : i32)
  }
  func @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<1000x1000xf64>, %arg4: memref<1000x1200xf64>) {
    %c0 = constant 0 : index
    %cst = constant 1.500000e+00 : f64
    %c0_i32 = constant 0 : i32
    %cst_0 = constant 1.000000e+00 : f64
  ...
  ^bb4:  // pred: ^bb3
    ...
    %10 = divf %8, %9 : f64
    store %10, %arg3[%2, %5] : memref<1000x1000xf64>
    %11 = addi %3, %c1_i32 : i32
    br ^bb3(%11 : i32)
  ^bb5:  // pred: ^bb3
    store %cst_0, %arg3[%2, %2] : memref<1000x1000xf64>
    br ^bb6(%c0_i32 : i32)
  ^bb6(%12: i32):  // 2 preds: ^bb5, ^bb7
  ...
  ^bb7:  // pred: ^bb6
    %15 = subi %0, %12 : i32
    %16 = addi %arg1, %15 : i32
    %17 = remi_signed %16, %arg1 : i32
    %18 = sitofp %17 : i32 to f64
    %19 = sitofp %arg1 : i32 to f64
    %20 = divf %18, %19 : f64
    store %20, %arg4[%2, %14] : memref<1000x1200xf64>
    %21 = addi %12, %c1_i32 : i32
    br ^bb6(%21 : i32)
  ^bb8:  // pred: ^bb6
    %22 = addi %0, %c1_i32 : i32
    br ^bb1(%22 : i32)
  }
  ...
  func @kernel_trmm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<1000x1000xf64>, %arg4: memref<1000x1200xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to %1 {
        affine.for %arg7 = #map6(%arg5) to %0 {
          call @S0(%arg4, %arg5, %arg6, %arg7, %arg3) : (memref<1000x1200xf64>, index, index, index, memref<1000x1000xf64>) -> ()
        }
        call @S1(%arg4, %arg5, %arg6, %arg2) : (memref<1000x1200xf64>, index, index, f64) -> ()
      }
    }
    return
  }
  ...
  func private @S0(%arg0: memref<1000x1200xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<1000x1000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<1000x1200xf64>
    %1 = affine.load %arg4[%arg3, %arg1] : memref<1000x1000xf64>
    %2 = affine.load %arg0[%arg3, %arg2] : memref<1000x1200xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1, %arg2] : memref<1000x1200xf64>
    return
  }
  func private @S1(%arg0: memref<1000x1200xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<1000x1200xf64>
    %1 = mulf %arg3, %0 : f64
    affine.store %1, %arg0[%arg1, %arg2] : memref<1000x1200xf64>
    return
  }
  func @kernel_trmm_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<1000x1000xf64>, %arg4: memref<1000x1200xf64>) {
    %0 = index_cast %arg1 : i32 to index
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg5 = 0 to #map7()[%0] {
      affine.for %arg6 = 0 to #map8()[%1] {
        affine.for %arg7 = #map0(%arg6) to #map7()[%1] {
          affine.for %arg8 = #map1(%arg5) to min #map9(%arg5)[%0] {
            affine.for %arg9 = #map1(%arg6) to min #map10(%arg6, %arg7)[%1] {
              affine.for %arg10 = max #map4(%arg7, %arg9) to min #map9(%arg7)[%1] {
                call @S0(%arg4, %arg9, %arg8, %arg10, %arg3) : (memref<1000x1200xf64>, index, index, index, memref<1000x1000xf64>) -> ()
              }
            }
          }
        }
    ...
    affine.for %arg5 = 0 to #map7()[%1] {
      affine.for %arg6 = 0 to #map7()[%0] {
        affine.for %arg7 = #map1(%arg5) to min #map9(%arg5)[%1] {
          affine.for %arg8 = #map1(%arg6) to min #map9(%arg6)[%0] {
            call @S1(%arg4, %arg7, %arg8, %arg2) : (memref<1000x1200xf64>, index, index, f64) -> ()
          }
        }
      }
    }
