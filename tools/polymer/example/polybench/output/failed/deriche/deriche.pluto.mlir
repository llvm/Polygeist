module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<64x64xf32>, %arg4: memref<64x64xf32>, %arg5: memref<64x64xf32>, %arg6: memref<64x64xf32>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        call @S10(%arg5, %arg7, %arg8, %5, %17, %4, %16, %2, %13, %arg3, %12) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        call @S18(%arg6, %arg7, %arg8, %0, %11, %17, %10, %16, %7, %15, %6, %14) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        call @S27(%arg5, %arg8, %arg7, %5, %17, %4, %16, %3, %13, %arg4, %12) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        call @S35(%arg6, %arg8, %arg7, %1, %11, %17, %10, %16, %9, %15, %8, %14) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
  ...
  func private @kernel_deriche_new(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<64x64xf32>, %arg4: memref<64x64xf32>, %arg5: memref<64x64xf32>, %arg6: memref<64x64xf32>) {
    ...
    %15 = alloca() : memref<1xf32>
    %16 = alloca() : memref<1xf32>
    %17 = index_cast %arg0 : i32 to index
    %18 = index_cast %arg1 : i32 to index
    call @S0(%10, %arg2) : (memref<1xf32>, f32) -> ()
    call @S1(%9, %arg2) : (memref<1xf32>, f32) -> ()
    call @S2(%8, %arg2) : (memref<1xf32>, f32) -> ()
    call @S3(%7, %arg2) : (memref<1xf32>, f32) -> ()
    call @S4(%6, %arg2) : (memref<1xf32>, f32) -> ()
    call @S5(%5, %arg2) : (memref<1xf32>, f32) -> ()
    call @S6(%4) : (memref<1xf32>) -> ()
    affine.for %arg7 = 0 to %17 {
      call @S7(%3) : (memref<1xf32>) -> ()
      call @S8(%2) : (memref<1xf32>) -> ()
      call @S9(%15) : (memref<1xf32>) -> ()
      affine.for %arg8 = 0 to %18 {
        call @S10(%arg5, %arg7, %arg8, %2, %5, %3, %6, %15, %9, %arg3, %10) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
        call @S11(%15, %arg3, %arg7, %arg8) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
        call @S12(%2, %3) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S13(%3, %arg5, %arg7, %arg8) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %17 {
      call @S14(%16) : (memref<1xf32>) -> ()
      call @S15(%12) : (memref<1xf32>) -> ()
      call @S16(%14) : (memref<1xf32>) -> ()
      call @S17(%11) : (memref<1xf32>) -> ()
      affine.for %arg8 = 0 to %18 {
        call @S18(%arg6, %arg7, %arg8, %18, %12, %5, %16, %6, %11, %7, %14, %8) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S19(%11, %14) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S20(%14, %arg3, %arg7, %arg8, %18) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
        call @S21(%12, %16) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S22(%16, %arg6, %arg7, %arg8, %18) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %17 {
      affine.for %arg8 = 0 to %18 {
        call @S23(%arg4, %arg7, %arg8, %arg6, %arg5, %4) : (memref<64x64xf32>, index, index, memref<64x64xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
      }
    }
    affine.for %arg7 = 0 to %18 {
      call @S24(%13) : (memref<1xf32>) -> ()
      call @S25(%3) : (memref<1xf32>) -> ()
      call @S26(%2) : (memref<1xf32>) -> ()
      affine.for %arg8 = 0 to %17 {
        call @S27(%arg5, %arg8, %arg7, %2, %5, %3, %6, %13, %9, %arg4, %10) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
        call @S28(%13, %arg4, %arg8, %arg7) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
        call @S29(%2, %3) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S30(%3, %arg5, %arg8, %arg7) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %18 {
      ...
      affine.for %arg8 = 0 to %17 {
        call @S35(%arg6, %arg8, %arg7, %17, %12, %5, %16, %6, %0, %7, %1, %8) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S36(%0, %1) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S37(%1, %arg4, %arg8, %arg7, %17) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
        call @S38(%12, %16) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S39(%16, %arg6, %arg8, %arg7, %17) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %17 {
      affine.for %arg8 = 0 to %18 {
        call @S40(%arg4, %arg7, %arg8, %arg6, %arg5, %4) : (memref<64x64xf32>, index, index, memref<64x64xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
      }
    }
    return
  }
