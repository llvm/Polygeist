...
module  {
  ...
  func @kernel_gemm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: f64, %arg4: f64, %arg5: memref<1000x1100xf64>, %arg6: memref<1000x1200xf64>, %arg7: memref<1200x1100xf64>) {
    ...
    affine.for %arg8 = 0 to #map0()[%3] {
      affine.for %arg9 = 0 to #map0()[%2] {
        affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%3] {
    ...
    affine.for %arg8 = 0 to %3 {
      affine.for %arg9 = 0 to %2 {
        call @S1(%0, %arg3, %arg6, %arg8, %arg9) : (memref<1xf64>, f64, memref<1000x1200xf64>, index, index) -> ()
        affine.for %arg10 = 0 to #map0()[%1] {
          affine.for %arg11 = #map1(%arg10) to min #map2(%arg10)[%1] {
            call @S2(%arg5, %arg8, %arg9, %arg7, %arg11, %0) : (memref<1000x1100xf64>, index, index, memref<1200x1100xf64>, index, memref<1xf64>) -> ()
          }
        }
      }
    }
