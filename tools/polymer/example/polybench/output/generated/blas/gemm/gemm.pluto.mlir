  ...
  func @kernel_gemm_new(%arg0: f64, %arg1: memref<1000x1100xf64>, %arg2: memref<1000x1200xf64>, %arg3: memref<1200x1100xf64>, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: f64) {
    ...
    affine.for %arg8 = 0 to #map6()[%2] {
      affine.for %arg9 = 0 to #map6()[%0] {
        %3 = alloca() : memref<1xf64>
        affine.for %arg10 = #map4(%arg8) to min #map5(%arg8)[%2] {
          affine.for %arg11 = #map4(%arg9) to min #map5(%arg9)[%0] {
            %4 = affine.apply #map3(%arg10)
            %5 = affine.apply #map3(%arg11)
            call @S0(%arg1, %4, %5, %arg7) : (memref<1000x1100xf64>, index, index, f64) -> ()
          }
        }
      }
    }
    affine.for %arg8 = 0 to %2 {
      affine.for %arg9 = 0 to %0 {
        ...
        call @S1(%3, %arg0, %arg2, %4, %5) : (memref<1xf64>, f64, memref<1000x1200xf64>, index, index) -> ()
        affine.for %arg10 = 0 to #map6()[%1] {
          affine.for %arg11 = #map4(%arg10) to min #map5(%arg10)[%1] {
            %6 = alloca() : memref<1xf64>
            %7 = affine.apply #map3(%arg11)
            call @S2(%arg1, %4, %5, %arg3, %7, %6) : (memref<1000x1100xf64>, index, index, memref<1200x1100xf64>, index, memref<1xf64>) -> ()
          }
        }
      }
    }
