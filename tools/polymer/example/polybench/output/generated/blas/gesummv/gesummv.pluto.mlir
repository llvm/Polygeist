  ...
  func @kernel_gesummv_new(%arg0: memref<1300xf64>, %arg1: memref<1300xf64>, %arg2: memref<1300x1300xf64>, %arg3: memref<1300xf64>, %arg4: memref<1300x1300xf64>, %arg5: f64, %arg6: i32, %arg7: f64) {
    ...
    affine.for %arg8 = 0 to #map6()[%0] {
      affine.for %arg9 = #map4(%arg8) to min #map5(%arg8)[%0] {
        ...
        call @S1(%arg1, %3) : (memref<1300xf64>, index) -> ()
      }
    }
    affine.for %arg8 = 0 to %0 {
      %1 = alloca() : memref<1xf64>
      %2 = affine.apply #map2(%arg8)
      call @S3(%1, %arg1, %2) : (memref<1xf64>, memref<1300xf64>, index) -> ()
      affine.for %arg9 = 0 to %0 {
        %3 = alloca() : memref<1xf64>
        %4 = affine.apply #map2(%arg9)
        call @S5(%arg1, %2, %3, %arg3, %4, %arg4) : (memref<1300xf64>, index, memref<1xf64>, memref<1300xf64>, index, memref<1300x1300xf64>) -> ()
      }
    }
    affine.for %arg8 = 0 to #map6()[%0] {
      affine.for %arg9 = #map4(%arg8) to min #map5(%arg8)[%0] {
        %1 = affine.apply #map2(%arg9)
        call @S0(%arg0, %1) : (memref<1300xf64>, index) -> ()
      }
    }
    affine.for %arg8 = 0 to %0 {
      %1 = alloca() : memref<1xf64>
      %2 = affine.apply #map2(%arg8)
      call @S2(%1, %arg0, %2) : (memref<1xf64>, memref<1300xf64>, index) -> ()
      affine.for %arg9 = 0 to %0 {
        %3 = alloca() : memref<1xf64>
        %4 = affine.apply #map2(%arg9)
        call @S4(%arg0, %2, %3, %arg3, %4, %arg2) : (memref<1300xf64>, index, memref<1xf64>, memref<1300xf64>, index, memref<1300x1300xf64>) -> ()
      }
    }
    affine.for %arg8 = 0 to #map6()[%0] {
      affine.for %arg9 = #map4(%arg8) to min #map5(%arg8)[%0] {
        %1 = affine.apply #map2(%arg9)
        call @S6(%arg1, %1, %arg5, %arg7, %arg0) : (memref<1300xf64>, index, f64, f64, memref<1300xf64>) -> ()
      }
    }
    return
  }
