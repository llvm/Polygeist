...
module {
  ...
  func @kernel_symm_new(%arg0: f64, %arg1: memref<1000x1000xf64>, %arg2: memref<1000x1200xf64>, %arg3: memref<1000x1200xf64>, %arg4: i32, %arg5: i32, %arg6: f64) {
    ...
    %5 = index_cast %arg4 : i32 to index
    call @S0(%3) : (memref<1xf64>) -> ()
    call @S1(%2, %3) : (memref<1xf64>, memref<1xf64>) -> ()
    call @S2(%1, %arg6, %3) : (memref<1xf64>, f64, memref<1xf64>) -> ()
    call @S3(%0, %arg1, %c0) : (memref<1xf64>, memref<1000x1000xf64>, index) -> ()
    affine.for %arg7 = 0 to %4 {
      %6 = alloca() : memref<1xf64>
      call @S4(%6, %arg6, %arg2, %c0, %arg7) : (memref<1xf64>, f64, memref<1000x1200xf64>, index, index) -> ()
      call @S7(%arg3, %c0, %arg7, %1, %0, %arg6, %arg2, %arg0) : (memref<1000x1200xf64>, index, index, memref<1xf64>, memref<1xf64>, f64, memref<1000x1200xf64>, f64) -> ()
    }
    affine.for %arg7 = 1 to %5 {
      call @S3(%0, %arg1, %arg7) : (memref<1xf64>, memref<1000x1000xf64>, index) -> ()
      affine.for %arg8 = 0 to %4 {
        %6 = alloca() : memref<1xf64>
        call @S4(%6, %arg6, %arg2, %arg7, %arg8) : (memref<1xf64>, f64, memref<1000x1200xf64>, index, index) -> ()
        affine.for %arg9 = 0 to #map1(%arg7) {
          call @S5(%arg3, %arg7, %arg8, %arg1, %arg9, %6) : (memref<1000x1200xf64>, index, index, memref<1000x1000xf64>, index, memref<1xf64>) -> ()
          call @S6(%3, %arg1, %arg7, %arg8, %arg2, %arg9, %2) : (memref<1xf64>, memref<1000x1000xf64>, index, index, memref<1000x1200xf64>, index, memref<1xf64>) -> ()
        }
        call @S7(%arg3, %arg7, %arg8, %1, %0, %arg6, %arg2, %arg0) : (memref<1000x1200xf64>, index, index, memref<1xf64>, memref<1xf64>, f64, memref<1000x1200xf64>, f64) -> ()
      }
    }
    return
  }
