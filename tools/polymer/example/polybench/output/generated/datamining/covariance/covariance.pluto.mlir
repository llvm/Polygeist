...
module  {
  ...
  func @kernel_covariance_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<1400x1200xf64>, %arg4: memref<1200x1200xf64>, %arg5: memref<1200xf64>) {
    ...
    affine.for %arg6 = 0 to #map1()[%2] {
      affine.for %arg7 = #map0(%arg6) to #map1()[%2] {
        affine.for %arg8 = #map2(%arg6) to min #map3(%arg6)[%2] {
          affine.for %arg9 = max #map4(%arg7, %arg8) to min #map3(%arg7)[%2] {
    ...
    affine.for %arg6 = 0 to #map1()[%2] {
      affine.for %arg7 = #map0(%arg6) to #map1()[%2] {
        affine.for %arg8 = #map2(%arg6) to min #map3(%arg6)[%2] {
          affine.for %arg9 = max #map4(%arg7, %arg8) to min #map3(%arg7)[%2] {
            %3 = alloca() : memref<1xf64>
            call @S9(%arg4, %arg8, %arg9, %3) : (memref<1200x1200xf64>, index, index, memref<1xf64>) -> ()
          }
        }
      }
    }
    call @S5(%0, %arg2) : (memref<1xf64>, f64) -> ()
    affine.for %arg6 = 0 to #map1()[%2] {
      affine.for %arg7 = #map2(%arg6) to min #map3(%arg6)[%2] {
