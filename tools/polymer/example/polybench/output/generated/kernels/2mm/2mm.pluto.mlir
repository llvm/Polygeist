...
module  {
  ...
  func @S2(%arg0: memref<800x900xf64>, %arg1: index, %arg2: index, %arg3: memref<1100x900xf64>, %arg4: index, %arg5: f64, %arg6: memref<800x1100xf64>, %arg7: memref<1xf64>) attributes {scop.stmt} {
    ...
    %1 = affine.load %arg6[symbol(%arg1), symbol(%arg4)] : memref<800x1100xf64>
    %2 = mulf %arg5, %1 : f64
    %3 = affine.load %arg3[symbol(%arg4), symbol(%arg2)] : memref<1100x900xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
    affine.store %5, %arg0[symbol(%arg1), symbol(%arg2)] : memref<800x900xf64>
    return
  }
  func @S3(%arg0: memref<800x1200xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[symbol(%arg1), symbol(%arg2)] : memref<800x1200xf64>
    %1 = mulf %0, %arg3 : f64
    affine.store %1, %arg0[symbol(%arg1), symbol(%arg2)] : memref<800x1200xf64>
    return
  }
  func @S4(%arg0: memref<1xf64>, %arg1: memref<800x1200xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[symbol(%arg2), symbol(%arg3)] : memref<800x1200xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func @S5(%arg0: memref<800x1200xf64>, %arg1: index, %arg2: index, %arg3: memref<900x1200xf64>, %arg4: index, %arg5: memref<800x900xf64>, %arg6: memref<1xf64>) attributes {scop.stmt} {
    ...
    %2 = affine.load %arg3[symbol(%arg4), symbol(%arg2)] : memref<900x1200xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
  ...
  func @kernel_2mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<800x900xf64>, %arg7: memref<800x1100xf64>, %arg8: memref<1100x900xf64>, %arg9: memref<900x1200xf64>, %arg10: memref<800x1200xf64>) {
    ...
    affine.for %arg11 = 0 to #map0()[%4] {
      affine.for %arg12 = 0 to #map0()[%3] {
        affine.for %arg13 = #map1(%arg11) to min #map2(%arg11)[%4] {
    ...
    affine.for %arg11 = 0 to %4 {
      affine.for %arg12 = 0 to %3 {
        call @S1(%1, %arg6, %arg11, %arg12) : (memref<1xf64>, memref<800x900xf64>, index, index) -> ()
        affine.for %arg13 = 0 to %2 {
          call @S2(%arg6, %arg11, %arg12, %arg8, %arg13, %arg4, %arg7, %1) : (memref<800x900xf64>, index, index, memref<1100x900xf64>, index, f64, memref<800x1100xf64>, memref<1xf64>) -> ()
        }
      }
      affine.for %arg12 = 0 to %3 {
        call @S4(%0, %arg10, %arg11, %arg12) : (memref<1xf64>, memref<800x1200xf64>, index, index) -> ()
        affine.for %arg13 = 0 to %2 {
          call @S5(%arg10, %arg11, %arg12, %arg9, %arg13, %arg6, %0) : (memref<800x1200xf64>, index, index, memref<900x1200xf64>, index, memref<800x900xf64>, memref<1xf64>) -> ()
        }
      }
    }
    return
