  ...
  func @kernel_3mm_new(%arg0: memref<800x900xf64>, %arg1: i32, %arg2: memref<800x1000xf64>, %arg3: memref<1000x900xf64>, %arg4: memref<900x1100xf64>, %arg5: memref<1200x1100xf64>, %arg6: memref<800x1100xf64>, %arg7: memref<900x1200xf64>, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32) {
    ...
    affine.for %arg12 = 0 to #map6()[%1] {
      affine.for %arg13 = 0 to #map6()[%2] {
        ...
        %5 = alloca() : memref<1xf64>
        affine.for %arg14 = #map4(%arg12) to min #map5(%arg12)[%1] {
          affine.for %arg15 = #map4(%arg13) to min #map5(%arg13)[%2] {
            %6 = affine.apply #map3(%arg14)
            %7 = affine.apply #map3(%arg15)
            call @S6(%arg6, %6, %7) : (memref<800x1100xf64>, index, index) -> ()
            call @S3(%arg4, %6, %7) : (memref<900x1100xf64>, index, index) -> ()
          }
        }
      }
    }
    affine.for %arg12 = 0 to %1 {
      affine.for %arg13 = 0 to %2 {
        %3 = alloca() : memref<1xf64>
        %4 = affine.apply #map3(%arg12)
        %5 = affine.apply #map3(%arg13)
        call @S4(%3, %arg4, %4, %5) : (memref<1xf64>, memref<900x1100xf64>, index, index) -> ()
        affine.for %arg14 = 0 to %0 {
          %6 = alloca() : memref<1xf64>
          %7 = affine.apply #map3(%arg14)
          call @S5(%arg4, %4, %5, %arg5, %7, %arg7, %6) : (memref<900x1100xf64>, index, index, memref<1200x1100xf64>, index, memref<900x1200xf64>, memref<1xf64>) -> ()
        }
      }
    }
    affine.for %arg12 = 0 to #map6()[%1] {
      affine.for %arg13 = 0 to #map6()[%2] {
        affine.for %arg14 = #map4(%arg12) to min #map5(%arg12)[%1] {
          affine.for %arg15 = #map4(%arg13) to min #map5(%arg13)[%2] {
            %3 = affine.apply #map3(%arg14)
            %4 = affine.apply #map3(%arg15)
            call @S0(%arg0, %3, %4) : (memref<800x900xf64>, index, index) -> ()
          }
        }
      }
    }
    affine.for %arg12 = 0 to %1 {
      affine.for %arg13 = 0 to %2 {
        ...
        %4 = affine.apply #map3(%arg12)
        %5 = affine.apply #map3(%arg13)
        call @S1(%3, %arg0, %4, %5) : (memref<1xf64>, memref<800x900xf64>, index, index) -> ()
        affine.for %arg14 = 0 to %0 {
          %6 = alloca() : memref<1xf64>
          %7 = affine.apply #map3(%arg14)
          call @S2(%arg0, %4, %5, %arg3, %7, %arg2, %6) : (memref<800x900xf64>, index, index, memref<1000x900xf64>, index, memref<800x1000xf64>, memref<1xf64>) -> ()
        }
      }
      affine.for %arg13 = 0 to %2 {
        %3 = alloca() : memref<1xf64>
        %4 = affine.apply #map3(%arg12)
        %5 = affine.apply #map3(%arg13)
        call @S7(%3, %arg6, %4, %5) : (memref<1xf64>, memref<800x1100xf64>, index, index) -> ()
        affine.for %arg14 = 0 to %0 {
          %6 = alloca() : memref<1xf64>
          %7 = affine.apply #map3(%arg14)
          call @S8(%arg6, %4, %5, %arg4, %7, %arg0, %6) : (memref<800x1100xf64>, index, index, memref<900x1100xf64>, index, memref<800x900xf64>, memref<1xf64>) -> ()
        }
      }
    }
    return
