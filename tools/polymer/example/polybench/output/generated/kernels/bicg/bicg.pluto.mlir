...
#map7 = affine_map<()[s0] -> (2, s0)>
#map8 = affine_map<() -> (3)>
#map9 = affine_map<()[s0] -> (32, s0)>
#map10 = affine_map<() -> (1)>
  ...
  func @kernel_bicg_new(%arg0: memref<1900xf64>, %arg1: memref<2100xf64>, %arg2: memref<2100xf64>, %arg3: memref<2100x1900xf64>, %arg4: memref<1900xf64>, %arg5: i32, %arg6: i32) {
    ...
    affine.for %arg7 = 0 to #map6()[%0] {
      ...
      affine.for %arg8 = #map4(%arg7) to min #map5(%arg7)[%0] {
        ...
        call @S2(%arg1, %5) : (memref<2100xf64>, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %0 {
      %3 = alloca() : memref<1xf64>
      %4 = affine.apply #map2(%arg7)
      call @S4(%3, %arg1, %4) : (memref<1xf64>, memref<2100xf64>, index) -> ()
      affine.for %arg8 = 0 to %1 {
        %5 = alloca() : memref<1xf64>
        %6 = affine.apply #map2(%arg8)
        call @S6(%arg1, %4, %arg4, %6, %arg3, %5) : (memref<2100xf64>, index, memref<1900xf64>, index, memref<2100x1900xf64>, memref<1xf64>) -> ()
      }
    }
    ...
    affine.for %arg7 = 0 to #map6()[%0] {
      affine.for %arg8 = #map4(%arg7) to min #map5(%arg7)[%0] {
        ...
        call @S1(%arg0, %4, %3) : (memref<1900xf64>, index, memref<1xf64>) -> ()
      }
    }
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to min #map7()[%1] {
        %3 = alloca() : memref<1xf64>
        %4 = affine.apply #map2(%arg7)
        %5 = affine.apply #map2(%arg8)
        call @S5(%arg0, %4, %arg3, %5, %3) : (memref<1900xf64>, index, memref<2100x1900xf64>, index, memref<1xf64>) -> ()
      }
      affine.if #set0()[%1] {
        %3 = alloca() : memref<1xf64>
        %4 = affine.apply #map2(%arg7)
        call @S3(%3, %arg2, %4) : (memref<1xf64>, memref<2100xf64>, index) -> ()
        %c2 = constant 2 : index
        call @S5(%arg0, %4, %arg3, %c2, %3) : (memref<1900xf64>, index, memref<2100x1900xf64>, index, memref<1xf64>) -> ()
      }
      affine.if #set1()[%1] {
        %3 = alloca() : memref<1xf64>
        %4 = affine.apply #map2(%arg7)
      ...
      affine.for %arg8 = 3 to min #map9()[%1] {
        %3 = alloca() : memref<1xf64>
        %4 = affine.apply #map2(%arg7)
        %5 = affine.apply #map2(%arg8)
        call @S5(%arg0, %4, %arg3, %5, %3) : (memref<1900xf64>, index, memref<2100x1900xf64>, index, memref<1xf64>) -> ()
      ...
      affine.for %arg8 = 1 to #map6()[%1] {
        affine.for %arg9 = #map4(%arg8) to min #map5(%arg8)[%1] {
          %3 = alloca() : memref<1xf64>
          %4 = affine.apply #map2(%arg7)
