...
module {
  ...
  func @kernel_cholesky_new(%arg0: i32, %arg1: memref<2000x2000xf64>) {
    ...
    call @S3(%1, %arg1, %c0) : (memref<1xf64>, memref<2000x2000xf64>, index) -> ()
    call @S5(%arg1, %c0) : (memref<2000x2000xf64>, index) -> ()
    call @S3(%1, %arg1, %c1) : (memref<1xf64>, memref<2000x2000xf64>, index) -> ()
    call @S0(%0, %arg1, %c1, %c0) : (memref<1xf64>, memref<2000x2000xf64>, index, index) -> ()
    call @S2(%arg1, %c1, %c0) : (memref<2000x2000xf64>, index, index) -> ()
    call @S4(%arg1, %c1, %c0, %1) : (memref<2000x2000xf64>, index, index, memref<1xf64>) -> ()
