...
module  {
  ...
  func @kernel_durbin_new(%arg0: i32, %arg1: memref<2000xf64>, %arg2: memref<2000xf64>) {
    ...
    affine.for %arg3 = 1 to %8 {
      call @S13(%arg2, %arg3, %4, %5, %arg1) : (memref<2000xf64>, index, memref<1xf64>, memref<1xf64>, memref<2000xf64>) -> ()
      call @S10(%3, %4, %5, %arg1, %arg3) : (memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<2000xf64>, index) -> ()
    }
    call @S2(%3, %arg1) : (memref<1xf64>, memref<2000xf64>) -> ()
    call @S1(%6) : (memref<1xf64>) -> ()
    call @S0(%arg2, %arg1) : (memref<2000xf64>, memref<2000xf64>) -> ()
    affine.for %arg3 = 1 to %8 {
      call @S11(%arg3, %0, %arg2, %2) : (index, memref<2000xf64>, memref<2000xf64>, memref<1xf64>) -> ()
      affine.for %arg4 = 1 to #map(%arg3) {
        call @S11(%arg3, %0, %arg2, %2) : (index, memref<2000xf64>, memref<2000xf64>, memref<1xf64>) -> ()
        call @S12(%arg2, %arg3, %0) : (memref<2000xf64>, index, memref<2000xf64>) -> ()
        call @S8(%1, %arg2, %arg3, %arg1, %7) : (memref<1xf64>, memref<2000xf64>, index, memref<2000xf64>, memref<1xf64>) -> ()
      }
      call @S9(%2, %4, %5, %arg1, %arg3) : (memref<1xf64>, memref<1xf64>, memref<1xf64>, memref<2000xf64>, index) -> ()
      call @S12(%arg2, %arg3, %0) : (memref<2000xf64>, index, memref<2000xf64>) -> ()
      call @S8(%1, %arg2, %arg3, %arg1, %7) : (memref<1xf64>, memref<2000xf64>, index, memref<2000xf64>, memref<1xf64>) -> ()
    }
    call @S5(%1) : (memref<1xf64>) -> ()
    call @S7(%5, %1) : (memref<1xf64>, memref<1xf64>) -> ()
    call @S6(%7, %1) : (memref<1xf64>, memref<1xf64>) -> ()
    call @S3(%4, %6, %3) : (memref<1xf64>, memref<1xf64>, memref<1xf64>) -> ()
    call @S4(%6, %3) : (memref<1xf64>, memref<1xf64>) -> ()
    return
  }
}
