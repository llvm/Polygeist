...
module {
  ...
  func @kernel_ludcmp_new(%arg0: memref<2000xf64>, %arg1: i32, %arg2: memref<2000xf64>, %arg3: memref<2000x2000xf64>, %arg4: memref<2000xf64>) {
    %c1 = constant 1 : index
    %c0 = constant 0 : index
    %0 = alloca() : memref<1xf64>
    ...
    call @S14(%arg4, %c0, %4) : (memref<2000xf64>, index, memref<1xf64>) -> ()
    affine.for %arg5 = 1 to %9 {
      call @S12(%7, %arg2, %arg5) : (memref<1xf64>, memref<2000xf64>, index) -> ()
      affine.for %arg6 = 0 to #map1(%arg5) {
        call @S13(%7, %arg4, %arg5, %arg3, %arg6, %5) : (memref<1xf64>, memref<2000xf64>, index, memref<2000x2000xf64>, index, memref<1xf64>) -> ()
      }
      call @S14(%arg4, %arg5, %4) : (memref<2000xf64>, index, memref<1xf64>) -> ()
    }
    ...
    affine.for %arg5 = 0 to %9 {
      ...
      affine.for %arg6 = 1 to %9 {
        call @S18(%7, %arg0, %arg5, %arg3, %arg6, %3) : (memref<1xf64>, memref<2000xf64>, index, memref<2000x2000xf64>, index, memref<1xf64>) -> ()
      }
      call @S19(%arg0, %arg5, %arg3, %2) : (memref<2000xf64>, index, memref<2000x2000xf64>, memref<1xf64>) -> ()
    }
    call @S2(%1, %7) : (memref<1xf64>, memref<1xf64>) -> ()
    call @S3(%0, %7) : (memref<1xf64>, memref<1xf64>) -> ()
    affine.for %arg5 = 0 to %9 {
      call @S7(%7, %arg3, %c0, %arg5) : (memref<1xf64>, memref<2000x2000xf64>, index, index) -> ()
      call @S9(%arg3, %c0, %arg5, %0) : (memref<2000x2000xf64>, index, index, memref<1xf64>) -> ()
    }
    call @S4(%7, %arg3, %c1, %c0) : (memref<1xf64>, memref<2000x2000xf64>, index, index) -> ()
    call @S6(%arg3, %c1, %c0, %6) : (memref<2000x2000xf64>, index, index, memref<1xf64>) -> ()
    affine.for %arg5 = 1 to %9 {
      call @S7(%7, %arg3, %c1, %arg5) : (memref<1xf64>, memref<2000x2000xf64>, index, index) -> ()
      call @S8(%7, %arg3, %c1, %arg5, %c0, %1) : (memref<1xf64>, memref<2000x2000xf64>, index, index, index, memref<1xf64>) -> ()
      call @S9(%arg3, %c1, %arg5, %0) : (memref<2000x2000xf64>, index, index, memref<1xf64>) -> ()
    }
    affine.for %arg5 = 2 to %9 {
      call @S4(%7, %arg3, %arg5, %c0) : (memref<1xf64>, memref<2000x2000xf64>, index, index) -> ()
      call @S6(%arg3, %arg5, %c0, %6) : (memref<2000x2000xf64>, index, index, memref<1xf64>) -> ()
      affine.for %arg6 = 1 to #map1(%arg5) {
        call @S4(%7, %arg3, %arg5, %arg6) : (memref<1xf64>, memref<2000x2000xf64>, index, index) -> ()
        affine.for %arg7 = 0 to #map1(%arg6) {
          call @S5(%7, %arg3, %arg5, %arg6, %arg7, %8) : (memref<1xf64>, memref<2000x2000xf64>, index, index, index, memref<1xf64>) -> ()
        }
        call @S6(%arg3, %arg5, %arg6, %6) : (memref<2000x2000xf64>, index, index, memref<1xf64>) -> ()
      }
      affine.for %arg6 = #map1(%arg5) to %9 {
        call @S7(%7, %arg3, %arg5, %arg6) : (memref<1xf64>, memref<2000x2000xf64>, index, index) -> ()
        affine.for %arg7 = 0 to #map1(%arg5) {
          call @S8(%7, %arg3, %arg5, %arg6, %arg7, %1) : (memref<1xf64>, memref<2000x2000xf64>, index, index, index, memref<1xf64>) -> ()
        }
        call @S9(%arg3, %arg5, %arg6, %0) : (memref<2000x2000xf64>, index, index, memref<1xf64>) -> ()
      }
    }
    return
  }
