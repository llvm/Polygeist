...
#map3 = affine_map<()[s0, s1, s2] -> ((s0 + s1 - 2) floordiv 32 + 1, (s0 + s2 - 2) floordiv 32 + 1)>
#map4 = affine_map<(d0)[s0] -> (0, (d0 * 32 - s0 + 1) ceildiv 32)>
#map5 = affine_map<(d0)[s0] -> (d0 + (-s0) floordiv 32 + 1)>
#map6 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32)>
#map7 = affine_map<(d0, d1)[s0] -> (s0, d0 * 32 - d1 * 32 + 32)>
#map8 = affine_map<(d0)[s0, s1] -> (0, (d0 * 32 - s0 + 1) ceildiv 32, (d0 * 32 - s1 + 1) ceildiv 32)>
#map9 = affine_map<(d0)[s0] -> ((s0 - 1) floordiv 32 + 1, d0 + 1)>
#map10 = affine_map<()[s0, s1] -> ((s0 + s1 - 1) ceildiv 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c800_i32, %c900_i32, %c1100_i32, %c1200_i32, %7, %8, %3, %4, %5, %6) : (i32, i32, i32, i32, memref<?xf64>, memref<?xf64>, memref<800x1100xf64>, memref<1100x900xf64>, memref<900x1200xf64>, memref<800x1200xf64>) -> ()
    %9 = load %0[%c0] : memref<1xf64>
    %10 = load %1[%c0] : memref<1xf64>
    call @kernel_2mm_new(%c800_i32, %c900_i32, %c1100_i32, %c1200_i32, %9, %10, %2, %3, %4, %5, %6) : (i32, i32, i32, i32, f64, f64, memref<800x900xf64>, memref<800x1100xf64>, memref<1100x900xf64>, memref<900x1200xf64>, memref<800x1200xf64>) -> ()
    call @print_array(%c800_i32, %c1200_i32, %6) : (i32, i32, memref<800x1200xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<800x1100xf64>, %arg7: memref<1100x900xf64>, %arg8: memref<900x1200xf64>, %arg9: memref<800x1200xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<800x900xf64>, %arg7: memref<800x1100xf64>, %arg8: memref<1100x900xf64>, %arg9: memref<900x1200xf64>, %arg10: memref<800x1200xf64>) {
  ...
  func @kernel_2mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<800x900xf64>, %arg7: memref<800x1100xf64>, %arg8: memref<1100x900xf64>, %arg9: memref<900x1200xf64>, %arg10: memref<800x1200xf64>) {
    ...
    affine.for %arg11 = 0 to min #map3()[%2, %1, %0] {
      affine.for %arg12 = max #map4(%arg11)[%1] to #map5(%arg11)[%0] {
        affine.for %arg13 = 0 to #map0()[%0] {
          affine.for %arg14 = #map6(%arg11, %arg12) to min #map7(%arg11, %arg12)[%1] {
            affine.for %arg15 = #map1(%arg12) to min #map2(%arg12)[%2] {
              affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%0] {
      ...
      affine.for %arg12 = max #map4(%arg11)[%0] to #map5(%arg11)[%1] {
        affine.for %arg13 = 0 to #map0()[%1] {
          affine.for %arg14 = #map1(%arg12) to min #map2(%arg12)[%2] {
            affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%1] {
              affine.for %arg16 = #map6(%arg11, %arg12) to min #map7(%arg11, %arg12)[%0] {
      ...
      affine.for %arg12 = max #map8(%arg11)[%1, %0] to min #map9(%arg11)[%2] {
        affine.for %arg13 = 0 to #map0()[%0] {
          affine.for %arg14 = #map6(%arg11, %arg12) to min #map7(%arg11, %arg12)[%1] {
            affine.for %arg15 = #map1(%arg12) to min #map2(%arg12)[%2] {
              affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%0] {
    ...
    affine.for %arg11 = #map10()[%2, %0] to #map11()[%2, %1] {
      affine.for %arg12 = max #map4(%arg11)[%1] to #map0()[%2] {
        affine.for %arg13 = 0 to #map0()[%0] {
          affine.for %arg14 = #map6(%arg11, %arg12) to min #map7(%arg11, %arg12)[%1] {
            affine.for %arg15 = #map1(%arg12) to min #map2(%arg12)[%2] {
              affine.for %arg16 = #map1(%arg13) to min #map2(%arg13)[%0] {
    ...
    affine.for %arg11 = #map10()[%2, %1] to #map11()[%2, %0] {
      affine.for %arg12 = max #map4(%arg11)[%0] to #map0()[%2] {
        affine.for %arg13 = 0 to #map0()[%1] {
          affine.for %arg14 = #map1(%arg12) to min #map2(%arg12)[%2] {
            affine.for %arg15 = #map1(%arg13) to min #map2(%arg13)[%1] {
              affine.for %arg16 = #map6(%arg11, %arg12) to min #map7(%arg11, %arg12)[%0] {
