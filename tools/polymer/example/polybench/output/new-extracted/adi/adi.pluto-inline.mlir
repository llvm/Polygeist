...
#map3 = affine_map<()[s0] -> ((s0 - 2) floordiv 32 + 1)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %28 = sitofp %c500_i32 : i32 to f64
    %29 = divf %cst_0, %28 : f64
    %30 = mulf %cst_0, %29 : f64
    %31 = sitofp %c1000_i32 : i32 to f64
    ...
    %40 = sitofp %c1000_i32 : i32 to f64
  ...
  ^bb3(%45: i32):  // 2 preds: ^bb1, ^bb4
    ...
    cond_br %46, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %48 = addi %4, %c1000_i32 : i32
    %49 = subi %48, %45 : i32
    %50 = sitofp %49 : i32 to f64
    %51 = sitofp %c1000_i32 : i32 to f64
    %52 = divf %50, %51 : f64
    store %52, %0[%6, %47] : memref<1000x1000xf64>
