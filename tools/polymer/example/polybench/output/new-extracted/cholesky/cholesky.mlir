    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map(%arg2) {
        affine.for %arg4 = 0 to #map(%arg3) {
          %6 = affine.load %arg1[%arg2, %arg4] : memref<2000x2000xf64>
          %7 = affine.load %arg1[%arg3, %arg4] : memref<2000x2000xf64>
          %8 = mulf %6, %7 : f64
          %9 = affine.load %arg1[%arg2, %arg3] : memref<2000x2000xf64>
          %10 = subf %9, %8 : f64
          affine.store %10, %arg1[%arg2, %arg3] : memref<2000x2000xf64>
        }
        %3 = affine.load %arg1[%arg3, %arg3] : memref<2000x2000xf64>
      ...
      affine.for %arg3 = 0 to #map(%arg2) {
        ...
        %4 = affine.load %arg1[%arg2, %arg3] : memref<2000x2000xf64>
        %5 = mulf %3, %4 : f64
        %6 = affine.load %arg1[%arg2, %arg2] : memref<2000x2000xf64>
        %7 = subf %6, %5 : f64
        affine.store %7, %arg1[%arg2, %arg2] : memref<2000x2000xf64>
      }
      %1 = affine.load %arg1[%arg2, %arg2] : memref<2000x2000xf64>
      %2 = sqrt %1 : f64
      affine.store %2, %arg1[%arg2, %arg2] : memref<2000x2000xf64>
    }
    return
  }
