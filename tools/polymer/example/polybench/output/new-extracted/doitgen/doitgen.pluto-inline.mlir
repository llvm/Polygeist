...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb9(%24: i32):  // 2 preds: ^bb7, ^bb10
    %25 = cmpi "slt", %24, %c160_i32 : i32
    %26 = index_cast %24 : i32 to index
    cond_br %25, ^bb10, ^bb11
  ^bb10:  // pred: ^bb9
    %27 = muli %21, %24 : i32
    %28 = remi_signed %27, %c160_i32 : i32
    %29 = sitofp %28 : i32 to f64
    %30 = sitofp %c160_i32 : i32 to f64
    %31 = divf %29, %30 : f64
    store %31, %2[%23, %26] : memref<160x160xf64>
  ...
  func @"\E0\04\9E\01\00\00\00\00\10\C0\88\01\00\00\00\00ew"(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<150x140x160xf64>, %arg4: memref<160x160xf64>, %arg5: memref<160xf64>) {
