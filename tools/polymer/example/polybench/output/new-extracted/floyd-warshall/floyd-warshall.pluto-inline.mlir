...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %9 = addi %8, %c1_i32 : i32
    store %9, %0[%3, %6] : memref<2800x2800xi32>
    %10 = addi %1, %4 : i32
    ...
    scf.if %14 {
      store %c999_i32, %0[%3, %6] : memref<2800x2800xi32>
    }
  ...
  func @"p\DC*\03\00\00\00\00\10\B0\FC\02\00\00\00\00shall_new"(%arg0: i32, %arg1: memref<2800x2800xi32>) {
