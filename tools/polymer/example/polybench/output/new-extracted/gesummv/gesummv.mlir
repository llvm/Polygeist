module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @init_array(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<1300x1300xf64>, %arg4: memref<1300x1300xf64>, %arg5: memref<1300xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_gesummv(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<1300x1300xf64>, %arg4: memref<1300x1300xf64>, %arg5: memref<1300xf64>, %arg6: memref<1300xf64>, %arg7: memref<1300xf64>) {
    ...
    affine.for %arg8 = 0 to %0 {
      ...
      affine.for %arg9 = 0 to %0 {
        %6 = affine.load %arg3[%arg8, %arg9] : memref<1300x1300xf64>
        %7 = affine.load %arg6[%arg9] : memref<1300xf64>
        %8 = mulf %6, %7 : f64
        %9 = affine.load %arg5[%arg8] : memref<1300xf64>
        %10 = addf %8, %9 : f64
        affine.store %10, %arg5[%arg8] : memref<1300xf64>
        %11 = affine.load %arg4[%arg8, %arg9] : memref<1300x1300xf64>
        %12 = affine.load %arg6[%arg9] : memref<1300xf64>
        %13 = mulf %11, %12 : f64
        %14 = affine.load %arg7[%arg8] : memref<1300xf64>
        %15 = addf %13, %14 : f64
        affine.store %15, %arg7[%arg8] : memref<1300xf64>
      }
      %1 = affine.load %arg5[%arg8] : memref<1300xf64>
      %2 = mulf %arg1, %1 : f64
      %3 = affine.load %arg7[%arg8] : memref<1300xf64>
      %4 = mulf %arg2, %3 : f64
      %5 = addf %2, %4 : f64
      affine.store %5, %arg7[%arg8] : memref<1300xf64>
    }
    return
  }
