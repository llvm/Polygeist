...
#map11 = affine_map<()[s0, s1] -> ((s0 * 2 + s1 - 4) floordiv 32 + 1)>
#map12 = affine_map<(d0)[s0] -> (d0 ceildiv 2, (d0 * 32 - s0 + 1) ceildiv 32)>
#map13 = affine_map<(d0)[s0, s1] -> ((s0 + s1 - 3) floordiv 32 + 1, (d0 * 32 + s1 + 29) floordiv 64 + 1, d0 + 1)>
#map14 = affine_map<(d0, d1)[s0] -> ((d0 * 64 - s0 - 28) ceildiv 32, d1)>
#map15 = affine_map<(d0, d1)[s0, s1] -> ((s0 + s1 - 3) floordiv 16 + 1, (d0 * 32 - d1 * 32 + s1 + 29) floordiv 16 + 1, (d0 * 32 + s1 + 60) floordiv 32 + 1, (d1 * 64 + s1 + 59) floordiv 32 + 1, (d1 * 32 + s0 + s1 + 28) floordiv 32 + 1)>
#map16 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 - d1 * 32, d1 * 32 - s0 + 2, d2 * 16 - s0 + 2, d1 * -32 + d2 * 32 - s0 - 29)>
#map17 = affine_map<(d0, d1, d2)[s0] -> (s0, d0 * 32 + 31, d1 * 16 + 15, d2 * 32 - d0 * 32 + 32, d0 * -32 + d1 * 32 + 31)>
#map18 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32, d1 + 1, d2 * 32 - d1 - s0 + 2)>
#map19 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * 32 - d2 + 31, d2 + s0 - 1)>
#map20 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 + d2 + s0 - 1)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
          ...
          affine.for %arg5 = max #map4(%arg2, %arg3, %arg4) to min #map5(%arg2, %arg3, %arg4) {
            affine.for %arg6 = max #map6(%arg3, %arg4, %arg5) to min #map7(%arg3, %arg4, %arg5) {
              affine.for %arg7 = max #map8(%arg4, %arg5, %arg6) to min #map9(%arg4, %arg5, %arg6) {
                ...
                call @S0(%0, %arg5, %17) : (memref<2000x2000xf64>, index, index) -> ()
              }
            }
          }
        }
  ...
  ^bb4:  // pred: ^bb3
    ...
    %12 = addf %10, %11 : f64
    %13 = sitofp %c2000_i32 : i32 to f64
    %14 = divf %12, %13 : f64
    store %14, %0[%3, %6] : memref<2000x2000xf64>
  ...
  func @kernel_seidel_2d_new(%arg0: i32, %arg1: i32, %arg2: memref<2000x2000xf64>) {
    ...
    affine.for %arg3 = 0 to #map11()[%1, %0] {
      affine.for %arg4 = max #map12(%arg3)[%1] to min #map13(%arg3)[%1, %0] {
        affine.for %arg5 = max #map14(%arg3, %arg4)[%0] to min #map15(%arg3, %arg4)[%1, %0] {
          affine.for %arg6 = max #map16(%arg3, %arg4, %arg5)[%0] to min #map17(%arg3, %arg4, %arg5)[%1] {
            affine.for %arg7 = max #map18(%arg4, %arg5, %arg6)[%0] to min #map19(%arg4, %arg5, %arg6)[%0] {
              affine.for %arg8 = max #map8(%arg5, %arg6, %arg7) to min #map20(%arg5, %arg6, %arg7)[%0] {
