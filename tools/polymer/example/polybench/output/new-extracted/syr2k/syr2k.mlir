...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @init_array(%c1200_i32, %c1000_i32, %5, %6, %2, %3, %4) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<1200x1200xf64>, memref<1200x1000xf64>, memref<1200x1000xf64>) -> ()
    %7 = load %0[%c0] : memref<1xf64>
    %8 = load %1[%c0] : memref<1xf64>
    call @kernel_syr2k(%c1200_i32, %c1000_i32, %7, %8, %2, %3, %4) : (i32, i32, f64, f64, memref<1200x1200xf64>, memref<1200x1000xf64>, memref<1200x1000xf64>) -> ()
    call @print_array(%c1200_i32, %2) : (i32, memref<1200x1200xf64>) -> ()
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<1200x1200xf64>, %arg5: memref<1200x1000xf64>, %arg6: memref<1200x1000xf64>) {
    %c0 = constant 0 : index
  ...
  func private @kernel_syr2k(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<1200x1200xf64>, %arg5: memref<1200x1000xf64>, %arg6: memref<1200x1000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to #map(%arg7) {
        %2 = affine.load %arg4[%arg7, %arg8] : memref<1200x1200xf64>
        %3 = mulf %2, %arg3 : f64
        affine.store %3, %arg4[%arg7, %arg8] : memref<1200x1200xf64>
      }
      affine.for %arg8 = 0 to %1 {
        affine.for %arg9 = 0 to #map(%arg7) {
          %2 = affine.load %arg5[%arg9, %arg8] : memref<1200x1000xf64>
          %3 = mulf %2, %arg2 : f64
          %4 = affine.load %arg6[%arg7, %arg8] : memref<1200x1000xf64>
          %5 = mulf %3, %4 : f64
          %6 = affine.load %arg6[%arg9, %arg8] : memref<1200x1000xf64>
          %7 = mulf %6, %arg2 : f64
          %8 = affine.load %arg5[%arg7, %arg8] : memref<1200x1000xf64>
          %9 = mulf %7, %8 : f64
          %10 = addf %5, %9 : f64
          %11 = affine.load %arg4[%arg7, %arg9] : memref<1200x1200xf64>
          %12 = addf %11, %10 : f64
          affine.store %12, %arg4[%arg7, %arg9] : memref<1200x1200xf64>
        }
      }
    }
    return
