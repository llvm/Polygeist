...
#map1 = affine_map<(d0) -> (16, d0 * 32 + 32)>
#map2 = affine_map<(d0) -> (24, d0 * 32 + 32)>
#map3 = affine_map<(d0) -> (0, (d0 * 32 - 23) ceildiv 32)>
#map4 = affine_map<(d0) -> (d0)>
#map5 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32)>
#map6 = affine_map<(d0, d1) -> (24, d0 * 32 - d1 * 32 + 32)>
#map7 = affine_map<(d0) -> (18, d0 * 32 + 32)>
#map8 = affine_map<(d0) -> (0, (d0 * 32 - 17) ceildiv 32)>
#map9 = affine_map<(d0, d1) -> (18, d0 * 32 - d1 * 32 + 32)>
#map10 = affine_map<(d0) -> (0, (d0 * 32 - 23) ceildiv 32, (d0 * 32 - 17) ceildiv 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb3:  // pred: ^bb2
    ...
    %17 = sitofp %c16_i32 : i32 to f64
    %18 = divf %16, %17 : f64
    store %18, %3[%9, %12] : memref<16x22xf64>
  ...
  ^bb11:  // pred: ^bb10
    ...
    %43 = remi_signed %42, %c24_i32 : i32
    %44 = sitofp %43 : i32 to f64
    %45 = sitofp %c24_i32 : i32 to f64
    %46 = divf %44, %45 : f64
    store %46, %5[%36, %39] : memref<18x24xf64>
  ...
  ^bb14:  // pred: ^bb13
      ...
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map0(%arg2) to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map2(%arg3) {
            call @S2(%6, %arg4, %arg5, %53) : (memref<16x24xf64>, index, index, f64) -> ()
            call @S0(%2, %arg4, %arg5) : (memref<16x18xf64>, index, index) -> ()
          }
        }
      }
    }
          ...
          affine.for %arg5 = #map5(%arg2, %arg3) to min #map6(%arg2, %arg3) {
            affine.for %arg6 = #map0(%arg3) to min #map1(%arg3) {
              affine.for %arg7 = #map0(%arg4) to min #map7(%arg4) {
                call @S1(%2, %arg6, %arg5, %4, %arg7, %52, %3) : (memref<16x18xf64>, index, index, memref<22x18xf64>, index, f64, memref<16x22xf64>) -> ()
              }
            }
          }
        }
      }
      affine.for %arg3 = max #map8(%arg2) to #map4(%arg2) {
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            affine.for %arg6 = #map0(%arg4) to min #map2(%arg4) {
              affine.for %arg7 = #map5(%arg2, %arg3) to min #map9(%arg2, %arg3) {
                call @S3(%6, %arg5, %arg6, %5, %arg7, %2) : (memref<16x24xf64>, index, index, memref<18x24xf64>, index, memref<16x18xf64>) -> ()
              }
            }
          }
        }
    ...
    affine.for %arg2 = 2 to 2 {
      affine.for %arg3 = max #map3(%arg2) to 1 {
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = #map5(%arg2, %arg3) to min #map6(%arg2, %arg3) {
            affine.for %arg6 = #map0(%arg3) to min #map1(%arg3) {
              affine.for %arg7 = #map0(%arg4) to min #map7(%arg4) {
  ...
  ^bb15(%54: i32):  // 2 preds: ^bb13, ^bb16
    %55 = cmpi "slt", %54, %c24_i32 : i32
    %56 = index_cast %54 : i32 to index
    cond_br %55, ^bb16, ^bb17
  ^bb16:  // pred: ^bb15
    %57 = addi %54, %c2_i32 : i32
    %58 = muli %49, %57 : i32
    %59 = remi_signed %58, %c22_i32 : i32
    %60 = sitofp %59 : i32 to f64
    %61 = sitofp %c22_i32 : i32 to f64
    %62 = divf %60, %61 : f64
    store %62, %6[%51, %56] : memref<16x24xf64>
  ...
  func @kernel_2mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<16x18xf64>, %arg7: memref<16x22xf64>, %arg8: memref<22x18xf64>, %arg9: memref<18x24xf64>, %arg10: memref<16x24xf64>) {
    %0 = index_cast %arg1 : i32 to index
    %1 = index_cast %arg3 : i32 to index
    %2 = index_cast %arg0 : i32 to index
    affine.for %arg11 = 0 to #map12()[%2] {
      affine.for %arg12 = 0 to #map12()[%1] {
        affine.for %arg13 = #map0(%arg11) to min #map13(%arg11)[%2] {
          affine.for %arg14 = #map0(%arg12) to min #map13(%arg12)[%1] {
            call @S2(%arg10, %arg13, %arg14, %arg5) : (memref<16x24xf64>, index, index, f64) -> ()
            call @S0(%arg6, %arg13, %arg14) : (memref<16x18xf64>, index, index) -> ()
          }
        }
      }
    }
    affine.for %arg11 = 0 to min #map14()[%2, %1, %0] {
      affine.for %arg12 = max #map15(%arg11)[%1] to #map16(%arg11)[%0] {
        affine.for %arg13 = 0 to #map12()[%0] {
          affine.for %arg14 = #map5(%arg11, %arg12) to min #map17(%arg11, %arg12)[%1] {
            affine.for %arg15 = #map0(%arg12) to min #map13(%arg12)[%2] {
              affine.for %arg16 = #map0(%arg13) to min #map13(%arg13)[%0] {
                call @S1(%arg6, %arg15, %arg14, %arg8, %arg16, %arg4, %arg7) : (memref<16x18xf64>, index, index, memref<22x18xf64>, index, f64, memref<16x22xf64>) -> ()
              }
            }
          }
        }
      }
      affine.for %arg12 = max #map15(%arg11)[%0] to #map16(%arg11)[%1] {
        affine.for %arg13 = 0 to #map12()[%1] {
          affine.for %arg14 = #map0(%arg12) to min #map13(%arg12)[%2] {
            affine.for %arg15 = #map0(%arg13) to min #map13(%arg13)[%1] {
              affine.for %arg16 = #map5(%arg11, %arg12) to min #map17(%arg11, %arg12)[%0] {
                call @S3(%arg10, %arg14, %arg15, %arg9, %arg16, %arg6) : (memref<16x24xf64>, index, index, memref<18x24xf64>, index, memref<16x18xf64>) -> ()
              }
            }
          }
        }
      }
      affine.for %arg12 = max #map18(%arg11)[%1, %0] to min #map19(%arg11)[%2] {
        affine.for %arg13 = 0 to #map12()[%0] {
          affine.for %arg14 = #map5(%arg11, %arg12) to min #map17(%arg11, %arg12)[%1] {
            affine.for %arg15 = #map0(%arg12) to min #map13(%arg12)[%2] {
              affine.for %arg16 = #map0(%arg13) to min #map13(%arg13)[%0] {
    ...
    affine.for %arg11 = #map20()[%2, %0] to #map21()[%2, %1] {
      affine.for %arg12 = max #map15(%arg11)[%1] to #map12()[%2] {
        affine.for %arg13 = 0 to #map12()[%0] {
          affine.for %arg14 = #map5(%arg11, %arg12) to min #map17(%arg11, %arg12)[%1] {
            affine.for %arg15 = #map0(%arg12) to min #map13(%arg12)[%2] {
              affine.for %arg16 = #map0(%arg13) to min #map13(%arg13)[%0] {
    ...
    affine.for %arg11 = #map20()[%2, %1] to #map21()[%2, %0] {
      affine.for %arg12 = max #map15(%arg11)[%0] to #map12()[%2] {
        affine.for %arg13 = 0 to #map12()[%1] {
          affine.for %arg14 = #map0(%arg12) to min #map13(%arg12)[%2] {
            affine.for %arg15 = #map0(%arg13) to min #map13(%arg13)[%1] {
              affine.for %arg16 = #map5(%arg11, %arg12) to min #map17(%arg11, %arg12)[%0] {
