...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_2mm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<16x18xf64>, %arg7: memref<16x22xf64>, %arg8: memref<22x18xf64>, %arg9: memref<18x24xf64>, %arg10: memref<16x24xf64>) {
    ...
    affine.for %arg11 = 0 to #map6()[%0, %1] {
      affine.for %arg12 = max #map7(%arg11)[%1] to min #map8(%arg11)[%0] {
        affine.for %arg13 = 0 to #map0()[%2] {
          affine.for %arg14 = #map9(%arg11, %arg12) to min #map10(%arg11, %arg12)[%1] {
            affine.for %arg15 = #map2(%arg12) to min #map3(%arg12)[%0] {
        ...
        affine.for %arg13 = 0 to #map0()[%3] {
          affine.for %arg14 = #map2(%arg12) to min #map3(%arg12)[%0] {
            affine.for %arg15 = #map2(%arg13) to min #map3(%arg13)[%3] {
              affine.for %arg16 = #map9(%arg11, %arg12) to min #map10(%arg11, %arg12)[%1] {
