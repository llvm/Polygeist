...
#map2 = affine_map<(d0) -> (0, (d0 * 32 - 41) ceildiv 32)>
#map3 = affine_map<(d0) -> (2, d0 + 1)>
#map4 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32)>
#map5 = affine_map<(d0, d1) -> (42, d0 * 32 - d1 * 32 + 32)>
#map6 = affine_map<(d0) -> (42, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb4:  // pred: ^bb3
      ...
      affine.for %arg3 = max #map2(%arg2) to min #map3(%arg2) {
        affine.for %arg4 = #map0(%arg3) to min #map1(%arg3) {
          affine.for %arg5 = #map4(%arg2, %arg3) to min #map5(%arg2, %arg3) {
            call @S2(%3, %arg4, %1, %arg5, %0) : (memref<38xf64>, index, memref<42xf64>, index, memref<38x42xf64>) -> ()
          }
        }
      }
    }
    affine.for %arg2 = 0 to 2 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S0(%2, %arg3) : (memref<42xf64>, index) -> ()
      }
    }
    affine.for %arg2 = 0 to 2 {
      affine.for %arg3 = 0 to 2 {
        affine.for %arg4 = #map0(%arg2) to min #map6(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            call @S3(%2, %arg5, %3, %arg4, %0) : (memref<42xf64>, index, memref<38xf64>, index, memref<38x42xf64>) -> ()
          }
        }
      }
    }
  ...
  ^bb5(%16: i32):  // 2 preds: ^bb3, ^bb6
    %17 = cmpi "slt", %16, %c42_i32 : i32
    %18 = index_cast %16 : i32 to index
    cond_br %17, ^bb6, ^bb7
  ^bb6:  // pred: ^bb5
    %19 = addi %13, %16 : i32
    %20 = remi_signed %19, %c42_i32 : i32
    %21 = sitofp %20 : i32 to f64
    %22 = sitofp %c190_i32 : i32 to f64
    %23 = divf %21, %22 : f64
    store %23, %0[%15, %18] : memref<38x42xf64>
  ...
  func @init_array(%arg0: i32, %arg1: i32, %arg2: memref<38x42xf64>, %arg3: memref<42xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func @kernel_atax(%arg0: i32, %arg1: i32, %arg2: memref<38x42xf64>, %arg3: memref<42xf64>, %arg4: memref<42xf64>, %arg5: memref<38xf64>) {
    %0 = index_cast %arg1 : i32 to index
    affine.for %arg6 = 0 to %0 {
      call @S0(%arg4, %arg6) : (memref<42xf64>, index) -> ()
    }
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg6 = 0 to %1 {
      call @S1(%arg5, %arg6) : (memref<38xf64>, index) -> ()
      affine.for %arg7 = 0 to %0 {
        call @S2(%arg5, %arg6, %arg3, %arg7, %arg2) : (memref<38xf64>, index, memref<42xf64>, index, memref<38x42xf64>) -> ()
      }
      affine.for %arg7 = 0 to %0 {
        call @S3(%arg4, %arg7, %arg5, %arg6, %arg2) : (memref<42xf64>, index, memref<38xf64>, index, memref<38x42xf64>) -> ()
      }
    }
    return
  }
  func @print_array(%arg0: i32, %arg1: memref<42xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @S2(%arg0: memref<38xf64>, %arg1: index, %arg2: memref<42xf64>, %arg3: index, %arg4: memref<38x42xf64>) attributes {scop.stmt} {
    ...
    %1 = affine.load %arg4[%arg1, %arg3] : memref<38x42xf64>
    %2 = affine.load %arg2[%arg3] : memref<42xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1] : memref<38xf64>
    return
  }
  func private @S3(%arg0: memref<42xf64>, %arg1: index, %arg2: memref<38xf64>, %arg3: index, %arg4: memref<38x42xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<42xf64>
    %1 = affine.load %arg4[%arg3, %arg1] : memref<38x42xf64>
  ...
  func @kernel_atax_new(%arg0: i32, %arg1: i32, %arg2: memref<38x42xf64>, %arg3: memref<42xf64>, %arg4: memref<42xf64>, %arg5: memref<38xf64>) {
    %0 = index_cast %arg1 : i32 to index
    %1 = index_cast %arg0 : i32 to index
