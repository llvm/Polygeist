...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
      ...
      affine.for %arg3 = max #map0(%arg2) to #map1(%arg2) {
        ...
        affine.for %arg4 = #map3(%arg2, %arg3) to min #map4(%arg2, %arg3) {
          affine.for %arg5 = #map5(%arg3) to #map6(%arg3) {
            call @S2(%0, %arg4, %arg5) : (memref<40x40xf64>, index, index) -> ()
          }
        }
      }
      affine.if #set0(%arg2) {
        ...
        affine.if #set1(%arg2) {
          affine.if #set2() {
            call @S3(%0, %c38) : (memref<40x40xf64>, index) -> ()
            call @S1(%0, %c39, %c38) : (memref<40x40xf64>, index, index) -> ()
            call @S2(%0, %c39, %c38) : (memref<40x40xf64>, index, index) -> ()
            call @S3(%0, %c39) : (memref<40x40xf64>, index) -> ()
          }
        }
        affine.if #set3(%arg2) {
          %58 = affine.apply #map11(%arg2)
          call @S3(%0, %58) : (memref<40x40xf64>, index) -> ()
          %59 = affine.apply #map9(%arg2)
          %60 = affine.apply #map11(%arg2)
          call @S1(%0, %59, %60) : (memref<40x40xf64>, index, index) -> ()
          %61 = affine.apply #map9(%arg2)
          %62 = affine.apply #map11(%arg2)
          call @S2(%0, %61, %62) : (memref<40x40xf64>, index, index) -> ()
          %63 = affine.apply #map9(%arg2)
          call @S3(%0, %63) : (memref<40x40xf64>, index) -> ()
          affine.for %arg3 = #map12(%arg2) to min #map10(%arg2) {
            %64 = affine.apply #map11(%arg2)
            call @S1(%0, %arg3, %64) : (memref<40x40xf64>, index, index) -> ()
            %65 = affine.apply #map11(%arg2)
            call @S2(%0, %arg3, %65) : (memref<40x40xf64>, index, index) -> ()
            affine.for %arg4 = #map9(%arg2) to #map2(%arg3) {
              ...
              call @S2(%0, %arg3, %arg4) : (memref<40x40xf64>, index, index) -> ()
            }
            call @S3(%0, %arg3) : (memref<40x40xf64>, index) -> ()
          }
        }
      }
    }
  ...
  func @kernel_cholesky(%arg0: i32, %arg1: memref<40x40xf64>) {
    ...
    affine.for %arg2 = 0 to %0 {
      ...
      affine.for %arg3 = 0 to #map2(%arg2) {
        call @S2(%arg1, %arg2, %arg3) : (memref<40x40xf64>, index, index) -> ()
      }
      call @S3(%arg1, %arg2) : (memref<40x40xf64>, index) -> ()
    }
    return
  }
  ...
  func private @S0(%arg0: memref<40x40xf64>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    ...
    %2 = affine.load %arg0[%arg2, %arg3] : memref<40x40xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
  ...
  func private @S2(%arg0: memref<40x40xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg1] : memref<40x40xf64>
    %1 = affine.load %arg0[%arg1, %arg2] : memref<40x40xf64>
    %2 = affine.load %arg0[%arg1, %arg2] : memref<40x40xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[%arg1, %arg1] : memref<40x40xf64>
    return
  }
  func private @S3(%arg0: memref<40x40xf64>, %arg1: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg1] : memref<40x40xf64>
    %1 = sqrt %0 : f64
  ...
  func @kernel_cholesky_new(%arg0: i32, %arg1: memref<40x40xf64>) {
    ...
    affine.for %arg2 = 0 to #map13()[%0] {
      affine.for %arg3 = max #map14(%arg2)[%0] to #map1(%arg2) {
        ...
        affine.for %arg4 = #map3(%arg2, %arg3) to min #map15(%arg2, %arg3)[%0] {
          affine.for %arg5 = #map5(%arg3) to #map6(%arg3) {
            call @S2(%arg1, %arg4, %arg5) : (memref<40x40xf64>, index, index) -> ()
          }
        }
      }
      affine.if #set0(%arg2) {
        ...
        affine.if #set5(%arg2)[%0] {
          affine.if #set6()[%0] {
            ...
            call @S3(%arg1, %1) : (memref<40x40xf64>, index) -> ()
            %2 = affine.apply #map18()[%0]
            %3 = affine.apply #map17()[%0]
            call @S1(%arg1, %2, %3) : (memref<40x40xf64>, index, index) -> ()
            %4 = affine.apply #map18()[%0]
            %5 = affine.apply #map17()[%0]
            call @S2(%arg1, %4, %5) : (memref<40x40xf64>, index, index) -> ()
            %6 = affine.apply #map18()[%0]
            call @S3(%arg1, %6) : (memref<40x40xf64>, index) -> ()
          }
        }
        affine.if #set7(%arg2)[%0] {
          ...
          affine.for %arg3 = #map12(%arg2) to min #map16(%arg2)[%0] {
            ...
            call @S1(%arg1, %arg3, %7) : (memref<40x40xf64>, index, index) -> ()
            %8 = affine.apply #map11(%arg2)
            call @S2(%arg1, %arg3, %8) : (memref<40x40xf64>, index, index) -> ()
            affine.for %arg4 = #map9(%arg2) to #map2(%arg3) {
              affine.for %arg5 = #map11(%arg2) to #map2(%arg4) {
                call @S0(%arg1, %arg3, %arg4, %arg5) : (memref<40x40xf64>, index, index, index) -> ()
              }
              call @S1(%arg1, %arg3, %arg4) : (memref<40x40xf64>, index, index) -> ()
              call @S2(%arg1, %arg3, %arg4) : (memref<40x40xf64>, index, index) -> ()
            }
            call @S3(%arg1, %arg3) : (memref<40x40xf64>, index) -> ()
          }
        }
      }
    }
