...
#map1 = affine_map<(d0) -> (28, d0 * 32 + 32)>
#map2 = affine_map<(d0) -> (d0)>
#map3 = affine_map<(d0, d1) -> (27, d0 * 32 + 32, d1 * 32 + 31)>
#map4 = affine_map<(d0, d1) -> (d0 * 32, d1 + 1)>
#map5 = affine_map<(d0) -> (0, (d0 * 32 - 31) ceildiv 32)>
#map6 = affine_map<(d0) -> (1, d0 + 1)>
#map7 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32)>
#map8 = affine_map<(d0, d1) -> (32, d0 * 32 - d1 * 32 + 32)>
#map9 = affine_map<(d0) -> (27, d0 * 32 + 32)>
#map10 = affine_map<(d0) -> (32, d0 * 32 + 32)>
#map11 = affine_map<(d0) -> (32, 28, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %5 = sitofp %c32_i32 : i32 to f64
    store %5, %0[%c0] : memref<1xf64>
    br ^bb1(%c0_i32 : i32)
  ^bb1(%6: i32):  // 2 preds: ^bb0, ^bb5
    %7 = cmpi "slt", %6, %c32_i32 : i32
  ...
  ^bb2:  // pred: ^bb1
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S3(%4, %arg3) : (memref<28xf64>, index) -> ()
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map2(%arg2) to 1 {
        affine.for %arg4 = #map0(%arg2) to min #map3(%arg2, %arg3) {
          affine.for %arg5 = max #map4(%arg3, %arg4) to min #map1(%arg3) {
            call @S11(%2, %arg4, %arg5) : (memref<28x28xf64>, index, index) -> ()
          }
        }
      }
    }
    affine.for %arg2 = 0 to 2 {
      affine.for %arg3 = max #map5(%arg2) to min #map6(%arg2) {
        affine.for %arg4 = #map2(%arg3) to 1 {
          affine.for %arg5 = #map0(%arg3) to min #map3(%arg3, %arg4) {
            affine.for %arg6 = max #map4(%arg4, %arg5) to min #map1(%arg4) {
              affine.for %arg7 = #map7(%arg2, %arg3) to min #map8(%arg2, %arg3) {
                call @S12(%2, %arg5, %arg6, %1, %arg7) : (memref<28x28xf64>, index, index, memref<32x28xf64>, index) -> ()
              }
            }
          }
        }
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map2(%arg2) to 1 {
        affine.for %arg4 = #map0(%arg2) to min #map3(%arg2, %arg3) {
          affine.for %arg5 = max #map4(%arg3, %arg4) to min #map1(%arg3) {
            call @S13(%2, %arg4, %arg5) : (memref<28x28xf64>, index, index) -> ()
          }
        }
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map0(%arg2) to min #map9(%arg2) {
        call @S10(%2, %arg3) : (memref<28x28xf64>, index) -> ()
        call @S0(%3, %arg3) : (memref<28xf64>, index) -> ()
      }
      affine.if #set0(%arg2) {
        call @S0(%3, %c27) : (memref<28xf64>, index) -> ()
      }
    }
    affine.if #set1() {
      call @S0(%3, %c27) : (memref<28xf64>, index) -> ()
      ...
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map0(%arg2) to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map10(%arg3) {
            call @S1(%3, %arg4, %1, %arg5) : (memref<28xf64>, index, memref<32x28xf64>, index) -> ()
          }
        }
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S2(%3, %arg3, %9) : (memref<28xf64>, index, f64) -> ()
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map0(%arg2) to min #map11(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map11(%arg3) {
            call @S4(%4, %arg4, %3, %1, %arg5) : (memref<28xf64>, index, memref<28xf64>, memref<32x28xf64>, index) -> ()
            call @S8(%1, %arg5, %arg4, %3) : (memref<32x28xf64>, index, index, memref<28xf64>) -> ()
          }
          affine.for %arg5 = 28 to min #map10(%arg3) {
            call @S4(%4, %arg4, %3, %1, %arg5) : (memref<28xf64>, index, memref<28xf64>, memref<32x28xf64>, index) -> ()
          }
          affine.for %arg5 = 32 to min #map1(%arg3) {
            call @S8(%1, %arg5, %arg4, %3) : (memref<32x28xf64>, index, index, memref<28xf64>) -> ()
          }
        }
        affine.for %arg4 = 32 to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map10(%arg3) {
            call @S4(%4, %arg4, %3, %1, %arg5) : (memref<28xf64>, index, memref<28xf64>, memref<32x28xf64>, index) -> ()
          }
        }
        affine.for %arg4 = 28 to min #map10(%arg2) {
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S5(%4, %arg3, %9) : (memref<28xf64>, index, f64) -> ()
        call @S6(%4, %arg3) : (memref<28xf64>, index) -> ()
        call @S7(%4, %arg3) : (memref<28xf64>, index) -> ()
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map0(%arg2) to min #map10(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            call @S9(%1, %arg5, %arg4, %4, %9) : (memref<32x28xf64>, index, index, memref<28xf64>, f64) -> ()
          }
        }
      }
    }
  ...
  ^bb3(%10: i32):  // 2 preds: ^bb1, ^bb4
    %11 = cmpi "slt", %10, %c28_i32 : i32
    %12 = index_cast %10 : i32 to index
    cond_br %11, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %13 = muli %6, %10 : i32
    %14 = sitofp %13 : i32 to f64
    %15 = sitofp %c28_i32 : i32 to f64
    %16 = divf %14, %15 : f64
    %17 = sitofp %6 : i32 to f64
    %18 = addf %16, %17 : f64
    store %18, %1[%8, %12] : memref<32x28xf64>
