...
#map2 = affine_map<(d0) -> (28, d0 * 32 + 32)>
#map3 = affine_map<(d0, d1) -> (d0 * 32, d1)>
#map4 = affine_map<(d0) -> (32, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %4 = sitofp %c32_i32 : i32 to f64
    store %4, %0[%c0] : memref<1xf64>
    br ^bb1(%c0_i32 : i32)
  ^bb1(%5: i32):  // 2 preds: ^bb0, ^bb5
    %6 = cmpi "slt", %5, %c32_i32 : i32
  ...
  ^bb2:  // pred: ^bb1
      ...
      affine.for %arg3 = #map0(%arg2) to 1 {
        affine.for %arg4 = #map1(%arg2) to min #map2(%arg2) {
          affine.for %arg5 = max #map3(%arg3, %arg4) to min #map2(%arg3) {
            call @S4(%2, %arg4, %arg5) : (memref<28x28xf64>, index, index) -> ()
          }
        }
      }
    }
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map1(%arg2) to min #map2(%arg2) {
        call @S2(%3, %arg3, %8) : (memref<28xf64>, index, f64) -> ()
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map1(%arg2) to min #map4(%arg2) {
          affine.for %arg5 = #map1(%arg3) to min #map2(%arg3) {
            call @S3(%1, %arg5, %arg4, %3) : (memref<32x28xf64>, index, index, memref<28xf64>) -> ()
          }
        }
      }
    }
          ...
          affine.for %arg5 = #map1(%arg3) to min #map2(%arg3) {
            affine.for %arg6 = max #map3(%arg4, %arg5) to min #map2(%arg4) {
              affine.for %arg7 = #map7(%arg2, %arg3) to min #map8(%arg2, %arg3) {
                call @S5(%2, %arg5, %arg6, %1, %arg7) : (memref<28x28xf64>, index, index, memref<32x28xf64>, index) -> ()
              }
            }
          }
        }
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map0(%arg2) to 1 {
        affine.for %arg4 = #map1(%arg2) to min #map2(%arg2) {
          affine.for %arg5 = max #map3(%arg3, %arg4) to min #map2(%arg3) {
            call @S6(%2, %arg4, %arg5, %8) : (memref<28x28xf64>, index, index, f64) -> ()
            call @S7(%2, %arg4, %arg5) : (memref<28x28xf64>, index, index) -> ()
          }
        }
      }
    }
  ...
  ^bb3(%9: i32):  // 2 preds: ^bb1, ^bb4
    %10 = cmpi "slt", %9, %c28_i32 : i32
    %11 = index_cast %9 : i32 to index
    cond_br %10, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %12 = sitofp %5 : i32 to f64
    %13 = sitofp %9 : i32 to f64
    %14 = mulf %12, %13 : f64
    %15 = sitofp %c28_i32 : i32 to f64
    %16 = divf %14, %15 : f64
    store %16, %1[%7, %11] : memref<32x28xf64>
    %17 = addi %9, %c1_i32 : i32
    br ^bb3(%17 : i32)
  ^bb5:  // pred: ^bb3
  ...
  func @kernel_covariance_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<32x28xf64>, %arg4: memref<28x28xf64>, %arg5: memref<28xf64>) {
    %0 = index_cast %arg1 : i32 to index
    %1 = index_cast %arg0 : i32 to index
      ...
      affine.for %arg7 = #map0(%arg6) to #map9()[%1] {
        affine.for %arg8 = #map1(%arg6) to min #map10(%arg6)[%1] {
          affine.for %arg9 = max #map3(%arg7, %arg8) to min #map10(%arg7)[%1] {
            ...
            call @S7(%arg4, %arg8, %arg9) : (memref<28x28xf64>, index, index) -> ()
          }
        }
      }
    }
