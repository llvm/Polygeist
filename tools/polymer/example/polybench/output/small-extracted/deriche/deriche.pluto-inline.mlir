...
#map1 = affine_map<(d0) -> (64, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb2:  // pred: ^bb1
    ...
    affine.for %arg2 = 0 to 64 {
      call @S17(%25) : (memref<1xf32>) -> ()
      call @S16(%26) : (memref<1xf32>) -> ()
      call @S15(%20) : (memref<1xf32>) -> ()
      call @S14(%21) : (memref<1xf32>) -> ()
      affine.for %arg3 = 0 to 64 {
        call @S18(%4, %arg2, %arg3, %c64, %20, %13, %21, %15, %25, %19, %26, %24) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S21(%20, %21) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S22(%21, %4, %arg2, %arg3, %c64) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
        call @S19(%25, %26) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S20(%26, %1, %arg2, %arg3, %c64) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
      }
    }
    %27 = negf %9 : f32
    %28 = exp %27 : f32
    ...
    %40 = exp %39 : f32
    %41 = mulf %37, %40 : f32
    affine.store %41, %19[0] : memref<1xf32>
    %42 = mulf %cst_2, %9 : f32
    %43 = exp %42 : f32
    %44 = negf %9 : f32
    %45 = exp %44 : f32
    ...
    %53 = addf %9, %cst_1 : f32
    %54 = mulf %52, %53 : f32
    affine.store %54, %24[0] : memref<1xf32>
    %55 = mulf %cst_2, %9 : f32
    %56 = exp %55 : f32
    %57 = negf %9 : f32
    %58 = exp %57 : f32
    ...
    affine.for %arg2 = 0 to 64 {
      affine.for %arg3 = 0 to 64 {
        call @S10(%3, %arg2, %arg3, %12, %13, %14, %15, %16, %17, %1, %18) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
        call @S12(%12, %14) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S13(%14, %3, %arg2, %arg3) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
        call @S11(%16, %1, %arg2, %arg3) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
      }
      ...
      affine.for %arg3 = 0 to 2 {
        affine.for %arg4 = #map0(%arg2) to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            call @S23(%2, %arg4, %arg5, %4, %3, %23) : (memref<64x64xf32>, index, index, memref<64x64xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
          }
        }
      }
    }
    affine.for %arg2 = 0 to 64 {
      ...
      affine.for %arg3 = 0 to 64 {
        call @S35(%4, %arg2, %arg3, %c64, %20, %13, %21, %15, %10, %19, %11, %24) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S38(%20, %21) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S39(%21, %4, %arg2, %arg3, %c64) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
        call @S36(%10, %11) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S37(%11, %2, %arg2, %arg3, %c64) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
      }
    }
    affine.for %arg2 = 0 to 64 {
      ...
      affine.for %arg3 = 0 to 64 {
        call @S27(%3, %arg2, %arg3, %12, %13, %14, %15, %22, %17, %2, %18) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
        call @S29(%12, %14) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S30(%14, %3, %arg2, %arg3) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
        call @S28(%22, %2, %arg2, %arg3) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
      }
    }
    %78 = negf %cst_2 : f32
    %79 = mulf %78, %9 : f32
    ...
    affine.for %arg2 = 0 to 2 {
      affine.for %arg3 = 0 to 2 {
        affine.for %arg4 = #map0(%arg2) to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            call @S40(%2, %arg4, %arg5, %4, %3, %23) : (memref<64x64xf32>, index, index, memref<64x64xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
          }
        }
      }
    }
  ...
  ^bb4:  // pred: ^bb3
    ...
    store %91, %1[%8, %85] : memref<64x64xf32>
  ...
  func @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf32>, %arg3: memref<64x64xf32>, %arg4: memref<64x64xf32>) {
    %c0 = constant 0 : index
    %cst = constant 2.500000e-01 : f64
    %c0_i32 = constant 0 : i32
    %c313_i32 = constant 313 : i32
  ...
  func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<64x64xf32>, %arg4: memref<64x64xf32>, %arg5: memref<64x64xf32>, %arg6: memref<64x64xf32>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        call @S10(%arg5, %arg7, %arg8, %5, %68, %4, %67, %2, %23, %arg3, %12) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
        call @S11(%2, %arg3, %arg7, %arg8) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
        call @S12(%5, %4) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S13(%4, %arg5, %arg7, %arg8) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        call @S18(%arg6, %arg7, %arg8, %0, %11, %68, %10, %67, %7, %51, %6, %37) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S19(%7, %6) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S20(%6, %arg3, %arg7, %arg8, %0) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
        call @S21(%11, %10) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S22(%10, %arg6, %arg7, %arg8, %0) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %1 {
      affine.for %arg8 = 0 to %0 {
        call @S23(%arg4, %arg7, %arg8, %arg6, %arg5, %73) : (memref<64x64xf32>, index, index, memref<64x64xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
      }
    }
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        call @S27(%arg5, %arg8, %arg7, %5, %68, %4, %67, %3, %23, %arg4, %12) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
        call @S28(%3, %arg4, %arg8, %arg7) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
        call @S29(%5, %4) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S30(%4, %arg5, %arg8, %arg7) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        call @S35(%arg6, %arg8, %arg7, %1, %11, %68, %10, %67, %9, %51, %8, %37) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S36(%9, %8) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S37(%8, %arg4, %arg8, %arg7, %1) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
        call @S38(%11, %10) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S39(%10, %arg6, %arg8, %arg7, %1) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %1 {
      affine.for %arg8 = 0 to %0 {
        call @S40(%arg4, %arg7, %arg8, %arg6, %arg5, %73) : (memref<64x64xf32>, index, index, memref<64x64xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
      }
    }
    return
  }
  func @print_array(%arg0: i32, %arg1: i32, %arg2: memref<64x64xf32>) {
    %c0_i32 = constant 0 : i32
  ...
  func private @S10(%arg0: memref<64x64xf32>, %arg1: index, %arg2: index, %arg3: memref<1xf32>, %arg4: memref<1xf32>, %arg5: memref<1xf32>, %arg6: memref<1xf32>, %arg7: memref<1xf32>, %arg8: memref<1xf32>, %arg9: memref<64x64xf32>, %arg10: memref<1xf32>) attributes {scop.stmt} {
  ...
  func private @S11(%arg0: memref<1xf32>, %arg1: memref<64x64xf32>, %arg2: index, %arg3: index) attributes {scop.stmt} {
  ...
  func private @S13(%arg0: memref<1xf32>, %arg1: memref<64x64xf32>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2, %arg3] : memref<64x64xf32>
    affine.store %0, %arg0[0] : memref<1xf32>
    return
  }
  ...
  func private @S18(%arg0: memref<64x64xf32>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<1xf32>, %arg5: memref<1xf32>, %arg6: memref<1xf32>, %arg7: memref<1xf32>, %arg8: memref<1xf32>, %arg9: memref<1xf32>, %arg10: memref<1xf32>, %arg11: memref<1xf32>) attributes {scop.stmt} {
  ...
  func private @S22(%arg0: memref<1xf32>, %arg1: memref<64x64xf32>, %arg2: index, %arg3: index, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2, -%arg3 + symbol(%arg4) - 1] : memref<64x64xf32>
    affine.store %0, %arg0[0] : memref<1xf32>
    return
  }
  ...
  func private @S27(%arg0: memref<64x64xf32>, %arg1: index, %arg2: index, %arg3: memref<1xf32>, %arg4: memref<1xf32>, %arg5: memref<1xf32>, %arg6: memref<1xf32>, %arg7: memref<1xf32>, %arg8: memref<1xf32>, %arg9: memref<64x64xf32>, %arg10: memref<1xf32>) attributes {scop.stmt} {
    %0 = affine.load %arg10[0] : memref<1xf32>
    %1 = affine.load %arg9[%arg1, %arg2] : memref<64x64xf32>
    %2 = mulf %0, %1 : f32
    %3 = affine.load %arg8[0] : memref<1xf32>
  ...
  func private @S28(%arg0: memref<1xf32>, %arg1: memref<64x64xf32>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2, %arg3] : memref<64x64xf32>
    affine.store %0, %arg0[0] : memref<1xf32>
    return
  }
  ...
  func private @S35(%arg0: memref<64x64xf32>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<1xf32>, %arg5: memref<1xf32>, %arg6: memref<1xf32>, %arg7: memref<1xf32>, %arg8: memref<1xf32>, %arg9: memref<1xf32>, %arg10: memref<1xf32>, %arg11: memref<1xf32>) attributes {scop.stmt} {
    %0 = affine.load %arg11[0] : memref<1xf32>
    %1 = affine.load %arg10[0] : memref<1xf32>
    %2 = mulf %0, %1 : f32
    %3 = affine.load %arg9[0] : memref<1xf32>
  ...
  func @kernel_deriche_new(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<64x64xf32>, %arg4: memref<64x64xf32>, %arg5: memref<64x64xf32>, %arg6: memref<64x64xf32>) {
    %cst = constant 1.000000e+00 : f32
    %cst_0 = constant 2.000000e+00 : f32
    %c1_i32 = constant 1 : i32
    %0 = alloca() : memref<1xf32>
    ...
    affine.for %arg7 = 0 to %18 {
      ...
      affine.for %arg8 = 0 to %17 {
        call @S18(%arg6, %arg7, %arg8, %17, %10, %3, %11, %5, %15, %9, %16, %14) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S21(%10, %11) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S22(%11, %arg6, %arg7, %arg8, %17) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
        call @S19(%15, %16) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S20(%16, %arg3, %arg7, %arg8, %17) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
      }
    }
    %19 = negf %arg2 : f32
    %20 = exp %19 : f32
    ...
    %32 = exp %31 : f32
    %33 = mulf %29, %32 : f32
    affine.store %33, %9[0] : memref<1xf32>
    ...
    %46 = mulf %44, %45 : f32
    affine.store %46, %14[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to %18 {
      affine.for %arg8 = 0 to %17 {
        call @S10(%arg5, %arg7, %arg8, %2, %3, %4, %5, %6, %7, %arg3, %8) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
        call @S12(%2, %4) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S13(%4, %arg5, %arg7, %arg8) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
        call @S11(%6, %arg3, %arg7, %arg8) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
      }
      call @S9(%6) : (memref<1xf32>) -> ()
      call @S8(%2) : (memref<1xf32>) -> ()
      call @S7(%4) : (memref<1xf32>) -> ()
    }
    affine.for %arg7 = 0 to #map2()[%18] {
      affine.for %arg8 = 0 to #map2()[%17] {
        affine.for %arg9 = #map0(%arg7) to min #map3(%arg7)[%18] {
          affine.for %arg10 = #map0(%arg8) to min #map3(%arg8)[%17] {
            call @S23(%arg4, %arg9, %arg10, %arg6, %arg5, %13) : (memref<64x64xf32>, index, index, memref<64x64xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
          }
        }
      }
    }
    affine.for %arg7 = 0 to %18 {
      ...
      affine.for %arg8 = 0 to %17 {
        call @S35(%arg6, %arg7, %arg8, %18, %10, %3, %11, %5, %0, %9, %1, %14) : (memref<64x64xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S38(%10, %11) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S39(%11, %arg6, %arg7, %arg8, %18) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
        call @S36(%0, %1) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S37(%1, %arg4, %arg7, %arg8, %18) : (memref<1xf32>, memref<64x64xf32>, index, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %18 {
      ...
      affine.for %arg8 = 0 to %17 {
        call @S27(%arg5, %arg7, %arg8, %2, %3, %4, %5, %12, %7, %arg4, %8) : (memref<64x64xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
        call @S29(%2, %4) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S30(%4, %arg5, %arg7, %arg8) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
        call @S28(%12, %arg4, %arg7, %arg8) : (memref<1xf32>, memref<64x64xf32>, index, index) -> ()
      }
    }
    %70 = negf %cst_0 : f32
    %71 = mulf %70, %arg2 : f32
    ...
    affine.for %arg7 = 0 to #map2()[%18] {
      affine.for %arg8 = 0 to #map2()[%17] {
        affine.for %arg9 = #map0(%arg7) to min #map3(%arg7)[%18] {
          affine.for %arg10 = #map0(%arg8) to min #map3(%arg8)[%17] {
            call @S40(%arg4, %arg9, %arg10, %arg6, %arg5, %13) : (memref<64x64xf32>, index, index, memref<64x64xf32>, memref<64x64xf32>, memref<1xf32>) -> ()
          }
        }
      }
    }
