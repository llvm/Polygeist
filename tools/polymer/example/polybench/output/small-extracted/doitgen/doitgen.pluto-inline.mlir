...
#map1 = affine_map<(d0) -> (12, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %0 = alloc() : memref<10x8x12xf64>
    %1 = alloc() : memref<12xf64>
    %2 = alloc() : memref<12x12xf64>
    br ^bb1(%c0_i32 : i32)
  ^bb1(%3: i32):  // 2 preds: ^bb0, ^bb3
    %4 = cmpi "slt", %3, %c10_i32 : i32
    %5 = index_cast %3 : i32 to index
    cond_br %4, ^bb2(%c0_i32 : i32), ^bb7(%c0_i32 : i32)
  ^bb2(%6: i32):  // 2 preds: ^bb1, ^bb6
    %7 = cmpi "slt", %6, %c8_i32 : i32
  ...
  ^bb4(%10: i32):  // 2 preds: ^bb2, ^bb5
    %11 = cmpi "slt", %10, %c12_i32 : i32
    %12 = index_cast %10 : i32 to index
    cond_br %11, ^bb5, ^bb6
  ^bb5:  // pred: ^bb4
    %13 = muli %3, %6 : i32
    %14 = addi %13, %10 : i32
    %15 = remi_signed %14, %c12_i32 : i32
    %16 = sitofp %15 : i32 to f64
    %17 = sitofp %c12_i32 : i32 to f64
    %18 = divf %16, %17 : f64
    store %18, %0[%5, %8, %12] : memref<10x8x12xf64>
      ...
      affine.for %arg3 = 0 to 8 {
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = #map0(%arg4) to min #map1(%arg4) {
            call @S0(%1, %arg2) : (memref<12xf64>, index) -> ()
          }
        }
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = 0 to 1 {
            affine.for %arg6 = #map0(%arg4) to min #map1(%arg4) {
              affine.for %arg7 = #map0(%arg5) to min #map1(%arg5) {
                call @S1(%1, %arg2, %2, %arg3, %0, %arg6, %arg7) : (memref<12xf64>, index, memref<12x12xf64>, index, memref<10x8x12xf64>, index, index) -> ()
              }
            }
          }
        }
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = #map0(%arg4) to min #map1(%arg4) {
            call @S2(%0, %arg2, %arg3, %arg5, %1) : (memref<10x8x12xf64>, index, index, index, memref<12xf64>) -> ()
          }
        }
      }
    }
    call @print_array(%c10_i32, %c8_i32, %c12_i32, %0) : (i32, i32, i32, memref<10x8x12xf64>) -> ()
    return %c0_i32 : i32
  ^bb9(%24: i32):  // 2 preds: ^bb7, ^bb10
    %25 = cmpi "slt", %24, %c12_i32 : i32
    %26 = index_cast %24 : i32 to index
    cond_br %25, ^bb10, ^bb11
  ^bb10:  // pred: ^bb9
    %27 = muli %21, %24 : i32
    %28 = remi_signed %27, %c12_i32 : i32
    %29 = sitofp %28 : i32 to f64
    %30 = sitofp %c12_i32 : i32 to f64
    %31 = divf %29, %30 : f64
    store %31, %2[%23, %26] : memref<12x12xf64>
    %32 = addi %24, %c1_i32 : i32
    br ^bb9(%32 : i32)
  ^bb11:  // pred: ^bb9
    %33 = addi %21, %c1_i32 : i32
    br ^bb7(%33 : i32)
  }
  func @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<10x8x12xf64>, %arg4: memref<12x12xf64>) {
    %c0_i32 = constant 0 : i32
    %c1_i32 = constant 1 : i32
    br ^bb1(%c0_i32 : i32)
  ...
  ^bb5:  // pred: ^bb4
    ...
    %15 = divf %13, %14 : f64
    store %15, %arg3[%2, %5, %9] : memref<10x8x12xf64>
  ...
  ^bb10:  // pred: ^bb9
    ...
    %28 = divf %26, %27 : f64
    store %28, %arg4[%20, %23] : memref<12x12xf64>
  ...
  func @kernel_doitgen(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<10x8x12xf64>, %arg4: memref<12x12xf64>, %arg5: memref<12xf64>) {
    ...
    affine.for %arg6 = 0 to %2 {
      affine.for %arg7 = 0 to %0 {
        affine.for %arg8 = 0 to %1 {
          call @S0(%arg5, %arg8) : (memref<12xf64>, index) -> ()
          affine.for %arg9 = 0 to %1 {
            call @S1(%arg5, %arg8, %arg4, %arg9, %arg3, %arg6, %arg7) : (memref<12xf64>, index, memref<12x12xf64>, index, memref<10x8x12xf64>, index, index) -> ()
          }
        }
        affine.for %arg8 = 0 to %1 {
          call @S2(%arg3, %arg6, %arg7, %arg8, %arg5) : (memref<10x8x12xf64>, index, index, index, memref<12xf64>) -> ()
        }
      }
    }
    return
  }
  func @print_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<10x8x12xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  ^bb6:  // pred: ^bb5
    ...
    %46 = load %arg3[%15, %30, %34] : memref<10x8x12xf64>
  ...
  func private @S0(%arg0: memref<12xf64>, %arg1: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1] : memref<12xf64>
    return
  }
  func private @S1(%arg0: memref<12xf64>, %arg1: index, %arg2: memref<12x12xf64>, %arg3: index, %arg4: memref<10x8x12xf64>, %arg5: index, %arg6: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1] : memref<12xf64>
    %1 = affine.load %arg4[%arg5, %arg6, %arg3] : memref<10x8x12xf64>
    %2 = affine.load %arg2[%arg3, %arg1] : memref<12x12xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1] : memref<12xf64>
    return
  }
  func private @S2(%arg0: memref<10x8x12xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<12xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[%arg3] : memref<12xf64>
    affine.store %0, %arg0[%arg1, %arg2, %arg3] : memref<10x8x12xf64>
    return
  }
  func @kernel_doitgen_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<10x8x12xf64>, %arg4: memref<12x12xf64>, %arg5: memref<12xf64>) {
      ...
      affine.for %arg7 = 0 to %1 {
        affine.for %arg8 = 0 to #map2()[%0] {
          affine.for %arg9 = #map0(%arg8) to min #map3(%arg8)[%0] {
            call @S0(%arg5, %arg6) : (memref<12xf64>, index) -> ()
          }
        }
        affine.for %arg8 = 0 to #map2()[%0] {
          affine.for %arg9 = 0 to #map2()[%0] {
            affine.for %arg10 = #map0(%arg8) to min #map3(%arg8)[%0] {
              affine.for %arg11 = #map0(%arg9) to min #map3(%arg9)[%0] {
                call @S1(%arg5, %arg6, %arg4, %arg7, %arg3, %arg10, %arg11) : (memref<12xf64>, index, memref<12x12xf64>, index, memref<10x8x12xf64>, index, index) -> ()
              }
            }
          }
        }
        affine.for %arg8 = 0 to #map2()[%0] {
          affine.for %arg9 = #map0(%arg8) to min #map3(%arg8)[%0] {
            call @S2(%arg3, %arg6, %arg7, %arg9, %arg5) : (memref<10x8x12xf64>, index, index, index, memref<12xf64>) -> ()
          }
        }
      }
    }
