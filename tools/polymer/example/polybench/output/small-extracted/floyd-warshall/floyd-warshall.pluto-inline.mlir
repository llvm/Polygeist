#map0 = affine_map<(d0) -> (0, (d0 * 32 - 59) ceildiv 32)>
#map1 = affine_map<(d0) -> (2, d0 + 1)>
#map2 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32)>
#map3 = affine_map<(d0, d1) -> (60, d0 * 32 - d1 * 32 + 32)>
#map4 = affine_map<(d0) -> (d0 * 32)>
#map5 = affine_map<(d0) -> (60, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %0 = alloc() : memref<60x60xi32>
    br ^bb1(%c0_i32 : i32)
  ^bb1(%1: i32):  // 2 preds: ^bb0, ^bb5
    %2 = cmpi "slt", %1, %c60_i32 : i32
        ...
        affine.for %arg4 = max #map0(%arg3) to min #map1(%arg3) {
          affine.for %arg5 = #map2(%arg3, %arg4) to min #map3(%arg3, %arg4) {
            affine.for %arg6 = #map4(%arg4) to min #map5(%arg4) {
              call @S0(%0, %arg2, %arg5, %arg6) : (memref<60x60xi32>, index, index, index) -> ()
            }
          }
        }
      }
    }
    call @print_array(%c60_i32, %0) : (i32, memref<60x60xi32>) -> ()
    return %c0_i32 : i32
  ^bb3(%4: i32):  // 2 preds: ^bb1, ^bb4
    %5 = cmpi "slt", %4, %c60_i32 : i32
    %6 = index_cast %4 : i32 to index
    cond_br %5, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %7 = muli %1, %4 : i32
    %8 = remi_signed %7, %c7_i32 : i32
    %9 = addi %8, %c1_i32 : i32
    store %9, %0[%3, %6] : memref<60x60xi32>
    %10 = addi %1, %4 : i32
    %11 = remi_signed %10, %c13_i32 : i32
    %12 = cmpi "eq", %11, %c0_i32 : i32
    %13 = scf.if %12 -> (i1) {
      scf.yield %true : i1
    } else {
      %17 = remi_signed %10, %c7_i32 : i32
      %18 = cmpi "eq", %17, %c0_i32 : i32
      scf.yield %18 : i1
    }
    %14 = scf.if %13 -> (i1) {
      scf.yield %true : i1
    } else {
      %17 = remi_signed %10, %c11_i32 : i32
      %18 = cmpi "eq", %17, %c0_i32 : i32
      scf.yield %18 : i1
    }
    scf.if %14 {
      store %c999_i32, %0[%3, %6] : memref<60x60xi32>
    }
  ...
  func @init_array(%arg0: i32, %arg1: memref<60x60xi32>) {
    %c0_i32 = constant 0 : i32
    %c7_i32 = constant 7 : i32
    %c13_i32 = constant 13 : i32
    %true = constant true
  ...
  ^bb4:  // pred: ^bb3
    ...
    %8 = addi %7, %c1_i32 : i32
    store %8, %arg1[%2, %5] : memref<60x60xi32>
    %9 = addi %0, %3 : i32
    ...
    scf.if %13 {
      store %c999_i32, %arg1[%2, %5] : memref<60x60xi32>
    }
  ...
  func @kernel_floyd_warshall(%arg0: i32, %arg1: memref<60x60xi32>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to %0 {
        affine.for %arg4 = 0 to %0 {
          call @S0(%arg1, %arg3, %arg4, %arg2) : (memref<60x60xi32>, index, index, index) -> ()
        }
      }
    }
    return
  ...
  ^bb4:  // pred: ^bb3
    ...
    %39 = load %arg1[%15, %30] : memref<60x60xi32>
  ...
  func private @S0(%arg0: memref<60x60xi32>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<60x60xi32>
    %1 = affine.load %arg0[%arg1, %arg3] : memref<60x60xi32>
    %2 = affine.load %arg0[%arg3, %arg2] : memref<60x60xi32>
    %3 = addi %1, %2 : i32
    %4 = cmpi "slt", %0, %3 : i32
    %5 = scf.if %4 -> (i32) {
      %6 = affine.load %arg0[%arg1, %arg2] : memref<60x60xi32>
      scf.yield %6 : i32
    } else {
      %6 = affine.load %arg0[%arg1, %arg3] : memref<60x60xi32>
      %7 = affine.load %arg0[%arg3, %arg2] : memref<60x60xi32>
      %8 = addi %6, %7 : i32
      scf.yield %8 : i32
    }
    affine.store %5, %arg0[%arg1, %arg2] : memref<60x60xi32>
    return
  }
  func @kernel_floyd_warshall_new(%arg0: i32, %arg1: memref<60x60xi32>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg2 = 0 to %0 {
        ...
        affine.for %arg4 = max #map7(%arg3)[%0] to min #map8(%arg3)[%0] {
          affine.for %arg5 = #map2(%arg3, %arg4) to min #map9(%arg3, %arg4)[%0] {
            affine.for %arg6 = #map4(%arg4) to min #map10(%arg4)[%0] {
              call @S0(%arg1, %arg2, %arg5, %arg6) : (memref<60x60xi32>, index, index, index) -> ()
            }
          }
        }
      }
