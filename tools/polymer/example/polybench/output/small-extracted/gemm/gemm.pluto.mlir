...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_gemm_new(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: f64, %arg4: f64, %arg5: memref<20x25xf64>, %arg6: memref<20x30xf64>, %arg7: memref<30x25xf64>) {
    ...
    affine.for %arg8 = 0 to #map3()[%1, %2] {
      affine.for %arg9 = max #map4(%arg8)[%2] to min #map5(%arg8)[%1] {
        affine.for %arg10 = 0 to #map0()[%0] {
          affine.for %arg11 = #map1(%arg9) to min #map2(%arg9)[%1] {
            affine.for %arg12 = #map1(%arg10) to min #map2(%arg10)[%0] {
              affine.for %arg13 = #map6(%arg8, %arg9) to min #map7(%arg8, %arg9)[%2] {
                call @S1(%arg5, %arg12, %arg11, %arg7, %arg13, %arg3, %arg6) : (memref<20x25xf64>, index, index, memref<30x25xf64>, index, f64, memref<20x30xf64>) -> ()
              }
            }
          }
        }
