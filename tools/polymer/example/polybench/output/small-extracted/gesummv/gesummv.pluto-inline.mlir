...
#map1 = affine_map<(d0) -> (30, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb1(%7: i32):  // 2 preds: ^bb0, ^bb6
    %8 = cmpi "slt", %7, %c30_i32 : i32
    %9 = index_cast %7 : i32 to index
    cond_br %8, ^bb2, ^bb3
  ^bb2:  // pred: ^bb1
    %10 = remi_signed %7, %c30_i32 : i32
    %11 = sitofp %10 : i32 to f64
    %12 = sitofp %c30_i32 : i32 to f64
    %13 = divf %11, %12 : f64
    store %13, %5[%9] : memref<30xf64>
    br ^bb4(%c0_i32 : i32)
  ^bb3:  // pred: ^bb1
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S1(%6, %arg3) : (memref<30xf64>, index) -> ()
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map0(%arg2) to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            call @S3(%6, %arg4, %5, %arg5, %3) : (memref<30xf64>, index, memref<30xf64>, index, memref<30x30xf64>) -> ()
          }
        }
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S0(%4, %arg3) : (memref<30xf64>, index) -> ()
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map0(%arg2) to min #map1(%arg2) {
          affine.for %arg5 = #map0(%arg3) to min #map1(%arg3) {
            call @S2(%4, %arg4, %5, %arg5, %2) : (memref<30xf64>, index, memref<30xf64>, index, memref<30x30xf64>) -> ()
          }
        }
      }
    }
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S4(%6, %arg3, %15, %14, %4) : (memref<30xf64>, index, f64, f64, memref<30xf64>) -> ()
      }
    }
  ...
  ^bb5:  // pred: ^bb4
    ...
    %23 = divf %22, %12 : f64
    store %23, %2[%9, %18] : memref<30x30xf64>
    %24 = addi %19, %c2_i32 : i32
    %25 = remi_signed %24, %c30_i32 : i32
    %26 = sitofp %25 : i32 to f64
    %27 = divf %26, %12 : f64
    store %27, %3[%9, %18] : memref<30x30xf64>
  ...
  func @kernel_gesummv_new(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<30x30xf64>, %arg4: memref<30x30xf64>, %arg5: memref<30xf64>, %arg6: memref<30xf64>, %arg7: memref<30xf64>) {
    %0 = index_cast %arg0 : i32 to index
      ...
      affine.for %arg9 = 0 to #map2()[%0] {
        affine.for %arg10 = #map0(%arg8) to min #map3(%arg8)[%0] {
          affine.for %arg11 = #map0(%arg9) to min #map3(%arg9)[%0] {
            call @S3(%arg7, %arg10, %arg6, %arg11, %arg4) : (memref<30xf64>, index, memref<30xf64>, index, memref<30x30xf64>) -> ()
          }
        }
      }
    }
    ...
    affine.for %arg8 = 0 to #map2()[%0] {
      affine.for %arg9 = 0 to #map2()[%0] {
        affine.for %arg10 = #map0(%arg8) to min #map3(%arg8)[%0] {
          affine.for %arg11 = #map0(%arg9) to min #map3(%arg9)[%0] {
            call @S2(%arg5, %arg10, %arg6, %arg11, %arg3) : (memref<30xf64>, index, memref<30xf64>, index, memref<30x30xf64>) -> ()
          }
        }
      }
    }
