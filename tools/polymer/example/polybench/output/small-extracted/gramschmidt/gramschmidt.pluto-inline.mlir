...
#map2 = affine_map<(d0, d1) -> (29, d0 * 32 + 32, d1 * 32 + 31)>
#map3 = affine_map<(d0, d1) -> (d0 * 32, d1 + 1)>
#map4 = affine_map<(d0) -> (30, d0 * 32 + 32)>
#map5 = affine_map<(d0) -> (20, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb6:  // pred: ^bb5
    ...
    affine.for %arg2 = 0 to 29 {
      ...
      affine.for %arg3 = 0 to 20 {
        call @S1(%23, %0, %arg2, %arg3) : (memref<1xf64>, memref<20x30xf64>, index, index) -> ()
      }
      call @S2(%1, %arg2, %23) : (memref<30x30xf64>, index, memref<1xf64>) -> ()
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map1(%arg3) to min #map5(%arg3) {
          call @S3(%2, %arg2, %arg4, %1, %0) : (memref<20x30xf64>, index, index, memref<30x30xf64>, memref<20x30xf64>) -> ()
        }
      }
      affine.for %arg3 = #map6(%arg2) to 1 {
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = max #map3(%arg2, %arg3) to min #map4(%arg3) {
            affine.for %arg6 = #map1(%arg4) to min #map5(%arg4) {
              call @S5(%1, %arg2, %arg5, %0, %arg6, %2) : (memref<30x30xf64>, index, index, memref<20x30xf64>, index, memref<20x30xf64>) -> ()
            }
          }
        }
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = max #map3(%arg2, %arg3) to min #map4(%arg3) {
            affine.for %arg6 = #map1(%arg4) to min #map5(%arg4) {
              call @S6(%0, %arg2, %arg5, %1, %arg6, %2) : (memref<20x30xf64>, index, index, memref<30x30xf64>, index, memref<20x30xf64>) -> ()
            }
          }
        }
      }
    ...
    affine.for %arg2 = 0 to 20 {
      call @S1(%23, %0, %c29, %arg2) : (memref<1xf64>, memref<20x30xf64>, index, index) -> ()
    }
    %24 = affine.load %23[0] : memref<1xf64>
    %25 = sqrt %24 : f64
    affine.store %25, %1[symbol(%c30) - 1, symbol(%c30) - 1] : memref<30x30xf64>
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = #map1(%arg2) to min #map5(%arg2) {
        call @S3(%2, %c29, %arg3, %1, %0) : (memref<20x30xf64>, index, index, memref<30x30xf64>, memref<20x30xf64>) -> ()
      }
    }
    call @print_array(%c20_i32, %c30_i32, %0, %1, %2) : (i32, i32, memref<20x30xf64>, memref<30x30xf64>, memref<20x30xf64>) -> ()
    return %c0_i32 : i32
  ^bb7(%26: i32):  // 2 preds: ^bb5, ^bb8
    %27 = cmpi "slt", %26, %c30_i32 : i32
    %28 = index_cast %26 : i32 to index
    cond_br %27, ^bb8, ^bb9
  ^bb8:  // pred: ^bb7
    store %cst, %1[%22, %28] : memref<30x30xf64>
  ...
  func @init_array(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) {
    %c0_i32 = constant 0 : i32
    %c100_i32 = constant 100 : i32
    %c10_i32 = constant 10 : i32
    %cst = constant 0.000000e+00 : f64
  ...
  ^bb3:  // pred: ^bb2
    ...
    %14 = addf %12, %13 : f64
    store %14, %arg2[%2, %5] : memref<20x30xf64>
    store %cst, %arg4[%2, %5] : memref<20x30xf64>
  ...
  ^bb7(%20: i32):  // 2 preds: ^bb5, ^bb8
    ...
    cond_br %21, ^bb8, ^bb9
  ^bb8:  // pred: ^bb7
    store %cst, %arg3[%19, %22] : memref<30x30xf64>
  ...
  func @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) {
    ...
    affine.for %arg5 = 0 to %2 {
      ...
      affine.for %arg6 = 0 to %0 {
        call @S1(%1, %arg2, %arg6, %arg5) : (memref<1xf64>, memref<20x30xf64>, index, index) -> ()
      }
      call @S2(%arg3, %arg5, %1) : (memref<30x30xf64>, index, memref<1xf64>) -> ()
      affine.for %arg6 = 0 to %0 {
        call @S3(%arg4, %arg6, %arg5, %arg3, %arg2) : (memref<20x30xf64>, index, index, memref<30x30xf64>, memref<20x30xf64>) -> ()
      }
      affine.for %arg6 = #map7(%arg5) to %2 {
        call @S4(%arg3, %arg5, %arg6) : (memref<30x30xf64>, index, index) -> ()
        affine.for %arg7 = 0 to %0 {
          call @S5(%arg3, %arg5, %arg6, %arg2, %arg7, %arg4) : (memref<30x30xf64>, index, index, memref<20x30xf64>, index, memref<20x30xf64>) -> ()
        }
        affine.for %arg7 = 0 to %0 {
          call @S6(%arg2, %arg7, %arg6, %arg3, %arg5, %arg4) : (memref<20x30xf64>, index, index, memref<30x30xf64>, index, memref<20x30xf64>) -> ()
        }
      }
    }
    return
  }
  func @print_array(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) {
    %c0_i32 = constant 0 : i32
    %c20_i32 = constant 20 : i32
    %c1_i32 = constant 1 : i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    %41 = load %arg3[%15, %32] : memref<30x30xf64>
  ...
  ^bb9:  // pred: ^bb8
    ...
    %72 = load %arg4[%48, %63] : memref<20x30xf64>
  ...
  func private @S1(%arg0: memref<1xf64>, %arg1: memref<20x30xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg1[%arg2, %arg3] : memref<20x30xf64>
    %2 = affine.load %arg1[%arg2, %arg3] : memref<20x30xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[0] : memref<1xf64>
    return
  }
  func private @S2(%arg0: memref<30x30xf64>, %arg1: index, %arg2: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg2[0] : memref<1xf64>
    %1 = sqrt %0 : f64
    affine.store %1, %arg0[%arg1, %arg1] : memref<30x30xf64>
    return
  }
  func private @S3(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[%arg1, %arg2] : memref<20x30xf64>
    %1 = affine.load %arg3[%arg2, %arg2] : memref<30x30xf64>
    %2 = divf %0, %1 : f64
    affine.store %2, %arg0[%arg1, %arg2] : memref<20x30xf64>
    return
  }
  func private @S4(%arg0: memref<30x30xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[%arg1, %arg2] : memref<30x30xf64>
    return
  }
  func private @S5(%arg0: memref<30x30xf64>, %arg1: index, %arg2: index, %arg3: memref<20x30xf64>, %arg4: index, %arg5: memref<20x30xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<30x30xf64>
    %1 = affine.load %arg5[%arg4, %arg1] : memref<20x30xf64>
    %2 = affine.load %arg3[%arg4, %arg2] : memref<20x30xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1, %arg2] : memref<30x30xf64>
    return
  }
  func private @S6(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: memref<30x30xf64>, %arg4: index, %arg5: memref<20x30xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<20x30xf64>
    %1 = affine.load %arg5[%arg1, %arg4] : memref<20x30xf64>
    %2 = affine.load %arg3[%arg4, %arg2] : memref<30x30xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[%arg1, %arg2] : memref<20x30xf64>
    return
  }
  func @kernel_gramschmidt_new(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>, %arg3: memref<30x30xf64>, %arg4: memref<20x30xf64>) {
    %cst = constant 0.000000e+00 : f64
      ...
      affine.for %arg6 = #map0(%arg5) to #map9()[%2] {
        affine.for %arg7 = #map1(%arg5) to min #map10(%arg5, %arg6)[%2] {
          affine.for %arg8 = max #map3(%arg6, %arg7) to min #map11(%arg6)[%2] {
            call @S4(%arg3, %arg7, %arg8) : (memref<30x30xf64>, index, index) -> ()
          }
        }
      }
    }
    affine.for %arg5 = 0 to #map12()[%2] {
      ...
      affine.for %arg6 = 0 to %1 {
        call @S1(%0, %arg2, %arg5, %arg6) : (memref<1xf64>, memref<20x30xf64>, index, index) -> ()
      }
      call @S2(%arg3, %arg5, %0) : (memref<30x30xf64>, index, memref<1xf64>) -> ()
      affine.for %arg6 = 0 to #map9()[%1] {
        affine.for %arg7 = #map1(%arg6) to min #map11(%arg6)[%1] {
          call @S3(%arg4, %arg5, %arg7, %arg3, %arg2) : (memref<20x30xf64>, index, index, memref<30x30xf64>, memref<20x30xf64>) -> ()
        }
      }
        ...
        affine.for %arg7 = 0 to #map9()[%1] {
          affine.for %arg8 = max #map3(%arg5, %arg6) to min #map11(%arg6)[%2] {
            affine.for %arg9 = #map1(%arg7) to min #map11(%arg7)[%1] {
              call @S5(%arg3, %arg5, %arg8, %arg2, %arg9, %arg4) : (memref<30x30xf64>, index, index, memref<20x30xf64>, index, memref<20x30xf64>) -> ()
            }
          }
        }
        affine.for %arg7 = 0 to #map9()[%1] {
          affine.for %arg8 = max #map3(%arg5, %arg6) to min #map11(%arg6)[%2] {
            affine.for %arg9 = #map1(%arg7) to min #map11(%arg7)[%1] {
              call @S6(%arg2, %arg5, %arg8, %arg3, %arg9, %arg4) : (memref<20x30xf64>, index, index, memref<30x30xf64>, index, memref<20x30xf64>) -> ()
            }
          }
        }
      }
    ...
    affine.for %arg5 = 0 to %1 {
      ...
      call @S1(%0, %arg2, %5, %arg5) : (memref<1xf64>, memref<20x30xf64>, index, index) -> ()
    }
    %3 = affine.load %0[0] : memref<1xf64>
    %4 = sqrt %3 : f64
    affine.store %4, %arg3[symbol(%2) - 1, symbol(%2) - 1] : memref<30x30xf64>
    affine.for %arg5 = 0 to #map9()[%1] {
      affine.for %arg6 = #map1(%arg5) to min #map11(%arg5)[%1] {
        %5 = affine.apply #map12()[%2]
        call @S3(%arg4, %5, %arg6, %arg3, %arg2) : (memref<20x30xf64>, index, index, memref<30x30xf64>, memref<20x30xf64>) -> ()
      }
    }
    return
  }
