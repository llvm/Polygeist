...
#map8 = affine_map<(d0)[s0] -> (d0 - s0 * 2 + 1)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_jacobi_1d_new(%arg0: i32, %arg1: i32, %arg2: memref<30xf64>, %arg3: memref<30xf64>) {
    ...
    affine.for %arg4 = -1 to min #map1()[%0, %1] {
      ...
      affine.for %arg5 = max #map2(%arg4)[%0] to min #map3(%arg4)[%0, %1] {
        affine.if #set2(%arg4) {
          affine.for %arg6 = #map4(%arg5) to #map5(%arg5) {
            call @S0(%arg3, %arg6, %arg2) : (memref<30xf64>, index, memref<30xf64>) -> ()
          }
        }
        affine.for %arg6 = #map6(%arg4, %arg5)[%0] to min #map7(%arg4, %arg5)[%0, %1] {
          %2 = affine.apply #map8(%arg6)[%0]
          call @S1(%arg2, %2, %arg3) : (memref<30xf64>, index, memref<30xf64>) -> ()
        }
        affine.if #set3(%arg4, %arg5)[%0, %1] {
