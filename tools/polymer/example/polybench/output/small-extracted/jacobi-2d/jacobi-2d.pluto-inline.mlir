#map0 = affine_map<(d0) -> (40, d0 * 32)>
#map1 = affine_map<(d0) -> (d0 * 32 + 32, 68)>
#map2 = affine_map<(d0) -> (d0 ceildiv 2, (d0 * 16 - 18) ceildiv 16)>
#map3 = affine_map<(d0) -> (3, (d0 * 16 + 43) floordiv 32 + 1, d0 + 2)>
#map4 = affine_map<(d0) -> (d0 * 8 + 7)>
#map5 = affine_map<(d0, d1) -> (0, (d0 - 1) ceildiv 2, (d1 * 32 - 57) ceildiv 32)>
#map6 = affine_map<(d0, d1) -> (3, (d0 * 16 + 58) floordiv 32 + 1, d1 + 2)>
#map7 = affine_map<(d0, d1) -> (d0 * 32, d1 * 32 - 27)>
#map8 = affine_map<(d0, d1) -> (d0 * 32 + 1, d1 * 32 + 32)>
#map9 = affine_map<(d0)[s0] -> ((d0 * 32 - s0 + 1) ceildiv 2)>
#map10 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 32 - 27, d2 * -32 + d0 * 32 + d1 * 64 - 87)>
#map11 = affine_map<(d0, d1, d2) -> (d0 * 32 + 32, d1 * -32 + d0 * 32 + d2 * 64 - 55)>
#map12 = affine_map<(d0, d1)[s0] -> (d0 * -32 + d1 + s0 - 2)>
#map13 = affine_map<(d0, d1) -> (d0 * 32, d1 * 16 + 2)>
#map14 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 16 + 30)>
#map15 = affine_map<(d0) -> (d0 * 8)>
#map16 = affine_map<(d0, d1, d2) -> (0, (d0 * 32 - 28) ceildiv 2, (d1 * 32 - 28) ceildiv 2, d2 * 8, d2 * 16 - d0 * 16 + 1)>
#map17 = affine_map<(d0, d1, d2) -> (d0 * 16 - d1 * 16 + 25, 30, d0 * 8 + 16, d1 * 16 + 15, d2 * 16 + 15)>
#map18 = affine_map<(d0, d1) -> (d0 * 32, d1 * 2 + 1)>
#map19 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 2 + 29)>
...
#map24 = affine_map<(d0, d1, d2) -> (d0 * 32 + 32, d1 * -32 + d0 * 32 + d2 * 4 + 1, d2 * 2 + 29)>
#map25 = affine_map<(d0, d1) -> (d0 * 32, d1 * 2 + 2)>
#map26 = affine_map<(d0, d1) -> (d0 * -2 + d1 - 1)>
#map27 = affine_map<(d0, d1, d2) -> (d0 * -32 + d1 * 32 + d2 * 4 + 1)>
#map28 = affine_map<(d0, d1, d2) -> (d0 * 32 + 32, d1 * 2 + 30, d2 * -32 + d0 * 32 + d1 * 4 + 3)>
#map29 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 2 + 30)>
#map30 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 32 - d2 * 32 + 60)>
#map31 = affine_map<(d0, d1, d2) -> (d0 * 32 + 32, d1 * 32 - d2 * 32 + 88)>
#map32 = affine_map<(d0, d1)[s0] -> ((d0 * 32 - d1 * 32 + s0 + 29) ceildiv 2)>
#map33 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 32 + 31, d2 * -32 + d0 * 32 + d1 * 64 + 29)>
#map34 = affine_map<(d0, d1, d2) -> (d0 * 32 + 32, d1 * 32 + 59, d2 * -32 + d0 * 32 + d1 * 64 + 61)>
#map35 = affine_map<(d0) -> (d0 * 16 + 15)>
#map36 = affine_map<(d0, d1) -> (d0 * -32 + d1 - 30)>
#map37 = affine_map<(d0) -> (d0 * 32)>
#map38 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 16 + 59)>
#map39 = affine_map<(d0) -> (d0 * 8 + 15)>
#map40 = affine_map<(d0, d1) -> (d0 * -16 + d1 * 32)>
#map41 = affine_map<(d0, d1) -> (40, d0 * 32, d1 * -32 + d0 * 32 + 47)>
#map42 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * -32 + d0 * 32 + 79)>
#map43 = affine_map<(d0)[s0] -> (d0 - s0 * 2 + 1)>
#map44 = affine_map<(d0) -> (1, d0 * 32)>
#map45 = affine_map<(d0) -> (29, d0 * 32 + 32)>
...
#set0 = affine_set<(d0) : (d0 * 8 - 19 == 0)>
#set1 = affine_set<() : (3 == 0)>
#set2 = affine_set<(d0, d1) : (d0 - 1 >= 0, d0 * 16 - (d1 * 32 - 42) == 0)>
#set3 = affine_set<(d0) : ((d0 + 1) mod 2 == 0)>
#set4 = affine_set<(d0) : ((d0 * 16 + 950) mod 32 == 0)>
#set5 = affine_set<(d0, d1) : (d1 * 2 - d0 - 2 >= 0, d1 - 1 >= 0)>
#set6 = affine_set<() : (1 == 0)>
#set7 = affine_set<(d0, d1, d2) : (d1 * 2 - d0 - 2 >= 0, d2 + d1 - d0 - 1 >= 0, d1 - d2 - 1 >= 0, d1 - 1 >= 0)>
#set8 = affine_set<(d0, d1, d2) : (d0 - d1 * 2 == 0, d0 - (d2 * 32 - 29) ceildiv 16 >= 0)>
...
#set12 = affine_set<(d0, d1) : (d0 - (d1 * 2 - 2) ceildiv 32 >= 0)>
#set13 = affine_set<(d0, d1, d2) : ((d1 * 32 + d2 * 2 - 29) floordiv 32 - d0 >= 0, d1 - (d2 * 2 - 2) ceildiv 32 >= 0)>
#set14 = affine_set<(d0, d1, d2) : (d1 * 2 - d0 - 2 >= 0, d1 - d0 >= 0, d1 + d2 - d0 - 1 >= 0)>
#set15 = affine_set<(d0, d1, d2) : (d0 - (d1 * 32 + d2 * 32 - 19) ceildiv 32 >= 0, d0 - d2 * 2 >= 0, -d2 >= 0)>
#set16 = affine_set<(d0, d1, d2) : (d0 - d1 * 2 == 0, -d0 >= 0, d2 * 2 - d0 - 2 >= 0)>
#set17 = affine_set<(d0, d1) : (d0 - d1 * 2 == 0, -d0 >= 0)>
#set18 = affine_set<(d0) : ((d0 * 16 + 58) mod 32 == 0)>
#set19 = affine_set<(d0, d1) : (-d0 >= 0, d1 * 2 - d0 - 1 >= 0)>
#set20 = affine_set<(d0) : ((d0 * 16 + 59) mod 32 == 0)>
#set21 = affine_set<(d0) : (d0 - 1 >= 0)>
#set22 = affine_set<(d0) : (d0 + 1 == 0)>
#set23 = affine_set<() : (27 == 0)>
#set24 = affine_set<(d0) : (d0 - 2 >= 0)>
#set25 = affine_set<(d0)[s0] : (d0 * 8 - (s0 - 1) == 0)>
#set26 = affine_set<()[s0] : ((s0 + 15) mod 16 == 0)>
#set27 = affine_set<(d0, d1)[s0] : (d0 - 1 >= 0, d0 * 16 - (d1 * 32 - s0 - 12) == 0)>
#set28 = affine_set<(d0)[s0] : ((d0 * 16 + s0 * 31 + 20) mod 32 == 0)>
#set29 = affine_set<(d0, d1)[s0] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, d1 - (s0 - 1) ceildiv 32 >= 0)>
#set30 = affine_set<()[s0] : ((s0 + 1) mod 2 == 0)>
#set31 = affine_set<(d0, d1, d2)[s0] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d2 * 32 + d1 * 32 - s0 - 1) floordiv 32 - d0 >= 0, d1 - d2 - 1 >= 0, d1 - (s0 - 1) ceildiv 32 >= 0)>
#set32 = affine_set<(d0, d1, d2)[s0] : (d0 - d1 * 2 == 0, d0 - (d2 * 32 - s0 + 1) ceildiv 16 >= 0)>
#set33 = affine_set<(d0, d1)[s0] : (d0 - (d1 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set34 = affine_set<(d0, d1, d2)[s0] : ((d1 * 32 + d2 * 2 - s0 + 1) floordiv 32 - d0 >= 0, d1 - (d2 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set35 = affine_set<(d0, d1, d2)[s0, s1] : ((d1 * 32 - s0 + 1) floordiv 16 - d0 >= 0, (d1 * 32 + s1 * 2 - s0 - 31) floordiv 32 - d0 >= 0, (d1 * 32 + d2 * 32 - s0 - 1) floordiv 32 - d0 >= 0)>
#set36 = affine_set<(d0, d1, d2)[s0, s1] : (d0 - (d1 * 32 + d2 * 32 - s0 + 1) ceildiv 32 >= 0, d0 - d2 * 2 >= 0, -d2 + s1 floordiv 16 - 1 >= 0)>
#set37 = affine_set<(d0, d1, d2)[s0] : (d0 - d1 * 2 == 0, -d0 + s0 floordiv 8 - 2 >= 0, d2 * 2 - d0 - 2 >= 0)>
#set38 = affine_set<(d0, d1)[s0] : (d0 - d1 * 2 == 0, -d0 + s0 floordiv 8 - 2 >= 0)>
#set39 = affine_set<(d0)[s0] : ((d0 * 16 + s0 + 28) mod 32 == 0)>
#set40 = affine_set<(d0, d1)[s0] : (-d0 + s0 floordiv 8 - 2 >= 0, d1 * 2 - d0 - 1 >= 0)>
#set41 = affine_set<(d0)[s0] : ((d0 * 16 + s0 + 29) mod 32 == 0)>
#set42 = affine_set<(d0)[s0] : (d0 - (s0 - 15) ceildiv 8 >= 0)>
#set43 = affine_set<()[s0, s1] : ((s0 * 2 + s1 + 29) mod 32 == 0)>
#set44 = affine_set<()[s0] : ((s0 + 29) mod 32 == 0)>
#set45 = affine_set<(d0)[s0] : (d0 - (s0 - 8) ceildiv 8 >= 0)>
#set46 = affine_set<()[s0] : (s0 - 3 == 0)>
#set47 = affine_set<()[s0] : ((s0 + 7) mod 8 == 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
        ...
        affine.if #set1() {
          affine.for %arg3 = 2 to 3 {
            affine.for %arg4 = max #map0(%arg3) to min #map1(%arg3) {
              call @S1(%0, %c19, %c1, %1) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
      }
        ...
        affine.if #set2(%arg2, %arg3) {
          affine.if #set3(%arg2) {
            affine.if #set4(%arg2) {
              ...
              call @S0(%1, %24, %c28, %0) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
        affine.for %arg4 = max #map5(%arg2, %arg3) to min #map6(%arg2, %arg3) {
          affine.if #set5(%arg2, %arg3) {
            affine.if #set6() {
              affine.for %arg5 = max #map7(%arg3, %arg4) to min #map8(%arg3, %arg4) {
                %24 = affine.apply #map9(%arg3)[%c30]
                call @S1(%0, %24, %c28, %1) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.if #set7(%arg2, %arg3, %arg4) {
            affine.if #set6() {
              affine.for %arg5 = max #map10(%arg2, %arg3, %arg4) to min #map11(%arg2, %arg3, %arg4) {
                %24 = affine.apply #map9(%arg4)[%c30]
                %25 = affine.apply #map12(%arg4, %arg5)[%c30]
                call @S1(%0, %24, %25, %1) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.if #set8(%arg2, %arg3, %arg4) {
            affine.for %arg5 = max #map13(%arg2, %arg4) to min #map14(%arg2, %arg4) {
              affine.if #set9(%arg2) {
                ...
                call @S1(%0, %24, %c1, %1) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.for %arg5 = max #map16(%arg2, %arg3, %arg4) to min #map17(%arg2, %arg3, %arg4) {
            affine.if #set10(%arg2, %arg3, %arg5) {
              affine.for %arg6 = max #map18(%arg4, %arg5) to min #map19(%arg4, %arg5) {
                call @S0(%1, %arg5, %c1, %0) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
            affine.for %arg6 = max #map20(%arg2, %arg3, %arg5) to #map21(%arg2, %arg3, %arg5) {
              affine.for %arg7 = max #map18(%arg4, %arg5) to min #map19(%arg4, %arg5) {
                ...
                call @S0(%1, %arg5, %24, %0) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
            affine.for %arg6 = max #map23(%arg2, %arg3, %arg5) to min #map24(%arg2, %arg3, %arg5) {
              ...
              affine.for %arg7 = max #map25(%arg4, %arg5) to min #map19(%arg4, %arg5) {
                ...
                call @S1(%0, %arg5, %24, %1) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
                %25 = affine.apply #map22(%arg5, %arg6)
                call @S0(%1, %arg5, %25, %0) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            ...
            affine.if #set13(%arg2, %arg3, %arg5) {
              affine.for %arg6 = max #map25(%arg4, %arg5) to min #map29(%arg4, %arg5) {
                call @S1(%0, %arg5, %c28, %1) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.if #set14(%arg2, %arg3, %arg4) {
            affine.if #set6() {
              affine.for %arg5 = max #map30(%arg2, %arg3, %arg4) to min #map31(%arg2, %arg3, %arg4) {
                %24 = affine.apply #map32(%arg2, %arg3)[%c30]
                call @S0(%1, %24, %c28, %0) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.if #set15(%arg2, %arg3, %arg4) {
            affine.for %arg5 = max #map33(%arg2, %arg3, %arg4) to min #map34(%arg2, %arg3, %arg4) {
              ...
              call @S0(%1, %24, %25, %0) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
          affine.if #set16(%arg2, %arg3, %arg4) {
            affine.for %arg5 = #map37(%arg4) to min #map38(%arg2, %arg4) {
              affine.if #set9(%arg2) {
                ...
                call @S0(%1, %24, %c1, %0) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
        }
        ...
        affine.if #set21(%arg2) {
          affine.if #set1() {
            affine.for %arg4 = max #map41(%arg2, %arg3) to min #map42(%arg2, %arg3) {
              %24 = affine.apply #map43(%arg4)[%c20]
              call @S1(%0, %c19, %24, %1) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
      }
        ...
        affine.if #set23() {
          affine.for %arg3 = 0 to 1 {
            affine.for %arg4 = max #map44(%arg3) to min #map45(%arg3) {
              call @S0(%1, %c0, %c28, %0) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
      }
      affine.if #set24(%arg2) {
        affine.if #set1() {
          affine.for %arg3 = 1 to 3 {
            affine.for %arg4 = max #map0(%arg3) to min #map1(%arg3) {
              call @S1(%0, %c19, %c28, %1) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
      }
  ...
  ^bb4:  // pred: ^bb3
    ...
    %13 = addf %11, %12 : f64
    %14 = sitofp %c30_i32 : i32 to f64
    %15 = divf %13, %14 : f64
    store %15, %0[%4, %7] : memref<30x30xf64>
    ...
    %20 = addf %18, %19 : f64
    %21 = divf %20, %14 : f64
    store %21, %1[%4, %7] : memref<30x30xf64>
  ...
  func @init_array(%arg0: i32, %arg1: memref<30x30xf64>, %arg2: memref<30x30xf64>) {
    %c0_i32 = constant 0 : i32
    %c2_i32 = constant 2 : i32
    %c3_i32 = constant 3 : i32
    %c1_i32 = constant 1 : i32
  ...
  func @kernel_jacobi_2d(%arg0: i32, %arg1: i32, %arg2: memref<30x30xf64>, %arg3: memref<30x30xf64>) {
  ...
  func @kernel_jacobi_2d_new(%arg0: i32, %arg1: i32, %arg2: memref<30x30xf64>, %arg3: memref<30x30xf64>) {
    %c0 = constant 0 : index
    %c1 = constant 1 : index
    %0 = index_cast %arg1 : i32 to index
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg4 = -1 to min #map47()[%1, %0] {
        ...
        affine.if #set26()[%1] {
          affine.for %arg5 = #map48()[%1] to #map49()[%1, %0] {
            affine.for %arg6 = max #map50(%arg5)[%1] to min #map51(%arg5)[%1, %0] {
              ...
              call @S1(%arg2, %2, %c1, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg5 = max #map52(%arg4)[%1] to min #map53(%arg4)[%1, %0] {
        affine.if #set27(%arg4, %arg5)[%0] {
          affine.if #set3(%arg4) {
            affine.if #set28(%arg4)[%0] {
        ...
        affine.for %arg6 = max #map55(%arg4, %arg5)[%0] to min #map56(%arg4, %arg5)[%1, %0] {
          ...
          affine.if #set31(%arg4, %arg5, %arg6)[%0] {
            affine.if #set30()[%0] {
          ...
          affine.if #set32(%arg4, %arg5, %arg6)[%0] {
          ...
          affine.for %arg7 = max #map61(%arg4, %arg5, %arg6)[%0] to min #map62(%arg4, %arg5, %arg6)[%1, %0] {
            affine.if #set10(%arg4, %arg5, %arg7) {
              affine.for %arg8 = max #map18(%arg6, %arg7) to min #map63(%arg6, %arg7)[%0] {
                call @S0(%arg3, %arg7, %c1, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
            affine.for %arg8 = max #map20(%arg4, %arg5, %arg7) to #map21(%arg4, %arg5, %arg7) {
              affine.for %arg9 = max #map18(%arg6, %arg7) to min #map63(%arg6, %arg7)[%0] {
                ...
                call @S0(%arg3, %arg7, %2, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
            affine.for %arg8 = max #map23(%arg4, %arg5, %arg7) to min #map64(%arg4, %arg5, %arg7)[%0] {
              ...
              affine.for %arg9 = max #map25(%arg6, %arg7) to min #map63(%arg6, %arg7)[%0] {
                ...
                call @S1(%arg2, %arg7, %2, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
                %3 = affine.apply #map22(%arg7, %arg8)
                call @S0(%arg3, %arg7, %3, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
              affine.if #set33(%arg6, %arg7)[%0] {
                %2 = affine.apply #map26(%arg7, %arg8)
                call @S1(%arg2, %arg7, %2, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
            ...
            affine.if #set34(%arg4, %arg5, %arg7)[%0] {
          ...
          affine.if #set35(%arg4, %arg5, %arg6)[%1, %0] {
            affine.if #set30()[%0] {
          ...
          affine.if #set36(%arg4, %arg5, %arg6)[%1, %0] {
          ...
          affine.if #set37(%arg4, %arg5, %arg6)[%1] {
        ...
        affine.if #set38(%arg4, %arg5)[%1] {
          affine.if #set39(%arg4)[%0] {
            affine.if #set9(%arg4) {
              %2 = affine.apply #map39(%arg4)
              call @S0(%arg3, %2, %c1, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
      ...
      affine.if #set22(%arg4) {
        affine.if #set44()[%0] {
          affine.for %arg5 = 0 to #map73()[%0] {
            affine.for %arg6 = max #map44(%arg5) to min #map74(%arg5)[%0] {
              %2 = affine.apply #map54()[%0]
              call @S0(%arg3, %c0, %2, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
      }
      affine.if #set45(%arg4)[%1] {
        affine.if #set43()[%1, %0] {
