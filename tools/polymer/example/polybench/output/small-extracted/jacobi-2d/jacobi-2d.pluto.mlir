...
#map6 = affine_map<(d0)[s0] -> (d0 - s0 * 2 + 1)>
#map7 = affine_map<(d0)[s0] -> (d0 ceildiv 2, (d0 * 16 - s0 + 2) ceildiv 16)>
#map8 = affine_map<(d0)[s0, s1] -> ((s0 * 2 + s1 - 4) floordiv 32 + 1, (d0 * 16 + s1 + 13) floordiv 32 + 1, (d0 * 32 + s1 + 28) floordiv 32 + 1)>
...
#map17 = affine_map<(d0, d1) -> (d0 * 32, d1 * 16 + 2)>
#map18 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 16 + s0)>
#map19 = affine_map<(d0, d1) -> (d0 * -16 + d1 - 1)>
#map20 = affine_map<(d0, d1, d2)[s0] -> (0, (d0 * 32 - s0 + 2) ceildiv 2, (d1 * 32 - s0 + 2) ceildiv 2, d2 * 8, d2 * 16 - d0 * 16 + 1)>
#map21 = affine_map<(d0, d1, d2)[s0, s1] -> (d0 * 16 - d1 * 16 + s0 floordiv 2 + 15, s1, d0 * 8 + 16, d1 * 16 + 15, d2 * 16 + 15)>
#map22 = affine_map<(d0, d1) -> (d0 * 32, d1 * 2 + 1)>
#map23 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 2 + s0 - 1)>
#map24 = affine_map<(d0, d1) -> (d0 * -2 + d1)>
#map25 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 2 + 2, d2 * -32 + d0 * 32 + d1 * 4 - 31)>
#map26 = affine_map<(d0, d1, d2) -> (d0 * -32 + d1 * 32 + d2 * 4 - 29)>
#map27 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 2 + 2, d2 * -32 + d0 * 32 + d1 * 4 - 29)>
#map28 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * -32 + d0 * 32 + d2 * 4 + 1, d2 * 2 + s0 - 1)>
#map29 = affine_map<(d0, d1) -> (d0 * 32, d1 * 2 + 2)>
#map30 = affine_map<(d0, d1) -> (d0 * -2 + d1 - 1)>
#map31 = affine_map<(d0, d1, d2) -> (d0 * -32 + d1 * 32 + d2 * 4 + 1)>
#map32 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * 2 + s0, d2 * -32 + d0 * 32 + d1 * 4 + 3)>
#map33 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 2 + s0)>
#map34 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32, d1 * 32 - d2 * 32 + s0 + 30)>
#map35 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * 32 - d2 * 32 + s0 * 2 + 28)>
#map36 = affine_map<(d0, d1, d2)[s0] -> (d0 * -32 + d1 * 32 + d2 - s0 - 29)>
#map37 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 * 32 + 31, d2 * -32 + d0 * 32 + d1 * 64 + 29)>
#map38 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32 + 32, d1 * 32 + s0 + 29, d2 * -32 + d0 * 32 + d1 * 64 + 61)>
#map39 = affine_map<(d0, d1) -> (d0 * -32 + d1 - 30)>
#map40 = affine_map<(d0) -> (d0 * 32)>
#map41 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * 16 + s0 + 29)>
#map42 = affine_map<(d0, d1) -> (d0 * -16 + d1 - 30)>
#map43 = affine_map<(d0, d1) -> (d0 * -16 + d1 * 32)>
#map44 = affine_map<(d0, d1)[s0] -> (s0 * 2, d0 * 32, d1 * -32 + d0 * 32 + s0 * 4 - 33)>
#map45 = affine_map<(d0, d1)[s0] -> (d0 * 32 + 32, d1 * -32 + d0 * 32 + s0 * 4 - 1)>
#map46 = affine_map<()[s0] -> ((s0 - 3) floordiv 32 + 1)>
#map47 = affine_map<(d0) -> (1, d0 * 32)>
#map48 = affine_map<(d0)[s0] -> (s0 - 1, d0 * 32 + 32)>
#map49 = affine_map<()[s0] -> ((s0 - 15) ceildiv 16)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_jacobi_2d_new(%arg0: i32, %arg1: i32, %arg2: memref<30x30xf64>, %arg3: memref<30x30xf64>) {
    ...
    affine.for %arg4 = -1 to min #map1()[%0, %1] {
      affine.if #set0(%arg4)[%0] {
        affine.if #set1()[%0] {
          affine.for %arg5 = #map2()[%0] to #map3()[%0, %1] {
            affine.for %arg6 = max #map4(%arg5)[%0] to min #map5(%arg5)[%0, %1] {
              %2 = affine.apply #map6(%arg6)[%0]
              call @S1(%arg2, %c1, %2, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg5 = max #map7(%arg4)[%0] to min #map8(%arg4)[%0, %1] {
        affine.if #set2(%arg4, %arg5)[%1] {
          affine.if #set3(%arg4) {
            affine.if #set4(%arg4)[%1] {
              %2 = affine.apply #map9()[%1]
              call @S0(%arg3, %2, %c1, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
        affine.for %arg6 = max #map10(%arg4, %arg5)[%1] to min #map11(%arg4, %arg5)[%0, %1] {
          affine.if #set5(%arg4, %arg5)[%1] {
            affine.if #set6()[%1] {
              affine.for %arg7 = max #map12(%arg5, %arg6)[%1] to min #map13(%arg5, %arg6) {
                %2 = affine.apply #map9()[%1]
                %3 = affine.apply #map14(%arg5, %arg7)[%1]
                call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.if #set7(%arg4, %arg5, %arg6)[%1] {
            affine.if #set6()[%1] {
              affine.for %arg7 = max #map15(%arg4, %arg5, %arg6)[%1] to min #map16(%arg4, %arg5, %arg6)[%1] {
                %2 = affine.apply #map14(%arg6, %arg7)[%1]
                %3 = affine.apply #map9()[%1]
                call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.if #set8(%arg4, %arg5, %arg6)[%1] {
            affine.for %arg7 = max #map17(%arg4, %arg6) to min #map18(%arg4, %arg6)[%1] {
              affine.if #set9(%arg4) {
                %2 = affine.apply #map19(%arg4, %arg7)
                call @S1(%arg2, %c1, %2, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.for %arg7 = max #map20(%arg4, %arg5, %arg6)[%1] to min #map21(%arg4, %arg5, %arg6)[%0, %1] {
            affine.if #set10(%arg4, %arg5, %arg7) {
              affine.for %arg8 = max #map22(%arg6, %arg7) to min #map23(%arg6, %arg7)[%1] {
                %2 = affine.apply #map24(%arg7, %arg8)
            ...
            affine.for %arg8 = max #map25(%arg4, %arg5, %arg7) to #map26(%arg4, %arg5, %arg7) {
              affine.for %arg9 = max #map22(%arg6, %arg7) to min #map23(%arg6, %arg7)[%1] {
                %2 = affine.apply #map24(%arg7, %arg8)
                %3 = affine.apply #map24(%arg7, %arg9)
                call @S0(%arg3, %2, %3, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
            affine.for %arg8 = max #map27(%arg4, %arg5, %arg7) to min #map28(%arg4, %arg5, %arg7)[%1] {
              affine.if #set11(%arg6, %arg7) {
                %2 = affine.apply #map24(%arg7, %arg8)
                call @S0(%arg3, %2, %c1, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
              affine.for %arg9 = max #map29(%arg6, %arg7) to min #map23(%arg6, %arg7)[%1] {
                %2 = affine.apply #map30(%arg7, %arg8)
                %3 = affine.apply #map30(%arg7, %arg9)
                call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
                %4 = affine.apply #map24(%arg7, %arg8)
                %5 = affine.apply #map24(%arg7, %arg9)
                call @S0(%arg3, %4, %5, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
              affine.if #set12(%arg6, %arg7)[%1] {
                %2 = affine.apply #map30(%arg7, %arg8)
                %3 = affine.apply #map9()[%1]
                call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
            affine.for %arg8 = #map31(%arg4, %arg5, %arg7) to min #map32(%arg4, %arg5, %arg7)[%1] {
              affine.for %arg9 = max #map29(%arg6, %arg7) to min #map33(%arg6, %arg7)[%1] {
                %2 = affine.apply #map30(%arg7, %arg8)
                %3 = affine.apply #map30(%arg7, %arg9)
                call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
            affine.if #set13(%arg4, %arg5, %arg7)[%1] {
              affine.for %arg8 = max #map29(%arg6, %arg7) to min #map33(%arg6, %arg7)[%1] {
                %2 = affine.apply #map9()[%1]
                %3 = affine.apply #map30(%arg7, %arg8)
                call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.if #set14(%arg4, %arg5, %arg6)[%0, %1] {
            affine.if #set6()[%1] {
              affine.for %arg7 = max #map34(%arg4, %arg5, %arg6)[%1] to min #map35(%arg4, %arg5, %arg6)[%1] {
                %2 = affine.apply #map9()[%1]
                %3 = affine.apply #map36(%arg4, %arg5, %arg7)[%1]
                call @S0(%arg3, %2, %3, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
          affine.if #set15(%arg4, %arg5, %arg6)[%0, %1] {
            affine.for %arg7 = max #map37(%arg4, %arg5, %arg6) to min #map38(%arg4, %arg5, %arg6)[%1] {
              %2 = affine.apply #map39(%arg6, %arg7)
              call @S0(%arg3, %2, %c1, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
          affine.if #set16(%arg4, %arg5, %arg6)[%0] {
            affine.for %arg7 = #map40(%arg6) to min #map41(%arg4, %arg6)[%1] {
              affine.if #set9(%arg4) {
                %2 = affine.apply #map42(%arg4, %arg7)
                call @S0(%arg3, %c1, %2, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
              }
            }
          }
        ...
        affine.if #set19(%arg4, %arg5)[%0] {
          affine.if #set20(%arg4)[%1] {
            %2 = affine.apply #map43(%arg4, %arg5)
            %3 = affine.apply #map9()[%1]
            call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
          }
        }
        affine.if #set21(%arg4)[%0] {
          affine.if #set22()[%0, %1] {
            affine.for %arg6 = max #map44(%arg4, %arg5)[%0] to min #map45(%arg4, %arg5)[%0] {
              %2 = affine.apply #map6(%arg6)[%0]
              %3 = affine.apply #map9()[%1]
              call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
      ...
      affine.if #set23(%arg4) {
        affine.if #set24()[%1] {
          affine.for %arg5 = 0 to #map46()[%1] {
            affine.for %arg6 = max #map47(%arg5) to min #map48(%arg5)[%1] {
              %2 = affine.apply #map9()[%1]
              call @S0(%arg3, %2, %arg6, %arg2) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
      }
      affine.if #set25(%arg4)[%0] {
        affine.if #set22()[%0, %1] {
          affine.for %arg5 = #map49()[%0] to #map3()[%0, %1] {
            affine.for %arg6 = max #map4(%arg5)[%0] to min #map5(%arg5)[%0, %1] {
              %2 = affine.apply #map9()[%1]
              %3 = affine.apply #map6(%arg6)[%0]
              call @S1(%arg2, %2, %3, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
            }
          }
        }
    ...
    affine.if #set26()[%1] {
      affine.if #set27()[%0] {
        affine.if #set1()[%0] {
          call @S1(%arg2, %c1, %c1, %arg3) : (memref<30x30xf64>, index, index, memref<30x30xf64>) -> ()
        }
      }
    }
    return
