...
#map4 = affine_map<(d0, d1) -> (40, d0 * 32 - d1 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb11:  // pred: ^bb10
    ...
    store %29, %4[%25, %28] : memref<40x40xf64>
  ...
  ^bb17:  // pred: ^bb16
    %42 = load %0[%37, %34] : memref<40x40xf64>
    %43 = load %0[%41, %34] : memref<40x40xf64>
    %44 = mulf %42, %43 : f64
    %45 = load %4[%37, %41] : memref<40x40xf64>
    %46 = addf %45, %44 : f64
    store %46, %4[%37, %41] : memref<40x40xf64>
    ...
    affine.for %arg2 = 0 to 3 {
      affine.for %arg3 = max #map0(%arg2) to #map1(%arg2) {
          ...
          affine.for %arg5 = #map3(%arg2, %arg3) to min #map4(%arg2, %arg3) {
            affine.for %arg6 = #map5(%arg3) to #map6(%arg3) {
              affine.for %arg7 = #map5(%arg4) to #map6(%arg4) {
                call @S0(%0, %arg5, %arg6, %arg7) : (memref<40x40xf64>, index, index, index) -> ()
              }
            }
          }
        }
        affine.for %arg4 = #map3(%arg2, %arg3) to min #map4(%arg2, %arg3) {
          ...
          call @S1(%0, %arg4, %58) : (memref<40x40xf64>, index, index) -> ()
          affine.for %arg5 = #map7(%arg3) to #map6(%arg3) {
            affine.for %arg6 = #map5(%arg3) to #map2(%arg5) {
              call @S0(%0, %arg4, %arg5, %arg6) : (memref<40x40xf64>, index, index, index) -> ()
            }
            call @S1(%0, %arg4, %arg5) : (memref<40x40xf64>, index, index) -> ()
          }
        }
      }
      affine.if #set0(%arg2) {
        affine.for %arg3 = 0 to #map8(%arg2) {
          affine.for %arg4 = #map9(%arg2) to min #map10(%arg2) {
            affine.for %arg5 = #map5(%arg3) to #map6(%arg3) {
              %58 = affine.apply #map9(%arg2)
              call @S2(%0, %58, %arg4, %arg5) : (memref<40x40xf64>, index, index, index) -> ()
            }
          }
          affine.for %arg4 = #map11(%arg2) to min #map10(%arg2) {
            ...
            affine.for %arg5 = #map2(%arg4) to min #map10(%arg2) {
              affine.for %arg6 = #map5(%arg3) to #map6(%arg3) {
                call @S2(%0, %arg4, %arg5, %arg6) : (memref<40x40xf64>, index, index, index) -> ()
              }
            }
          }
        }
        affine.if #set1(%arg2) {
          affine.if #set2() {
            call @S1(%0, %c39, %c38) : (memref<40x40xf64>, index, index) -> ()
            call @S2(%0, %c39, %c39, %c38) : (memref<40x40xf64>, index, index, index) -> ()
          }
        }
        affine.if #set3(%arg2) {
          %58 = affine.apply #map11(%arg2)
          %59 = affine.apply #map9(%arg2)
          call @S1(%0, %58, %59) : (memref<40x40xf64>, index, index) -> ()
          affine.for %arg3 = #map11(%arg2) to min #map10(%arg2) {
            %60 = affine.apply #map11(%arg2)
            %61 = affine.apply #map9(%arg2)
            call @S2(%0, %60, %arg3, %61) : (memref<40x40xf64>, index, index, index) -> ()
          }
          affine.for %arg3 = #map12(%arg2) to min #map10(%arg2) {
            %60 = affine.apply #map9(%arg2)
            call @S1(%0, %arg3, %60) : (memref<40x40xf64>, index, index) -> ()
            affine.for %arg4 = #map11(%arg2) to #map2(%arg3) {
              affine.for %arg5 = #map9(%arg2) to #map2(%arg4) {
                call @S0(%0, %arg3, %arg4, %arg5) : (memref<40x40xf64>, index, index, index) -> ()
              }
              call @S1(%0, %arg3, %arg4) : (memref<40x40xf64>, index, index) -> ()
            }
            affine.for %arg4 = #map2(%arg3) to min #map10(%arg2) {
              affine.for %arg5 = #map9(%arg2) to #map2(%arg3) {
                call @S2(%0, %arg3, %arg4, %arg5) : (memref<40x40xf64>, index, index, index) -> ()
              }
            }
          }
        }
          ...
          affine.for %arg5 = max #map16(%arg2, %arg3, %arg4) to #map17(%arg2, %arg3) {
            affine.for %arg6 = #map5(%arg3) to min #map18(%arg3) {
              affine.for %arg7 = #map5(%arg4) to min #map19(%arg4, %arg5) {
                call @S2(%0, %arg5, %arg6, %arg7) : (memref<40x40xf64>, index, index, index) -> ()
              }
            }
          }
        }
      ...
      affine.if #set4() {
        affine.for %arg2 = 0 to 1 {
          affine.for %arg3 = #map5(%arg2) to #map6(%arg2) {
            call @S2(%0, %c39, %c39, %arg3) : (memref<40x40xf64>, index, index, index) -> ()
          }
        }
      }
    }
  ...
  ^bb22:  // pred: ^bb21
    %55 = load %4[%51, %54] : memref<40x40xf64>
    store %55, %0[%51, %54] : memref<40x40xf64>
  ...
  func @init_array(%arg0: i32, %arg1: memref<40x40xf64>) {
    %c0_i32 = constant 0 : i32
    %c1_i32 = constant 1 : i32
    br ^bb1(%c0_i32 : i32)
  ...
  func @kernel_lu(%arg0: i32, %arg1: memref<40x40xf64>) {
  ...
  func @print_array(%arg0: i32, %arg1: memref<40x40xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func @kernel_lu_new(%arg0: i32, %arg1: memref<40x40xf64>) {
    %0 = index_cast %arg0 : i32 to index
