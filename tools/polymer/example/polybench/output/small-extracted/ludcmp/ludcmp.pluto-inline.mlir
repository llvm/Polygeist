...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb2:  // pred: ^bb1
    ...
    store %8, %2[%7] : memref<40xf64>
    store %8, %3[%7] : memref<40xf64>
    %9 = addi %5, %c1_i32 : i32
  ...
  ^bb6:  // pred: ^bb5
    ...
    %23 = remi_signed %22, %c40_i32 : i32
    %24 = sitofp %23 : i32 to f64
    %25 = divf %24, %4 : f64
    %26 = sitofp %c1_i32 : i32 to f64
    %27 = addf %25, %26 : f64
    store %27, %0[%17, %21] : memref<40x40xf64>
  ...
  ^bb18(%52: i32):  // 2 preds: ^bb16, ^bb19
    %53 = cmpi "slt", %52, %c40_i32 : i32
    %54 = index_cast %52 : i32 to index
    cond_br %53, ^bb19, ^bb20
  ^bb19:  // pred: ^bb18
    %55 = load %0[%50, %47] : memref<40x40xf64>
    %56 = load %0[%54, %47] : memref<40x40xf64>
    %57 = mulf %55, %56 : f64
    %58 = load %18[%50, %54] : memref<40x40xf64>
    %59 = addf %58, %57 : f64
    store %59, %18[%50, %54] : memref<40x40xf64>
  ...
  ^bb21(%62: i32):  // 2 preds: ^bb15, ^bb25
    %63 = cmpi "slt", %62, %c40_i32 : i32
    %64 = index_cast %62 : i32 to index
    cond_br %63, ^bb23(%c0_i32 : i32), ^bb22
  ^bb22:  // pred: ^bb21
    %65 = alloca() : memref<1xf64>
    affine.for %arg2 = 0 to 40 {
      call @S3(%65, %0, %c0, %arg2) : (memref<1xf64>, memref<40x40xf64>, index, index) -> ()
      call @S5(%0, %c0, %arg2, %65) : (memref<40x40xf64>, index, index, memref<1xf64>) -> ()
    }
    %66 = affine.load %0[%c1, %c0] : memref<40x40xf64>
    affine.store %66, %65[0] : memref<1xf64>
    %67 = affine.load %65[0] : memref<1xf64>
    %68 = affine.load %0[%c0, %c0] : memref<40x40xf64>
    %69 = divf %67, %68 : f64
    affine.store %69, %0[%c1, %c0] : memref<40x40xf64>
    affine.for %arg2 = 1 to 40 {
      call @S3(%65, %0, %c1, %arg2) : (memref<1xf64>, memref<40x40xf64>, index, index) -> ()
      call @S4(%65, %0, %c1, %arg2, %c0) : (memref<1xf64>, memref<40x40xf64>, index, index, index) -> ()
      call @S5(%0, %c1, %arg2, %65) : (memref<40x40xf64>, index, index, memref<1xf64>) -> ()
    }
    affine.for %arg2 = 2 to 40 {
      call @S0(%65, %0, %arg2, %c0) : (memref<1xf64>, memref<40x40xf64>, index, index) -> ()
      call @S2(%0, %arg2, %c0, %65) : (memref<40x40xf64>, index, index, memref<1xf64>) -> ()
      affine.for %arg3 = 1 to #map0(%arg2) {
        call @S0(%65, %0, %arg2, %arg3) : (memref<1xf64>, memref<40x40xf64>, index, index) -> ()
        affine.for %arg4 = 0 to #map0(%arg3) {
          call @S1(%65, %0, %arg2, %arg3, %arg4) : (memref<1xf64>, memref<40x40xf64>, index, index, index) -> ()
        }
        call @S2(%0, %arg2, %arg3, %65) : (memref<40x40xf64>, index, index, memref<1xf64>) -> ()
      }
      affine.for %arg3 = #map0(%arg2) to 40 {
        call @S3(%65, %0, %arg2, %arg3) : (memref<1xf64>, memref<40x40xf64>, index, index) -> ()
        affine.for %arg4 = 0 to #map0(%arg2) {
          call @S4(%65, %0, %arg2, %arg3, %arg4) : (memref<1xf64>, memref<40x40xf64>, index, index, index) -> ()
        }
        call @S5(%0, %arg2, %arg3, %65) : (memref<40x40xf64>, index, index, memref<1xf64>) -> ()
      }
    }
    %70 = affine.load %65[0] : memref<1xf64>
    %71 = affine.load %0[-%c0 + symbol(%c40) - 1, -%c0 + symbol(%c40) - 1] : memref<40x40xf64>
    %72 = divf %70, %71 : f64
    affine.store %72, %2[-%c0 + symbol(%c40) - 1] : memref<40xf64>
    %73 = affine.load %3[-%c0 + symbol(%c40) - 1] : memref<40xf64>
    affine.store %73, %65[0] : memref<1xf64>
    affine.for %arg2 = 1 to 40 {
      affine.for %arg3 = #map1(%arg2) to 40 {
        call @S10(%65, %2, %arg2, %0, %arg3, %c40) : (memref<1xf64>, memref<40xf64>, index, memref<40x40xf64>, index, index) -> ()
      }
      call @S11(%2, %arg2, %c40, %0, %65) : (memref<40xf64>, index, index, memref<40x40xf64>, memref<1xf64>) -> ()
      call @S9(%65, %3, %arg2, %c40) : (memref<1xf64>, memref<40xf64>, index, index) -> ()
    }
    %74 = affine.load %1[%c0] : memref<40xf64>
    affine.store %74, %65[0] : memref<1xf64>
    %75 = affine.load %65[0] : memref<1xf64>
    affine.store %75, %3[%c0] : memref<40xf64>
    affine.for %arg2 = 1 to 40 {
      call @S6(%65, %1, %arg2) : (memref<1xf64>, memref<40xf64>, index) -> ()
      affine.for %arg3 = 0 to #map0(%arg2) {
        call @S7(%65, %3, %arg2, %0, %arg3) : (memref<1xf64>, memref<40xf64>, index, memref<40x40xf64>, index) -> ()
      }
      call @S8(%3, %arg2, %65) : (memref<40xf64>, index, memref<1xf64>) -> ()
    }
    call @print_array(%c40_i32, %2) : (i32, memref<40xf64>) -> ()
    return %c0_i32 : i32
  ^bb23(%76: i32):  // 2 preds: ^bb21, ^bb24
    %77 = cmpi "slt", %76, %c40_i32 : i32
    %78 = index_cast %76 : i32 to index
    cond_br %77, ^bb24, ^bb25
  ^bb24:  // pred: ^bb23
    %79 = load %18[%64, %78] : memref<40x40xf64>
    store %79, %0[%64, %78] : memref<40x40xf64>
  ...
  func @init_array(%arg0: i32, %arg1: memref<40x40xf64>, %arg2: memref<40xf64>, %arg3: memref<40xf64>, %arg4: memref<40xf64>) {
    %c0_i32 = constant 0 : i32
    %cst = constant 2.000000e+00 : f64
    %c4_i32 = constant 4 : i32
    %c1_i32 = constant 1 : i32
  ...
  func @kernel_ludcmp(%arg0: i32, %arg1: memref<40x40xf64>, %arg2: memref<40xf64>, %arg3: memref<40xf64>, %arg4: memref<40xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = alloca() : memref<1xf64>
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to #map0(%arg5) {
        call @S0(%1, %arg1, %arg5, %arg6) : (memref<1xf64>, memref<40x40xf64>, index, index) -> ()
        affine.for %arg7 = 0 to #map0(%arg6) {
          call @S1(%1, %arg1, %arg7, %arg6, %arg5) : (memref<1xf64>, memref<40x40xf64>, index, index, index) -> ()
        }
        call @S2(%arg1, %arg5, %arg6, %1) : (memref<40x40xf64>, index, index, memref<1xf64>) -> ()
      }
      affine.for %arg6 = #map0(%arg5) to %0 {
        call @S3(%1, %arg1, %arg5, %arg6) : (memref<1xf64>, memref<40x40xf64>, index, index) -> ()
        affine.for %arg7 = 0 to #map0(%arg5) {
          call @S4(%1, %arg1, %arg7, %arg6, %arg5) : (memref<1xf64>, memref<40x40xf64>, index, index, index) -> ()
        }
        call @S5(%arg1, %arg5, %arg6, %1) : (memref<40x40xf64>, index, index, memref<1xf64>) -> ()
      }
    }
    affine.for %arg5 = 0 to %0 {
      call @S6(%1, %arg2, %arg5) : (memref<1xf64>, memref<40xf64>, index) -> ()
      affine.for %arg6 = 0 to #map0(%arg5) {
        call @S7(%1, %arg4, %arg6, %arg1, %arg5) : (memref<1xf64>, memref<40xf64>, index, memref<40x40xf64>, index) -> ()
      }
      call @S8(%arg4, %arg5, %1) : (memref<40xf64>, index, memref<1xf64>) -> ()
    }
    affine.for %arg5 = 0 to %0 {
      call @S9(%1, %arg4, %arg5, %0) : (memref<1xf64>, memref<40xf64>, index, index) -> ()
      affine.for %arg6 = #map2(%arg5)[%0] to %0 {
        call @S10(%1, %arg3, %arg6, %arg1, %arg5, %0) : (memref<1xf64>, memref<40xf64>, index, memref<40x40xf64>, index, index) -> ()
      }
      call @S11(%arg3, %arg5, %0, %arg1, %1) : (memref<40xf64>, index, index, memref<40x40xf64>, memref<1xf64>) -> ()
    }
    return
  }
  ...
  func private @S0(%arg0: memref<1xf64>, %arg1: memref<40x40xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2, %arg3] : memref<40x40xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S1(%arg0: memref<1xf64>, %arg1: memref<40x40xf64>, %arg2: index, %arg3: index, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg1[%arg4, %arg2] : memref<40x40xf64>
    %2 = affine.load %arg1[%arg2, %arg3] : memref<40x40xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[0] : memref<1xf64>
    return
  }
  func private @S2(%arg0: memref<40x40xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>) attributes {scop.stmt} {
  ...
  func private @S3(%arg0: memref<1xf64>, %arg1: memref<40x40xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2, %arg3] : memref<40x40xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S4(%arg0: memref<1xf64>, %arg1: memref<40x40xf64>, %arg2: index, %arg3: index, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg1[%arg4, %arg2] : memref<40x40xf64>
    %2 = affine.load %arg1[%arg2, %arg3] : memref<40x40xf64>
    %3 = mulf %1, %2 : f64
  ...
  func private @S5(%arg0: memref<40x40xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg3[0] : memref<1xf64>
    affine.store %0, %arg0[%arg1, %arg2] : memref<40x40xf64>
    return
  }
  func private @S6(%arg0: memref<1xf64>, %arg1: memref<40xf64>, %arg2: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[%arg2] : memref<40xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S7(%arg0: memref<1xf64>, %arg1: memref<40xf64>, %arg2: index, %arg3: memref<40x40xf64>, %arg4: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg3[%arg4, %arg2] : memref<40x40xf64>
    %2 = affine.load %arg1[%arg2] : memref<40xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[0] : memref<1xf64>
    return
  }
  func private @S8(%arg0: memref<40xf64>, %arg1: index, %arg2: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg2[0] : memref<1xf64>
    affine.store %0, %arg0[%arg1] : memref<40xf64>
    return
  }
  func private @S9(%arg0: memref<1xf64>, %arg1: memref<40xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg1[-%arg2 + symbol(%arg3) - 1] : memref<40xf64>
    affine.store %0, %arg0[0] : memref<1xf64>
    return
  }
  func private @S10(%arg0: memref<1xf64>, %arg1: memref<40xf64>, %arg2: index, %arg3: memref<40x40xf64>, %arg4: index, %arg5: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg3[-%arg4 + symbol(%arg5) - 1, %arg2] : memref<40x40xf64>
    %2 = affine.load %arg1[%arg2] : memref<40xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
    affine.store %4, %arg0[0] : memref<1xf64>
  ...
  func private @S11(%arg0: memref<40xf64>, %arg1: index, %arg2: index, %arg3: memref<40x40xf64>, %arg4: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[0] : memref<1xf64>
    %1 = affine.load %arg3[-%arg1 + symbol(%arg2) - 1, -%arg1 + symbol(%arg2) - 1] : memref<40x40xf64>
    %2 = divf %0, %1 : f64
    affine.store %2, %arg0[-%arg1 + symbol(%arg2) - 1] : memref<40xf64>
    return
  }
  func @kernel_ludcmp_new(%arg0: i32, %arg1: memref<40x40xf64>, %arg2: memref<40xf64>, %arg3: memref<40xf64>, %arg4: memref<40xf64>) {
    %c1 = constant 1 : index
    %c0 = constant 0 : index
    ...
    %2 = affine.load %arg1[%c1, %c0] : memref<40x40xf64>
    affine.store %2, %0[0] : memref<1xf64>
    %3 = affine.load %0[0] : memref<1xf64>
    %4 = affine.load %arg1[%c0, %c0] : memref<40x40xf64>
    %5 = divf %3, %4 : f64
    affine.store %5, %arg1[%c1, %c0] : memref<40x40xf64>
    affine.for %arg5 = 1 to %1 {
      call @S3(%0, %arg1, %c1, %arg5) : (memref<1xf64>, memref<40x40xf64>, index, index) -> ()
      call @S4(%0, %arg1, %c1, %arg5, %c0) : (memref<1xf64>, memref<40x40xf64>, index, index, index) -> ()
    ...
    affine.for %arg5 = 2 to %1 {
      ...
      affine.for %arg6 = 1 to #map0(%arg5) {
        ...
        affine.for %arg7 = 0 to #map0(%arg6) {
          call @S1(%0, %arg1, %arg5, %arg6, %arg7) : (memref<1xf64>, memref<40x40xf64>, index, index, index) -> ()
        }
      ...
      affine.for %arg6 = #map0(%arg5) to %1 {
        ...
        affine.for %arg7 = 0 to #map0(%arg5) {
          call @S4(%0, %arg1, %arg5, %arg6, %arg7) : (memref<1xf64>, memref<40x40xf64>, index, index, index) -> ()
        }
        call @S5(%arg1, %arg5, %arg6, %0) : (memref<40x40xf64>, index, index, memref<1xf64>) -> ()
      }
    }
    %6 = affine.load %0[0] : memref<1xf64>
    %7 = affine.load %arg1[-%c0 + symbol(%1) - 1, -%c0 + symbol(%1) - 1] : memref<40x40xf64>
    %8 = divf %6, %7 : f64
    affine.store %8, %arg3[-%c0 + symbol(%1) - 1] : memref<40xf64>
    %9 = affine.load %arg4[-%c0 + symbol(%1) - 1] : memref<40xf64>
    affine.store %9, %0[0] : memref<1xf64>
    affine.for %arg5 = 1 to %1 {
      affine.for %arg6 = #map2(%arg5)[%1] to %1 {
        call @S10(%0, %arg3, %arg5, %arg1, %arg6, %1) : (memref<1xf64>, memref<40xf64>, index, memref<40x40xf64>, index, index) -> ()
      }
    ...
    %10 = affine.load %arg2[%c0] : memref<40xf64>
    affine.store %10, %0[0] : memref<1xf64>
    %11 = affine.load %0[0] : memref<1xf64>
    affine.store %11, %arg4[%c0] : memref<40xf64>
    affine.for %arg5 = 1 to %1 {
      call @S6(%0, %arg2, %arg5) : (memref<1xf64>, memref<40xf64>, index) -> ()
      affine.for %arg6 = 0 to #map0(%arg5) {
        call @S7(%0, %arg4, %arg5, %arg1, %arg6) : (memref<1xf64>, memref<40xf64>, index, memref<40x40xf64>, index) -> ()
      }
