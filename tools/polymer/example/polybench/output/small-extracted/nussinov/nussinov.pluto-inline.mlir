...
#map2 = affine_map<(d0) -> (0, (d0 * 32 - 59) ceildiv 32)>
#map3 = affine_map<(d0) -> (2, d0 + 1)>
#map4 = affine_map<(d0, d1) -> (2, d0 * 32 - d1 * 32, d1 * -32 + 30)>
#map5 = affine_map<(d0, d1) -> (60, d0 * 32 - d1 * 32 + 32)>
#map6 = affine_map<(d0)[s0] -> (-d0 + s0)>
#map7 = affine_map<(d0, d1) -> (d0 * 32, -d1 + 61)>
#map8 = affine_map<(d0) -> (60, d0 * 32 + 32)>
#map9 = affine_map<(d0) -> (-d0 + 60)>
#map10 = affine_map<(d0) -> (d0)>
#map11 = affine_map<(d0) -> (d0 - 1)>
#map12 = affine_map<(d0)[s0] -> (-d0 + s0 - 1)>
#map13 = affine_map<()[s0] -> ((s0 - 62) floordiv 32 + 1)>
#map14 = affine_map<()[s0] -> (0, (s0 - 61) ceildiv 32)>
#map15 = affine_map<()[s0] -> ((s0 - 1) floordiv 16 + 1)>
#map16 = affine_map<(d0)[s0] -> (0, (d0 * 32 - s0 + 1) ceildiv 32)>
#map17 = affine_map<(d0)[s0] -> ((s0 - 1) floordiv 32 + 1, d0 + 1)>
#map18 = affine_map<()[s0] -> (s0 - 1)>
#map19 = affine_map<(d0, d1)[s0] -> (2, d0 * 32 - d1 * 32, d1 * -32 + s0 - 30)>
#map20 = affine_map<(d0, d1)[s0] -> (s0, d0 * 32 - d1 * 32 + 32)>
#map21 = affine_map<(d0, d1)[s0] -> (d0 * 32, -d1 + s0 + 1)>
#map22 = affine_map<(d0)[s0] -> (s0, d0 * 32 + 32)>
#set0 = affine_set<() : (-2 >= 0)>
#set1 = affine_set<() : (30 == 0)>
#set2 = affine_set<(d0, d1) : (-d0 >= 0, -d1 >= 0)>
#set3 = affine_set<(d0, d1) : (d0 - d1 == 0, d0 - 1 >= 0)>
#set4 = affine_set<(d0, d1) : ((-d1 + 60) floordiv 32 - d0 >= 0)>
#set5 = affine_set<(d0) : (d0 >= 0)>
#set6 = affine_set<(d0)[s0] : (-d0 + s0 - 1 >= 0)>
#set7 = affine_set<(d0, d1)[s0] : (d0 >= 0, -d1 + s0 - 1 >= 0)>
#set8 = affine_set<(d0, d1) : (d1 - d0 - 1 >= 0)>
#set9 = affine_set<()[s0] : (s0 - 62 >= 0)>
#set10 = affine_set<()[s0] : ((s0 + 2) mod 32 == 0)>
#set11 = affine_set<(d0, d1)[s0] : (-d0 + (s0 - 31) floordiv 32 >= 0, -d1 + s0 floordiv 32 - 1 >= 0)>
#set12 = affine_set<(d0, d1)[s0] : (d0 - d1 == 0, d0 - (s0 - 31) ceildiv 32 >= 0)>
#set13 = affine_set<(d0, d1)[s0] : ((-d1 + s0) floordiv 32 - d0 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb2:  // pred: ^bb1
    ...
    store %7, %0[%4] : memref<60xi8>
    br ^bb1(%5 : i32)
  ^bb3(%8: i32):  // 2 preds: ^bb1, ^bb7
    %9 = cmpi "slt", %8, %c60_i32 : i32
    ...
    affine.if #set0() {
      affine.if #set1() {
        affine.for %arg2 = 0 to 0 {
          %16 = affine.apply #map0(%arg2)[%c60]
          %17 = affine.apply #map1(%arg2)
          call @S0(%1, %16, %17, %c60) : (memref<60x60xi32>, index, index, index) -> ()
          %18 = affine.apply #map0(%arg2)[%c60]
          %19 = affine.apply #map1(%arg2)
          call @S1(%1, %18, %19, %c60) : (memref<60x60xi32>, index, index, index) -> ()
          %20 = affine.apply #map0(%arg2)[%c60]
          %21 = affine.apply #map1(%arg2)
          call @S2(%1, %20, %21, %c60, %0) : (memref<60x60xi32>, index, index, index, memref<60xi8>) -> ()
          %22 = affine.apply #map0(%arg2)[%c60]
          %23 = affine.apply #map1(%arg2)
          call @S3(%1, %22, %23, %c60) : (memref<60x60xi32>, index, index, index) -> ()
        }
      }
    }
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = max #map2(%arg2) to min #map3(%arg2) {
        affine.if #set2(%arg2, %arg3) {
          %16 = affine.apply #map0(%arg3)[%c60]
          %17 = affine.apply #map1(%arg3)
          call @S0(%1, %16, %17, %c60) : (memref<60x60xi32>, index, index, index) -> ()
          %18 = affine.apply #map0(%arg3)[%c60]
          %19 = affine.apply #map1(%arg3)
          call @S1(%1, %18, %19, %c60) : (memref<60x60xi32>, index, index, index) -> ()
          %20 = affine.apply #map0(%arg3)[%c60]
          %21 = affine.apply #map1(%arg3)
          call @S2(%1, %20, %21, %c60, %0) : (memref<60x60xi32>, index, index, index, memref<60xi8>) -> ()
          %22 = affine.apply #map0(%arg3)[%c60]
          %23 = affine.apply #map1(%arg3)
          call @S3(%1, %22, %23, %c60) : (memref<60x60xi32>, index, index, index) -> ()
        }
        affine.if #set3(%arg2, %arg3) {
          call @S0(%1, %c1, %c59, %c60) : (memref<60x60xi32>, index, index, index) -> ()
          call @S1(%1, %c1, %c59, %c60) : (memref<60x60xi32>, index, index, index) -> ()
          call @S2(%1, %c1, %c59, %c60, %0) : (memref<60x60xi32>, index, index, index, memref<60xi8>) -> ()
          call @S3(%1, %c1, %c59, %c60) : (memref<60x60xi32>, index, index, index) -> ()
        }
        affine.for %arg4 = max #map4(%arg2, %arg3) to min #map5(%arg2, %arg3) {
          affine.if #set4(%arg3, %arg4) {
            %16 = affine.apply #map6(%arg4)[%c60]
            call @S0(%1, %arg4, %16, %c60) : (memref<60x60xi32>, index, index, index) -> ()
            %17 = affine.apply #map6(%arg4)[%c60]
            call @S1(%1, %arg4, %17, %c60) : (memref<60x60xi32>, index, index, index) -> ()
            %18 = affine.apply #map6(%arg4)[%c60]
            call @S2(%1, %arg4, %18, %c60, %0) : (memref<60x60xi32>, index, index, index, memref<60xi8>) -> ()
            %19 = affine.apply #map6(%arg4)[%c60]
            call @S3(%1, %arg4, %19, %c60) : (memref<60x60xi32>, index, index, index) -> ()
          }
          affine.for %arg5 = max #map7(%arg3, %arg4) to min #map8(%arg3) {
            call @S0(%1, %arg4, %arg5, %c60) : (memref<60x60xi32>, index, index, index) -> ()
            call @S1(%1, %arg4, %arg5, %c60) : (memref<60x60xi32>, index, index, index) -> ()
            call @S2(%1, %arg4, %arg5, %c60, %0) : (memref<60x60xi32>, index, index, index, memref<60xi8>) -> ()
            call @S3(%1, %arg4, %arg5, %c60) : (memref<60x60xi32>, index, index, index) -> ()
            affine.for %arg6 = #map9(%arg4) to #map10(%arg5) {
              call @S4(%1, %arg4, %arg5, %c60, %arg6) : (memref<60x60xi32>, index, index, index, index) -> ()
            }
          }
        }
      }
  ...
  ^bb5(%11: i32):  // 2 preds: ^bb3, ^bb6
    %12 = cmpi "slt", %11, %c60_i32 : i32
    %13 = index_cast %11 : i32 to index
    cond_br %12, ^bb6, ^bb7
  ^bb6:  // pred: ^bb5
    store %c0_i32, %1[%10, %13] : memref<60x60xi32>
  ...
  func @kernel_nussinov(%arg0: i32, %arg1: memref<60xi8>, %arg2: memref<60x60xi32>) {
    ...
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = #map6(%arg3)[%0] to %0 {
        %1 = affine.apply #map11(%arg4)
        affine.if #set5(%1) {
        ...
        affine.if #set7(%1, %2)[%0] {
          %3 = affine.apply #map12(%arg3)[%0]
          affine.if #set8(%3, %1) {
        ...
        affine.for %arg5 = #map6(%arg3)[%0] to #map10(%arg4) {
  ...
  func @kernel_nussinov_new(%arg0: i32, %arg1: memref<60xi8>, %arg2: memref<60x60xi32>) {
    ...
    affine.for %arg3 = max #map14()[%0] to #map15()[%0] {
      affine.for %arg4 = max #map16(%arg3)[%0] to min #map17(%arg3)[%0] {
        affine.if #set11(%arg3, %arg4)[%0] {
        ...
        affine.for %arg5 = max #map19(%arg3, %arg4)[%0] to min #map20(%arg3, %arg4)[%0] {
          ...
          affine.for %arg6 = max #map21(%arg4, %arg5)[%0] to min #map22(%arg4)[%0] {
