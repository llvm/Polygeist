    ...
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = 1 to #map()[%1] {
        affine.for %arg5 = 1 to #map()[%1] {
          %2 = affine.load %arg2[%arg4 - 1, %arg5 - 1] : memref<40x40xf64>
          %3 = affine.load %arg2[%arg4 - 1, %arg5] : memref<40x40xf64>
          %4 = addf %2, %3 : f64
          %5 = affine.load %arg2[%arg4 - 1, %arg5 + 1] : memref<40x40xf64>
          %6 = addf %4, %5 : f64
          %7 = affine.load %arg2[%arg4, %arg5 - 1] : memref<40x40xf64>
          %8 = addf %6, %7 : f64
          %9 = affine.load %arg2[%arg4, %arg5] : memref<40x40xf64>
          %10 = addf %8, %9 : f64
          %11 = affine.load %arg2[%arg4, %arg5 + 1] : memref<40x40xf64>
          %12 = addf %10, %11 : f64
          %13 = affine.load %arg2[%arg4 + 1, %arg5 - 1] : memref<40x40xf64>
          %14 = addf %12, %13 : f64
          %15 = affine.load %arg2[%arg4 + 1, %arg5] : memref<40x40xf64>
          %16 = addf %14, %15 : f64
          %17 = affine.load %arg2[%arg4 + 1, %arg5 + 1] : memref<40x40xf64>
          %18 = addf %16, %17 : f64
          %19 = divf %18, %cst : f64
          affine.store %19, %arg2[%arg4, %arg5] : memref<40x40xf64>
        }
      }
    }
    return
