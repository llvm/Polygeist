#map0 = affine_map<(d0) -> (d0 ceildiv 2, (d0 * 32 - 19) ceildiv 32)>
#map1 = affine_map<(d0) -> (2, (d0 * 32 + 69) floordiv 64 + 1, d0 + 1)>
#map2 = affine_map<(d0, d1) -> ((d0 * 64 - 68) ceildiv 32, d1)>
#map3 = affine_map<(d0, d1) -> (4, d0 * 2 - d1 * 2 + 5, d0 + 4, d1 * 2 + 4, d1 + 3)>
#map4 = affine_map<(d0, d1, d2) -> (d0 * 32 - d1 * 32, d1 * 32 - 38, d2 * 16 - 38, d1 * -32 + d2 * 32 - 69)>
#map5 = affine_map<(d0, d1, d2) -> (20, d0 * 32 + 31, d1 * 16 + 15, d2 * 32 - d0 * 32 + 32, d0 * -32 + d1 * 32 + 31)>
#map6 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 + 1, d2 * 32 - d1 - 38)>
#map7 = affine_map<(d0, d1, d2) -> (d0 * 32 + 32, d1 * 32 - d2 + 31, d2 + 39)>
#map8 = affine_map<(d0, d1, d2) -> (d0 * 32, d1 + d2 + 1)>
#map9 = affine_map<(d0, d1, d2) -> (d0 * 32 + 32, d1 + d2 + 39)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
          ...
          affine.for %arg5 = max #map4(%arg2, %arg3, %arg4) to min #map5(%arg2, %arg3, %arg4) {
            affine.for %arg6 = max #map6(%arg3, %arg4, %arg5) to min #map7(%arg3, %arg4, %arg5) {
              affine.for %arg7 = max #map8(%arg4, %arg5, %arg6) to min #map9(%arg4, %arg5, %arg6) {
                %17 = affine.apply #map10(%arg5, %arg6)
                call @S0(%0, %arg5, %17) : (memref<40x40xf64>, index, index) -> ()
              }
            }
          }
        }
  ...
  ^bb4:  // pred: ^bb3
    ...
    %12 = addf %10, %11 : f64
    %13 = sitofp %c40_i32 : i32 to f64
    %14 = divf %12, %13 : f64
    store %14, %0[%3, %6] : memref<40x40xf64>
    %15 = addi %4, %c1_i32 : i32
    br ^bb3(%15 : i32)
  ^bb5:  // pred: ^bb3
  ...
  ^bb4:  // pred: ^bb3
    ...
    %13 = divf %11, %12 : f64
    store %13, %arg1[%2, %5] : memref<40x40xf64>
  ...
  func @kernel_seidel_2d(%arg0: i32, %arg1: i32, %arg2: memref<40x40xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = 1 to #map11()[%1] {
        affine.for %arg5 = 1 to #map11()[%1] {
          call @S0(%arg2, %arg4, %arg5) : (memref<40x40xf64>, index, index) -> ()
        }
      }
    }
    return
  ...
  func private @S0(%arg0: memref<40x40xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 9.000000e+00 : f64
    %0 = affine.load %arg0[%arg1 - 1, %arg2 - 1] : memref<40x40xf64>
    %1 = affine.load %arg0[%arg1 - 1, %arg2] : memref<40x40xf64>
    %2 = addf %0, %1 : f64
    %3 = affine.load %arg0[%arg1 - 1, %arg2 + 1] : memref<40x40xf64>
    %4 = addf %2, %3 : f64
    %5 = affine.load %arg0[%arg1, %arg2 - 1] : memref<40x40xf64>
    %6 = addf %4, %5 : f64
    %7 = affine.load %arg0[%arg1, %arg2] : memref<40x40xf64>
    %8 = addf %6, %7 : f64
    %9 = affine.load %arg0[%arg1, %arg2 + 1] : memref<40x40xf64>
    %10 = addf %8, %9 : f64
    %11 = affine.load %arg0[%arg1 + 1, %arg2 - 1] : memref<40x40xf64>
    %12 = addf %10, %11 : f64
    %13 = affine.load %arg0[%arg1 + 1, %arg2] : memref<40x40xf64>
    %14 = addf %12, %13 : f64
    %15 = affine.load %arg0[%arg1 + 1, %arg2 + 1] : memref<40x40xf64>
    %16 = addf %14, %15 : f64
    %17 = divf %16, %cst : f64
    affine.store %17, %arg0[%arg1, %arg2] : memref<40x40xf64>
    return
  }
  func @kernel_seidel_2d_new(%arg0: i32, %arg1: i32, %arg2: memref<40x40xf64>) {
          ...
          affine.for %arg6 = max #map17(%arg3, %arg4, %arg5)[%0] to min #map18(%arg3, %arg4, %arg5)[%1] {
            affine.for %arg7 = max #map19(%arg4, %arg5, %arg6)[%0] to min #map20(%arg4, %arg5, %arg6)[%0] {
              affine.for %arg8 = max #map8(%arg5, %arg6, %arg7) to min #map21(%arg5, %arg6, %arg7)[%0] {
                ...
                call @S0(%arg2, %arg6, %2) : (memref<40x40xf64>, index, index) -> ()
              }
            }
          }
        }
