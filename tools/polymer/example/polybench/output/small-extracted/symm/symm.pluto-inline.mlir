...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb3:  // pred: ^bb2
    ...
    %14 = sitofp %c20_i32 : i32 to f64
    %15 = divf %13, %14 : f64
    store %15, %2[%7, %10] : memref<20x30xf64>
    %16 = addi %5, %c30_i32 : i32
    %17 = subi %16, %8 : i32
    %18 = remi_signed %17, %c100_i32 : i32
    %19 = sitofp %18 : i32 to f64
    %20 = divf %19, %14 : f64
    store %20, %4[%7, %10] : memref<20x30xf64>
  ...
  ^bb6:  // pred: ^bb5
    ...
    affine.for %arg2 = 0 to 30 {
      ...
      call @S3(%2, %c0, %arg2, %26, %28, %3, %4, %27) : (memref<20x30xf64>, index, index, f64, memref<1xf64>, memref<20x20xf64>, memref<20x30xf64>, f64) -> ()
    }
    affine.for %arg2 = 1 to 20 {
      affine.for %arg3 = 0 to 30 {
        call @S1(%2, %arg2, %arg3, %3, %c0, %26, %4) : (memref<20x30xf64>, index, index, memref<20x20xf64>, index, f64, memref<20x30xf64>) -> ()
        call @S0(%28) : (memref<1xf64>) -> ()
        call @S2(%28, %3, %arg2, %arg3, %4, %c0) : (memref<1xf64>, memref<20x20xf64>, index, index, memref<20x30xf64>, index) -> ()
        affine.for %arg4 = 1 to #map(%arg2) {
          call @S1(%2, %arg2, %arg3, %3, %arg4, %26, %4) : (memref<20x30xf64>, index, index, memref<20x20xf64>, index, f64, memref<20x30xf64>) -> ()
          call @S2(%28, %3, %arg2, %arg3, %4, %arg4) : (memref<1xf64>, memref<20x20xf64>, index, index, memref<20x30xf64>, index) -> ()
        }
        call @S3(%2, %arg2, %arg3, %26, %28, %3, %4, %27) : (memref<20x30xf64>, index, index, f64, memref<1xf64>, memref<20x20xf64>, memref<20x30xf64>, f64) -> ()
      }
    }
    call @print_array(%c20_i32, %c30_i32, %2) : (i32, i32, memref<20x30xf64>) -> ()
    return %c0_i32 : i32
  ...
  ^bb8:  // pred: ^bb7
    ...
    %35 = sitofp %c20_i32 : i32 to f64
    %36 = divf %34, %35 : f64
    store %36, %3[%25, %31] : memref<20x20xf64>
  ...
  ^bb10(%39: i32):  // 2 preds: ^bb9, ^bb11
    %40 = cmpi "slt", %39, %c20_i32 : i32
    %41 = index_cast %39 : i32 to index
    cond_br %40, ^bb11, ^bb5(%38 : i32)
  ^bb11:  // pred: ^bb10
    %42 = sitofp %c-999_i32 : i32 to f64
    store %42, %3[%25, %41] : memref<20x20xf64>
    %43 = addi %39, %c1_i32 : i32
    br ^bb10(%43 : i32)
  }
  func @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<20x30xf64>, %arg5: memref<20x20xf64>, %arg6: memref<20x30xf64>) {
    %c0 = constant 0 : index
    %cst = constant 1.500000e+00 : f64
    %cst_0 = constant 1.200000e+00 : f64
    %c0_i32 = constant 0 : i32
  ...
  ^bb3:  // pred: ^bb2
    ...
    %10 = divf %8, %9 : f64
    store %10, %arg4[%2, %5] : memref<20x30xf64>
    %11 = addi %arg1, %0 : i32
    %12 = subi %11, %3 : i32
    %13 = remi_signed %12, %c100_i32 : i32
    %14 = sitofp %13 : i32 to f64
    %15 = divf %14, %9 : f64
    store %15, %arg6[%2, %5] : memref<20x30xf64>
  ...
  ^bb8:  // pred: ^bb7
    ...
    %28 = divf %26, %27 : f64
    store %28, %arg5[%20, %23] : memref<20x20xf64>
  ...
  ^bb11:  // pred: ^bb10
    ...
    store %34, %arg5[%20, %33] : memref<20x20xf64>
    %35 = addi %31, %c1_i32 : i32
    br ^bb10(%35 : i32)
  }
  func @kernel_symm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<20x30xf64>, %arg5: memref<20x20xf64>, %arg6: memref<20x30xf64>) {
    ...
    affine.for %arg7 = 0 to %2 {
      affine.for %arg8 = 0 to %0 {
        ...
        affine.for %arg9 = 0 to #map(%arg7) {
          call @S1(%arg4, %arg9, %arg8, %arg5, %arg7, %arg2, %arg6) : (memref<20x30xf64>, index, index, memref<20x20xf64>, index, f64, memref<20x30xf64>) -> ()
          call @S2(%1, %arg5, %arg7, %arg9, %arg6, %arg8) : (memref<1xf64>, memref<20x20xf64>, index, index, memref<20x30xf64>, index) -> ()
        }
        call @S3(%arg4, %arg7, %arg8, %arg2, %1, %arg5, %arg6, %arg3) : (memref<20x30xf64>, index, index, f64, memref<1xf64>, memref<20x20xf64>, memref<20x30xf64>, f64) -> ()
      }
    }
    return
  }
  func @print_array(%arg0: i32, %arg1: i32, %arg2: memref<20x30xf64>) {
    %c0_i32 = constant 0 : i32
    %c20_i32 = constant 20 : i32
    %c1_i32 = constant 1 : i32
  ...
  ^bb4:  // pred: ^bb3
    ...
    %39 = load %arg2[%15, %30] : memref<20x30xf64>
  ...
  func private @S1(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: memref<20x20xf64>, %arg4: index, %arg5: f64, %arg6: memref<20x30xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<20x30xf64>
    %1 = affine.load %arg6[%arg4, %arg2] : memref<20x30xf64>
    %2 = mulf %arg5, %1 : f64
    %3 = affine.load %arg3[%arg4, %arg1] : memref<20x20xf64>
    %4 = mulf %2, %3 : f64
    %5 = addf %0, %4 : f64
    affine.store %5, %arg0[%arg1, %arg2] : memref<20x30xf64>
    return
  }
  func private @S2(%arg0: memref<1xf64>, %arg1: memref<20x20xf64>, %arg2: index, %arg3: index, %arg4: memref<20x30xf64>, %arg5: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg4[%arg3, %arg5] : memref<20x30xf64>
    %2 = affine.load %arg1[%arg2, %arg3] : memref<20x20xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[0] : memref<1xf64>
    return
  }
  func private @S3(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: f64, %arg4: memref<1xf64>, %arg5: memref<20x20xf64>, %arg6: memref<20x30xf64>, %arg7: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<20x30xf64>
    %1 = mulf %arg7, %0 : f64
    %2 = affine.load %arg6[%arg1, %arg2] : memref<20x30xf64>
    %3 = mulf %arg3, %2 : f64
    %4 = affine.load %arg5[%arg1, %arg1] : memref<20x20xf64>
    %5 = mulf %3, %4 : f64
    %6 = addf %1, %5 : f64
  ...
  func @kernel_symm_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<20x30xf64>, %arg5: memref<20x20xf64>, %arg6: memref<20x30xf64>) {
    %c0 = constant 0 : index
    %0 = alloca() : memref<1xf64>
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      call @S3(%arg4, %c0, %arg7, %arg2, %0, %arg5, %arg6, %arg3) : (memref<20x30xf64>, index, index, f64, memref<1xf64>, memref<20x20xf64>, memref<20x30xf64>, f64) -> ()
    }
    affine.for %arg7 = 1 to %2 {
      affine.for %arg8 = 0 to %1 {
        call @S1(%arg4, %arg7, %arg8, %arg5, %c0, %arg2, %arg6) : (memref<20x30xf64>, index, index, memref<20x20xf64>, index, f64, memref<20x30xf64>) -> ()
        call @S0(%0) : (memref<1xf64>) -> ()
        call @S2(%0, %arg5, %arg7, %arg8, %arg6, %c0) : (memref<1xf64>, memref<20x20xf64>, index, index, memref<20x30xf64>, index) -> ()
        affine.for %arg9 = 1 to #map(%arg7) {
          call @S1(%arg4, %arg7, %arg8, %arg5, %arg9, %arg2, %arg6) : (memref<20x30xf64>, index, index, memref<20x20xf64>, index, f64, memref<20x30xf64>) -> ()
          call @S2(%0, %arg5, %arg7, %arg8, %arg6, %arg9) : (memref<1xf64>, memref<20x20xf64>, index, index, memref<20x30xf64>, index) -> ()
        }
        call @S3(%arg4, %arg7, %arg8, %arg2, %0, %arg5, %arg6, %arg3) : (memref<20x30xf64>, index, index, f64, memref<1xf64>, memref<20x20xf64>, memref<20x30xf64>, f64) -> ()
      }
    }
    return
  }
