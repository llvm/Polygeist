...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
      ...
      affine.for %arg3 = 0 to #map0(%arg2) {
        affine.for %arg4 = #map1(%arg2) to min #map2(%arg2) {
          affine.for %arg5 = #map1(%arg3) to min #map3(%arg3, %arg4) {
            call @S0(%2, %arg4, %arg5, %22) : (memref<30x30xf64>, index, index, f64) -> ()
          }
        }
      }
    }
          ...
          affine.for %arg5 = #map1(%arg3) to min #map2(%arg3) {
            affine.for %arg6 = #map1(%arg4) to min #map3(%arg4, %arg5) {
              affine.for %arg7 = #map6(%arg2, %arg3) to min #map7(%arg2, %arg3) {
                call @S1(%2, %arg5, %arg7, %3, %arg6, %21) : (memref<30x30xf64>, index, index, memref<30x20xf64>, index, f64) -> ()
              }
            }
          }
        }
  ...
  ^bb7(%23: i32):  // 2 preds: ^bb5, ^bb8
    %24 = cmpi "slt", %23, %c30_i32 : i32
    %25 = index_cast %23 : i32 to index
    cond_br %24, ^bb8, ^bb9
  ^bb8:  // pred: ^bb7
    %26 = muli %18, %23 : i32
    %27 = addi %26, %c2_i32 : i32
    %28 = remi_signed %27, %c20_i32 : i32
    %29 = sitofp %28 : i32 to f64
    %30 = sitofp %c20_i32 : i32 to f64
    %31 = divf %29, %30 : f64
    store %31, %2[%20, %25] : memref<30x30xf64>
  ...
  func @kernel_syrk_new(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<30x30xf64>, %arg5: memref<30x20xf64>) {
