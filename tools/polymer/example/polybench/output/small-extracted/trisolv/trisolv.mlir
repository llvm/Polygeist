...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_trisolv(%c40_i32, %0, %1, %2) : (i32, memref<40x40xf64>, memref<40xf64>, memref<40xf64>) -> ()
  ...
  func @kernel_trisolv(%arg0: i32, %arg1: memref<40x40xf64>, %arg2: memref<40xf64>, %arg3: memref<40xf64>) {
    ...
    affine.for %arg4 = 0 to %0 {
      %1 = affine.load %arg3[%arg4] : memref<40xf64>
      affine.store %1, %arg2[%arg4] : memref<40xf64>
      affine.for %arg5 = 0 to #map(%arg4) {
        %5 = affine.load %arg1[%arg4, %arg5] : memref<40x40xf64>
        %6 = affine.load %arg2[%arg5] : memref<40xf64>
        %7 = mulf %5, %6 : f64
        %8 = affine.load %arg2[%arg4] : memref<40xf64>
        %9 = subf %8, %7 : f64
        affine.store %9, %arg2[%arg4] : memref<40xf64>
      }
      %2 = affine.load %arg2[%arg4] : memref<40xf64>
      %3 = affine.load %arg1[%arg4, %arg4] : memref<40x40xf64>
      %4 = divf %2, %3 : f64
      affine.store %4, %arg2[%arg4] : memref<40xf64>
    }
    return
  }
