...
#map2 = affine_map<(d0) -> (0, (d0 * 32 - 39) ceildiv 32)>
...
#map9 = affine_map<(d0) -> (40, d0 * 16 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  ^bb1(%3: i32):  // 2 preds: ^bb0, ^bb6
    %4 = cmpi "slt", %3, %c40_i32 : i32
    %5 = index_cast %3 : i32 to index
    cond_br %4, ^bb2, ^bb3
  ^bb2:  // pred: ^bb1
    %6 = sitofp %c-999_i32 : i32 to f64
    store %6, %1[%5] : memref<40xf64>
    %7 = sitofp %3 : i32 to f64
    store %7, %2[%5] : memref<40xf64>
    br ^bb4(%c0_i32 : i32)
  ^bb3:  // pred: ^bb1
    affine.for %arg2 = 0 to 2 {
      affine.for %arg3 = #map0(%arg2) to min #map1(%arg2) {
        call @S0(%1, %arg3, %2) : (memref<40xf64>, index, memref<40xf64>) -> ()
      }
    }
      ...
      affine.for %arg3 = max #map2(%arg2) to #map3(%arg2) {
        affine.for %arg4 = #map4(%arg2, %arg3) to min #map5(%arg2, %arg3) {
          affine.for %arg5 = #map0(%arg3) to #map6(%arg3) {
            call @S1(%1, %arg4, %arg5, %0) : (memref<40xf64>, index, index, memref<40x40xf64>) -> ()
          }
        }
      }
      affine.if #set0(%arg2) {
        %21 = affine.apply #map7(%arg2)
        call @S2(%1, %21, %0) : (memref<40xf64>, index, memref<40x40xf64>) -> ()
        affine.for %arg3 = #map8(%arg2) to min #map9(%arg2) {
          affine.for %arg4 = #map7(%arg2) to #map10(%arg3) {
            call @S1(%1, %arg3, %arg4, %0) : (memref<40xf64>, index, index, memref<40x40xf64>) -> ()
          }
          call @S2(%1, %arg3, %0) : (memref<40xf64>, index, memref<40x40xf64>) -> ()
        }
      }
    }
    affine.if #set1() {
      affine.if #set1() {
        call @S2(%1, %c39, %0) : (memref<40xf64>, index, memref<40x40xf64>) -> ()
      }
    }
  ...
  ^bb4(%8: i32):  // 2 preds: ^bb2, ^bb5
    ...
    cond_br %9, ^bb5, ^bb6
  ^bb5:  // pred: ^bb4
    %11 = addi %3, %c40_i32 : i32
    %12 = subi %11, %8 : i32
    %13 = addi %12, %c1_i32 : i32
    %14 = sitofp %13 : i32 to f64
    %15 = sitofp %c2_i32 : i32 to f64
    %16 = mulf %14, %15 : f64
    %17 = sitofp %c40_i32 : i32 to f64
    %18 = divf %16, %17 : f64
    store %18, %0[%5, %10] : memref<40x40xf64>
  ...
  func @init_array(%arg0: i32, %arg1: memref<40x40xf64>, %arg2: memref<40xf64>, %arg3: memref<40xf64>) {
    %c0_i32 = constant 0 : i32
    %c-999_i32 = constant -999 : i32
    %c2_i32 = constant 2 : i32
    %c1_i32 = constant 1 : i32
  ...
  func @kernel_trisolv(%arg0: i32, %arg1: memref<40x40xf64>, %arg2: memref<40xf64>, %arg3: memref<40xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg4 = 0 to %0 {
      call @S0(%arg2, %arg4, %arg3) : (memref<40xf64>, index, memref<40xf64>) -> ()
      affine.for %arg5 = 0 to #map10(%arg4) {
  ...
  func @kernel_trisolv_new(%arg0: i32, %arg1: memref<40x40xf64>, %arg2: memref<40xf64>, %arg3: memref<40xf64>) {
    %0 = index_cast %arg0 : i32 to index
      ...
      affine.if #set0(%arg4) {
        ...
        affine.for %arg5 = #map8(%arg4) to min #map16(%arg4)[%0] {
          affine.for %arg6 = #map7(%arg4) to #map10(%arg5) {
            call @S1(%arg2, %arg5, %arg6, %arg1) : (memref<40xf64>, index, index, memref<40x40xf64>) -> ()
          }
          call @S2(%arg2, %arg5, %arg1) : (memref<40xf64>, index, memref<40x40xf64>) -> ()
        }
      }
    }
    affine.if #set2()[%0] {
