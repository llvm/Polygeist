...
#map3 = affine_map<(d0, d1) -> (19, d0 * 32 + 32, d1 * 32 + 31)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  llvm.mlir.global internal constant @str2("B\00")
  ...
  ^bb2:  // pred: ^bb1
    ...
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map0(%arg3) to 1 {
          affine.for %arg5 = #map1(%arg2) to min #map2(%arg2) {
            affine.for %arg6 = #map1(%arg3) to min #map3(%arg3, %arg4) {
              affine.for %arg7 = max #map4(%arg4, %arg6) to min #map5(%arg4) {
                call @S0(%2, %arg6, %arg5, %arg7, %1) : (memref<20x30xf64>, index, index, index, memref<20x20xf64>) -> ()
              }
            }
          }
        }
      ...
      affine.for %arg3 = 0 to 1 {
        affine.for %arg4 = #map1(%arg2) to min #map5(%arg2) {
          affine.for %arg5 = #map1(%arg3) to min #map2(%arg3) {
            call @S1(%2, %arg4, %arg5, %6) : (memref<20x30xf64>, index, index, f64) -> ()
          }
        }
      }
    }
    ...
    return %c0_i32 : i32
  ^bb3(%7: i32):  // 2 preds: ^bb1, ^bb4
    %8 = cmpi "slt", %7, %3 : i32
    %9 = index_cast %7 : i32 to index
    cond_br %8, ^bb4, ^bb5
  ^bb4:  // pred: ^bb3
    %10 = addi %3, %7 : i32
    %11 = remi_signed %10, %c20_i32 : i32
    %12 = sitofp %11 : i32 to f64
    %13 = sitofp %c20_i32 : i32 to f64
    %14 = divf %12, %13 : f64
    store %14, %1[%5, %9] : memref<20x20xf64>
    %15 = addi %7, %c1_i32 : i32
    br ^bb3(%15 : i32)
  ^bb5:  // pred: ^bb3
    store %cst_0, %1[%5, %5] : memref<20x20xf64>
    br ^bb6(%c0_i32 : i32)
  ^bb6(%16: i32):  // 2 preds: ^bb5, ^bb7
    %17 = cmpi "slt", %16, %c30_i32 : i32
    %18 = index_cast %16 : i32 to index
    cond_br %17, ^bb7, ^bb8
  ^bb7:  // pred: ^bb6
    %19 = subi %3, %16 : i32
    %20 = addi %19, %c30_i32 : i32
    %21 = remi_signed %20, %c30_i32 : i32
    %22 = sitofp %21 : i32 to f64
    %23 = sitofp %c30_i32 : i32 to f64
    %24 = divf %22, %23 : f64
    store %24, %2[%5, %18] : memref<20x30xf64>
    %25 = addi %16, %c1_i32 : i32
    br ^bb6(%25 : i32)
  ^bb8:  // pred: ^bb6
    %26 = addi %3, %c1_i32 : i32
    br ^bb1(%26 : i32)
  }
  func @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<20x20xf64>, %arg4: memref<20x30xf64>) {
    %c0 = constant 0 : index
    %cst = constant 1.500000e+00 : f64
    %c0_i32 = constant 0 : i32
    %cst_0 = constant 1.000000e+00 : f64
  ...
  ^bb4:  // pred: ^bb3
    ...
    %10 = divf %8, %9 : f64
    store %10, %arg3[%2, %5] : memref<20x20xf64>
    %11 = addi %3, %c1_i32 : i32
    br ^bb3(%11 : i32)
  ^bb5:  // pred: ^bb3
    store %cst_0, %arg3[%2, %2] : memref<20x20xf64>
    br ^bb6(%c0_i32 : i32)
  ...
  ^bb7:  // pred: ^bb6
    ...
    %20 = divf %18, %19 : f64
    store %20, %arg4[%2, %14] : memref<20x30xf64>
  ...
  func @kernel_trmm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<20x20xf64>, %arg4: memref<20x30xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to %1 {
        affine.for %arg7 = #map6(%arg5) to %0 {
          call @S0(%arg4, %arg5, %arg6, %arg7, %arg3) : (memref<20x30xf64>, index, index, index, memref<20x20xf64>) -> ()
        }
        call @S1(%arg4, %arg5, %arg6, %arg2) : (memref<20x30xf64>, index, index, f64) -> ()
      }
    }
    return
  }
  ...
  func private @S0(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<20x20xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<20x30xf64>
    %1 = affine.load %arg4[%arg3, %arg1] : memref<20x20xf64>
    %2 = affine.load %arg0[%arg3, %arg2] : memref<20x30xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[%arg1, %arg2] : memref<20x30xf64>
    return
  }
  func private @S1(%arg0: memref<20x30xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[%arg1, %arg2] : memref<20x30xf64>
    %1 = mulf %arg3, %0 : f64
