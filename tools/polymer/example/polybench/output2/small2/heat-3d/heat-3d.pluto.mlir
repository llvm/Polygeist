...
#map1 = affine_map<()[s0] -> ((s0 + 38) floordiv 32 + 1)>
#map2 = affine_map<()[s0] -> ((s0 + 28) floordiv 32 + 1)>
#map3 = affine_map<(d0) -> (31, d0 * 32)>
#map4 = affine_map<(d0)[s0] -> (s0 + 29, d0 * 32 + 32)>
#map5 = affine_map<()[s0] -> (s0 - 2)>
#map6 = affine_map<(d0) -> (d0 - 30)>
#map7 = affine_map<(d0)[s0] -> (0, (d0 * 32 - s0 - 27) ceildiv 32)>
#map8 = affine_map<(d0)[s0] -> ((s0 + 38) floordiv 32 + 1, (d0 * 32 + s0 + 27) floordiv 32 + 1)>
#map9 = affine_map<(d0) -> (d0 * 32)>
#map10 = affine_map<(d0) -> (d0 * 32 + 32)>
#map11 = affine_map<(d0, d1)[s0] -> (0, (d0 * 32 - s0 - 27) ceildiv 32, (d1 * 32 - s0 - 27) ceildiv 32)>
#map12 = affine_map<(d0, d1)[s0] -> ((s0 + 38) floordiv 32 + 1, (d0 * 32 + s0 + 27) floordiv 32 + 1, (d1 * 32 + s0 + 27) floordiv 32 + 1)>
#map13 = affine_map<(d0, d1)[s0] -> (d0 * 32, d1 * 32 - s0 + 3)>
#map14 = affine_map<(d0, d1) -> (d0 * 32 + 1, d1 * 32 + 32)>
#map15 = affine_map<(d0, d1)[s0] -> (d0 * -32 + d1 + s0 - 2)>
#map16 = affine_map<(d0, d1, d2)[s0] -> (1, (d0 * 32 - s0 + 2) ceildiv 2, (d1 * 32 - s0 + 2) ceildiv 2, (d2 * 32 - s0 + 2) ceildiv 2)>
#map17 = affine_map<(d0, d1, d2) -> (21, d0 * 16 + 15, d1 * 16 + 15, d2 * 16 + 15)>
...
#map24 = affine_map<(d0) -> (42, d0 * 32)>
#map25 = affine_map<(d0) -> (d0 - 41)>
#map26 = affine_map<()[s0] -> ((s0 + 39) floordiv 32 + 1)>
#map27 = affine_map<(d0)[s0] -> (s0 + 40, d0 * 32 + 32)>
#set0 = affine_set<(d0)[s0] : (d0 * 32 - (s0 + 28) == 0)>
#set1 = affine_set<()[s0] : ((s0 + 28) mod 32 == 0)>
#set2 = affine_set<(d0, d1)[s0] : (-d0 + (s0 - 4) floordiv 32 >= 0, d1 * 32 - (s0 + 28) == 0)>
#set3 = affine_set<(d0, d1, d2)[s0] : (d1 - d0 - 1 >= 0, d1 - (s0 + 1) ceildiv 32 >= 0, d1 - d2 >= 0)>
#set4 = affine_set<()[s0] : ((s0 + 1) mod 2 == 0)>
#set5 = affine_set<(d0, d1, d2)[s0] : (d1 - d0 - 1 >= 0, d1 - d2 - 1 >= 0, d1 - (s0 + 1) ceildiv 32 >= 0)>
#set6 = affine_set<(d0, d1, d2)[s0] : (d0 - (s0 + 1) ceildiv 32 >= 0, d0 - d1 >= 0, d0 - d2 >= 0)>
#set7 = affine_set<(d0, d1) : (d1 floordiv 16 - d0 >= 0)>
#set8 = affine_set<(d0, d1)[s0] : (d0 - (d1 * 2 + s0 - 32) ceildiv 32 >= 0)>
#set9 = affine_set<(d0, d1) : (d0 == 0, d1 - 1 >= 0)>
#set10 = affine_set<(d0, d1, d2) : (d0 == 0, d1 - 1 >= 0, d2 - 1 >= 0)>
#set11 = affine_set<(d0) : (d0 == 0)>
#set12 = affine_set<(d0, d1) : (d0 - 1 >= 0, d1 - 1 >= 0)>
#set13 = affine_set<()[s0] : ((s0 + 7) mod 32 == 0)>
#set14 = affine_set<(d0) : (d0 - 1 >= 0)>
  ...
  func private @kernel_heat_3d_new(%arg0: i32, %arg1: i32, %arg2: memref<10x10x10xf64>, %arg3: memref<10x10x10xf64>) {
    ...
    affine.for %arg4 = 0 to #map1()[%0] {
      affine.if #set0(%arg4)[%0] {
        affine.for %arg5 = 0 to #map2()[%0] {
          affine.for %arg6 = max #map3(%arg5) to min #map4(%arg5)[%0] {
            affine.if #set1()[%0] {
              %1 = affine.apply #map5()[%0]
              %2 = affine.apply #map6(%arg6)
              call @S0(%arg3, %1, %c1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg5 = max #map7(%arg4)[%0] to min #map8(%arg4)[%0] {
        ...
        affine.if #set0(%arg4)[%0] {
          affine.for %arg6 = #map9(%arg5) to min #map4(%arg5)[%0] {
            affine.if #set1()[%0] {
              %1 = affine.apply #map5()[%0]
              %2 = affine.apply #map6(%arg6)
              call @S0(%arg3, %1, %2, %c1, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
        ...
        affine.for %arg6 = max #map11(%arg4, %arg5)[%0] to min #map12(%arg4, %arg5)[%0] {
          affine.if #set3(%arg4, %arg5, %arg6)[%0] {
            affine.if #set4()[%0] {
              affine.for %arg7 = max #map13(%arg4, %arg5)[%0] to #map10(%arg4) {
                affine.for %arg8 = max #map13(%arg5, %arg6)[%0] to min #map14(%arg5, %arg6) {
                  %1 = affine.apply #map15(%arg5, %arg7)[%0]
                  %2 = affine.apply #map5()[%0]
          ...
          affine.if #set5(%arg4, %arg5, %arg6)[%0] {
            affine.if #set4()[%0] {
              affine.for %arg7 = max #map13(%arg4, %arg6)[%0] to #map10(%arg4) {
                affine.for %arg8 = max #map13(%arg5, %arg6)[%0] to #map10(%arg5) {
                  %1 = affine.apply #map15(%arg6, %arg7)[%0]
                  %2 = affine.apply #map15(%arg6, %arg8)[%0]
                  %3 = affine.apply #map5()[%0]
                  call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
            }
          ...
          affine.if #set6(%arg4, %arg5, %arg6)[%0] {
            affine.if #set4()[%0] {
              affine.for %arg7 = max #map13(%arg4, %arg5)[%0] to min #map14(%arg4, %arg5) {
                affine.for %arg8 = max #map13(%arg4, %arg6)[%0] to min #map14(%arg4, %arg6) {
                  %1 = affine.apply #map5()[%0]
                  %2 = affine.apply #map15(%arg4, %arg7)[%0]
                  %3 = affine.apply #map15(%arg4, %arg8)[%0]
                  call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
            }
          }
          affine.for %arg7 = max #map16(%arg4, %arg5, %arg6)[%0] to min #map17(%arg4, %arg5, %arg6) {
            affine.if #set7(%arg4, %arg7) {
              affine.for %arg8 = max #map18(%arg5, %arg7) to min #map19(%arg5, %arg7)[%0] {
                affine.for %arg9 = max #map18(%arg6, %arg7) to min #map19(%arg6, %arg7)[%0] {
                  %1 = affine.apply #map20(%arg7, %arg8)
                  %2 = affine.apply #map20(%arg7, %arg9)
                  call @S0(%arg3, %c1, %1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
              }
            }
            affine.for %arg8 = max #map21(%arg4, %arg7) to min #map19(%arg4, %arg7)[%0] {
              ...
              affine.for %arg9 = max #map21(%arg5, %arg7) to min #map19(%arg5, %arg7)[%0] {
                affine.if #set7(%arg6, %arg7) {
                  %1 = affine.apply #map20(%arg7, %arg8)
                  %2 = affine.apply #map20(%arg7, %arg9)
                  call @S0(%arg3, %1, %2, %c1, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
                affine.for %arg10 = max #map21(%arg6, %arg7) to min #map19(%arg6, %arg7)[%0] {
                  %1 = affine.apply #map22(%arg7, %arg8)
                  %2 = affine.apply #map22(%arg7, %arg9)
                  %3 = affine.apply #map22(%arg7, %arg10)
                  call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                  %4 = affine.apply #map20(%arg7, %arg8)
                  %5 = affine.apply #map20(%arg7, %arg9)
                  %6 = affine.apply #map20(%arg7, %arg10)
                  call @S0(%arg3, %4, %5, %6, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
                }
                affine.if #set8(%arg6, %arg7)[%0] {
                  %1 = affine.apply #map22(%arg7, %arg8)
                  %2 = affine.apply #map22(%arg7, %arg9)
                  %3 = affine.apply #map5()[%0]
                  call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              ...
              affine.if #set8(%arg5, %arg7)[%0] {
                affine.for %arg9 = max #map21(%arg6, %arg7) to min #map23(%arg6, %arg7)[%0] {
                  %1 = affine.apply #map22(%arg7, %arg8)
                  %2 = affine.apply #map5()[%0]
            ...
            affine.if #set8(%arg4, %arg7)[%0] {
              affine.for %arg8 = max #map21(%arg5, %arg7) to min #map23(%arg5, %arg7)[%0] {
                affine.for %arg9 = max #map21(%arg6, %arg7) to min #map23(%arg6, %arg7)[%0] {
                  %1 = affine.apply #map5()[%0]
          ...
          affine.if #set9(%arg5, %arg6) {
            affine.for %arg7 = max #map3(%arg4) to min #map4(%arg4)[%0] {
              affine.for %arg8 = #map9(%arg6) to min #map4(%arg6)[%0] {
          ...
          affine.if #set10(%arg4, %arg5, %arg6) {
            affine.for %arg7 = #map9(%arg5) to min #map4(%arg5)[%0] {
              affine.for %arg8 = #map9(%arg6) to min #map4(%arg6)[%0] {
                %1 = affine.apply #map6(%arg7)
                %2 = affine.apply #map6(%arg8)
                call @S0(%arg3, %c1, %1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
          ...
          affine.if #set11(%arg6) {
            affine.for %arg7 = max #map3(%arg4) to min #map4(%arg4)[%0] {
              affine.for %arg8 = max #map3(%arg5) to min #map4(%arg5)[%0] {
                %1 = affine.apply #map6(%arg7)
                %2 = affine.apply #map6(%arg8)
                call @S0(%arg3, %1, %2, %c1, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              }
        ...
        affine.if #set9(%arg4, %arg5) {
          affine.if #set1()[%0] {
            affine.for %arg6 = #map9(%arg5) to #map10(%arg5) {
              %1 = affine.apply #map6(%arg6)
              %2 = affine.apply #map5()[%0]
              call @S0(%arg3, %c1, %1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
            }
        ...
        affine.if #set11(%arg5) {
          affine.if #set1()[%0] {
            affine.for %arg6 = max #map3(%arg4) to #map10(%arg4) {
              %1 = affine.apply #map6(%arg6)
              %2 = affine.apply #map5()[%0]
              call @S0(%arg3, %1, %c1, %2, %arg2) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
            }
        ...
        affine.if #set12(%arg4, %arg5) {
          affine.if #set13()[%0] {
            affine.for %arg6 = max #map24(%arg4) to #map10(%arg4) {
              affine.for %arg7 = max #map24(%arg5) to #map10(%arg5) {
                %1 = affine.apply #map25(%arg6)
                %2 = affine.apply #map25(%arg7)
                %3 = affine.apply #map5()[%0]
                call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              }
            }
      ...
      affine.if #set14(%arg4) {
        affine.if #set13()[%0] {
          affine.for %arg5 = 1 to #map26()[%0] {
            affine.for %arg6 = max #map24(%arg4) to #map10(%arg4) {
              affine.for %arg7 = max #map24(%arg5) to min #map27(%arg5)[%0] {
                %1 = affine.apply #map25(%arg6)
                %2 = affine.apply #map5()[%0]
                %3 = affine.apply #map25(%arg7)
                call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
              }
            }
          }
    ...
    affine.if #set13()[%0] {
      affine.for %arg4 = 1 to #map26()[%0] {
        affine.for %arg5 = 1 to #map26()[%0] {
          affine.for %arg6 = max #map24(%arg4) to min #map27(%arg4)[%0] {
            affine.for %arg7 = max #map24(%arg5) to min #map27(%arg5)[%0] {
              %1 = affine.apply #map5()[%0]
              %2 = affine.apply #map25(%arg6)
              %3 = affine.apply #map25(%arg7)
              call @S1(%arg2, %1, %2, %3, %arg3) : (memref<10x10x10xf64>, index, index, index, memref<10x10x10xf64>) -> ()
            }
          }
