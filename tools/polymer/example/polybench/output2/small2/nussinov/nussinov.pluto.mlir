...
#map2 = affine_map<()[s0] -> ((s0 - 62) floordiv 32 + 1)>
#map3 = affine_map<(d0)[s0] -> (d0 * -32 + s0 - 31)>
#map4 = affine_map<(d0) -> (d0 * 32 + 31)>
#map5 = affine_map<()[s0] -> (0, (s0 - 61) ceildiv 32)>
#map6 = affine_map<()[s0] -> (s0 floordiv 32 + 1)>
#map7 = affine_map<(d0)[s0] -> (0, (d0 * 32 - s0 + 1) ceildiv 32)>
#map8 = affine_map<(d0)[s0] -> ((s0 - 1) floordiv 32 + 1, d0 + 1)>
#map9 = affine_map<()[s0] -> (s0 - 1)>
#map10 = affine_map<(d0, d1)[s0] -> (2, d0 * 32 - d1 * 32, d1 * -32 + s0 - 30)>
#map11 = affine_map<(d0, d1)[s0] -> (s0, d0 * -32 + s0 + 1, d1 * 32 - d0 * 32 + 32)>
#map12 = affine_map<(d0)[s0] -> (-d0 + s0 + 1)>
#map13 = affine_map<(d0)[s0] -> (s0, d0 * 32 + 32)>
#map14 = affine_map<(d0)[s0] -> (d0 * -32 + s0 + 1)>
#map15 = affine_map<(d0, d1)[s0] -> (s0, d0 * 32 - d1 * 32 + 32)>
#map16 = affine_map<(d0) -> (d0 * 32)>
#map17 = affine_map<()[s0] -> ((s0 + 1) ceildiv 32)>
#map18 = affine_map<()[s0] -> ((s0 - 1) floordiv 16 + 1)>
#map19 = affine_map<(d0)[s0] -> ((d0 * 32 - s0 + 1) ceildiv 32)>
#map20 = affine_map<()[s0] -> ((s0 - 1) floordiv 32 + 1)>
#map21 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32)>
...
#set4 = affine_set<(d0, d1)[s0] : (-(d0 + d1 - s0 - 1) - 1 >= 0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_nussinov_new(%arg0: i32, %arg1: memref<60xi8>, %arg2: memref<60x60xi32>) {
    ...
    affine.if #set5()[%0] {
      affine.if #set6()[%0] {
        affine.for %arg3 = 0 to #map2()[%0] {
          %1 = affine.apply #map3(%arg3)[%0]
          ...
          %5 = affine.apply #map3(%arg3)[%0]
          %6 = affine.apply #map4(%arg3)
          call @S3(%arg2, %5, %6, %0) : (memref<60x60xi32>, index, index, index) -> ()
        }
      }
    }
    affine.for %arg3 = max #map5()[%0] to #map6()[%0] {
      affine.for %arg4 = max #map7(%arg3)[%0] to min #map8(%arg3)[%0] {
        affine.if #set7(%arg3, %arg4)[%0] {
          %1 = affine.apply #map3(%arg4)[%0]
          %2 = affine.apply #map4(%arg4)
          call @S0(%arg2, %1, %2, %0) : (memref<60x60xi32>, index, index, index) -> ()
          %3 = affine.apply #map3(%arg4)[%0]
          %4 = affine.apply #map4(%arg4)
          call @S1(%arg2, %3, %4, %0) : (memref<60x60xi32>, index, index, index) -> ()
          %5 = affine.apply #map3(%arg4)[%0]
          %6 = affine.apply #map4(%arg4)
          call @S3(%arg2, %5, %6, %0) : (memref<60x60xi32>, index, index, index) -> ()
        }
        affine.if #set8(%arg3, %arg4)[%0] {
          ...
          call @S3(%arg2, %c1, %3, %0) : (memref<60x60xi32>, index, index, index) -> ()
        }
        affine.for %arg5 = max #map10(%arg3, %arg4)[%0] to min #map11(%arg3, %arg4)[%0] {
          ...
          call @S3(%arg2, %arg5, %3, %0) : (memref<60x60xi32>, index, index, index) -> ()
          affine.for %arg6 = #map12(%arg5)[%0] to min #map13(%arg4)[%0] {
            ...
            affine.for %arg7 = #map0(%arg5)[%0] to #map1(%arg6) {
              call @S4(%arg2, %arg5, %arg6, %0, %arg7) : (memref<60x60xi32>, index, index, index, index) -> ()
            }
          }
        }
        affine.for %arg5 = #map14(%arg4)[%0] to min #map15(%arg3, %arg4)[%0] {
          affine.for %arg6 = #map16(%arg4) to min #map13(%arg4)[%0] {
            call @S0(%arg2, %arg5, %arg6, %0) : (memref<60x60xi32>, index, index, index) -> ()
            call @S1(%arg2, %arg5, %arg6, %0) : (memref<60x60xi32>, index, index, index) -> ()
            call @S2(%arg2, %arg5, %arg6, %0, %arg1) : (memref<60x60xi32>, index, index, index, memref<60xi8>) -> ()
            affine.for %arg7 = #map0(%arg5)[%0] to #map1(%arg6) {
    ...
    affine.for %arg3 = #map17()[%0] to #map18()[%0] {
      affine.for %arg4 = #map19(%arg3)[%0] to #map20()[%0] {
        affine.for %arg5 = #map21(%arg3, %arg4) to min #map15(%arg3, %arg4)[%0] {
          affine.for %arg6 = #map16(%arg4) to min #map13(%arg4)[%0] {
            call @S0(%arg2, %arg5, %arg6, %0) : (memref<60x60xi32>, index, index, index) -> ()
            call @S1(%arg2, %arg5, %arg6, %0) : (memref<60x60xi32>, index, index, index) -> ()
            call @S2(%arg2, %arg5, %arg6, %0, %arg1) : (memref<60x60xi32>, index, index, index, memref<60xi8>) -> ()
