module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_gemm(%c20_i32, %c25_i32, %c30_i32, %7, %8, %2, %3, %4) : (i32, i32, i32, f64, f64, memref<20x25xf64>, memref<20x30xf64>, memref<30x25xf64>) -> ()
  ...
  func private @kernel_gemm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: f64, %arg4: f64, %arg5: memref<20x25xf64>, %arg6: memref<20x30xf64>, %arg7: memref<30x25xf64>) {
    ...
    affine.for %arg8 = 0 to %0 {
      affine.for %arg9 = 0 to %1 {
        %3 = affine.load %arg5[%arg8, %arg9] : memref<20x25xf64>
        %4 = mulf %3, %arg4 : f64
        affine.store %4, %arg5[%arg8, %arg9] : memref<20x25xf64>
      }
      affine.for %arg9 = 0 to %2 {
        affine.for %arg10 = 0 to %1 {
          %3 = affine.load %arg6[%arg8, %arg9] : memref<20x30xf64>
          %4 = mulf %arg3, %3 : f64
          %5 = affine.load %arg7[%arg9, %arg10] : memref<30x25xf64>
          %6 = mulf %4, %5 : f64
          %7 = affine.load %arg5[%arg8, %arg10] : memref<20x25xf64>
          %8 = addf %7, %6 : f64
          affine.store %8, %arg5[%arg8, %arg10] : memref<20x25xf64>
        }
      }
    }
    return
