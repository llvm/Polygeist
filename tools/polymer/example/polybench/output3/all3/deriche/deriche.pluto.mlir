...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<7680x4320xf32>, %arg4: memref<7680x4320xf32>, %arg5: memref<7680x4320xf32>, %arg6: memref<7680x4320xf32>) {
    ...
    call @S0(%18, %arg2, %15, %14, %11) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    call @S1(%19, %arg2, %15, %14, %13, %12) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    call @S2(%22, %arg2, %13) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    call @S3(%20, %arg2, %12, %10) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>) -> ()
    call @S4(%16, %11) : (memref<1xf32>, memref<1xf32>) -> ()
    call @S5(%17, %10) : (memref<1xf32>, memref<1xf32>) -> ()
    call @S6(%21) : (memref<1xf32>) -> ()
    affine.for %arg7 = 0 to %24 {
      call @S7(%27) : (memref<1xf32>) -> ()
      call @S8(%28) : (memref<1xf32>) -> ()
      call @S9(%25) : (memref<1xf32>) -> ()
      affine.for %arg8 = 0 to %23 {
        call @S10(%arg5, %arg7, %arg8, %28, %17, %27, %16, %25, %19, %arg3, %18, %9, %8, %7) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %24 {
      ...
      affine.for %arg8 = 0 to %23 {
        call @S18(%arg6, %arg7, %arg8, %23, %34, %17, %33, %16, %30, %20, %29, %22, %6, %5, %4) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S19(%30, %6) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S20(%29, %arg3, %arg7, %arg8, %23) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
    ...
    affine.for %arg7 = 0 to %24 {
      affine.for %arg8 = 0 to %23 {
        call @S23(%arg4, %arg7, %arg8, %arg6, %arg5, %21) : (memref<7680x4320xf32>, index, index, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<1xf32>) -> ()
      }
    }
    affine.for %arg7 = 0 to %23 {
      ...
      affine.for %arg8 = 0 to %24 {
        call @S27(%arg5, %arg8, %arg7, %28, %17, %27, %16, %26, %19, %arg4, %18, %3, %2) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %23 {
      ...
      affine.for %arg8 = 0 to %24 {
        call @S35(%arg6, %arg8, %arg7, %24, %34, %17, %33, %16, %32, %20, %31, %22, %1, %0) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S36(%32, %1) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S37(%31, %arg4, %arg8, %arg7, %24) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
        call @S38(%34, %0) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S39(%33, %arg6, %arg8, %arg7, %24) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to %24 {
      affine.for %arg8 = 0 to %23 {
        call @S40(%arg4, %arg7, %arg8, %arg6, %arg5, %21) : (memref<7680x4320xf32>, index, index, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<1xf32>) -> ()
      }
    }
    return
  }
  ...
  func private @S18(%arg0: memref<7680x4320xf32>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<1xf32>, %arg5: memref<1xf32>, %arg6: memref<1xf32>, %arg7: memref<1xf32>, %arg8: memref<1xf32>, %arg9: memref<1xf32>, %arg10: memref<1xf32>, %arg11: memref<1xf32>, %arg12: memref<1xf32>, %arg13: memref<1xf32>, %arg14: memref<1xf32>) attributes {scop.stmt} {
  ...
  func private @kernel_deriche_new(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<7680x4320xf32>, %arg4: memref<7680x4320xf32>, %arg5: memref<7680x4320xf32>, %arg6: memref<7680x4320xf32>) {
    ...
    affine.for %arg7 = 0 to %33 {
      ...
      affine.for %arg8 = 0 to %34 {
        call @S10(%arg5, %arg7, %arg8, %27, %30, %28, %31, %26, %17, %arg3, %20, %25, %24, %14) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %33 {
      ...
      affine.for %arg8 = 0 to %34 {
        call @S18(%arg6, %arg7, %arg8, %34, %12, %30, %13, %31, %10, %32, %11, %16, %9, %7, %8) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S22(%13, %8) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S21(%12, %7) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S20(%11, %arg3, %arg7, %arg8, %34) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
      ...
      affine.for %arg8 = 0 to #map0()[%34] {
        affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%33] {
          affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%34] {
            call @S23(%arg4, %arg9, %arg10, %arg6, %arg5, %29) : (memref<7680x4320xf32>, index, index, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<1xf32>) -> ()
          }
        }
      }
    }
    affine.for %arg7 = 0 to %34 {
      ...
      affine.for %arg8 = 0 to %33 {
        call @S27(%arg5, %arg8, %arg7, %27, %30, %28, %31, %6, %17, %arg4, %20, %5, %4) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S30(%28, %arg5, %arg8, %arg7) : (memref<1xf32>, memref<7680x4320xf32>, index, index) -> ()
    ...
    affine.for %arg7 = 0 to %34 {
      ...
      affine.for %arg8 = 0 to %33 {
        call @S35(%arg6, %arg8, %arg7, %33, %12, %30, %13, %31, %2, %32, %3, %16, %1, %0) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        call @S39(%13, %arg6, %arg8, %arg7, %33) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
        call @S38(%12, %0) : (memref<1xf32>, memref<1xf32>) -> ()
        call @S37(%3, %arg4, %arg8, %arg7, %33) : (memref<1xf32>, memref<7680x4320xf32>, index, index, index) -> ()
    ...
    affine.for %arg7 = 0 to #map0()[%33] {
      affine.for %arg8 = 0 to #map0()[%34] {
        affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%33] {
          affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%34] {
            call @S40(%arg4, %arg9, %arg10, %arg6, %arg5, %29) : (memref<7680x4320xf32>, index, index, memref<7680x4320xf32>, memref<7680x4320xf32>, memref<1xf32>) -> ()
          }
        }
      }
    }
