  ...
  func private @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<7680x4320xf32>, %arg4: memref<7680x4320xf32>, %arg5: memref<7680x4320xf32>, %arg6: memref<7680x4320xf32>) {
    ...
    affine.for %arg7 = 0 to %24 {
      ...
      affine.for %arg8 = 0 to %23 {
        call @S10(%arg5, %arg7, %arg8, %28, %19, %27, %20, %25, %18, %arg3, %16, %9, %8, %7) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %24 {
      ...
      affine.for %arg8 = 0 to %23 {
        call @S18(%arg6, %arg7, %arg8, %23, %34, %19, %33, %20, %30, %21, %29, %22, %6, %5, %4) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %23 {
      ...
      affine.for %arg8 = 0 to %24 {
        call @S27(%arg5, %arg8, %arg7, %28, %19, %27, %20, %26, %18, %arg4, %16, %3, %2) : (memref<7680x4320xf32>, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<7680x4320xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to %23 {
      ...
      affine.for %arg8 = 0 to %24 {
        call @S35(%arg6, %arg8, %arg7, %24, %34, %19, %33, %20, %32, %21, %31, %22, %1, %0) : (memref<7680x4320xf32>, index, index, index, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
