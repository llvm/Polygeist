...
#map4 = affine_map<()[s0] -> (0, (s0 - 62) ceildiv 32)>
#map5 = affine_map<()[s0] -> ((s0 - 1) floordiv 16 + 1)>
#map6 = affine_map<(d0)[s0] -> (0, (d0 * 32 - s0 + 1) ceildiv 32)>
#map7 = affine_map<(d0)[s0] -> ((s0 - 1) floordiv 32 + 1, d0 + 1)>
#map8 = affine_map<(d0)[s0] -> (d0 * -32 + s0 - 31)>
#map9 = affine_map<(d0) -> (d0 * 32 + 31)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func private @kernel_nussinov_new(%arg0: i32, %arg1: memref<5500xi8>, %arg2: memref<5500x5500xi32>) {
    %c1 = constant 1 : index
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg3 = max #map4()[%0] to #map5()[%0] {
      affine.for %arg4 = max #map6(%arg3)[%0] to min #map7(%arg3)[%0] {
        affine.if #set5(%arg3, %arg4)[%0] {
          %1 = affine.apply #map8(%arg4)[%0]
          %2 = affine.apply #map9(%arg4)
          call @S0(%arg2, %1, %2, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          %3 = affine.apply #map8(%arg4)[%0]
          %4 = affine.apply #map9(%arg4)
          call @S1(%arg2, %3, %4, %0) : (memref<5500x5500xi32>, index, index, index) -> ()
          %5 = affine.apply #map8(%arg4)[%0]
          %6 = affine.apply #map9(%arg4)
        ...
        affine.for %arg5 = max #map11(%arg3, %arg4)[%0] to min #map12(%arg3, %arg4)[%0] {
          affine.if #set7(%arg4, %arg5)[%0] {
          ...
          affine.for %arg6 = max #map13(%arg4, %arg5)[%0] to min #map14(%arg4)[%0] {
