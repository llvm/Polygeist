...
#map3 = affine_map<(d0)[s0, s1] -> ((s0 + s1 - 3) floordiv 32 + 1, (d0 * 32 + s1 + 29) floordiv 32 + 1)>
#map4 = affine_map<(d0, d1)[s0] -> ((d0 * 64 - s0 - 28) ceildiv 32, d1 + d0)>
#map5 = affine_map<(d0, d1)[s0, s1] -> ((s0 + s1 - 3) floordiv 16 + 1, (d0 * 32 + s1 + 29) floordiv 16 + 1, (d1 * 64 + s1 + 59) floordiv 32 + 1, (d0 * 32 + d1 * 32 + s1 + 60) floordiv 32 + 1, (d1 * 32 + s0 + s1 + 28) floordiv 32 + 1)>
#map6 = affine_map<(d0, d1, d2)[s0] -> (d0 * 32, d1 * 32 - s0 + 2, d2 * 16 - s0 + 2, d1 * -32 + d2 * 32 - s0 - 29)>
#map7 = affine_map<(d0, d1, d2)[s0] -> (s0, d0 * 32 + 32, d1 * 32 + 31, d2 * 16 + 15, d1 * -32 + d2 * 32 + 31)>
...
#set = affine_set<()[s0, s1] : (s0 - 1 >= 0, s1 - 3 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_seidel_2d_new(%c1000_i32, %c4000_i32, %0) : (i32, i32, memref<4000x4000xf64>) -> ()
  ...
  ^bb4:  // pred: ^bb3
    ...
    %13 = divf %11, %12 : f64
    store %13, %arg1[%2, %5] : memref<4000x4000xf64>
  ...
  func private @kernel_seidel_2d(%arg0: i32, %arg1: i32, %arg2: memref<4000x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = 1 to #map0()[%1] {
        affine.for %arg5 = 1 to #map0()[%1] {
          call @S0(%arg2, %arg4, %arg5) : (memref<4000x4000xf64>, index, index) -> ()
        }
      }
    }
    return
  ...
  func private @S0(%arg0: memref<4000x4000xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 9.000000e+00 : f64
    %0 = affine.load %arg0[%arg1 - 1, %arg2 - 1] : memref<4000x4000xf64>
    %1 = affine.load %arg0[%arg1 - 1, %arg2] : memref<4000x4000xf64>
    %2 = addf %0, %1 : f64
    %3 = affine.load %arg0[%arg1 - 1, %arg2 + 1] : memref<4000x4000xf64>
    %4 = addf %2, %3 : f64
    %5 = affine.load %arg0[%arg1, %arg2 - 1] : memref<4000x4000xf64>
    %6 = addf %4, %5 : f64
    %7 = affine.load %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    %8 = addf %6, %7 : f64
    %9 = affine.load %arg0[%arg1, %arg2 + 1] : memref<4000x4000xf64>
    %10 = addf %8, %9 : f64
    %11 = affine.load %arg0[%arg1 + 1, %arg2 - 1] : memref<4000x4000xf64>
    %12 = addf %10, %11 : f64
    %13 = affine.load %arg0[%arg1 + 1, %arg2] : memref<4000x4000xf64>
    %14 = addf %12, %13 : f64
    %15 = affine.load %arg0[%arg1 + 1, %arg2 + 1] : memref<4000x4000xf64>
    %16 = addf %14, %15 : f64
    %17 = divf %16, %cst : f64
    affine.store %17, %arg0[%arg1, %arg2] : memref<4000x4000xf64>
    return
  }
  func private @kernel_seidel_2d_new(%arg0: i32, %arg1: i32, %arg2: memref<4000x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.if #set()[%0, %1] {
      affine.for %arg3 = 0 to #map1()[%0] {
        affine.for %arg4 = #map2(%arg3) to min #map3(%arg3)[%0, %1] {
          affine.for %arg5 = max #map4(%arg4, %arg3)[%1] to min #map5(%arg3, %arg4)[%0, %1] {
            affine.for %arg6 = max #map6(%arg3, %arg4, %arg5)[%1] to min #map7(%arg3, %arg4, %arg5)[%0] {
              affine.for %arg7 = max #map8(%arg4, %arg6, %arg5)[%1] to min #map9(%arg4, %arg5, %arg6)[%1] {
                affine.for %arg8 = max #map10(%arg5, %arg6, %arg7) to min #map11(%arg5, %arg6, %arg7)[%1] {
                  %2 = affine.apply #map12(%arg6, %arg7)
                  %3 = affine.apply #map13(%arg6, %arg7, %arg8)
                  call @S0(%arg2, %2, %3) : (memref<4000x4000xf64>, index, index) -> ()
                }
              }
            }
          }
