...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_cholesky(%c40_i32, %0) : (i32, memref<40x40xf64>) -> ()
    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map(%arg2) {
        affine.for %arg4 = 0 to #map(%arg3) {
          %6 = affine.load %arg1[%arg2, %arg4] : memref<40x40xf64>
          %7 = affine.load %arg1[%arg3, %arg4] : memref<40x40xf64>
          %8 = mulf %6, %7 : f64
          %9 = affine.load %arg1[%arg2, %arg3] : memref<40x40xf64>
          %10 = subf %9, %8 : f64
          affine.store %10, %arg1[%arg2, %arg3] : memref<40x40xf64>
        }
        %3 = affine.load %arg1[%arg3, %arg3] : memref<40x40xf64>
        %4 = affine.load %arg1[%arg2, %arg3] : memref<40x40xf64>
        %5 = divf %4, %3 : f64
        affine.store %5, %arg1[%arg2, %arg3] : memref<40x40xf64>
      }
      affine.for %arg3 = 0 to #map(%arg2) {
        %3 = affine.load %arg1[%arg2, %arg3] : memref<40x40xf64>
        %4 = affine.load %arg1[%arg2, %arg3] : memref<40x40xf64>
        %5 = mulf %3, %4 : f64
        %6 = affine.load %arg1[%arg2, %arg2] : memref<40x40xf64>
        %7 = subf %6, %5 : f64
        affine.store %7, %arg1[%arg2, %arg2] : memref<40x40xf64>
      }
      %1 = affine.load %arg1[%arg2, %arg2] : memref<40x40xf64>
      %2 = sqrt %1 : f64
      affine.store %2, %arg1[%arg2, %arg2] : memref<40x40xf64>
    }
    return
  }
