...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<32x28xf64>, %arg4: memref<28x28xf64>, %arg5: memref<28xf64>, %arg6: memref<28xf64>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        %10 = affine.load %arg3[%arg8, %arg7] : memref<32x28xf64>
        %11 = affine.load %arg5[%arg7] : memref<28xf64>
        %12 = subf %10, %11 : f64
        %13 = affine.load %arg3[%arg8, %arg7] : memref<32x28xf64>
        %14 = affine.load %arg5[%arg7] : memref<28xf64>
        %15 = subf %13, %14 : f64
        %16 = mulf %12, %15 : f64
        %17 = affine.load %arg6[%arg7] : memref<28xf64>
        %18 = addf %17, %16 : f64
        affine.store %18, %arg6[%arg7] : memref<28xf64>
      }
      %3 = affine.load %arg6[%arg7] : memref<28xf64>
      %4 = divf %3, %arg2 : f64
      affine.store %4, %arg6[%arg7] : memref<28xf64>
      %5 = affine.load %arg6[%arg7] : memref<28xf64>
      %6 = sqrt %5 : f64
      affine.store %6, %arg6[%arg7] : memref<28xf64>
      %7 = affine.load %arg6[%arg7] : memref<28xf64>
      %8 = cmpf "ule", %7, %cst : f64
      %9 = scf.if %8 -> (f64) {
        scf.yield %cst_1 : f64
      } else {
        %10 = affine.load %arg6[%arg7] : memref<28xf64>
        scf.yield %10 : f64
      }
      affine.store %9, %arg6[%arg7] : memref<28xf64>
    }
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to %1 {
        ...
        %8 = mulf %6, %7 : f64
        %9 = affine.load %arg3[%arg7, %arg8] : memref<32x28xf64>
        %10 = divf %9, %8 : f64
        affine.store %10, %arg3[%arg7, %arg8] : memref<32x28xf64>
      }
    }
    %2 = subi %1, %c1 : index
