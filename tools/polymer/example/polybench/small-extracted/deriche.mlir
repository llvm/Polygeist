  ...
  func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<64x64xf32>, %arg4: memref<64x64xf32>, %arg5: memref<64x64xf32>, %arg6: memref<64x64xf32>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        ...
        %50 = affine.load %arg3[%arg7, -%arg8 + symbol(%0) - 1] : memref<64x64xf32>
        affine.store %50, %6[0] : memref<1xf32>
        %51 = affine.load %10[0] : memref<1xf32>
        affine.store %51, %11[0] : memref<1xf32>
        %52 = affine.load %arg6[%arg7, -%arg8 + symbol(%0) - 1] : memref<64x64xf32>
    ...
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        %38 = affine.load %arg4[%arg8, %arg7] : memref<64x64xf32>
        %39 = mulf %21, %38 : f32
        ...
        %47 = mulf %36, %46 : f32
        %48 = addf %45, %47 : f32
        affine.store %48, %arg5[%arg8, %arg7] : memref<64x64xf32>
        %49 = affine.load %arg4[%arg8, %arg7] : memref<64x64xf32>
        affine.store %49, %3[0] : memref<1xf32>
        %50 = affine.load %4[0] : memref<1xf32>
        affine.store %50, %5[0] : memref<1xf32>
        %51 = affine.load %arg5[%arg8, %arg7] : memref<64x64xf32>
        affine.store %51, %4[0] : memref<1xf32>
      }
    }
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        ...
        %47 = mulf %36, %46 : f32
        %48 = addf %45, %47 : f32
        affine.store %48, %arg6[-%arg8 + symbol(%1) - 1, %arg7] : memref<64x64xf32>
        %49 = affine.load %8[0] : memref<1xf32>
        affine.store %49, %9[0] : memref<1xf32>
        %50 = affine.load %arg4[-%arg8 + symbol(%1) - 1, %arg7] : memref<64x64xf32>
        affine.store %50, %8[0] : memref<1xf32>
        %51 = affine.load %10[0] : memref<1xf32>
        affine.store %51, %11[0] : memref<1xf32>
        %52 = affine.load %arg6[-%arg8 + symbol(%1) - 1, %arg7] : memref<64x64xf32>
        affine.store %52, %10[0] : memref<1xf32>
      }
    }
    affine.for %arg7 = 0 to %1 {
