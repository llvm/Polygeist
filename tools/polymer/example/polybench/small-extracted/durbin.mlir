  ...
  func @kernel_durbin(%arg0: i32, %arg1: memref<40xf64>, %arg2: memref<40xf64>) {
    ...
    affine.for %arg3 = 1 to %8 {
      ...
      affine.for %arg4 = 0 to #map(%arg3) {
        %21 = affine.load %arg1[%arg3 - %arg4 - 1] : memref<40xf64>
        %22 = affine.load %arg2[%arg4] : memref<40xf64>
        %23 = mulf %21, %22 : f64
        %24 = affine.load %3[0] : memref<1xf64>
        %25 = addf %24, %23 : f64
        affine.store %25, %3[0] : memref<1xf64>
      }
      %16 = affine.load %arg1[%arg3] : memref<40xf64>
      ...
      affine.for %arg4 = 0 to #map(%arg3) {
        ...
        %22 = affine.load %arg2[%arg3 - %arg4 - 1] : memref<40xf64>
        %23 = mulf %20, %22 : f64
        %24 = addf %21, %23 : f64
        affine.store %24, %0[%arg4] : memref<40xf64>
      }
      affine.for %arg4 = 0 to #map(%arg3) {
        %21 = affine.load %0[%arg4] : memref<40xf64>
        affine.store %21, %arg2[%arg4] : memref<40xf64>
      }
      affine.store %20, %arg2[%arg3] : memref<40xf64>
    }
    return
  }
