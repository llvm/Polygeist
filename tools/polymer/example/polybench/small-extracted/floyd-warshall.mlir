    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to %0 {
        affine.for %arg4 = 0 to %0 {
          %1 = affine.load %arg1[%arg3, %arg4] : memref<60x60xi32>
          %2 = affine.load %arg1[%arg3, %arg2] : memref<60x60xi32>
          %3 = affine.load %arg1[%arg2, %arg4] : memref<60x60xi32>
          %4 = addi %2, %3 : i32
          %5 = cmpi "slt", %1, %4 : i32
          %6 = scf.if %5 -> (i32) {
            %7 = affine.load %arg1[%arg3, %arg4] : memref<60x60xi32>
            scf.yield %7 : i32
          } else {
            %7 = affine.load %arg1[%arg3, %arg2] : memref<60x60xi32>
            %8 = affine.load %arg1[%arg2, %arg4] : memref<60x60xi32>
            %9 = addi %7, %8 : i32
            scf.yield %9 : i32
          }
          affine.store %6, %arg1[%arg3, %arg4] : memref<60x60xi32>
        }
      }
    }
    return
