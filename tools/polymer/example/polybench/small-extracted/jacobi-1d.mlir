...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_jacobi_1d(%c20_i32, %c30_i32, %0, %1) : (i32, i32, memref<30xf64>, memref<30xf64>) -> ()
    call @print_array(%c30_i32, %0) : (i32, memref<30xf64>) -> ()
    return %c0_i32 : i32
  }
  func @init_array(%arg0: i32, %arg1: memref<30xf64>, %arg2: memref<30xf64>) {
    %c0_i32 = constant 0 : i32
  ...
  func @kernel_jacobi_1d(%arg0: i32, %arg1: i32, %arg2: memref<30xf64>, %arg3: memref<30xf64>) {
    %cst = constant 3.333300e-01 : f64
    %0 = index_cast %arg1 : i32 to index
    %1 = index_cast %arg0 : i32 to index
    affine.for %arg4 = 0 to %1 {
      affine.for %arg5 = 1 to #map()[%0] {
        %2 = affine.load %arg2[%arg5 - 1] : memref<30xf64>
        %3 = affine.load %arg2[%arg5] : memref<30xf64>
        %4 = addf %2, %3 : f64
        %5 = affine.load %arg2[%arg5 + 1] : memref<30xf64>
        %6 = addf %4, %5 : f64
        %7 = mulf %cst, %6 : f64
        affine.store %7, %arg3[%arg5] : memref<30xf64>
      }
      affine.for %arg5 = 1 to #map()[%0] {
        %2 = affine.load %arg3[%arg5 - 1] : memref<30xf64>
        %3 = affine.load %arg3[%arg5] : memref<30xf64>
        %4 = addf %2, %3 : f64
        %5 = affine.load %arg3[%arg5 + 1] : memref<30xf64>
        %6 = addf %4, %5 : f64
        %7 = mulf %cst, %6 : f64
        affine.store %7, %arg2[%arg5] : memref<30xf64>
      }
    }
    return
  }
