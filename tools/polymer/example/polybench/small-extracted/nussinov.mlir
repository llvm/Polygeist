  ...
  func @kernel_nussinov(%arg0: i32, %arg1: memref<60xi8>, %arg2: memref<60x60xi32>) {
    ...
    affine.for %arg3 = 0 to %0 {
      affine.for %arg4 = #map0(%arg3)[%0] to %0 {
        ...
        affine.if #set0(%1) {
          %3 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
          %4 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4 - 1] : memref<60x60xi32>
          %5 = cmpi "sge", %3, %4 : i32
          %6 = scf.if %5 -> (i32) {
            %7 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
            scf.yield %7 : i32
          } else {
            %7 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4 - 1] : memref<60x60xi32>
            scf.yield %7 : i32
          }
        ...
        affine.if #set1(%2)[%0] {
          %3 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
          %4 = affine.load %arg2[-%arg3 + symbol(%0), %arg4] : memref<60x60xi32>
          %5 = cmpi "sge", %3, %4 : i32
          %6 = scf.if %5 -> (i32) {
            %7 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
            scf.yield %7 : i32
          } else {
            %7 = affine.load %arg2[-%arg3 + symbol(%0), %arg4] : memref<60x60xi32>
            scf.yield %7 : i32
          }
          affine.store %6, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
        }
        affine.if #set2(%1, %2)[%0] {
          ...
          affine.if #set3(%3, %1) {
            %4 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
            %5 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<60x60xi32>
            %6 = affine.load %arg1[-%arg3 + symbol(%0) - 1] : memref<60xi8>
            %7 = sexti %6 : i8 to i32
            %8 = affine.load %arg1[%arg4] : memref<60xi8>
            %9 = sexti %8 : i8 to i32
            %10 = addi %7, %9 : i32
            ...
            %15 = scf.if %14 -> (i32) {
              %16 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
              scf.yield %16 : i32
            } else {
              %16 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<60x60xi32>
              %17 = affine.load %arg1[-%arg3 + symbol(%0) - 1] : memref<60xi8>
              %18 = sexti %17 : i8 to i32
              %19 = affine.load %arg1[%arg4] : memref<60xi8>
            ...
            affine.store %15, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
          } else {
            %4 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
            %5 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<60x60xi32>
            %6 = cmpi "sge", %4, %5 : i32
            %7 = scf.if %6 -> (i32) {
              %8 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
              scf.yield %8 : i32
            } else {
              %8 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<60x60xi32>
              scf.yield %8 : i32
            }
            affine.store %7, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
          }
        }
        affine.for %arg5 = #map0(%arg3)[%0] to #map3(%arg4) {
          %3 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
          %4 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg5] : memref<60x60xi32>
          %5 = affine.load %arg2[%arg5 + 1, %arg4] : memref<60x60xi32>
          %6 = addi %4, %5 : i32
          %7 = cmpi "sge", %3, %6 : i32
          %8 = scf.if %7 -> (i32) {
            %9 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
            scf.yield %9 : i32
          } else {
            %9 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg5] : memref<60x60xi32>
            %10 = affine.load %arg2[%arg5 + 1, %arg4] : memref<60x60xi32>
            %11 = addi %9, %10 : i32
            scf.yield %11 : i32
          }
          affine.store %8, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<60x60xi32>
        }
      }
    }
    return
