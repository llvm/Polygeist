    ...
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to %1 {
        affine.for %arg7 = #map(%arg5) to %0 {
          %4 = affine.load %arg3[%arg7, %arg5] : memref<20x20xf64>
          %5 = affine.load %arg4[%arg7, %arg6] : memref<20x30xf64>
          %6 = mulf %4, %5 : f64
          %7 = affine.load %arg4[%arg5, %arg6] : memref<20x30xf64>
          %8 = addf %7, %6 : f64
          affine.store %8, %arg4[%arg5, %arg6] : memref<20x30xf64>
        }
        %2 = affine.load %arg4[%arg5, %arg6] : memref<20x30xf64>
        %3 = mulf %arg2, %2 : f64
        affine.store %3, %arg4[%arg5, %arg6] : memref<20x30xf64>
      }
    }
    return
  }
