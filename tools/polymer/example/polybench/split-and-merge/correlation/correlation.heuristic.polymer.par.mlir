...
#map7 = affine_map<(d0) -> (0, (d0 * 32 - 2999) ceildiv 32)>
#map8 = affine_map<(d0) -> (82, d0 + 1)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    affine.for %arg2 = 0 to 175 {
      affine.for %arg3 = max #map7(%arg2) to min #map8(%arg2) {
        affine.for %arg4 = #map9(%arg2, %arg3) to min #map10(%arg2, %arg3) {
          affine.for %arg5 = #map1(%arg3) to min #map5(%arg3) {
            affine.for %arg6 = #map11(%arg5) to 2600 {
              %12 = affine.load %2[%arg4, %arg5] : memref<3000x2600xf64>
