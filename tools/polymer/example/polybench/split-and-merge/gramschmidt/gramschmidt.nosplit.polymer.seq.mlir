...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    ^bb0(%arg2: i32, %arg3: i32):  // no predecessors
      ...
      ^bb0(%arg4: i32):  // no predecessors
        ...
        %18 = remi_signed %17, %c2000_i32 : i32
        %19 = sitofp %18 : i32 to f64
        %20 = sitofp %c2000_i32 : i32 to f64
        %21 = divf %19, %20 : f64
        %22 = sitofp %c100_i32 : i32 to f64
        %23 = mulf %21, %22 : f64
        %24 = sitofp %c10_i32 : i32 to f64
        %25 = addf %23, %24 : f64
        memref.store %25, %0[%13, %16] : memref<2000x2600xf64>
        memref.store %cst, %2[%13, %16] : memref<2000x2600xf64>
    ...
    %7 = index_cast %6#0 : i32 to index
    %8 = scf.for %arg2 = %7 to %c2600 step %c1 iter_args(%arg3 = %6#0) -> (i32) {
      %13 = index_cast %arg3 : i32 to index
      scf.for %arg4 = %c0 to %c2600 step %c1 {
        memref.store %cst, %1[%13, %arg4] : memref<2600x2600xf64>
      }
      %14 = addi %arg3, %c1_i32 : i32
      scf.yield %14 : i32
    }
    call @polybench_timer_start() : () -> ()
    %9 = memref.alloca() {scop.scratchpad} : memref<1xf64>
      ...
      affine.for %arg3 = #map0(%arg2) to 82 {
        affine.for %arg4 = #map1(%arg2) to min #map2(%arg2, %arg3) {
          affine.for %arg5 = max #map3(%arg3, %arg4) to min #map4(%arg3) {
            affine.store %cst, %1[%arg4, %arg5] : memref<2600x2600xf64>
          }
        }
      }
    }
    affine.for %arg2 = 0 to 2600 {
          ...
          affine.for %arg4 = 0 to 63 {
            affine.for %arg5 = #map1(%arg4) to min #map5(%arg4) {
              affine.for %arg6 = max #map3(%arg3, %arg2) to min #map4(%arg3) {
                %16 = affine.load %1[%arg2, %arg6] : memref<2600x2600xf64>
                %17 = affine.load %2[%arg5, %arg2] : memref<2000x2600xf64>
                %18 = affine.load %0[%arg5, %arg6] : memref<2000x2600xf64>
                %19 = mulf %17, %18 {scop.splittable = 1 : index} : f64
                %20 = addf %16, %19 : f64
                affine.store %20, %1[%arg2, %arg6] : memref<2600x2600xf64>
              }
            }
          }
          affine.for %arg4 = 0 to 63 {
            affine.for %arg5 = #map1(%arg4) to min #map5(%arg4) {
              affine.for %arg6 = max #map3(%arg3, %arg2) to min #map4(%arg3) {
                %16 = affine.load %0[%arg5, %arg6] : memref<2000x2600xf64>
                %17 = affine.load %2[%arg5, %arg2] : memref<2000x2600xf64>
                %18 = affine.load %1[%arg2, %arg6] : memref<2600x2600xf64>
                %19 = mulf %17, %18 {scop.splittable = 2 : index} : f64
                %20 = subf %16, %19 : f64
                affine.store %20, %0[%arg5, %arg6] : memref<2000x2600xf64>
              }
            }
          }
        }
      ...
      affine.store %15, %1[%arg2, %arg2] : memref<2600x2600xf64>
    }
  ...
  func private @S1(%arg0: memref<1xf64>, %arg1: memref<?x2600xf64>, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[0] : memref<1xf64>
    %1 = affine.load %arg1[symbol(%arg2), symbol(%arg3)] : memref<?x2600xf64>
    %2 = mulf %1, %1 {scop.splittable = 0 : index} : f64
    %3 = addf %0, %2 : f64
  ...
  func private @S3(%arg0: memref<?x2600xf64>, %arg1: index, %arg2: memref<1xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg2[0] : memref<1xf64>
    affine.store %0, %arg0[symbol(%arg1), symbol(%arg1)] : memref<?x2600xf64>
    return
  }
  func private @S4(%arg0: memref<?x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<1xf64>, %arg4: memref<?x2600xf64>) attributes {scop.stmt} {
  ...
  func private @S5(%arg0: memref<?x2600xf64>, %arg1: index, %arg2: index) attributes {scop.stmt} {
    %cst = constant 0.000000e+00 : f64
    affine.store %cst, %arg0[symbol(%arg1), symbol(%arg2)] : memref<?x2600xf64>
    return
  }
  func private @S6(%arg0: memref<?x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<?x2600xf64>, %arg4: index, %arg5: memref<?x2600xf64>) attributes {scop.stmt} {
