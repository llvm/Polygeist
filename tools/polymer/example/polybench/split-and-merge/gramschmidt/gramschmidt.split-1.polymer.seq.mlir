...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    affine.for %arg2 = 0 to 2600 {
      ...
      affine.for %arg3 = 0 to 2000 {
        ...
        %18 = affine.load %1[%arg3, %arg2] : memref<2000x2600xf64>
        %19 = mulf %18, %18 {scop.splittable = 0 : index} : f64
        %20 = addf %17, %19 : f64
        affine.store %20, %11[0] : memref<1xf64>
      }
      ...
      affine.for %arg3 = #map6(%arg2) to 2600 {
        affine.for %arg4 = 0 to 63 {
          affine.for %arg5 = #map1(%arg4) to min #map5(%arg4) {
            %17 = affine.load %3[%arg5, %arg2] : memref<2000x2600xf64>
            %18 = affine.load %1[%arg5, %arg3] : memref<2000x2600xf64>
            %19 = mulf %17, %18 {scop.splittable = 1 : index} : f64
            affine.store %19, %0[%arg5] : memref<2000xf64>
          }
        }
        affine.for %arg4 = 0 to 2000 {
          %17 = affine.load %2[%arg2, %arg3] : memref<2600x2600xf64>
          %18 = affine.load %0[%arg4] : memref<2000xf64>
          %19 = addf %17, %18 : f64
          affine.store %19, %2[%arg2, %arg3] : memref<2600x2600xf64>
        }
        affine.for %arg4 = 0 to 63 {
          affine.for %arg5 = #map1(%arg4) to min #map5(%arg4) {
            %17 = affine.load %1[%arg5, %arg3] : memref<2000x2600xf64>
            %18 = affine.load %3[%arg5, %arg2] : memref<2000x2600xf64>
            %19 = affine.load %2[%arg2, %arg3] : memref<2600x2600xf64>
            %20 = mulf %18, %19 {scop.splittable = 2 : index} : f64
            %21 = subf %17, %20 : f64
            affine.store %21, %1[%arg5, %arg3] : memref<2000x2600xf64>
          }
        }
      }
  ...
  func private @S6(%arg0: memref<?xf64>, %arg1: index, %arg2: memref<?x2600xf64>, %arg3: index, %arg4: memref<?x2600xf64>, %arg5: index) attributes {scop.stmt} {
    %0 = affine.load %arg4[symbol(%arg1), symbol(%arg5)] : memref<?x2600xf64>
  ...
  func private @S7(%arg0: memref<?x2600xf64>, %arg1: index, %arg2: index, %arg3: memref<?xf64>, %arg4: index) attributes {scop.stmt} {
