...
void ScopStmtOpSet::insert(mlir::Operation *op) {
  opSet.insert(op);
...
LogicalResult ScopStmtOpSet::getEnclosingOps(
...
LogicalResult
ScopStmtOpSet::getDomain(affine::FlatAffineValueConstraints &domain,
                         SmallVectorImpl<mlir::Operation *> &enclosingOps) {
